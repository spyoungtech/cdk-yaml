...
class CfnDataSource_ConnectionConfigurationPropertyDef(BaseStruct):
    ...
    secret_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Amazon Resource Name (ARN) of credentials stored in AWS Secrets Manager . The credentials should be a user/password pair. For more information, see `Using a Database Data Source <https://docs.aws.amazon.com/kendra/latest/dg/data-source-database.html>`_ . For more information about AWS Secrets Manager , see `What Is AWS Secrets Manager <https://docs.aws.amazon.com/secretsmanager/latest/userguide/intro.html>`_ in the *AWS Secrets Manager* user guide.\n')
...
class CfnDataSource_DataSourceConfigurationPropertyDef(BaseStruct):
    ...
    s3_configuration: typing.Union[models.UnsupportedResource, models.aws_kendra.CfnDataSource_S3DataSourceConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Provides the configuration information to connect to an Amazon S3 bucket as your data source.\n')
...
class CfnDataSource_HookConfigurationPropertyDef(BaseStruct):
    lambda_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Amazon Resource Name (ARN) of a role with permission to run a Lambda function during ingestion. For more information, see `IAM roles for Amazon Kendra <https://docs.aws.amazon.com/kendra/latest/dg/iam-roles.html>`_ .\n')
...
class CfnIndex_RelevancePropertyDef(BaseStruct):
    ...
    rank_order: typing.Optional[str] = pydantic.Field(None, description='Determines how values should be interpreted. When the ``RankOrder`` field is ``ASCENDING`` , higher numbers are better. For example, a document with a rating score of 10 is higher ranking than a document with a rating score of 1. When the ``RankOrder`` field is ``DESCENDING`` , lower numbers are better. For example, in a task tracking application, a priority 1 task is more important than a priority 5 task. Only applies to ``LONG`` and ``DOUBLE`` fields.\n')
...
class CfnDataSourceDefConfig(pydantic.BaseModel):
    AccessControlListConfigurationProperty: typing.Optional[list[CfnDataSourceDefAccesscontrollistconfigurationpropertyParams]] = pydantic.Field(None, description='')
    AclConfigurationProperty: typing.Optional[list[CfnDataSourceDefAclconfigurationpropertyParams]] = pydantic.Field(None, description='')
    ColumnConfigurationProperty: typing.Optional[list[CfnDataSourceDefColumnconfigurationpropertyParams]] = pydantic.Field(None, description='')
    ConfluenceAttachmentConfigurationProperty: typing.Optional[list[CfnDataSourceDefConfluenceattachmentconfigurationpropertyParams]] = pydantic.Field(None, description='')
    ConfluenceAttachmentToIndexFieldMappingProperty: typing.Optional[list[CfnDataSourceDefConfluenceattachmenttoindexfieldmappingpropertyParams]] = pydantic.Field(None, description='')
    ConfluenceBlogConfigurationProperty: typing.Optional[list[CfnDataSourceDefConfluenceblogconfigurationpropertyParams]] = pydantic.Field(None, description='')
    ConfluenceBlogToIndexFieldMappingProperty: typing.Optional[list[CfnDataSourceDefConfluenceblogtoindexfieldmappingpropertyParams]] = pydantic.Field(None, description='')
    ConfluenceConfigurationProperty: typing.Optional[list[CfnDataSourceDefConfluenceconfigurationpropertyParams]] = pydantic.Field(None, description='')
    ConfluencePageConfigurationProperty: typing.Optional[list[CfnDataSourceDefConfluencepageconfigurationpropertyParams]] = pydantic.Field(None, description='')
    ConfluencePageToIndexFieldMappingProperty: typing.Optional[list[CfnDataSourceDefConfluencepagetoindexfieldmappingpropertyParams]] = pydantic.Field(None, description='')
    ConfluenceSpaceConfigurationProperty: typing.Optional[list[CfnDataSourceDefConfluencespaceconfigurationpropertyParams]] = pydantic.Field(None, description='')
    ConfluenceSpaceToIndexFieldMappingProperty: typing.Optional[list[CfnDataSourceDefConfluencespacetoindexfieldmappingpropertyParams]] = pydantic.Field(None, description='')
    ConnectionConfigurationProperty: typing.Optional[list[CfnDataSourceDefConnectionconfigurationpropertyParams]] = pydantic.Field(None, description='')
    CustomDocumentEnrichmentConfigurationProperty: typing.Optional[list[CfnDataSourceDefCustomdocumentenrichmentconfigurationpropertyParams]] = pydantic.Field(None, description='')
    DataSourceConfigurationProperty: typing.Optional[list[CfnDataSourceDefDatasourceconfigurationpropertyParams]] = pydantic.Field(None, description='')
    DataSourceToIndexFieldMappingProperty: typing.Optional[list[CfnDataSourceDefDatasourcetoindexfieldmappingpropertyParams]] = pydantic.Field(None, description='')
    DataSourceVpcConfigurationProperty: typing.Optional[list[CfnDataSourceDefDatasourcevpcconfigurationpropertyParams]] = pydantic.Field(None, description='')
    DatabaseConfigurationProperty: typing.Optional[list[CfnDataSourceDefDatabaseconfigurationpropertyParams]] = pydantic.Field(None, description='')
    DocumentAttributeConditionProperty: typing.Optional[list[CfnDataSourceDefDocumentattributeconditionpropertyParams]] = pydantic.Field(None, description='')
    DocumentAttributeTargetProperty: typing.Optional[list[CfnDataSourceDefDocumentattributetargetpropertyParams]] = pydantic.Field(None, description='')
    DocumentAttributeValueProperty: typing.Optional[list[CfnDataSourceDefDocumentattributevaluepropertyParams]] = pydantic.Field(None, description='')
    DocumentsMetadataConfigurationProperty: typing.Optional[list[CfnDataSourceDefDocumentsmetadataconfigurationpropertyParams]] = pydantic.Field(None, description='')
    GoogleDriveConfigurationProperty: typing.Optional[list[CfnDataSourceDefGoogledriveconfigurationpropertyParams]] = pydantic.Field(None, description='')
    HookConfigurationProperty: typing.Optional[list[CfnDataSourceDefHookconfigurationpropertyParams]] = pydantic.Field(None, description='')
    InlineCustomDocumentEnrichmentConfigurationProperty: typing.Optional[list[CfnDataSourceDefInlinecustomdocumentenrichmentconfigurationpropertyParams]] = pydantic.Field(None, description='')
    OneDriveConfigurationProperty: typing.Optional[list[CfnDataSourceDefOnedriveconfigurationpropertyParams]] = pydantic.Field(None, description='')
    OneDriveUsersProperty: typing.Optional[list[CfnDataSourceDefOnedriveuserspropertyParams]] = pydantic.Field(None, description='')
    ProxyConfigurationProperty: typing.Optional[list[CfnDataSourceDefProxyconfigurationpropertyParams]] = pydantic.Field(None, description='')
    S3DataSourceConfigurationProperty: typing.Optional[list[CfnDataSourceDefS3DatasourceconfigurationpropertyParams]] = pydantic.Field(None, description='')
    S3PathProperty: typing.Optional[list[CfnDataSourceDefS3PathpropertyParams]] = pydantic.Field(None, description='')
    SalesforceChatterFeedConfigurationProperty: typing.Optional[list[CfnDataSourceDefSalesforcechatterfeedconfigurationpropertyParams]] = pydantic.Field(None, description='')
    SalesforceConfigurationProperty: typing.Optional[list[CfnDataSourceDefSalesforceconfigurationpropertyParams]] = pydantic.Field(None, description='')
    SalesforceCustomKnowledgeArticleTypeConfigurationProperty: typing.Optional[list[CfnDataSourceDefSalesforcecustomknowledgearticletypeconfigurationpropertyParams]] = pydantic.Field(None, description='')
    SalesforceKnowledgeArticleConfigurationProperty: typing.Optional[list[CfnDataSourceDefSalesforceknowledgearticleconfigurationpropertyParams]] = pydantic.Field(None, description='')
    SalesforceStandardKnowledgeArticleTypeConfigurationProperty: typing.Optional[list[CfnDataSourceDefSalesforcestandardknowledgearticletypeconfigurationpropertyParams]] = pydantic.Field(None, description='')
    SalesforceStandardObjectAttachmentConfigurationProperty: typing.Optional[list[CfnDataSourceDefSalesforcestandardobjectattachmentconfigurationpropertyParams]] = pydantic.Field(None, description='')
    SalesforceStandardObjectConfigurationProperty: typing.Optional[list[CfnDataSourceDefSalesforcestandardobjectconfigurationpropertyParams]] = pydantic.Field(None, description='')
    ServiceNowConfigurationProperty: typing.Optional[list[CfnDataSourceDefServicenowconfigurationpropertyParams]] = pydantic.Field(None, description='')
    ServiceNowKnowledgeArticleConfigurationProperty: typing.Optional[list[CfnDataSourceDefServicenowknowledgearticleconfigurationpropertyParams]] = pydantic.Field(None, description='')
    ServiceNowServiceCatalogConfigurationProperty: typing.Optional[list[CfnDataSourceDefServicenowservicecatalogconfigurationpropertyParams]] = pydantic.Field(None, description='')
    SharePointConfigurationProperty: typing.Optional[list[CfnDataSourceDefSharepointconfigurationpropertyParams]] = pydantic.Field(None, description='')
    SqlConfigurationProperty: typing.Optional[list[CfnDataSourceDefSqlconfigurationpropertyParams]] = pydantic.Field(None, description='')
    TemplateConfigurationProperty: typing.Optional[list[CfnDataSourceDefTemplateconfigurationpropertyParams]] = pydantic.Field(None, description='')
    WebCrawlerAuthenticationConfigurationProperty: typing.Optional[list[CfnDataSourceDefWebcrawlerauthenticationconfigurationpropertyParams]] = pydantic.Field(None, description='')
    WebCrawlerBasicAuthenticationProperty: typing.Optional[list[CfnDataSourceDefWebcrawlerbasicauthenticationpropertyParams]] = pydantic.Field(None, description='')
    WebCrawlerConfigurationProperty: typing.Optional[list[CfnDataSourceDefWebcrawlerconfigurationpropertyParams]] = pydantic.Field(None, description='')
    WebCrawlerSeedUrlConfigurationProperty: typing.Optional[list[CfnDataSourceDefWebcrawlerseedurlconfigurationpropertyParams]] = pydantic.Field(None, description='')
    WebCrawlerSiteMapsConfigurationProperty: typing.Optional[list[CfnDataSourceDefWebcrawlersitemapsconfigurationpropertyParams]] = pydantic.Field(None, description='')
    WebCrawlerUrlsProperty: typing.Optional[list[CfnDataSourceDefWebcrawlerurlspropertyParams]] = pydantic.Field(None, description='')
    WorkDocsConfigurationProperty: typing.Optional[list[CfnDataSourceDefWorkdocsconfigurationpropertyParams]] = pydantic.Field(None, description='')
...
class CfnFaqDef(BaseCfnResource):
    ...
    tags: typing.Optional[typing.Sequence[typing.Union[models.CfnTagDef, dict[str, typing.Any]]]] = pydantic.Field(None, description='An array of key-value pairs to apply to this resource. For more information, see `Tag <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-resource-tags.html>`_ .')
    _init_params: typing.ClassVar[list[str]] = ['index_id', 'name', 'role_arn', 's3_path', 'description', 'file_format', 'tags']
    ...
    resource_config: typing.Optional[CfnFaqDefConfig] = pydantic.Field(None)


class CfnFaqDefConfig(pydantic.BaseModel):
    S3PathProperty: typing.Optional[list[CfnFaqDefS3PathpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[CfnFaqDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[CfnFaqDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[CfnFaqDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[CfnFaqDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[CfnFaqDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[CfnFaqDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[CfnFaqDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[CfnFaqDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[CfnFaqDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[CfnFaqDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[CfnFaqDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[CfnFaqDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[CfnFaqDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
    tags_config: typing.Optional[models.core.TagManagerDefConfig] = pydantic.Field(None)
...
class CfnIndexDefConfig(pydantic.BaseModel):
    CapacityUnitsConfigurationProperty: typing.Optional[list[CfnIndexDefCapacityunitsconfigurationpropertyParams]] = pydantic.Field(None, description='')
    DocumentMetadataConfigurationProperty: typing.Optional[list[CfnIndexDefDocumentmetadataconfigurationpropertyParams]] = pydantic.Field(None, description='')
    JsonTokenTypeConfigurationProperty: typing.Optional[list[CfnIndexDefJsontokentypeconfigurationpropertyParams]] = pydantic.Field(None, description='')
    JwtTokenTypeConfigurationProperty: typing.Optional[list[CfnIndexDefJwttokentypeconfigurationpropertyParams]] = pydantic.Field(None, description='')
    RelevanceProperty: typing.Optional[list[CfnIndexDefRelevancepropertyParams]] = pydantic.Field(None, description='')
    SearchProperty: typing.Optional[list[CfnIndexDefSearchpropertyParams]] = pydantic.Field(None, description='')
    ServerSideEncryptionConfigurationProperty: typing.Optional[list[CfnIndexDefServersideencryptionconfigurationpropertyParams]] = pydantic.Field(None, description='')
    UserTokenConfigurationProperty: typing.Optional[list[CfnIndexDefUsertokenconfigurationpropertyParams]] = pydantic.Field(None, description='')
    ValueImportanceItemProperty: typing.Optional[list[CfnIndexDefValueimportanceitempropertyParams]] = pydantic.Field(None, description='')
...
class ModuleModel(pydantic.BaseModel):
    CfnDataSource_AccessControlListConfigurationProperty: typing.Optional[dict[str, CfnDataSource_AccessControlListConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDataSource_AclConfigurationProperty: typing.Optional[dict[str, CfnDataSource_AclConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDataSource_ColumnConfigurationProperty: typing.Optional[dict[str, CfnDataSource_ColumnConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDataSource_ConfluenceAttachmentConfigurationProperty: typing.Optional[dict[str, CfnDataSource_ConfluenceAttachmentConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDataSource_ConfluenceAttachmentToIndexFieldMappingProperty: typing.Optional[dict[str, CfnDataSource_ConfluenceAttachmentToIndexFieldMappingPropertyDef]] = pydantic.Field(None)
    CfnDataSource_ConfluenceBlogConfigurationProperty: typing.Optional[dict[str, CfnDataSource_ConfluenceBlogConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDataSource_ConfluenceBlogToIndexFieldMappingProperty: typing.Optional[dict[str, CfnDataSource_ConfluenceBlogToIndexFieldMappingPropertyDef]] = pydantic.Field(None)
    CfnDataSource_ConfluenceConfigurationProperty: typing.Optional[dict[str, CfnDataSource_ConfluenceConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDataSource_ConfluencePageConfigurationProperty: typing.Optional[dict[str, CfnDataSource_ConfluencePageConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDataSource_ConfluencePageToIndexFieldMappingProperty: typing.Optional[dict[str, CfnDataSource_ConfluencePageToIndexFieldMappingPropertyDef]] = pydantic.Field(None)
    CfnDataSource_ConfluenceSpaceConfigurationProperty: typing.Optional[dict[str, CfnDataSource_ConfluenceSpaceConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDataSource_ConfluenceSpaceToIndexFieldMappingProperty: typing.Optional[dict[str, CfnDataSource_ConfluenceSpaceToIndexFieldMappingPropertyDef]] = pydantic.Field(None)
    CfnDataSource_ConnectionConfigurationProperty: typing.Optional[dict[str, CfnDataSource_ConnectionConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDataSource_CustomDocumentEnrichmentConfigurationProperty: typing.Optional[dict[str, CfnDataSource_CustomDocumentEnrichmentConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDataSource_DatabaseConfigurationProperty: typing.Optional[dict[str, CfnDataSource_DatabaseConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDataSource_DataSourceConfigurationProperty: typing.Optional[dict[str, CfnDataSource_DataSourceConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDataSource_DataSourceToIndexFieldMappingProperty: typing.Optional[dict[str, CfnDataSource_DataSourceToIndexFieldMappingPropertyDef]] = pydantic.Field(None)
    CfnDataSource_DataSourceVpcConfigurationProperty: typing.Optional[dict[str, CfnDataSource_DataSourceVpcConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDataSource_DocumentAttributeConditionProperty: typing.Optional[dict[str, CfnDataSource_DocumentAttributeConditionPropertyDef]] = pydantic.Field(None)
    CfnDataSource_DocumentAttributeTargetProperty: typing.Optional[dict[str, CfnDataSource_DocumentAttributeTargetPropertyDef]] = pydantic.Field(None)
    CfnDataSource_DocumentAttributeValueProperty: typing.Optional[dict[str, CfnDataSource_DocumentAttributeValuePropertyDef]] = pydantic.Field(None)
    CfnDataSource_DocumentsMetadataConfigurationProperty: typing.Optional[dict[str, CfnDataSource_DocumentsMetadataConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDataSource_GoogleDriveConfigurationProperty: typing.Optional[dict[str, CfnDataSource_GoogleDriveConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDataSource_HookConfigurationProperty: typing.Optional[dict[str, CfnDataSource_HookConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDataSource_InlineCustomDocumentEnrichmentConfigurationProperty: typing.Optional[dict[str, CfnDataSource_InlineCustomDocumentEnrichmentConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDataSource_OneDriveConfigurationProperty: typing.Optional[dict[str, CfnDataSource_OneDriveConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDataSource_OneDriveUsersProperty: typing.Optional[dict[str, CfnDataSource_OneDriveUsersPropertyDef]] = pydantic.Field(None)
    CfnDataSource_ProxyConfigurationProperty: typing.Optional[dict[str, CfnDataSource_ProxyConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDataSource_S3DataSourceConfigurationProperty: typing.Optional[dict[str, CfnDataSource_S3DataSourceConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDataSource_S3PathProperty: typing.Optional[dict[str, CfnDataSource_S3PathPropertyDef]] = pydantic.Field(None)
    CfnDataSource_SalesforceChatterFeedConfigurationProperty: typing.Optional[dict[str, CfnDataSource_SalesforceChatterFeedConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDataSource_SalesforceConfigurationProperty: typing.Optional[dict[str, CfnDataSource_SalesforceConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDataSource_SalesforceCustomKnowledgeArticleTypeConfigurationProperty: typing.Optional[dict[str, CfnDataSource_SalesforceCustomKnowledgeArticleTypeConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDataSource_SalesforceKnowledgeArticleConfigurationProperty: typing.Optional[dict[str, CfnDataSource_SalesforceKnowledgeArticleConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDataSource_SalesforceStandardKnowledgeArticleTypeConfigurationProperty: typing.Optional[dict[str, CfnDataSource_SalesforceStandardKnowledgeArticleTypeConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDataSource_SalesforceStandardObjectAttachmentConfigurationProperty: typing.Optional[dict[str, CfnDataSource_SalesforceStandardObjectAttachmentConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDataSource_SalesforceStandardObjectConfigurationProperty: typing.Optional[dict[str, CfnDataSource_SalesforceStandardObjectConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDataSource_ServiceNowConfigurationProperty: typing.Optional[dict[str, CfnDataSource_ServiceNowConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDataSource_ServiceNowKnowledgeArticleConfigurationProperty: typing.Optional[dict[str, CfnDataSource_ServiceNowKnowledgeArticleConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDataSource_ServiceNowServiceCatalogConfigurationProperty: typing.Optional[dict[str, CfnDataSource_ServiceNowServiceCatalogConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDataSource_SharePointConfigurationProperty: typing.Optional[dict[str, CfnDataSource_SharePointConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDataSource_SqlConfigurationProperty: typing.Optional[dict[str, CfnDataSource_SqlConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDataSource_TemplateConfigurationProperty: typing.Optional[dict[str, CfnDataSource_TemplateConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDataSource_WebCrawlerAuthenticationConfigurationProperty: typing.Optional[dict[str, CfnDataSource_WebCrawlerAuthenticationConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDataSource_WebCrawlerBasicAuthenticationProperty: typing.Optional[dict[str, CfnDataSource_WebCrawlerBasicAuthenticationPropertyDef]] = pydantic.Field(None)
    CfnDataSource_WebCrawlerConfigurationProperty: typing.Optional[dict[str, CfnDataSource_WebCrawlerConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDataSource_WebCrawlerSeedUrlConfigurationProperty: typing.Optional[dict[str, CfnDataSource_WebCrawlerSeedUrlConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDataSource_WebCrawlerSiteMapsConfigurationProperty: typing.Optional[dict[str, CfnDataSource_WebCrawlerSiteMapsConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDataSource_WebCrawlerUrlsProperty: typing.Optional[dict[str, CfnDataSource_WebCrawlerUrlsPropertyDef]] = pydantic.Field(None)
    CfnDataSource_WorkDocsConfigurationProperty: typing.Optional[dict[str, CfnDataSource_WorkDocsConfigurationPropertyDef]] = pydantic.Field(None)
    CfnFaq_S3PathProperty: typing.Optional[dict[str, CfnFaq_S3PathPropertyDef]] = pydantic.Field(None)
    CfnIndex_CapacityUnitsConfigurationProperty: typing.Optional[dict[str, CfnIndex_CapacityUnitsConfigurationPropertyDef]] = pydantic.Field(None)
    CfnIndex_DocumentMetadataConfigurationProperty: typing.Optional[dict[str, CfnIndex_DocumentMetadataConfigurationPropertyDef]] = pydantic.Field(None)
    CfnIndex_JsonTokenTypeConfigurationProperty: typing.Optional[dict[str, CfnIndex_JsonTokenTypeConfigurationPropertyDef]] = pydantic.Field(None)
    CfnIndex_JwtTokenTypeConfigurationProperty: typing.Optional[dict[str, CfnIndex_JwtTokenTypeConfigurationPropertyDef]] = pydantic.Field(None)
    CfnIndex_RelevanceProperty: typing.Optional[dict[str, CfnIndex_RelevancePropertyDef]] = pydantic.Field(None)
    CfnIndex_SearchProperty: typing.Optional[dict[str, CfnIndex_SearchPropertyDef]] = pydantic.Field(None)
    CfnIndex_ServerSideEncryptionConfigurationProperty: typing.Optional[dict[str, CfnIndex_ServerSideEncryptionConfigurationPropertyDef]] = pydantic.Field(None)
    CfnIndex_UserTokenConfigurationProperty: typing.Optional[dict[str, CfnIndex_UserTokenConfigurationPropertyDef]] = pydantic.Field(None)
    CfnIndex_ValueImportanceItemProperty: typing.Optional[dict[str, CfnIndex_ValueImportanceItemPropertyDef]] = pydantic.Field(None)
    CfnDataSource: typing.Optional[dict[str, CfnDataSourceDef]] = pydantic.Field(None)
    CfnFaq: typing.Optional[dict[str, CfnFaqDef]] = pydantic.Field(None)
    ...
    CfnFaqProps: typing.Optional[dict[str, CfnFaqPropsDef]] = pydantic.Field(None)
