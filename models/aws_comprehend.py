...
class CfnDocumentClassifierDef(BaseCfnResource):
    ...
    mode: typing.Optional[str] = pydantic.Field(None, description='Indicates the mode in which the classifier will be trained. The classifier can be trained in multi-class (single-label) mode or multi-label mode. Multi-class mode identifies a single class label for each document and multi-label mode identifies one or more class labels for each document. Multiple labels for an individual document are separated by a delimiter. The default delimiter between labels is a pipe (|).\n')
    model_config = pydantic.ConfigDict(protected_namespaces=())
    model_kms_key_id_: typing.Optional[str] = pydantic.Field(None, description='ID for the AWS KMS key that Amazon Comprehend uses to encrypt trained custom models. The ModelKmsKeyId can be either of the following formats: - KMS Key ID: ``"1234abcd-12ab-34cd-56ef-1234567890ab"`` - Amazon Resource Name (ARN) of a KMS Key: ``"arn:aws:kms:us-west-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab"``\n', alias='model_kms_key_id')
    model_config = pydantic.ConfigDict(protected_namespaces=())
    model_policy_: typing.Optional[str] = pydantic.Field(None, description='The resource-based policy to attach to your custom document classifier model. You can use this policy to allow another AWS account to import your custom model. Provide your policy as a JSON body that you enter as a UTF-8 encoded string without line breaks. To provide valid JSON, enclose the attribute names and values in double quotes. If the JSON body is also enclosed in double quotes, then you must escape the double quotes that are inside the policy: ``"{\\"attribute\\": \\"value\\", \\"attribute\\": [\\"value\\"]}"`` To avoid escaping quotes, you can use single quotes to enclose the policy and double quotes to enclose the JSON names and values: ``\'{"attribute": "value", "attribute": ["value"]}\'``\n', alias='model_policy')
    output_data_config_: typing.Union[models.UnsupportedResource, models.aws_comprehend.CfnDocumentClassifier_DocumentClassifierOutputDataConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Provides output results configuration parameters for custom classifier jobs.\n', alias='output_data_config')
    ...
    version_name_: typing.Optional[str] = pydantic.Field(None, description='The version name given to the newly created classifier. Version names can have a maximum of 256 characters. Alphanumeric characters, hyphens (-) and underscores (_) are allowed. The version name must be unique among all models with the same classifier name in the AWS account / AWS Region .\n', alias='version_name')
    volume_kms_key_id_: typing.Optional[str] = pydantic.Field(None, description='ID for the AWS Key Management Service (KMS) key that Amazon Comprehend uses to encrypt data on the storage volume attached to the ML compute instance(s) that process the analysis job. The VolumeKmsKeyId can be either of the following formats: - KMS Key ID: ``"1234abcd-12ab-34cd-56ef-1234567890ab"`` - Amazon Resource Name (ARN) of a KMS Key: ``"arn:aws:kms:us-west-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab"``\n', alias='volume_kms_key_id')
    vpc_config_: typing.Union[models.UnsupportedResource, models.aws_comprehend.CfnDocumentClassifier_VpcConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Configuration parameters for a private Virtual Private Cloud (VPC) containing the resources you are using for your custom classifier. For more information, see `Amazon VPC <https://docs.aws.amazon.com/vpc/latest/userguide/what-is-amazon-vpc.html>`_ .', alias='vpc_config')
    ...
    resource_config: typing.Optional[models.aws_comprehend.CfnDocumentClassifierDefConfig] = pydantic.Field(None)


class CfnDocumentClassifierDefConfig(pydantic.BaseModel):
    AugmentedManifestsListItemProperty: typing.Optional[list[models.aws_comprehend.CfnDocumentClassifierDefAugmentedmanifestslistitempropertyParams]] = pydantic.Field(None, description='')
    DocumentClassifierDocumentsProperty: typing.Optional[list[models.aws_comprehend.CfnDocumentClassifierDefDocumentclassifierdocumentspropertyParams]] = pydantic.Field(None, description='')
    DocumentClassifierInputDataConfigProperty: typing.Optional[list[models.aws_comprehend.CfnDocumentClassifierDefDocumentclassifierinputdataconfigpropertyParams]] = pydantic.Field(None, description='')
    DocumentClassifierOutputDataConfigProperty: typing.Optional[list[models.aws_comprehend.CfnDocumentClassifierDefDocumentclassifieroutputdataconfigpropertyParams]] = pydantic.Field(None, description='')
    DocumentReaderConfigProperty: typing.Optional[list[models.aws_comprehend.CfnDocumentClassifierDefDocumentreaderconfigpropertyParams]] = pydantic.Field(None, description='')
    VpcConfigProperty: typing.Optional[list[models.aws_comprehend.CfnDocumentClassifierDefVpcconfigpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_comprehend.CfnDocumentClassifierDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_comprehend.CfnDocumentClassifierDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_comprehend.CfnDocumentClassifierDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_comprehend.CfnDocumentClassifierDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_comprehend.CfnDocumentClassifierDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_comprehend.CfnDocumentClassifierDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_comprehend.CfnDocumentClassifierDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_comprehend.CfnDocumentClassifierDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_comprehend.CfnDocumentClassifierDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_comprehend.CfnDocumentClassifierDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_comprehend.CfnDocumentClassifierDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_comprehend.CfnDocumentClassifierDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_comprehend.CfnDocumentClassifierDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
class CfnFlywheelDef(BaseCfnResource):
    ...
    model_config = pydantic.ConfigDict(protected_namespaces=())
    model_type_: typing.Optional[str] = pydantic.Field(None, description="Model type of the flywheel's model.\n", alias='model_type')
    ...
    task_config_: typing.Union[models.UnsupportedResource, models.aws_comprehend.CfnFlywheel_TaskConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Configuration about the model associated with a flywheel.', alias='task_config')
    ...
    resource_config: typing.Optional[models.aws_comprehend.CfnFlywheelDefConfig] = pydantic.Field(None)


class CfnFlywheelDefConfig(pydantic.BaseModel):
    DataSecurityConfigProperty: typing.Optional[list[models.aws_comprehend.CfnFlywheelDefDatasecurityconfigpropertyParams]] = pydantic.Field(None, description='')
    DocumentClassificationConfigProperty: typing.Optional[list[models.aws_comprehend.CfnFlywheelDefDocumentclassificationconfigpropertyParams]] = pydantic.Field(None, description='')
    EntityRecognitionConfigProperty: typing.Optional[list[models.aws_comprehend.CfnFlywheelDefEntityrecognitionconfigpropertyParams]] = pydantic.Field(None, description='')
    EntityTypesListItemProperty: typing.Optional[list[models.aws_comprehend.CfnFlywheelDefEntitytypeslistitempropertyParams]] = pydantic.Field(None, description='')
    TaskConfigProperty: typing.Optional[list[models.aws_comprehend.CfnFlywheelDefTaskconfigpropertyParams]] = pydantic.Field(None, description='')
    VpcConfigProperty: typing.Optional[list[models.aws_comprehend.CfnFlywheelDefVpcconfigpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_comprehend.CfnFlywheelDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_comprehend.CfnFlywheelDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_comprehend.CfnFlywheelDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_comprehend.CfnFlywheelDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_comprehend.CfnFlywheelDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_comprehend.CfnFlywheelDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_comprehend.CfnFlywheelDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_comprehend.CfnFlywheelDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_comprehend.CfnFlywheelDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_comprehend.CfnFlywheelDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_comprehend.CfnFlywheelDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_comprehend.CfnFlywheelDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_comprehend.CfnFlywheelDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
class CfnFlywheelDefDatasecurityconfigpropertyParams(pydantic.BaseModel):
    ...
    model_config = pydantic.ConfigDict(protected_namespaces=())
    model_kms_key_id_: typing.Optional[str] = pydantic.Field(None, description='', alias='model_kms_key_id')
...
class ModuleModel(pydantic.BaseModel):
    CfnDocumentClassifier_AugmentedManifestsListItemProperty: typing.Optional[dict[str, models.aws_comprehend.CfnDocumentClassifier_AugmentedManifestsListItemPropertyDef]] = pydantic.Field(None)
    CfnDocumentClassifier_DocumentClassifierDocumentsProperty: typing.Optional[dict[str, models.aws_comprehend.CfnDocumentClassifier_DocumentClassifierDocumentsPropertyDef]] = pydantic.Field(None)
    CfnDocumentClassifier_DocumentClassifierInputDataConfigProperty: typing.Optional[dict[str, models.aws_comprehend.CfnDocumentClassifier_DocumentClassifierInputDataConfigPropertyDef]] = pydantic.Field(None)
    CfnDocumentClassifier_DocumentClassifierOutputDataConfigProperty: typing.Optional[dict[str, models.aws_comprehend.CfnDocumentClassifier_DocumentClassifierOutputDataConfigPropertyDef]] = pydantic.Field(None)
    CfnDocumentClassifier_DocumentReaderConfigProperty: typing.Optional[dict[str, models.aws_comprehend.CfnDocumentClassifier_DocumentReaderConfigPropertyDef]] = pydantic.Field(None)
    CfnDocumentClassifier_VpcConfigProperty: typing.Optional[dict[str, models.aws_comprehend.CfnDocumentClassifier_VpcConfigPropertyDef]] = pydantic.Field(None)
    CfnFlywheel_DataSecurityConfigProperty: typing.Optional[dict[str, models.aws_comprehend.CfnFlywheel_DataSecurityConfigPropertyDef]] = pydantic.Field(None)
    CfnFlywheel_DocumentClassificationConfigProperty: typing.Optional[dict[str, models.aws_comprehend.CfnFlywheel_DocumentClassificationConfigPropertyDef]] = pydantic.Field(None)
    CfnFlywheel_EntityRecognitionConfigProperty: typing.Optional[dict[str, models.aws_comprehend.CfnFlywheel_EntityRecognitionConfigPropertyDef]] = pydantic.Field(None)
    CfnFlywheel_EntityTypesListItemProperty: typing.Optional[dict[str, models.aws_comprehend.CfnFlywheel_EntityTypesListItemPropertyDef]] = pydantic.Field(None)
    CfnFlywheel_TaskConfigProperty: typing.Optional[dict[str, models.aws_comprehend.CfnFlywheel_TaskConfigPropertyDef]] = pydantic.Field(None)
    CfnFlywheel_VpcConfigProperty: typing.Optional[dict[str, models.aws_comprehend.CfnFlywheel_VpcConfigPropertyDef]] = pydantic.Field(None)
    CfnDocumentClassifier: typing.Optional[dict[str, models.aws_comprehend.CfnDocumentClassifierDef]] = pydantic.Field(None)
    CfnFlywheel: typing.Optional[dict[str, models.aws_comprehend.CfnFlywheelDef]] = pydantic.Field(None)
    CfnDocumentClassifierProps: typing.Optional[dict[str, models.aws_comprehend.CfnDocumentClassifierPropsDef]] = pydantic.Field(None)
    CfnFlywheelProps: typing.Optional[dict[str, models.aws_comprehend.CfnFlywheelPropsDef]] = pydantic.Field(None)
    ...
