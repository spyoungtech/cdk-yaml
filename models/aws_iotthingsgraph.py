...
class CfnFlowTemplateDef(BaseCfnResource):
    definition: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotthingsgraph.CfnFlowTemplate_DefinitionDocumentPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='``AWS::IoTThingsGraph::FlowTemplate.Definition``.\n')
    compatible_namespace_version: typing.Union[int, float, None] = pydantic.Field(None, description='``AWS::IoTThingsGraph::FlowTemplate.CompatibleNamespaceVersion``.')
