...
class CfnDatabaseDef(BaseCfnResource):
    ...
    backup_retention: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='A Boolean value indicating whether automated backup retention is enabled for the database.\n')
