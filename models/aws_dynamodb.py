...
#  autogenerated from aws_cdk.aws_dynamodb.InputFormat
class InputFormatDef(BaseClass):
    _init_params: typing.ClassVar[list[str]] = []
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = ['csv', 'dynamo_db_json', 'ion']
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_dynamodb.InputFormat'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...


    resource_config: typing.Optional[models.aws_dynamodb.InputFormatDefConfig] = pydantic.Field(None)


class InputFormatDefConfig(pydantic.BaseModel):
    csv: typing.Optional[list[models.aws_dynamodb.InputFormatDefCsvParams]] = pydantic.Field(None, description='CSV format.')
    dynamo_db_json: typing.Optional[list[models.aws_dynamodb.InputFormatDefDynamoDbJsonParams]] = pydantic.Field(None, description='DynamoDB JSON format.')
    ion: typing.Optional[list[models.aws_dynamodb.InputFormatDefIonParams]] = pydantic.Field(None, description='Amazon Ion format.')

class InputFormatDefCsvParams(pydantic.BaseModel):
    delimiter: typing.Optional[str] = pydantic.Field(None, description='The delimiter used for separating items in the CSV file being imported. Valid delimiters are as follows: - comma (``,``) - tab (``\\t``) - colon (``:``) - semicolon (``;``) - pipe (``|``) - space (`` ``) Default: - use comma as a delimiter.\n')
    header_list: typing.Optional[typing.Sequence[str]] = pydantic.Field(None, description='List of the headers used to specify a common header for all source CSV files being imported. **NOTE**: If this field is specified then the first line of each CSV file is treated as data instead of the header. If this field is not specified the the first line of each CSV file is treated as the header. Default: - the first line of the CSV file is treated as the header')
    return_config: typing.Optional[list[models.aws_dynamodb.InputFormatDefConfig]] = pydantic.Field(None)
    ...

class InputFormatDefDynamoDbJsonParams(pydantic.BaseModel):
    return_config: typing.Optional[list[models.aws_dynamodb.InputFormatDefConfig]] = pydantic.Field(None)
    ...

class InputFormatDefIonParams(pydantic.BaseModel):
    return_config: typing.Optional[list[models.aws_dynamodb.InputFormatDefConfig]] = pydantic.Field(None)
    ...
...
class TableBaseDefConfig(pydantic.BaseModel):
    add_to_resource_policy: typing.Optional[list[models.aws_dynamodb.TableBaseDefAddToResourcePolicyParams]] = pydantic.Field(None, description='Adds a statement to the resource policy associated with this file system.\nA resource policy will be automatically created upon the first call to ``addToResourcePolicy``.\n\nNote that this does not work with imported file systems.')
...
class TableBaseDefAddToResourcePolicyParams(pydantic.BaseModel):
...
class TableBaseV2DefConfig(pydantic.BaseModel):
    add_to_resource_policy: typing.Optional[list[models.aws_dynamodb.TableBaseV2DefAddToResourcePolicyParams]] = pydantic.Field(None, description='Adds a statement to the resource policy associated with this file system.\nA resource policy will be automatically created upon the first call to ``addToResourcePolicy``.\n\nNote that this does not work with imported file systems.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
...
class TableBaseV2DefAddToResourcePolicyParams(pydantic.BaseModel):
    statement: models.aws_iam.PolicyStatementDef = pydantic.Field(..., description='The policy statement to add.')
    ...
...
class TableDef(BaseConstruct):
    ...
    import_source: typing.Union[models.aws_dynamodb.ImportSourceSpecificationDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The properties of data being imported from the S3 bucket source to the table. Default: - no data import from the S3 bucket\n')
    ...
    resource_policy: typing.Optional[models.aws_iam.PolicyDocumentDef] = pydantic.Field(None, description='Resource policy to assign to table. Default: - No resource policy statement\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['kinesis_stream', 'table_name', 'billing_mode', 'contributor_insights_enabled', 'deletion_protection', 'encryption', 'encryption_key', 'import_source', 'point_in_time_recovery', 'read_capacity', 'removal_policy', 'replication_regions', 'replication_timeout', 'resource_policy', 'stream', 'table_class', 'time_to_live_attribute', 'wait_for_replication_to_finish', 'write_capacity', 'partition_key', 'sort_key']
    _method_names: typing.ClassVar[list[str]] = ['add_global_secondary_index', 'add_local_secondary_index', 'add_to_resource_policy', 'apply_removal_policy', 'auto_scale_global_secondary_index_read_capacity', 'auto_scale_global_secondary_index_write_capacity', 'auto_scale_read_capacity', 'auto_scale_write_capacity', 'grant', 'grant_full_access', 'grant_read_data', 'grant_read_write_data', 'grant_stream', 'grant_stream_read', 'grant_table_list_streams', 'grant_write_data', 'metric', 'metric_conditional_check_failed_requests', 'metric_consumed_read_capacity_units', 'metric_consumed_write_capacity_units', 'metric_successful_request_latency', 'metric_system_errors', 'metric_system_errors_for_operations', 'metric_throttled_requests', 'metric_throttled_requests_for_operation', 'metric_throttled_requests_for_operations', 'metric_user_errors', 'schema']
...
class TableDefConfig(pydantic.BaseModel):
    ...
    add_to_resource_policy: typing.Optional[list[models.aws_dynamodb.TableDefAddToResourcePolicyParams]] = pydantic.Field(None, description='Adds a statement to the resource policy associated with this file system.\nA resource policy will be automatically created upon the first call to ``addToResourcePolicy``.\n\nNote that this does not work with imported file systems.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
...
class TableDefAddToResourcePolicyParams(pydantic.BaseModel):
    statement: models.aws_iam.PolicyStatementDef = pydantic.Field(..., description='The policy statement to add.')
    ...
...
class TableV2Def(BaseConstruct):
    ...
    resource_policy: typing.Optional[models.aws_iam.PolicyDocumentDef] = pydantic.Field(None, description='Resource policy to assign to DynamoDB Table. Default: - No resource policy statements are added to the created table.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['partition_key', 'billing', 'dynamo_stream', 'encryption', 'global_secondary_indexes', 'local_secondary_indexes', 'removal_policy', 'replicas', 'sort_key', 'table_name', 'time_to_live_attribute', 'contributor_insights', 'deletion_protection', 'kinesis_stream', 'point_in_time_recovery', 'resource_policy', 'table_class', 'tags']
    _method_names: typing.ClassVar[list[str]] = ['add_global_secondary_index', 'add_local_secondary_index', 'add_replica', 'add_to_resource_policy', 'apply_removal_policy', 'grant', 'grant_full_access', 'grant_read_data', 'grant_read_write_data', 'grant_stream', 'grant_stream_read', 'grant_table_list_streams', 'grant_write_data', 'metric', 'metric_conditional_check_failed_requests', 'metric_consumed_read_capacity_units', 'metric_consumed_write_capacity_units', 'metric_successful_request_latency', 'metric_system_errors', 'metric_system_errors_for_operations', 'metric_throttled_requests', 'metric_throttled_requests_for_operation', 'metric_throttled_requests_for_operations', 'metric_user_errors', 'replica']
    _classmethod_names: typing.ClassVar[list[str]] = ['from_table_arn', 'from_table_attributes', 'from_table_name']
...
class TableV2DefConfig(pydantic.BaseModel):
    ...
    add_to_resource_policy: typing.Optional[list[models.aws_dynamodb.TableV2DefAddToResourcePolicyParams]] = pydantic.Field(None, description='Adds a statement to the resource policy associated with this file system.\nA resource policy will be automatically created upon the first call to ``addToResourcePolicy``.\n\nNote that this does not work with imported file systems.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
...
class TableV2DefAddToResourcePolicyParams(pydantic.BaseModel):
    statement: models.aws_iam.PolicyStatementDef = pydantic.Field(..., description='The policy statement to add.')
    ...
...
class CfnGlobalTable_GlobalSecondaryIndexPropertyDef(BaseStruct):
    ...
    write_on_demand_throughput_settings: typing.Union[models.UnsupportedResource, models.aws_dynamodb.CfnGlobalTable_WriteOnDemandThroughputSettingsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Sets the write request settings for a global table or a global secondary index. You must specify this setting if you set the ``BillingMode`` to ``PAY_PER_REQUEST`` .\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['index_name', 'key_schema', 'projection', 'write_on_demand_throughput_settings', 'write_provisioned_throughput_settings']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
#  autogenerated from aws_cdk.aws_dynamodb.CfnGlobalTable.ReadOnDemandThroughputSettingsProperty
class CfnGlobalTable_ReadOnDemandThroughputSettingsPropertyDef(BaseStruct):
    max_read_request_units: typing.Union[int, float, None] = pydantic.Field(None, description='Maximum number of read request units for the specified replica of a global table.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dynamodb-globaltable-readondemandthroughputsettings.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_dynamodb as dynamodb\n\n    read_on_demand_throughput_settings_property = dynamodb.CfnGlobalTable.ReadOnDemandThroughputSettingsProperty(\n        max_read_request_units=123\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['max_read_request_units']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_dynamodb.CfnGlobalTable.ReadOnDemandThroughputSettingsProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class CfnGlobalTable_ReplicaGlobalSecondaryIndexSpecificationPropertyDef(BaseStruct):
    ...
    read_on_demand_throughput_settings: typing.Union[models.UnsupportedResource, models.aws_dynamodb.CfnGlobalTable_ReadOnDemandThroughputSettingsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Sets the read request settings for a replica global secondary index. You must specify this setting if you set the ``BillingMode`` to ``PAY_PER_REQUEST`` .\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['index_name', 'contributor_insights_specification', 'read_on_demand_throughput_settings', 'read_provisioned_throughput_settings']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnGlobalTable_ReplicaSpecificationPropertyDef(BaseStruct):
    ...
    read_on_demand_throughput_settings: typing.Union[models.UnsupportedResource, models.aws_dynamodb.CfnGlobalTable_ReadOnDemandThroughputSettingsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Sets read request settings for the replica table.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['region', 'contributor_insights_specification', 'deletion_protection_enabled', 'global_secondary_indexes', 'kinesis_stream_specification', 'point_in_time_recovery_specification', 'read_on_demand_throughput_settings', 'read_provisioned_throughput_settings', 'replica_stream_specification', 'resource_policy', 'sse_specification', 'table_class', 'tags']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
#  autogenerated from aws_cdk.aws_dynamodb.CfnGlobalTable.ReplicaStreamSpecificationProperty
class CfnGlobalTable_ReplicaStreamSpecificationPropertyDef(BaseStruct):
    resource_policy: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_dynamodb.CfnGlobalTable_ResourcePolicyPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description="A resource-based policy document that contains the permissions for the specified stream of a DynamoDB global table replica. Resource-based policies let you define access permissions by specifying who has access to each resource, and the actions they are allowed to perform on each resource. In a CloudFormation template, you can provide the policy in JSON or YAML format because CloudFormation converts YAML to JSON before submitting it to DynamoDB . For more information about resource-based policies, see `Using resource-based policies for DynamoDB <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/access-control-resource-based.html>`_ and `Resource-based policy examples <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/rbac-examples.html>`_ . You can update the ``ResourcePolicy`` property if you've specified more than one table using the `AWS ::DynamoDB::GlobalTable <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-dynamodb-globaltable.html>`_ resource.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dynamodb-globaltable-replicastreamspecification.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_dynamodb as dynamodb\n\n    # policy_document: Any\n\n    replica_stream_specification_property = dynamodb.CfnGlobalTable.ReplicaStreamSpecificationProperty(\n        resource_policy=dynamodb.CfnGlobalTable.ResourcePolicyProperty(\n            policy_document=policy_document\n        )\n    )\n")
    _init_params: typing.ClassVar[list[str]] = ['resource_policy']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_dynamodb.CfnGlobalTable.ReplicaStreamSpecificationProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
#  autogenerated from aws_cdk.aws_dynamodb.CfnGlobalTable.WriteOnDemandThroughputSettingsProperty
class CfnGlobalTable_WriteOnDemandThroughputSettingsPropertyDef(BaseStruct):
    max_write_request_units: typing.Union[int, float, None] = pydantic.Field(None, description='Maximum number of write request settings for the specified replica of a global table.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dynamodb-globaltable-writeondemandthroughputsettings.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_dynamodb as dynamodb\n\n    write_on_demand_throughput_settings_property = dynamodb.CfnGlobalTable.WriteOnDemandThroughputSettingsProperty(\n        max_write_request_units=123\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['max_write_request_units']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_dynamodb.CfnGlobalTable.WriteOnDemandThroughputSettingsProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class CfnTable_GlobalSecondaryIndexPropertyDef(BaseStruct):
    ...
    on_demand_throughput: typing.Union[models.UnsupportedResource, models.aws_dynamodb.CfnTable_OnDemandThroughputPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The maximum number of read and write units for the specified global secondary index. If you use this parameter, you must specify ``MaxReadRequestUnits`` , ``MaxWriteRequestUnits`` , or both.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['index_name', 'key_schema', 'projection', 'contributor_insights_specification', 'on_demand_throughput', 'provisioned_throughput']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
#  autogenerated from aws_cdk.aws_dynamodb.CfnTable.OnDemandThroughputProperty
class CfnTable_OnDemandThroughputPropertyDef(BaseStruct):
    max_read_request_units: typing.Union[int, float, None] = pydantic.Field(None, description='Maximum number of read request units for the specified table. To specify a maximum ``OnDemandThroughput`` on your table, set the value of ``MaxReadRequestUnits`` as greater than or equal to 1. To remove the maximum ``OnDemandThroughput`` that is currently set on your table, set the value of ``MaxReadRequestUnits`` to -1.\n')
    max_write_request_units: typing.Union[int, float, None] = pydantic.Field(None, description='Maximum number of write request units for the specified table. To specify a maximum ``OnDemandThroughput`` on your table, set the value of ``MaxWriteRequestUnits`` as greater than or equal to 1. To remove the maximum ``OnDemandThroughput`` that is currently set on your table, set the value of ``MaxWriteRequestUnits`` to -1.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dynamodb-table-ondemandthroughput.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_dynamodb as dynamodb\n\n    on_demand_throughput_property = dynamodb.CfnTable.OnDemandThroughputProperty(\n        max_read_request_units=123,\n        max_write_request_units=123\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['max_read_request_units', 'max_write_request_units']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_dynamodb.CfnTable.OnDemandThroughputProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
#  autogenerated from aws_cdk.aws_dynamodb.CfnTable.ResourcePolicyProperty
class CfnTable_ResourcePolicyPropertyDef(BaseStruct):
    ...
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_dynamodb.CfnTable.ResourcePolicyProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
#  autogenerated from aws_cdk.aws_dynamodb.CsvOptions
class CsvOptionsDef(BaseStruct):
    delimiter: typing.Optional[str] = pydantic.Field(None, description='The delimiter used for separating items in the CSV file being imported. Valid delimiters are as follows: - comma (``,``) - tab (``\\t``) - colon (``:``) - semicolon (``;``) - pipe (``|``) - space (`` ``) Default: - use comma as a delimiter.\n')
    ...
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_dynamodb.CsvOptions'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
#  autogenerated from aws_cdk.aws_dynamodb.ImportSourceSpecification
class ImportSourceSpecificationDef(BaseStruct):
    bucket: typing.Union[_REQUIRED_INIT_PARAM, models.aws_s3.BucketBaseDef, models.aws_s3.BucketDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The S3 bucket that is being imported from.\n')
    input_format: typing.Union[models.aws_dynamodb.InputFormatDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The format of the imported data.\n')
    bucket_owner: typing.Optional[str] = pydantic.Field(None, description='The account number of the S3 bucket that is being imported from. Default: - no value\n')
    compression_type: typing.Optional[aws_cdk.aws_dynamodb.InputCompressionType] = pydantic.Field(None, description='The compression type of the imported data. Default: InputCompressionType.NONE\n')
    key_prefix: typing.Optional[str] = pydantic.Field(None, description='The key prefix shared by all S3 Objects that are being imported. Default: - no value\n\n:exampleMetadata: infused\n\nExample::\n\n    import aws_cdk as cdk\n    import aws_cdk.aws_s3 as s3\n\n    # bucket: s3.IBucket\n\n\n    app = cdk.App()\n    stack = cdk.Stack(app, "Stack")\n\n    dynamodb.Table(stack, "Table",\n        partition_key=dynamodb.Attribute(\n            name="id",\n            type=dynamodb.AttributeType.STRING\n        ),\n        import_source=dynamodb.ImportSourceSpecification(\n            compression_type=dynamodb.InputCompressionType.GZIP,\n            input_format=dynamodb.InputFormat.dynamo_dBJson(),\n            bucket=bucket,\n            key_prefix="prefix"\n        )\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['bucket', 'input_format', 'bucket_owner', 'compression_type', 'key_prefix']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_dynamodb.ImportSourceSpecification'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...


    resource_config: typing.Optional[models.aws_dynamodb.ImportSourceSpecificationDefConfig] = pydantic.Field(None)


class ImportSourceSpecificationDefConfig(pydantic.BaseModel):
...
class ReplicaTablePropsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['contributor_insights', 'deletion_protection', 'kinesis_stream', 'point_in_time_recovery', 'resource_policy', 'table_class', 'tags', 'region', 'global_secondary_index_options', 'read_capacity']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class TableOptionsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['partition_key', 'sort_key', 'billing_mode', 'contributor_insights_enabled', 'deletion_protection', 'encryption', 'encryption_key', 'import_source', 'point_in_time_recovery', 'read_capacity', 'removal_policy', 'replication_regions', 'replication_timeout', 'resource_policy', 'stream', 'table_class', 'time_to_live_attribute', 'wait_for_replication_to_finish', 'write_capacity']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class TableOptionsV2Def(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['contributor_insights', 'deletion_protection', 'kinesis_stream', 'point_in_time_recovery', 'resource_policy', 'table_class', 'tags']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class TablePropsV2Def(BaseStruct):
    ...
    table_name: typing.Optional[str] = pydantic.Field(None, description='The name of the table. Default: - generated by CloudFormation\n')
    time_to_live_attribute: typing.Optional[str] = pydantic.Field(None, description='The name of the TTL attribute. Default: - TTL is disabled\n\n:exampleMetadata: infused\n\nExample::\n\n    import aws_cdk as cdk\n\n\n    app = cdk.App()\n    stack = cdk.Stack(app, "Stack", env=cdk.Environment(region="us-west-2"))\n\n    global_table = dynamodb.TableV2(stack, "GlobalTable",\n        partition_key=dynamodb.Attribute(name="pk", type=dynamodb.AttributeType.STRING),\n        # applys to all replicas, i.e., us-west-2, us-east-1, us-east-2\n        removal_policy=cdk.RemovalPolicy.DESTROY,\n        replicas=[dynamodb.ReplicaTableProps(region="us-east-1"), dynamodb.ReplicaTableProps(region="us-east-2")\n        ]\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['contributor_insights', 'deletion_protection', 'kinesis_stream', 'point_in_time_recovery', 'resource_policy', 'table_class', 'tags', 'partition_key', 'billing', 'dynamo_stream', 'encryption', 'global_secondary_indexes', 'local_secondary_indexes', 'removal_policy', 'replicas', 'sort_key', 'table_name', 'time_to_live_attribute']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
#  autogenerated from aws_cdk.aws_dynamodb.InputCompressionType
# skipping emum
...
class CfnGlobalTableDef(BaseCfnResource):
    ...
    _init_params: typing.ClassVar[list[str]] = ['attribute_definitions', 'key_schema', 'replicas', 'billing_mode', 'global_secondary_indexes', 'local_secondary_indexes', 'sse_specification', 'stream_specification', 'table_name', 'time_to_live_specification', 'write_on_demand_throughput_settings', 'write_provisioned_throughput_settings']
    _method_names: typing.ClassVar[list[str]] = ['AttributeDefinitionProperty', 'CapacityAutoScalingSettingsProperty', 'ContributorInsightsSpecificationProperty', 'GlobalSecondaryIndexProperty', 'KeySchemaProperty', 'KinesisStreamSpecificationProperty', 'LocalSecondaryIndexProperty', 'PointInTimeRecoverySpecificationProperty', 'ProjectionProperty', 'ReadOnDemandThroughputSettingsProperty', 'ReadProvisionedThroughputSettingsProperty', 'ReplicaGlobalSecondaryIndexSpecificationProperty', 'ReplicaSSESpecificationProperty', 'ReplicaSpecificationProperty', 'ReplicaStreamSpecificationProperty', 'ResourcePolicyProperty', 'SSESpecificationProperty', 'StreamSpecificationProperty', 'TargetTrackingScalingPolicyConfigurationProperty', 'TimeToLiveSpecificationProperty', 'WriteOnDemandThroughputSettingsProperty', 'WriteProvisionedThroughputSettingsProperty', 'add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnGlobalTableDefConfig(pydantic.BaseModel):
    ...
    ReadOnDemandThroughputSettingsProperty: typing.Optional[list[models.aws_dynamodb.CfnGlobalTableDefReadondemandthroughputsettingspropertyParams]] = pydantic.Field(None, description='')
    ...
    ReplicaStreamSpecificationProperty: typing.Optional[list[models.aws_dynamodb.CfnGlobalTableDefReplicastreamspecificationpropertyParams]] = pydantic.Field(None, description='')
    ResourcePolicyProperty: typing.Optional[list[models.aws_dynamodb.CfnGlobalTableDefResourcepolicypropertyParams]] = pydantic.Field(None, description='')
    ...
    WriteOnDemandThroughputSettingsProperty: typing.Optional[list[models.aws_dynamodb.CfnGlobalTableDefWriteondemandthroughputsettingspropertyParams]] = pydantic.Field(None, description='')
...
class CfnGlobalTableDefGlobalsecondaryindexpropertyParams(pydantic.BaseModel):
    ...
    write_on_demand_throughput_settings: typing.Union[models.UnsupportedResource, models.aws_dynamodb.CfnGlobalTable_WriteOnDemandThroughputSettingsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
...
class CfnGlobalTableDefKinesisstreamspecificationpropertyParams(pydantic.BaseModel):
    ...
    approximate_creation_date_time_precision: typing.Optional[str] = pydantic.Field(None, description='')
    ...
...
class CfnGlobalTableDefReadondemandthroughputsettingspropertyParams(pydantic.BaseModel):
    max_read_request_units: typing.Union[int, float, None] = pydantic.Field(None, description='')
    ...
...
class CfnGlobalTableDefReplicaglobalsecondaryindexspecificationpropertyParams(pydantic.BaseModel):
    ...
    read_on_demand_throughput_settings: typing.Union[models.UnsupportedResource, models.aws_dynamodb.CfnGlobalTable_ReadOnDemandThroughputSettingsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
...
class CfnGlobalTableDefReplicaspecificationpropertyParams(pydantic.BaseModel):
    ...
    read_on_demand_throughput_settings: typing.Union[models.UnsupportedResource, models.aws_dynamodb.CfnGlobalTable_ReadOnDemandThroughputSettingsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    read_provisioned_throughput_settings: typing.Union[models.UnsupportedResource, models.aws_dynamodb.CfnGlobalTable_ReadProvisionedThroughputSettingsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    replica_stream_specification: typing.Union[models.UnsupportedResource, models.aws_dynamodb.CfnGlobalTable_ReplicaStreamSpecificationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    resource_policy: typing.Union[models.UnsupportedResource, models.aws_dynamodb.CfnGlobalTable_ResourcePolicyPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
...
class CfnGlobalTableDefReplicastreamspecificationpropertyParams(pydantic.BaseModel):
    resource_policy: typing.Union[models.UnsupportedResource, models.aws_dynamodb.CfnGlobalTable_ResourcePolicyPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    ...

class CfnGlobalTableDefResourcepolicypropertyParams(pydantic.BaseModel):
...
class CfnGlobalTableDefWriteondemandthroughputsettingspropertyParams(pydantic.BaseModel):
    max_write_request_units: typing.Union[int, float, None] = pydantic.Field(None, description='')
    ...
...
class CfnTableDefConfig(pydantic.BaseModel):
    ...
    OnDemandThroughputProperty: typing.Optional[list[models.aws_dynamodb.CfnTableDefOndemandthroughputpropertyParams]] = pydantic.Field(None, description='')
    ...
    ResourcePolicyProperty: typing.Optional[list[models.aws_dynamodb.CfnTableDefResourcepolicypropertyParams]] = pydantic.Field(None, description='')
...
class CfnTableDefGlobalsecondaryindexpropertyParams(pydantic.BaseModel):
    ...
    on_demand_throughput: typing.Union[models.UnsupportedResource, models.aws_dynamodb.CfnTable_OnDemandThroughputPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
...
class CfnTableDefOndemandthroughputpropertyParams(pydantic.BaseModel):
    max_read_request_units: typing.Union[int, float, None] = pydantic.Field(None, description='')
    max_write_request_units: typing.Union[int, float, None] = pydantic.Field(None, description='')
    ...
...
class CfnTableDefResourcepolicypropertyParams(pydantic.BaseModel):
    policy_document: typing.Any = pydantic.Field(..., description='')
    ...
...
class CfnTableDefStreamspecificationpropertyParams(pydantic.BaseModel):
    stream_view_type: str = pydantic.Field(..., description='')
    resource_policy: typing.Union[models.UnsupportedResource, models.aws_dynamodb.CfnTable_ResourcePolicyPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class ModuleModel(pydantic.BaseModel):
    ...
    InputFormat: typing.Optional[dict[str, models.aws_dynamodb.InputFormatDef]] = pydantic.Field(None)
    ...
    CfnGlobalTable_ReadOnDemandThroughputSettingsProperty: typing.Optional[dict[str, models.aws_dynamodb.CfnGlobalTable_ReadOnDemandThroughputSettingsPropertyDef]] = pydantic.Field(None)
    ...
    CfnGlobalTable_ReplicaStreamSpecificationProperty: typing.Optional[dict[str, models.aws_dynamodb.CfnGlobalTable_ReplicaStreamSpecificationPropertyDef]] = pydantic.Field(None)
    CfnGlobalTable_ResourcePolicyProperty: typing.Optional[dict[str, models.aws_dynamodb.CfnGlobalTable_ResourcePolicyPropertyDef]] = pydantic.Field(None)
    ...
    CfnGlobalTable_WriteOnDemandThroughputSettingsProperty: typing.Optional[dict[str, models.aws_dynamodb.CfnGlobalTable_WriteOnDemandThroughputSettingsPropertyDef]] = pydantic.Field(None)
    ...
    CfnTable_OnDemandThroughputProperty: typing.Optional[dict[str, models.aws_dynamodb.CfnTable_OnDemandThroughputPropertyDef]] = pydantic.Field(None)
    ...
    CfnTable_ResourcePolicyProperty: typing.Optional[dict[str, models.aws_dynamodb.CfnTable_ResourcePolicyPropertyDef]] = pydantic.Field(None)
    ...
    CsvOptions: typing.Optional[dict[str, models.aws_dynamodb.CsvOptionsDef]] = pydantic.Field(None)
    ...
    ImportSourceSpecification: typing.Optional[dict[str, models.aws_dynamodb.ImportSourceSpecificationDef]] = pydantic.Field(None)
