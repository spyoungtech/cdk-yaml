...
class BillingDef(BaseClass):
    ...
    resource_config: typing.Optional[BillingDefConfig] = pydantic.Field(None)


class BillingDefConfig(pydantic.BaseModel):
    on_demand: typing.Optional[list[BillingDefOnDemandParams]] = pydantic.Field(None, description='Flexible billing option capable of serving requests without capacity planning.\nNote: Billing mode will be PAY_PER_REQUEST.')
    provisioned: typing.Optional[list[BillingDefProvisionedParams]] = pydantic.Field(None, description='Specify the number of reads and writes per second that you need for your application.')
...
class CapacityDef(BaseClass):
    ...
    resource_config: typing.Optional[CapacityDefConfig] = pydantic.Field(None)


class CapacityDefConfig(pydantic.BaseModel):
    autoscaled: typing.Optional[list[CapacityDefAutoscaledParams]] = pydantic.Field(None, description='Dynamically adjusts provisioned throughput capacity on your behalf in response to actual traffic patterns.')
    fixed: typing.Optional[list[CapacityDefFixedParams]] = pydantic.Field(None, description='Provisioned throughput capacity is configured with fixed capacity units.\nNote: You cannot configure write capacity using fixed capacity mode.')
...
class TableBaseDef(BaseClass):
    ...
    resource_config: typing.Optional[TableBaseDefConfig] = pydantic.Field(None)


class TableBaseDefConfig(pydantic.BaseModel):
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    grant: typing.Optional[list[TableBaseDefGrantParams]] = pydantic.Field(None, description="Adds an IAM policy statement associated with this table to an IAM principal's policy.\nIf ``encryptionKey`` is present, appropriate grants to the key needs to be added\nseparately using the ``table.encryptionKey.grant*`` methods.")
    grant_full_access: typing.Optional[list[TableBaseDefGrantFullAccessParams]] = pydantic.Field(None, description='Permits all DynamoDB operations ("dynamodb:*") to an IAM principal.\nAppropriate grants will also be added to the customer-managed KMS key\nif one was configured.')
    grant_read_data: typing.Optional[list[TableBaseDefGrantReadDataParams]] = pydantic.Field(None, description='Permits an IAM principal all data read operations from this table: BatchGetItem, GetRecords, GetShardIterator, Query, GetItem, Scan, DescribeTable.\nAppropriate grants will also be added to the customer-managed KMS key\nif one was configured.')
    grant_read_write_data: typing.Optional[list[TableBaseDefGrantReadWriteDataParams]] = pydantic.Field(None, description='Permits an IAM principal to all data read/write operations to this table.\nBatchGetItem, GetRecords, GetShardIterator, Query, GetItem, Scan,\nBatchWriteItem, PutItem, UpdateItem, DeleteItem, DescribeTable\n\nAppropriate grants will also be added to the customer-managed KMS key\nif one was configured.')
    grant_stream: typing.Optional[list[TableBaseDefGrantStreamParams]] = pydantic.Field(None, description="Adds an IAM policy statement associated with this table's stream to an IAM principal's policy.\nIf ``encryptionKey`` is present, appropriate grants to the key needs to be added\nseparately using the ``table.encryptionKey.grant*`` methods.")
    grant_stream_read: typing.Optional[list[TableBaseDefGrantStreamReadParams]] = pydantic.Field(None, description="Permits an IAM principal all stream data read operations for this table's stream: DescribeStream, GetRecords, GetShardIterator, ListStreams.\nAppropriate grants will also be added to the customer-managed KMS key\nif one was configured.")
    grant_table_list_streams: typing.Optional[list[TableBaseDefGrantTableListStreamsParams]] = pydantic.Field(None, description='Permits an IAM Principal to list streams attached to current dynamodb table.')
    grant_write_data: typing.Optional[list[TableBaseDefGrantWriteDataParams]] = pydantic.Field(None, description='Permits an IAM principal all data write operations to this table: BatchWriteItem, PutItem, UpdateItem, DeleteItem, DescribeTable.\nAppropriate grants will also be added to the customer-managed KMS key\nif one was configured.')
    metric: typing.Optional[list[TableBaseDefMetricParams]] = pydantic.Field(None, description='Return the given named metric for this Table.\nBy default, the metric will be calculated as a sum over a period of 5 minutes.\nYou can customize this by using the ``statistic`` and ``period`` properties.')
    metric_conditional_check_failed_requests: typing.Optional[list[TableBaseDefMetricConditionalCheckFailedRequestsParams]] = pydantic.Field(None, description='Metric for the conditional check failed requests this table.\nBy default, the metric will be calculated as a sum over a period of 5 minutes.\nYou can customize this by using the ``statistic`` and ``period`` properties.')
    metric_consumed_read_capacity_units: typing.Optional[list[TableBaseDefMetricConsumedReadCapacityUnitsParams]] = pydantic.Field(None, description='Metric for the consumed read capacity units this table.\nBy default, the metric will be calculated as a sum over a period of 5 minutes.\nYou can customize this by using the ``statistic`` and ``period`` properties.')
    metric_consumed_write_capacity_units: typing.Optional[list[TableBaseDefMetricConsumedWriteCapacityUnitsParams]] = pydantic.Field(None, description='Metric for the consumed write capacity units this table.\nBy default, the metric will be calculated as a sum over a period of 5 minutes.\nYou can customize this by using the ``statistic`` and ``period`` properties.')
    metric_successful_request_latency: typing.Optional[list[TableBaseDefMetricSuccessfulRequestLatencyParams]] = pydantic.Field(None, description='Metric for the successful request latency this table.\nBy default, the metric will be calculated as an average over a period of 5 minutes.\nYou can customize this by using the ``statistic`` and ``period`` properties.')
    metric_system_errors: typing.Optional[list[TableBaseDefMetricSystemErrorsParams]] = pydantic.Field(None, description='(deprecated) Metric for the system errors this table.')
    metric_system_errors_for_operations: typing.Optional[list[TableBaseDefMetricSystemErrorsForOperationsParams]] = pydantic.Field(None, description='Metric for the system errors this table.\nThis will sum errors across all possible operations.\nNote that by default, each individual metric will be calculated as a sum over a period of 5 minutes.\nYou can customize this by using the ``statistic`` and ``period`` properties.')
    metric_throttled_requests: typing.Optional[list[TableBaseDefMetricThrottledRequestsParams]] = pydantic.Field(None, description='(deprecated) How many requests are throttled on this table.\nDefault: sum over 5 minutes')
    metric_throttled_requests_for_operation: typing.Optional[list[TableBaseDefMetricThrottledRequestsForOperationParams]] = pydantic.Field(None, description='How many requests are throttled on this table, for the given operation.\nDefault: sum over 5 minutes')
    metric_throttled_requests_for_operations: typing.Optional[list[TableBaseDefMetricThrottledRequestsForOperationsParams]] = pydantic.Field(None, description='How many requests are throttled on this table.\nThis will sum errors across all possible operations.\nNote that by default, each individual metric will be calculated as a sum over a period of 5 minutes.\nYou can customize this by using the ``statistic`` and ``period`` properties.')
    metric_user_errors: typing.Optional[list[TableBaseDefMetricUserErrorsParams]] = pydantic.Field(None, description='Metric for the user errors.\nNote that this metric reports user errors across all\nthe tables in the account and region the table resides in.\n\nBy default, the metric will be calculated as a sum over a period of 5 minutes.\nYou can customize this by using the ``statistic`` and ``period`` properties.')
...
class TableBaseV2Def(BaseClass):
    ...
    resource_config: typing.Optional[TableBaseV2DefConfig] = pydantic.Field(None)


class TableBaseV2DefConfig(pydantic.BaseModel):
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    grant: typing.Optional[list[TableBaseV2DefGrantParams]] = pydantic.Field(None, description="Adds an IAM policy statement associated with this table to an IAM principal's policy.\nNote: If ``encryptionKey`` is present, appropriate grants to the key needs to be added\nseparately using the ``table.encryptionKey.grant*`` methods.")
    grant_full_access: typing.Optional[list[TableBaseV2DefGrantFullAccessParams]] = pydantic.Field(None, description="Permits an IAM principal to all DynamoDB operations ('dynamodb:*') on this table.\nNote: Appropriate grants will also be added to the customer-managed KMS keys associated with this\ntable if one was configured.")
    grant_read_data: typing.Optional[list[TableBaseV2DefGrantReadDataParams]] = pydantic.Field(None, description='Permits an IAM principal all data read operations on this table.\nActions: BatchGetItem, GetRecords, GetShardIterator, Query, GetItem, Scan, DescribeTable.\n\nNote: Appropriate grants will also be added to the customer-managed KMS keys associated with this\ntable if one was configured.')
    grant_read_write_data: typing.Optional[list[TableBaseV2DefGrantReadWriteDataParams]] = pydantic.Field(None, description='Permits an IAM principal to all data read/write operations on this table.\nActions: BatchGetItem, GetRecords, GetShardIterator, Query, GetItem, Scan, BatchWriteItem, PutItem, UpdateItem,\nDeleteItem, DescribeTable.\n\nNote: Appropriate grants will also be added to the customer-managed KMS keys associated with this\ntable if one was configured.')
    grant_stream: typing.Optional[list[TableBaseV2DefGrantStreamParams]] = pydantic.Field(None, description="Adds an IAM policy statement associated with this table to an IAM principal's policy.\nNote: If ``encryptionKey`` is present, appropriate grants to the key needs to be added\nseparately using the ``table.encryptionKey.grant*`` methods.")
    grant_stream_read: typing.Optional[list[TableBaseV2DefGrantStreamReadParams]] = pydantic.Field(None, description="Adds an IAM policy statement associated with this table to an IAM principal's policy.\nActions: DescribeStream, GetRecords, GetShardIterator, ListStreams.\n\nNote: Appropriate grants will also be added to the customer-managed KMS keys associated with this\ntable if one was configured.")
    grant_table_list_streams: typing.Optional[list[TableBaseV2DefGrantTableListStreamsParams]] = pydantic.Field(None, description='Permits an IAM principal to list streams attached to this table.')
    grant_write_data: typing.Optional[list[TableBaseV2DefGrantWriteDataParams]] = pydantic.Field(None, description='Permits an IAM principal all data write operations on this table.\nActions: BatchWriteItem, PutItem, UpdateItem, DeleteItem, DescribeTable.\n\nNote: Appropriate grants will also be added to the customer-managed KMS keys associated with this\ntable if one was configured.')
    metric: typing.Optional[list[TableBaseV2DefMetricParams]] = pydantic.Field(None, description='Return the given named metric for this table.\nBy default, the metric will be calculated as a sum over a period of 5 minutes.\nYou can customize this by using the ``statistic`` and ``period`` properties.')
    metric_conditional_check_failed_requests: typing.Optional[list[TableBaseV2DefMetricConditionalCheckFailedRequestsParams]] = pydantic.Field(None, description='Metric for the conditional check failed requests for this table.\nBy default, the metric will be calculated as a sum over a period of 5 minutes.\nYou can customize this by using the ``statistic`` and ``period`` properties.')
    metric_consumed_read_capacity_units: typing.Optional[list[TableBaseV2DefMetricConsumedReadCapacityUnitsParams]] = pydantic.Field(None, description='Metric for the consumed read capacity units for this table.\nBy default, the metric will be calculated as a sum over a period of 5 minutes.\nYou can customize this by using the ``statistic`` and ``period`` properties.')
    metric_consumed_write_capacity_units: typing.Optional[list[TableBaseV2DefMetricConsumedWriteCapacityUnitsParams]] = pydantic.Field(None, description='Metric for the consumed write capacity units for this table.\nBy default, the metric will be calculated as a sum over a period of 5 minutes.\nYou can customize this by using the ``statistic`` and ``period`` properties.')
    metric_successful_request_latency: typing.Optional[list[TableBaseV2DefMetricSuccessfulRequestLatencyParams]] = pydantic.Field(None, description='Metric for the successful request latency for this table.\nBy default, the metric will be calculated as an average over a period of 5 minutes.\nYou can customize this by using the ``statistic`` and ``period`` properties.')
    metric_system_errors: typing.Optional[list[TableBaseV2DefMetricSystemErrorsParams]] = pydantic.Field(None, description='(deprecated) Metric for the system errors this table.')
    metric_system_errors_for_operations: typing.Optional[list[TableBaseV2DefMetricSystemErrorsForOperationsParams]] = pydantic.Field(None, description='Metric for the system errors for this table. This will sum errors across all possible operations.\nBy default, each individual metric will be calculated as a sum over a period of 5 minutes.\nYou can customize this by using the ``statistic`` and ``period`` properties.')
    metric_throttled_requests: typing.Optional[list[TableBaseV2DefMetricThrottledRequestsParams]] = pydantic.Field(None, description='(deprecated) How many requests are throttled on this table.\nBy default, each individual metric will be calculated as a sum over a period of 5 minutes.\nYou can customize this by using the ``statistic`` and ``period`` properties.')
    metric_throttled_requests_for_operation: typing.Optional[list[TableBaseV2DefMetricThrottledRequestsForOperationParams]] = pydantic.Field(None, description='How many requests are throttled on this table for the given operation.\nBy default, the metric will be calculated as an average over a period of 5 minutes.\nYou can customize this by using the ``statistic`` and ``period`` properties.')
    metric_throttled_requests_for_operations: typing.Optional[list[TableBaseV2DefMetricThrottledRequestsForOperationsParams]] = pydantic.Field(None, description='How many requests are throttled on this table. This will sum errors across all possible operations.\nBy default, each individual metric will be calculated as a sum over a period of 5 minutes.\nYou can customize this by using the ``statistic`` and ``period`` properties.')
    metric_user_errors: typing.Optional[list[TableBaseV2DefMetricUserErrorsParams]] = pydantic.Field(None, description='Metric for the user errors for this table.\nNote: This metric reports user errors across all the tables in the account and region the table\nresides in.\n\nBy default, the metric will be calculated as a sum over a period of 5 minutes.\nYou can customize this by using the ``statistic`` and ``period`` properties.')
...
class TableEncryptionV2Def(BaseClass):
    ...
    resource_config: typing.Optional[TableEncryptionV2DefConfig] = pydantic.Field(None)


class TableEncryptionV2DefConfig(pydantic.BaseModel):
    aws_managed_key: typing.Optional[list[TableEncryptionV2DefAwsManagedKeyParams]] = pydantic.Field(None, description='Configure server-side encryption using a DynamoDB owned key.')
    customer_managed_key: typing.Optional[list[TableEncryptionV2DefCustomerManagedKeyParams]] = pydantic.Field(None, description='Configure server-side encryption using customer managed keys.')
    dynamo_owned_key: typing.Optional[list[TableEncryptionV2DefDynamoOwnedKeyParams]] = pydantic.Field(None, description='Configure server-side encryption using a DynamoDB owned key.')
...
class TableDefConfig(pydantic.BaseModel):
    ...
    metric_system_errors: typing.Optional[list[TableDefMetricSystemErrorsParams]] = pydantic.Field(None, description='(deprecated) Metric for the system errors this table.')
...
class TableV2Def(BaseConstruct):
    ...
    from_table_arn: typing.Optional[TableV2DefFromTableArnParams] = pydantic.Field(None, description='Creates a Table construct that represents an external table via table ARN.')
    from_table_attributes: typing.Optional[TableV2DefFromTableAttributesParams] = pydantic.Field(None, description='Creates a Table construct that represents an external table.')
    from_table_name: typing.Optional[TableV2DefFromTableNameParams] = pydantic.Field(None, description='Creates a Table construct that represents an external table via table name.')
    resource_config: typing.Optional[TableV2DefConfig] = pydantic.Field(None)


class TableV2DefConfig(pydantic.BaseModel):
    add_global_secondary_index: typing.Optional[list[TableV2DefAddGlobalSecondaryIndexParams]] = pydantic.Field(None, description='Add a global secondary index to the table.\nNote: Global secondary indexes will be inherited by all replica tables.')
    add_local_secondary_index: typing.Optional[list[TableV2DefAddLocalSecondaryIndexParams]] = pydantic.Field(None, description='Add a local secondary index to the table.\nNote: Local secondary indexes will be inherited by all replica tables.')
    add_replica: typing.Optional[list[TableV2DefAddReplicaParams]] = pydantic.Field(None, description='Add a replica table.\nNote: Adding a replica table will allow you to use your table as a global table.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    grant: typing.Optional[list[TableV2DefGrantParams]] = pydantic.Field(None, description="Adds an IAM policy statement associated with this table to an IAM principal's policy.\nNote: If ``encryptionKey`` is present, appropriate grants to the key needs to be added\nseparately using the ``table.encryptionKey.grant*`` methods.")
    grant_full_access: typing.Optional[list[TableV2DefGrantFullAccessParams]] = pydantic.Field(None, description="Permits an IAM principal to all DynamoDB operations ('dynamodb:*') on this table.\nNote: Appropriate grants will also be added to the customer-managed KMS keys associated with this\ntable if one was configured.")
    grant_read_data: typing.Optional[list[TableV2DefGrantReadDataParams]] = pydantic.Field(None, description='Permits an IAM principal all data read operations on this table.\nActions: BatchGetItem, GetRecords, GetShardIterator, Query, GetItem, Scan, DescribeTable.\n\nNote: Appropriate grants will also be added to the customer-managed KMS keys associated with this\ntable if one was configured.')
    grant_read_write_data: typing.Optional[list[TableV2DefGrantReadWriteDataParams]] = pydantic.Field(None, description='Permits an IAM principal to all data read/write operations on this table.\nActions: BatchGetItem, GetRecords, GetShardIterator, Query, GetItem, Scan, BatchWriteItem, PutItem, UpdateItem,\nDeleteItem, DescribeTable.\n\nNote: Appropriate grants will also be added to the customer-managed KMS keys associated with this\ntable if one was configured.')
    grant_stream: typing.Optional[list[TableV2DefGrantStreamParams]] = pydantic.Field(None, description="Adds an IAM policy statement associated with this table to an IAM principal's policy.\nNote: If ``encryptionKey`` is present, appropriate grants to the key needs to be added\nseparately using the ``table.encryptionKey.grant*`` methods.")
    grant_stream_read: typing.Optional[list[TableV2DefGrantStreamReadParams]] = pydantic.Field(None, description="Adds an IAM policy statement associated with this table to an IAM principal's policy.\nActions: DescribeStream, GetRecords, GetShardIterator, ListStreams.\n\nNote: Appropriate grants will also be added to the customer-managed KMS keys associated with this\ntable if one was configured.")
    grant_table_list_streams: typing.Optional[list[TableV2DefGrantTableListStreamsParams]] = pydantic.Field(None, description='Permits an IAM principal to list streams attached to this table.')
    grant_write_data: typing.Optional[list[TableV2DefGrantWriteDataParams]] = pydantic.Field(None, description='Permits an IAM principal all data write operations on this table.\nActions: BatchWriteItem, PutItem, UpdateItem, DeleteItem, DescribeTable.\n\nNote: Appropriate grants will also be added to the customer-managed KMS keys associated with this\ntable if one was configured.')
    metric: typing.Optional[list[TableV2DefMetricParams]] = pydantic.Field(None, description='Return the given named metric for this table.\nBy default, the metric will be calculated as a sum over a period of 5 minutes.\nYou can customize this by using the ``statistic`` and ``period`` properties.')
    metric_conditional_check_failed_requests: typing.Optional[list[TableV2DefMetricConditionalCheckFailedRequestsParams]] = pydantic.Field(None, description='Metric for the conditional check failed requests for this table.\nBy default, the metric will be calculated as a sum over a period of 5 minutes.\nYou can customize this by using the ``statistic`` and ``period`` properties.')
    metric_consumed_read_capacity_units: typing.Optional[list[TableV2DefMetricConsumedReadCapacityUnitsParams]] = pydantic.Field(None, description='Metric for the consumed read capacity units for this table.\nBy default, the metric will be calculated as a sum over a period of 5 minutes.\nYou can customize this by using the ``statistic`` and ``period`` properties.')
    metric_consumed_write_capacity_units: typing.Optional[list[TableV2DefMetricConsumedWriteCapacityUnitsParams]] = pydantic.Field(None, description='Metric for the consumed write capacity units for this table.\nBy default, the metric will be calculated as a sum over a period of 5 minutes.\nYou can customize this by using the ``statistic`` and ``period`` properties.')
    metric_successful_request_latency: typing.Optional[list[TableV2DefMetricSuccessfulRequestLatencyParams]] = pydantic.Field(None, description='Metric for the successful request latency for this table.\nBy default, the metric will be calculated as an average over a period of 5 minutes.\nYou can customize this by using the ``statistic`` and ``period`` properties.')
    metric_system_errors: typing.Optional[list[TableV2DefMetricSystemErrorsParams]] = pydantic.Field(None, description='(deprecated) Metric for the system errors this table.')
    metric_system_errors_for_operations: typing.Optional[list[TableV2DefMetricSystemErrorsForOperationsParams]] = pydantic.Field(None, description='Metric for the system errors for this table. This will sum errors across all possible operations.\nBy default, each individual metric will be calculated as a sum over a period of 5 minutes.\nYou can customize this by using the ``statistic`` and ``period`` properties.')
    metric_throttled_requests: typing.Optional[list[TableV2DefMetricThrottledRequestsParams]] = pydantic.Field(None, description='(deprecated) How many requests are throttled on this table.\nBy default, each individual metric will be calculated as a sum over a period of 5 minutes.\nYou can customize this by using the ``statistic`` and ``period`` properties.')
    metric_throttled_requests_for_operation: typing.Optional[list[TableV2DefMetricThrottledRequestsForOperationParams]] = pydantic.Field(None, description='How many requests are throttled on this table for the given operation.\nBy default, the metric will be calculated as an average over a period of 5 minutes.\nYou can customize this by using the ``statistic`` and ``period`` properties.')
    metric_throttled_requests_for_operations: typing.Optional[list[TableV2DefMetricThrottledRequestsForOperationsParams]] = pydantic.Field(None, description='How many requests are throttled on this table. This will sum errors across all possible operations.\nBy default, each individual metric will be calculated as a sum over a period of 5 minutes.\nYou can customize this by using the ``statistic`` and ``period`` properties.')
    metric_user_errors: typing.Optional[list[TableV2DefMetricUserErrorsParams]] = pydantic.Field(None, description='Metric for the user errors for this table.\nNote: This metric reports user errors across all the tables in the account and region the table\nresides in.\n\nBy default, the metric will be calculated as a sum over a period of 5 minutes.\nYou can customize this by using the ``statistic`` and ``period`` properties.')
    replica: typing.Optional[list[TableV2DefReplicaParams]] = pydantic.Field(None, description='Retrieve a replica table.\nNote: Replica tables are not supported in a region agnostic stack.')
...
class ThroughputPropsDef(BaseStruct):
    ...
    resource_config: typing.Optional[ThroughputPropsDefConfig] = pydantic.Field(None)
...
class ModuleModel(pydantic.BaseModel):
    Billing: typing.Optional[dict[str, BillingDef]] = pydantic.Field(None)
    Capacity: typing.Optional[dict[str, CapacityDef]] = pydantic.Field(None)
    TableBase: typing.Optional[dict[str, TableBaseDef]] = pydantic.Field(None)
    TableBaseV2: typing.Optional[dict[str, TableBaseV2Def]] = pydantic.Field(None)
    TableEncryptionV2: typing.Optional[dict[str, TableEncryptionV2Def]] = pydantic.Field(None)
    Table: typing.Optional[dict[str, TableDef]] = pydantic.Field(None)
    TableV2: typing.Optional[dict[str, TableV2Def]] = pydantic.Field(None)
    Attribute: typing.Optional[dict[str, AttributeDef]] = pydantic.Field(None)
    AutoscaledCapacityOptions: typing.Optional[dict[str, AutoscaledCapacityOptionsDef]] = pydantic.Field(None)
    ...
    GlobalSecondaryIndexPropsV2: typing.Optional[dict[str, GlobalSecondaryIndexPropsV2Def]] = pydantic.Field(None)
    ...
    ReplicaGlobalSecondaryIndexOptions: typing.Optional[dict[str, ReplicaGlobalSecondaryIndexOptionsDef]] = pydantic.Field(None)
    ReplicaTableProps: typing.Optional[dict[str, ReplicaTablePropsDef]] = pydantic.Field(None)
    ...
    TableAttributesV2: typing.Optional[dict[str, TableAttributesV2Def]] = pydantic.Field(None)
    TableOptions: typing.Optional[dict[str, TableOptionsDef]] = pydantic.Field(None)
    TableOptionsV2: typing.Optional[dict[str, TableOptionsV2Def]] = pydantic.Field(None)
    TableProps: typing.Optional[dict[str, TablePropsDef]] = pydantic.Field(None)
    TablePropsV2: typing.Optional[dict[str, TablePropsV2Def]] = pydantic.Field(None)
    ThroughputProps: typing.Optional[dict[str, ThroughputPropsDef]] = pydantic.Field(None)
