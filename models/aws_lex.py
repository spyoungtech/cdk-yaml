...
class CfnBotDef(BaseCfnResource):
    ...
    resource_config: typing.Optional[models.aws_lex.CfnBotDefConfig] = pydantic.Field(None)


class CfnBotDefConfig(pydantic.BaseModel):
    AdvancedRecognitionSettingProperty: typing.Optional[list[models.aws_lex.CfnBotDefAdvancedrecognitionsettingpropertyParams]] = pydantic.Field(None, description='')
    AllowedInputTypesProperty: typing.Optional[list[models.aws_lex.CfnBotDefAllowedinputtypespropertyParams]] = pydantic.Field(None, description='')
    AudioAndDTMFInputSpecificationProperty: typing.Optional[list[models.aws_lex.CfnBotDefAudioanddtmfinputspecificationpropertyParams]] = pydantic.Field(None, description='')
    AudioLogDestinationProperty: typing.Optional[list[models.aws_lex.CfnBotDefAudiologdestinationpropertyParams]] = pydantic.Field(None, description='')
    AudioLogSettingProperty: typing.Optional[list[models.aws_lex.CfnBotDefAudiologsettingpropertyParams]] = pydantic.Field(None, description='')
    AudioSpecificationProperty: typing.Optional[list[models.aws_lex.CfnBotDefAudiospecificationpropertyParams]] = pydantic.Field(None, description='')
    BotAliasLocaleSettingsItemProperty: typing.Optional[list[models.aws_lex.CfnBotDefBotaliaslocalesettingsitempropertyParams]] = pydantic.Field(None, description='')
    BotAliasLocaleSettingsProperty: typing.Optional[list[models.aws_lex.CfnBotDefBotaliaslocalesettingspropertyParams]] = pydantic.Field(None, description='')
    BotLocaleProperty: typing.Optional[list[models.aws_lex.CfnBotDefBotlocalepropertyParams]] = pydantic.Field(None, description='')
    ButtonProperty: typing.Optional[list[models.aws_lex.CfnBotDefButtonpropertyParams]] = pydantic.Field(None, description='')
    CloudWatchLogGroupLogDestinationProperty: typing.Optional[list[models.aws_lex.CfnBotDefCloudwatchloggrouplogdestinationpropertyParams]] = pydantic.Field(None, description='')
    CodeHookSpecificationProperty: typing.Optional[list[models.aws_lex.CfnBotDefCodehookspecificationpropertyParams]] = pydantic.Field(None, description='')
    ConditionProperty: typing.Optional[list[models.aws_lex.CfnBotDefConditionpropertyParams]] = pydantic.Field(None, description='')
    ConditionalBranchProperty: typing.Optional[list[models.aws_lex.CfnBotDefConditionalbranchpropertyParams]] = pydantic.Field(None, description='')
    ConditionalSpecificationProperty: typing.Optional[list[models.aws_lex.CfnBotDefConditionalspecificationpropertyParams]] = pydantic.Field(None, description='')
    ConversationLogSettingsProperty: typing.Optional[list[models.aws_lex.CfnBotDefConversationlogsettingspropertyParams]] = pydantic.Field(None, description='')
    CustomPayloadProperty: typing.Optional[list[models.aws_lex.CfnBotDefCustompayloadpropertyParams]] = pydantic.Field(None, description='')
    CustomVocabularyItemProperty: typing.Optional[list[models.aws_lex.CfnBotDefCustomvocabularyitempropertyParams]] = pydantic.Field(None, description='')
    CustomVocabularyProperty: typing.Optional[list[models.aws_lex.CfnBotDefCustomvocabularypropertyParams]] = pydantic.Field(None, description='')
    DTMFSpecificationProperty: typing.Optional[list[models.aws_lex.CfnBotDefDtmfspecificationpropertyParams]] = pydantic.Field(None, description='')
    DataPrivacyProperty: typing.Optional[list[models.aws_lex.CfnBotDefDataprivacypropertyParams]] = pydantic.Field(None, description='')
    DefaultConditionalBranchProperty: typing.Optional[list[models.aws_lex.CfnBotDefDefaultconditionalbranchpropertyParams]] = pydantic.Field(None, description='')
    DialogActionProperty: typing.Optional[list[models.aws_lex.CfnBotDefDialogactionpropertyParams]] = pydantic.Field(None, description='')
    DialogCodeHookInvocationSettingProperty: typing.Optional[list[models.aws_lex.CfnBotDefDialogcodehookinvocationsettingpropertyParams]] = pydantic.Field(None, description='')
    DialogCodeHookSettingProperty: typing.Optional[list[models.aws_lex.CfnBotDefDialogcodehooksettingpropertyParams]] = pydantic.Field(None, description='')
    DialogStateProperty: typing.Optional[list[models.aws_lex.CfnBotDefDialogstatepropertyParams]] = pydantic.Field(None, description='')
    ElicitationCodeHookInvocationSettingProperty: typing.Optional[list[models.aws_lex.CfnBotDefElicitationcodehookinvocationsettingpropertyParams]] = pydantic.Field(None, description='')
    ExternalSourceSettingProperty: typing.Optional[list[models.aws_lex.CfnBotDefExternalsourcesettingpropertyParams]] = pydantic.Field(None, description='')
    FulfillmentCodeHookSettingProperty: typing.Optional[list[models.aws_lex.CfnBotDefFulfillmentcodehooksettingpropertyParams]] = pydantic.Field(None, description='')
    FulfillmentStartResponseSpecificationProperty: typing.Optional[list[models.aws_lex.CfnBotDefFulfillmentstartresponsespecificationpropertyParams]] = pydantic.Field(None, description='')
    FulfillmentUpdateResponseSpecificationProperty: typing.Optional[list[models.aws_lex.CfnBotDefFulfillmentupdateresponsespecificationpropertyParams]] = pydantic.Field(None, description='')
    FulfillmentUpdatesSpecificationProperty: typing.Optional[list[models.aws_lex.CfnBotDefFulfillmentupdatesspecificationpropertyParams]] = pydantic.Field(None, description='')
    GrammarSlotTypeSettingProperty: typing.Optional[list[models.aws_lex.CfnBotDefGrammarslottypesettingpropertyParams]] = pydantic.Field(None, description='')
    GrammarSlotTypeSourceProperty: typing.Optional[list[models.aws_lex.CfnBotDefGrammarslottypesourcepropertyParams]] = pydantic.Field(None, description='')
    ImageResponseCardProperty: typing.Optional[list[models.aws_lex.CfnBotDefImageresponsecardpropertyParams]] = pydantic.Field(None, description='')
    InitialResponseSettingProperty: typing.Optional[list[models.aws_lex.CfnBotDefInitialresponsesettingpropertyParams]] = pydantic.Field(None, description='')
    InputContextProperty: typing.Optional[list[models.aws_lex.CfnBotDefInputcontextpropertyParams]] = pydantic.Field(None, description='')
    IntentClosingSettingProperty: typing.Optional[list[models.aws_lex.CfnBotDefIntentclosingsettingpropertyParams]] = pydantic.Field(None, description='')
    IntentConfirmationSettingProperty: typing.Optional[list[models.aws_lex.CfnBotDefIntentconfirmationsettingpropertyParams]] = pydantic.Field(None, description='')
    IntentOverrideProperty: typing.Optional[list[models.aws_lex.CfnBotDefIntentoverridepropertyParams]] = pydantic.Field(None, description='')
    IntentProperty: typing.Optional[list[models.aws_lex.CfnBotDefIntentpropertyParams]] = pydantic.Field(None, description='')
    KendraConfigurationProperty: typing.Optional[list[models.aws_lex.CfnBotDefKendraconfigurationpropertyParams]] = pydantic.Field(None, description='')
    LambdaCodeHookProperty: typing.Optional[list[models.aws_lex.CfnBotDefLambdacodehookpropertyParams]] = pydantic.Field(None, description='')
    MessageGroupProperty: typing.Optional[list[models.aws_lex.CfnBotDefMessagegrouppropertyParams]] = pydantic.Field(None, description='')
    MessageProperty: typing.Optional[list[models.aws_lex.CfnBotDefMessagepropertyParams]] = pydantic.Field(None, description='')
    MultipleValuesSettingProperty: typing.Optional[list[models.aws_lex.CfnBotDefMultiplevaluessettingpropertyParams]] = pydantic.Field(None, description='')
    ObfuscationSettingProperty: typing.Optional[list[models.aws_lex.CfnBotDefObfuscationsettingpropertyParams]] = pydantic.Field(None, description='')
    OutputContextProperty: typing.Optional[list[models.aws_lex.CfnBotDefOutputcontextpropertyParams]] = pydantic.Field(None, description='')
    PlainTextMessageProperty: typing.Optional[list[models.aws_lex.CfnBotDefPlaintextmessagepropertyParams]] = pydantic.Field(None, description='')
    PostDialogCodeHookInvocationSpecificationProperty: typing.Optional[list[models.aws_lex.CfnBotDefPostdialogcodehookinvocationspecificationpropertyParams]] = pydantic.Field(None, description='')
    PostFulfillmentStatusSpecificationProperty: typing.Optional[list[models.aws_lex.CfnBotDefPostfulfillmentstatusspecificationpropertyParams]] = pydantic.Field(None, description='')
    PromptAttemptSpecificationProperty: typing.Optional[list[models.aws_lex.CfnBotDefPromptattemptspecificationpropertyParams]] = pydantic.Field(None, description='')
    PromptSpecificationProperty: typing.Optional[list[models.aws_lex.CfnBotDefPromptspecificationpropertyParams]] = pydantic.Field(None, description='')
    ResponseSpecificationProperty: typing.Optional[list[models.aws_lex.CfnBotDefResponsespecificationpropertyParams]] = pydantic.Field(None, description='')
    S3BucketLogDestinationProperty: typing.Optional[list[models.aws_lex.CfnBotDefS3BucketlogdestinationpropertyParams]] = pydantic.Field(None, description='')
    S3LocationProperty: typing.Optional[list[models.aws_lex.CfnBotDefS3LocationpropertyParams]] = pydantic.Field(None, description='')
    SSMLMessageProperty: typing.Optional[list[models.aws_lex.CfnBotDefSsmlmessagepropertyParams]] = pydantic.Field(None, description='')
    SampleUtteranceProperty: typing.Optional[list[models.aws_lex.CfnBotDefSampleutterancepropertyParams]] = pydantic.Field(None, description='')
    SampleValueProperty: typing.Optional[list[models.aws_lex.CfnBotDefSamplevaluepropertyParams]] = pydantic.Field(None, description='')
    SentimentAnalysisSettingsProperty: typing.Optional[list[models.aws_lex.CfnBotDefSentimentanalysissettingspropertyParams]] = pydantic.Field(None, description='')
    SessionAttributeProperty: typing.Optional[list[models.aws_lex.CfnBotDefSessionattributepropertyParams]] = pydantic.Field(None, description='')
    SlotCaptureSettingProperty: typing.Optional[list[models.aws_lex.CfnBotDefSlotcapturesettingpropertyParams]] = pydantic.Field(None, description='')
    SlotDefaultValueProperty: typing.Optional[list[models.aws_lex.CfnBotDefSlotdefaultvaluepropertyParams]] = pydantic.Field(None, description='')
    SlotDefaultValueSpecificationProperty: typing.Optional[list[models.aws_lex.CfnBotDefSlotdefaultvaluespecificationpropertyParams]] = pydantic.Field(None, description='')
    SlotPriorityProperty: typing.Optional[list[models.aws_lex.CfnBotDefSlotprioritypropertyParams]] = pydantic.Field(None, description='')
    SlotProperty: typing.Optional[list[models.aws_lex.CfnBotDefSlotpropertyParams]] = pydantic.Field(None, description='')
    SlotTypeProperty: typing.Optional[list[models.aws_lex.CfnBotDefSlottypepropertyParams]] = pydantic.Field(None, description='')
    SlotTypeValueProperty: typing.Optional[list[models.aws_lex.CfnBotDefSlottypevaluepropertyParams]] = pydantic.Field(None, description='')
    SlotValueElicitationSettingProperty: typing.Optional[list[models.aws_lex.CfnBotDefSlotvalueelicitationsettingpropertyParams]] = pydantic.Field(None, description='')
    SlotValueOverrideMapProperty: typing.Optional[list[models.aws_lex.CfnBotDefSlotvalueoverridemappropertyParams]] = pydantic.Field(None, description='')
    SlotValueOverrideProperty: typing.Optional[list[models.aws_lex.CfnBotDefSlotvalueoverridepropertyParams]] = pydantic.Field(None, description='')
    SlotValueProperty: typing.Optional[list[models.aws_lex.CfnBotDefSlotvaluepropertyParams]] = pydantic.Field(None, description='')
    SlotValueRegexFilterProperty: typing.Optional[list[models.aws_lex.CfnBotDefSlotvalueregexfilterpropertyParams]] = pydantic.Field(None, description='')
    SlotValueSelectionSettingProperty: typing.Optional[list[models.aws_lex.CfnBotDefSlotvalueselectionsettingpropertyParams]] = pydantic.Field(None, description='')
    StillWaitingResponseSpecificationProperty: typing.Optional[list[models.aws_lex.CfnBotDefStillwaitingresponsespecificationpropertyParams]] = pydantic.Field(None, description='')
    TestBotAliasSettingsProperty: typing.Optional[list[models.aws_lex.CfnBotDefTestbotaliassettingspropertyParams]] = pydantic.Field(None, description='')
    TextInputSpecificationProperty: typing.Optional[list[models.aws_lex.CfnBotDefTextinputspecificationpropertyParams]] = pydantic.Field(None, description='')
    TextLogDestinationProperty: typing.Optional[list[models.aws_lex.CfnBotDefTextlogdestinationpropertyParams]] = pydantic.Field(None, description='')
    TextLogSettingProperty: typing.Optional[list[models.aws_lex.CfnBotDefTextlogsettingpropertyParams]] = pydantic.Field(None, description='')
    VoiceSettingsProperty: typing.Optional[list[models.aws_lex.CfnBotDefVoicesettingspropertyParams]] = pydantic.Field(None, description='')
    WaitAndContinueSpecificationProperty: typing.Optional[list[models.aws_lex.CfnBotDefWaitandcontinuespecificationpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_lex.CfnBotDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_lex.CfnBotDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_lex.CfnBotDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_lex.CfnBotDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_lex.CfnBotDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_lex.CfnBotDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_lex.CfnBotDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_lex.CfnBotDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_lex.CfnBotDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_lex.CfnBotDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_lex.CfnBotDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_lex.CfnBotDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_lex.CfnBotDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
class CfnBotAliasDef(BaseCfnResource):
    ...
    resource_config: typing.Optional[models.aws_lex.CfnBotAliasDefConfig] = pydantic.Field(None)


class CfnBotAliasDefConfig(pydantic.BaseModel):
    AudioLogDestinationProperty: typing.Optional[list[models.aws_lex.CfnBotAliasDefAudiologdestinationpropertyParams]] = pydantic.Field(None, description='')
    AudioLogSettingProperty: typing.Optional[list[models.aws_lex.CfnBotAliasDefAudiologsettingpropertyParams]] = pydantic.Field(None, description='')
    BotAliasLocaleSettingsItemProperty: typing.Optional[list[models.aws_lex.CfnBotAliasDefBotaliaslocalesettingsitempropertyParams]] = pydantic.Field(None, description='')
    BotAliasLocaleSettingsProperty: typing.Optional[list[models.aws_lex.CfnBotAliasDefBotaliaslocalesettingspropertyParams]] = pydantic.Field(None, description='')
    CloudWatchLogGroupLogDestinationProperty: typing.Optional[list[models.aws_lex.CfnBotAliasDefCloudwatchloggrouplogdestinationpropertyParams]] = pydantic.Field(None, description='')
    CodeHookSpecificationProperty: typing.Optional[list[models.aws_lex.CfnBotAliasDefCodehookspecificationpropertyParams]] = pydantic.Field(None, description='')
    ConversationLogSettingsProperty: typing.Optional[list[models.aws_lex.CfnBotAliasDefConversationlogsettingspropertyParams]] = pydantic.Field(None, description='')
    LambdaCodeHookProperty: typing.Optional[list[models.aws_lex.CfnBotAliasDefLambdacodehookpropertyParams]] = pydantic.Field(None, description='')
    S3BucketLogDestinationProperty: typing.Optional[list[models.aws_lex.CfnBotAliasDefS3BucketlogdestinationpropertyParams]] = pydantic.Field(None, description='')
    SentimentAnalysisSettingsProperty: typing.Optional[list[models.aws_lex.CfnBotAliasDefSentimentanalysissettingspropertyParams]] = pydantic.Field(None, description='')
    TextLogDestinationProperty: typing.Optional[list[models.aws_lex.CfnBotAliasDefTextlogdestinationpropertyParams]] = pydantic.Field(None, description='')
    TextLogSettingProperty: typing.Optional[list[models.aws_lex.CfnBotAliasDefTextlogsettingpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_lex.CfnBotAliasDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_lex.CfnBotAliasDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_lex.CfnBotAliasDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_lex.CfnBotAliasDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_lex.CfnBotAliasDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_lex.CfnBotAliasDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_lex.CfnBotAliasDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_lex.CfnBotAliasDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_lex.CfnBotAliasDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_lex.CfnBotAliasDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_lex.CfnBotAliasDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_lex.CfnBotAliasDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_lex.CfnBotAliasDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
class CfnBotVersionDef(BaseCfnResource):
    ...
    resource_config: typing.Optional[models.aws_lex.CfnBotVersionDefConfig] = pydantic.Field(None)


class CfnBotVersionDefConfig(pydantic.BaseModel):
    BotVersionLocaleDetailsProperty: typing.Optional[list[models.aws_lex.CfnBotVersionDefBotversionlocaledetailspropertyParams]] = pydantic.Field(None, description='')
    BotVersionLocaleSpecificationProperty: typing.Optional[list[models.aws_lex.CfnBotVersionDefBotversionlocalespecificationpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_lex.CfnBotVersionDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_lex.CfnBotVersionDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_lex.CfnBotVersionDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_lex.CfnBotVersionDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_lex.CfnBotVersionDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_lex.CfnBotVersionDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_lex.CfnBotVersionDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_lex.CfnBotVersionDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_lex.CfnBotVersionDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_lex.CfnBotVersionDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_lex.CfnBotVersionDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_lex.CfnBotVersionDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_lex.CfnBotVersionDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
class CfnResourcePolicyDef(BaseCfnResource):
    ...
    resource_config: typing.Optional[models.aws_lex.CfnResourcePolicyDefConfig] = pydantic.Field(None)


class CfnResourcePolicyDefConfig(pydantic.BaseModel):
    add_deletion_override: typing.Optional[list[models.aws_lex.CfnResourcePolicyDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_lex.CfnResourcePolicyDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_lex.CfnResourcePolicyDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_lex.CfnResourcePolicyDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_lex.CfnResourcePolicyDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_lex.CfnResourcePolicyDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_lex.CfnResourcePolicyDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_lex.CfnResourcePolicyDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_lex.CfnResourcePolicyDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_lex.CfnResourcePolicyDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_lex.CfnResourcePolicyDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_lex.CfnResourcePolicyDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_lex.CfnResourcePolicyDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
class ModuleModel(pydantic.BaseModel):
    CfnBot_AdvancedRecognitionSettingProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_AdvancedRecognitionSettingPropertyDef]] = pydantic.Field(None)
    CfnBot_AllowedInputTypesProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_AllowedInputTypesPropertyDef]] = pydantic.Field(None)
    CfnBot_AudioAndDTMFInputSpecificationProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_AudioAndDTMFInputSpecificationPropertyDef]] = pydantic.Field(None)
    CfnBot_AudioLogDestinationProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_AudioLogDestinationPropertyDef]] = pydantic.Field(None)
    CfnBot_AudioLogSettingProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_AudioLogSettingPropertyDef]] = pydantic.Field(None)
    CfnBot_AudioSpecificationProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_AudioSpecificationPropertyDef]] = pydantic.Field(None)
    CfnBot_BotAliasLocaleSettingsItemProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_BotAliasLocaleSettingsItemPropertyDef]] = pydantic.Field(None)
    CfnBot_BotAliasLocaleSettingsProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_BotAliasLocaleSettingsPropertyDef]] = pydantic.Field(None)
    CfnBot_BotLocaleProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_BotLocalePropertyDef]] = pydantic.Field(None)
    CfnBot_ButtonProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_ButtonPropertyDef]] = pydantic.Field(None)
    CfnBot_CloudWatchLogGroupLogDestinationProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_CloudWatchLogGroupLogDestinationPropertyDef]] = pydantic.Field(None)
    CfnBot_CodeHookSpecificationProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_CodeHookSpecificationPropertyDef]] = pydantic.Field(None)
    CfnBot_ConditionalBranchProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_ConditionalBranchPropertyDef]] = pydantic.Field(None)
    CfnBot_ConditionalSpecificationProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_ConditionalSpecificationPropertyDef]] = pydantic.Field(None)
    CfnBot_ConditionProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_ConditionPropertyDef]] = pydantic.Field(None)
    CfnBot_ConversationLogSettingsProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_ConversationLogSettingsPropertyDef]] = pydantic.Field(None)
    CfnBot_CustomPayloadProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_CustomPayloadPropertyDef]] = pydantic.Field(None)
    CfnBot_CustomVocabularyItemProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_CustomVocabularyItemPropertyDef]] = pydantic.Field(None)
    CfnBot_CustomVocabularyProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_CustomVocabularyPropertyDef]] = pydantic.Field(None)
    CfnBot_DataPrivacyProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_DataPrivacyPropertyDef]] = pydantic.Field(None)
    CfnBot_DefaultConditionalBranchProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_DefaultConditionalBranchPropertyDef]] = pydantic.Field(None)
    CfnBot_DialogActionProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_DialogActionPropertyDef]] = pydantic.Field(None)
    CfnBot_DialogCodeHookInvocationSettingProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_DialogCodeHookInvocationSettingPropertyDef]] = pydantic.Field(None)
    CfnBot_DialogCodeHookSettingProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_DialogCodeHookSettingPropertyDef]] = pydantic.Field(None)
    CfnBot_DialogStateProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_DialogStatePropertyDef]] = pydantic.Field(None)
    CfnBot_DTMFSpecificationProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_DTMFSpecificationPropertyDef]] = pydantic.Field(None)
    CfnBot_ElicitationCodeHookInvocationSettingProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_ElicitationCodeHookInvocationSettingPropertyDef]] = pydantic.Field(None)
    CfnBot_ExternalSourceSettingProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_ExternalSourceSettingPropertyDef]] = pydantic.Field(None)
    CfnBot_FulfillmentCodeHookSettingProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_FulfillmentCodeHookSettingPropertyDef]] = pydantic.Field(None)
    CfnBot_FulfillmentStartResponseSpecificationProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_FulfillmentStartResponseSpecificationPropertyDef]] = pydantic.Field(None)
    CfnBot_FulfillmentUpdateResponseSpecificationProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_FulfillmentUpdateResponseSpecificationPropertyDef]] = pydantic.Field(None)
    CfnBot_FulfillmentUpdatesSpecificationProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_FulfillmentUpdatesSpecificationPropertyDef]] = pydantic.Field(None)
    CfnBot_GrammarSlotTypeSettingProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_GrammarSlotTypeSettingPropertyDef]] = pydantic.Field(None)
    CfnBot_GrammarSlotTypeSourceProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_GrammarSlotTypeSourcePropertyDef]] = pydantic.Field(None)
    CfnBot_ImageResponseCardProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_ImageResponseCardPropertyDef]] = pydantic.Field(None)
    CfnBot_InitialResponseSettingProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_InitialResponseSettingPropertyDef]] = pydantic.Field(None)
    CfnBot_InputContextProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_InputContextPropertyDef]] = pydantic.Field(None)
    CfnBot_IntentClosingSettingProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_IntentClosingSettingPropertyDef]] = pydantic.Field(None)
    CfnBot_IntentConfirmationSettingProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_IntentConfirmationSettingPropertyDef]] = pydantic.Field(None)
    CfnBot_IntentOverrideProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_IntentOverridePropertyDef]] = pydantic.Field(None)
    CfnBot_IntentProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_IntentPropertyDef]] = pydantic.Field(None)
    CfnBot_KendraConfigurationProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_KendraConfigurationPropertyDef]] = pydantic.Field(None)
    CfnBot_LambdaCodeHookProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_LambdaCodeHookPropertyDef]] = pydantic.Field(None)
    CfnBot_MessageGroupProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_MessageGroupPropertyDef]] = pydantic.Field(None)
    CfnBot_MessageProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_MessagePropertyDef]] = pydantic.Field(None)
    CfnBot_MultipleValuesSettingProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_MultipleValuesSettingPropertyDef]] = pydantic.Field(None)
    CfnBot_ObfuscationSettingProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_ObfuscationSettingPropertyDef]] = pydantic.Field(None)
    CfnBot_OutputContextProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_OutputContextPropertyDef]] = pydantic.Field(None)
    CfnBot_PlainTextMessageProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_PlainTextMessagePropertyDef]] = pydantic.Field(None)
    CfnBot_PostDialogCodeHookInvocationSpecificationProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_PostDialogCodeHookInvocationSpecificationPropertyDef]] = pydantic.Field(None)
    CfnBot_PostFulfillmentStatusSpecificationProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_PostFulfillmentStatusSpecificationPropertyDef]] = pydantic.Field(None)
    CfnBot_PromptAttemptSpecificationProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_PromptAttemptSpecificationPropertyDef]] = pydantic.Field(None)
    CfnBot_PromptSpecificationProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_PromptSpecificationPropertyDef]] = pydantic.Field(None)
    CfnBot_ResponseSpecificationProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_ResponseSpecificationPropertyDef]] = pydantic.Field(None)
    CfnBot_S3BucketLogDestinationProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_S3BucketLogDestinationPropertyDef]] = pydantic.Field(None)
    CfnBot_S3LocationProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_S3LocationPropertyDef]] = pydantic.Field(None)
    CfnBot_SampleUtteranceProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_SampleUtterancePropertyDef]] = pydantic.Field(None)
    CfnBot_SampleValueProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_SampleValuePropertyDef]] = pydantic.Field(None)
    CfnBot_SentimentAnalysisSettingsProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_SentimentAnalysisSettingsPropertyDef]] = pydantic.Field(None)
    CfnBot_SessionAttributeProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_SessionAttributePropertyDef]] = pydantic.Field(None)
    CfnBot_SlotCaptureSettingProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_SlotCaptureSettingPropertyDef]] = pydantic.Field(None)
    CfnBot_SlotDefaultValueProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_SlotDefaultValuePropertyDef]] = pydantic.Field(None)
    CfnBot_SlotDefaultValueSpecificationProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_SlotDefaultValueSpecificationPropertyDef]] = pydantic.Field(None)
    CfnBot_SlotPriorityProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_SlotPriorityPropertyDef]] = pydantic.Field(None)
    CfnBot_SlotProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_SlotPropertyDef]] = pydantic.Field(None)
    CfnBot_SlotTypeProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_SlotTypePropertyDef]] = pydantic.Field(None)
    CfnBot_SlotTypeValueProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_SlotTypeValuePropertyDef]] = pydantic.Field(None)
    CfnBot_SlotValueElicitationSettingProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_SlotValueElicitationSettingPropertyDef]] = pydantic.Field(None)
    CfnBot_SlotValueOverrideMapProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_SlotValueOverrideMapPropertyDef]] = pydantic.Field(None)
    CfnBot_SlotValueOverrideProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_SlotValueOverridePropertyDef]] = pydantic.Field(None)
    CfnBot_SlotValueProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_SlotValuePropertyDef]] = pydantic.Field(None)
    CfnBot_SlotValueRegexFilterProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_SlotValueRegexFilterPropertyDef]] = pydantic.Field(None)
    CfnBot_SlotValueSelectionSettingProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_SlotValueSelectionSettingPropertyDef]] = pydantic.Field(None)
    CfnBot_SSMLMessageProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_SSMLMessagePropertyDef]] = pydantic.Field(None)
    CfnBot_StillWaitingResponseSpecificationProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_StillWaitingResponseSpecificationPropertyDef]] = pydantic.Field(None)
    CfnBot_TestBotAliasSettingsProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_TestBotAliasSettingsPropertyDef]] = pydantic.Field(None)
    CfnBot_TextInputSpecificationProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_TextInputSpecificationPropertyDef]] = pydantic.Field(None)
    CfnBot_TextLogDestinationProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_TextLogDestinationPropertyDef]] = pydantic.Field(None)
    CfnBot_TextLogSettingProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_TextLogSettingPropertyDef]] = pydantic.Field(None)
    CfnBot_VoiceSettingsProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_VoiceSettingsPropertyDef]] = pydantic.Field(None)
    CfnBot_WaitAndContinueSpecificationProperty: typing.Optional[dict[str, models.aws_lex.CfnBot_WaitAndContinueSpecificationPropertyDef]] = pydantic.Field(None)
    CfnBotAlias_AudioLogDestinationProperty: typing.Optional[dict[str, models.aws_lex.CfnBotAlias_AudioLogDestinationPropertyDef]] = pydantic.Field(None)
    CfnBotAlias_AudioLogSettingProperty: typing.Optional[dict[str, models.aws_lex.CfnBotAlias_AudioLogSettingPropertyDef]] = pydantic.Field(None)
    CfnBotAlias_BotAliasLocaleSettingsItemProperty: typing.Optional[dict[str, models.aws_lex.CfnBotAlias_BotAliasLocaleSettingsItemPropertyDef]] = pydantic.Field(None)
    CfnBotAlias_BotAliasLocaleSettingsProperty: typing.Optional[dict[str, models.aws_lex.CfnBotAlias_BotAliasLocaleSettingsPropertyDef]] = pydantic.Field(None)
    CfnBotAlias_CloudWatchLogGroupLogDestinationProperty: typing.Optional[dict[str, models.aws_lex.CfnBotAlias_CloudWatchLogGroupLogDestinationPropertyDef]] = pydantic.Field(None)
    CfnBotAlias_CodeHookSpecificationProperty: typing.Optional[dict[str, models.aws_lex.CfnBotAlias_CodeHookSpecificationPropertyDef]] = pydantic.Field(None)
    CfnBotAlias_ConversationLogSettingsProperty: typing.Optional[dict[str, models.aws_lex.CfnBotAlias_ConversationLogSettingsPropertyDef]] = pydantic.Field(None)
    CfnBotAlias_LambdaCodeHookProperty: typing.Optional[dict[str, models.aws_lex.CfnBotAlias_LambdaCodeHookPropertyDef]] = pydantic.Field(None)
    CfnBotAlias_S3BucketLogDestinationProperty: typing.Optional[dict[str, models.aws_lex.CfnBotAlias_S3BucketLogDestinationPropertyDef]] = pydantic.Field(None)
    CfnBotAlias_SentimentAnalysisSettingsProperty: typing.Optional[dict[str, models.aws_lex.CfnBotAlias_SentimentAnalysisSettingsPropertyDef]] = pydantic.Field(None)
    CfnBotAlias_TextLogDestinationProperty: typing.Optional[dict[str, models.aws_lex.CfnBotAlias_TextLogDestinationPropertyDef]] = pydantic.Field(None)
    CfnBotAlias_TextLogSettingProperty: typing.Optional[dict[str, models.aws_lex.CfnBotAlias_TextLogSettingPropertyDef]] = pydantic.Field(None)
    CfnBotVersion_BotVersionLocaleDetailsProperty: typing.Optional[dict[str, models.aws_lex.CfnBotVersion_BotVersionLocaleDetailsPropertyDef]] = pydantic.Field(None)
    CfnBotVersion_BotVersionLocaleSpecificationProperty: typing.Optional[dict[str, models.aws_lex.CfnBotVersion_BotVersionLocaleSpecificationPropertyDef]] = pydantic.Field(None)
    CfnBot: typing.Optional[dict[str, models.aws_lex.CfnBotDef]] = pydantic.Field(None)
    CfnBotAlias: typing.Optional[dict[str, models.aws_lex.CfnBotAliasDef]] = pydantic.Field(None)
    CfnBotVersion: typing.Optional[dict[str, models.aws_lex.CfnBotVersionDef]] = pydantic.Field(None)
    CfnResourcePolicy: typing.Optional[dict[str, models.aws_lex.CfnResourcePolicyDef]] = pydantic.Field(None)
    CfnBotAliasProps: typing.Optional[dict[str, models.aws_lex.CfnBotAliasPropsDef]] = pydantic.Field(None)
    CfnBotProps: typing.Optional[dict[str, models.aws_lex.CfnBotPropsDef]] = pydantic.Field(None)
    CfnBotVersionProps: typing.Optional[dict[str, models.aws_lex.CfnBotVersionPropsDef]] = pydantic.Field(None)
    CfnResourcePolicyProps: typing.Optional[dict[str, models.aws_lex.CfnResourcePolicyPropsDef]] = pydantic.Field(None)
    ...
