...
class CfnCampaign_ConditionBasedCollectionSchemePropertyDef(BaseStruct):
    expression: str = pydantic.Field(..., description='The logical expression used to recognize what data to collect. For example, ``$variable.Vehicle.OutsideAirTemperature >= 105.0`` .\n')
...
class CfnCampaign_DataDestinationConfigPropertyDef(BaseStruct):
    s3_config: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotfleetwise.CfnCampaign_S3ConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='(Optional) The Amazon S3 bucket where the AWS IoT FleetWise campaign sends data.\n')
    timestream_config: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotfleetwise.CfnCampaign_TimestreamConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='(Optional) The Amazon Timestream table where the campaign sends data.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iotfleetwise-campaign-datadestinationconfig.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_iotfleetwise as iotfleetwise\n\n    data_destination_config_property = iotfleetwise.CfnCampaign.DataDestinationConfigProperty(\n        s3_config=iotfleetwise.CfnCampaign.S3ConfigProperty(\n            bucket_arn="bucketArn",\n\n            # the properties below are optional\n            data_format="dataFormat",\n            prefix="prefix",\n            storage_compression_format="storageCompressionFormat"\n        ),\n        timestream_config=iotfleetwise.CfnCampaign.TimestreamConfigProperty(\n            execution_role_arn="executionRoleArn",\n            timestream_table_arn="timestreamTableArn"\n        )\n    )\n')
...
class CfnCampaign_S3ConfigPropertyDef(BaseStruct):
    bucket_arn: str = pydantic.Field(..., description='The Amazon Resource Name (ARN) of the Amazon S3 bucket.\n')
...
class CfnCampaign_SignalInformationPropertyDef(BaseStruct):
    name: str = pydantic.Field(..., description='The name of the signal.\n')
...
class CfnCampaign_TimestreamConfigPropertyDef(BaseStruct):
    execution_role_arn: str = pydantic.Field(..., description='The Amazon Resource Name (ARN) of the task execution role that grants AWS IoT FleetWise permission to deliver data to the Amazon Timestream table.\n')
    timestream_table_arn: str = pydantic.Field(..., description='The Amazon Resource Name (ARN) of the Amazon Timestream table.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iotfleetwise-campaign-timestreamconfig.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_iotfleetwise as iotfleetwise\n\n    timestream_config_property = iotfleetwise.CfnCampaign.TimestreamConfigProperty(\n        execution_role_arn="executionRoleArn",\n        timestream_table_arn="timestreamTableArn"\n    )\n')
...
class CfnDecoderManifest_CanInterfacePropertyDef(BaseStruct):
    name: str = pydantic.Field(..., description='The unique name of the interface.\n')
...
class CfnDecoderManifest_CanSignalPropertyDef(BaseStruct):
    factor: str = pydantic.Field(..., description='A multiplier used to decode the CAN message.\n')
    is_big_endian: str = pydantic.Field(..., description='Whether the byte ordering of a CAN message is big-endian.\n')
    is_signed: str = pydantic.Field(..., description='Whether the message data is specified as a signed value.\n')
    length: str = pydantic.Field(..., description='How many bytes of data are in the message.\n')
    message_id: str = pydantic.Field(..., description='The ID of the message.\n')
    offset: str = pydantic.Field(..., description='The offset used to calculate the signal value. Combined with factor, the calculation is ``value = raw_value * factor + offset`` .\n')
    start_bit: str = pydantic.Field(..., description='Indicates the beginning of the CAN message.\n')
...
class CfnDecoderManifest_NetworkInterfacesItemsPropertyDef(BaseStruct):
    interface_id: str = pydantic.Field(..., description='The ID of the network interface.\n')
    type: str = pydantic.Field(..., description='The network protocol for the vehicle. For example, ``CAN_SIGNAL`` specifies a protocol that defines how data is communicated between electronic control units (ECUs). ``OBD_SIGNAL`` specifies a protocol that defines how self-diagnostic data is communicated between ECUs.\n')
    can_interface: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotfleetwise.CfnDecoderManifest_CanInterfacePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='(Optional) Information about a network interface specified by the Controller Area Network (CAN) protocol.\n')
    obd_interface: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotfleetwise.CfnDecoderManifest_ObdInterfacePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='(Optional) Information about a network interface specified by the On-board diagnostic (OBD) II protocol.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iotfleetwise-decodermanifest-networkinterfacesitems.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_iotfleetwise as iotfleetwise\n\n    network_interfaces_items_property = iotfleetwise.CfnDecoderManifest.NetworkInterfacesItemsProperty(\n        interface_id="interfaceId",\n        type="type",\n\n        # the properties below are optional\n        can_interface=iotfleetwise.CfnDecoderManifest.CanInterfaceProperty(\n            name="name",\n\n            # the properties below are optional\n            protocol_name="protocolName",\n            protocol_version="protocolVersion"\n        ),\n        obd_interface=iotfleetwise.CfnDecoderManifest.ObdInterfaceProperty(\n            name="name",\n            request_message_id="requestMessageId",\n\n            # the properties below are optional\n            dtc_request_interval_seconds="dtcRequestIntervalSeconds",\n            has_transmission_ecu="hasTransmissionEcu",\n            obd_standard="obdStandard",\n            pid_request_interval_seconds="pidRequestIntervalSeconds",\n            use_extended_ids="useExtendedIds"\n        )\n    )\n')
...
class CfnDecoderManifest_ObdInterfacePropertyDef(BaseStruct):
    name: str = pydantic.Field(..., description='The name of the interface.\n')
    request_message_id: str = pydantic.Field(..., description='The ID of the message requesting vehicle data.\n')
...
class CfnDecoderManifest_ObdSignalPropertyDef(BaseStruct):
    byte_length: str = pydantic.Field(..., description='The length of a message.\n')
    offset: str = pydantic.Field(..., description='The offset used to calculate the signal value. Combined with scaling, the calculation is ``value = raw_value * scaling + offset`` .\n')
    pid: str = pydantic.Field(..., description='The diagnostic code used to request data from a vehicle for this signal.\n')
    pid_response_length: str = pydantic.Field(..., description='The length of the requested data.\n')
    scaling: str = pydantic.Field(..., description='A multiplier used to decode the message.\n')
    service_mode: str = pydantic.Field(..., description='The mode of operation (diagnostic service) in a message.\n')
    start_byte: str = pydantic.Field(..., description='Indicates the beginning of the message.\n')
...
class CfnDecoderManifest_SignalDecodersItemsPropertyDef(BaseStruct):
    fully_qualified_name: str = pydantic.Field(..., description='The fully qualified name of a signal decoder as defined in a vehicle model.\n')
    interface_id: str = pydantic.Field(..., description='The ID of a network interface that specifies what network protocol a vehicle follows.\n')
    type: str = pydantic.Field(..., description='The network protocol for the vehicle. For example, ``CAN_SIGNAL`` specifies a protocol that defines how data is communicated between electronic control units (ECUs). ``OBD_SIGNAL`` specifies a protocol that defines how self-diagnostic data is communicated between ECUs.\n')
    can_signal: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotfleetwise.CfnDecoderManifest_CanSignalPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='(Optional) Information about a single controller area network (CAN) signal and the messages it receives and transmits.\n')
    obd_signal: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotfleetwise.CfnDecoderManifest_ObdSignalPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='(Optional) Information about signal messages using the on-board diagnostics (OBD) II protocol in a vehicle.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iotfleetwise-decodermanifest-signaldecodersitems.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_iotfleetwise as iotfleetwise\n\n    signal_decoders_items_property = iotfleetwise.CfnDecoderManifest.SignalDecodersItemsProperty(\n        fully_qualified_name="fullyQualifiedName",\n        interface_id="interfaceId",\n        type="type",\n\n        # the properties below are optional\n        can_signal=iotfleetwise.CfnDecoderManifest.CanSignalProperty(\n            factor="factor",\n            is_big_endian="isBigEndian",\n            is_signed="isSigned",\n            length="length",\n            message_id="messageId",\n            offset="offset",\n            start_bit="startBit",\n\n            # the properties below are optional\n            name="name"\n        ),\n        obd_signal=iotfleetwise.CfnDecoderManifest.ObdSignalProperty(\n            byte_length="byteLength",\n            offset="offset",\n            pid="pid",\n            pid_response_length="pidResponseLength",\n            scaling="scaling",\n            service_mode="serviceMode",\n            start_byte="startByte",\n\n            # the properties below are optional\n            bit_mask_length="bitMaskLength",\n            bit_right_shift="bitRightShift"\n        )\n    )\n')
...
class CfnSignalCatalog_ActuatorPropertyDef(BaseStruct):
    data_type: str = pydantic.Field(..., description='The specified data type of the actuator.\n')
    fully_qualified_name: str = pydantic.Field(..., description='The fully qualified name of the actuator. For example, the fully qualified name of an actuator might be ``Vehicle.Front.Left.Door.Lock`` .\n')
...
class CfnSignalCatalog_AttributePropertyDef(BaseStruct):
    data_type: str = pydantic.Field(..., description='The specified data type of the attribute.\n')
    fully_qualified_name: str = pydantic.Field(..., description='The fully qualified name of the attribute. For example, the fully qualified name of an attribute might be ``Vehicle.Body.Engine.Type`` .\n')
...
class CfnSignalCatalog_BranchPropertyDef(BaseStruct):
    fully_qualified_name: str = pydantic.Field(..., description='The fully qualified name of the branch. For example, the fully qualified name of a branch might be ``Vehicle.Body.Engine`` .\n')
...
class CfnSignalCatalog_NodePropertyDef(BaseStruct):
    actuator: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotfleetwise.CfnSignalCatalog_ActuatorPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='(Optional) Information about a node specified as an actuator. .. epigraph:: An actuator is a digital representation of a vehicle device.\n')
    attribute: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotfleetwise.CfnSignalCatalog_AttributePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='(Optional) Information about a node specified as an attribute. .. epigraph:: An attribute represents static information about a vehicle.\n')
    branch: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotfleetwise.CfnSignalCatalog_BranchPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='(Optional) Information about a node specified as a branch. .. epigraph:: A group of signals that are defined in a hierarchical structure.\n')
    sensor: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotfleetwise.CfnSignalCatalog_SensorPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='(Optional) An input component that reports the environmental condition of a vehicle. .. epigraph:: You can collect data about fluid levels, temperatures, vibrations, or battery voltage from sensors.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iotfleetwise-signalcatalog-node.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_iotfleetwise as iotfleetwise\n\n    node_property = iotfleetwise.CfnSignalCatalog.NodeProperty(\n        actuator=iotfleetwise.CfnSignalCatalog.ActuatorProperty(\n            data_type="dataType",\n            fully_qualified_name="fullyQualifiedName",\n\n            # the properties below are optional\n            allowed_values=["allowedValues"],\n            assigned_value="assignedValue",\n            description="description",\n            max=123,\n            min=123,\n            unit="unit"\n        ),\n        attribute=iotfleetwise.CfnSignalCatalog.AttributeProperty(\n            data_type="dataType",\n            fully_qualified_name="fullyQualifiedName",\n\n            # the properties below are optional\n            allowed_values=["allowedValues"],\n            assigned_value="assignedValue",\n            default_value="defaultValue",\n            description="description",\n            max=123,\n            min=123,\n            unit="unit"\n        ),\n        branch=iotfleetwise.CfnSignalCatalog.BranchProperty(\n            fully_qualified_name="fullyQualifiedName",\n\n            # the properties below are optional\n            description="description"\n        ),\n        sensor=iotfleetwise.CfnSignalCatalog.SensorProperty(\n            data_type="dataType",\n            fully_qualified_name="fullyQualifiedName",\n\n            # the properties below are optional\n            allowed_values=["allowedValues"],\n            description="description",\n            max=123,\n            min=123,\n            unit="unit"\n        )\n    )\n')
...
class CfnSignalCatalog_SensorPropertyDef(BaseStruct):
    data_type: str = pydantic.Field(..., description='The specified data type of the sensor.\n')
    fully_qualified_name: str = pydantic.Field(..., description='The fully qualified name of the sensor. For example, the fully qualified name of a sensor might be ``Vehicle.Body.Engine.Battery`` .\n')
...
class CfnCampaignDef(BaseCfnResource):
    action: str = pydantic.Field(..., description='Specifies how to update a campaign. The action can be one of the following:. - ``APPROVE`` - To approve delivering a data collection scheme to vehicles. - ``SUSPEND`` - To suspend collecting signal data. The campaign is deleted from vehicles and all vehicles in the suspended campaign will stop sending data. - ``RESUME`` - To reactivate the ``SUSPEND`` campaign. The campaign is redeployed to all vehicles and the vehicles will resume sending data. - ``UPDATE`` - To update a campaign.\n')
    collection_scheme: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotfleetwise.CfnCampaign_CollectionSchemePropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='The data collection scheme associated with the campaign. You can specify a scheme that collects data based on time or an event.\n')
    name: str = pydantic.Field(..., description='The name of a campaign.\n')
    signal_catalog_arn: str = pydantic.Field(..., description='The Amazon Resource Name (ARN) of the signal catalog associated with the campaign.\n')
    target_arn: str = pydantic.Field(..., description='The Amazon Resource Name (ARN) of a vehicle or fleet to which the campaign is deployed.\n')
    compression: typing.Optional[str] = pydantic.Field(None, description="(Optional) Whether to compress signals before transmitting data to AWS IoT FleetWise . If you don't want to compress the signals, use ``OFF`` . If it's not specified, ``SNAPPY`` is used. Default: ``SNAPPY``\n")
    data_destination_configs: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotfleetwise.CfnCampaign_DataDestinationConfigPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='(Optional) The destination where the campaign sends data. You can choose to send data to be stored in Amazon S3 or Amazon Timestream . Amazon S3 optimizes the cost of data storage and provides additional mechanisms to use vehicle data, such as data lakes, centralized data storage, data processing pipelines, and analytics. AWS IoT FleetWise supports at-least-once file delivery to S3. Your vehicle data is stored on multiple AWS IoT FleetWise servers for redundancy and high availability. You can use Amazon Timestream to access and analyze time series data, and Timestream to query vehicle data so that you can identify trends and patterns.\n')
    ...
    diagnostics_mode: typing.Optional[str] = pydantic.Field(None, description="(Optional) Option for a vehicle to send diagnostic trouble codes to AWS IoT FleetWise . If you want to send diagnostic trouble codes, use ``SEND_ACTIVE_DTCS`` . If it's not specified, ``OFF`` is used. Default: ``OFF``\n")
    expiry_time: typing.Optional[str] = pydantic.Field(None, description="(Optional) The time the campaign expires, in seconds since epoch (January 1, 1970 at midnight UTC time). Vehicle data isn't collected after the campaign expires. Default: 253402214400 (December 31, 9999, 00:00:00 UTC)\n")
    post_trigger_collection_duration: typing.Union[int, float, None] = pydantic.Field(None, description="(Optional) How long (in milliseconds) to collect raw data after a triggering event initiates the collection. If it's not specified, ``0`` is used. Default: ``0``\n")
    priority: typing.Union[int, float, None] = pydantic.Field(None, description="(Optional) A number indicating the priority of one campaign over another campaign for a certain vehicle or fleet. A campaign with the lowest value is deployed to vehicles before any other campaigns. If it's not specified, ``0`` is used. Default: ``0``\n")
    signals_to_collect: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotfleetwise.CfnCampaign_SignalInformationPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='(Optional) A list of information about signals to collect.\n')
    ...
    start_time: typing.Optional[str] = pydantic.Field(None, description="(Optional) The time, in milliseconds, to deliver a campaign after it was approved. If it's not specified, ``0`` is used. Default: ``0``\n")
...
class CfnCampaignDefDatadestinationconfigpropertyParams(pydantic.BaseModel):
    s3_config: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotfleetwise.CfnCampaign_S3ConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    timestream_config: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotfleetwise.CfnCampaign_TimestreamConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnDecoderManifestDef(BaseCfnResource):
    model_manifest_arn: str = pydantic.Field(..., description='The Amazon Resource Name (ARN) of a vehicle model (model manifest) associated with the decoder manifest.\n')
    name: str = pydantic.Field(..., description='The name of the decoder manifest.\n')
    description: typing.Optional[str] = pydantic.Field(None, description='(Optional) A brief description of the decoder manifest.\n')
    network_interfaces: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotfleetwise.CfnDecoderManifest_NetworkInterfacesItemsPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='(Optional) A list of information about available network interfaces.\n')
    signal_decoders: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotfleetwise.CfnDecoderManifest_SignalDecodersItemsPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='(Optional) A list of information about signal decoders.\n')
    status: typing.Optional[str] = pydantic.Field(None, description="(Optional) The state of the decoder manifest. If the status is ``ACTIVE`` , the decoder manifest can't be edited. If the status is marked ``DRAFT`` , you can edit the decoder manifest.\n")
    ...
    _method_names: typing.ClassVar[list[str]] = ['CanInterfaceProperty', 'CanSignalProperty', 'NetworkInterfacesItemsProperty', 'ObdInterfaceProperty', 'ObdSignalProperty', 'SignalDecodersItemsProperty', 'add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnDecoderManifestDefSignaldecodersitemspropertyParams(pydantic.BaseModel):
    ...
    interface_id: str = pydantic.Field(..., description='')
    type: str = pydantic.Field(..., description='')
    can_signal: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotfleetwise.CfnDecoderManifest_CanSignalPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    obd_signal: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotfleetwise.CfnDecoderManifest_ObdSignalPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnFleetDef(BaseCfnResource):
    ...
    signal_catalog_arn: str = pydantic.Field(..., description='The ARN of the signal catalog associated with the fleet.\n')
...
class CfnModelManifestDef(BaseCfnResource):
    name: str = pydantic.Field(..., description='The name of the vehicle model.\n')
    signal_catalog_arn: str = pydantic.Field(..., description='The Amazon Resource Name (ARN) of the signal catalog associated with the vehicle model.\n')
    ...
    status: typing.Optional[str] = pydantic.Field(None, description="(Optional) The state of the vehicle model. If the status is ``ACTIVE`` , the vehicle model can't be edited. If the status is ``DRAFT`` , you can edit the vehicle model.\n")
...
class CfnSignalCatalogDef(BaseCfnResource):
    ...
    node_counts: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotfleetwise.CfnSignalCatalog_NodeCountsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='(Optional) Information about the number of nodes and node types in a vehicle network.\n')
    nodes: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotfleetwise.CfnSignalCatalog_NodePropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='(Optional) A list of information about nodes, which are a general abstraction of signals.\n')
...
class CfnSignalCatalogDefNodepropertyParams(pydantic.BaseModel):
    actuator: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotfleetwise.CfnSignalCatalog_ActuatorPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    attribute: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotfleetwise.CfnSignalCatalog_AttributePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    branch: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotfleetwise.CfnSignalCatalog_BranchPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    sensor: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotfleetwise.CfnSignalCatalog_SensorPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnVehicleDef(BaseCfnResource):
    decoder_manifest_arn: str = pydantic.Field(..., description='The Amazon Resource Name (ARN) of a decoder manifest associated with the vehicle to create.\n')
    model_manifest_arn: str = pydantic.Field(..., description='The Amazon Resource Name (ARN) of the vehicle model (model manifest) to create the vehicle from.\n')
    name: str = pydantic.Field(..., description='The unique ID of the vehicle.\n')
    ...
    attributes: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Mapping[str, str], None] = pydantic.Field(None, description='(Optional) Static information about a vehicle in a key-value pair. For example: ``"engine Type"`` : ``"v6"``\n')
