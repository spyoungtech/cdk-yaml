...
class CfnCampaignDef(BaseCfnResource):
    ...
    resource_config: typing.Optional[models.aws_iotfleetwise.CfnCampaignDefConfig] = pydantic.Field(None)


class CfnCampaignDefConfig(pydantic.BaseModel):
    CollectionSchemeProperty: typing.Optional[list[models.aws_iotfleetwise.CfnCampaignDefCollectionschemepropertyParams]] = pydantic.Field(None, description='')
    ConditionBasedCollectionSchemeProperty: typing.Optional[list[models.aws_iotfleetwise.CfnCampaignDefConditionbasedcollectionschemepropertyParams]] = pydantic.Field(None, description='')
    DataDestinationConfigProperty: typing.Optional[list[models.aws_iotfleetwise.CfnCampaignDefDatadestinationconfigpropertyParams]] = pydantic.Field(None, description='')
    S3ConfigProperty: typing.Optional[list[models.aws_iotfleetwise.CfnCampaignDefS3ConfigpropertyParams]] = pydantic.Field(None, description='')
    SignalInformationProperty: typing.Optional[list[models.aws_iotfleetwise.CfnCampaignDefSignalinformationpropertyParams]] = pydantic.Field(None, description='')
    TimeBasedCollectionSchemeProperty: typing.Optional[list[models.aws_iotfleetwise.CfnCampaignDefTimebasedcollectionschemepropertyParams]] = pydantic.Field(None, description='')
    TimestreamConfigProperty: typing.Optional[list[models.aws_iotfleetwise.CfnCampaignDefTimestreamconfigpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_iotfleetwise.CfnCampaignDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_iotfleetwise.CfnCampaignDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_iotfleetwise.CfnCampaignDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_iotfleetwise.CfnCampaignDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_iotfleetwise.CfnCampaignDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_iotfleetwise.CfnCampaignDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_iotfleetwise.CfnCampaignDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_iotfleetwise.CfnCampaignDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_iotfleetwise.CfnCampaignDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_iotfleetwise.CfnCampaignDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_iotfleetwise.CfnCampaignDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_iotfleetwise.CfnCampaignDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_iotfleetwise.CfnCampaignDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
class CfnDecoderManifestDef(BaseCfnResource):
    ...
    model_manifest_arn_: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Amazon Resource Name (ARN) of a vehicle model (model manifest) associated with the decoder manifest.\n', alias='model_manifest_arn')
    name_: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the decoder manifest.\n', alias='name')
    description_: typing.Optional[str] = pydantic.Field(None, description='(Optional) A brief description of the decoder manifest.\n', alias='description')
    network_interfaces_: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_iotfleetwise.CfnDecoderManifest_NetworkInterfacesItemsPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='(Optional) A list of information about available network interfaces.\n', alias='network_interfaces')
    signal_decoders_: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_iotfleetwise.CfnDecoderManifest_SignalDecodersItemsPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='(Optional) A list of information about signal decoders.\n', alias='signal_decoders')
    status_: typing.Optional[str] = pydantic.Field(None, description='(Optional) The state of the decoder manifest. If the status is ``ACTIVE`` , the decoder manifest can\'t be edited. If the status is marked ``DRAFT`` , you can edit the decoder manifest. Default: - "DRAFT"\n', alias='status')
    tags_: typing.Optional[typing.Sequence[typing.Union[models.CfnTagDef, dict[str, typing.Any]]]] = pydantic.Field(None, description='(Optional) Metadata that can be used to manage the decoder manifest.', alias='tags')
    ...
    resource_config: typing.Optional[models.aws_iotfleetwise.CfnDecoderManifestDefConfig] = pydantic.Field(None)


class CfnDecoderManifestDefConfig(pydantic.BaseModel):
    CanInterfaceProperty: typing.Optional[list[models.aws_iotfleetwise.CfnDecoderManifestDefCaninterfacepropertyParams]] = pydantic.Field(None, description='')
    CanNetworkInterfaceProperty: typing.Optional[list[models.aws_iotfleetwise.CfnDecoderManifestDefCannetworkinterfacepropertyParams]] = pydantic.Field(None, description='')
    CanSignalDecoderProperty: typing.Optional[list[models.aws_iotfleetwise.CfnDecoderManifestDefCansignaldecoderpropertyParams]] = pydantic.Field(None, description='')
    CanSignalProperty: typing.Optional[list[models.aws_iotfleetwise.CfnDecoderManifestDefCansignalpropertyParams]] = pydantic.Field(None, description='')
    NetworkInterfacesItemsProperty: typing.Optional[list[models.aws_iotfleetwise.CfnDecoderManifestDefNetworkinterfacesitemspropertyParams]] = pydantic.Field(None, description='')
    ObdInterfaceProperty: typing.Optional[list[models.aws_iotfleetwise.CfnDecoderManifestDefObdinterfacepropertyParams]] = pydantic.Field(None, description='')
    ObdNetworkInterfaceProperty: typing.Optional[list[models.aws_iotfleetwise.CfnDecoderManifestDefObdnetworkinterfacepropertyParams]] = pydantic.Field(None, description='')
    ObdSignalDecoderProperty: typing.Optional[list[models.aws_iotfleetwise.CfnDecoderManifestDefObdsignaldecoderpropertyParams]] = pydantic.Field(None, description='')
    ObdSignalProperty: typing.Optional[list[models.aws_iotfleetwise.CfnDecoderManifestDefObdsignalpropertyParams]] = pydantic.Field(None, description='')
    SignalDecodersItemsProperty: typing.Optional[list[models.aws_iotfleetwise.CfnDecoderManifestDefSignaldecodersitemspropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_iotfleetwise.CfnDecoderManifestDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_iotfleetwise.CfnDecoderManifestDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_iotfleetwise.CfnDecoderManifestDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_iotfleetwise.CfnDecoderManifestDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_iotfleetwise.CfnDecoderManifestDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_iotfleetwise.CfnDecoderManifestDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_iotfleetwise.CfnDecoderManifestDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_iotfleetwise.CfnDecoderManifestDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_iotfleetwise.CfnDecoderManifestDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_iotfleetwise.CfnDecoderManifestDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_iotfleetwise.CfnDecoderManifestDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_iotfleetwise.CfnDecoderManifestDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_iotfleetwise.CfnDecoderManifestDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
    tags_config: typing.Optional[models.core.TagManagerDefConfig] = pydantic.Field(None)
...
class CfnFleetDef(BaseCfnResource):
    ...
    resource_config: typing.Optional[models.aws_iotfleetwise.CfnFleetDefConfig] = pydantic.Field(None)


class CfnFleetDefConfig(pydantic.BaseModel):
    add_deletion_override: typing.Optional[list[models.aws_iotfleetwise.CfnFleetDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_iotfleetwise.CfnFleetDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_iotfleetwise.CfnFleetDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_iotfleetwise.CfnFleetDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_iotfleetwise.CfnFleetDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_iotfleetwise.CfnFleetDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_iotfleetwise.CfnFleetDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_iotfleetwise.CfnFleetDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_iotfleetwise.CfnFleetDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_iotfleetwise.CfnFleetDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_iotfleetwise.CfnFleetDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_iotfleetwise.CfnFleetDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_iotfleetwise.CfnFleetDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
    tags_config: typing.Optional[models.core.TagManagerDefConfig] = pydantic.Field(None)
...
class CfnModelManifestDef(BaseCfnResource):
    ...
    resource_config: typing.Optional[models.aws_iotfleetwise.CfnModelManifestDefConfig] = pydantic.Field(None)


class CfnModelManifestDefConfig(pydantic.BaseModel):
    add_deletion_override: typing.Optional[list[models.aws_iotfleetwise.CfnModelManifestDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_iotfleetwise.CfnModelManifestDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_iotfleetwise.CfnModelManifestDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_iotfleetwise.CfnModelManifestDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_iotfleetwise.CfnModelManifestDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_iotfleetwise.CfnModelManifestDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_iotfleetwise.CfnModelManifestDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_iotfleetwise.CfnModelManifestDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_iotfleetwise.CfnModelManifestDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_iotfleetwise.CfnModelManifestDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_iotfleetwise.CfnModelManifestDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_iotfleetwise.CfnModelManifestDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_iotfleetwise.CfnModelManifestDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
    tags_config: typing.Optional[models.core.TagManagerDefConfig] = pydantic.Field(None)
...
class CfnSignalCatalogDef(BaseCfnResource):
    ...
    resource_config: typing.Optional[models.aws_iotfleetwise.CfnSignalCatalogDefConfig] = pydantic.Field(None)


class CfnSignalCatalogDefConfig(pydantic.BaseModel):
    ActuatorProperty: typing.Optional[list[models.aws_iotfleetwise.CfnSignalCatalogDefActuatorpropertyParams]] = pydantic.Field(None, description='')
    AttributeProperty: typing.Optional[list[models.aws_iotfleetwise.CfnSignalCatalogDefAttributepropertyParams]] = pydantic.Field(None, description='')
    BranchProperty: typing.Optional[list[models.aws_iotfleetwise.CfnSignalCatalogDefBranchpropertyParams]] = pydantic.Field(None, description='')
    NodeCountsProperty: typing.Optional[list[models.aws_iotfleetwise.CfnSignalCatalogDefNodecountspropertyParams]] = pydantic.Field(None, description='')
    NodeProperty: typing.Optional[list[models.aws_iotfleetwise.CfnSignalCatalogDefNodepropertyParams]] = pydantic.Field(None, description='')
    SensorProperty: typing.Optional[list[models.aws_iotfleetwise.CfnSignalCatalogDefSensorpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_iotfleetwise.CfnSignalCatalogDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_iotfleetwise.CfnSignalCatalogDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_iotfleetwise.CfnSignalCatalogDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_iotfleetwise.CfnSignalCatalogDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_iotfleetwise.CfnSignalCatalogDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_iotfleetwise.CfnSignalCatalogDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_iotfleetwise.CfnSignalCatalogDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_iotfleetwise.CfnSignalCatalogDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_iotfleetwise.CfnSignalCatalogDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_iotfleetwise.CfnSignalCatalogDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_iotfleetwise.CfnSignalCatalogDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_iotfleetwise.CfnSignalCatalogDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_iotfleetwise.CfnSignalCatalogDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
class CfnVehicleDef(BaseCfnResource):
    ...
    model_config = pydantic.ConfigDict(protected_namespaces=())
    model_manifest_arn_: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Amazon Resource Name (ARN) of the vehicle model (model manifest) to create the vehicle from.\n', alias='model_manifest_arn')
    name_: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The unique ID of the vehicle.\n', alias='name')
    association_behavior_: typing.Optional[str] = pydantic.Field(None, description='(Optional) An option to create a new AWS IoT thing when creating a vehicle, or to validate an existing thing as a vehicle.\n', alias='association_behavior')
    attributes_: typing.Union[models.UnsupportedResource, typing.Mapping[str, str], None] = pydantic.Field(None, description='(Optional) Static information about a vehicle in a key-value pair. For example: ``"engine Type"`` : ``"v6"``\n', alias='attributes')
    tags_: typing.Optional[typing.Sequence[typing.Union[models.CfnTagDef, dict[str, typing.Any]]]] = pydantic.Field(None, description='(Optional) Metadata which can be used to manage the vehicle.', alias='tags')
    ...
    resource_config: typing.Optional[models.aws_iotfleetwise.CfnVehicleDefConfig] = pydantic.Field(None)


class CfnVehicleDefConfig(pydantic.BaseModel):
    add_deletion_override: typing.Optional[list[models.aws_iotfleetwise.CfnVehicleDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_iotfleetwise.CfnVehicleDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_iotfleetwise.CfnVehicleDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_iotfleetwise.CfnVehicleDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_iotfleetwise.CfnVehicleDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_iotfleetwise.CfnVehicleDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_iotfleetwise.CfnVehicleDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_iotfleetwise.CfnVehicleDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_iotfleetwise.CfnVehicleDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_iotfleetwise.CfnVehicleDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_iotfleetwise.CfnVehicleDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_iotfleetwise.CfnVehicleDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_iotfleetwise.CfnVehicleDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
    tags_config: typing.Optional[models.core.TagManagerDefConfig] = pydantic.Field(None)
...
class ModuleModel(pydantic.BaseModel):
    CfnCampaign_CollectionSchemeProperty: typing.Optional[dict[str, models.aws_iotfleetwise.CfnCampaign_CollectionSchemePropertyDef]] = pydantic.Field(None)
    CfnCampaign_ConditionBasedCollectionSchemeProperty: typing.Optional[dict[str, models.aws_iotfleetwise.CfnCampaign_ConditionBasedCollectionSchemePropertyDef]] = pydantic.Field(None)
    CfnCampaign_DataDestinationConfigProperty: typing.Optional[dict[str, models.aws_iotfleetwise.CfnCampaign_DataDestinationConfigPropertyDef]] = pydantic.Field(None)
    CfnCampaign_S3ConfigProperty: typing.Optional[dict[str, models.aws_iotfleetwise.CfnCampaign_S3ConfigPropertyDef]] = pydantic.Field(None)
    CfnCampaign_SignalInformationProperty: typing.Optional[dict[str, models.aws_iotfleetwise.CfnCampaign_SignalInformationPropertyDef]] = pydantic.Field(None)
    CfnCampaign_TimeBasedCollectionSchemeProperty: typing.Optional[dict[str, models.aws_iotfleetwise.CfnCampaign_TimeBasedCollectionSchemePropertyDef]] = pydantic.Field(None)
    CfnCampaign_TimestreamConfigProperty: typing.Optional[dict[str, models.aws_iotfleetwise.CfnCampaign_TimestreamConfigPropertyDef]] = pydantic.Field(None)
    CfnDecoderManifest_CanInterfaceProperty: typing.Optional[dict[str, models.aws_iotfleetwise.CfnDecoderManifest_CanInterfacePropertyDef]] = pydantic.Field(None)
    CfnDecoderManifest_CanNetworkInterfaceProperty: typing.Optional[dict[str, models.aws_iotfleetwise.CfnDecoderManifest_CanNetworkInterfacePropertyDef]] = pydantic.Field(None)
    CfnDecoderManifest_CanSignalDecoderProperty: typing.Optional[dict[str, models.aws_iotfleetwise.CfnDecoderManifest_CanSignalDecoderPropertyDef]] = pydantic.Field(None)
    CfnDecoderManifest_CanSignalProperty: typing.Optional[dict[str, models.aws_iotfleetwise.CfnDecoderManifest_CanSignalPropertyDef]] = pydantic.Field(None)
    CfnDecoderManifest_NetworkInterfacesItemsProperty: typing.Optional[dict[str, models.aws_iotfleetwise.CfnDecoderManifest_NetworkInterfacesItemsPropertyDef]] = pydantic.Field(None)
    CfnDecoderManifest_ObdInterfaceProperty: typing.Optional[dict[str, models.aws_iotfleetwise.CfnDecoderManifest_ObdInterfacePropertyDef]] = pydantic.Field(None)
    CfnDecoderManifest_ObdNetworkInterfaceProperty: typing.Optional[dict[str, models.aws_iotfleetwise.CfnDecoderManifest_ObdNetworkInterfacePropertyDef]] = pydantic.Field(None)
    CfnDecoderManifest_ObdSignalDecoderProperty: typing.Optional[dict[str, models.aws_iotfleetwise.CfnDecoderManifest_ObdSignalDecoderPropertyDef]] = pydantic.Field(None)
    CfnDecoderManifest_ObdSignalProperty: typing.Optional[dict[str, models.aws_iotfleetwise.CfnDecoderManifest_ObdSignalPropertyDef]] = pydantic.Field(None)
    CfnDecoderManifest_SignalDecodersItemsProperty: typing.Optional[dict[str, models.aws_iotfleetwise.CfnDecoderManifest_SignalDecodersItemsPropertyDef]] = pydantic.Field(None)
    CfnSignalCatalog_ActuatorProperty: typing.Optional[dict[str, models.aws_iotfleetwise.CfnSignalCatalog_ActuatorPropertyDef]] = pydantic.Field(None)
    CfnSignalCatalog_AttributeProperty: typing.Optional[dict[str, models.aws_iotfleetwise.CfnSignalCatalog_AttributePropertyDef]] = pydantic.Field(None)
    CfnSignalCatalog_BranchProperty: typing.Optional[dict[str, models.aws_iotfleetwise.CfnSignalCatalog_BranchPropertyDef]] = pydantic.Field(None)
    CfnSignalCatalog_NodeCountsProperty: typing.Optional[dict[str, models.aws_iotfleetwise.CfnSignalCatalog_NodeCountsPropertyDef]] = pydantic.Field(None)
    CfnSignalCatalog_NodeProperty: typing.Optional[dict[str, models.aws_iotfleetwise.CfnSignalCatalog_NodePropertyDef]] = pydantic.Field(None)
    CfnSignalCatalog_SensorProperty: typing.Optional[dict[str, models.aws_iotfleetwise.CfnSignalCatalog_SensorPropertyDef]] = pydantic.Field(None)
    CfnCampaign: typing.Optional[dict[str, models.aws_iotfleetwise.CfnCampaignDef]] = pydantic.Field(None)
    CfnDecoderManifest: typing.Optional[dict[str, models.aws_iotfleetwise.CfnDecoderManifestDef]] = pydantic.Field(None)
    CfnFleet: typing.Optional[dict[str, models.aws_iotfleetwise.CfnFleetDef]] = pydantic.Field(None)
    CfnModelManifest: typing.Optional[dict[str, models.aws_iotfleetwise.CfnModelManifestDef]] = pydantic.Field(None)
    CfnSignalCatalog: typing.Optional[dict[str, models.aws_iotfleetwise.CfnSignalCatalogDef]] = pydantic.Field(None)
    CfnVehicle: typing.Optional[dict[str, models.aws_iotfleetwise.CfnVehicleDef]] = pydantic.Field(None)
    CfnCampaignProps: typing.Optional[dict[str, models.aws_iotfleetwise.CfnCampaignPropsDef]] = pydantic.Field(None)
    CfnDecoderManifestProps: typing.Optional[dict[str, models.aws_iotfleetwise.CfnDecoderManifestPropsDef]] = pydantic.Field(None)
    CfnFleetProps: typing.Optional[dict[str, models.aws_iotfleetwise.CfnFleetPropsDef]] = pydantic.Field(None)
    CfnModelManifestProps: typing.Optional[dict[str, models.aws_iotfleetwise.CfnModelManifestPropsDef]] = pydantic.Field(None)
    CfnSignalCatalogProps: typing.Optional[dict[str, models.aws_iotfleetwise.CfnSignalCatalogPropsDef]] = pydantic.Field(None)
    CfnVehicleProps: typing.Optional[dict[str, models.aws_iotfleetwise.CfnVehiclePropsDef]] = pydantic.Field(None)
    ...
