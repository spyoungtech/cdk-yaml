...
class CfnBackupPlan_BackupRuleResourceTypePropertyDef(BaseStruct):
    ...
    recovery_point_tags: typing.Union[models.UnsupportedResource, typing.Mapping[str, str], None] = pydantic.Field(None, description='To help organize your resources, you can assign your own metadata to the resources that you create. Each tag is a key-value pair.\n')
...
class CfnFramework_FrameworkControlPropertyDef(BaseStruct):
    ...
    control_input_parameters: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_backup.CfnFramework_ControlInputParameterPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='A list of ``ParameterName`` and ``ParameterValue`` pairs.\n')
    control_scope: typing.Any = pydantic.Field(None, description='The scope of a control. The control scope defines what the control will evaluate. Three examples of control scopes are: a specific backup plan, all backup plans with a specific tag, or all backup plans.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-backup-framework-frameworkcontrol.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_backup as backup\n\n    # control_scope: Any\n\n    framework_control_property = backup.CfnFramework.FrameworkControlProperty(\n        control_name="controlName",\n\n        # the properties below are optional\n        control_input_parameters=[backup.CfnFramework.ControlInputParameterProperty(\n            parameter_name="parameterName",\n            parameter_value="parameterValue"\n        )],\n        control_scope=control_scope\n    )\n')
...
class CfnBackupPlanDef(BaseCfnResource):
    ...
    backup_plan_tags: typing.Union[models.UnsupportedResource, typing.Mapping[str, str], None] = pydantic.Field(None, description='To help organize your resources, you can assign your own metadata to the resources that you create. Each tag is a key-value pair. The specified tags are assigned to all backups created with this plan.')
...
class CfnBackupVaultDef(BaseCfnResource):
    ...
    backup_vault_tags: typing.Union[models.UnsupportedResource, typing.Mapping[str, str], None] = pydantic.Field(None, description='Metadata that you can assign to help organize the resources that you create. Each tag is a key-value pair.\n')
...
class CfnFrameworkDef(BaseCfnResource):
    ...
    framework_tags: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.CfnTagDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='A list of tags with which to tag your framework.')
...
class CfnReportPlanDef(BaseCfnResource):
    ...
    report_plan_tags: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.CfnTagDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='A list of tags to tag your report plan.')
