...
#  autogenerated from aws_cdk.aws_docdb.CaCertificate
class CaCertificateDef(BaseClass):
    _init_params: typing.ClassVar[list[str]] = []
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = ['of']
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_docdb.CaCertificate'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = ['of']
    ...


    of: typing.Optional[models.aws_docdb.CaCertificateDefOfParams] = pydantic.Field(None, description='Custom CA certificate.')
...
class DatabaseClusterDef(BaseConstruct):
    ...
    ca_certificate: typing.Optional[models.aws_rds.CaCertificateDef] = pydantic.Field(None, description='The identifier of the CA certificate used for the instances. Specifying or updating this property triggers a reboot. Default: - DocumentDB will choose a certificate authority\n')
    ...
    copy_tags_to_snapshot: typing.Optional[bool] = pydantic.Field(None, description='Whether to copy tags to the snapshot when a snapshot is created. Default: - false\n')
    ...
    instance_removal_policy: typing.Optional[aws_cdk.RemovalPolicy] = pydantic.Field(None, description="The removal policy to apply to the cluster's instances. Cannot be set to ``SNAPSHOT``. Default: - ``RemovalPolicy.DESTROY`` when ``removalPolicy`` is set to ``SNAPSHOT``, ``removalPolicy`` otherwise.\n")
    ...
    security_group_removal_policy: typing.Optional[aws_cdk.RemovalPolicy] = pydantic.Field(None, description="The removal policy to apply to the cluster's security group. Cannot be set to ``SNAPSHOT``. Default: - ``RemovalPolicy.DESTROY`` when ``removalPolicy`` is set to ``SNAPSHOT``, ``removalPolicy`` otherwise.\n")
    ...
    _init_params: typing.ClassVar[list[str]] = ['instance_type', 'master_user', 'vpc', 'backup', 'ca_certificate', 'cloud_watch_logs_retention', 'cloud_watch_logs_retention_role', 'copy_tags_to_snapshot', 'db_cluster_name', 'deletion_protection', 'enable_performance_insights', 'engine_version', 'export_audit_logs_to_cloud_watch', 'export_profiler_logs_to_cloud_watch', 'instance_identifier_base', 'instance_removal_policy', 'instances', 'kms_key', 'parameter_group', 'port', 'preferred_maintenance_window', 'removal_policy', 'security_group', 'security_group_removal_policy', 'storage_encrypted', 'vpc_subnets']
...
class DatabaseInstanceDef(BaseConstruct):
    ...
    ca_certificate: typing.Optional[models.aws_rds.CaCertificateDef] = pydantic.Field(None, description='The identifier of the CA certificate for this DB instance. Specifying or updating this property triggers a reboot. Default: - DocumentDB will choose a certificate authority\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['cluster', 'instance_type', 'auto_minor_version_upgrade', 'availability_zone', 'ca_certificate', 'db_instance_name', 'enable_performance_insights', 'preferred_maintenance_window', 'removal_policy']
    _method_names: typing.ClassVar[list[str]] = ['apply_removal_policy']
...
class CfnDBClusterDef(BaseCfnResource):
    ...
    storage_type: typing.Optional[str] = pydantic.Field(None, description="The storage type to associate with the DB cluster. For information on storage types for Amazon DocumentDB clusters, see Cluster storage configurations in the *Amazon DocumentDB Developer Guide* . Valid values for storage type - ``standard | iopt1`` Default value is ``standard`` .. epigraph:: When you create a DocumentDB DB cluster with the storage type set to ``iopt1`` , the storage type is returned in the response. The storage type isn't returned when you set it to ``standard`` .\n")
...
class CfnDBInstanceDef(BaseCfnResource):
    ...
    _init_params: typing.ClassVar[list[str]] = ['db_cluster_identifier', 'db_instance_class', 'auto_minor_version_upgrade', 'availability_zone', 'ca_certificate_identifier', 'certificate_rotation_restart', 'db_instance_identifier', 'enable_performance_insights', 'preferred_maintenance_window', 'tags']
    _method_names: typing.ClassVar[list[str]] = ['add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
#  autogenerated from aws_cdk.aws_docdb.CfnEventSubscription
class CfnEventSubscriptionDef(BaseCfnResource):
    sns_topic_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Amazon Resource Name (ARN) of the SNS topic created for event notification. Amazon SNS creates the ARN when you create a topic and subscribe to it.\n')
    enabled: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='A Boolean value; set to ``true`` to activate the subscription, set to ``false`` to create the subscription but not active it.\n')
    event_categories: typing.Optional[typing.Sequence[str]] = pydantic.Field(None, description='A list of event categories for a ``SourceType`` that you want to subscribe to.\n')
    ...
    source_type: typing.Optional[str] = pydantic.Field(None, description='The type of source that is generating the events. For example, if you want to be notified of events generated by an instance, you would set this parameter to ``db-instance`` . If this value is not specified, all events are returned. Valid values: ``db-instance`` , ``db-cluster`` , ``db-parameter-group`` , ``db-security-group`` , ``db-cluster-snapshot``\n')
    subscription_name: typing.Optional[str] = pydantic.Field(None, description='The name of the subscription. Constraints: The name must be fewer than 255 characters.')
    _init_params: typing.ClassVar[list[str]] = ['sns_topic_arn', 'enabled', 'event_categories', 'source_ids', 'source_type', 'subscription_name']
    _method_names: typing.ClassVar[list[str]] = ['add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_docdb.CfnEventSubscription'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...


    resource_config: typing.Optional[models.aws_docdb.CfnEventSubscriptionDefConfig] = pydantic.Field(None)


class CfnEventSubscriptionDefConfig(pydantic.BaseModel):
    add_deletion_override: typing.Optional[list[models.aws_docdb.CfnEventSubscriptionDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_docdb.CfnEventSubscriptionDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_docdb.CfnEventSubscriptionDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_docdb.CfnEventSubscriptionDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_docdb.CfnEventSubscriptionDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_docdb.CfnEventSubscriptionDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_docdb.CfnEventSubscriptionDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_docdb.CfnEventSubscriptionDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_docdb.CfnEventSubscriptionDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_docdb.CfnEventSubscriptionDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_docdb.CfnEventSubscriptionDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_docdb.CfnEventSubscriptionDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_docdb.CfnEventSubscriptionDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
#  autogenerated from aws_cdk.aws_docdb.CfnEventSubscriptionProps
class CfnEventSubscriptionPropsDef(BaseCfnProperty):
    ...
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_docdb.CfnEventSubscriptionProps'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class ModuleModel(pydantic.BaseModel):
    CaCertificate: typing.Optional[dict[str, models.aws_docdb.CaCertificateDef]] = pydantic.Field(None)
    ...
    CfnEventSubscription: typing.Optional[dict[str, models.aws_docdb.CfnEventSubscriptionDef]] = pydantic.Field(None)
    ...
    CfnEventSubscriptionProps: typing.Optional[dict[str, models.aws_docdb.CfnEventSubscriptionPropsDef]] = pydantic.Field(None)
    ...
