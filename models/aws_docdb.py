...
class EndpointDef(BaseClass):
    address: str = pydantic.Field(..., description='- The hostname or address of the endpoint.\n')
    port: typing.Union[int, float] = pydantic.Field(..., description='- The port number of the endpoint.')
    ...
    resource_config: typing.Optional[EndpointDefConfig] = pydantic.Field(None)
...
class ClusterParameterGroupDef(BaseConstruct):
    family: str = pydantic.Field(..., description='Database family of this parameter group.\n')
    parameters: typing.Mapping[str, str] = pydantic.Field(..., description='The parameters in this parameter group.\n')
    ...
    from_parameter_group_name: typing.Optional[ClusterParameterGroupDefFromParameterGroupNameParams] = pydantic.Field(None, description='Imports a parameter group.')
    resource_config: typing.Optional[ClusterParameterGroupDefConfig] = pydantic.Field(None)
...
class DatabaseClusterDef(BaseConstruct):
    instance_type: models.aws_ec2.InstanceTypeDef = pydantic.Field(..., description='What type of instance to start for the replicas.\n')
    master_user: typing.Union[models.aws_docdb.LoginDef, dict[str, typing.Any]] = pydantic.Field(..., description='Username and password for the administrative user.\n')
    vpc: typing.Union[models.aws_ec2.VpcDef] = pydantic.Field(..., description='What subnets to run the DocumentDB instances in. Must be at least 2 subnets in two different AZs.\n')
...
class DatabaseClusterDefConfig(pydantic.BaseModel):
    ...
    add_security_groups: typing.Optional[list[DatabaseClusterDefAddSecurityGroupsParams]] = pydantic.Field(None, description='Adds security groups to this cluster.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
...
class DatabaseInstanceDef(BaseConstruct):
    cluster: typing.Union[models.aws_docdb.DatabaseClusterDef] = pydantic.Field(..., description='The DocumentDB database cluster the instance should launch into.\n')
...
class DatabaseClusterPropsDef(BaseStruct):
    ...
    resource_config: typing.Optional[DatabaseClusterPropsDefConfig] = pydantic.Field(None)
...
class CfnDBClusterDef(BaseCfnResource):
    ...
    copy_tags_to_snapshot: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description='``AWS::DocDB::DBCluster.CopyTagsToSnapshot``.\n')
    ...
    deletion_protection: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description='Protects clusters from being accidentally deleted. If enabled, the cluster cannot be deleted unless it is modified and ``DeletionProtection`` is disabled.\n')
    ...
    restore_to_time: typing.Optional[str] = pydantic.Field(None, description='``AWS::DocDB::DBCluster.RestoreToTime``.\n')
    restore_type: typing.Optional[str] = pydantic.Field(None, description='``AWS::DocDB::DBCluster.RestoreType``.\n')
    ...
    source_db_cluster_identifier: typing.Optional[str] = pydantic.Field(None, description='``AWS::DocDB::DBCluster.SourceDBClusterIdentifier``.\n')
    storage_encrypted: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description='Specifies whether the cluster is encrypted.\n')
    ...
    use_latest_restorable_time: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description='``AWS::DocDB::DBCluster.UseLatestRestorableTime``.\n')
...
class CfnDBClusterParameterGroupDef(BaseCfnResource):
    description: str = pydantic.Field(..., description='The description for the cluster parameter group.\n')
    family: str = pydantic.Field(..., description='The cluster parameter group family name.\n')
    parameters: typing.Any = pydantic.Field(..., description='Provides a list of parameters for the cluster parameter group.\n')
...
class CfnDBInstanceDef(BaseCfnResource):
    db_cluster_identifier: str = pydantic.Field(..., description='The identifier of the cluster that the instance will belong to.\n')
    db_instance_class: str = pydantic.Field(..., description="The compute and memory capacity of the instance; for example, ``db.m4.large`` . If you change the class of an instance there can be some interruption in the cluster's service.\n")
    auto_minor_version_upgrade: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description='This parameter does not apply to Amazon DocumentDB. Amazon DocumentDB does not perform minor version upgrades regardless of the value set. Default: ``false``\n')
    ...
    enable_performance_insights: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description='``AWS::DocDB::DBInstance.EnablePerformanceInsights``.\n')
...
class CfnDBSubnetGroupDef(BaseCfnResource):
    db_subnet_group_description: str = pydantic.Field(..., description='The description for the subnet group.\n')
    subnet_ids: typing.Sequence[str] = pydantic.Field(..., description='The Amazon EC2 subnet IDs for the subnet group.\n')
...
class ModuleModel(pydantic.BaseModel):
    ...
    ClusterParameterGroup: typing.Optional[dict[str, ClusterParameterGroupDef]] = pydantic.Field(None)
    ...
    ClusterParameterGroupProps: typing.Optional[dict[str, ClusterParameterGroupPropsDef]] = pydantic.Field(None)
    ...
    Login: typing.Optional[dict[str, LoginDef]] = pydantic.Field(None)
