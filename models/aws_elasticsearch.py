...
class DomainDef(BaseConstruct, ConnectableMixin):
    version: typing.Union[models.aws_elasticsearch.ElasticsearchVersionDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='(deprecated) The Elasticsearch version that your domain will leverage.\n')
...
class CfnDomain_AdvancedSecurityOptionsInputPropertyDef(BaseStruct):
    ...
    enabled: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='True to enable fine-grained access control. You must also enable encryption of data at rest and node-to-node encryption.\n')
...
class CfnDomain_ColdStorageOptionsPropertyDef(BaseStruct):
    enabled: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='Whether to enable or disable cold storage on the domain. You must enable UltraWarm storage in order to enable cold storage.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-elasticsearch-domain-coldstorageoptions.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_elasticsearch as elasticsearch\n\n    cold_storage_options_property = elasticsearch.CfnDomain.ColdStorageOptionsProperty(\n        enabled=False\n    )\n')
...
class CfnDomain_DomainEndpointOptionsPropertyDef(BaseStruct):
    ...
    enforce_https: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='True to require that all traffic to the domain arrive over HTTPS.\n')
...
class CfnDomain_ElasticsearchClusterConfigPropertyDef(BaseStruct):
    cold_storage_options: typing.Union[models.UnsupportedResource, models.aws_elasticsearch.CfnDomain_ColdStorageOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Specifies cold storage options for the domain.\n')
    ...
    warm_enabled: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='Whether to enable warm storage for the cluster.\n')
    ...
    zone_awareness_config: typing.Union[models.UnsupportedResource, models.aws_elasticsearch.CfnDomain_ZoneAwarenessConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Specifies zone awareness configuration options. Only use if ``ZoneAwarenessEnabled`` is ``true`` .\n')
...
class CfnDomain_EncryptionAtRestOptionsPropertyDef(BaseStruct):
    enabled: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='Specify ``true`` to enable encryption at rest.\n')
...
class CognitoOptionsDef(BaseStruct):
    identity_pool_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='(deprecated) The Amazon Cognito identity pool ID that you want Amazon ES to use for Kibana authentication.\n')
    role: typing.Union[_REQUIRED_INIT_PARAM, models.aws_iam.LazyRoleDef, models.aws_iam.RoleDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='(deprecated) A role that allows Amazon ES to configure your user pool and identity pool. It must have the ``AmazonESCognitoAccess`` policy attached to it.\n')
    user_pool_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='(deprecated) The Amazon Cognito user pool ID that you want Amazon ES to use for Kibana authentication.\n\n:deprecated: use opensearchservice module instead\n\n:see: https://docs.aws.amazon.com/elasticsearch-service/latest/developerguide/es-cognito-auth.html\n:stability: deprecated\n:exampleMetadata: fixture=migrate-opensearch infused\n\nExample::\n\n    es.Domain(self, "Domain",\n        cognito_kibana_auth=es.CognitoOptions(\n            identity_pool_id="test-identity-pool-id",\n            user_pool_id="test-user-pool-id",\n            role=role\n        ),\n        version=elasticsearch_version\n    )\n')
...
class CustomEndpointOptionsDef(BaseStruct):
    domain_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='(deprecated) The custom domain name to assign.\n')
...
class DomainAttributesDef(BaseStruct):
    domain_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='(deprecated) The ARN of the Elasticsearch domain.\n')
    domain_endpoint: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='(deprecated) The domain endpoint of the Elasticsearch domain.\n\n:deprecated: use opensearchservice module instead\n\n:stability: deprecated\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_elasticsearch as elasticsearch\n\n    domain_attributes = elasticsearch.DomainAttributes(\n        domain_arn="domainArn",\n        domain_endpoint="domainEndpoint"\n    )\n')
...
class CfnDomainDef(BaseCfnResource):
    ...
    advanced_security_options: typing.Union[models.UnsupportedResource, models.aws_elasticsearch.CfnDomain_AdvancedSecurityOptionsInputPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Specifies options for fine-grained access control.\n')
    cognito_options: typing.Union[models.UnsupportedResource, models.aws_elasticsearch.CfnDomain_CognitoOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Configures OpenSearch Service to use Amazon Cognito authentication for OpenSearch Dashboards.\n')
    domain_arn: typing.Optional[str] = pydantic.Field(None, description='')
    domain_endpoint_options: typing.Union[models.UnsupportedResource, models.aws_elasticsearch.CfnDomain_DomainEndpointOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Specifies additional options for the domain endpoint, such as whether to require HTTPS for all traffic or whether to use a custom endpoint rather than the default endpoint.\n')
    ...
    encryption_at_rest_options: typing.Union[models.UnsupportedResource, models.aws_elasticsearch.CfnDomain_EncryptionAtRestOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Whether the domain should encrypt data at rest, and if so, the AWS Key Management Service key to use. See `Encryption of data at rest for Amazon OpenSearch Service <https://docs.aws.amazon.com/opensearch-service/latest/developerguide/encryption-at-rest.html>`_ .\n')
    log_publishing_options: typing.Union[models.UnsupportedResource, typing.Mapping[str, typing.Union[models.UnsupportedResource, models.aws_elasticsearch.CfnDomain_LogPublishingOptionPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='An object with one or more of the following keys: ``SEARCH_SLOW_LOGS`` , ``ES_APPLICATION_LOGS`` , ``INDEX_SLOW_LOGS`` , ``AUDIT_LOGS`` , depending on the types of logs you want to publish. Each key needs a valid ``LogPublishingOption`` value.\n')
    node_to_node_encryption_options: typing.Union[models.UnsupportedResource, models.aws_elasticsearch.CfnDomain_NodeToNodeEncryptionOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Specifies whether node-to-node encryption is enabled. See `Node-to-node encryption for Amazon OpenSearch Service <https://docs.aws.amazon.com/opensearch-service/latest/developerguide/ntn.html>`_ .\n')
    snapshot_options: typing.Union[models.UnsupportedResource, models.aws_elasticsearch.CfnDomain_SnapshotOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='*DEPRECATED* . The automated snapshot configuration for the OpenSearch Service domain indices.\n')
...
class CfnDomainDefAdvancedsecurityoptionsinputpropertyParams(pydantic.BaseModel):
    ...
    master_user_options: typing.Union[models.UnsupportedResource, models.aws_elasticsearch.CfnDomain_MasterUserOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnDomainDefElasticsearchclusterconfigpropertyParams(pydantic.BaseModel):
    cold_storage_options: typing.Union[models.UnsupportedResource, models.aws_elasticsearch.CfnDomain_ColdStorageOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
    zone_awareness_config: typing.Union[models.UnsupportedResource, models.aws_elasticsearch.CfnDomain_ZoneAwarenessConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
