...
#  autogenerated from aws_cdk.aws_iottwinmaker.CfnComponentType.CompositeComponentTypeProperty
class CfnComponentType_CompositeComponentTypePropertyDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['component_type_id']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_iottwinmaker.CfnComponentType.CompositeComponentTypeProperty'
...
class CfnComponentType_PropertyDefinitionPropertyDef(BaseStruct):
    ...
    is_external_id: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='A Boolean value that specifies whether the property ID comes from an external data source.\n')
...
#  autogenerated from aws_cdk.aws_iottwinmaker.CfnEntity.CompositeComponentProperty
class CfnEntity_CompositeComponentPropertyDef(BaseStruct):
    component_name: typing.Optional[str] = pydantic.Field(None, description='The name of the component.\n')
    component_path: typing.Optional[str] = pydantic.Field(None, description='The path to the composite component, starting from the top-level component.\n')
    component_type_id: typing.Optional[str] = pydantic.Field(None, description='The ID of the composite component type.\n')
    description: typing.Optional[str] = pydantic.Field(None, description='The description of the component type.\n')
    properties: typing.Union[models.UnsupportedResource, typing.Mapping[str, typing.Union[models.UnsupportedResource, models.aws_iottwinmaker.CfnEntity_PropertyPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='Map of strings to the properties in the component type. Each string in the mapping must be unique to this component.\n')
    property_groups: typing.Union[models.UnsupportedResource, typing.Mapping[str, typing.Union[models.UnsupportedResource, models.aws_iottwinmaker.CfnEntity_PropertyGroupPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The property groups.\n')
    status: typing.Union[models.UnsupportedResource, models.aws_iottwinmaker.CfnEntity_StatusPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The current status of the composite component.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iottwinmaker-entity-compositecomponent.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_iottwinmaker as iottwinmaker\n\n    # data_value_property_: iottwinmaker.CfnEntity.DataValueProperty\n    # definition: Any\n    # error: Any\n    # relationship_value: Any\n\n    composite_component_property = iottwinmaker.CfnEntity.CompositeComponentProperty(\n        component_name="componentName",\n        component_path="componentPath",\n        component_type_id="componentTypeId",\n        description="description",\n        properties={\n            "properties_key": iottwinmaker.CfnEntity.PropertyProperty(\n                definition=definition,\n                value=iottwinmaker.CfnEntity.DataValueProperty(\n                    boolean_value=False,\n                    double_value=123,\n                    expression="expression",\n                    integer_value=123,\n                    list_value=[data_value_property_],\n                    long_value=123,\n                    map_value={\n                        "map_value_key": data_value_property_\n                    },\n                    relationship_value=relationship_value,\n                    string_value="stringValue"\n                )\n            )\n        },\n        property_groups={\n            "property_groups_key": iottwinmaker.CfnEntity.PropertyGroupProperty(\n                group_type="groupType",\n                property_names=["propertyNames"]\n            )\n        },\n        status=iottwinmaker.CfnEntity.StatusProperty(\n            error=error,\n            state="state"\n        )\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['component_name', 'component_path', 'component_type_id', 'description', 'properties', 'property_groups', 'status']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_iottwinmaker.CfnEntity.CompositeComponentProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class CfnComponentTypeDef(BaseCfnResource):
    ...
    composite_component_types: typing.Union[models.UnsupportedResource, typing.Mapping[str, typing.Union[models.UnsupportedResource, models.aws_iottwinmaker.CfnComponentType_CompositeComponentTypePropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='Maps strings to ``compositeComponentTypes`` of the ``componentType`` . ``CompositeComponentType`` is referenced by ``componentTypeId`` .\n')
    description: typing.Optional[str] = pydantic.Field(None, description='The description of the component type.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['component_type_id', 'workspace_id', 'composite_component_types', 'description', 'extends_from', 'functions', 'is_singleton', 'property_definitions', 'property_groups', 'tags']
    _method_names: typing.ClassVar[list[str]] = ['CompositeComponentTypeProperty', 'DataConnectorProperty', 'DataTypeProperty', 'DataValueProperty', 'ErrorProperty', 'FunctionProperty', 'LambdaFunctionProperty', 'PropertyDefinitionProperty', 'PropertyGroupProperty', 'RelationshipProperty', 'RelationshipValueProperty', 'StatusProperty', 'add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnComponentTypeDefConfig(pydantic.BaseModel):
    CompositeComponentTypeProperty: typing.Optional[list[models.aws_iottwinmaker.CfnComponentTypeDefCompositecomponenttypepropertyParams]] = pydantic.Field(None, description='')
...
class CfnComponentTypeDefCompositecomponenttypepropertyParams(pydantic.BaseModel):
...
class CfnEntityDef(BaseCfnResource):
    ...
    workspace_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The ID of the workspace that contains the entity.\n')
    ...
    composite_components: typing.Union[models.UnsupportedResource, typing.Mapping[str, typing.Union[models.UnsupportedResource, models.aws_iottwinmaker.CfnEntity_CompositeComponentPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='Maps string to ``compositeComponent`` updates in the request. Each key of the map represents the ``componentPath`` of the ``compositeComponent`` .\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['entity_name', 'workspace_id', 'components', 'composite_components', 'description', 'entity_id', 'parent_entity_id', 'tags']
    _method_names: typing.ClassVar[list[str]] = ['ComponentProperty', 'CompositeComponentProperty', 'DataTypeProperty', 'DataValueProperty', 'DefinitionProperty', 'ErrorProperty', 'PropertyGroupProperty', 'PropertyProperty', 'RelationshipProperty', 'RelationshipValueProperty', 'StatusProperty', 'add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnEntityDefConfig(pydantic.BaseModel):
    ...
    CompositeComponentProperty: typing.Optional[list[models.aws_iottwinmaker.CfnEntityDefCompositecomponentpropertyParams]] = pydantic.Field(None, description='')
...
class CfnEntityDefCompositecomponentpropertyParams(pydantic.BaseModel):
    component_name: typing.Optional[str] = pydantic.Field(None, description='')
    component_path: typing.Optional[str] = pydantic.Field(None, description='')
    component_type_id: typing.Optional[str] = pydantic.Field(None, description='')
    description: typing.Optional[str] = pydantic.Field(None, description='')
    properties: typing.Union[models.UnsupportedResource, typing.Mapping[str, typing.Union[models.UnsupportedResource, models.aws_iottwinmaker.CfnEntity_PropertyPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    property_groups: typing.Union[models.UnsupportedResource, typing.Mapping[str, typing.Union[models.UnsupportedResource, models.aws_iottwinmaker.CfnEntity_PropertyGroupPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
...
class ModuleModel(pydantic.BaseModel):
    CfnComponentType_CompositeComponentTypeProperty: typing.Optional[dict[str, models.aws_iottwinmaker.CfnComponentType_CompositeComponentTypePropertyDef]] = pydantic.Field(None)
    ...
    CfnEntity_CompositeComponentProperty: typing.Optional[dict[str, models.aws_iottwinmaker.CfnEntity_CompositeComponentPropertyDef]] = pydantic.Field(None)
