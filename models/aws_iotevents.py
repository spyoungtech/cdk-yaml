...
class CfnAlarmModel_FirehosePropertyDef(BaseStruct):
    ...
    payload: typing.Union[models.UnsupportedResource, models.aws_iotevents.CfnAlarmModel_PayloadPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='You can configure the action payload when you send a message to an Amazon Kinesis Data Firehose delivery stream.\n')
...
class CfnDetectorModel_FirehosePropertyDef(BaseStruct):
    delivery_stream_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the Kinesis Data Firehose delivery stream where the data is written.\n')
    payload: typing.Union[models.UnsupportedResource, models.aws_iotevents.CfnDetectorModel_PayloadPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='You can configure the action payload when you send a message to an Amazon Kinesis Data Firehose delivery stream.\n')
...
class CfnAlarmModelDef(BaseCfnResource):
    ...
    resource_config: typing.Optional[CfnAlarmModelDefConfig] = pydantic.Field(None)


class CfnAlarmModelDefConfig(pydantic.BaseModel):
    AcknowledgeFlowProperty: typing.Optional[list[CfnAlarmModelDefAcknowledgeflowpropertyParams]] = pydantic.Field(None, description='')
    AlarmActionProperty: typing.Optional[list[CfnAlarmModelDefAlarmactionpropertyParams]] = pydantic.Field(None, description='')
    AlarmCapabilitiesProperty: typing.Optional[list[CfnAlarmModelDefAlarmcapabilitiespropertyParams]] = pydantic.Field(None, description='')
    AlarmEventActionsProperty: typing.Optional[list[CfnAlarmModelDefAlarmeventactionspropertyParams]] = pydantic.Field(None, description='')
    AlarmRuleProperty: typing.Optional[list[CfnAlarmModelDefAlarmrulepropertyParams]] = pydantic.Field(None, description='')
    AssetPropertyTimestampProperty: typing.Optional[list[CfnAlarmModelDefAssetpropertytimestamppropertyParams]] = pydantic.Field(None, description='')
    AssetPropertyValueProperty: typing.Optional[list[CfnAlarmModelDefAssetpropertyvaluepropertyParams]] = pydantic.Field(None, description='')
    AssetPropertyVariantProperty: typing.Optional[list[CfnAlarmModelDefAssetpropertyvariantpropertyParams]] = pydantic.Field(None, description='')
    DynamoDBProperty: typing.Optional[list[CfnAlarmModelDefDynamodbpropertyParams]] = pydantic.Field(None, description='')
    DynamoDBv2Property: typing.Optional[list[CfnAlarmModelDefDynamodbv2PropertyParams]] = pydantic.Field(None, description='')
    FirehoseProperty: typing.Optional[list[CfnAlarmModelDefFirehosepropertyParams]] = pydantic.Field(None, description='')
    InitializationConfigurationProperty: typing.Optional[list[CfnAlarmModelDefInitializationconfigurationpropertyParams]] = pydantic.Field(None, description='')
    IotEventsProperty: typing.Optional[list[CfnAlarmModelDefIoteventspropertyParams]] = pydantic.Field(None, description='')
    IotSiteWiseProperty: typing.Optional[list[CfnAlarmModelDefIotsitewisepropertyParams]] = pydantic.Field(None, description='')
    IotTopicPublishProperty: typing.Optional[list[CfnAlarmModelDefIottopicpublishpropertyParams]] = pydantic.Field(None, description='')
    LambdaProperty: typing.Optional[list[CfnAlarmModelDefLambdapropertyParams]] = pydantic.Field(None, description='')
    PayloadProperty: typing.Optional[list[CfnAlarmModelDefPayloadpropertyParams]] = pydantic.Field(None, description='')
    SimpleRuleProperty: typing.Optional[list[CfnAlarmModelDefSimplerulepropertyParams]] = pydantic.Field(None, description='')
    SnsProperty: typing.Optional[list[CfnAlarmModelDefSnspropertyParams]] = pydantic.Field(None, description='')
    SqsProperty: typing.Optional[list[CfnAlarmModelDefSqspropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[CfnAlarmModelDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[CfnAlarmModelDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[CfnAlarmModelDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[CfnAlarmModelDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[CfnAlarmModelDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[CfnAlarmModelDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[CfnAlarmModelDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[CfnAlarmModelDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[CfnAlarmModelDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[CfnAlarmModelDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[CfnAlarmModelDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[CfnAlarmModelDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[CfnAlarmModelDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
class CfnDetectorModelDef(BaseCfnResource):
    ...
    resource_config: typing.Optional[CfnDetectorModelDefConfig] = pydantic.Field(None)


class CfnDetectorModelDefConfig(pydantic.BaseModel):
    ActionProperty: typing.Optional[list[CfnDetectorModelDefActionpropertyParams]] = pydantic.Field(None, description='')
    AssetPropertyTimestampProperty: typing.Optional[list[CfnDetectorModelDefAssetpropertytimestamppropertyParams]] = pydantic.Field(None, description='')
    AssetPropertyValueProperty: typing.Optional[list[CfnDetectorModelDefAssetpropertyvaluepropertyParams]] = pydantic.Field(None, description='')
    AssetPropertyVariantProperty: typing.Optional[list[CfnDetectorModelDefAssetpropertyvariantpropertyParams]] = pydantic.Field(None, description='')
    ClearTimerProperty: typing.Optional[list[CfnDetectorModelDefCleartimerpropertyParams]] = pydantic.Field(None, description='')
    DetectorModelDefinitionProperty: typing.Optional[list[CfnDetectorModelDefDetectormodeldefinitionpropertyParams]] = pydantic.Field(None, description='')
    DynamoDBProperty: typing.Optional[list[CfnDetectorModelDefDynamodbpropertyParams]] = pydantic.Field(None, description='')
    DynamoDBv2Property: typing.Optional[list[CfnDetectorModelDefDynamodbv2PropertyParams]] = pydantic.Field(None, description='')
    EventProperty: typing.Optional[list[CfnDetectorModelDefEventpropertyParams]] = pydantic.Field(None, description='')
    FirehoseProperty: typing.Optional[list[CfnDetectorModelDefFirehosepropertyParams]] = pydantic.Field(None, description='')
    IotEventsProperty: typing.Optional[list[CfnDetectorModelDefIoteventspropertyParams]] = pydantic.Field(None, description='')
    IotSiteWiseProperty: typing.Optional[list[CfnDetectorModelDefIotsitewisepropertyParams]] = pydantic.Field(None, description='')
    IotTopicPublishProperty: typing.Optional[list[CfnDetectorModelDefIottopicpublishpropertyParams]] = pydantic.Field(None, description='')
    LambdaProperty: typing.Optional[list[CfnDetectorModelDefLambdapropertyParams]] = pydantic.Field(None, description='')
    OnEnterProperty: typing.Optional[list[CfnDetectorModelDefOnenterpropertyParams]] = pydantic.Field(None, description='')
    OnExitProperty: typing.Optional[list[CfnDetectorModelDefOnexitpropertyParams]] = pydantic.Field(None, description='')
    OnInputProperty: typing.Optional[list[CfnDetectorModelDefOninputpropertyParams]] = pydantic.Field(None, description='')
    PayloadProperty: typing.Optional[list[CfnDetectorModelDefPayloadpropertyParams]] = pydantic.Field(None, description='')
    ResetTimerProperty: typing.Optional[list[CfnDetectorModelDefResettimerpropertyParams]] = pydantic.Field(None, description='')
    SetTimerProperty: typing.Optional[list[CfnDetectorModelDefSettimerpropertyParams]] = pydantic.Field(None, description='')
    SetVariableProperty: typing.Optional[list[CfnDetectorModelDefSetvariablepropertyParams]] = pydantic.Field(None, description='')
    SnsProperty: typing.Optional[list[CfnDetectorModelDefSnspropertyParams]] = pydantic.Field(None, description='')
    SqsProperty: typing.Optional[list[CfnDetectorModelDefSqspropertyParams]] = pydantic.Field(None, description='')
    StateProperty: typing.Optional[list[CfnDetectorModelDefStatepropertyParams]] = pydantic.Field(None, description='')
    TransitionEventProperty: typing.Optional[list[CfnDetectorModelDefTransitioneventpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[CfnDetectorModelDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[CfnDetectorModelDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[CfnDetectorModelDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[CfnDetectorModelDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[CfnDetectorModelDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[CfnDetectorModelDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[CfnDetectorModelDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[CfnDetectorModelDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[CfnDetectorModelDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[CfnDetectorModelDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[CfnDetectorModelDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[CfnDetectorModelDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[CfnDetectorModelDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
    tags_config: typing.Optional[models.core.TagManagerDefConfig] = pydantic.Field(None)
...
class CfnInputDefConfig(pydantic.BaseModel):
    AttributeProperty: typing.Optional[list[CfnInputDefAttributepropertyParams]] = pydantic.Field(None, description='')
    InputDefinitionProperty: typing.Optional[list[CfnInputDefInputdefinitionpropertyParams]] = pydantic.Field(None, description='')
...
class ModuleModel(pydantic.BaseModel):
    CfnAlarmModel_AcknowledgeFlowProperty: typing.Optional[dict[str, CfnAlarmModel_AcknowledgeFlowPropertyDef]] = pydantic.Field(None)
    CfnAlarmModel_AlarmActionProperty: typing.Optional[dict[str, CfnAlarmModel_AlarmActionPropertyDef]] = pydantic.Field(None)
    CfnAlarmModel_AlarmCapabilitiesProperty: typing.Optional[dict[str, CfnAlarmModel_AlarmCapabilitiesPropertyDef]] = pydantic.Field(None)
    CfnAlarmModel_AlarmEventActionsProperty: typing.Optional[dict[str, CfnAlarmModel_AlarmEventActionsPropertyDef]] = pydantic.Field(None)
    CfnAlarmModel_AlarmRuleProperty: typing.Optional[dict[str, CfnAlarmModel_AlarmRulePropertyDef]] = pydantic.Field(None)
    CfnAlarmModel_AssetPropertyTimestampProperty: typing.Optional[dict[str, CfnAlarmModel_AssetPropertyTimestampPropertyDef]] = pydantic.Field(None)
    CfnAlarmModel_AssetPropertyValueProperty: typing.Optional[dict[str, CfnAlarmModel_AssetPropertyValuePropertyDef]] = pydantic.Field(None)
    CfnAlarmModel_AssetPropertyVariantProperty: typing.Optional[dict[str, CfnAlarmModel_AssetPropertyVariantPropertyDef]] = pydantic.Field(None)
    CfnAlarmModel_DynamoDBProperty: typing.Optional[dict[str, CfnAlarmModel_DynamoDBPropertyDef]] = pydantic.Field(None)
    CfnAlarmModel_DynamoDBv2Property: typing.Optional[dict[str, CfnAlarmModel_DynamoDBv2PropertyDef]] = pydantic.Field(None)
    CfnAlarmModel_FirehoseProperty: typing.Optional[dict[str, CfnAlarmModel_FirehosePropertyDef]] = pydantic.Field(None)
    CfnAlarmModel_InitializationConfigurationProperty: typing.Optional[dict[str, CfnAlarmModel_InitializationConfigurationPropertyDef]] = pydantic.Field(None)
    CfnAlarmModel_IotEventsProperty: typing.Optional[dict[str, CfnAlarmModel_IotEventsPropertyDef]] = pydantic.Field(None)
    CfnAlarmModel_IotSiteWiseProperty: typing.Optional[dict[str, CfnAlarmModel_IotSiteWisePropertyDef]] = pydantic.Field(None)
    CfnAlarmModel_IotTopicPublishProperty: typing.Optional[dict[str, CfnAlarmModel_IotTopicPublishPropertyDef]] = pydantic.Field(None)
    CfnAlarmModel_LambdaProperty: typing.Optional[dict[str, CfnAlarmModel_LambdaPropertyDef]] = pydantic.Field(None)
    CfnAlarmModel_PayloadProperty: typing.Optional[dict[str, CfnAlarmModel_PayloadPropertyDef]] = pydantic.Field(None)
    CfnAlarmModel_SimpleRuleProperty: typing.Optional[dict[str, CfnAlarmModel_SimpleRulePropertyDef]] = pydantic.Field(None)
    CfnAlarmModel_SnsProperty: typing.Optional[dict[str, CfnAlarmModel_SnsPropertyDef]] = pydantic.Field(None)
    CfnAlarmModel_SqsProperty: typing.Optional[dict[str, CfnAlarmModel_SqsPropertyDef]] = pydantic.Field(None)
    CfnDetectorModel_ActionProperty: typing.Optional[dict[str, CfnDetectorModel_ActionPropertyDef]] = pydantic.Field(None)
    CfnDetectorModel_AssetPropertyTimestampProperty: typing.Optional[dict[str, CfnDetectorModel_AssetPropertyTimestampPropertyDef]] = pydantic.Field(None)
    CfnDetectorModel_AssetPropertyValueProperty: typing.Optional[dict[str, CfnDetectorModel_AssetPropertyValuePropertyDef]] = pydantic.Field(None)
    CfnDetectorModel_AssetPropertyVariantProperty: typing.Optional[dict[str, CfnDetectorModel_AssetPropertyVariantPropertyDef]] = pydantic.Field(None)
    CfnDetectorModel_ClearTimerProperty: typing.Optional[dict[str, CfnDetectorModel_ClearTimerPropertyDef]] = pydantic.Field(None)
    CfnDetectorModel_DetectorModelDefinitionProperty: typing.Optional[dict[str, CfnDetectorModel_DetectorModelDefinitionPropertyDef]] = pydantic.Field(None)
    CfnDetectorModel_DynamoDBProperty: typing.Optional[dict[str, CfnDetectorModel_DynamoDBPropertyDef]] = pydantic.Field(None)
    CfnDetectorModel_DynamoDBv2Property: typing.Optional[dict[str, CfnDetectorModel_DynamoDBv2PropertyDef]] = pydantic.Field(None)
    CfnDetectorModel_EventProperty: typing.Optional[dict[str, CfnDetectorModel_EventPropertyDef]] = pydantic.Field(None)
    CfnDetectorModel_FirehoseProperty: typing.Optional[dict[str, CfnDetectorModel_FirehosePropertyDef]] = pydantic.Field(None)
    CfnDetectorModel_IotEventsProperty: typing.Optional[dict[str, CfnDetectorModel_IotEventsPropertyDef]] = pydantic.Field(None)
    CfnDetectorModel_IotSiteWiseProperty: typing.Optional[dict[str, CfnDetectorModel_IotSiteWisePropertyDef]] = pydantic.Field(None)
    CfnDetectorModel_IotTopicPublishProperty: typing.Optional[dict[str, CfnDetectorModel_IotTopicPublishPropertyDef]] = pydantic.Field(None)
    CfnDetectorModel_LambdaProperty: typing.Optional[dict[str, CfnDetectorModel_LambdaPropertyDef]] = pydantic.Field(None)
    CfnDetectorModel_OnEnterProperty: typing.Optional[dict[str, CfnDetectorModel_OnEnterPropertyDef]] = pydantic.Field(None)
    CfnDetectorModel_OnExitProperty: typing.Optional[dict[str, CfnDetectorModel_OnExitPropertyDef]] = pydantic.Field(None)
    CfnDetectorModel_OnInputProperty: typing.Optional[dict[str, CfnDetectorModel_OnInputPropertyDef]] = pydantic.Field(None)
    CfnDetectorModel_PayloadProperty: typing.Optional[dict[str, CfnDetectorModel_PayloadPropertyDef]] = pydantic.Field(None)
    CfnDetectorModel_ResetTimerProperty: typing.Optional[dict[str, CfnDetectorModel_ResetTimerPropertyDef]] = pydantic.Field(None)
    CfnDetectorModel_SetTimerProperty: typing.Optional[dict[str, CfnDetectorModel_SetTimerPropertyDef]] = pydantic.Field(None)
    CfnDetectorModel_SetVariableProperty: typing.Optional[dict[str, CfnDetectorModel_SetVariablePropertyDef]] = pydantic.Field(None)
    CfnDetectorModel_SnsProperty: typing.Optional[dict[str, CfnDetectorModel_SnsPropertyDef]] = pydantic.Field(None)
    CfnDetectorModel_SqsProperty: typing.Optional[dict[str, CfnDetectorModel_SqsPropertyDef]] = pydantic.Field(None)
    CfnDetectorModel_StateProperty: typing.Optional[dict[str, CfnDetectorModel_StatePropertyDef]] = pydantic.Field(None)
    CfnDetectorModel_TransitionEventProperty: typing.Optional[dict[str, CfnDetectorModel_TransitionEventPropertyDef]] = pydantic.Field(None)
    CfnInput_AttributeProperty: typing.Optional[dict[str, CfnInput_AttributePropertyDef]] = pydantic.Field(None)
    CfnInput_InputDefinitionProperty: typing.Optional[dict[str, CfnInput_InputDefinitionPropertyDef]] = pydantic.Field(None)
    CfnAlarmModel: typing.Optional[dict[str, CfnAlarmModelDef]] = pydantic.Field(None)
    CfnDetectorModel: typing.Optional[dict[str, CfnDetectorModelDef]] = pydantic.Field(None)
    CfnInput: typing.Optional[dict[str, CfnInputDef]] = pydantic.Field(None)
    CfnAlarmModelProps: typing.Optional[dict[str, CfnAlarmModelPropsDef]] = pydantic.Field(None)
    CfnDetectorModelProps: typing.Optional[dict[str, CfnDetectorModelPropsDef]] = pydantic.Field(None)
