...
class CfnNotificationRuleDef(BaseCfnResource):
    ...
    targets: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_codestarnotifications.CfnNotificationRule_TargetPropertyDef, dict[str, typing.Any]]]] = pydantic.Field(REQUIRED_INIT_PARAM, description='A list of Amazon Resource Names (ARNs) of Amazon SNS topics and AWS Chatbot clients to associate with the notification rule.\n')
    created_by: typing.Optional[str] = pydantic.Field(None, description='The name or email alias of the person who created the notification rule.\n')
    event_type_id: typing.Optional[str] = pydantic.Field(None, description='The event type associated with this notification rule. For a complete list of event types and IDs, see `Notification concepts <https://docs.aws.amazon.com/dtconsole/latest/userguide/concepts.html#concepts-api>`_ in the *Developer Tools Console User Guide* .\n')
    ...
    target_address: typing.Optional[str] = pydantic.Field(None, description='The Amazon Resource Name (ARN) of the Amazon SNS topic or AWS Chatbot client.')
