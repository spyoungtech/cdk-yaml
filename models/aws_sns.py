...
class FilterDef(BaseClass):
    filter_doc: typing.Union[models.aws_sns.SubscriptionFilterDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='filter argument to construct.')
...
class PolicyDef(BaseClass):
    policy_doc: typing.Union[typing.Mapping[str, models.aws_sns.FilterOrPolicyDef], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='policy argument to construct.')
...
class SubscriptionFilterDefStringFilterParams(pydantic.BaseModel):
    ...
    match_suffixes: typing.Optional[typing.Sequence[str]] = pydantic.Field(None, description='Matches values that end with the specified suffixes. Default: - None')
    return_config: typing.Optional[list[models.aws_sns.SubscriptionFilterDefConfig]] = pydantic.Field(None)
    ...
...
class TopicBaseDef(BaseClass):
    ...
    _method_names: typing.ClassVar[list[str]] = ['add_subscription', 'add_to_resource_policy', 'apply_removal_policy', 'bind_as_notification_rule_target', 'grant_publish', 'grant_subscribe', 'metric', 'metric_number_of_messages_published', 'metric_number_of_notifications_delivered', 'metric_number_of_notifications_failed', 'metric_number_of_notifications_filtered_out', 'metric_number_of_notifications_filtered_out_invalid_attributes', 'metric_number_of_notifications_filtered_out_no_message_attributes', 'metric_publish_size', 'metric_sms_month_to_date_spent_usd', 'metric_sms_success_rate']
...
class TopicBaseDefConfig(pydantic.BaseModel):
    ...
    grant_subscribe: typing.Optional[list[models.aws_sns.TopicBaseDefGrantSubscribeParams]] = pydantic.Field(None, description='Grant topic subscribing permissions to the given identity.')
...
class TopicBaseDefGrantSubscribeParams(pydantic.BaseModel):
    grantee: models.AnyResource = pydantic.Field(..., description='-')
    return_config: typing.Optional[list[models.aws_iam.GrantDefConfig]] = pydantic.Field(None)
    ...
...
class SubscriptionDef(BaseConstruct):
    topic: typing.Union[_REQUIRED_INIT_PARAM, models.aws_sns.TopicBaseDef, models.aws_sns.TopicDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The topic to subscribe to.\n')
    endpoint: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description="The subscription endpoint. The meaning of this value depends on the value for 'protocol'.\n")
    protocol: typing.Union[aws_cdk.aws_sns.SubscriptionProtocol, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='What type of subscription to add.\n')
...
class TopicDef(BaseConstruct):
    ...
    enforce_ssl: typing.Optional[bool] = pydantic.Field(None, description='Adds a statement to enforce encryption of data in transit when publishing to the topic. Default: false\n')
    fifo: typing.Optional[bool] = pydantic.Field(None, description='Set to true to create a FIFO topic. Default: None\n')
    logging_configs: typing.Optional[typing.Sequence[typing.Union[models.aws_sns.LoggingConfigDef, dict[str, typing.Any]]]] = pydantic.Field(None, description='The list of delivery status logging configurations for the topic. Default: None\n')
    ...
    message_retention_period_in_days: typing.Union[int, float, None] = pydantic.Field(None, description='The number of days Amazon SNS retains messages. It can only be set for FIFO topics. Default: - do not archive messages\n')
    signature_version: typing.Optional[str] = pydantic.Field(None, description='The signature version corresponds to the hashing algorithm used while creating the signature of the notifications, subscription confirmations, or unsubscribe confirmation messages sent by Amazon SNS. Default: 1\n')
    ...
    tracing_config: typing.Optional[aws_cdk.aws_sns.TracingConfig] = pydantic.Field(None, description='Tracing mode of an Amazon SNS topic. Default: TracingConfig.PASS_THROUGH')
    _init_params: typing.ClassVar[list[str]] = ['content_based_deduplication', 'display_name', 'enforce_ssl', 'fifo', 'logging_configs', 'master_key', 'message_retention_period_in_days', 'signature_version', 'topic_name', 'tracing_config']
    _method_names: typing.ClassVar[list[str]] = ['add_logging_config', 'add_subscription', 'add_to_resource_policy', 'apply_removal_policy', 'bind_as_notification_rule_target', 'grant_publish', 'grant_subscribe', 'metric', 'metric_number_of_messages_published', 'metric_number_of_notifications_delivered', 'metric_number_of_notifications_failed', 'metric_number_of_notifications_filtered_out', 'metric_number_of_notifications_filtered_out_invalid_attributes', 'metric_number_of_notifications_filtered_out_no_message_attributes', 'metric_publish_size', 'metric_sms_month_to_date_spent_usd', 'metric_sms_success_rate']
    _classmethod_names: typing.ClassVar[list[str]] = ['from_topic_arn', 'from_topic_attributes']
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_sns.Topic'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = ['from_topic_arn', 'from_topic_attributes']
    ...
    ...
    from_topic_attributes: typing.Optional[models.aws_sns.TopicDefFromTopicAttributesParams] = pydantic.Field(None, description='Import an existing SNS topic provided a topic attributes.')
    resource_config: typing.Optional[models.aws_sns.TopicDefConfig] = pydantic.Field(None)


class TopicDefConfig(pydantic.BaseModel):
    add_logging_config: typing.Optional[list[models.aws_sns.TopicDefAddLoggingConfigParams]] = pydantic.Field(None, description='Adds a delivery status logging configuration to the topic.')
    ...
    grant_subscribe: typing.Optional[list[models.aws_sns.TopicDefGrantSubscribeParams]] = pydantic.Field(None, description='Grant topic subscribing permissions to the given identity.')
...
class TopicDefAddLoggingConfigParams(pydantic.BaseModel):
    protocol: aws_cdk.aws_sns.LoggingProtocol = pydantic.Field(..., description='Indicates one of the supported protocols for the SNS topic.\n')
    failure_feedback_role: typing.Optional[typing.Union[models.aws_iam.LazyRoleDef, models.aws_iam.RoleDef]] = pydantic.Field(None, description='The IAM role to be used when logging failed message deliveries in Amazon CloudWatch. Default: None\n')
    success_feedback_role: typing.Optional[typing.Union[models.aws_iam.LazyRoleDef, models.aws_iam.RoleDef]] = pydantic.Field(None, description='The IAM role to be used when logging successful message deliveries in Amazon CloudWatch. Default: None\n')
    success_feedback_sample_rate: typing.Union[int, float, None] = pydantic.Field(None, description='The percentage of successful message deliveries to be logged in Amazon CloudWatch. Valid values are integer between 0-100 Default: None')
    ...
...
class TopicDefFromTopicAttributesParams(pydantic.BaseModel):
    scope: models.constructs.ConstructDef = pydantic.Field(..., description='The parent creating construct.\n')
    id: str = pydantic.Field(..., description="The construct's name.\n")
    topic_arn: str = pydantic.Field(..., description='The ARN of the SNS topic.\n')
    content_based_deduplication: typing.Optional[bool] = pydantic.Field(None, description='Whether content-based deduplication is enabled. Only applicable for FIFO topics. Default: false')
    ...
...
class TopicDefGrantSubscribeParams(pydantic.BaseModel):
    grantee: models.AnyResource = pydantic.Field(..., description='-')
    return_config: typing.Optional[list[models.aws_iam.GrantDefConfig]] = pydantic.Field(None)
    ...
...
class TopicPolicyDef(BaseConstruct):
    topics: typing.Union[typing.Sequence[typing.Union[models.aws_sns.TopicBaseDef, models.aws_sns.TopicDef]], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The set of topics this policy applies to.\n')
    enforce_ssl: typing.Optional[bool] = pydantic.Field(None, description='Adds a statement to enforce encryption of data in transit when publishing to the topic. For more information, see https://docs.aws.amazon.com/sns/latest/dg/sns-security-best-practices.html#enforce-encryption-data-in-transit. Default: false\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['topics', 'enforce_ssl', 'policy_document']
    _method_names: typing.ClassVar[list[str]] = ['apply_removal_policy']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
#  autogenerated from aws_cdk.aws_sns.CfnTopic.LoggingConfigProperty
class CfnTopic_LoggingConfigPropertyDef(BaseStruct):
    protocol: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Indicates one of the supported protocols for the Amazon SNS topic. .. epigraph:: At least one of the other three ``LoggingConfig`` properties is recommend along with ``Protocol`` .\n')
    failure_feedback_role_arn: typing.Optional[str] = pydantic.Field(None, description='The IAM role ARN to be used when logging failed message deliveries in Amazon CloudWatch.\n')
    success_feedback_role_arn: typing.Optional[str] = pydantic.Field(None, description='The IAM role ARN to be used when logging successful message deliveries in Amazon CloudWatch.\n')
    success_feedback_sample_rate: typing.Optional[str] = pydantic.Field(None, description='The percentage of successful message deliveries to be logged in Amazon CloudWatch. Valid percentage values range from 0 to 100.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sns-topic-loggingconfig.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_sns as sns\n\n    logging_config_property = sns.CfnTopic.LoggingConfigProperty(\n        protocol="protocol",\n\n        # the properties below are optional\n        failure_feedback_role_arn="failureFeedbackRoleArn",\n        success_feedback_role_arn="successFeedbackRoleArn",\n        success_feedback_sample_rate="successFeedbackSampleRate"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['protocol', 'failure_feedback_role_arn', 'success_feedback_role_arn', 'success_feedback_sample_rate']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_sns.CfnTopic.LoggingConfigProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class CfnTopic_SubscriptionPropertyDef(BaseStruct):
    endpoint: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The endpoint that receives notifications from the Amazon SNS topic. The endpoint value depends on the protocol that you specify. For more information, see the ``Endpoint`` parameter of the ``[Subscribe](https://docs.aws.amazon.com/sns/latest/api/API_Subscribe.html)`` action in the *Amazon SNS API Reference* .\n')
    protocol: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The subscription\'s protocol. For more information, see the ``Protocol`` parameter of the ``[Subscribe](https://docs.aws.amazon.com/sns/latest/api/API_Subscribe.html)`` action in the *Amazon SNS API Reference* .\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sns-topic-subscription.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_sns as sns\n\n    subscription_property = sns.CfnTopic.SubscriptionProperty(\n        endpoint="endpoint",\n        protocol="protocol"\n    )\n')
...
#  autogenerated from aws_cdk.aws_sns.LoggingConfig
class LoggingConfigDef(BaseStruct):
    protocol: typing.Union[aws_cdk.aws_sns.LoggingProtocol, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Indicates one of the supported protocols for the SNS topic.\n')
    failure_feedback_role: typing.Optional[typing.Union[models.aws_iam.LazyRoleDef, models.aws_iam.RoleDef]] = pydantic.Field(None, description='The IAM role to be used when logging failed message deliveries in Amazon CloudWatch. Default: None\n')
    success_feedback_role: typing.Optional[typing.Union[models.aws_iam.LazyRoleDef, models.aws_iam.RoleDef]] = pydantic.Field(None, description='The IAM role to be used when logging successful message deliveries in Amazon CloudWatch. Default: None\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['protocol', 'failure_feedback_role', 'success_feedback_role', 'success_feedback_sample_rate']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_sns.LoggingConfig'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class StringConditionsDef(BaseStruct):
    ...
    match_prefixes: typing.Optional[typing.Sequence[str]] = pydantic.Field(None, description='Matches values that begins with the specified prefixes. Default: - None\n')
    match_suffixes: typing.Optional[typing.Sequence[str]] = pydantic.Field(None, description='Matches values that end with the specified suffixes. Default: - None\n\n:exampleMetadata: infused\n\nExample::\n\n    import aws_cdk.aws_lambda as lambda_\n    # fn: lambda.Function\n\n\n    my_topic = sns.Topic(self, "MyTopic")\n\n    # Lambda should receive only message matching the following conditions on attributes:\n    # color: \'red\' or \'orange\' or begins with \'bl\'\n    # size: anything but \'small\' or \'medium\'\n    # price: between 100 and 200 or greater than 300\n    # store: attribute must be present\n    my_topic.add_subscription(subscriptions.LambdaSubscription(fn,\n        filter_policy={\n            "color": sns.SubscriptionFilter.string_filter(\n                allowlist=["red", "orange"],\n                match_prefixes=["bl"],\n                match_suffixes=["ue"]\n            ),\n            "size": sns.SubscriptionFilter.string_filter(\n                denylist=["small", "medium"]\n            ),\n            "price": sns.SubscriptionFilter.numeric_filter(\n                between=sns.BetweenCondition(start=100, stop=200),\n                greater_than=300\n            ),\n            "store": sns.SubscriptionFilter.exists_filter()\n        }\n    ))\n')
    _init_params: typing.ClassVar[list[str]] = ['allowlist', 'denylist', 'match_prefixes', 'match_suffixes']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
#  autogenerated from aws_cdk.aws_sns.TopicAttributes
class TopicAttributesDef(BaseStruct):
    topic_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The ARN of the SNS topic.\n')
    content_based_deduplication: typing.Optional[bool] = pydantic.Field(None, description='Whether content-based deduplication is enabled. Only applicable for FIFO topics. Default: false\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_sns as sns\n\n    topic_attributes = sns.TopicAttributes(\n        topic_arn="topicArn",\n\n        # the properties below are optional\n        content_based_deduplication=False\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['topic_arn', 'content_based_deduplication']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_sns.TopicAttributes'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class TopicSubscriptionConfigDef(BaseStruct):
    ...
    region: typing.Optional[str] = pydantic.Field(None, description='The region where the topic resides, in the case of cross-region subscriptions. Default: - the region where the CloudFormation stack is being deployed.\n')
    subscription_role_arn: typing.Optional[str] = pydantic.Field(None, description='Arn of role allowing access to firehose delivery stream. Required for a firehose subscription protocol. Default: - No subscription role is provided\n')
    subscriber_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The id of the SNS subscription resource created under ``scope``. In most cases, it is recommended to use the ``uniqueId`` of the topic you are subscribing to.\n')
    ...
    subscription_dependency: typing.Optional[models.UnsupportedResource] = pydantic.Field(None, description='The resources that need to be created before the subscription can be safely created. For example for SQS subscription, the subscription needs to have a dependency on the SQS queue policy in order for the subscription to successfully deliver messages. Default: - empty list\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_sns as sns\n    from aws_cdk import aws_sqs as sqs\n    import constructs as constructs\n\n    # construct: constructs.Construct\n    # dependable: constructs.IDependable\n    # filter_or_policy: sns.FilterOrPolicy\n    # queue: sqs.Queue\n    # subscription_filter: sns.SubscriptionFilter\n\n    topic_subscription_config = sns.TopicSubscriptionConfig(\n        endpoint="endpoint",\n        protocol=sns.SubscriptionProtocol.HTTP,\n        subscriber_id="subscriberId",\n\n        # the properties below are optional\n        dead_letter_queue=queue,\n        filter_policy={\n            "filter_policy_key": subscription_filter\n        },\n        filter_policy_with_message_body={\n            "filter_policy_with_message_body_key": filter_or_policy\n        },\n        raw_message_delivery=False,\n        region="region",\n        subscriber_scope=construct,\n        subscription_dependency=dependable,\n        subscription_role_arn="subscriptionRoleArn"\n    )\n')
...
#  autogenerated from aws_cdk.aws_sns.LoggingProtocol
# skipping emum

#  autogenerated from aws_cdk.aws_sns.SubscriptionProtocol
# skipping emum

#  autogenerated from aws_cdk.aws_sns.TracingConfig
# skipping emum
...
class CfnSubscriptionDef(BaseCfnResource):
    protocol: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description="The subscription's protocol. For more information, see the ``Protocol`` parameter of the ``[Subscribe](https://docs.aws.amazon.com/sns/latest/api/API_Subscribe.html)`` action in the *Amazon SNS API Reference* .\n")
    topic_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The ARN of the topic to subscribe to.\n')
    ...
    replay_policy: typing.Any = pydantic.Field(None, description="Specifies whether Amazon SNS resends the notification to the subscription when a message's attribute changes.\n")
    subscription_role_arn: typing.Optional[str] = pydantic.Field(None, description='This property applies only to Amazon Data Firehose delivery stream subscriptions. Specify the ARN of the IAM role that has the following: - Permission to write to the Amazon Data Firehose delivery stream - Amazon SNS listed as a trusted entity Specifying a valid ARN for this attribute is required for Firehose delivery stream subscriptions. For more information, see `Fanout to Amazon Data Firehose delivery streams <https://docs.aws.amazon.com/sns/latest/dg/sns-firehose-as-subscriber.html>`_ in the *Amazon SNS Developer Guide.*')
    _init_params: typing.ClassVar[list[str]] = ['protocol', 'topic_arn', 'delivery_policy', 'endpoint', 'filter_policy', 'filter_policy_scope', 'raw_message_delivery', 'redrive_policy', 'region', 'replay_policy', 'subscription_role_arn']
...
class CfnTopicDef(BaseCfnResource):
    archive_policy: typing.Any = pydantic.Field(None, description='The archive policy determines the number of days Amazon SNS retains messages. You can set a retention period from 1 to 365 days.\n')
    ...
    fifo_topic: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='Set to true to create a FIFO topic.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['archive_policy', 'content_based_deduplication', 'data_protection_policy', 'delivery_status_logging', 'display_name', 'fifo_topic', 'kms_master_key_id', 'signature_version', 'subscription', 'tags', 'topic_name', 'tracing_config']
    _method_names: typing.ClassVar[list[str]] = ['LoggingConfigProperty', 'SubscriptionProperty', 'add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnTopicDefConfig(pydantic.BaseModel):
    LoggingConfigProperty: typing.Optional[list[models.aws_sns.CfnTopicDefLoggingconfigpropertyParams]] = pydantic.Field(None, description='')
...
class CfnTopicDefLoggingconfigpropertyParams(pydantic.BaseModel):
    protocol: str = pydantic.Field(..., description='')
    failure_feedback_role_arn: typing.Optional[str] = pydantic.Field(None, description='')
    success_feedback_role_arn: typing.Optional[str] = pydantic.Field(None, description='')
    success_feedback_sample_rate: typing.Optional[str] = pydantic.Field(None, description='')
    ...
...
#  autogenerated from aws_cdk.aws_sns.CfnTopicInlinePolicy
class CfnTopicInlinePolicyDef(BaseCfnResource):
    policy_document: typing.Union[typing.Any, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A policy document that contains permissions to add to the specified Amazon SNS topic.\n')
    topic_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Amazon Resource Name (ARN) of the topic to which you want to add the policy.')
    _init_params: typing.ClassVar[list[str]] = ['policy_document', 'topic_arn']
    _method_names: typing.ClassVar[list[str]] = ['add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_sns.CfnTopicInlinePolicy'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class CfnTopicInlinePolicyDefAddDependencyParams(pydantic.BaseModel):
    target: models.CfnResourceDef = pydantic.Field(..., description='-')
    ...

class CfnTopicInlinePolicyDefAddDependsOnParams(pydantic.BaseModel):
    target: models.CfnResourceDef = pydantic.Field(..., description='-\n\n:deprecated: use addDependency\n\n:stability: deprecated\n')
    ...

class CfnTopicInlinePolicyDefAddMetadataParams(pydantic.BaseModel):
    key: str = pydantic.Field(..., description='-\n')
    value: typing.Any = pydantic.Field(..., description='-\n\n:see:\n\nhttps://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/metadata-section-structure.html\n\nNote that this is a different set of metadata from CDK node metadata; this\nmetadata ends up in the stack template under the resource, whereas CDK\nnode metadata ends up in the Cloud Assembly.\n')
    ...

class CfnTopicInlinePolicyDefAddOverrideParams(pydantic.BaseModel):
    path: str = pydantic.Field(..., description='- The path of the property, you can use dot notation to override values in complex types. Any intermediate keys will be created as needed.\n')
    value: typing.Any = pydantic.Field(..., description='- The value. Could be primitive or complex.')
    ...

class CfnTopicInlinePolicyDefAddPropertyDeletionOverrideParams(pydantic.BaseModel):
    property_path: str = pydantic.Field(..., description='The path to the property.')
    ...

class CfnTopicInlinePolicyDefAddPropertyOverrideParams(pydantic.BaseModel):
    property_path: str = pydantic.Field(..., description='The path of the property.\n')
    value: typing.Any = pydantic.Field(..., description='The value.')
    ...

class CfnTopicInlinePolicyDefApplyRemovalPolicyParams(pydantic.BaseModel):
    policy: typing.Optional[aws_cdk.RemovalPolicy] = pydantic.Field(None, description='-\n')
    apply_to_update_replace_policy: typing.Optional[bool] = pydantic.Field(None, description='Apply the same deletion policy to the resource\'s "UpdateReplacePolicy". Default: true\n')
    default: typing.Optional[aws_cdk.RemovalPolicy] = pydantic.Field(None, description="The default policy to apply in case the removal policy is not defined. Default: - Default value is resource specific. To determine the default value for a resource, please consult that specific resource's documentation.\n\n:see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-deletionpolicy.html#aws-attribute-deletionpolicy-options\n")
    ...

class CfnTopicInlinePolicyDefGetAttParams(pydantic.BaseModel):
    attribute_name: str = pydantic.Field(..., description='The name of the attribute.\n')
    type_hint: typing.Optional[aws_cdk.ResolutionTypeHint] = pydantic.Field(None, description='-')
    return_config: typing.Optional[list[models.core.ReferenceDefConfig]] = pydantic.Field(None)
    ...

class CfnTopicInlinePolicyDefGetMetadataParams(pydantic.BaseModel):
    key: str = pydantic.Field(..., description='-\n\n:see:\n\nhttps://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/metadata-section-structure.html\n\nNote that this is a different set of metadata from CDK node metadata; this\nmetadata ends up in the stack template under the resource, whereas CDK\nnode metadata ends up in the Cloud Assembly.\n')
    ...

class CfnTopicInlinePolicyDefInspectParams(pydantic.BaseModel):
    inspector: models.TreeInspectorDef = pydantic.Field(..., description='tree inspector to collect and process attributes.')
    ...

class CfnTopicInlinePolicyDefOverrideLogicalIdParams(pydantic.BaseModel):
    new_logical_id: str = pydantic.Field(..., description='The new logical ID to use for this stack element.')
    ...

class CfnTopicInlinePolicyDefRemoveDependencyParams(pydantic.BaseModel):
    target: models.CfnResourceDef = pydantic.Field(..., description='-')
    ...

class CfnTopicInlinePolicyDefReplaceDependencyParams(pydantic.BaseModel):
    target: models.CfnResourceDef = pydantic.Field(..., description='The dependency to replace.\n')
    new_target: models.CfnResourceDef = pydantic.Field(..., description='The new dependency to add.')
    ...
...
class CfnTopicPolicyDef(BaseCfnResource):
    policy_document: typing.Union[typing.Any, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A policy document that contains permissions to add to the specified SNS topics.\n')
    topics: typing.Union[typing.Sequence[str], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Amazon Resource Names (ARN) of the topics to which you want to add the policy. You can use the ``[Ref](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/intrinsic-function-reference-ref.html)`` function to specify an ``[AWS::SNS::Topic](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-sns-topic.html)`` resource.')
...
#  autogenerated from aws_cdk.aws_sns.CfnTopicInlinePolicyProps
class CfnTopicInlinePolicyPropsDef(BaseCfnProperty):
    policy_document: typing.Union[typing.Any, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A policy document that contains permissions to add to the specified Amazon SNS topic.\n')
    ...
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_sns.CfnTopicInlinePolicyProps'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class ModuleModel(pydantic.BaseModel):
    ...
    CfnTopic_LoggingConfigProperty: typing.Optional[dict[str, models.aws_sns.CfnTopic_LoggingConfigPropertyDef]] = pydantic.Field(None)
    ...
    LoggingConfig: typing.Optional[dict[str, models.aws_sns.LoggingConfigDef]] = pydantic.Field(None)
    ...
    TopicAttributes: typing.Optional[dict[str, models.aws_sns.TopicAttributesDef]] = pydantic.Field(None)
