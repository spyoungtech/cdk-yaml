...
class CfnTopicDef(BaseCfnResource):
    ...
    _init_params: typing.ClassVar[list[str]] = ['archive_policy', 'content_based_deduplication', 'data_protection_policy', 'display_name', 'fifo_topic', 'kms_master_key_id', 'signature_version', 'subscription', 'tags', 'topic_name', 'tracing_config']
