...
class ApplicationScalingActionDef(BaseClass):
    step_scaling_action: models.aws_applicationautoscaling.StepScalingActionDef = pydantic.Field(..., description='-')
...
class AutoScalingActionDef(BaseClass):
    step_scaling_action: models.aws_autoscaling.StepScalingActionDef = pydantic.Field(..., description='-')
    _init_params: typing.ClassVar[list[str]] = ['step_scaling_action']
    _method_names: typing.ClassVar[list[str]] = ['bind']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class Ec2ActionDef(BaseClass):
    instance_action: aws_cdk.aws_cloudwatch_actions.Ec2InstanceAction = pydantic.Field(..., description='-')
...
class SsmActionDef(BaseClass):
    severity: aws_cdk.aws_cloudwatch_actions.OpsItemSeverity = pydantic.Field(..., description='-')
...
class SsmIncidentActionDef(BaseClass):
    response_plan_name: str = pydantic.Field(..., description='-')
