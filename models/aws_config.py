...
#  autogenerated from aws_cdk.aws_config.EvaluationMode
class EvaluationModeDef(BaseClass):
    modes: typing.Union[typing.Sequence[str], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The modes of evaluation for the rule.')
    _init_params: typing.ClassVar[list[str]] = ['modes']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_config.EvaluationMode'
...
class AccessKeysRotatedDef(BaseConstruct):
    ...
    evaluation_modes: typing.Optional[models.aws_config.EvaluationModeDef] = pydantic.Field(None, description='The modes the AWS Config rule can be evaluated in. The valid values are distinct objects. Default: - Detective evaluation mode only\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['max_age', 'config_rule_name', 'description', 'evaluation_modes', 'input_parameters', 'maximum_execution_frequency', 'rule_scope']
...
class CloudFormationStackDriftDetectionCheckDef(BaseConstruct):
    ...
    maximum_execution_frequency: typing.Optional[aws_cdk.aws_config.MaximumExecutionFrequency] = pydantic.Field(None, description='The maximum frequency at which the AWS Config rule runs evaluations. Default: MaximumExecutionFrequency.TWENTY_FOUR_HOURS\n')
    rule_scope: typing.Optional[models.aws_config.RuleScopeDef] = pydantic.Field(None, description='Defines which resources trigger an evaluation for an AWS Config rule. Default: - evaluations for the rule are triggered when any resource in the recording group changes.')
    _init_params: typing.ClassVar[list[str]] = ['own_stack_only', 'role', 'config_rule_name', 'description', 'evaluation_modes', 'input_parameters', 'maximum_execution_frequency', 'rule_scope']
    _method_names: typing.ClassVar[list[str]] = ['apply_removal_policy', 'on_compliance_change', 'on_event', 'on_re_evaluation_status']
    _classmethod_names: typing.ClassVar[list[str]] = ['from_config_rule_name']
...
class CloudFormationStackNotificationCheckDef(BaseConstruct):
    ...
    maximum_execution_frequency: typing.Optional[aws_cdk.aws_config.MaximumExecutionFrequency] = pydantic.Field(None, description='The maximum frequency at which the AWS Config rule runs evaluations. Default: MaximumExecutionFrequency.TWENTY_FOUR_HOURS\n')
    rule_scope: typing.Optional[models.aws_config.RuleScopeDef] = pydantic.Field(None, description='Defines which resources trigger an evaluation for an AWS Config rule. Default: - evaluations for the rule are triggered when any resource in the recording group changes.')
    _init_params: typing.ClassVar[list[str]] = ['topics', 'config_rule_name', 'description', 'evaluation_modes', 'input_parameters', 'maximum_execution_frequency', 'rule_scope']
    _method_names: typing.ClassVar[list[str]] = ['apply_removal_policy', 'on_compliance_change', 'on_event', 'on_re_evaluation_status']
    _classmethod_names: typing.ClassVar[list[str]] = ['from_config_rule_name']
...
class CustomPolicyDef(BaseConstruct):
    ...
    maximum_execution_frequency: typing.Optional[aws_cdk.aws_config.MaximumExecutionFrequency] = pydantic.Field(None, description='The maximum frequency at which the AWS Config rule runs evaluations. Default: MaximumExecutionFrequency.TWENTY_FOUR_HOURS\n')
    rule_scope: typing.Optional[models.aws_config.RuleScopeDef] = pydantic.Field(None, description='Defines which resources trigger an evaluation for an AWS Config rule. Default: - evaluations for the rule are triggered when any resource in the recording group changes.')
    _init_params: typing.ClassVar[list[str]] = ['policy_text', 'enable_debug_log', 'config_rule_name', 'description', 'evaluation_modes', 'input_parameters', 'maximum_execution_frequency', 'rule_scope']
    _method_names: typing.ClassVar[list[str]] = ['apply_removal_policy', 'on_compliance_change', 'on_event', 'on_re_evaluation_status']
    _classmethod_names: typing.ClassVar[list[str]] = ['from_config_rule_name']
...
class CustomRuleDef(BaseConstruct):
    ...
    maximum_execution_frequency: typing.Optional[aws_cdk.aws_config.MaximumExecutionFrequency] = pydantic.Field(None, description='The maximum frequency at which the AWS Config rule runs evaluations. Default: MaximumExecutionFrequency.TWENTY_FOUR_HOURS\n')
    rule_scope: typing.Optional[models.aws_config.RuleScopeDef] = pydantic.Field(None, description='Defines which resources trigger an evaluation for an AWS Config rule. Default: - evaluations for the rule are triggered when any resource in the recording group changes.')
    _init_params: typing.ClassVar[list[str]] = ['lambda_function', 'configuration_changes', 'periodic', 'config_rule_name', 'description', 'evaluation_modes', 'input_parameters', 'maximum_execution_frequency', 'rule_scope']
    _method_names: typing.ClassVar[list[str]] = ['apply_removal_policy', 'on_compliance_change', 'on_event', 'on_re_evaluation_status']
    _classmethod_names: typing.ClassVar[list[str]] = ['from_config_rule_name']
...
class ManagedRuleDef(BaseConstruct):
    ...
    maximum_execution_frequency: typing.Optional[aws_cdk.aws_config.MaximumExecutionFrequency] = pydantic.Field(None, description='The maximum frequency at which the AWS Config rule runs evaluations. Default: MaximumExecutionFrequency.TWENTY_FOUR_HOURS\n')
    rule_scope: typing.Optional[models.aws_config.RuleScopeDef] = pydantic.Field(None, description='Defines which resources trigger an evaluation for an AWS Config rule. Default: - evaluations for the rule are triggered when any resource in the recording group changes.')
    _init_params: typing.ClassVar[list[str]] = ['identifier', 'config_rule_name', 'description', 'evaluation_modes', 'input_parameters', 'maximum_execution_frequency', 'rule_scope']
    _method_names: typing.ClassVar[list[str]] = ['apply_removal_policy', 'on_compliance_change', 'on_event', 'on_re_evaluation_status']
    _classmethod_names: typing.ClassVar[list[str]] = ['from_config_rule_name']
...
class AccessKeysRotatedPropsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['config_rule_name', 'description', 'evaluation_modes', 'input_parameters', 'maximum_execution_frequency', 'rule_scope', 'max_age']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnConfigurationRecorder_RecordingGroupPropertyDef(BaseStruct):
    all_supported: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='Specifies whether AWS Config records configuration changes for all supported resource types, excluding the global IAM resource types. If you set this field to ``true`` , when AWS Config adds support for a new resource type, AWS Config starts recording resources of that type automatically. If you set this field to ``true`` , you cannot enumerate specific resource types to record in the ``resourceTypes`` field of `RecordingGroup <https://docs.aws.amazon.com/config/latest/APIReference/API_RecordingGroup.html>`_ , or to exclude in the ``resourceTypes`` field of `ExclusionByResourceTypes <https://docs.aws.amazon.com/config/latest/APIReference/API_ExclusionByResourceTypes.html>`_ . .. epigraph:: *Region availability* Check `Resource Coverage by Region Availability <https://docs.aws.amazon.com/config/latest/developerguide/what-is-resource-config-coverage.html>`_ to see if a resource type is supported in the AWS Region where you set up AWS Config .\n')
...
#  autogenerated from aws_cdk.aws_config.CfnConfigurationRecorder.RecordingModeOverrideProperty
class CfnConfigurationRecorder_RecordingModeOverridePropertyDef(BaseStruct):
    recording_frequency: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The recording frequency that will be applied to all the resource types specified in the override. - Continuous recording allows you to record configuration changes continuously whenever a change occurs. - Daily recording allows you to receive a configuration item (CI) representing the most recent state of your resources over the last 24-hour period, only if it’s different from the previous CI recorded. .. epigraph:: AWS Firewall Manager depends on continuous recording to monitor your resources. If you are using Firewall Manager, it is recommended that you set the recording frequency to Continuous.\n')
    resource_types: typing.Union[typing.Sequence[str], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A comma-separated list that specifies which resource types AWS Config includes in the override. .. epigraph:: Daily recording is not supported for the following resource types: - ``AWS::Config::ResourceCompliance`` - ``AWS::Config::ConformancePackCompliance`` - ``AWS::Config::ConfigurationRecorder``\n')
    description: typing.Optional[str] = pydantic.Field(None, description='A description that you provide for the override.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-config-configurationrecorder-recordingmodeoverride.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_config as config\n\n    recording_mode_override_property = config.CfnConfigurationRecorder.RecordingModeOverrideProperty(\n        recording_frequency="recordingFrequency",\n        resource_types=["resourceTypes"],\n\n        # the properties below are optional\n        description="description"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['recording_frequency', 'resource_types', 'description']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_config.CfnConfigurationRecorder.RecordingModeOverrideProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
#  autogenerated from aws_cdk.aws_config.CfnConfigurationRecorder.RecordingModeProperty
class CfnConfigurationRecorder_RecordingModePropertyDef(BaseStruct):
    recording_frequency: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The default recording frequency that AWS Config uses to record configuration changes. .. epigraph:: Daily recording is not supported for the following resource types: - ``AWS::Config::ResourceCompliance`` - ``AWS::Config::ConformancePackCompliance`` - ``AWS::Config::ConfigurationRecorder`` For the *allSupported* ( ``ALL_SUPPORTED_RESOURCE_TYPES`` ) recording strategy, these resource types will be set to Continuous recording.\n')
    recording_mode_overrides: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_config.CfnConfigurationRecorder_RecordingModeOverridePropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='An array of ``recordingModeOverride`` objects for you to specify your overrides for the recording mode. The ``recordingModeOverride`` object in the ``recordingModeOverrides`` array consists of three fields: a ``description`` , the new ``recordingFrequency`` , and an array of ``resourceTypes`` to override.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-config-configurationrecorder-recordingmode.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_config as config\n\n    recording_mode_property = config.CfnConfigurationRecorder.RecordingModeProperty(\n        recording_frequency="recordingFrequency",\n\n        # the properties below are optional\n        recording_mode_overrides=[config.CfnConfigurationRecorder.RecordingModeOverrideProperty(\n            recording_frequency="recordingFrequency",\n            resource_types=["resourceTypes"],\n\n            # the properties below are optional\n            description="description"\n        )]\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['recording_frequency', 'recording_mode_overrides']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_config.CfnConfigurationRecorder.RecordingModeProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class CfnConformancePack_TemplateSSMDocumentDetailsPropertyDef(BaseStruct):
    document_name: typing.Optional[str] = pydantic.Field(None, description='The name or Amazon Resource Name (ARN) of the SSM document to use to create a conformance pack. If you use the document name, AWS Config checks only your account and AWS Region for the SSM document.\n')
...
class CloudFormationStackDriftDetectionCheckPropsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['config_rule_name', 'description', 'evaluation_modes', 'input_parameters', 'maximum_execution_frequency', 'rule_scope', 'own_stack_only', 'role']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CloudFormationStackNotificationCheckPropsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['config_rule_name', 'description', 'evaluation_modes', 'input_parameters', 'maximum_execution_frequency', 'rule_scope', 'topics']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CustomPolicyPropsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['config_rule_name', 'description', 'evaluation_modes', 'input_parameters', 'maximum_execution_frequency', 'rule_scope', 'policy_text', 'enable_debug_log']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CustomRulePropsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['config_rule_name', 'description', 'evaluation_modes', 'input_parameters', 'maximum_execution_frequency', 'rule_scope', 'lambda_function', 'configuration_changes', 'periodic']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class ManagedRulePropsDef(BaseStruct):
    ...
    rule_scope: typing.Optional[models.aws_config.RuleScopeDef] = pydantic.Field(None, description='Defines which resources trigger an evaluation for an AWS Config rule. Default: - evaluations for the rule are triggered when any resource in the recording group changes.\n')
    identifier: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The identifier of the AWS managed rule.\n\n:exampleMetadata: infused\n\nExample::\n\n    # fn: lambda.Function\n    # sample_policy_text: str\n\n\n    config.ManagedRule(self, "ManagedRule",\n        identifier=config.ManagedRuleIdentifiers.API_GW_XRAY_ENABLED,\n        evaluation_modes=config.EvaluationMode.DETECTIVE_AND_PROACTIVE\n    )\n\n    config.CustomRule(self, "CustomRule",\n        lambda_function=fn,\n        evaluation_modes=config.EvaluationMode.PROACTIVE\n    )\n\n    config.CustomPolicy(self, "CustomPolicy",\n        policy_text=sample_policy_text,\n        evaluation_modes=config.EvaluationMode.DETECTIVE\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['config_rule_name', 'description', 'evaluation_modes', 'input_parameters', 'maximum_execution_frequency', 'rule_scope', 'identifier']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class RulePropsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['config_rule_name', 'description', 'evaluation_modes', 'input_parameters', 'maximum_execution_frequency', 'rule_scope']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnConfigurationRecorderDef(BaseCfnResource):
    ...
    recording_mode: typing.Union[models.UnsupportedResource, models.aws_config.CfnConfigurationRecorder_RecordingModePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Specifies the default recording frequency that AWS Config uses to record configuration changes. AWS Config supports *Continuous recording* and *Daily recording* . - Continuous recording allows you to record configuration changes continuously whenever a change occurs. - Daily recording allows you to receive a configuration item (CI) representing the most recent state of your resources over the last 24-hour period, only if it’s different from the previous CI recorded. .. epigraph:: AWS Firewall Manager depends on continuous recording to monitor your resources. If you are using Firewall Manager, it is recommended that you set the recording frequency to Continuous. You can also override the recording frequency for specific resource types.')
    _init_params: typing.ClassVar[list[str]] = ['role_arn', 'name', 'recording_group', 'recording_mode']
    _method_names: typing.ClassVar[list[str]] = ['ExclusionByResourceTypesProperty', 'RecordingGroupProperty', 'RecordingModeOverrideProperty', 'RecordingModeProperty', 'RecordingStrategyProperty', 'add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnConfigurationRecorderDefConfig(pydantic.BaseModel):
    ...
    RecordingModeOverrideProperty: typing.Optional[list[models.aws_config.CfnConfigurationRecorderDefRecordingmodeoverridepropertyParams]] = pydantic.Field(None, description='')
    RecordingModeProperty: typing.Optional[list[models.aws_config.CfnConfigurationRecorderDefRecordingmodepropertyParams]] = pydantic.Field(None, description='')
...
class CfnConfigurationRecorderDefRecordingmodeoverridepropertyParams(pydantic.BaseModel):
    recording_frequency: str = pydantic.Field(..., description='')
    resource_types: typing.Sequence[str] = pydantic.Field(..., description='')
    description: typing.Optional[str] = pydantic.Field(None, description='')
    ...

class CfnConfigurationRecorderDefRecordingmodepropertyParams(pydantic.BaseModel):
    recording_frequency: str = pydantic.Field(..., description='')
    recording_mode_overrides: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_config.CfnConfigurationRecorder_RecordingModeOverridePropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    ...
...
class ModuleModel(pydantic.BaseModel):
    EvaluationMode: typing.Optional[dict[str, models.aws_config.EvaluationModeDef]] = pydantic.Field(None)
    ...
    CfnConfigurationRecorder_RecordingModeOverrideProperty: typing.Optional[dict[str, models.aws_config.CfnConfigurationRecorder_RecordingModeOverridePropertyDef]] = pydantic.Field(None)
    CfnConfigurationRecorder_RecordingModeProperty: typing.Optional[dict[str, models.aws_config.CfnConfigurationRecorder_RecordingModePropertyDef]] = pydantic.Field(None)
