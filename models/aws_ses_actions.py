...
class AddHeaderDef(BaseClass):
    ...
    resource_config: typing.Optional[models.aws_ses_actions.AddHeaderDefConfig] = pydantic.Field(None)


class AddHeaderDefConfig(pydantic.BaseModel):
    bind: typing.Optional[list[models.aws_ses_actions.AddHeaderDefBindParams]] = pydantic.Field(None, description='Returns the receipt rule action specification.')
...
class BounceDef(BaseClass):
    ...
    resource_config: typing.Optional[models.aws_ses_actions.BounceDefConfig] = pydantic.Field(None)


class BounceDefConfig(pydantic.BaseModel):
    bind: typing.Optional[list[models.aws_ses_actions.BounceDefBindParams]] = pydantic.Field(None, description='Returns the receipt rule action specification.')
...
class LambdaDef(BaseClass):
    ...
    resource_config: typing.Optional[models.aws_ses_actions.LambdaDefConfig] = pydantic.Field(None)


class LambdaDefConfig(pydantic.BaseModel):
    bind: typing.Optional[list[models.aws_ses_actions.LambdaDefBindParams]] = pydantic.Field(None, description='Returns the receipt rule action specification.')
...
class S3Def(BaseClass):
    bucket: typing.Union[_REQUIRED_INIT_PARAM, models.aws_s3.BucketBaseDef, models.aws_s3.BucketDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The S3 bucket that incoming email will be saved to.')
    ...
    resource_config: typing.Optional[models.aws_ses_actions.S3DefConfig] = pydantic.Field(None)


class S3DefConfig(pydantic.BaseModel):
    bind: typing.Optional[list[models.aws_ses_actions.S3DefBindParams]] = pydantic.Field(None, description='Returns the receipt rule action specification.')
...
class SnsDef(BaseClass):
    ...
    resource_config: typing.Optional[models.aws_ses_actions.SnsDefConfig] = pydantic.Field(None)


class SnsDefConfig(pydantic.BaseModel):
    bind: typing.Optional[list[models.aws_ses_actions.SnsDefBindParams]] = pydantic.Field(None, description='Returns the receipt rule action specification.')
...
class StopDef(BaseClass):
    ...
    resource_config: typing.Optional[models.aws_ses_actions.StopDefConfig] = pydantic.Field(None)


class StopDefConfig(pydantic.BaseModel):
    bind: typing.Optional[list[models.aws_ses_actions.StopDefBindParams]] = pydantic.Field(None, description='Returns the receipt rule action specification.')

class StopDefBindParams(pydantic.BaseModel):
    ...


#  autogenerated from aws_cdk.aws_ses_actions.WorkMail
class WorkMailDef(BaseClass):
    organization_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The WorkMail organization ARN. Amazon WorkMail organization ARNs are in the form ``arn:aws:workmail:region:account_ID:organization/organization_ID``')
    topic: typing.Optional[typing.Union[models.aws_sns.TopicBaseDef, models.aws_sns.TopicDef]] = pydantic.Field(None, description='The SNS topic to notify when the WorkMail action is taken. Default: - no topic will be attached to the action')
    _init_params: typing.ClassVar[list[str]] = ['organization_arn', 'topic']
    _method_names: typing.ClassVar[list[str]] = ['bind']
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_ses_actions.WorkMail'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...


    resource_config: typing.Optional[models.aws_ses_actions.WorkMailDefConfig] = pydantic.Field(None)


class WorkMailDefConfig(pydantic.BaseModel):
    bind: typing.Optional[list[models.aws_ses_actions.WorkMailDefBindParams]] = pydantic.Field(None, description='Returns the receipt rule action specification.')

class WorkMailDefBindParams(pydantic.BaseModel):
    ...
...
class LambdaPropsDef(BaseStruct):
    ...
    resource_config: typing.Optional[models.aws_ses_actions.LambdaPropsDefConfig] = pydantic.Field(None)
...
class S3PropsDef(BaseStruct):
    ...
    resource_config: typing.Optional[models.aws_ses_actions.S3PropsDefConfig] = pydantic.Field(None)
...
class SnsPropsDef(BaseStruct):
    ...
    resource_config: typing.Optional[models.aws_ses_actions.SnsPropsDefConfig] = pydantic.Field(None)
...
#  autogenerated from aws_cdk.aws_ses_actions.WorkMailProps
class WorkMailPropsDef(BaseStruct):
    organization_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The WorkMail organization ARN. Amazon WorkMail organization ARNs are in the form ``arn:aws:workmail:region:account_ID:organization/organization_ID``\n')
    topic: typing.Optional[typing.Union[models.aws_sns.TopicBaseDef, models.aws_sns.TopicDef]] = pydantic.Field(None, description='The SNS topic to notify when the WorkMail action is taken. Default: - no topic will be attached to the action\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_ses_actions as ses_actions\n    from aws_cdk import aws_sns as sns\n\n    # topic: sns.Topic\n\n    work_mail_props = ses_actions.WorkMailProps(\n        organization_arn="organizationArn",\n\n        # the properties below are optional\n        topic=topic\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['organization_arn', 'topic']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_ses_actions.WorkMailProps'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class ModuleModel(pydantic.BaseModel):
    AddHeader: typing.Optional[dict[str, models.aws_ses_actions.AddHeaderDef]] = pydantic.Field(None)
    Bounce: typing.Optional[dict[str, models.aws_ses_actions.BounceDef]] = pydantic.Field(None)
    BounceTemplate: typing.Optional[dict[str, models.aws_ses_actions.BounceTemplateDef]] = pydantic.Field(None)
    Lambda: typing.Optional[dict[str, models.aws_ses_actions.LambdaDef]] = pydantic.Field(None)
    S3: typing.Optional[dict[str, models.aws_ses_actions.S3Def]] = pydantic.Field(None)
    Sns: typing.Optional[dict[str, models.aws_ses_actions.SnsDef]] = pydantic.Field(None)
    Stop: typing.Optional[dict[str, models.aws_ses_actions.StopDef]] = pydantic.Field(None)
    WorkMail: typing.Optional[dict[str, models.aws_ses_actions.WorkMailDef]] = pydantic.Field(None)
    AddHeaderProps: typing.Optional[dict[str, models.aws_ses_actions.AddHeaderPropsDef]] = pydantic.Field(None)
    BounceProps: typing.Optional[dict[str, models.aws_ses_actions.BouncePropsDef]] = pydantic.Field(None)
    BounceTemplateProps: typing.Optional[dict[str, models.aws_ses_actions.BounceTemplatePropsDef]] = pydantic.Field(None)
    LambdaProps: typing.Optional[dict[str, models.aws_ses_actions.LambdaPropsDef]] = pydantic.Field(None)
    S3Props: typing.Optional[dict[str, models.aws_ses_actions.S3PropsDef]] = pydantic.Field(None)
    SnsProps: typing.Optional[dict[str, models.aws_ses_actions.SnsPropsDef]] = pydantic.Field(None)
    StopProps: typing.Optional[dict[str, models.aws_ses_actions.StopPropsDef]] = pydantic.Field(None)
    WorkMailProps: typing.Optional[dict[str, models.aws_ses_actions.WorkMailPropsDef]] = pydantic.Field(None)
    ...
