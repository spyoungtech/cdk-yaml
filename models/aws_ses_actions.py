...
class AddHeaderDef(BaseClass):
    name: str = pydantic.Field(..., description='The name of the header to add. Must be between 1 and 50 characters, inclusive, and consist of alphanumeric (a-z, A-Z, 0-9) characters and dashes only.')
    value: str = pydantic.Field(..., description='The value of the header to add. Must be less than 2048 characters, and must not contain newline characters ("\\r" or "\\n").')
...
class BounceDef(BaseClass):
    sender: str = pydantic.Field(..., description='The email address of the sender of the bounced email. This is the address from which the bounce message will be sent.')
    template: models.aws_ses_actions.BounceTemplateDef = pydantic.Field(..., description='The template containing the message, reply code and status code.\n')
...
class S3Def(BaseClass):
    bucket: typing.Union[models.aws_s3.BucketBaseDef, models.aws_s3.BucketDef] = pydantic.Field(..., description='The S3 bucket that incoming email will be saved to.')
...
class SnsDef(BaseClass):
    topic: typing.Union[models.aws_sns.TopicBaseDef, models.aws_sns.TopicDef] = pydantic.Field(..., description='The SNS topic to notify.')
