...
class CfnDataIntegrationDef(BaseCfnResource):
    ...
    schedule_config: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_appintegrations.CfnDataIntegration_ScheduleConfigPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the data and how often it should be pulled from the source.\n')
