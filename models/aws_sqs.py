...
class QueueBaseDef(BaseClass):
    ...
    resource_config: typing.Optional[models.aws_sqs.QueueBaseDefConfig] = pydantic.Field(None)


class QueueBaseDefConfig(pydantic.BaseModel):
    add_to_resource_policy: typing.Optional[list[models.aws_sqs.QueueBaseDefAddToResourcePolicyParams]] = pydantic.Field(None, description='Adds a statement to the IAM resource policy associated with this queue.\nIf this queue was created in this stack (``new Queue``), a queue policy\nwill be automatically created upon the first call to ``addToPolicy``. If\nthe queue is imported (``Queue.import``), then this is a no-op.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    grant: typing.Optional[list[models.aws_sqs.QueueBaseDefGrantParams]] = pydantic.Field(None, description='Grant the actions defined in queueActions to the identity Principal given on this SQS queue resource.')
    grant_consume_messages: typing.Optional[list[models.aws_sqs.QueueBaseDefGrantConsumeMessagesParams]] = pydantic.Field(None, description='Grant permissions to consume messages from a queue.\nThis will grant the following permissions:\n\n- sqs:ChangeMessageVisibility\n- sqs:DeleteMessage\n- sqs:ReceiveMessage\n- sqs:GetQueueAttributes\n- sqs:GetQueueUrl\n\nIf encryption is used, permission to use the key to decrypt the contents of the queue will also be granted to the same principal.\n\nThis will grant the following KMS permissions:\n\n- kms:Decrypt')
    grant_purge: typing.Optional[list[models.aws_sqs.QueueBaseDefGrantPurgeParams]] = pydantic.Field(None, description='Grant an IAM principal permissions to purge all messages from the queue.\nThis will grant the following permissions:\n\n- sqs:PurgeQueue\n- sqs:GetQueueAttributes\n- sqs:GetQueueUrl')
    grant_send_messages: typing.Optional[list[models.aws_sqs.QueueBaseDefGrantSendMessagesParams]] = pydantic.Field(None, description='Grant access to send messages to a queue to the given identity.\nThis will grant the following permissions:\n\n- sqs:SendMessage\n- sqs:GetQueueAttributes\n- sqs:GetQueueUrl\n\nIf encryption is used, permission to use the key to encrypt/decrypt the contents of the queue will also be granted to the same principal.\n\nThis will grant the following KMS permissions:\n\n- kms:Decrypt\n- kms:Encrypt\n- kms:ReEncrypt*\n- kms:GenerateDataKey*')
    metric: typing.Optional[list[models.aws_sqs.QueueBaseDefMetricParams]] = pydantic.Field(None, description='Return the given named metric for this Queue.')
    metric_approximate_age_of_oldest_message: typing.Optional[list[models.aws_sqs.QueueBaseDefMetricApproximateAgeOfOldestMessageParams]] = pydantic.Field(None, description='The approximate age of the oldest non-deleted message in the queue.\nMaximum over 5 minutes')
    metric_approximate_number_of_messages_delayed: typing.Optional[list[models.aws_sqs.QueueBaseDefMetricApproximateNumberOfMessagesDelayedParams]] = pydantic.Field(None, description='The number of messages in the queue that are delayed and not available for reading immediately.\nMaximum over 5 minutes')
    metric_approximate_number_of_messages_not_visible: typing.Optional[list[models.aws_sqs.QueueBaseDefMetricApproximateNumberOfMessagesNotVisibleParams]] = pydantic.Field(None, description='The number of messages that are in flight.\nMaximum over 5 minutes')
    metric_approximate_number_of_messages_visible: typing.Optional[list[models.aws_sqs.QueueBaseDefMetricApproximateNumberOfMessagesVisibleParams]] = pydantic.Field(None, description='The number of messages available for retrieval from the queue.\nMaximum over 5 minutes')
    metric_number_of_empty_receives: typing.Optional[list[models.aws_sqs.QueueBaseDefMetricNumberOfEmptyReceivesParams]] = pydantic.Field(None, description='The number of ReceiveMessage API calls that did not return a message.\nSum over 5 minutes')
    metric_number_of_messages_deleted: typing.Optional[list[models.aws_sqs.QueueBaseDefMetricNumberOfMessagesDeletedParams]] = pydantic.Field(None, description='The number of messages deleted from the queue.\nSum over 5 minutes')
    metric_number_of_messages_received: typing.Optional[list[models.aws_sqs.QueueBaseDefMetricNumberOfMessagesReceivedParams]] = pydantic.Field(None, description='The number of messages returned by calls to the ReceiveMessage action.\nSum over 5 minutes')
    metric_number_of_messages_sent: typing.Optional[list[models.aws_sqs.QueueBaseDefMetricNumberOfMessagesSentParams]] = pydantic.Field(None, description='The number of messages added to a queue.\nSum over 5 minutes')
    metric_sent_message_size: typing.Optional[list[models.aws_sqs.QueueBaseDefMetricSentMessageSizeParams]] = pydantic.Field(None, description='The size of messages added to a queue.\nAverage over 5 minutes')
...
class QueueDef(BaseConstruct):
    ...
    redrive_allow_policy: typing.Union[models.aws_sqs.RedriveAllowPolicyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The string that includes the parameters for the permissions for the dead-letter queue redrive permission and which source queues can specify dead-letter queues. Default: - All source queues can designate this queue as their dead-letter queue.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['content_based_deduplication', 'data_key_reuse', 'dead_letter_queue', 'deduplication_scope', 'delivery_delay', 'encryption', 'encryption_master_key', 'enforce_ssl', 'fifo', 'fifo_throughput_limit', 'max_message_size_bytes', 'queue_name', 'receive_message_wait_time', 'redrive_allow_policy', 'removal_policy', 'retention_period', 'visibility_timeout']
    _method_names: typing.ClassVar[list[str]] = ['add_to_resource_policy', 'apply_removal_policy', 'grant', 'grant_consume_messages', 'grant_purge', 'grant_send_messages', 'metric', 'metric_approximate_age_of_oldest_message', 'metric_approximate_number_of_messages_delayed', 'metric_approximate_number_of_messages_not_visible', 'metric_approximate_number_of_messages_visible', 'metric_number_of_empty_receives', 'metric_number_of_messages_deleted', 'metric_number_of_messages_received', 'metric_number_of_messages_sent', 'metric_sent_message_size']
    ...
    from_queue_arn: typing.Optional[models.aws_sqs.QueueDefFromQueueArnParams] = pydantic.Field(None, description='Import an existing SQS queue provided an ARN.')
    from_queue_attributes: typing.Optional[models.aws_sqs.QueueDefFromQueueAttributesParams] = pydantic.Field(None, description='Import an existing queue.')
    resource_config: typing.Optional[models.aws_sqs.QueueDefConfig] = pydantic.Field(None)


class QueueDefConfig(pydantic.BaseModel):
    add_to_resource_policy: typing.Optional[list[models.aws_sqs.QueueDefAddToResourcePolicyParams]] = pydantic.Field(None, description='Adds a statement to the IAM resource policy associated with this queue.\nIf this queue was created in this stack (``new Queue``), a queue policy\nwill be automatically created upon the first call to ``addToPolicy``. If\nthe queue is imported (``Queue.import``), then this is a no-op.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    grant: typing.Optional[list[models.aws_sqs.QueueDefGrantParams]] = pydantic.Field(None, description='Grant the actions defined in queueActions to the identity Principal given on this SQS queue resource.')
    grant_consume_messages: typing.Optional[list[models.aws_sqs.QueueDefGrantConsumeMessagesParams]] = pydantic.Field(None, description='Grant permissions to consume messages from a queue.\nThis will grant the following permissions:\n\n- sqs:ChangeMessageVisibility\n- sqs:DeleteMessage\n- sqs:ReceiveMessage\n- sqs:GetQueueAttributes\n- sqs:GetQueueUrl\n\nIf encryption is used, permission to use the key to decrypt the contents of the queue will also be granted to the same principal.\n\nThis will grant the following KMS permissions:\n\n- kms:Decrypt')
    grant_purge: typing.Optional[list[models.aws_sqs.QueueDefGrantPurgeParams]] = pydantic.Field(None, description='Grant an IAM principal permissions to purge all messages from the queue.\nThis will grant the following permissions:\n\n- sqs:PurgeQueue\n- sqs:GetQueueAttributes\n- sqs:GetQueueUrl')
    grant_send_messages: typing.Optional[list[models.aws_sqs.QueueDefGrantSendMessagesParams]] = pydantic.Field(None, description='Grant access to send messages to a queue to the given identity.\nThis will grant the following permissions:\n\n- sqs:SendMessage\n- sqs:GetQueueAttributes\n- sqs:GetQueueUrl\n\nIf encryption is used, permission to use the key to encrypt/decrypt the contents of the queue will also be granted to the same principal.\n\nThis will grant the following KMS permissions:\n\n- kms:Decrypt\n- kms:Encrypt\n- kms:ReEncrypt*\n- kms:GenerateDataKey*')
    metric: typing.Optional[list[models.aws_sqs.QueueDefMetricParams]] = pydantic.Field(None, description='Return the given named metric for this Queue.')
    metric_approximate_age_of_oldest_message: typing.Optional[list[models.aws_sqs.QueueDefMetricApproximateAgeOfOldestMessageParams]] = pydantic.Field(None, description='The approximate age of the oldest non-deleted message in the queue.\nMaximum over 5 minutes')
    metric_approximate_number_of_messages_delayed: typing.Optional[list[models.aws_sqs.QueueDefMetricApproximateNumberOfMessagesDelayedParams]] = pydantic.Field(None, description='The number of messages in the queue that are delayed and not available for reading immediately.\nMaximum over 5 minutes')
    metric_approximate_number_of_messages_not_visible: typing.Optional[list[models.aws_sqs.QueueDefMetricApproximateNumberOfMessagesNotVisibleParams]] = pydantic.Field(None, description='The number of messages that are in flight.\nMaximum over 5 minutes')
    metric_approximate_number_of_messages_visible: typing.Optional[list[models.aws_sqs.QueueDefMetricApproximateNumberOfMessagesVisibleParams]] = pydantic.Field(None, description='The number of messages available for retrieval from the queue.\nMaximum over 5 minutes')
    metric_number_of_empty_receives: typing.Optional[list[models.aws_sqs.QueueDefMetricNumberOfEmptyReceivesParams]] = pydantic.Field(None, description='The number of ReceiveMessage API calls that did not return a message.\nSum over 5 minutes')
    metric_number_of_messages_deleted: typing.Optional[list[models.aws_sqs.QueueDefMetricNumberOfMessagesDeletedParams]] = pydantic.Field(None, description='The number of messages deleted from the queue.\nSum over 5 minutes')
    metric_number_of_messages_received: typing.Optional[list[models.aws_sqs.QueueDefMetricNumberOfMessagesReceivedParams]] = pydantic.Field(None, description='The number of messages returned by calls to the ReceiveMessage action.\nSum over 5 minutes')
    metric_number_of_messages_sent: typing.Optional[list[models.aws_sqs.QueueDefMetricNumberOfMessagesSentParams]] = pydantic.Field(None, description='The number of messages added to a queue.\nSum over 5 minutes')
    metric_sent_message_size: typing.Optional[list[models.aws_sqs.QueueDefMetricSentMessageSizeParams]] = pydantic.Field(None, description='The size of messages added to a queue.\nAverage over 5 minutes')
...
class QueuePolicyDef(BaseConstruct):
    queues: typing.Union[typing.Sequence[typing.Union[models.aws_sqs.QueueBaseDef, models.aws_sqs.QueueDef]], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The set of queues this policy applies to.')
    ...
    resource_config: typing.Optional[models.aws_sqs.QueuePolicyDefConfig] = pydantic.Field(None)
...
class DeadLetterQueueDef(BaseStruct):
    max_receive_count: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The number of times a message can be unsuccessfully dequeued before being moved to the dead-letter queue.\n')
    queue: typing.Union[_REQUIRED_INIT_PARAM, models.aws_sqs.QueueBaseDef, models.aws_sqs.QueueDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The dead-letter queue to which Amazon SQS moves messages after the value of maxReceiveCount is exceeded.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_sqs as sqs\n\n    # queue: sqs.Queue\n\n    dead_letter_queue = sqs.DeadLetterQueue(\n        max_receive_count=123,\n        queue=queue\n    )\n')
...
class QueueAttributesDef(BaseStruct):
    queue_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The ARN of the queue.\n')
    fifo: typing.Optional[bool] = pydantic.Field(None, description='Whether this queue is an Amazon SQS FIFO queue. If false, this is a standard queue. In case of a FIFO queue which is imported from a token, this value has to be explicitly set to true. Default: - if fifo is not specified, the property will be determined based on the queue name (not possible for FIFO queues imported from a token)\n')
    key_arn: typing.Optional[str] = pydantic.Field(None, description='KMS encryption key, if this queue is server-side encrypted by a KMS key. Default: - None\n')
    queue_name: typing.Optional[str] = pydantic.Field(None, description='The name of the queue. Default: if queue name is not specified, the name will be derived from the queue ARN\n')
...
#  autogenerated from aws_cdk.aws_sqs.RedriveAllowPolicy
class RedriveAllowPolicyDef(BaseStruct):
    redrive_permission: typing.Optional[aws_cdk.aws_sqs.RedrivePermission] = pydantic.Field(None, description='Permission settings for source queues that can designate this queue as their dead-letter queue. Default: - ``RedrivePermission.BY_QUEUE`` if ``sourceQueues`` is specified,``RedrivePermission.ALLOW_ALL`` otherwise.\n')
    source_queues: typing.Optional[typing.Sequence[typing.Union[models.aws_sqs.QueueBaseDef, models.aws_sqs.QueueDef]]] = pydantic.Field(None, description='Source queues that can designate this queue as their dead-letter queue. When ``redrivePermission`` is set to ``RedrivePermission.BY_QUEUE``, this parameter is required. You can specify up to 10 source queues. To allow more than 10 source queues to specify dead-letter queues, set the ``redrivePermission`` to ``RedrivePermission.ALLOW_ALL``. When ``redrivePermission`` is either ``RedrivePermission.ALLOW_ALL`` or ``RedrivePermission.DENY_ALL``, this parameter cannot be set. Default: - Required when ``redrivePermission`` is ``RedrivePermission.BY_QUEUE``, cannot be defined otherwise.\n\n:exampleMetadata: infused\n\nExample::\n\n    # source_queue: sqs.IQueue\n\n\n    # Only the sourceQueue can specify this queue as the dead-letter queue.\n    queue1 = sqs.Queue(self, "Queue2",\n        redrive_allow_policy=sqs.RedriveAllowPolicy(\n            source_queues=[source_queue]\n        )\n    )\n\n    # No source queues can specify this queue as the dead-letter queue.\n    queue2 = sqs.Queue(self, "Queue",\n        redrive_allow_policy=sqs.RedriveAllowPolicy(\n            redrive_permission=sqs.RedrivePermission.DENY_ALL\n        )\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['redrive_permission', 'source_queues']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_sqs.RedriveAllowPolicy'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
#  autogenerated from aws_cdk.aws_sqs.RedrivePermission
# skipping emum
...
class CfnQueueDef(BaseCfnResource):
    ...
    resource_config: typing.Optional[models.aws_sqs.CfnQueueDefConfig] = pydantic.Field(None)


class CfnQueueDefConfig(pydantic.BaseModel):
    add_deletion_override: typing.Optional[list[models.aws_sqs.CfnQueueDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_sqs.CfnQueueDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_sqs.CfnQueueDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_sqs.CfnQueueDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_sqs.CfnQueueDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_sqs.CfnQueueDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_sqs.CfnQueueDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_sqs.CfnQueueDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_sqs.CfnQueueDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_sqs.CfnQueueDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_sqs.CfnQueueDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_sqs.CfnQueueDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_sqs.CfnQueueDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
#  autogenerated from aws_cdk.aws_sqs.CfnQueueInlinePolicy
class CfnQueueInlinePolicyDef(BaseCfnResource):
    policy_document: typing.Union[typing.Any, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A policy document that contains the permissions for the specified Amazon SQS queues. For more information about Amazon SQS policies, see `Using custom policies with the Amazon SQS access policy language <https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-creating-custom-policies.html>`_ in the *Amazon SQS Developer Guide* .\n')
    queue: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The URLs of the queues to which you want to add the policy. You can use the ``[Ref](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/intrinsic-function-reference-ref.html)`` function to specify an ``[AWS::SQS::Queue](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sqs-queues.html)`` resource.')
    _init_params: typing.ClassVar[list[str]] = ['policy_document', 'queue']
    _method_names: typing.ClassVar[list[str]] = ['add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_sqs.CfnQueueInlinePolicy'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...


    resource_config: typing.Optional[models.aws_sqs.CfnQueueInlinePolicyDefConfig] = pydantic.Field(None)


class CfnQueueInlinePolicyDefConfig(pydantic.BaseModel):
    add_deletion_override: typing.Optional[list[models.aws_sqs.CfnQueueInlinePolicyDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_sqs.CfnQueueInlinePolicyDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_sqs.CfnQueueInlinePolicyDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_sqs.CfnQueueInlinePolicyDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_sqs.CfnQueueInlinePolicyDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_sqs.CfnQueueInlinePolicyDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_sqs.CfnQueueInlinePolicyDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_sqs.CfnQueueInlinePolicyDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_sqs.CfnQueueInlinePolicyDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_sqs.CfnQueueInlinePolicyDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_sqs.CfnQueueInlinePolicyDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_sqs.CfnQueueInlinePolicyDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_sqs.CfnQueueInlinePolicyDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')

class CfnQueueInlinePolicyDefAddDeletionOverrideParams(pydantic.BaseModel):
    path: str = pydantic.Field(..., description='The path of the value to delete.')
    ...

class CfnQueueInlinePolicyDefAddDependencyParams(pydantic.BaseModel):
    target: models.CfnResourceDef = pydantic.Field(..., description='-')
    ...

class CfnQueueInlinePolicyDefAddDependsOnParams(pydantic.BaseModel):
    target: models.CfnResourceDef = pydantic.Field(..., description='-\n\n:deprecated: use addDependency\n\n:stability: deprecated\n')
    ...

class CfnQueueInlinePolicyDefAddMetadataParams(pydantic.BaseModel):
    key: str = pydantic.Field(..., description='-\n')
    value: typing.Any = pydantic.Field(..., description='-\n\n:see:\n\nhttps://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/metadata-section-structure.html\n\nNote that this is a different set of metadata from CDK node metadata; this\nmetadata ends up in the stack template under the resource, whereas CDK\nnode metadata ends up in the Cloud Assembly.\n')
    ...

class CfnQueueInlinePolicyDefAddOverrideParams(pydantic.BaseModel):
    path: str = pydantic.Field(..., description='- The path of the property, you can use dot notation to override values in complex types. Any intermediate keys will be created as needed.\n')
    value: typing.Any = pydantic.Field(..., description='- The value. Could be primitive or complex.')
    ...

class CfnQueueInlinePolicyDefAddPropertyDeletionOverrideParams(pydantic.BaseModel):
    property_path: str = pydantic.Field(..., description='The path to the property.')
    ...

class CfnQueueInlinePolicyDefAddPropertyOverrideParams(pydantic.BaseModel):
    property_path: str = pydantic.Field(..., description='The path of the property.\n')
    value: typing.Any = pydantic.Field(..., description='The value.')
    ...

class CfnQueueInlinePolicyDefApplyRemovalPolicyParams(pydantic.BaseModel):
    policy: typing.Optional[aws_cdk.RemovalPolicy] = pydantic.Field(None, description='-\n')
    apply_to_update_replace_policy: typing.Optional[bool] = pydantic.Field(None, description='Apply the same deletion policy to the resource\'s "UpdateReplacePolicy". Default: true\n')
    default: typing.Optional[aws_cdk.RemovalPolicy] = pydantic.Field(None, description="The default policy to apply in case the removal policy is not defined. Default: - Default value is resource specific. To determine the default value for a resource, please consult that specific resource's documentation.\n\n:see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-deletionpolicy.html#aws-attribute-deletionpolicy-options\n")
    ...

class CfnQueueInlinePolicyDefGetAttParams(pydantic.BaseModel):
    attribute_name: str = pydantic.Field(..., description='The name of the attribute.\n')
    type_hint: typing.Optional[aws_cdk.ResolutionTypeHint] = pydantic.Field(None, description='-')
    return_config: typing.Optional[list[models.core.ReferenceDefConfig]] = pydantic.Field(None)
    ...

class CfnQueueInlinePolicyDefGetMetadataParams(pydantic.BaseModel):
    key: str = pydantic.Field(..., description='-\n\n:see:\n\nhttps://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/metadata-section-structure.html\n\nNote that this is a different set of metadata from CDK node metadata; this\nmetadata ends up in the stack template under the resource, whereas CDK\nnode metadata ends up in the Cloud Assembly.\n')
    ...

class CfnQueueInlinePolicyDefInspectParams(pydantic.BaseModel):
    inspector: models.TreeInspectorDef = pydantic.Field(..., description='tree inspector to collect and process attributes.')
    ...

class CfnQueueInlinePolicyDefOverrideLogicalIdParams(pydantic.BaseModel):
    new_logical_id: str = pydantic.Field(..., description='The new logical ID to use for this stack element.')
    ...

class CfnQueueInlinePolicyDefRemoveDependencyParams(pydantic.BaseModel):
    target: models.CfnResourceDef = pydantic.Field(..., description='-')
    ...

class CfnQueueInlinePolicyDefReplaceDependencyParams(pydantic.BaseModel):
    target: models.CfnResourceDef = pydantic.Field(..., description='The dependency to replace.\n')
    new_target: models.CfnResourceDef = pydantic.Field(..., description='The new dependency to add.')
    ...
...
class CfnQueuePolicyDef(BaseCfnResource):
    policy_document: typing.Union[typing.Any, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A policy document that contains the permissions for the specified Amazon SQS queues. For more information about Amazon SQS policies, see `Using custom policies with the Amazon SQS access policy language <https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-creating-custom-policies.html>`_ in the *Amazon SQS Developer Guide* .\n')
    queues: typing.Union[typing.Sequence[str], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The URLs of the queues to which you want to add the policy. You can use the ``[Ref](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/intrinsic-function-reference-ref.html)`` function to specify an ``[AWS::SQS::Queue](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-sqs-queue.html)`` resource.')
    ...
    resource_config: typing.Optional[models.aws_sqs.CfnQueuePolicyDefConfig] = pydantic.Field(None)


class CfnQueuePolicyDefConfig(pydantic.BaseModel):
    add_deletion_override: typing.Optional[list[models.aws_sqs.CfnQueuePolicyDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_sqs.CfnQueuePolicyDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_sqs.CfnQueuePolicyDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_sqs.CfnQueuePolicyDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_sqs.CfnQueuePolicyDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_sqs.CfnQueuePolicyDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_sqs.CfnQueuePolicyDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_sqs.CfnQueuePolicyDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_sqs.CfnQueuePolicyDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_sqs.CfnQueuePolicyDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_sqs.CfnQueuePolicyDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_sqs.CfnQueuePolicyDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_sqs.CfnQueuePolicyDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
#  autogenerated from aws_cdk.aws_sqs.CfnQueueInlinePolicyProps
class CfnQueueInlinePolicyPropsDef(BaseCfnProperty):
    policy_document: typing.Union[typing.Any, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A policy document that contains the permissions for the specified Amazon SQS queues. For more information about Amazon SQS policies, see `Using custom policies with the Amazon SQS access policy language <https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-creating-custom-policies.html>`_ in the *Amazon SQS Developer Guide* .\n')
    ...
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_sqs.CfnQueueInlinePolicyProps'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class ModuleModel(pydantic.BaseModel):
    QueueBase: typing.Optional[dict[str, models.aws_sqs.QueueBaseDef]] = pydantic.Field(None)
    Queue: typing.Optional[dict[str, models.aws_sqs.QueueDef]] = pydantic.Field(None)
    QueuePolicy: typing.Optional[dict[str, models.aws_sqs.QueuePolicyDef]] = pydantic.Field(None)
    DeadLetterQueue: typing.Optional[dict[str, models.aws_sqs.DeadLetterQueueDef]] = pydantic.Field(None)
    QueueAttributes: typing.Optional[dict[str, models.aws_sqs.QueueAttributesDef]] = pydantic.Field(None)
    QueuePolicyProps: typing.Optional[dict[str, models.aws_sqs.QueuePolicyPropsDef]] = pydantic.Field(None)
    QueueProps: typing.Optional[dict[str, models.aws_sqs.QueuePropsDef]] = pydantic.Field(None)
    RedriveAllowPolicy: typing.Optional[dict[str, models.aws_sqs.RedriveAllowPolicyDef]] = pydantic.Field(None)
    CfnQueue: typing.Optional[dict[str, models.aws_sqs.CfnQueueDef]] = pydantic.Field(None)
    CfnQueueInlinePolicy: typing.Optional[dict[str, models.aws_sqs.CfnQueueInlinePolicyDef]] = pydantic.Field(None)
    CfnQueuePolicy: typing.Optional[dict[str, models.aws_sqs.CfnQueuePolicyDef]] = pydantic.Field(None)
    CfnQueueInlinePolicyProps: typing.Optional[dict[str, models.aws_sqs.CfnQueueInlinePolicyPropsDef]] = pydantic.Field(None)
    CfnQueuePolicyProps: typing.Optional[dict[str, models.aws_sqs.CfnQueuePolicyPropsDef]] = pydantic.Field(None)
    CfnQueueProps: typing.Optional[dict[str, models.aws_sqs.CfnQueuePropsDef]] = pydantic.Field(None)
    ...
