...
class CfnDataflowEndpointGroup_ConnectionDetailsPropertyDef(BaseStruct):
    mtu: typing.Union[int, float, None] = pydantic.Field(None, description='Maximum transmission unit (MTU) size in bytes of a dataflow endpoint.\n')
    socket_address: typing.Union[models.UnsupportedResource, models.aws_groundstation.CfnDataflowEndpointGroup_SocketAddressPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A socket address.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-groundstation-dataflowendpointgroup-connectiondetails.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_groundstation as groundstation\n\n    connection_details_property = groundstation.CfnDataflowEndpointGroup.ConnectionDetailsProperty(\n        mtu=123,\n        socket_address=groundstation.CfnDataflowEndpointGroup.SocketAddressProperty(\n            name="name",\n            port=123\n        )\n    )\n')
...
class CfnDataflowEndpointGroup_EndpointDetailsPropertyDef(BaseStruct):
    aws_ground_station_agent_endpoint: typing.Union[models.UnsupportedResource, models.aws_groundstation.CfnDataflowEndpointGroup_AwsGroundStationAgentEndpointPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='An agent endpoint.\n')
...
class CfnDataflowEndpointGroup_RangedSocketAddressPropertyDef(BaseStruct):
    name: typing.Optional[str] = pydantic.Field(None, description='IPv4 socket address.\n')
    port_range: typing.Union[models.UnsupportedResource, models.aws_groundstation.CfnDataflowEndpointGroup_IntegerRangePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Port range of a socket address.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-groundstation-dataflowendpointgroup-rangedsocketaddress.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_groundstation as groundstation\n\n    ranged_socket_address_property = groundstation.CfnDataflowEndpointGroup.RangedSocketAddressProperty(\n        name="name",\n        port_range=groundstation.CfnDataflowEndpointGroup.IntegerRangeProperty(\n            maximum=123,\n            minimum=123\n        )\n    )\n')
...
class CfnMissionProfileDef(BaseCfnResource):
    ...
    contact_post_pass_duration_seconds: typing.Union[int, float, None] = pydantic.Field(None, description='Amount of time in seconds after a contact ends that you’d like to receive a Ground Station Contact State Change indicating the pass has finished.\n')
    contact_pre_pass_duration_seconds: typing.Union[int, float, None] = pydantic.Field(None, description="Amount of time in seconds prior to contact start that you'd like to receive a Ground Station Contact State Change Event indicating an upcoming pass.\n")
    streams_kms_key: typing.Union[models.UnsupportedResource, models.aws_groundstation.CfnMissionProfile_StreamsKmsKeyPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='KMS key to use for encrypting streams.\n')
    streams_kms_role: typing.Optional[str] = pydantic.Field(None, description='Role to use for encrypting streams with KMS key.\n')
