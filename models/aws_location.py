...
class CfnGeofenceCollectionDef(BaseCfnResource):
    ...
    pricing_plan_data_source: typing.Optional[str] = pydantic.Field(None, description='')
    _init_params: typing.ClassVar[list[str]] = ['collection_name', 'description', 'kms_key_id', 'pricing_plan', 'pricing_plan_data_source']
...
class CfnTrackerDef(BaseCfnResource):
    ...
    pricing_plan: typing.Optional[str] = pydantic.Field(None, description='')
    pricing_plan_data_source: typing.Optional[str] = pydantic.Field(None, description='')
    _init_params: typing.ClassVar[list[str]] = ['tracker_name', 'description', 'kms_key_id', 'position_filtering', 'pricing_plan', 'pricing_plan_data_source']
    _method_names: typing.ClassVar[list[str]] = ['add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
