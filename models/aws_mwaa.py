...
class CfnEnvironment_LoggingConfigurationPropertyDef(BaseStruct):
    dag_processing_logs: typing.Union[models.UnsupportedResource, models.aws_mwaa.CfnEnvironment_ModuleLoggingConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Defines the processing logs sent to CloudWatch Logs and the logging level to send.\n')
    scheduler_logs: typing.Union[models.UnsupportedResource, models.aws_mwaa.CfnEnvironment_ModuleLoggingConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Defines the scheduler logs sent to CloudWatch Logs and the logging level to send.\n')
    task_logs: typing.Union[models.UnsupportedResource, models.aws_mwaa.CfnEnvironment_ModuleLoggingConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Defines the task logs sent to CloudWatch Logs and the logging level to send.\n')
    webserver_logs: typing.Union[models.UnsupportedResource, models.aws_mwaa.CfnEnvironment_ModuleLoggingConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Defines the web server logs sent to CloudWatch Logs and the logging level to send.\n')
    worker_logs: typing.Union[models.UnsupportedResource, models.aws_mwaa.CfnEnvironment_ModuleLoggingConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Defines the worker logs sent to CloudWatch Logs and the logging level to send.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-mwaa-environment-loggingconfiguration.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_mwaa as mwaa\n\n    logging_configuration_property = mwaa.CfnEnvironment.LoggingConfigurationProperty(\n        dag_processing_logs=mwaa.CfnEnvironment.ModuleLoggingConfigurationProperty(\n            cloud_watch_log_group_arn="cloudWatchLogGroupArn",\n            enabled=False,\n            log_level="logLevel"\n        ),\n        scheduler_logs=mwaa.CfnEnvironment.ModuleLoggingConfigurationProperty(\n            cloud_watch_log_group_arn="cloudWatchLogGroupArn",\n            enabled=False,\n            log_level="logLevel"\n        ),\n        task_logs=mwaa.CfnEnvironment.ModuleLoggingConfigurationProperty(\n            cloud_watch_log_group_arn="cloudWatchLogGroupArn",\n            enabled=False,\n            log_level="logLevel"\n        ),\n        webserver_logs=mwaa.CfnEnvironment.ModuleLoggingConfigurationProperty(\n            cloud_watch_log_group_arn="cloudWatchLogGroupArn",\n            enabled=False,\n            log_level="logLevel"\n        ),\n        worker_logs=mwaa.CfnEnvironment.ModuleLoggingConfigurationProperty(\n            cloud_watch_log_group_arn="cloudWatchLogGroupArn",\n            enabled=False,\n            log_level="logLevel"\n        )\n    )\n')
...
class CfnEnvironment_ModuleLoggingConfigurationPropertyDef(BaseStruct):
    ...
    enabled: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='Indicates whether to enable the Apache Airflow log type (e.g. ``DagProcessingLogs`` ) in CloudWatch Logs.\n')
...
class CfnEnvironmentDef(BaseCfnResource):
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of your Amazon MWAA environment.\n')
    ...
    endpoint_management: typing.Optional[str] = pydantic.Field(None, description='Defines whether the VPC endpoints configured for the environment are created, and managed, by the customer or by Amazon MWAA. If set to ``SERVICE`` , Amazon MWAA will create and manage the required VPC endpoints in your VPC. If set to ``CUSTOMER`` , you must create, and manage, the VPC endpoints in your VPC.\n')
    ...
    min_webservers: typing.Union[int, float, None] = pydantic.Field(None, description='The minimum number of web servers that you want to run in your environment. Amazon MWAA scales the number of Apache Airflow web servers up to the number you specify for ``MaxWebservers`` when you interact with your Apache Airflow environment using Apache Airflow REST API, or the Apache Airflow CLI. As the transaction-per-second rate, and the network load, decrease, Amazon MWAA disposes of the additional web servers, and scales down to the number set in ``MinxWebserers`` . Valid values: Accepts between ``2`` and ``5`` . Defaults to ``2`` .\n')
    ...
    network_configuration: typing.Union[models.UnsupportedResource, models.aws_mwaa.CfnEnvironment_NetworkConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The VPC networking components used to secure and enable network traffic between the AWS resources for your environment. To learn more, see `About networking on Amazon MWAA <https://docs.aws.amazon.com/mwaa/latest/userguide/networking-about.html>`_ .\n')
    ...
    tags: typing.Any = pydantic.Field(None, description='The key-value tag pairs associated to your environment. For example, ``"Environment": "Staging"`` . To learn more, see `Tagging <https://docs.aws.amazon.com/general/latest/gr/aws_tagging.html>`_ . If you specify new tags for an existing environment, the update requires service interruption before taking effect.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['name', 'airflow_configuration_options', 'airflow_version', 'dag_s3_path', 'endpoint_management', 'environment_class', 'execution_role_arn', 'kms_key', 'logging_configuration', 'max_webservers', 'max_workers', 'min_webservers', 'min_workers', 'network_configuration', 'plugins_s3_object_version', 'plugins_s3_path', 'requirements_s3_object_version', 'requirements_s3_path', 'schedulers', 'source_bucket_arn', 'startup_script_s3_object_version', 'startup_script_s3_path', 'tags', 'webserver_access_mode', 'weekly_maintenance_window_start']
    ...
    resource_config: typing.Optional[models.aws_mwaa.CfnEnvironmentDefConfig] = pydantic.Field(None)


class CfnEnvironmentDefConfig(pydantic.BaseModel):
    LoggingConfigurationProperty: typing.Optional[list[models.aws_mwaa.CfnEnvironmentDefLoggingconfigurationpropertyParams]] = pydantic.Field(None, description='')
    ModuleLoggingConfigurationProperty: typing.Optional[list[models.aws_mwaa.CfnEnvironmentDefModuleloggingconfigurationpropertyParams]] = pydantic.Field(None, description='')
    NetworkConfigurationProperty: typing.Optional[list[models.aws_mwaa.CfnEnvironmentDefNetworkconfigurationpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_mwaa.CfnEnvironmentDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_mwaa.CfnEnvironmentDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_mwaa.CfnEnvironmentDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_mwaa.CfnEnvironmentDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_mwaa.CfnEnvironmentDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_mwaa.CfnEnvironmentDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_mwaa.CfnEnvironmentDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_mwaa.CfnEnvironmentDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_mwaa.CfnEnvironmentDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_mwaa.CfnEnvironmentDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_mwaa.CfnEnvironmentDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_mwaa.CfnEnvironmentDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_mwaa.CfnEnvironmentDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
    tags_config: typing.Optional[models.core.TagManagerDefConfig] = pydantic.Field(None)

class CfnEnvironmentDefLoggingconfigurationpropertyParams(pydantic.BaseModel):
    dag_processing_logs: typing.Union[models.UnsupportedResource, models.aws_mwaa.CfnEnvironment_ModuleLoggingConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    scheduler_logs: typing.Union[models.UnsupportedResource, models.aws_mwaa.CfnEnvironment_ModuleLoggingConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    task_logs: typing.Union[models.UnsupportedResource, models.aws_mwaa.CfnEnvironment_ModuleLoggingConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    webserver_logs: typing.Union[models.UnsupportedResource, models.aws_mwaa.CfnEnvironment_ModuleLoggingConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    worker_logs: typing.Union[models.UnsupportedResource, models.aws_mwaa.CfnEnvironment_ModuleLoggingConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class ModuleModel(pydantic.BaseModel):
    CfnEnvironment_LoggingConfigurationProperty: typing.Optional[dict[str, models.aws_mwaa.CfnEnvironment_LoggingConfigurationPropertyDef]] = pydantic.Field(None)
    CfnEnvironment_ModuleLoggingConfigurationProperty: typing.Optional[dict[str, models.aws_mwaa.CfnEnvironment_ModuleLoggingConfigurationPropertyDef]] = pydantic.Field(None)
    CfnEnvironment_NetworkConfigurationProperty: typing.Optional[dict[str, models.aws_mwaa.CfnEnvironment_NetworkConfigurationPropertyDef]] = pydantic.Field(None)
    CfnEnvironment: typing.Optional[dict[str, models.aws_mwaa.CfnEnvironmentDef]] = pydantic.Field(None)
    CfnEnvironmentProps: typing.Optional[dict[str, models.aws_mwaa.CfnEnvironmentPropsDef]] = pydantic.Field(None)
    ...
