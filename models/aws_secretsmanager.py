...
class ResourcePolicyDef(BaseConstruct):
    secret: typing.Union[_REQUIRED_INIT_PARAM, models.aws_docdb.DatabaseSecretDef, models.aws_rds.DatabaseSecretDef, models.aws_secretsmanager.SecretDef, models.aws_secretsmanager.SecretTargetAttachmentDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The secret to attach a resource-based permissions policy.')
...
class SecretRotationDef(BaseConstruct):
    application: typing.Union[models.aws_secretsmanager.SecretRotationApplicationDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The serverless application for the rotation.\n')
    ...
    vpc_subnets: typing.Union[models.aws_ec2.SubnetSelectionDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The type of subnets in the VPC where the Lambda rotation function will run. Default: - the Vpc default strategy if not specified.')
    _init_params: typing.ClassVar[list[str]] = ['application', 'secret', 'target', 'vpc', 'automatically_after', 'endpoint', 'exclude_characters', 'master_secret', 'rotate_immediately_on_update', 'security_group', 'vpc_subnets']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class SecretTargetAttachmentDef(BaseConstruct):
    secret: typing.Union[_REQUIRED_INIT_PARAM, models.aws_docdb.DatabaseSecretDef, models.aws_rds.DatabaseSecretDef, models.aws_secretsmanager.SecretDef, models.aws_secretsmanager.SecretTargetAttachmentDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The secret to attach to the target.\n')
    target: typing.Union[_REQUIRED_INIT_PARAM, models.aws_rds.DatabaseProxyDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The target to attach the secret to.')
...
class CfnSecret_GenerateSecretStringPropertyDef(BaseStruct):
    exclude_characters: typing.Optional[str] = pydantic.Field(None, description="A string of the characters that you don't want in the password.\n")
    exclude_lowercase: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description="Specifies whether to exclude lowercase letters from the password. If you don't include this switch, the password can contain lowercase letters.\n")
    exclude_numbers: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description="Specifies whether to exclude numbers from the password. If you don't include this switch, the password can contain numbers.\n")
    exclude_punctuation: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='Specifies whether to exclude the following punctuation characters from the password: `! " # $ % & \' ( ) * + , - . / : ; < = > ? @ [ \\ ] ^ _ `` { | } ~`` . If you don\'t include this switch, the password can contain punctuation.\n')
    exclude_uppercase: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description="Specifies whether to exclude uppercase letters from the password. If you don't include this switch, the password can contain uppercase letters.\n")
    ...
    include_space: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='Specifies whether to include the space character. If you include this switch, the password can contain space characters.\n')
    ...
    require_each_included_type: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description="Specifies whether to include at least one upper and lowercase letter, one number, and one punctuation. If you don't include this switch, the password contains at least one of every character type.\n")
...
class CfnSecret_ReplicaRegionPropertyDef(BaseStruct):
    region: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='(Optional) A string that represents a ``Region`` , for example "us-east-1".\n')
...
class ReplicaRegionDef(BaseStruct):
    region: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the region.\n')
...
class SecretAttachmentTargetPropsDef(BaseStruct):
    target_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The id of the target to attach the secret to.\n')
    target_type: typing.Union[aws_cdk.aws_secretsmanager.AttachmentTargetType, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The type of the target to attach the secret to.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_secretsmanager as secretsmanager\n\n    secret_attachment_target_props = secretsmanager.SecretAttachmentTargetProps(\n        target_id="targetId",\n        target_type=secretsmanager.AttachmentTargetType.RDS_DB_INSTANCE\n    )\n')
...
class CfnResourcePolicyDef(BaseCfnResource):
    resource_policy: typing.Union[typing.Any, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A JSON-formatted string for an AWS resource-based policy. For example policies, see `Permissions policy examples <https://docs.aws.amazon.com/secretsmanager/latest/userguide/auth-and-access_examples.html>`_ .\n')
    secret_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The ARN or name of the secret to attach the resource-based policy. For an ARN, we recommend that you specify a complete ARN rather than a partial ARN.\n')
    block_public_policy: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='Specifies whether to block resource-based policies that allow broad access to the secret. By default, Secrets Manager blocks policies that allow broad access, for example those that use a wildcard for the principal.')
...
class CfnRotationScheduleDef(BaseCfnResource):
    ...
    rotation_rules: typing.Union[models.UnsupportedResource, models.aws_secretsmanager.CfnRotationSchedule_RotationRulesPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A structure that defines the rotation configuration for this secret.')
...
class CfnSecretDef(BaseCfnResource):
    ...
    generate_secret_string: typing.Union[models.UnsupportedResource, models.aws_secretsmanager.CfnSecret_GenerateSecretStringPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A structure that specifies how to generate a password to encrypt and store in the secret. To include a specific string in the secret, use ``SecretString`` instead. If you omit both ``GenerateSecretString`` and ``SecretString`` , you create an empty secret. When you make a change to this property, a new secret version is created. We recommend that you specify the maximum length and include every character type that the system you are generating a password for can support.\n')
    ...
    replica_regions: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_secretsmanager.CfnSecret_ReplicaRegionPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='A custom type that specifies a ``Region`` and the ``KmsKeyId`` for a replica secret.\n')
...
class CfnSecretDefGeneratesecretstringpropertyParams(pydantic.BaseModel):
    exclude_characters: typing.Optional[str] = pydantic.Field(None, description='')
    exclude_lowercase: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
    exclude_numbers: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
    exclude_punctuation: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
    exclude_uppercase: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
    generate_string_key: typing.Optional[str] = pydantic.Field(None, description='')
    include_space: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
    password_length: typing.Union[int, float, None] = pydantic.Field(None, description='')
    require_each_included_type: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
