...
class DynamoEventSourceDef(BaseClass):
    ...
    max_record_age: typing.Optional[models.DurationDef] = pydantic.Field(None, description='The maximum age of a record that Lambda sends to a function for processing. Valid Range: - Minimum value of 60 seconds - Maximum value of 7 days The default value is -1, which sets the maximum age to infinite. When the value is set to infinite, Lambda never discards old records. Record are valid until it expires in the event source. Default: -1\n')
...
class ManagedKafkaEventSourceDef(BaseClass):
    ...
    on_failure: typing.Optional[typing.Union[models.aws_lambda_event_sources.S3OnFailureDestinationDef, models.aws_lambda_event_sources.SnsDlqDef, models.aws_lambda_event_sources.SqsDlqDef]] = pydantic.Field(None, description='Add an on Failure Destination for this Kafka event. SNS/SQS/S3 are supported Default: - discarded records are ignored\n')
    ...
    enabled: typing.Optional[bool] = pydantic.Field(None, description='If the stream event source mapping should be enabled. Default: true\n')
    max_batching_window: typing.Optional[models.DurationDef] = pydantic.Field(None, description='The maximum amount of time to gather records before invoking the function. Maximum of Duration.minutes(5). Default: - Duration.seconds(0) for Kinesis, DynamoDB, and SQS event sources, Duration.millis(500) for MSK, self-managed Kafka, and Amazon MQ.')
    _init_params: typing.ClassVar[list[str]] = ['cluster_arn', 'topic', 'consumer_group_id', 'filters', 'on_failure', 'secret', 'starting_position', 'batch_size', 'enabled', 'max_batching_window']
    _method_names: typing.ClassVar[list[str]] = ['bind']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
#  autogenerated from aws_cdk.aws_lambda_event_sources.S3EventSourceV2
class S3EventSourceV2Def(BaseClass):
    ...
    _method_names: typing.ClassVar[list[str]] = ['bind']
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_lambda_event_sources.S3EventSourceV2'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...


    resource_config: typing.Optional[models.aws_lambda_event_sources.S3EventSourceV2DefConfig] = pydantic.Field(None)


class S3EventSourceV2DefConfig(pydantic.BaseModel):
    bind: typing.Optional[list[models.aws_lambda_event_sources.S3EventSourceV2DefBindParams]] = pydantic.Field(None, description='Called by ``lambda.addEventSource`` to allow the event source to bind to this function.')

class S3EventSourceV2DefBindParams(pydantic.BaseModel):
    target: typing.Union[models.aws_lambda.FunctionBaseDef, models.aws_lambda.QualifiedFunctionBaseDef, models.aws_lambda.AliasDef, models.aws_lambda.DockerImageFunctionDef, models.aws_lambda.FunctionDef, models.aws_lambda.SingletonFunctionDef, models.aws_lambda.VersionDef, models.aws_lambda_nodejs.NodejsFunctionDef, models.triggers.TriggerFunctionDef] = pydantic.Field(..., description='-')
    ...


#  autogenerated from aws_cdk.aws_lambda_event_sources.S3OnFailureDestination
class S3OnFailureDestinationDef(BaseClass):
    bucket: typing.Union[_REQUIRED_INIT_PARAM, models.aws_s3.BucketBaseDef, models.aws_s3.BucketDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='-')
    _init_params: typing.ClassVar[list[str]] = ['bucket']
    _method_names: typing.ClassVar[list[str]] = ['bind']
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_lambda_event_sources.S3OnFailureDestination'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...


    resource_config: typing.Optional[models.aws_lambda_event_sources.S3OnFailureDestinationDefConfig] = pydantic.Field(None)


class S3OnFailureDestinationDefConfig(pydantic.BaseModel):
    bind: typing.Optional[list[models.aws_lambda_event_sources.S3OnFailureDestinationDefBindParams]] = pydantic.Field(None, description='Returns a destination configuration for the DLQ.')

class S3OnFailureDestinationDefBindParams(pydantic.BaseModel):
...
class SelfManagedKafkaEventSourceDef(BaseClass):
    ...
    enabled: typing.Optional[bool] = pydantic.Field(None, description='If the stream event source mapping should be enabled. Default: true\n')
    max_batching_window: typing.Optional[models.DurationDef] = pydantic.Field(None, description='The maximum amount of time to gather records before invoking the function. Maximum of Duration.minutes(5). Default: - Duration.seconds(0) for Kinesis, DynamoDB, and SQS event sources, Duration.millis(500) for MSK, self-managed Kafka, and Amazon MQ.')
    _init_params: typing.ClassVar[list[str]] = ['bootstrap_servers', 'authentication_method', 'root_ca_certificate', 'security_group', 'vpc', 'vpc_subnets', 'topic', 'consumer_group_id', 'filters', 'on_failure', 'secret', 'starting_position', 'batch_size', 'enabled', 'max_batching_window']
    _method_names: typing.ClassVar[list[str]] = ['bind']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class KafkaEventSourcePropsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['starting_position', 'batch_size', 'enabled', 'max_batching_window', 'topic', 'consumer_group_id', 'filters', 'on_failure', 'secret']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class ManagedKafkaEventSourcePropsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['starting_position', 'batch_size', 'enabled', 'max_batching_window', 'topic', 'consumer_group_id', 'filters', 'on_failure', 'secret', 'cluster_arn']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class SelfManagedKafkaEventSourcePropsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['starting_position', 'batch_size', 'enabled', 'max_batching_window', 'topic', 'consumer_group_id', 'filters', 'on_failure', 'secret', 'bootstrap_servers', 'authentication_method', 'root_ca_certificate', 'security_group', 'vpc', 'vpc_subnets']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class ModuleModel(pydantic.BaseModel):
    ...
    S3EventSourceV2: typing.Optional[dict[str, models.aws_lambda_event_sources.S3EventSourceV2Def]] = pydantic.Field(None)
    S3OnFailureDestination: typing.Optional[dict[str, models.aws_lambda_event_sources.S3OnFailureDestinationDef]] = pydantic.Field(None)
