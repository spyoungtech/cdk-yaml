...
class DynamoEventSourceDef(BaseClass):
    ...
    starting_position: aws_cdk.aws_lambda.StartingPosition = pydantic.Field(..., description='Where to begin consuming the stream.\n')
...
class ManagedKafkaEventSourceDef(BaseClass):
    cluster_arn: str = pydantic.Field(..., description='An MSK cluster construct.')
    topic: str = pydantic.Field(..., description='The Kafka topic to subscribe to.\n')
    ...
    enabled: typing.Optional[bool] = pydantic.Field(None, description='If the stream event source mapping should be enabled. Default: true\n')
    max_batching_window: typing.Optional[models.DurationDef] = pydantic.Field(None, description='The maximum amount of time to gather records before invoking the function. Maximum of Duration.minutes(5). Default: - Duration.seconds(0) for Kinesis, DynamoDB, and SQS event sources, Duration.millis(500) for MSK, self-managed Kafka, and Amazon MQ.')
    _init_params: typing.ClassVar[list[str]] = ['cluster_arn', 'topic', 'consumer_group_id', 'secret', 'starting_position', 'batch_size', 'enabled', 'max_batching_window']
    _method_names: typing.ClassVar[list[str]] = ['bind']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class S3EventSourceDef(BaseClass):
    ...
    events: typing.Sequence[aws_cdk.aws_s3.EventType] = pydantic.Field(..., description='The s3 event types that will trigger the notification.\n')
...
class SelfManagedKafkaEventSourceDef(BaseClass):
    bootstrap_servers: typing.Sequence[str] = pydantic.Field(..., description='The list of host and port pairs that are the addresses of the Kafka brokers in a "bootstrap" Kafka cluster that a Kafka client connects to initially to bootstrap itself. They are in the format ``abc.xyz.com:xxxx``.')
    ...
    enabled: typing.Optional[bool] = pydantic.Field(None, description='If the stream event source mapping should be enabled. Default: true\n')
    max_batching_window: typing.Optional[models.DurationDef] = pydantic.Field(None, description='The maximum amount of time to gather records before invoking the function. Maximum of Duration.minutes(5). Default: - Duration.seconds(0) for Kinesis, DynamoDB, and SQS event sources, Duration.millis(500) for MSK, self-managed Kafka, and Amazon MQ.')
    _init_params: typing.ClassVar[list[str]] = ['bootstrap_servers', 'authentication_method', 'root_ca_certificate', 'security_group', 'vpc', 'vpc_subnets', 'topic', 'consumer_group_id', 'secret', 'starting_position', 'batch_size', 'enabled', 'max_batching_window']
    _method_names: typing.ClassVar[list[str]] = ['bind']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class KafkaEventSourcePropsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['starting_position', 'batch_size', 'enabled', 'max_batching_window', 'topic', 'consumer_group_id', 'secret']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class ManagedKafkaEventSourcePropsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['starting_position', 'batch_size', 'enabled', 'max_batching_window', 'topic', 'consumer_group_id', 'secret', 'cluster_arn']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class SelfManagedKafkaEventSourcePropsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['starting_position', 'batch_size', 'enabled', 'max_batching_window', 'topic', 'consumer_group_id', 'secret', 'bootstrap_servers', 'authentication_method', 'root_ca_certificate', 'security_group', 'vpc', 'vpc_subnets']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
