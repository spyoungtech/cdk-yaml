...
class GatewayRouteDef(BaseConstruct):
    virtual_gateway: typing.Union[_REQUIRED_INIT_PARAM, models.aws_appmesh.VirtualGatewayDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The VirtualGateway this GatewayRoute is associated with.\n')
    route_spec: typing.Union[models.aws_appmesh.GatewayRouteSpecDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='What protocol the route uses.\n')
...
class RouteDef(BaseConstruct):
    mesh: typing.Union[_REQUIRED_INIT_PARAM, models.aws_appmesh.MeshDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The service mesh to define the route in.\n')
    virtual_router: typing.Union[_REQUIRED_INIT_PARAM, models.aws_appmesh.VirtualRouterDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The VirtualRouter the Route belongs to.\n')
    route_spec: typing.Union[models.aws_appmesh.RouteSpecDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Protocol specific spec.\n')
...
class VirtualGatewayDef(BaseConstruct):
    mesh: typing.Union[_REQUIRED_INIT_PARAM, models.aws_appmesh.MeshDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Mesh which the VirtualGateway belongs to.\n')
    access_log: typing.Optional[models.aws_appmesh.AccessLogDef] = pydantic.Field(None, description='Access Logging Configuration for the VirtualGateway. Default: - no access logging\n')
    backend_defaults: typing.Union[models.aws_appmesh.BackendDefaultsDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Default Configuration Virtual Node uses to communicate with Virtual Service. Default: - No Config\n')
    listeners: typing.Optional[typing.Sequence[models.aws_appmesh.VirtualGatewayListenerDef]] = pydantic.Field(None, description='Listeners for the VirtualGateway. Only one is supported. Default: - Single HTTP listener on port 8080\n')
    virtual_gateway_name: typing.Optional[str] = pydantic.Field(None, description='Name of the VirtualGateway. Default: - A name is automatically determined')
...
class VirtualNodeDef(BaseConstruct):
    mesh: typing.Union[_REQUIRED_INIT_PARAM, models.aws_appmesh.MeshDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Mesh which the VirtualNode belongs to.\n')
    access_log: typing.Optional[models.aws_appmesh.AccessLogDef] = pydantic.Field(None, description='Access Logging Configuration for the virtual node. Default: - No access logging\n')
    backend_defaults: typing.Union[models.aws_appmesh.BackendDefaultsDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Default Configuration Virtual Node uses to communicate with Virtual Service. Default: - No Config\n')
    backends: typing.Optional[typing.Sequence[models.aws_appmesh.BackendDef]] = pydantic.Field(None, description='Virtual Services that this is node expected to send outbound traffic to. Default: - No backends\n')
    listeners: typing.Optional[typing.Sequence[models.aws_appmesh.VirtualNodeListenerDef]] = pydantic.Field(None, description='Initial listener for the virtual node. Default: - No listeners\n')
...
class VirtualRouterDef(BaseConstruct):
    mesh: typing.Union[_REQUIRED_INIT_PARAM, models.aws_appmesh.MeshDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Mesh which the VirtualRouter belongs to.\n')
    listeners: typing.Optional[typing.Sequence[models.aws_appmesh.VirtualRouterListenerDef]] = pydantic.Field(None, description='Listener specification for the VirtualRouter. Default: - A listener on HTTP port 8080\n')
    virtual_router_name: typing.Optional[str] = pydantic.Field(None, description='The name of the VirtualRouter. Default: - A name is automatically determined')
...
class VirtualServiceDef(BaseConstruct):
    virtual_service_provider: typing.Union[models.aws_appmesh.VirtualServiceProviderDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The VirtualNode or VirtualRouter which the VirtualService uses as its provider.\n')
...
class CfnGatewayRoute_GatewayRouteMetadataMatchPropertyDef(BaseStruct):
    ...
    range: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_GatewayRouteRangeMatchPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='An object that represents the range of values to match on.\n')
...
class CfnGatewayRoute_GatewayRouteRangeMatchPropertyDef(BaseStruct):
    end: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The end of the range.\n')
    start: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The start of the range.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-gatewayroute-gatewayrouterangematch.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    gateway_route_range_match_property = appmesh.CfnGatewayRoute.GatewayRouteRangeMatchProperty(\n        end=123,\n        start=123\n    )\n')
...
class CfnGatewayRoute_GatewayRouteSpecPropertyDef(BaseStruct):
    grpc_route: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_GrpcGatewayRoutePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='An object that represents the specification of a gRPC gateway route.\n')
    http2_route: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_HttpGatewayRoutePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='An object that represents the specification of an HTTP/2 gateway route.\n')
    http_route: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_HttpGatewayRoutePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='An object that represents the specification of an HTTP gateway route.\n')
...
class CfnGatewayRoute_GatewayRouteTargetPropertyDef(BaseStruct):
    virtual_service: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_GatewayRouteVirtualServicePropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='An object that represents a virtual service gateway route target.\n')
...
class CfnGatewayRoute_GrpcGatewayRouteActionPropertyDef(BaseStruct):
    target: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_GatewayRouteTargetPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='An object that represents the target that traffic is routed to when a request matches the gateway route.\n')
    rewrite: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_GrpcGatewayRouteRewritePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The gateway route action to rewrite.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-gatewayroute-grpcgatewayrouteaction.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    grpc_gateway_route_action_property = appmesh.CfnGatewayRoute.GrpcGatewayRouteActionProperty(\n        target=appmesh.CfnGatewayRoute.GatewayRouteTargetProperty(\n            virtual_service=appmesh.CfnGatewayRoute.GatewayRouteVirtualServiceProperty(\n                virtual_service_name="virtualServiceName"\n            ),\n\n            # the properties below are optional\n            port=123\n        ),\n\n        # the properties below are optional\n        rewrite=appmesh.CfnGatewayRoute.GrpcGatewayRouteRewriteProperty(\n            hostname=appmesh.CfnGatewayRoute.GatewayRouteHostnameRewriteProperty(\n                default_target_hostname="defaultTargetHostname"\n            )\n        )\n    )\n')
...
class CfnGatewayRoute_GrpcGatewayRouteMatchPropertyDef(BaseStruct):
    hostname: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_GatewayRouteHostnameMatchPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The gateway route host name to be matched on.\n')
    metadata: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_GrpcGatewayRouteMetadataPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The gateway route metadata to be matched on.\n')
...
class CfnGatewayRoute_GrpcGatewayRouteMetadataPropertyDef(BaseStruct):
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A name for the gateway route metadata.\n')
    invert: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='Specify ``True`` to match anything except the match criteria. The default value is ``False`` .\n')
    match: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_GatewayRouteMetadataMatchPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The criteria for determining a metadata match.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-gatewayroute-grpcgatewayroutemetadata.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    grpc_gateway_route_metadata_property = appmesh.CfnGatewayRoute.GrpcGatewayRouteMetadataProperty(\n        name="name",\n\n        # the properties below are optional\n        invert=False,\n        match=appmesh.CfnGatewayRoute.GatewayRouteMetadataMatchProperty(\n            exact="exact",\n            prefix="prefix",\n            range=appmesh.CfnGatewayRoute.GatewayRouteRangeMatchProperty(\n                end=123,\n                start=123\n            ),\n            regex="regex",\n            suffix="suffix"\n        )\n    )\n')
...
class CfnGatewayRoute_GrpcGatewayRoutePropertyDef(BaseStruct):
    action: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_GrpcGatewayRouteActionPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='An object that represents the action to take if a match is determined.\n')
    match: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_GrpcGatewayRouteMatchPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='An object that represents the criteria for determining a request match.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-gatewayroute-grpcgatewayroute.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    grpc_gateway_route_property = appmesh.CfnGatewayRoute.GrpcGatewayRouteProperty(\n        action=appmesh.CfnGatewayRoute.GrpcGatewayRouteActionProperty(\n            target=appmesh.CfnGatewayRoute.GatewayRouteTargetProperty(\n                virtual_service=appmesh.CfnGatewayRoute.GatewayRouteVirtualServiceProperty(\n                    virtual_service_name="virtualServiceName"\n                ),\n\n                # the properties below are optional\n                port=123\n            ),\n\n            # the properties below are optional\n            rewrite=appmesh.CfnGatewayRoute.GrpcGatewayRouteRewriteProperty(\n                hostname=appmesh.CfnGatewayRoute.GatewayRouteHostnameRewriteProperty(\n                    default_target_hostname="defaultTargetHostname"\n                )\n            )\n        ),\n        match=appmesh.CfnGatewayRoute.GrpcGatewayRouteMatchProperty(\n            hostname=appmesh.CfnGatewayRoute.GatewayRouteHostnameMatchProperty(\n                exact="exact",\n                suffix="suffix"\n            ),\n            metadata=[appmesh.CfnGatewayRoute.GrpcGatewayRouteMetadataProperty(\n                name="name",\n\n                # the properties below are optional\n                invert=False,\n                match=appmesh.CfnGatewayRoute.GatewayRouteMetadataMatchProperty(\n                    exact="exact",\n                    prefix="prefix",\n                    range=appmesh.CfnGatewayRoute.GatewayRouteRangeMatchProperty(\n                        end=123,\n                        start=123\n                    ),\n                    regex="regex",\n                    suffix="suffix"\n                )\n            )],\n            port=123,\n            service_name="serviceName"\n        )\n    )\n')
...
class CfnGatewayRoute_GrpcGatewayRouteRewritePropertyDef(BaseStruct):
    hostname: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_GatewayRouteHostnameRewritePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The host name of the gateway route to rewrite.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-gatewayroute-grpcgatewayrouterewrite.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    grpc_gateway_route_rewrite_property = appmesh.CfnGatewayRoute.GrpcGatewayRouteRewriteProperty(\n        hostname=appmesh.CfnGatewayRoute.GatewayRouteHostnameRewriteProperty(\n            default_target_hostname="defaultTargetHostname"\n        )\n    )\n')
...
class CfnGatewayRoute_HttpGatewayRouteHeaderPropertyDef(BaseStruct):
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A name for the HTTP header in the gateway route that will be matched on.\n')
    invert: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='Specify ``True`` to match anything except the match criteria. The default value is ``False`` .\n')
    match: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_HttpGatewayRouteHeaderMatchPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='An object that represents the method and value to match with the header value sent in a request. Specify one match method.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-gatewayroute-httpgatewayrouteheader.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    http_gateway_route_header_property = appmesh.CfnGatewayRoute.HttpGatewayRouteHeaderProperty(\n        name="name",\n\n        # the properties below are optional\n        invert=False,\n        match=appmesh.CfnGatewayRoute.HttpGatewayRouteHeaderMatchProperty(\n            exact="exact",\n            prefix="prefix",\n            range=appmesh.CfnGatewayRoute.GatewayRouteRangeMatchProperty(\n                end=123,\n                start=123\n            ),\n            regex="regex",\n            suffix="suffix"\n        )\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['name', 'invert', 'match']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnGatewayRoute_HttpGatewayRouteMatchPropertyDef(BaseStruct):
    headers: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_HttpGatewayRouteHeaderPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The client request headers to match on.\n')
    hostname: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_GatewayRouteHostnameMatchPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The host name to match on.\n')
    method: typing.Optional[str] = pydantic.Field(None, description='The method to match on.\n')
    path: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_HttpPathMatchPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The path to match on.\n')
    ...
    query_parameters: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_QueryParameterPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The query parameter to match on.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-gatewayroute-httpgatewayroutematch.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    http_gateway_route_match_property = appmesh.CfnGatewayRoute.HttpGatewayRouteMatchProperty(\n        headers=[appmesh.CfnGatewayRoute.HttpGatewayRouteHeaderProperty(\n            name="name",\n\n            # the properties below are optional\n            invert=False,\n            match=appmesh.CfnGatewayRoute.HttpGatewayRouteHeaderMatchProperty(\n                exact="exact",\n                prefix="prefix",\n                range=appmesh.CfnGatewayRoute.GatewayRouteRangeMatchProperty(\n                    end=123,\n                    start=123\n                ),\n                regex="regex",\n                suffix="suffix"\n            )\n        )],\n        hostname=appmesh.CfnGatewayRoute.GatewayRouteHostnameMatchProperty(\n            exact="exact",\n            suffix="suffix"\n        ),\n        method="method",\n        path=appmesh.CfnGatewayRoute.HttpPathMatchProperty(\n            exact="exact",\n            regex="regex"\n        ),\n        port=123,\n        prefix="prefix",\n        query_parameters=[appmesh.CfnGatewayRoute.QueryParameterProperty(\n            name="name",\n\n            # the properties below are optional\n            match=appmesh.CfnGatewayRoute.HttpQueryParameterMatchProperty(\n                exact="exact"\n            )\n        )]\n    )\n')
...
class CfnGatewayRoute_HttpGatewayRoutePropertyDef(BaseStruct):
    action: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_HttpGatewayRouteActionPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='An object that represents the action to take if a match is determined.\n')
    match: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_HttpGatewayRouteMatchPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='An object that represents the criteria for determining a request match.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-gatewayroute-httpgatewayroute.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    http_gateway_route_property = appmesh.CfnGatewayRoute.HttpGatewayRouteProperty(\n        action=appmesh.CfnGatewayRoute.HttpGatewayRouteActionProperty(\n            target=appmesh.CfnGatewayRoute.GatewayRouteTargetProperty(\n                virtual_service=appmesh.CfnGatewayRoute.GatewayRouteVirtualServiceProperty(\n                    virtual_service_name="virtualServiceName"\n                ),\n\n                # the properties below are optional\n                port=123\n            ),\n\n            # the properties below are optional\n            rewrite=appmesh.CfnGatewayRoute.HttpGatewayRouteRewriteProperty(\n                hostname=appmesh.CfnGatewayRoute.GatewayRouteHostnameRewriteProperty(\n                    default_target_hostname="defaultTargetHostname"\n                ),\n                path=appmesh.CfnGatewayRoute.HttpGatewayRoutePathRewriteProperty(\n                    exact="exact"\n                ),\n                prefix=appmesh.CfnGatewayRoute.HttpGatewayRoutePrefixRewriteProperty(\n                    default_prefix="defaultPrefix",\n                    value="value"\n                )\n            )\n        ),\n        match=appmesh.CfnGatewayRoute.HttpGatewayRouteMatchProperty(\n            headers=[appmesh.CfnGatewayRoute.HttpGatewayRouteHeaderProperty(\n                name="name",\n\n                # the properties below are optional\n                invert=False,\n                match=appmesh.CfnGatewayRoute.HttpGatewayRouteHeaderMatchProperty(\n                    exact="exact",\n                    prefix="prefix",\n                    range=appmesh.CfnGatewayRoute.GatewayRouteRangeMatchProperty(\n                        end=123,\n                        start=123\n                    ),\n                    regex="regex",\n                    suffix="suffix"\n                )\n            )],\n            hostname=appmesh.CfnGatewayRoute.GatewayRouteHostnameMatchProperty(\n                exact="exact",\n                suffix="suffix"\n            ),\n            method="method",\n            path=appmesh.CfnGatewayRoute.HttpPathMatchProperty(\n                exact="exact",\n                regex="regex"\n            ),\n            port=123,\n            prefix="prefix",\n            query_parameters=[appmesh.CfnGatewayRoute.QueryParameterProperty(\n                name="name",\n\n                # the properties below are optional\n                match=appmesh.CfnGatewayRoute.HttpQueryParameterMatchProperty(\n                    exact="exact"\n                )\n            )]\n        )\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['action', 'match']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnGatewayRoute_HttpGatewayRouteRewritePropertyDef(BaseStruct):
    hostname: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_GatewayRouteHostnameRewritePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The host name to rewrite.\n')
    path: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_HttpGatewayRoutePathRewritePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The path to rewrite.\n')
    prefix: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_HttpGatewayRoutePrefixRewritePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The specified beginning characters to rewrite.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-gatewayroute-httpgatewayrouterewrite.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    http_gateway_route_rewrite_property = appmesh.CfnGatewayRoute.HttpGatewayRouteRewriteProperty(\n        hostname=appmesh.CfnGatewayRoute.GatewayRouteHostnameRewriteProperty(\n            default_target_hostname="defaultTargetHostname"\n        ),\n        path=appmesh.CfnGatewayRoute.HttpGatewayRoutePathRewriteProperty(\n            exact="exact"\n        ),\n        prefix=appmesh.CfnGatewayRoute.HttpGatewayRoutePrefixRewriteProperty(\n            default_prefix="defaultPrefix",\n            value="value"\n        )\n    )\n')
...
class CfnGatewayRoute_QueryParameterPropertyDef(BaseStruct):
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A name for the query parameter that will be matched on.\n')
    match: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_HttpQueryParameterMatchPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The query parameter to match on.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-gatewayroute-queryparameter.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    query_parameter_property = appmesh.CfnGatewayRoute.QueryParameterProperty(\n        name="name",\n\n        # the properties below are optional\n        match=appmesh.CfnGatewayRoute.HttpQueryParameterMatchProperty(\n            exact="exact"\n        )\n    )\n')
...
class CfnMesh_MeshSpecPropertyDef(BaseStruct):
    egress_filter: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnMesh_EgressFilterPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The egress filter rules for the service mesh.\n')
    service_discovery: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnMesh_MeshServiceDiscoveryPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='An object that represents the service discovery information for a service mesh.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-mesh-meshspec.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    mesh_spec_property = appmesh.CfnMesh.MeshSpecProperty(\n        egress_filter=appmesh.CfnMesh.EgressFilterProperty(\n            type="type"\n        ),\n        service_discovery=appmesh.CfnMesh.MeshServiceDiscoveryProperty(\n            ip_preference="ipPreference"\n        )\n    )\n')
...
class CfnRoute_DurationPropertyDef(BaseStruct):
    unit: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A unit of time.\n')
    value: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='A number of time units.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-route-duration.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    duration_property = appmesh.CfnRoute.DurationProperty(\n        unit="unit",\n        value=123\n    )\n')
...
class CfnRoute_GrpcRetryPolicyPropertyDef(BaseStruct):
    max_retries: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The maximum number of retry attempts.\n')
    per_retry_timeout: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_appmesh.CfnRoute_DurationPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The timeout for each retry attempt.\n')
...
class CfnRoute_GrpcRouteMatchPropertyDef(BaseStruct):
    metadata: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_GrpcRouteMetadataPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='An object that represents the data to match from the request.\n')
...
class CfnRoute_GrpcRouteMetadataMatchMethodPropertyDef(BaseStruct):
    exact: typing.Optional[str] = pydantic.Field(None, description='The value sent by the client must match the specified value exactly.\n')
    prefix: typing.Optional[str] = pydantic.Field(None, description='The value sent by the client must begin with the specified characters.\n')
    range: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_MatchRangePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='An object that represents the range of values to match on.\n')
    regex: typing.Optional[str] = pydantic.Field(None, description='The value sent by the client must include the specified characters.\n')
...
class CfnRoute_GrpcRouteMetadataPropertyDef(BaseStruct):
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the route.\n')
    invert: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='Specify ``True`` to match anything except the match criteria. The default value is ``False`` .\n')
    match: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_GrpcRouteMetadataMatchMethodPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='An object that represents the data to match from the request.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-route-grpcroutemetadata.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    grpc_route_metadata_property = appmesh.CfnRoute.GrpcRouteMetadataProperty(\n        name="name",\n\n        # the properties below are optional\n        invert=False,\n        match=appmesh.CfnRoute.GrpcRouteMetadataMatchMethodProperty(\n            exact="exact",\n            prefix="prefix",\n            range=appmesh.CfnRoute.MatchRangeProperty(\n                end=123,\n                start=123\n            ),\n            regex="regex",\n            suffix="suffix"\n        )\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['name', 'invert', 'match']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnRoute_GrpcRoutePropertyDef(BaseStruct):
    action: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_appmesh.CfnRoute_GrpcRouteActionPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='An object that represents the action to take if a match is determined.\n')
    match: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_appmesh.CfnRoute_GrpcRouteMatchPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='An object that represents the criteria for determining a request match.\n')
    retry_policy: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_GrpcRetryPolicyPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='An object that represents a retry policy.\n')
    timeout: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_GrpcTimeoutPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='An object that represents types of timeouts.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-route-grpcroute.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    grpc_route_property = appmesh.CfnRoute.GrpcRouteProperty(\n        action=appmesh.CfnRoute.GrpcRouteActionProperty(\n            weighted_targets=[appmesh.CfnRoute.WeightedTargetProperty(\n                virtual_node="virtualNode",\n                weight=123,\n\n                # the properties below are optional\n                port=123\n            )]\n        ),\n        match=appmesh.CfnRoute.GrpcRouteMatchProperty(\n            metadata=[appmesh.CfnRoute.GrpcRouteMetadataProperty(\n                name="name",\n\n                # the properties below are optional\n                invert=False,\n                match=appmesh.CfnRoute.GrpcRouteMetadataMatchMethodProperty(\n                    exact="exact",\n                    prefix="prefix",\n                    range=appmesh.CfnRoute.MatchRangeProperty(\n                        end=123,\n                        start=123\n                    ),\n                    regex="regex",\n                    suffix="suffix"\n                )\n            )],\n            method_name="methodName",\n            port=123,\n            service_name="serviceName"\n        ),\n\n        # the properties below are optional\n        retry_policy=appmesh.CfnRoute.GrpcRetryPolicyProperty(\n            max_retries=123,\n            per_retry_timeout=appmesh.CfnRoute.DurationProperty(\n                unit="unit",\n                value=123\n            ),\n\n            # the properties below are optional\n            grpc_retry_events=["grpcRetryEvents"],\n            http_retry_events=["httpRetryEvents"],\n            tcp_retry_events=["tcpRetryEvents"]\n        ),\n        timeout=appmesh.CfnRoute.GrpcTimeoutProperty(\n            idle=appmesh.CfnRoute.DurationProperty(\n                unit="unit",\n                value=123\n            ),\n            per_request=appmesh.CfnRoute.DurationProperty(\n                unit="unit",\n                value=123\n            )\n        )\n    )\n')
...
class CfnRoute_HttpRouteHeaderPropertyDef(BaseStruct):
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A name for the HTTP header in the client request that will be matched on.\n')
    invert: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='Specify ``True`` to match anything except the match criteria. The default value is ``False`` .\n')
    match: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_HeaderMatchMethodPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The ``HeaderMatchMethod`` object.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-route-httprouteheader.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    http_route_header_property = appmesh.CfnRoute.HttpRouteHeaderProperty(\n        name="name",\n\n        # the properties below are optional\n        invert=False,\n        match=appmesh.CfnRoute.HeaderMatchMethodProperty(\n            exact="exact",\n            prefix="prefix",\n            range=appmesh.CfnRoute.MatchRangeProperty(\n                end=123,\n                start=123\n            ),\n            regex="regex",\n            suffix="suffix"\n        )\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['name', 'invert', 'match']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnRoute_HttpRouteMatchPropertyDef(BaseStruct):
    headers: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_HttpRouteHeaderPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The client request headers to match on.\n')
    method: typing.Optional[str] = pydantic.Field(None, description='The client request method to match on. Specify only one.\n')
    path: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_HttpPathMatchPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The client request path to match on.\n')
    port: typing.Union[int, float, None] = pydantic.Field(None, description='The port number to match on.\n')
    prefix: typing.Optional[str] = pydantic.Field(None, description='Specifies the path to match requests with. This parameter must always start with ``/`` , which by itself matches all requests to the virtual service name. You can also match for path-based routing of requests. For example, if your virtual service name is ``my-service.local`` and you want the route to match requests to ``my-service.local/metrics`` , your prefix should be ``/metrics`` .\n')
    query_parameters: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_QueryParameterPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The client request query parameters to match on.\n')
...
class CfnRoute_HttpRoutePropertyDef(BaseStruct):
    action: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_appmesh.CfnRoute_HttpRouteActionPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='An object that represents the action to take if a match is determined.\n')
    match: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_appmesh.CfnRoute_HttpRouteMatchPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='An object that represents the criteria for determining a request match.\n')
    retry_policy: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_HttpRetryPolicyPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='An object that represents a retry policy.\n')
    timeout: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_HttpTimeoutPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='An object that represents types of timeouts.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-route-httproute.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    http_route_property = appmesh.CfnRoute.HttpRouteProperty(\n        action=appmesh.CfnRoute.HttpRouteActionProperty(\n            weighted_targets=[appmesh.CfnRoute.WeightedTargetProperty(\n                virtual_node="virtualNode",\n                weight=123,\n\n                # the properties below are optional\n                port=123\n            )]\n        ),\n        match=appmesh.CfnRoute.HttpRouteMatchProperty(\n            headers=[appmesh.CfnRoute.HttpRouteHeaderProperty(\n                name="name",\n\n                # the properties below are optional\n                invert=False,\n                match=appmesh.CfnRoute.HeaderMatchMethodProperty(\n                    exact="exact",\n                    prefix="prefix",\n                    range=appmesh.CfnRoute.MatchRangeProperty(\n                        end=123,\n                        start=123\n                    ),\n                    regex="regex",\n                    suffix="suffix"\n                )\n            )],\n            method="method",\n            path=appmesh.CfnRoute.HttpPathMatchProperty(\n                exact="exact",\n                regex="regex"\n            ),\n            port=123,\n            prefix="prefix",\n            query_parameters=[appmesh.CfnRoute.QueryParameterProperty(\n                name="name",\n\n                # the properties below are optional\n                match=appmesh.CfnRoute.HttpQueryParameterMatchProperty(\n                    exact="exact"\n                )\n            )],\n            scheme="scheme"\n        ),\n\n        # the properties below are optional\n        retry_policy=appmesh.CfnRoute.HttpRetryPolicyProperty(\n            max_retries=123,\n            per_retry_timeout=appmesh.CfnRoute.DurationProperty(\n                unit="unit",\n                value=123\n            ),\n\n            # the properties below are optional\n            http_retry_events=["httpRetryEvents"],\n            tcp_retry_events=["tcpRetryEvents"]\n        ),\n        timeout=appmesh.CfnRoute.HttpTimeoutProperty(\n            idle=appmesh.CfnRoute.DurationProperty(\n                unit="unit",\n                value=123\n            ),\n            per_request=appmesh.CfnRoute.DurationProperty(\n                unit="unit",\n                value=123\n            )\n        )\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['action', 'match', 'retry_policy', 'timeout']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnRoute_QueryParameterPropertyDef(BaseStruct):
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A name for the query parameter that will be matched on.\n')
    match: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_HttpQueryParameterMatchPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The query parameter to match on.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-route-queryparameter.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    query_parameter_property = appmesh.CfnRoute.QueryParameterProperty(\n        name="name",\n\n        # the properties below are optional\n        match=appmesh.CfnRoute.HttpQueryParameterMatchProperty(\n            exact="exact"\n        )\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['name', 'match']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnRoute_RouteSpecPropertyDef(BaseStruct):
    grpc_route: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_GrpcRoutePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='An object that represents the specification of a gRPC route.\n')
    http2_route: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_HttpRoutePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='An object that represents the specification of an HTTP/2 route.\n')
    http_route: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_HttpRoutePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='An object that represents the specification of an HTTP route.\n')
...
class CfnRoute_TcpRoutePropertyDef(BaseStruct):
    action: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_appmesh.CfnRoute_TcpRouteActionPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The action to take if a match is determined.\n')
    match: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_TcpRouteMatchPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='An object that represents the criteria for determining a request match.\n')
    timeout: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_TcpTimeoutPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='An object that represents types of timeouts.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-route-tcproute.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    tcp_route_property = appmesh.CfnRoute.TcpRouteProperty(\n        action=appmesh.CfnRoute.TcpRouteActionProperty(\n            weighted_targets=[appmesh.CfnRoute.WeightedTargetProperty(\n                virtual_node="virtualNode",\n                weight=123,\n\n                # the properties below are optional\n                port=123\n            )]\n        ),\n\n        # the properties below are optional\n        match=appmesh.CfnRoute.TcpRouteMatchProperty(\n            port=123\n        ),\n        timeout=appmesh.CfnRoute.TcpTimeoutProperty(\n            idle=appmesh.CfnRoute.DurationProperty(\n                unit="unit",\n                value=123\n            )\n        )\n    )\n')
...
class CfnRoute_WeightedTargetPropertyDef(BaseStruct):
    virtual_node: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The virtual node to associate with the weighted target.\n')
    weight: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The relative weight of the weighted target.\n')
...
class CfnVirtualGateway_JsonFormatRefPropertyDef(BaseStruct):
    key: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The specified key for the JSON.\n')
    value: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The specified value for the JSON.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-virtualgateway-jsonformatref.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    json_format_ref_property = appmesh.CfnVirtualGateway.JsonFormatRefProperty(\n        key="key",\n        value="value"\n    )\n')
...
class CfnVirtualGateway_LoggingFormatPropertyDef(BaseStruct):
    json_: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_JsonFormatRefPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The logging format for JSON.\n', alias='json')
...
class CfnVirtualGateway_VirtualGatewayAccessLogPropertyDef(BaseStruct):
    file: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayFileAccessLogPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The file object to send virtual gateway access logs to.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-virtualgateway-virtualgatewayaccesslog.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    virtual_gateway_access_log_property = appmesh.CfnVirtualGateway.VirtualGatewayAccessLogProperty(\n        file=appmesh.CfnVirtualGateway.VirtualGatewayFileAccessLogProperty(\n            path="path",\n\n            # the properties below are optional\n            format=appmesh.CfnVirtualGateway.LoggingFormatProperty(\n                json=[appmesh.CfnVirtualGateway.JsonFormatRefProperty(\n                    key="key",\n                    value="value"\n                )],\n                text="text"\n            )\n        )\n    )\n')
...
class CfnVirtualGateway_VirtualGatewayClientPolicyPropertyDef(BaseStruct):
    tls: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayClientPolicyTlsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A reference to an object that represents a Transport Layer Security (TLS) client policy.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-virtualgateway-virtualgatewayclientpolicy.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    virtual_gateway_client_policy_property = appmesh.CfnVirtualGateway.VirtualGatewayClientPolicyProperty(\n        tls=appmesh.CfnVirtualGateway.VirtualGatewayClientPolicyTlsProperty(\n            validation=appmesh.CfnVirtualGateway.VirtualGatewayTlsValidationContextProperty(\n                trust=appmesh.CfnVirtualGateway.VirtualGatewayTlsValidationContextTrustProperty(\n                    acm=appmesh.CfnVirtualGateway.VirtualGatewayTlsValidationContextAcmTrustProperty(\n                        certificate_authority_arns=["certificateAuthorityArns"]\n                    ),\n                    file=appmesh.CfnVirtualGateway.VirtualGatewayTlsValidationContextFileTrustProperty(\n                        certificate_chain="certificateChain"\n                    ),\n                    sds=appmesh.CfnVirtualGateway.VirtualGatewayTlsValidationContextSdsTrustProperty(\n                        secret_name="secretName"\n                    )\n                ),\n\n                # the properties below are optional\n                subject_alternative_names=appmesh.CfnVirtualGateway.SubjectAlternativeNamesProperty(\n                    match=appmesh.CfnVirtualGateway.SubjectAlternativeNameMatchersProperty(\n                        exact=["exact"]\n                    )\n                )\n            ),\n\n            # the properties below are optional\n            certificate=appmesh.CfnVirtualGateway.VirtualGatewayClientTlsCertificateProperty(\n                file=appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsFileCertificateProperty(\n                    certificate_chain="certificateChain",\n                    private_key="privateKey"\n                ),\n                sds=appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsSdsCertificateProperty(\n                    secret_name="secretName"\n                )\n            ),\n            enforce=False,\n            ports=[123]\n        )\n    )\n')
...
class CfnVirtualGateway_VirtualGatewayClientPolicyTlsPropertyDef(BaseStruct):
    validation: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayTlsValidationContextPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='A reference to an object that represents a Transport Layer Security (TLS) validation context.\n')
    certificate: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayClientTlsCertificatePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description="A reference to an object that represents a virtual gateway's client's Transport Layer Security (TLS) certificate.\n")
    enforce: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description="Whether the policy is enforced. The default is ``True`` , if a value isn't specified.\n")
    ports: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[int, float]], None] = pydantic.Field(None, description='One or more ports that the policy is enforced for.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-virtualgateway-virtualgatewayclientpolicytls.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    virtual_gateway_client_policy_tls_property = appmesh.CfnVirtualGateway.VirtualGatewayClientPolicyTlsProperty(\n        validation=appmesh.CfnVirtualGateway.VirtualGatewayTlsValidationContextProperty(\n            trust=appmesh.CfnVirtualGateway.VirtualGatewayTlsValidationContextTrustProperty(\n                acm=appmesh.CfnVirtualGateway.VirtualGatewayTlsValidationContextAcmTrustProperty(\n                    certificate_authority_arns=["certificateAuthorityArns"]\n                ),\n                file=appmesh.CfnVirtualGateway.VirtualGatewayTlsValidationContextFileTrustProperty(\n                    certificate_chain="certificateChain"\n                ),\n                sds=appmesh.CfnVirtualGateway.VirtualGatewayTlsValidationContextSdsTrustProperty(\n                    secret_name="secretName"\n                )\n            ),\n\n            # the properties below are optional\n            subject_alternative_names=appmesh.CfnVirtualGateway.SubjectAlternativeNamesProperty(\n                match=appmesh.CfnVirtualGateway.SubjectAlternativeNameMatchersProperty(\n                    exact=["exact"]\n                )\n            )\n        ),\n\n        # the properties below are optional\n        certificate=appmesh.CfnVirtualGateway.VirtualGatewayClientTlsCertificateProperty(\n            file=appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsFileCertificateProperty(\n                certificate_chain="certificateChain",\n                private_key="privateKey"\n            ),\n            sds=appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsSdsCertificateProperty(\n                secret_name="secretName"\n            )\n        ),\n        enforce=False,\n        ports=[123]\n    )\n')
...
class CfnVirtualGateway_VirtualGatewayConnectionPoolPropertyDef(BaseStruct):
    grpc: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayGrpcConnectionPoolPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='An object that represents a type of connection pool.\n')
    http: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayHttpConnectionPoolPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='An object that represents a type of connection pool.\n')
    http2: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayHttp2ConnectionPoolPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='An object that represents a type of connection pool.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-virtualgateway-virtualgatewayconnectionpool.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    virtual_gateway_connection_pool_property = appmesh.CfnVirtualGateway.VirtualGatewayConnectionPoolProperty(\n        grpc=appmesh.CfnVirtualGateway.VirtualGatewayGrpcConnectionPoolProperty(\n            max_requests=123\n        ),\n        http=appmesh.CfnVirtualGateway.VirtualGatewayHttpConnectionPoolProperty(\n            max_connections=123,\n\n            # the properties below are optional\n            max_pending_requests=123\n        ),\n        http2=appmesh.CfnVirtualGateway.VirtualGatewayHttp2ConnectionPoolProperty(\n            max_requests=123\n        )\n    )\n')
...
class CfnVirtualGateway_VirtualGatewayFileAccessLogPropertyDef(BaseStruct):
    path: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description="The file path to write access logs to. You can use ``/dev/stdout`` to send access logs to standard out and configure your Envoy container to use a log driver, such as ``awslogs`` , to export the access logs to a log storage service such as Amazon CloudWatch Logs. You can also specify a path in the Envoy container's file system to write the files to disk.\n")
    format: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_LoggingFormatPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The specified format for the virtual gateway access logs. It can be either ``json_format`` or ``text_format`` .\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-virtualgateway-virtualgatewayfileaccesslog.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    virtual_gateway_file_access_log_property = appmesh.CfnVirtualGateway.VirtualGatewayFileAccessLogProperty(\n        path="path",\n\n        # the properties below are optional\n        format=appmesh.CfnVirtualGateway.LoggingFormatProperty(\n            json=[appmesh.CfnVirtualGateway.JsonFormatRefProperty(\n                key="key",\n                value="value"\n            )],\n            text="text"\n        )\n    )\n')
...
class CfnVirtualGateway_VirtualGatewayHealthCheckPolicyPropertyDef(BaseStruct):
    healthy_threshold: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The number of consecutive successful health checks that must occur before declaring the listener healthy.\n')
    interval_millis: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The time period in milliseconds between each health check execution.\n')
    protocol: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The protocol for the health check request. If you specify ``grpc`` , then your service must conform to the `GRPC Health Checking Protocol <https://docs.aws.amazon.com/https://github.com/grpc/grpc/blob/master/doc/health-checking.md>`_ .\n')
    timeout_millis: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The amount of time to wait when receiving a response from the health check, in milliseconds.\n')
    unhealthy_threshold: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The number of consecutive failed health checks that must occur before declaring a virtual gateway unhealthy.\n')
...
class CfnVirtualGateway_VirtualGatewayHttpConnectionPoolPropertyDef(BaseStruct):
    max_connections: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='Maximum number of outbound TCP connections Envoy can establish concurrently with all hosts in upstream cluster.\n')
...
class CfnVirtualGateway_VirtualGatewayListenerPropertyDef(BaseStruct):
    port_mapping: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayPortMappingPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The port mapping information for the listener.\n')
    connection_pool: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayConnectionPoolPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The connection pool information for the listener.\n')
    health_check: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayHealthCheckPolicyPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The health check information for the listener.\n')
    tls: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayListenerTlsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A reference to an object that represents the Transport Layer Security (TLS) properties for the listener.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-virtualgateway-virtualgatewaylistener.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    virtual_gateway_listener_property = appmesh.CfnVirtualGateway.VirtualGatewayListenerProperty(\n        port_mapping=appmesh.CfnVirtualGateway.VirtualGatewayPortMappingProperty(\n            port=123,\n            protocol="protocol"\n        ),\n\n        # the properties below are optional\n        connection_pool=appmesh.CfnVirtualGateway.VirtualGatewayConnectionPoolProperty(\n            grpc=appmesh.CfnVirtualGateway.VirtualGatewayGrpcConnectionPoolProperty(\n                max_requests=123\n            ),\n            http=appmesh.CfnVirtualGateway.VirtualGatewayHttpConnectionPoolProperty(\n                max_connections=123,\n\n                # the properties below are optional\n                max_pending_requests=123\n            ),\n            http2=appmesh.CfnVirtualGateway.VirtualGatewayHttp2ConnectionPoolProperty(\n                max_requests=123\n            )\n        ),\n        health_check=appmesh.CfnVirtualGateway.VirtualGatewayHealthCheckPolicyProperty(\n            healthy_threshold=123,\n            interval_millis=123,\n            protocol="protocol",\n            timeout_millis=123,\n            unhealthy_threshold=123,\n\n            # the properties below are optional\n            path="path",\n            port=123\n        ),\n        tls=appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsProperty(\n            certificate=appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsCertificateProperty(\n                acm=appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsAcmCertificateProperty(\n                    certificate_arn="certificateArn"\n                ),\n                file=appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsFileCertificateProperty(\n                    certificate_chain="certificateChain",\n                    private_key="privateKey"\n                ),\n                sds=appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsSdsCertificateProperty(\n                    secret_name="secretName"\n                )\n            ),\n            mode="mode",\n\n            # the properties below are optional\n            validation=appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsValidationContextProperty(\n                trust=appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsValidationContextTrustProperty(\n                    file=appmesh.CfnVirtualGateway.VirtualGatewayTlsValidationContextFileTrustProperty(\n                        certificate_chain="certificateChain"\n                    ),\n                    sds=appmesh.CfnVirtualGateway.VirtualGatewayTlsValidationContextSdsTrustProperty(\n                        secret_name="secretName"\n                    )\n                ),\n\n                # the properties below are optional\n                subject_alternative_names=appmesh.CfnVirtualGateway.SubjectAlternativeNamesProperty(\n                    match=appmesh.CfnVirtualGateway.SubjectAlternativeNameMatchersProperty(\n                        exact=["exact"]\n                    )\n                )\n            )\n        )\n    )\n')
...
class CfnVirtualGateway_VirtualGatewayListenerTlsCertificatePropertyDef(BaseStruct):
    acm: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayListenerTlsAcmCertificatePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A reference to an object that represents an AWS Certificate Manager certificate.\n')
    file: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayListenerTlsFileCertificatePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A reference to an object that represents a local file certificate.\n')
    sds: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayListenerTlsSdsCertificatePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A reference to an object that represents a virtual gateway\'s listener\'s Secret Discovery Service certificate.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-virtualgateway-virtualgatewaylistenertlscertificate.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    virtual_gateway_listener_tls_certificate_property = appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsCertificateProperty(\n        acm=appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsAcmCertificateProperty(\n            certificate_arn="certificateArn"\n        ),\n        file=appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsFileCertificateProperty(\n            certificate_chain="certificateChain",\n            private_key="privateKey"\n        ),\n        sds=appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsSdsCertificateProperty(\n            secret_name="secretName"\n        )\n    )\n')
...
class CfnVirtualGateway_VirtualGatewayListenerTlsFileCertificatePropertyDef(BaseStruct):
    certificate_chain: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The certificate chain for the certificate.\n')
    private_key: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The private key for a certificate stored on the file system of the mesh endpoint that the proxy is running on.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-virtualgateway-virtualgatewaylistenertlsfilecertificate.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    virtual_gateway_listener_tls_file_certificate_property = appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsFileCertificateProperty(\n        certificate_chain="certificateChain",\n        private_key="privateKey"\n    )\n')
...
class CfnVirtualGateway_VirtualGatewayListenerTlsPropertyDef(BaseStruct):
    certificate: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayListenerTlsCertificatePropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='An object that represents a Transport Layer Security (TLS) certificate.\n')
    mode: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Specify one of the following modes. - ** STRICT – Listener only accepts connections with TLS enabled. - ** PERMISSIVE – Listener accepts connections with or without TLS enabled. - ** DISABLED – Listener only accepts connections without TLS.\n')
    validation: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayListenerTlsValidationContextPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A reference to an object that represents a virtual gateway\'s listener\'s Transport Layer Security (TLS) validation context.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-virtualgateway-virtualgatewaylistenertls.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    virtual_gateway_listener_tls_property = appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsProperty(\n        certificate=appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsCertificateProperty(\n            acm=appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsAcmCertificateProperty(\n                certificate_arn="certificateArn"\n            ),\n            file=appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsFileCertificateProperty(\n                certificate_chain="certificateChain",\n                private_key="privateKey"\n            ),\n            sds=appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsSdsCertificateProperty(\n                secret_name="secretName"\n            )\n        ),\n        mode="mode",\n\n        # the properties below are optional\n        validation=appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsValidationContextProperty(\n            trust=appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsValidationContextTrustProperty(\n                file=appmesh.CfnVirtualGateway.VirtualGatewayTlsValidationContextFileTrustProperty(\n                    certificate_chain="certificateChain"\n                ),\n                sds=appmesh.CfnVirtualGateway.VirtualGatewayTlsValidationContextSdsTrustProperty(\n                    secret_name="secretName"\n                )\n            ),\n\n            # the properties below are optional\n            subject_alternative_names=appmesh.CfnVirtualGateway.SubjectAlternativeNamesProperty(\n                match=appmesh.CfnVirtualGateway.SubjectAlternativeNameMatchersProperty(\n                    exact=["exact"]\n                )\n            )\n        )\n    )\n')
...
class CfnVirtualGateway_VirtualGatewayListenerTlsSdsCertificatePropertyDef(BaseStruct):
    secret_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A reference to an object that represents the name of the secret secret requested from the Secret Discovery Service provider representing Transport Layer Security (TLS) materials like a certificate or certificate chain.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-virtualgateway-virtualgatewaylistenertlssdscertificate.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    virtual_gateway_listener_tls_sds_certificate_property = appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsSdsCertificateProperty(\n        secret_name="secretName"\n    )\n')
...
class CfnVirtualGateway_VirtualGatewayListenerTlsValidationContextPropertyDef(BaseStruct):
    trust: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayListenerTlsValidationContextTrustPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='A reference to where to retrieve the trust chain when validating a peer’s Transport Layer Security (TLS) certificate.\n')
    subject_alternative_names: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_SubjectAlternativeNamesPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A reference to an object that represents the SANs for a virtual gateway listener\'s Transport Layer Security (TLS) validation context.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-virtualgateway-virtualgatewaylistenertlsvalidationcontext.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    virtual_gateway_listener_tls_validation_context_property = appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsValidationContextProperty(\n        trust=appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsValidationContextTrustProperty(\n            file=appmesh.CfnVirtualGateway.VirtualGatewayTlsValidationContextFileTrustProperty(\n                certificate_chain="certificateChain"\n            ),\n            sds=appmesh.CfnVirtualGateway.VirtualGatewayTlsValidationContextSdsTrustProperty(\n                secret_name="secretName"\n            )\n        ),\n\n        # the properties below are optional\n        subject_alternative_names=appmesh.CfnVirtualGateway.SubjectAlternativeNamesProperty(\n            match=appmesh.CfnVirtualGateway.SubjectAlternativeNameMatchersProperty(\n                exact=["exact"]\n            )\n        )\n    )\n')
...
class CfnVirtualGateway_VirtualGatewayPortMappingPropertyDef(BaseStruct):
    port: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The port used for the port mapping. Specify one protocol.\n')
    protocol: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The protocol used for the port mapping.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-virtualgateway-virtualgatewayportmapping.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    virtual_gateway_port_mapping_property = appmesh.CfnVirtualGateway.VirtualGatewayPortMappingProperty(\n        port=123,\n        protocol="protocol"\n    )\n')
...
class CfnVirtualGateway_VirtualGatewaySpecPropertyDef(BaseStruct):
    listeners: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayListenerPropertyDef, dict[str, typing.Any]]]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The listeners that the mesh endpoint is expected to receive inbound traffic from. You can specify one listener.\n')
    backend_defaults: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayBackendDefaultsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A reference to an object that represents the defaults for backends.\n')
    logging: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayLoggingPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='An object that represents logging information.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-virtualgateway-virtualgatewayspec.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    virtual_gateway_spec_property = appmesh.CfnVirtualGateway.VirtualGatewaySpecProperty(\n        listeners=[appmesh.CfnVirtualGateway.VirtualGatewayListenerProperty(\n            port_mapping=appmesh.CfnVirtualGateway.VirtualGatewayPortMappingProperty(\n                port=123,\n                protocol="protocol"\n            ),\n\n            # the properties below are optional\n            connection_pool=appmesh.CfnVirtualGateway.VirtualGatewayConnectionPoolProperty(\n                grpc=appmesh.CfnVirtualGateway.VirtualGatewayGrpcConnectionPoolProperty(\n                    max_requests=123\n                ),\n                http=appmesh.CfnVirtualGateway.VirtualGatewayHttpConnectionPoolProperty(\n                    max_connections=123,\n\n                    # the properties below are optional\n                    max_pending_requests=123\n                ),\n                http2=appmesh.CfnVirtualGateway.VirtualGatewayHttp2ConnectionPoolProperty(\n                    max_requests=123\n                )\n            ),\n            health_check=appmesh.CfnVirtualGateway.VirtualGatewayHealthCheckPolicyProperty(\n                healthy_threshold=123,\n                interval_millis=123,\n                protocol="protocol",\n                timeout_millis=123,\n                unhealthy_threshold=123,\n\n                # the properties below are optional\n                path="path",\n                port=123\n            ),\n            tls=appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsProperty(\n                certificate=appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsCertificateProperty(\n                    acm=appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsAcmCertificateProperty(\n                        certificate_arn="certificateArn"\n                    ),\n                    file=appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsFileCertificateProperty(\n                        certificate_chain="certificateChain",\n                        private_key="privateKey"\n                    ),\n                    sds=appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsSdsCertificateProperty(\n                        secret_name="secretName"\n                    )\n                ),\n                mode="mode",\n\n                # the properties below are optional\n                validation=appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsValidationContextProperty(\n                    trust=appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsValidationContextTrustProperty(\n                        file=appmesh.CfnVirtualGateway.VirtualGatewayTlsValidationContextFileTrustProperty(\n                            certificate_chain="certificateChain"\n                        ),\n                        sds=appmesh.CfnVirtualGateway.VirtualGatewayTlsValidationContextSdsTrustProperty(\n                            secret_name="secretName"\n                        )\n                    ),\n\n                    # the properties below are optional\n                    subject_alternative_names=appmesh.CfnVirtualGateway.SubjectAlternativeNamesProperty(\n                        match=appmesh.CfnVirtualGateway.SubjectAlternativeNameMatchersProperty(\n                            exact=["exact"]\n                        )\n                    )\n                )\n            )\n        )],\n\n        # the properties below are optional\n        backend_defaults=appmesh.CfnVirtualGateway.VirtualGatewayBackendDefaultsProperty(\n            client_policy=appmesh.CfnVirtualGateway.VirtualGatewayClientPolicyProperty(\n                tls=appmesh.CfnVirtualGateway.VirtualGatewayClientPolicyTlsProperty(\n                    validation=appmesh.CfnVirtualGateway.VirtualGatewayTlsValidationContextProperty(\n                        trust=appmesh.CfnVirtualGateway.VirtualGatewayTlsValidationContextTrustProperty(\n                            acm=appmesh.CfnVirtualGateway.VirtualGatewayTlsValidationContextAcmTrustProperty(\n                                certificate_authority_arns=["certificateAuthorityArns"]\n                            ),\n                            file=appmesh.CfnVirtualGateway.VirtualGatewayTlsValidationContextFileTrustProperty(\n                                certificate_chain="certificateChain"\n                            ),\n                            sds=appmesh.CfnVirtualGateway.VirtualGatewayTlsValidationContextSdsTrustProperty(\n                                secret_name="secretName"\n                            )\n                        ),\n\n                        # the properties below are optional\n                        subject_alternative_names=appmesh.CfnVirtualGateway.SubjectAlternativeNamesProperty(\n                            match=appmesh.CfnVirtualGateway.SubjectAlternativeNameMatchersProperty(\n                                exact=["exact"]\n                            )\n                        )\n                    ),\n\n                    # the properties below are optional\n                    certificate=appmesh.CfnVirtualGateway.VirtualGatewayClientTlsCertificateProperty(\n                        file=appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsFileCertificateProperty(\n                            certificate_chain="certificateChain",\n                            private_key="privateKey"\n                        ),\n                        sds=appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsSdsCertificateProperty(\n                            secret_name="secretName"\n                        )\n                    ),\n                    enforce=False,\n                    ports=[123]\n                )\n            )\n        ),\n        logging=appmesh.CfnVirtualGateway.VirtualGatewayLoggingProperty(\n            access_log=appmesh.CfnVirtualGateway.VirtualGatewayAccessLogProperty(\n                file=appmesh.CfnVirtualGateway.VirtualGatewayFileAccessLogProperty(\n                    path="path",\n\n                    # the properties below are optional\n                    format=appmesh.CfnVirtualGateway.LoggingFormatProperty(\n                        json=[appmesh.CfnVirtualGateway.JsonFormatRefProperty(\n                            key="key",\n                            value="value"\n                        )],\n                        text="text"\n                    )\n                )\n            )\n        )\n    )\n')
...
class CfnVirtualGateway_VirtualGatewayTlsValidationContextPropertyDef(BaseStruct):
    trust: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayTlsValidationContextTrustPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='A reference to where to retrieve the trust chain when validating a peer’s Transport Layer Security (TLS) certificate.\n')
    subject_alternative_names: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_SubjectAlternativeNamesPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A reference to an object that represents the SANs for a virtual gateway\'s listener\'s Transport Layer Security (TLS) validation context.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-virtualgateway-virtualgatewaytlsvalidationcontext.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    virtual_gateway_tls_validation_context_property = appmesh.CfnVirtualGateway.VirtualGatewayTlsValidationContextProperty(\n        trust=appmesh.CfnVirtualGateway.VirtualGatewayTlsValidationContextTrustProperty(\n            acm=appmesh.CfnVirtualGateway.VirtualGatewayTlsValidationContextAcmTrustProperty(\n                certificate_authority_arns=["certificateAuthorityArns"]\n            ),\n            file=appmesh.CfnVirtualGateway.VirtualGatewayTlsValidationContextFileTrustProperty(\n                certificate_chain="certificateChain"\n            ),\n            sds=appmesh.CfnVirtualGateway.VirtualGatewayTlsValidationContextSdsTrustProperty(\n                secret_name="secretName"\n            )\n        ),\n\n        # the properties below are optional\n        subject_alternative_names=appmesh.CfnVirtualGateway.SubjectAlternativeNamesProperty(\n            match=appmesh.CfnVirtualGateway.SubjectAlternativeNameMatchersProperty(\n                exact=["exact"]\n            )\n        )\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['trust', 'subject_alternative_names']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnVirtualGateway_VirtualGatewayTlsValidationContextTrustPropertyDef(BaseStruct):
    acm: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayTlsValidationContextAcmTrustPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A reference to an object that represents a Transport Layer Security (TLS) validation context trust for an AWS Certificate Manager certificate.\n')
    file: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayTlsValidationContextFileTrustPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='An object that represents a Transport Layer Security (TLS) validation context trust for a local file.\n')
...
class CfnVirtualNode_AccessLogPropertyDef(BaseStruct):
    file: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_FileAccessLogPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The file object to send virtual node access logs to.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-virtualnode-accesslog.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    access_log_property = appmesh.CfnVirtualNode.AccessLogProperty(\n        file=appmesh.CfnVirtualNode.FileAccessLogProperty(\n            path="path",\n\n            # the properties below are optional\n            format=appmesh.CfnVirtualNode.LoggingFormatProperty(\n                json=[appmesh.CfnVirtualNode.JsonFormatRefProperty(\n                    key="key",\n                    value="value"\n                )],\n                text="text"\n            )\n        )\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['file']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnVirtualNode_AwsCloudMapInstanceAttributePropertyDef(BaseStruct):
    key: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of an AWS Cloud Map service instance attribute key. Any AWS Cloud Map service instance that contains the specified key and value is returned.\n')
    value: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The value of an AWS Cloud Map service instance attribute key. Any AWS Cloud Map service instance that contains the specified key and value is returned.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-virtualnode-awscloudmapinstanceattribute.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    aws_cloud_map_instance_attribute_property = appmesh.CfnVirtualNode.AwsCloudMapInstanceAttributeProperty(\n        key="key",\n        value="value"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['key', 'value']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnVirtualNode_AwsCloudMapServiceDiscoveryPropertyDef(BaseStruct):
    namespace_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The HTTP name of the AWS Cloud Map namespace to use.\n')
    service_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the AWS Cloud Map service to use.\n')
    attributes: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_AwsCloudMapInstanceAttributePropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='A string map that contains attributes with values that you can use to filter instances by any custom attribute that you specified when you registered the instance. Only instances that match all of the specified key/value pairs will be returned.\n')
...
class CfnVirtualNode_BackendDefaultsPropertyDef(BaseStruct):
    client_policy: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_ClientPolicyPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A reference to an object that represents a client policy.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-virtualnode-backenddefaults.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    backend_defaults_property = appmesh.CfnVirtualNode.BackendDefaultsProperty(\n        client_policy=appmesh.CfnVirtualNode.ClientPolicyProperty(\n            tls=appmesh.CfnVirtualNode.ClientPolicyTlsProperty(\n                validation=appmesh.CfnVirtualNode.TlsValidationContextProperty(\n                    trust=appmesh.CfnVirtualNode.TlsValidationContextTrustProperty(\n                        acm=appmesh.CfnVirtualNode.TlsValidationContextAcmTrustProperty(\n                            certificate_authority_arns=["certificateAuthorityArns"]\n                        ),\n                        file=appmesh.CfnVirtualNode.TlsValidationContextFileTrustProperty(\n                            certificate_chain="certificateChain"\n                        ),\n                        sds=appmesh.CfnVirtualNode.TlsValidationContextSdsTrustProperty(\n                            secret_name="secretName"\n                        )\n                    ),\n\n                    # the properties below are optional\n                    subject_alternative_names=appmesh.CfnVirtualNode.SubjectAlternativeNamesProperty(\n                        match=appmesh.CfnVirtualNode.SubjectAlternativeNameMatchersProperty(\n                            exact=["exact"]\n                        )\n                    )\n                ),\n\n                # the properties below are optional\n                certificate=appmesh.CfnVirtualNode.ClientTlsCertificateProperty(\n                    file=appmesh.CfnVirtualNode.ListenerTlsFileCertificateProperty(\n                        certificate_chain="certificateChain",\n                        private_key="privateKey"\n                    ),\n                    sds=appmesh.CfnVirtualNode.ListenerTlsSdsCertificateProperty(\n                        secret_name="secretName"\n                    )\n                ),\n                enforce=False,\n                ports=[123]\n            )\n        )\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['client_policy']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnVirtualNode_BackendPropertyDef(BaseStruct):
    virtual_service: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_VirtualServiceBackendPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Specifies a virtual service to use as a backend.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-virtualnode-backend.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    backend_property = appmesh.CfnVirtualNode.BackendProperty(\n        virtual_service=appmesh.CfnVirtualNode.VirtualServiceBackendProperty(\n            virtual_service_name="virtualServiceName",\n\n            # the properties below are optional\n            client_policy=appmesh.CfnVirtualNode.ClientPolicyProperty(\n                tls=appmesh.CfnVirtualNode.ClientPolicyTlsProperty(\n                    validation=appmesh.CfnVirtualNode.TlsValidationContextProperty(\n                        trust=appmesh.CfnVirtualNode.TlsValidationContextTrustProperty(\n                            acm=appmesh.CfnVirtualNode.TlsValidationContextAcmTrustProperty(\n                                certificate_authority_arns=["certificateAuthorityArns"]\n                            ),\n                            file=appmesh.CfnVirtualNode.TlsValidationContextFileTrustProperty(\n                                certificate_chain="certificateChain"\n                            ),\n                            sds=appmesh.CfnVirtualNode.TlsValidationContextSdsTrustProperty(\n                                secret_name="secretName"\n                            )\n                        ),\n\n                        # the properties below are optional\n                        subject_alternative_names=appmesh.CfnVirtualNode.SubjectAlternativeNamesProperty(\n                            match=appmesh.CfnVirtualNode.SubjectAlternativeNameMatchersProperty(\n                                exact=["exact"]\n                            )\n                        )\n                    ),\n\n                    # the properties below are optional\n                    certificate=appmesh.CfnVirtualNode.ClientTlsCertificateProperty(\n                        file=appmesh.CfnVirtualNode.ListenerTlsFileCertificateProperty(\n                            certificate_chain="certificateChain",\n                            private_key="privateKey"\n                        ),\n                        sds=appmesh.CfnVirtualNode.ListenerTlsSdsCertificateProperty(\n                            secret_name="secretName"\n                        )\n                    ),\n                    enforce=False,\n                    ports=[123]\n                )\n            )\n        )\n    )\n')
...
class CfnVirtualNode_ClientPolicyPropertyDef(BaseStruct):
    tls: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_ClientPolicyTlsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A reference to an object that represents a Transport Layer Security (TLS) client policy.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-virtualnode-clientpolicy.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    client_policy_property = appmesh.CfnVirtualNode.ClientPolicyProperty(\n        tls=appmesh.CfnVirtualNode.ClientPolicyTlsProperty(\n            validation=appmesh.CfnVirtualNode.TlsValidationContextProperty(\n                trust=appmesh.CfnVirtualNode.TlsValidationContextTrustProperty(\n                    acm=appmesh.CfnVirtualNode.TlsValidationContextAcmTrustProperty(\n                        certificate_authority_arns=["certificateAuthorityArns"]\n                    ),\n                    file=appmesh.CfnVirtualNode.TlsValidationContextFileTrustProperty(\n                        certificate_chain="certificateChain"\n                    ),\n                    sds=appmesh.CfnVirtualNode.TlsValidationContextSdsTrustProperty(\n                        secret_name="secretName"\n                    )\n                ),\n\n                # the properties below are optional\n                subject_alternative_names=appmesh.CfnVirtualNode.SubjectAlternativeNamesProperty(\n                    match=appmesh.CfnVirtualNode.SubjectAlternativeNameMatchersProperty(\n                        exact=["exact"]\n                    )\n                )\n            ),\n\n            # the properties below are optional\n            certificate=appmesh.CfnVirtualNode.ClientTlsCertificateProperty(\n                file=appmesh.CfnVirtualNode.ListenerTlsFileCertificateProperty(\n                    certificate_chain="certificateChain",\n                    private_key="privateKey"\n                ),\n                sds=appmesh.CfnVirtualNode.ListenerTlsSdsCertificateProperty(\n                    secret_name="secretName"\n                )\n            ),\n            enforce=False,\n            ports=[123]\n        )\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['tls']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnVirtualNode_ClientPolicyTlsPropertyDef(BaseStruct):
    validation: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_TlsValidationContextPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='A reference to an object that represents a TLS validation context.\n')
    certificate: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_ClientTlsCertificatePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description="A reference to an object that represents a client's TLS certificate.\n")
    enforce: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description="Whether the policy is enforced. The default is ``True`` , if a value isn't specified.\n")
...
class CfnVirtualNode_ClientTlsCertificatePropertyDef(BaseStruct):
    file: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_ListenerTlsFileCertificatePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='An object that represents a local file certificate. The certificate must meet specific requirements and you must have proxy authorization enabled. For more information, see `Transport Layer Security (TLS) <https://docs.aws.amazon.com/app-mesh/latest/userguide/tls.html>`_ .\n')
    sds: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_ListenerTlsSdsCertificatePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A reference to an object that represents a client\'s TLS Secret Discovery Service certificate.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-virtualnode-clienttlscertificate.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    client_tls_certificate_property = appmesh.CfnVirtualNode.ClientTlsCertificateProperty(\n        file=appmesh.CfnVirtualNode.ListenerTlsFileCertificateProperty(\n            certificate_chain="certificateChain",\n            private_key="privateKey"\n        ),\n        sds=appmesh.CfnVirtualNode.ListenerTlsSdsCertificateProperty(\n            secret_name="secretName"\n        )\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['file', 'sds']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnVirtualNode_DnsServiceDiscoveryPropertyDef(BaseStruct):
    hostname: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Specifies the DNS service discovery hostname for the virtual node.\n')
    ip_preference: typing.Optional[str] = pydantic.Field(None, description='The preferred IP version that this virtual node uses. Setting the IP preference on the virtual node only overrides the IP preference set for the mesh on this specific node.\n')
...
class CfnVirtualNode_FileAccessLogPropertyDef(BaseStruct):
    ...
    format: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_LoggingFormatPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The specified format for the logs. The format is either ``json_format`` or ``text_format`` .\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-virtualnode-fileaccesslog.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    file_access_log_property = appmesh.CfnVirtualNode.FileAccessLogProperty(\n        path="path",\n\n        # the properties below are optional\n        format=appmesh.CfnVirtualNode.LoggingFormatProperty(\n            json=[appmesh.CfnVirtualNode.JsonFormatRefProperty(\n                key="key",\n                value="value"\n            )],\n            text="text"\n        )\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['path', 'format']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnVirtualNode_HealthCheckPropertyDef(BaseStruct):
    healthy_threshold: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The number of consecutive successful health checks that must occur before declaring listener healthy.\n')
    interval_millis: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The time period in milliseconds between each health check execution.\n')
    protocol: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The protocol for the health check request. If you specify ``grpc`` , then your service must conform to the `GRPC Health Checking Protocol <https://docs.aws.amazon.com/https://github.com/grpc/grpc/blob/master/doc/health-checking.md>`_ .\n')
    timeout_millis: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The amount of time to wait when receiving a response from the health check, in milliseconds.\n')
    unhealthy_threshold: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The number of consecutive failed health checks that must occur before declaring a virtual node unhealthy.\n')
    path: typing.Optional[str] = pydantic.Field(None, description='The destination path for the health check request. This value is only used if the specified protocol is HTTP or HTTP/2. For any other protocol, this value is ignored.\n')
...
class CfnVirtualNode_ListenerPropertyDef(BaseStruct):
    port_mapping: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_PortMappingPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The port mapping information for the listener.\n')
    connection_pool: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_VirtualNodeConnectionPoolPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The connection pool information for the listener.\n')
    health_check: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_HealthCheckPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The health check information for the listener.\n')
    outlier_detection: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_OutlierDetectionPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The outlier detection information for the listener.\n')
    timeout: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_ListenerTimeoutPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='An object that represents timeouts for different protocols.\n')
    tls: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_ListenerTlsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A reference to an object that represents the Transport Layer Security (TLS) properties for a listener.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-virtualnode-listener.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    listener_property = appmesh.CfnVirtualNode.ListenerProperty(\n        port_mapping=appmesh.CfnVirtualNode.PortMappingProperty(\n            port=123,\n            protocol="protocol"\n        ),\n\n        # the properties below are optional\n        connection_pool=appmesh.CfnVirtualNode.VirtualNodeConnectionPoolProperty(\n            grpc=appmesh.CfnVirtualNode.VirtualNodeGrpcConnectionPoolProperty(\n                max_requests=123\n            ),\n            http=appmesh.CfnVirtualNode.VirtualNodeHttpConnectionPoolProperty(\n                max_connections=123,\n\n                # the properties below are optional\n                max_pending_requests=123\n            ),\n            http2=appmesh.CfnVirtualNode.VirtualNodeHttp2ConnectionPoolProperty(\n                max_requests=123\n            ),\n            tcp=appmesh.CfnVirtualNode.VirtualNodeTcpConnectionPoolProperty(\n                max_connections=123\n            )\n        ),\n        health_check=appmesh.CfnVirtualNode.HealthCheckProperty(\n            healthy_threshold=123,\n            interval_millis=123,\n            protocol="protocol",\n            timeout_millis=123,\n            unhealthy_threshold=123,\n\n            # the properties below are optional\n            path="path",\n            port=123\n        ),\n        outlier_detection=appmesh.CfnVirtualNode.OutlierDetectionProperty(\n            base_ejection_duration=appmesh.CfnVirtualNode.DurationProperty(\n                unit="unit",\n                value=123\n            ),\n            interval=appmesh.CfnVirtualNode.DurationProperty(\n                unit="unit",\n                value=123\n            ),\n            max_ejection_percent=123,\n            max_server_errors=123\n        ),\n        timeout=appmesh.CfnVirtualNode.ListenerTimeoutProperty(\n            grpc=appmesh.CfnVirtualNode.GrpcTimeoutProperty(\n                idle=appmesh.CfnVirtualNode.DurationProperty(\n                    unit="unit",\n                    value=123\n                ),\n                per_request=appmesh.CfnVirtualNode.DurationProperty(\n                    unit="unit",\n                    value=123\n                )\n            ),\n            http=appmesh.CfnVirtualNode.HttpTimeoutProperty(\n                idle=appmesh.CfnVirtualNode.DurationProperty(\n                    unit="unit",\n                    value=123\n                ),\n                per_request=appmesh.CfnVirtualNode.DurationProperty(\n                    unit="unit",\n                    value=123\n                )\n            ),\n            http2=appmesh.CfnVirtualNode.HttpTimeoutProperty(\n                idle=appmesh.CfnVirtualNode.DurationProperty(\n                    unit="unit",\n                    value=123\n                ),\n                per_request=appmesh.CfnVirtualNode.DurationProperty(\n                    unit="unit",\n                    value=123\n                )\n            ),\n            tcp=appmesh.CfnVirtualNode.TcpTimeoutProperty(\n                idle=appmesh.CfnVirtualNode.DurationProperty(\n                    unit="unit",\n                    value=123\n                )\n            )\n        ),\n        tls=appmesh.CfnVirtualNode.ListenerTlsProperty(\n            certificate=appmesh.CfnVirtualNode.ListenerTlsCertificateProperty(\n                acm=appmesh.CfnVirtualNode.ListenerTlsAcmCertificateProperty(\n                    certificate_arn="certificateArn"\n                ),\n                file=appmesh.CfnVirtualNode.ListenerTlsFileCertificateProperty(\n                    certificate_chain="certificateChain",\n                    private_key="privateKey"\n                ),\n                sds=appmesh.CfnVirtualNode.ListenerTlsSdsCertificateProperty(\n                    secret_name="secretName"\n                )\n            ),\n            mode="mode",\n\n            # the properties below are optional\n            validation=appmesh.CfnVirtualNode.ListenerTlsValidationContextProperty(\n                trust=appmesh.CfnVirtualNode.ListenerTlsValidationContextTrustProperty(\n                    file=appmesh.CfnVirtualNode.TlsValidationContextFileTrustProperty(\n                        certificate_chain="certificateChain"\n                    ),\n                    sds=appmesh.CfnVirtualNode.TlsValidationContextSdsTrustProperty(\n                        secret_name="secretName"\n                    )\n                ),\n\n                # the properties below are optional\n                subject_alternative_names=appmesh.CfnVirtualNode.SubjectAlternativeNamesProperty(\n                    match=appmesh.CfnVirtualNode.SubjectAlternativeNameMatchersProperty(\n                        exact=["exact"]\n                    )\n                )\n            )\n        )\n    )\n')
...
class CfnVirtualNode_ListenerTimeoutPropertyDef(BaseStruct):
    grpc: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_GrpcTimeoutPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='An object that represents types of timeouts.\n')
    http: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_HttpTimeoutPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='An object that represents types of timeouts.\n')
    http2: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_HttpTimeoutPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='An object that represents types of timeouts.\n')
    tcp: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_TcpTimeoutPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='An object that represents types of timeouts.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-virtualnode-listenertimeout.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    listener_timeout_property = appmesh.CfnVirtualNode.ListenerTimeoutProperty(\n        grpc=appmesh.CfnVirtualNode.GrpcTimeoutProperty(\n            idle=appmesh.CfnVirtualNode.DurationProperty(\n                unit="unit",\n                value=123\n            ),\n            per_request=appmesh.CfnVirtualNode.DurationProperty(\n                unit="unit",\n                value=123\n            )\n        ),\n        http=appmesh.CfnVirtualNode.HttpTimeoutProperty(\n            idle=appmesh.CfnVirtualNode.DurationProperty(\n                unit="unit",\n                value=123\n            ),\n            per_request=appmesh.CfnVirtualNode.DurationProperty(\n                unit="unit",\n                value=123\n            )\n        ),\n        http2=appmesh.CfnVirtualNode.HttpTimeoutProperty(\n            idle=appmesh.CfnVirtualNode.DurationProperty(\n                unit="unit",\n                value=123\n            ),\n            per_request=appmesh.CfnVirtualNode.DurationProperty(\n                unit="unit",\n                value=123\n            )\n        ),\n        tcp=appmesh.CfnVirtualNode.TcpTimeoutProperty(\n            idle=appmesh.CfnVirtualNode.DurationProperty(\n                unit="unit",\n                value=123\n            )\n        )\n    )\n')
...
class CfnVirtualNode_ListenerTlsCertificatePropertyDef(BaseStruct):
    acm: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_ListenerTlsAcmCertificatePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A reference to an object that represents an AWS Certificate Manager certificate.\n')
    file: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_ListenerTlsFileCertificatePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A reference to an object that represents a local file certificate.\n')
    sds: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_ListenerTlsSdsCertificatePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A reference to an object that represents a listener\'s Secret Discovery Service certificate.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-virtualnode-listenertlscertificate.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    listener_tls_certificate_property = appmesh.CfnVirtualNode.ListenerTlsCertificateProperty(\n        acm=appmesh.CfnVirtualNode.ListenerTlsAcmCertificateProperty(\n            certificate_arn="certificateArn"\n        ),\n        file=appmesh.CfnVirtualNode.ListenerTlsFileCertificateProperty(\n            certificate_chain="certificateChain",\n            private_key="privateKey"\n        ),\n        sds=appmesh.CfnVirtualNode.ListenerTlsSdsCertificateProperty(\n            secret_name="secretName"\n        )\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['acm', 'file', 'sds']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnVirtualNode_ListenerTlsPropertyDef(BaseStruct):
    certificate: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_ListenerTlsCertificatePropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description="A reference to an object that represents a listener's Transport Layer Security (TLS) certificate.\n")
    mode: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Specify one of the following modes. - ** STRICT – Listener only accepts connections with TLS enabled. - ** PERMISSIVE – Listener accepts connections with or without TLS enabled. - ** DISABLED – Listener only accepts connections without TLS.\n')
    validation: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_ListenerTlsValidationContextPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A reference to an object that represents a listener\'s Transport Layer Security (TLS) validation context.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-virtualnode-listenertls.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    listener_tls_property = appmesh.CfnVirtualNode.ListenerTlsProperty(\n        certificate=appmesh.CfnVirtualNode.ListenerTlsCertificateProperty(\n            acm=appmesh.CfnVirtualNode.ListenerTlsAcmCertificateProperty(\n                certificate_arn="certificateArn"\n            ),\n            file=appmesh.CfnVirtualNode.ListenerTlsFileCertificateProperty(\n                certificate_chain="certificateChain",\n                private_key="privateKey"\n            ),\n            sds=appmesh.CfnVirtualNode.ListenerTlsSdsCertificateProperty(\n                secret_name="secretName"\n            )\n        ),\n        mode="mode",\n\n        # the properties below are optional\n        validation=appmesh.CfnVirtualNode.ListenerTlsValidationContextProperty(\n            trust=appmesh.CfnVirtualNode.ListenerTlsValidationContextTrustProperty(\n                file=appmesh.CfnVirtualNode.TlsValidationContextFileTrustProperty(\n                    certificate_chain="certificateChain"\n                ),\n                sds=appmesh.CfnVirtualNode.TlsValidationContextSdsTrustProperty(\n                    secret_name="secretName"\n                )\n            ),\n\n            # the properties below are optional\n            subject_alternative_names=appmesh.CfnVirtualNode.SubjectAlternativeNamesProperty(\n                match=appmesh.CfnVirtualNode.SubjectAlternativeNameMatchersProperty(\n                    exact=["exact"]\n                )\n            )\n        )\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['certificate', 'mode', 'validation']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnVirtualNode_ListenerTlsSdsCertificatePropertyDef(BaseStruct):
    secret_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A reference to an object that represents the name of the secret requested from the Secret Discovery Service provider representing Transport Layer Security (TLS) materials like a certificate or certificate chain.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-virtualnode-listenertlssdscertificate.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    listener_tls_sds_certificate_property = appmesh.CfnVirtualNode.ListenerTlsSdsCertificateProperty(\n        secret_name="secretName"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['secret_name']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnVirtualNode_ListenerTlsValidationContextPropertyDef(BaseStruct):
    trust: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_ListenerTlsValidationContextTrustPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='A reference to where to retrieve the trust chain when validating a peer’s Transport Layer Security (TLS) certificate.\n')
    subject_alternative_names: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_SubjectAlternativeNamesPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A reference to an object that represents the SANs for a listener\'s Transport Layer Security (TLS) validation context.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-virtualnode-listenertlsvalidationcontext.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    listener_tls_validation_context_property = appmesh.CfnVirtualNode.ListenerTlsValidationContextProperty(\n        trust=appmesh.CfnVirtualNode.ListenerTlsValidationContextTrustProperty(\n            file=appmesh.CfnVirtualNode.TlsValidationContextFileTrustProperty(\n                certificate_chain="certificateChain"\n            ),\n            sds=appmesh.CfnVirtualNode.TlsValidationContextSdsTrustProperty(\n                secret_name="secretName"\n            )\n        ),\n\n        # the properties below are optional\n        subject_alternative_names=appmesh.CfnVirtualNode.SubjectAlternativeNamesProperty(\n            match=appmesh.CfnVirtualNode.SubjectAlternativeNameMatchersProperty(\n                exact=["exact"]\n            )\n        )\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['trust', 'subject_alternative_names']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnVirtualNode_ListenerTlsValidationContextTrustPropertyDef(BaseStruct):
    file: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_TlsValidationContextFileTrustPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='An object that represents a Transport Layer Security (TLS) validation context trust for a local file.\n')
    sds: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_TlsValidationContextSdsTrustPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A reference to an object that represents a listener\'s Transport Layer Security (TLS) Secret Discovery Service validation context trust.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-virtualnode-listenertlsvalidationcontexttrust.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    listener_tls_validation_context_trust_property = appmesh.CfnVirtualNode.ListenerTlsValidationContextTrustProperty(\n        file=appmesh.CfnVirtualNode.TlsValidationContextFileTrustProperty(\n            certificate_chain="certificateChain"\n        ),\n        sds=appmesh.CfnVirtualNode.TlsValidationContextSdsTrustProperty(\n            secret_name="secretName"\n        )\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['file', 'sds']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnVirtualNode_LoggingFormatPropertyDef(BaseStruct):
    json_: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_JsonFormatRefPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The logging format for JSON.\n', alias='json')
...
class CfnVirtualNode_OutlierDetectionPropertyDef(BaseStruct):
    base_ejection_duration: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_DurationPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The base amount of time for which a host is ejected.\n')
    interval: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_DurationPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The time interval between ejection sweep analysis.\n')
    max_ejection_percent: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='Maximum percentage of hosts in load balancing pool for upstream service that can be ejected. Will eject at least one host regardless of the value.\n')
    max_server_errors: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='Number of consecutive ``5xx`` errors required for ejection.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-virtualnode-outlierdetection.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    outlier_detection_property = appmesh.CfnVirtualNode.OutlierDetectionProperty(\n        base_ejection_duration=appmesh.CfnVirtualNode.DurationProperty(\n            unit="unit",\n            value=123\n        ),\n        interval=appmesh.CfnVirtualNode.DurationProperty(\n            unit="unit",\n            value=123\n        ),\n        max_ejection_percent=123,\n        max_server_errors=123\n    )\n')
...
class CfnVirtualNode_PortMappingPropertyDef(BaseStruct):
    port: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The port used for the port mapping.\n')
    protocol: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The protocol used for the port mapping. Specify ``http`` , ``http2`` , ``grpc`` , or ``tcp`` .\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-virtualnode-portmapping.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    port_mapping_property = appmesh.CfnVirtualNode.PortMappingProperty(\n        port=123,\n        protocol="protocol"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['port', 'protocol']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnVirtualNode_ServiceDiscoveryPropertyDef(BaseStruct):
    aws_cloud_map: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_AwsCloudMapServiceDiscoveryPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Specifies any AWS Cloud Map information for the virtual node.\n')
    dns: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_DnsServiceDiscoveryPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Specifies the DNS information for the virtual node.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-virtualnode-servicediscovery.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    service_discovery_property = appmesh.CfnVirtualNode.ServiceDiscoveryProperty(\n        aws_cloud_map=appmesh.CfnVirtualNode.AwsCloudMapServiceDiscoveryProperty(\n            namespace_name="namespaceName",\n            service_name="serviceName",\n\n            # the properties below are optional\n            attributes=[appmesh.CfnVirtualNode.AwsCloudMapInstanceAttributeProperty(\n                key="key",\n                value="value"\n            )],\n            ip_preference="ipPreference"\n        ),\n        dns=appmesh.CfnVirtualNode.DnsServiceDiscoveryProperty(\n            hostname="hostname",\n\n            # the properties below are optional\n            ip_preference="ipPreference",\n            response_type="responseType"\n        )\n    )\n')
...
class CfnVirtualNode_SubjectAlternativeNamesPropertyDef(BaseStruct):
    match: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_SubjectAlternativeNameMatchersPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='An object that represents the criteria for determining a SANs match.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-virtualnode-subjectalternativenames.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    subject_alternative_names_property = appmesh.CfnVirtualNode.SubjectAlternativeNamesProperty(\n        match=appmesh.CfnVirtualNode.SubjectAlternativeNameMatchersProperty(\n            exact=["exact"]\n        )\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['match']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnVirtualNode_TlsValidationContextPropertyDef(BaseStruct):
    trust: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_TlsValidationContextTrustPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='A reference to where to retrieve the trust chain when validating a peer’s Transport Layer Security (TLS) certificate.\n')
    subject_alternative_names: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_SubjectAlternativeNamesPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A reference to an object that represents the SANs for a Transport Layer Security (TLS) validation context. If you don\'t specify SANs on the *terminating* mesh endpoint, the Envoy proxy for that node doesn\'t verify the SAN on a peer client certificate. If you don\'t specify SANs on the *originating* mesh endpoint, the SAN on the certificate provided by the terminating endpoint must match the mesh endpoint service discovery configuration. Since SPIRE vended certificates have a SPIFFE ID as a name, you must set the SAN since the name doesn\'t match the service discovery name.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-virtualnode-tlsvalidationcontext.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    tls_validation_context_property = appmesh.CfnVirtualNode.TlsValidationContextProperty(\n        trust=appmesh.CfnVirtualNode.TlsValidationContextTrustProperty(\n            acm=appmesh.CfnVirtualNode.TlsValidationContextAcmTrustProperty(\n                certificate_authority_arns=["certificateAuthorityArns"]\n            ),\n            file=appmesh.CfnVirtualNode.TlsValidationContextFileTrustProperty(\n                certificate_chain="certificateChain"\n            ),\n            sds=appmesh.CfnVirtualNode.TlsValidationContextSdsTrustProperty(\n                secret_name="secretName"\n            )\n        ),\n\n        # the properties below are optional\n        subject_alternative_names=appmesh.CfnVirtualNode.SubjectAlternativeNamesProperty(\n            match=appmesh.CfnVirtualNode.SubjectAlternativeNameMatchersProperty(\n                exact=["exact"]\n            )\n        )\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['trust', 'subject_alternative_names']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnVirtualNode_TlsValidationContextSdsTrustPropertyDef(BaseStruct):
    secret_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A reference to an object that represents the name of the secret for a Transport Layer Security (TLS) Secret Discovery Service validation context trust.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-virtualnode-tlsvalidationcontextsdstrust.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    tls_validation_context_sds_trust_property = appmesh.CfnVirtualNode.TlsValidationContextSdsTrustProperty(\n        secret_name="secretName"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['secret_name']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnVirtualNode_VirtualNodeConnectionPoolPropertyDef(BaseStruct):
    grpc: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_VirtualNodeGrpcConnectionPoolPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='An object that represents a type of connection pool.\n')
    http: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_VirtualNodeHttpConnectionPoolPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='An object that represents a type of connection pool.\n')
    http2: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_VirtualNodeHttp2ConnectionPoolPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='An object that represents a type of connection pool.\n')
    tcp: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_VirtualNodeTcpConnectionPoolPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='An object that represents a type of connection pool.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-virtualnode-virtualnodeconnectionpool.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    virtual_node_connection_pool_property = appmesh.CfnVirtualNode.VirtualNodeConnectionPoolProperty(\n        grpc=appmesh.CfnVirtualNode.VirtualNodeGrpcConnectionPoolProperty(\n            max_requests=123\n        ),\n        http=appmesh.CfnVirtualNode.VirtualNodeHttpConnectionPoolProperty(\n            max_connections=123,\n\n            # the properties below are optional\n            max_pending_requests=123\n        ),\n        http2=appmesh.CfnVirtualNode.VirtualNodeHttp2ConnectionPoolProperty(\n            max_requests=123\n        ),\n        tcp=appmesh.CfnVirtualNode.VirtualNodeTcpConnectionPoolProperty(\n            max_connections=123\n        )\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['grpc', 'http', 'http2', 'tcp']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnVirtualNode_VirtualServiceBackendPropertyDef(BaseStruct):
    virtual_service_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description="The name of the virtual service that is acting as a virtual node backend. .. epigraph:: App Mesh doesn't validate the existence of those virtual services specified in backends. This is to prevent a cyclic dependency between virtual nodes and virtual services creation. Make sure the virtual service name is correct. The virtual service can be created afterwards if it doesn't already exist.\n")
    client_policy: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_ClientPolicyPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A reference to an object that represents the client policy for a backend.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-virtualnode-virtualservicebackend.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    virtual_service_backend_property = appmesh.CfnVirtualNode.VirtualServiceBackendProperty(\n        virtual_service_name="virtualServiceName",\n\n        # the properties below are optional\n        client_policy=appmesh.CfnVirtualNode.ClientPolicyProperty(\n            tls=appmesh.CfnVirtualNode.ClientPolicyTlsProperty(\n                validation=appmesh.CfnVirtualNode.TlsValidationContextProperty(\n                    trust=appmesh.CfnVirtualNode.TlsValidationContextTrustProperty(\n                        acm=appmesh.CfnVirtualNode.TlsValidationContextAcmTrustProperty(\n                            certificate_authority_arns=["certificateAuthorityArns"]\n                        ),\n                        file=appmesh.CfnVirtualNode.TlsValidationContextFileTrustProperty(\n                            certificate_chain="certificateChain"\n                        ),\n                        sds=appmesh.CfnVirtualNode.TlsValidationContextSdsTrustProperty(\n                            secret_name="secretName"\n                        )\n                    ),\n\n                    # the properties below are optional\n                    subject_alternative_names=appmesh.CfnVirtualNode.SubjectAlternativeNamesProperty(\n                        match=appmesh.CfnVirtualNode.SubjectAlternativeNameMatchersProperty(\n                            exact=["exact"]\n                        )\n                    )\n                ),\n\n                # the properties below are optional\n                certificate=appmesh.CfnVirtualNode.ClientTlsCertificateProperty(\n                    file=appmesh.CfnVirtualNode.ListenerTlsFileCertificateProperty(\n                        certificate_chain="certificateChain",\n                        private_key="privateKey"\n                    ),\n                    sds=appmesh.CfnVirtualNode.ListenerTlsSdsCertificateProperty(\n                        secret_name="secretName"\n                    )\n                ),\n                enforce=False,\n                ports=[123]\n            )\n        )\n    )\n')
...
class CfnVirtualService_VirtualServiceProviderPropertyDef(BaseStruct):
    virtual_node: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualService_VirtualNodeServiceProviderPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The virtual node associated with a virtual service.\n')
    virtual_router: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualService_VirtualRouterServiceProviderPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The virtual router associated with a virtual service.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-virtualservice-virtualserviceprovider.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    virtual_service_provider_property = appmesh.CfnVirtualService.VirtualServiceProviderProperty(\n        virtual_node=appmesh.CfnVirtualService.VirtualNodeServiceProviderProperty(\n            virtual_node_name="virtualNodeName"\n        ),\n        virtual_router=appmesh.CfnVirtualService.VirtualRouterServiceProviderProperty(\n            virtual_router_name="virtualRouterName"\n        )\n    )\n')
...
class GatewayRouteAttributesDef(BaseStruct):
    gateway_route_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the GatewayRoute.\n')
...
class GatewayRouteHostnameMatchConfigDef(BaseStruct):
    hostname_match: typing.Union[_REQUIRED_INIT_PARAM, models.aws_appmesh.CfnGatewayRoute_GatewayRouteHostnameMatchPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='GatewayRoute CFN configuration for host name match.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    gateway_route_hostname_match_config = appmesh.GatewayRouteHostnameMatchConfig(\n        hostname_match=appmesh.CfnGatewayRoute.GatewayRouteHostnameMatchProperty(\n            exact="exact",\n            suffix="suffix"\n        )\n    )\n')
...
class GrpcGatewayRouteMatchDef(BaseStruct):
    ...
    port: typing.Union[int, float, None] = pydantic.Field(None, description='The port to match from the request. Default: - do not match on port\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['hostname', 'metadata', 'port', 'rewrite_request_hostname', 'service_name']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class GrpcGatewayRouteSpecOptionsDef(BaseStruct):
    priority: typing.Union[int, float, None] = pydantic.Field(None, description='The priority for the gateway route. When a Virtual Gateway has multiple gateway routes, gateway route match is performed in the order of specified value, where 0 is the highest priority, and first matched gateway route is selected. Default: - no particular priority\n')
    match: typing.Union[_REQUIRED_INIT_PARAM, models.aws_appmesh.GrpcGatewayRouteMatchDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The criterion for determining a request match for this GatewayRoute.\n')
    route_target: typing.Union[_REQUIRED_INIT_PARAM, models.aws_appmesh.VirtualServiceDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The VirtualService this GatewayRoute directs traffic to.\n\n:exampleMetadata: infused\n\nExample::\n\n    # gateway: appmesh.VirtualGateway\n    # virtual_service: appmesh.VirtualService\n\n\n    gateway.add_gateway_route("gateway-route-grpc",\n        route_spec=appmesh.GatewayRouteSpec.grpc(\n            route_target=virtual_service,\n            match=appmesh.GrpcGatewayRouteMatch(\n                hostname=appmesh.GatewayRouteHostnameMatch.ends_with(".example.com")\n            )\n        )\n    )\n')
...
class GrpcRetryPolicyDef(BaseStruct):
    retry_attempts: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The maximum number of retry attempts.\n')
    retry_timeout: typing.Union[models.DurationDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The timeout for each retry attempt.\n')
...
class GrpcRouteSpecOptionsDef(BaseStruct):
    priority: typing.Union[int, float, None] = pydantic.Field(None, description='The priority for the route. When a Virtual Router has multiple routes, route match is performed in the order of specified value, where 0 is the highest priority, and first matched route is selected. Default: - no particular priority\n')
    match: typing.Union[_REQUIRED_INIT_PARAM, models.aws_appmesh.GrpcRouteMatchDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The criterion for determining a request match for this Route.\n')
    weighted_targets: typing.Union[typing.Sequence[typing.Union[models.aws_appmesh.WeightedTargetDef, dict[str, typing.Any]]], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='List of targets that traffic is routed to when a request matches the route.\n')
    retry_policy: typing.Union[models.aws_appmesh.GrpcRetryPolicyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The retry policy. Default: - no retry policy\n')
    timeout: typing.Union[models.aws_appmesh.GrpcTimeoutDef, dict[str, typing.Any], None] = pydantic.Field(None, description='An object that represents a grpc timeout. Default: - None\n\n:exampleMetadata: infused\n\nExample::\n\n    # router: appmesh.VirtualRouter\n    # node: appmesh.VirtualNode\n\n\n    router.add_route("route-grpc-retry",\n        route_spec=appmesh.RouteSpec.grpc(\n            weighted_targets=[appmesh.WeightedTarget(virtual_node=node)],\n            match=appmesh.GrpcRouteMatch(\n                # When method name is specified, service name must be also specified.\n                method_name="methodname",\n                service_name="servicename",\n                metadata=[\n                    # All specified metadata must match for the route to match.\n                    appmesh.HeaderMatch.value_starts_with("Content-Type", "application/"),\n                    appmesh.HeaderMatch.value_does_not_start_with("Content-Type", "text/")\n                ]\n            )\n        )\n    )\n')
...
class HeaderMatchConfigDef(BaseStruct):
    header_match: typing.Union[_REQUIRED_INIT_PARAM, models.aws_appmesh.CfnRoute_HttpRouteHeaderPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='Route CFN configuration for the route header match.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    header_match_config = appmesh.HeaderMatchConfig(\n        header_match=appmesh.CfnRoute.HttpRouteHeaderProperty(\n            name="name",\n\n            # the properties below are optional\n            invert=False,\n            match=appmesh.CfnRoute.HeaderMatchMethodProperty(\n                exact="exact",\n                prefix="prefix",\n                range=appmesh.CfnRoute.MatchRangeProperty(\n                    end=123,\n                    start=123\n                ),\n                regex="regex",\n                suffix="suffix"\n            )\n        )\n    )\n')
...
class HttpConnectionPoolDef(BaseStruct):
    max_connections: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The maximum connections in the pool. Default: - none\n')
    max_pending_requests: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The maximum pending requests in the pool. Default: - none\n\n:exampleMetadata: infused\n\nExample::\n\n    # A Virtual Node with a gRPC listener with a connection pool set\n    # mesh: appmesh.Mesh\n\n    node = appmesh.VirtualNode(self, "node",\n        mesh=mesh,\n        # DNS service discovery can optionally specify the DNS response type as either LOAD_BALANCER or ENDPOINTS.\n        # LOAD_BALANCER means that the DNS resolver returns a loadbalanced set of endpoints,\n        # whereas ENDPOINTS means that the DNS resolver is returning all the endpoints.\n        # By default, the response type is assumed to be LOAD_BALANCER\n        service_discovery=appmesh.ServiceDiscovery.dns("node", appmesh.DnsResponseType.ENDPOINTS),\n        listeners=[appmesh.VirtualNodeListener.http(\n            port=80,\n            connection_pool=appmesh.HttpConnectionPool(\n                max_connections=100,\n                max_pending_requests=10\n            )\n        )]\n    )\n\n    # A Virtual Gateway with a gRPC listener with a connection pool set\n    gateway = appmesh.VirtualGateway(self, "gateway",\n        mesh=mesh,\n        listeners=[appmesh.VirtualGatewayListener.grpc(\n            port=8080,\n            connection_pool=appmesh.GrpcConnectionPool(\n                max_requests=10\n            )\n        )],\n        virtual_gateway_name="gateway"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['max_connections', 'max_pending_requests']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class HttpRouteMatchDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['headers', 'method', 'path', 'port', 'protocol', 'query_parameters']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class ListenerTlsOptionsDef(BaseStruct):
    certificate: typing.Union[models.aws_appmesh.TlsCertificateDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Represents TLS certificate.\n')
    mode: typing.Union[aws_cdk.aws_appmesh.TlsMode, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The TLS mode.\n')
...
class MutualTlsValidationDef(BaseStruct):
    trust: typing.Union[models.aws_appmesh.MutualTlsValidationTrustDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Reference to where to retrieve the trust chain.\n')
...
class OutlierDetectionDef(BaseStruct):
    base_ejection_duration: typing.Union[models.DurationDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The base amount of time for which a host is ejected.\n')
    interval: typing.Union[models.DurationDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The time interval between ejection sweep analysis.\n')
    max_ejection_percent: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='Maximum percentage of hosts in load balancing pool for upstream service that can be ejected. Will eject at least one host regardless of the value.\n')
...
class QueryParameterMatchConfigDef(BaseStruct):
    query_parameter_match: typing.Union[_REQUIRED_INIT_PARAM, models.aws_appmesh.CfnRoute_QueryParameterPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='Route CFN configuration for route query parameter match.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    query_parameter_match_config = appmesh.QueryParameterMatchConfig(\n        query_parameter_match=appmesh.CfnRoute.QueryParameterProperty(\n            name="name",\n\n            # the properties below are optional\n            match=appmesh.CfnRoute.HttpQueryParameterMatchProperty(\n                exact="exact"\n            )\n        )\n    )\n')
...
class RouteAttributesDef(BaseStruct):
    route_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the Route.\n')
...
class SubjectAlternativeNamesMatcherConfigDef(BaseStruct):
    subject_alternative_names_match: typing.Union[_REQUIRED_INIT_PARAM, models.aws_appmesh.CfnVirtualNode_SubjectAlternativeNameMatchersPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='VirtualNode CFN configuration for subject alternative names secured by the certificate.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    subject_alternative_names_matcher_config = appmesh.SubjectAlternativeNamesMatcherConfig(\n        subject_alternative_names_match=appmesh.CfnVirtualNode.SubjectAlternativeNameMatchersProperty(\n            exact=["exact"]\n        )\n    )\n')
...
class TlsCertificateConfigDef(BaseStruct):
    tls_certificate: typing.Union[_REQUIRED_INIT_PARAM, models.aws_appmesh.CfnVirtualNode_ListenerTlsCertificatePropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The CFN shape for a TLS certificate.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    tls_certificate_config = appmesh.TlsCertificateConfig(\n        tls_certificate=appmesh.CfnVirtualNode.ListenerTlsCertificateProperty(\n            acm=appmesh.CfnVirtualNode.ListenerTlsAcmCertificateProperty(\n                certificate_arn="certificateArn"\n            ),\n            file=appmesh.CfnVirtualNode.ListenerTlsFileCertificateProperty(\n                certificate_chain="certificateChain",\n                private_key="privateKey"\n            ),\n            sds=appmesh.CfnVirtualNode.ListenerTlsSdsCertificateProperty(\n                secret_name="secretName"\n            )\n        )\n    )\n')
...
class TlsClientPolicyDef(BaseStruct):
    validation: typing.Union[_REQUIRED_INIT_PARAM, models.aws_appmesh.TlsValidationDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='Represents the object for TLS validation context.\n')
...
class TlsValidationDef(BaseStruct):
    trust: typing.Union[models.aws_appmesh.TlsValidationTrustDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Reference to where to retrieve the trust chain.\n')
    subject_alternative_names: typing.Optional[models.aws_appmesh.SubjectAlternativeNamesDef] = pydantic.Field(None, description='Represents the subject alternative names (SANs) secured by the certificate. SANs must be in the FQDN or URI format. Default: - If you don\'t specify SANs on the terminating mesh endpoint, the Envoy proxy for that node doesn\'t verify the SAN on a peer client certificate. If you don\'t specify SANs on the originating mesh endpoint, the SAN on the certificate provided by the terminating endpoint must match the mesh endpoint service discovery configuration.\n\n:exampleMetadata: infused\n\nExample::\n\n    # mesh: appmesh.Mesh\n    # service: cloudmap.Service\n\n\n    node = appmesh.VirtualNode(self, "node",\n        mesh=mesh,\n        service_discovery=appmesh.ServiceDiscovery.cloud_map(service),\n        listeners=[appmesh.VirtualNodeListener.http(\n            port=8080,\n            health_check=appmesh.HealthCheck.http(\n                healthy_threshold=3,\n                interval=Duration.seconds(5),\n                path="/ping",\n                timeout=Duration.seconds(2),\n                unhealthy_threshold=2\n            ),\n            timeout=appmesh.HttpTimeout(\n                idle=Duration.seconds(5)\n            )\n        )],\n        backend_defaults=appmesh.BackendDefaults(\n            tls_client_policy=appmesh.TlsClientPolicy(\n                validation=appmesh.TlsValidation(\n                    trust=appmesh.TlsValidationTrust.file("/keys/local_cert_chain.pem")\n                )\n            )\n        ),\n        access_log=appmesh.AccessLog.from_file_path("/dev/stdout")\n    )\n\n    cdk.Tags.of(node).add("Environment", "Dev")\n')
    _init_params: typing.ClassVar[list[str]] = ['trust', 'subject_alternative_names']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class TlsValidationTrustConfigDef(BaseStruct):
    tls_validation_trust: typing.Union[_REQUIRED_INIT_PARAM, models.aws_appmesh.CfnVirtualNode_TlsValidationContextTrustPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='VirtualNode CFN configuration for client policy\'s TLS Validation Trust.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    tls_validation_trust_config = appmesh.TlsValidationTrustConfig(\n        tls_validation_trust=appmesh.CfnVirtualNode.TlsValidationContextTrustProperty(\n            acm=appmesh.CfnVirtualNode.TlsValidationContextAcmTrustProperty(\n                certificate_authority_arns=["certificateAuthorityArns"]\n            ),\n            file=appmesh.CfnVirtualNode.TlsValidationContextFileTrustProperty(\n                certificate_chain="certificateChain"\n            ),\n            sds=appmesh.CfnVirtualNode.TlsValidationContextSdsTrustProperty(\n                secret_name="secretName"\n            )\n        )\n    )\n')
...
class VirtualGatewayAttributesDef(BaseStruct):
    mesh: typing.Union[_REQUIRED_INIT_PARAM, models.aws_appmesh.MeshDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Mesh that the VirtualGateway belongs to.\n')
    virtual_gateway_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the VirtualGateway.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    # mesh: appmesh.Mesh\n\n    virtual_gateway_attributes = appmesh.VirtualGatewayAttributes(\n        mesh=mesh,\n        virtual_gateway_name="virtualGatewayName"\n    )\n')
...
class VirtualGatewayListenerConfigDef(BaseStruct):
    listener: typing.Union[_REQUIRED_INIT_PARAM, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayListenerPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='Single listener config for a VirtualGateway.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    virtual_gateway_listener_config = appmesh.VirtualGatewayListenerConfig(\n        listener=appmesh.CfnVirtualGateway.VirtualGatewayListenerProperty(\n            port_mapping=appmesh.CfnVirtualGateway.VirtualGatewayPortMappingProperty(\n                port=123,\n                protocol="protocol"\n            ),\n\n            # the properties below are optional\n            connection_pool=appmesh.CfnVirtualGateway.VirtualGatewayConnectionPoolProperty(\n                grpc=appmesh.CfnVirtualGateway.VirtualGatewayGrpcConnectionPoolProperty(\n                    max_requests=123\n                ),\n                http=appmesh.CfnVirtualGateway.VirtualGatewayHttpConnectionPoolProperty(\n                    max_connections=123,\n\n                    # the properties below are optional\n                    max_pending_requests=123\n                ),\n                http2=appmesh.CfnVirtualGateway.VirtualGatewayHttp2ConnectionPoolProperty(\n                    max_requests=123\n                )\n            ),\n            health_check=appmesh.CfnVirtualGateway.VirtualGatewayHealthCheckPolicyProperty(\n                healthy_threshold=123,\n                interval_millis=123,\n                protocol="protocol",\n                timeout_millis=123,\n                unhealthy_threshold=123,\n\n                # the properties below are optional\n                path="path",\n                port=123\n            ),\n            tls=appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsProperty(\n                certificate=appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsCertificateProperty(\n                    acm=appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsAcmCertificateProperty(\n                        certificate_arn="certificateArn"\n                    ),\n                    file=appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsFileCertificateProperty(\n                        certificate_chain="certificateChain",\n                        private_key="privateKey"\n                    ),\n                    sds=appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsSdsCertificateProperty(\n                        secret_name="secretName"\n                    )\n                ),\n                mode="mode",\n\n                # the properties below are optional\n                validation=appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsValidationContextProperty(\n                    trust=appmesh.CfnVirtualGateway.VirtualGatewayListenerTlsValidationContextTrustProperty(\n                        file=appmesh.CfnVirtualGateway.VirtualGatewayTlsValidationContextFileTrustProperty(\n                            certificate_chain="certificateChain"\n                        ),\n                        sds=appmesh.CfnVirtualGateway.VirtualGatewayTlsValidationContextSdsTrustProperty(\n                            secret_name="secretName"\n                        )\n                    ),\n\n                    # the properties below are optional\n                    subject_alternative_names=appmesh.CfnVirtualGateway.SubjectAlternativeNamesProperty(\n                        match=appmesh.CfnVirtualGateway.SubjectAlternativeNameMatchersProperty(\n                            exact=["exact"]\n                        )\n                    )\n                )\n            )\n        )\n    )\n')
...
class VirtualNodeAttributesDef(BaseStruct):
    mesh: typing.Union[_REQUIRED_INIT_PARAM, models.aws_appmesh.MeshDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Mesh that the VirtualNode belongs to.\n')
    virtual_node_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the VirtualNode.\n\n:exampleMetadata: infused\n\nExample::\n\n    virtual_node_name = "my-virtual-node"\n    appmesh.VirtualNode.from_virtual_node_attributes(self, "imported-virtual-node",\n        mesh=appmesh.Mesh.from_mesh_name(self, "Mesh", "testMesh"),\n        virtual_node_name=virtual_node_name\n    )\n')
...
class VirtualNodeListenerConfigDef(BaseStruct):
    listener: typing.Union[_REQUIRED_INIT_PARAM, models.aws_appmesh.CfnVirtualNode_ListenerPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='Single listener config for a VirtualNode.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    virtual_node_listener_config = appmesh.VirtualNodeListenerConfig(\n        listener=appmesh.CfnVirtualNode.ListenerProperty(\n            port_mapping=appmesh.CfnVirtualNode.PortMappingProperty(\n                port=123,\n                protocol="protocol"\n            ),\n\n            # the properties below are optional\n            connection_pool=appmesh.CfnVirtualNode.VirtualNodeConnectionPoolProperty(\n                grpc=appmesh.CfnVirtualNode.VirtualNodeGrpcConnectionPoolProperty(\n                    max_requests=123\n                ),\n                http=appmesh.CfnVirtualNode.VirtualNodeHttpConnectionPoolProperty(\n                    max_connections=123,\n\n                    # the properties below are optional\n                    max_pending_requests=123\n                ),\n                http2=appmesh.CfnVirtualNode.VirtualNodeHttp2ConnectionPoolProperty(\n                    max_requests=123\n                ),\n                tcp=appmesh.CfnVirtualNode.VirtualNodeTcpConnectionPoolProperty(\n                    max_connections=123\n                )\n            ),\n            health_check=appmesh.CfnVirtualNode.HealthCheckProperty(\n                healthy_threshold=123,\n                interval_millis=123,\n                protocol="protocol",\n                timeout_millis=123,\n                unhealthy_threshold=123,\n\n                # the properties below are optional\n                path="path",\n                port=123\n            ),\n            outlier_detection=appmesh.CfnVirtualNode.OutlierDetectionProperty(\n                base_ejection_duration=appmesh.CfnVirtualNode.DurationProperty(\n                    unit="unit",\n                    value=123\n                ),\n                interval=appmesh.CfnVirtualNode.DurationProperty(\n                    unit="unit",\n                    value=123\n                ),\n                max_ejection_percent=123,\n                max_server_errors=123\n            ),\n            timeout=appmesh.CfnVirtualNode.ListenerTimeoutProperty(\n                grpc=appmesh.CfnVirtualNode.GrpcTimeoutProperty(\n                    idle=appmesh.CfnVirtualNode.DurationProperty(\n                        unit="unit",\n                        value=123\n                    ),\n                    per_request=appmesh.CfnVirtualNode.DurationProperty(\n                        unit="unit",\n                        value=123\n                    )\n                ),\n                http=appmesh.CfnVirtualNode.HttpTimeoutProperty(\n                    idle=appmesh.CfnVirtualNode.DurationProperty(\n                        unit="unit",\n                        value=123\n                    ),\n                    per_request=appmesh.CfnVirtualNode.DurationProperty(\n                        unit="unit",\n                        value=123\n                    )\n                ),\n                http2=appmesh.CfnVirtualNode.HttpTimeoutProperty(\n                    idle=appmesh.CfnVirtualNode.DurationProperty(\n                        unit="unit",\n                        value=123\n                    ),\n                    per_request=appmesh.CfnVirtualNode.DurationProperty(\n                        unit="unit",\n                        value=123\n                    )\n                ),\n                tcp=appmesh.CfnVirtualNode.TcpTimeoutProperty(\n                    idle=appmesh.CfnVirtualNode.DurationProperty(\n                        unit="unit",\n                        value=123\n                    )\n                )\n            ),\n            tls=appmesh.CfnVirtualNode.ListenerTlsProperty(\n                certificate=appmesh.CfnVirtualNode.ListenerTlsCertificateProperty(\n                    acm=appmesh.CfnVirtualNode.ListenerTlsAcmCertificateProperty(\n                        certificate_arn="certificateArn"\n                    ),\n                    file=appmesh.CfnVirtualNode.ListenerTlsFileCertificateProperty(\n                        certificate_chain="certificateChain",\n                        private_key="privateKey"\n                    ),\n                    sds=appmesh.CfnVirtualNode.ListenerTlsSdsCertificateProperty(\n                        secret_name="secretName"\n                    )\n                ),\n                mode="mode",\n\n                # the properties below are optional\n                validation=appmesh.CfnVirtualNode.ListenerTlsValidationContextProperty(\n                    trust=appmesh.CfnVirtualNode.ListenerTlsValidationContextTrustProperty(\n                        file=appmesh.CfnVirtualNode.TlsValidationContextFileTrustProperty(\n                            certificate_chain="certificateChain"\n                        ),\n                        sds=appmesh.CfnVirtualNode.TlsValidationContextSdsTrustProperty(\n                            secret_name="secretName"\n                        )\n                    ),\n\n                    # the properties below are optional\n                    subject_alternative_names=appmesh.CfnVirtualNode.SubjectAlternativeNamesProperty(\n                        match=appmesh.CfnVirtualNode.SubjectAlternativeNameMatchersProperty(\n                            exact=["exact"]\n                        )\n                    )\n                )\n            )\n        )\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['listener']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class VirtualRouterAttributesDef(BaseStruct):
    mesh: typing.Union[_REQUIRED_INIT_PARAM, models.aws_appmesh.MeshDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Mesh which the VirtualRouter belongs to.\n')
    virtual_router_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the VirtualRouter.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    # mesh: appmesh.Mesh\n\n    virtual_router_attributes = appmesh.VirtualRouterAttributes(\n        mesh=mesh,\n        virtual_router_name="virtualRouterName"\n    )\n')
...
class VirtualRouterListenerConfigDef(BaseStruct):
    listener: typing.Union[_REQUIRED_INIT_PARAM, models.aws_appmesh.CfnVirtualRouter_VirtualRouterListenerPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='Single listener config for a VirtualRouter.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    virtual_router_listener_config = appmesh.VirtualRouterListenerConfig(\n        listener=appmesh.CfnVirtualRouter.VirtualRouterListenerProperty(\n            port_mapping=appmesh.CfnVirtualRouter.PortMappingProperty(\n                port=123,\n                protocol="protocol"\n            )\n        )\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['listener']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class VirtualServiceAttributesDef(BaseStruct):
    mesh: typing.Union[_REQUIRED_INIT_PARAM, models.aws_appmesh.MeshDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Mesh which the VirtualService belongs to.\n')
    virtual_service_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the VirtualService, it is recommended this follows the fully-qualified domain name format.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appmesh as appmesh\n\n    # mesh: appmesh.Mesh\n\n    virtual_service_attributes = appmesh.VirtualServiceAttributes(\n        mesh=mesh,\n        virtual_service_name="virtualServiceName"\n    )\n')
...
class VirtualServiceProviderConfigDef(BaseStruct):
    mesh: typing.Union[_REQUIRED_INIT_PARAM, models.aws_appmesh.MeshDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='Mesh the Provider is using. Default: - none\n')
...
class WeightedTargetDef(BaseStruct):
    virtual_node: typing.Union[_REQUIRED_INIT_PARAM, models.aws_appmesh.VirtualNodeDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The VirtualNode the route points to.\n')
    port: typing.Union[int, float, None] = pydantic.Field(None, description='The port to match from the request. Default: - do not match on port\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['virtual_node', 'port', 'weight']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnGatewayRouteDef(BaseCfnResource):
    mesh_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the service mesh that the resource resides in.\n')
    spec: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_GatewayRouteSpecPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The specifications of the gateway route.\n')
    virtual_gateway_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The virtual gateway that the gateway route is associated with.\n')
...
class CfnGatewayRouteDefGatewayroutemetadatamatchpropertyParams(pydantic.BaseModel):
    ...
    range: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_GatewayRouteRangeMatchPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
...
class CfnGatewayRouteDefGatewayroutespecpropertyParams(pydantic.BaseModel):
    grpc_route: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_GrpcGatewayRoutePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    http2_route: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_HttpGatewayRoutePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    http_route: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_HttpGatewayRoutePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
...
class CfnGatewayRouteDefGatewayroutetargetpropertyParams(pydantic.BaseModel):
    virtual_service: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_GatewayRouteVirtualServicePropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
...
class CfnGatewayRouteDefGrpcgatewayrouteactionpropertyParams(pydantic.BaseModel):
    target: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_GatewayRouteTargetPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    rewrite: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_GrpcGatewayRouteRewritePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...

class CfnGatewayRouteDefGrpcgatewayroutematchpropertyParams(pydantic.BaseModel):
    hostname: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_GatewayRouteHostnameMatchPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    metadata: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_GrpcGatewayRouteMetadataPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    port: typing.Union[int, float, None] = pydantic.Field(None, description='')
...
class CfnGatewayRouteDefGrpcgatewayroutemetadatapropertyParams(pydantic.BaseModel):
    ...
    invert: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
    match: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_GatewayRouteMetadataMatchPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...

class CfnGatewayRouteDefGrpcgatewayroutepropertyParams(pydantic.BaseModel):
    action: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_GrpcGatewayRouteActionPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    match: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_GrpcGatewayRouteMatchPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    ...

class CfnGatewayRouteDefGrpcgatewayrouterewritepropertyParams(pydantic.BaseModel):
    hostname: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_GatewayRouteHostnameRewritePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...

class CfnGatewayRouteDefHttpgatewayrouteactionpropertyParams(pydantic.BaseModel):
    target: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_GatewayRouteTargetPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    rewrite: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_HttpGatewayRouteRewritePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnGatewayRouteDefHttpgatewayrouteheaderpropertyParams(pydantic.BaseModel):
    name: str = pydantic.Field(..., description='')
    invert: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
    match: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_HttpGatewayRouteHeaderMatchPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...

class CfnGatewayRouteDefHttpgatewayroutematchpropertyParams(pydantic.BaseModel):
    headers: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_HttpGatewayRouteHeaderPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    hostname: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_GatewayRouteHostnameMatchPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    method: typing.Optional[str] = pydantic.Field(None, description='')
    path: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_HttpPathMatchPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    port: typing.Union[int, float, None] = pydantic.Field(None, description='')
    prefix: typing.Optional[str] = pydantic.Field(None, description='')
    query_parameters: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_QueryParameterPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    ...
...
class CfnGatewayRouteDefHttpgatewayroutepropertyParams(pydantic.BaseModel):
    action: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_HttpGatewayRouteActionPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    match: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_HttpGatewayRouteMatchPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    ...

class CfnGatewayRouteDefHttpgatewayrouterewritepropertyParams(pydantic.BaseModel):
    hostname: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_GatewayRouteHostnameRewritePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    path: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_HttpGatewayRoutePathRewritePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    prefix: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_HttpGatewayRoutePrefixRewritePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnGatewayRouteDefQueryparameterpropertyParams(pydantic.BaseModel):
    name: str = pydantic.Field(..., description='')
    match: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnGatewayRoute_HttpQueryParameterMatchPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnMeshDef(BaseCfnResource):
    ...
    spec: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnMesh_MeshSpecPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The service mesh specification to apply.\n')
...
class CfnMeshDefMeshspecpropertyParams(pydantic.BaseModel):
    egress_filter: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnMesh_EgressFilterPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    service_discovery: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnMesh_MeshServiceDiscoveryPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnRouteDef(BaseCfnResource):
    mesh_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the service mesh to create the route in.\n')
    spec: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_appmesh.CfnRoute_RouteSpecPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The route specification to apply.\n')
    virtual_router_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the virtual router in which to create the route. If the virtual router is in a shared mesh, then you must be the owner of the virtual router resource.\n')
...
class CfnRouteDefGrpcretrypolicypropertyParams(pydantic.BaseModel):
    ...
    per_retry_timeout: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_DurationPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
...
class CfnRouteDefGrpcrouteactionpropertyParams(pydantic.BaseModel):
    weighted_targets: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_WeightedTargetPropertyDef, dict[str, typing.Any]]]] = pydantic.Field(..., description='')
    ...

class CfnRouteDefGrpcroutematchpropertyParams(pydantic.BaseModel):
    metadata: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_GrpcRouteMetadataPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
...
class CfnRouteDefGrpcroutemetadatamatchmethodpropertyParams(pydantic.BaseModel):
    exact: typing.Optional[str] = pydantic.Field(None, description='')
    prefix: typing.Optional[str] = pydantic.Field(None, description='')
    range: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_MatchRangePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    regex: typing.Optional[str] = pydantic.Field(None, description='')
    suffix: typing.Optional[str] = pydantic.Field(None, description='')
    ...
...
class CfnRouteDefGrpcroutemetadatapropertyParams(pydantic.BaseModel):
    name: str = pydantic.Field(..., description='')
    invert: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
    match: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_GrpcRouteMetadataMatchMethodPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...

class CfnRouteDefGrpcroutepropertyParams(pydantic.BaseModel):
    action: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_GrpcRouteActionPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    match: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_GrpcRouteMatchPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    retry_policy: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_GrpcRetryPolicyPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    timeout: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_GrpcTimeoutPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...

class CfnRouteDefGrpctimeoutpropertyParams(pydantic.BaseModel):
    idle: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_DurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    per_request: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_DurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnRouteDefHttprouteheaderpropertyParams(pydantic.BaseModel):
    name: str = pydantic.Field(..., description='')
    invert: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
    match: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_HeaderMatchMethodPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...

class CfnRouteDefHttproutematchpropertyParams(pydantic.BaseModel):
    headers: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_HttpRouteHeaderPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    method: typing.Optional[str] = pydantic.Field(None, description='')
    path: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_HttpPathMatchPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    port: typing.Union[int, float, None] = pydantic.Field(None, description='')
    prefix: typing.Optional[str] = pydantic.Field(None, description='')
    query_parameters: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_QueryParameterPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    scheme: typing.Optional[str] = pydantic.Field(None, description='')
    ...

class CfnRouteDefHttproutepropertyParams(pydantic.BaseModel):
    action: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_HttpRouteActionPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    match: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_HttpRouteMatchPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    retry_policy: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_HttpRetryPolicyPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    timeout: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_HttpTimeoutPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnRouteDefQueryparameterpropertyParams(pydantic.BaseModel):
    name: str = pydantic.Field(..., description='')
    match: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_HttpQueryParameterMatchPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...

class CfnRouteDefRoutespecpropertyParams(pydantic.BaseModel):
    grpc_route: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_GrpcRoutePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    http2_route: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_HttpRoutePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    http_route: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_HttpRoutePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    priority: typing.Union[int, float, None] = pydantic.Field(None, description='')
    tcp_route: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_TcpRoutePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnRouteDefTcproutepropertyParams(pydantic.BaseModel):
    action: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_TcpRouteActionPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    match: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_TcpRouteMatchPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    timeout: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnRoute_TcpTimeoutPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnVirtualGatewayDef(BaseCfnResource):
    mesh_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the service mesh that the virtual gateway resides in.\n')
    spec: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewaySpecPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The specifications of the virtual gateway.\n')
    mesh_owner: typing.Optional[str] = pydantic.Field(None, description="The AWS IAM account ID of the service mesh owner. If the account ID is not your own, then it's the ID of the account that shared the mesh with your account. For more information about mesh sharing, see `Working with shared meshes <https://docs.aws.amazon.com/app-mesh/latest/userguide/sharing.html>`_ .\n")
...
class CfnVirtualGatewayDefLoggingformatpropertyParams(pydantic.BaseModel):
    json_: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_JsonFormatRefPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='', alias='json')
...
class CfnVirtualGatewayDefSubjectalternativenamespropertyParams(pydantic.BaseModel):
    match: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_SubjectAlternativeNameMatchersPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    ...

class CfnVirtualGatewayDefVirtualgatewayaccesslogpropertyParams(pydantic.BaseModel):
    file: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayFileAccessLogPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...

class CfnVirtualGatewayDefVirtualgatewaybackenddefaultspropertyParams(pydantic.BaseModel):
    client_policy: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayClientPolicyPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...

class CfnVirtualGatewayDefVirtualgatewayclientpolicypropertyParams(pydantic.BaseModel):
    tls: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayClientPolicyTlsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...

class CfnVirtualGatewayDefVirtualgatewayclientpolicytlspropertyParams(pydantic.BaseModel):
    validation: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayTlsValidationContextPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    certificate: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayClientTlsCertificatePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    enforce: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
...
class CfnVirtualGatewayDefVirtualgatewayclienttlscertificatepropertyParams(pydantic.BaseModel):
    file: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayListenerTlsFileCertificatePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    sds: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayListenerTlsSdsCertificatePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...

class CfnVirtualGatewayDefVirtualgatewayconnectionpoolpropertyParams(pydantic.BaseModel):
    grpc: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayGrpcConnectionPoolPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    http: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayHttpConnectionPoolPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    http2: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayHttp2ConnectionPoolPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnVirtualGatewayDefVirtualgatewayfileaccesslogpropertyParams(pydantic.BaseModel):
    ...
    format: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_LoggingFormatPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnVirtualGatewayDefVirtualgatewaylistenerpropertyParams(pydantic.BaseModel):
    port_mapping: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayPortMappingPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    connection_pool: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayConnectionPoolPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    health_check: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayHealthCheckPolicyPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    tls: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayListenerTlsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnVirtualGatewayDefVirtualgatewaylistenertlscertificatepropertyParams(pydantic.BaseModel):
    acm: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayListenerTlsAcmCertificatePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    file: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayListenerTlsFileCertificatePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    sds: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayListenerTlsSdsCertificatePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnVirtualGatewayDefVirtualgatewaylistenertlspropertyParams(pydantic.BaseModel):
    certificate: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayListenerTlsCertificatePropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    mode: str = pydantic.Field(..., description='')
    validation: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayListenerTlsValidationContextPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnVirtualGatewayDefVirtualgatewaylistenertlsvalidationcontextpropertyParams(pydantic.BaseModel):
    trust: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayListenerTlsValidationContextTrustPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    subject_alternative_names: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_SubjectAlternativeNamesPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...

class CfnVirtualGatewayDefVirtualgatewaylistenertlsvalidationcontexttrustpropertyParams(pydantic.BaseModel):
    file: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayTlsValidationContextFileTrustPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    sds: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayTlsValidationContextSdsTrustPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...

class CfnVirtualGatewayDefVirtualgatewayloggingpropertyParams(pydantic.BaseModel):
    access_log: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayAccessLogPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnVirtualGatewayDefVirtualgatewayspecpropertyParams(pydantic.BaseModel):
    listeners: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayListenerPropertyDef, dict[str, typing.Any]]]] = pydantic.Field(..., description='')
    backend_defaults: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayBackendDefaultsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    logging: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayLoggingPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnVirtualGatewayDefVirtualgatewaytlsvalidationcontextpropertyParams(pydantic.BaseModel):
    trust: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayTlsValidationContextTrustPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    subject_alternative_names: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_SubjectAlternativeNamesPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnVirtualGatewayDefVirtualgatewaytlsvalidationcontexttrustpropertyParams(pydantic.BaseModel):
    acm: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayTlsValidationContextAcmTrustPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    file: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayTlsValidationContextFileTrustPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    sds: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualGateway_VirtualGatewayTlsValidationContextSdsTrustPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnVirtualNodeDef(BaseCfnResource):
    mesh_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the service mesh to create the virtual node in.\n')
    spec: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_VirtualNodeSpecPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The virtual node specification to apply.\n')
    mesh_owner: typing.Optional[str] = pydantic.Field(None, description='The AWS IAM account ID of the service mesh owner. If the account ID is not your own, then the account that you specify must share the mesh with your account before you can create the resource in the service mesh. For more information about mesh sharing, see `Working with shared meshes <https://docs.aws.amazon.com/app-mesh/latest/userguide/sharing.html>`_ .\n')
...
class CfnVirtualNodeDefAccesslogpropertyParams(pydantic.BaseModel):
    file: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_FileAccessLogPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnVirtualNodeDefAwscloudmapservicediscoverypropertyParams(pydantic.BaseModel):
    ...
    attributes: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_AwsCloudMapInstanceAttributePropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    ip_preference: typing.Optional[str] = pydantic.Field(None, description='')
    ...

class CfnVirtualNodeDefBackenddefaultspropertyParams(pydantic.BaseModel):
    client_policy: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_ClientPolicyPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...

class CfnVirtualNodeDefBackendpropertyParams(pydantic.BaseModel):
    virtual_service: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_VirtualServiceBackendPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...

class CfnVirtualNodeDefClientpolicypropertyParams(pydantic.BaseModel):
    tls: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_ClientPolicyTlsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...

class CfnVirtualNodeDefClientpolicytlspropertyParams(pydantic.BaseModel):
    validation: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_TlsValidationContextPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    certificate: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_ClientTlsCertificatePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    enforce: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
    ports: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[int, float]], None] = pydantic.Field(None, description='')
    ...

class CfnVirtualNodeDefClienttlscertificatepropertyParams(pydantic.BaseModel):
    file: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_ListenerTlsFileCertificatePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    sds: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_ListenerTlsSdsCertificatePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnVirtualNodeDefFileaccesslogpropertyParams(pydantic.BaseModel):
    path: str = pydantic.Field(..., description='')
    format: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_LoggingFormatPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...

class CfnVirtualNodeDefGrpctimeoutpropertyParams(pydantic.BaseModel):
    idle: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_DurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    per_request: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_DurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnVirtualNodeDefListenerpropertyParams(pydantic.BaseModel):
    port_mapping: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_PortMappingPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    connection_pool: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_VirtualNodeConnectionPoolPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    health_check: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_HealthCheckPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    outlier_detection: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_OutlierDetectionPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    timeout: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_ListenerTimeoutPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    tls: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_ListenerTlsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...

class CfnVirtualNodeDefListenertimeoutpropertyParams(pydantic.BaseModel):
    grpc: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_GrpcTimeoutPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    http: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_HttpTimeoutPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    http2: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_HttpTimeoutPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    tcp: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_TcpTimeoutPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnVirtualNodeDefListenertlscertificatepropertyParams(pydantic.BaseModel):
    acm: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_ListenerTlsAcmCertificatePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    file: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_ListenerTlsFileCertificatePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    sds: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_ListenerTlsSdsCertificatePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnVirtualNodeDefListenertlspropertyParams(pydantic.BaseModel):
    certificate: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_ListenerTlsCertificatePropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    mode: str = pydantic.Field(..., description='')
    validation: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_ListenerTlsValidationContextPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnVirtualNodeDefListenertlsvalidationcontextpropertyParams(pydantic.BaseModel):
    trust: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_ListenerTlsValidationContextTrustPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    subject_alternative_names: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_SubjectAlternativeNamesPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...

class CfnVirtualNodeDefListenertlsvalidationcontexttrustpropertyParams(pydantic.BaseModel):
    file: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_TlsValidationContextFileTrustPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    sds: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_TlsValidationContextSdsTrustPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...

class CfnVirtualNodeDefLoggingformatpropertyParams(pydantic.BaseModel):
    json_: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_JsonFormatRefPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='', alias='json')
    text: typing.Optional[str] = pydantic.Field(None, description='')
    ...

class CfnVirtualNodeDefLoggingpropertyParams(pydantic.BaseModel):
    access_log: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_AccessLogPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...

class CfnVirtualNodeDefOutlierdetectionpropertyParams(pydantic.BaseModel):
    base_ejection_duration: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_DurationPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    interval: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_DurationPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
...
class CfnVirtualNodeDefServicediscoverypropertyParams(pydantic.BaseModel):
    aws_cloud_map: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_AwsCloudMapServiceDiscoveryPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    dns: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_DnsServiceDiscoveryPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnVirtualNodeDefSubjectalternativenamespropertyParams(pydantic.BaseModel):
    match: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_SubjectAlternativeNameMatchersPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    ...
...
class CfnVirtualNodeDefTlsvalidationcontextpropertyParams(pydantic.BaseModel):
    trust: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_TlsValidationContextTrustPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    subject_alternative_names: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_SubjectAlternativeNamesPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnVirtualNodeDefTlsvalidationcontexttrustpropertyParams(pydantic.BaseModel):
    acm: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_TlsValidationContextAcmTrustPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    file: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_TlsValidationContextFileTrustPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    sds: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_TlsValidationContextSdsTrustPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...

class CfnVirtualNodeDefVirtualnodeconnectionpoolpropertyParams(pydantic.BaseModel):
    grpc: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_VirtualNodeGrpcConnectionPoolPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    http: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_VirtualNodeHttpConnectionPoolPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    http2: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_VirtualNodeHttp2ConnectionPoolPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    tcp: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_VirtualNodeTcpConnectionPoolPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnVirtualNodeDefVirtualnodespecpropertyParams(pydantic.BaseModel):
    backend_defaults: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_BackendDefaultsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    backends: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_BackendPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    listeners: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_ListenerPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    logging: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_LoggingPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    service_discovery: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualNode_ServiceDiscoveryPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnVirtualRouterDef(BaseCfnResource):
    mesh_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the service mesh to create the virtual router in.\n')
    spec: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_appmesh.CfnVirtualRouter_VirtualRouterSpecPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The virtual router specification to apply.\n')
    mesh_owner: typing.Optional[str] = pydantic.Field(None, description='The AWS IAM account ID of the service mesh owner. If the account ID is not your own, then the account that you specify must share the mesh with your account before you can create the resource in the service mesh. For more information about mesh sharing, see `Working with shared meshes <https://docs.aws.amazon.com/app-mesh/latest/userguide/sharing.html>`_ .\n')
...
class CfnVirtualRouterDefVirtualrouterlistenerpropertyParams(pydantic.BaseModel):
    port_mapping: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualRouter_PortMappingPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    ...

class CfnVirtualRouterDefVirtualrouterspecpropertyParams(pydantic.BaseModel):
    listeners: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualRouter_VirtualRouterListenerPropertyDef, dict[str, typing.Any]]]] = pydantic.Field(..., description='')
    ...
...
class CfnVirtualServiceDef(BaseCfnResource):
    mesh_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the service mesh to create the virtual service in.\n')
    spec: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_appmesh.CfnVirtualService_VirtualServiceSpecPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The virtual service specification to apply.\n')
    virtual_service_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name to use for the virtual service.\n')
    mesh_owner: typing.Optional[str] = pydantic.Field(None, description='The AWS IAM account ID of the service mesh owner. If the account ID is not your own, then the account that you specify must share the mesh with your account before you can create the resource in the service mesh. For more information about mesh sharing, see `Working with shared meshes <https://docs.aws.amazon.com/app-mesh/latest/userguide/sharing.html>`_ .\n')
...
class CfnVirtualServiceDefVirtualserviceproviderpropertyParams(pydantic.BaseModel):
    virtual_node: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualService_VirtualNodeServiceProviderPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    virtual_router: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualService_VirtualRouterServiceProviderPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...

class CfnVirtualServiceDefVirtualservicespecpropertyParams(pydantic.BaseModel):
    provider: typing.Union[models.UnsupportedResource, models.aws_appmesh.CfnVirtualService_VirtualServiceProviderPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
