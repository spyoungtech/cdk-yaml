...
class DomainDef(BaseConstruct, ConnectableMixin):
    ...
    cold_storage_enabled: typing.Optional[bool] = pydantic.Field(None, description='Whether to enable or disable cold storage on the domain. You must enable UltraWarm storage to enable cold storage. Default: - undefined\n')
    ...
    ip_address_type: typing.Optional[aws_cdk.aws_opensearchservice.IpAddressType] = pydantic.Field(None, description="Specify either dual stack or IPv4 as your IP address type. Dual stack allows you to share domain resources across IPv4 and IPv6 address types, and is the recommended option. If you set your IP address type to dual stack, you can't change your address type later. Default: - IpAddressType.IPV4\n")
    ...
    _init_params: typing.ClassVar[list[str]] = ['version', 'access_policies', 'advanced_options', 'automated_snapshot_start_hour', 'capacity', 'cognito_dashboards_auth', 'cold_storage_enabled', 'custom_endpoint', 'domain_name', 'ebs', 'enable_auto_software_update', 'enable_version_upgrade', 'encryption_at_rest', 'enforce_https', 'fine_grained_access_control', 'ip_address_type', 'logging', 'node_to_node_encryption', 'off_peak_window_enabled', 'off_peak_window_start', 'removal_policy', 'security_groups', 'suppress_logs_resource_policy', 'tls_security_policy', 'use_unsigned_basic_auth', 'vpc', 'vpc_subnets', 'zone_awareness']
...
class CfnDomain_ClusterConfigPropertyDef(BaseStruct):
    cold_storage_options: typing.Union[models.UnsupportedResource, models.aws_opensearchservice.CfnDomain_ColdStorageOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Container for cold storage configuration options.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['cold_storage_options', 'dedicated_master_count', 'dedicated_master_enabled', 'dedicated_master_type', 'instance_count', 'instance_type', 'multi_az_with_standby_enabled', 'warm_count', 'warm_enabled', 'warm_type', 'zone_awareness_config', 'zone_awareness_enabled']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
#  autogenerated from aws_cdk.aws_opensearchservice.CfnDomain.ColdStorageOptionsProperty
class CfnDomain_ColdStorageOptionsPropertyDef(BaseStruct):
    enabled: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='Whether to enable or disable cold storage on the domain. You must enable UltraWarm storage to enable cold storage.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-opensearchservice-domain-coldstorageoptions.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_opensearchservice as opensearchservice\n\n    cold_storage_options_property = opensearchservice.CfnDomain.ColdStorageOptionsProperty(\n        enabled=False\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['enabled']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_opensearchservice.CfnDomain.ColdStorageOptionsProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class CfnDomain_EncryptionAtRestOptionsPropertyDef(BaseStruct):
    ...
    kms_key_id: typing.Optional[str] = pydantic.Field(None, description='The KMS key ID. Takes the form ``1a2a3a4-1a2a-3a4a-5a6a-1a2a3a4a5a6a`` . Required if you enable encryption at rest. You can also use ``keyAlias`` as a value. If no encryption at rest options were initially specified in the template, updating this property by adding it causes no interruption. However, if you change this property after it\'s already been set within a template, the domain is deleted and recreated in order to modify the property.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-opensearchservice-domain-encryptionatrestoptions.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_opensearchservice as opensearchservice\n\n    encryption_at_rest_options_property = opensearchservice.CfnDomain.EncryptionAtRestOptionsProperty(\n        enabled=False,\n        kms_key_id="kmsKeyId"\n    )\n')
...
class LoggingOptionsDef(BaseStruct):
    app_log_enabled: typing.Optional[bool] = pydantic.Field(None, description='Specify if Amazon OpenSearch Service application logging should be set up. Requires Elasticsearch version 5.1 or later or OpenSearch version 1.0 or later. An explicit ``false`` is required when disabling it from ``true``. Default: - false\n')
    ...
    slow_index_log_enabled: typing.Optional[bool] = pydantic.Field(None, description='Specify if slow index logging should be set up. Requires Elasticsearch version 5.1 or later or OpenSearch version 1.0 or later. An explicit ``false`` is required when disabling it from ``true``. Default: - false\n')
    ...
    slow_search_log_enabled: typing.Optional[bool] = pydantic.Field(None, description='Specify if slow search logging should be set up. Requires Elasticsearch version 5.1 or later or OpenSearch version 1.0 or later. An explicit ``false`` is required when disabling it from ``true``. Default: - false\n')
...
#  autogenerated from aws_cdk.aws_opensearchservice.IpAddressType
# skipping emum
...
class CfnDomainDef(BaseCfnResource):
    ...
    ip_address_type: typing.Optional[str] = pydantic.Field(None, description="Choose either dual stack or IPv4 as your IP address type. Dual stack allows you to share domain resources across IPv4 and IPv6 address types, and is the recommended option. If you set your IP address type to dual stack, you can't change your address type later.\n")
    ...
    software_update_options: typing.Union[models.UnsupportedResource, models.aws_opensearchservice.CfnDomain_SoftwareUpdateOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Service software update options for the domain.\n')
...
class CfnDomainDefConfig(pydantic.BaseModel):
    ...
    ColdStorageOptionsProperty: typing.Optional[list[models.aws_opensearchservice.CfnDomainDefColdstorageoptionspropertyParams]] = pydantic.Field(None, description='')
...
class CfnDomainDefClusterconfigpropertyParams(pydantic.BaseModel):
    cold_storage_options: typing.Union[models.UnsupportedResource, models.aws_opensearchservice.CfnDomain_ColdStorageOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
...
class ModuleModel(pydantic.BaseModel):
    ...
    CfnDomain_ColdStorageOptionsProperty: typing.Optional[dict[str, models.aws_opensearchservice.CfnDomain_ColdStorageOptionsPropertyDef]] = pydantic.Field(None)
