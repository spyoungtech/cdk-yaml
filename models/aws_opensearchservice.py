...
class ModuleModel(pydantic.BaseModel):
    ...
    SAMLOptionsProperty: typing.Optional[dict[str, SAMLOptionsPropertyDef]] = pydantic.Field(None)
    WindowStartTime: typing.Optional[dict[str, WindowStartTimeDef]] = pydantic.Field(None)
