...
class CfnExtensionDefConfig(pydantic.BaseModel):
    ActionProperty: typing.Optional[list[CfnExtensionDefActionpropertyParams]] = pydantic.Field(None, description='')
...
class ModuleModel(pydantic.BaseModel):
    ...
    CfnExtension_ActionProperty: typing.Optional[dict[str, CfnExtension_ActionPropertyDef]] = pydantic.Field(None)
