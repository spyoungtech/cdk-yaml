...
class CfnDataset_DatabaseInputDefinitionPropertyDef(BaseStruct):
    glue_connection_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The AWS Glue Connection that stores the connection information for the target database.\n')
...
class CfnDataset_DatasetParameterPropertyDef(BaseStruct):
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description="The name of the parameter that is used in the dataset's Amazon S3 path.\n")
    type: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description="The type of the dataset parameter, can be one of a 'String', 'Number' or 'Datetime'.\n")
    create_column: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='Optional boolean value that defines whether the captured value of this parameter should be loaded as an additional column in the dataset.\n')
    datetime_options: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnDataset_DatetimeOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Additional parameter options such as a format and a timezone. Required for datetime parameters.\n')
    filter: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnDataset_FilterExpressionPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The optional filter expression structure to apply additional matching criteria to the parameter.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-databrew-dataset-datasetparameter.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_databrew as databrew\n\n    dataset_parameter_property = databrew.CfnDataset.DatasetParameterProperty(\n        name="name",\n        type="type",\n\n        # the properties below are optional\n        create_column=False,\n        datetime_options=databrew.CfnDataset.DatetimeOptionsProperty(\n            format="format",\n\n            # the properties below are optional\n            locale_code="localeCode",\n            timezone_offset="timezoneOffset"\n        ),\n        filter=databrew.CfnDataset.FilterExpressionProperty(\n            expression="expression",\n            values_map=[databrew.CfnDataset.FilterValueProperty(\n                value="value",\n                value_reference="valueReference"\n            )]\n        )\n    )\n')
...
class CfnDataset_ExcelOptionsPropertyDef(BaseStruct):
    header_row: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='A variable that specifies whether the first row in the file is parsed as the header. If this value is false, column names are auto-generated.\n')
    sheet_indexes: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[int, float]], None] = pydantic.Field(None, description='One or more sheet numbers in the Excel file that will be included in the dataset.\n')
...
class CfnDataset_FilesLimitPropertyDef(BaseStruct):
    max_files: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The number of Amazon S3 files to select.\n')
...
class CfnDataset_FilterExpressionPropertyDef(BaseStruct):
    expression: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The expression which includes condition names followed by substitution variables, possibly grouped and combined with other conditions. For example, "(starts_with :prefix1 or starts_with :prefix2) and (ends_with :suffix1 or ends_with :suffix2)". Substitution variables should start with \':\' symbol.\n')
    values_map: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_databrew.CfnDataset_FilterValuePropertyDef, dict[str, typing.Any]]]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The map of substitution variable names to their values used in this filter expression.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-databrew-dataset-filterexpression.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_databrew as databrew\n\n    filter_expression_property = databrew.CfnDataset.FilterExpressionProperty(\n        expression="expression",\n        values_map=[databrew.CfnDataset.FilterValueProperty(\n            value="value",\n            value_reference="valueReference"\n        )]\n    )\n')
...
class CfnDataset_FilterValuePropertyDef(BaseStruct):
    value: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The value to be associated with the substitution variable.\n')
    value_reference: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The substitution variable reference.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-databrew-dataset-filtervalue.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_databrew as databrew\n\n    filter_value_property = databrew.CfnDataset.FilterValueProperty(\n        value="value",\n        value_reference="valueReference"\n    )\n')
...
class CfnDataset_FormatOptionsPropertyDef(BaseStruct):
    csv: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnDataset_CsvOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Options that define how CSV input is to be interpreted by DataBrew.\n')
    excel: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnDataset_ExcelOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Options that define how Excel input is to be interpreted by DataBrew.\n')
    json_: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnDataset_JsonOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Options that define how JSON input is to be interpreted by DataBrew.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-databrew-dataset-formatoptions.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_databrew as databrew\n\n    format_options_property = databrew.CfnDataset.FormatOptionsProperty(\n        csv=databrew.CfnDataset.CsvOptionsProperty(\n            delimiter="delimiter",\n            header_row=False\n        ),\n        excel=databrew.CfnDataset.ExcelOptionsProperty(\n            header_row=False,\n            sheet_indexes=[123],\n            sheet_names=["sheetNames"]\n        ),\n        json=databrew.CfnDataset.JsonOptionsProperty(\n            multi_line=False\n        )\n    )\n', alias='json')
...
class CfnDataset_InputPropertyDef(BaseStruct):
    database_input_definition: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnDataset_DatabaseInputDefinitionPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Connection information for dataset input files stored in a database.\n')
    data_catalog_input_definition: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnDataset_DataCatalogInputDefinitionPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The AWS Glue Data Catalog parameters for the data.\n')
    metadata: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnDataset_MetadataPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Contains additional resource information needed for specific datasets.\n')
    s3_input_definition: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnDataset_S3LocationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The Amazon S3 location where the data is stored.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-databrew-dataset-input.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_databrew as databrew\n\n    input_property = databrew.CfnDataset.InputProperty(\n        database_input_definition=databrew.CfnDataset.DatabaseInputDefinitionProperty(\n            glue_connection_name="glueConnectionName",\n\n            # the properties below are optional\n            database_table_name="databaseTableName",\n            query_string="queryString",\n            temp_directory=databrew.CfnDataset.S3LocationProperty(\n                bucket="bucket",\n\n                # the properties below are optional\n                key="key"\n            )\n        ),\n        data_catalog_input_definition=databrew.CfnDataset.DataCatalogInputDefinitionProperty(\n            catalog_id="catalogId",\n            database_name="databaseName",\n            table_name="tableName",\n            temp_directory=databrew.CfnDataset.S3LocationProperty(\n                bucket="bucket",\n\n                # the properties below are optional\n                key="key"\n            )\n        ),\n        metadata=databrew.CfnDataset.MetadataProperty(\n            source_arn="sourceArn"\n        ),\n        s3_input_definition=databrew.CfnDataset.S3LocationProperty(\n            bucket="bucket",\n\n            # the properties below are optional\n            key="key"\n        )\n    )\n')
...
class CfnDataset_PathOptionsPropertyDef(BaseStruct):
    files_limit: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnDataset_FilesLimitPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='If provided, this structure imposes a limit on a number of files that should be selected.\n')
    last_modified_date_condition: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnDataset_FilterExpressionPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='If provided, this structure defines a date range for matching Amazon S3 objects based on their LastModifiedDate attribute in Amazon S3 .\n')
    parameters: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_databrew.CfnDataset_PathParameterPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='A structure that maps names of parameters used in the Amazon S3 path of a dataset to their definitions.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-databrew-dataset-pathoptions.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_databrew as databrew\n\n    path_options_property = databrew.CfnDataset.PathOptionsProperty(\n        files_limit=databrew.CfnDataset.FilesLimitProperty(\n            max_files=123,\n\n            # the properties below are optional\n            order="order",\n            ordered_by="orderedBy"\n        ),\n        last_modified_date_condition=databrew.CfnDataset.FilterExpressionProperty(\n            expression="expression",\n            values_map=[databrew.CfnDataset.FilterValueProperty(\n                value="value",\n                value_reference="valueReference"\n            )]\n        ),\n        parameters=[databrew.CfnDataset.PathParameterProperty(\n            dataset_parameter=databrew.CfnDataset.DatasetParameterProperty(\n                name="name",\n                type="type",\n\n                # the properties below are optional\n                create_column=False,\n                datetime_options=databrew.CfnDataset.DatetimeOptionsProperty(\n                    format="format",\n\n                    # the properties below are optional\n                    locale_code="localeCode",\n                    timezone_offset="timezoneOffset"\n                ),\n                filter=databrew.CfnDataset.FilterExpressionProperty(\n                    expression="expression",\n                    values_map=[databrew.CfnDataset.FilterValueProperty(\n                        value="value",\n                        value_reference="valueReference"\n                    )]\n                )\n            ),\n            path_parameter_name="pathParameterName"\n        )]\n    )\n')
...
class CfnDataset_PathParameterPropertyDef(BaseStruct):
    dataset_parameter: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_databrew.CfnDataset_DatasetParameterPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The path parameter definition.\n')
    path_parameter_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the path parameter.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-databrew-dataset-pathparameter.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_databrew as databrew\n\n    path_parameter_property = databrew.CfnDataset.PathParameterProperty(\n        dataset_parameter=databrew.CfnDataset.DatasetParameterProperty(\n            name="name",\n            type="type",\n\n            # the properties below are optional\n            create_column=False,\n            datetime_options=databrew.CfnDataset.DatetimeOptionsProperty(\n                format="format",\n\n                # the properties below are optional\n                locale_code="localeCode",\n                timezone_offset="timezoneOffset"\n            ),\n            filter=databrew.CfnDataset.FilterExpressionProperty(\n                expression="expression",\n                values_map=[databrew.CfnDataset.FilterValueProperty(\n                    value="value",\n                    value_reference="valueReference"\n                )]\n            )\n        ),\n        path_parameter_name="pathParameterName"\n    )\n')
...
class CfnDataset_S3LocationPropertyDef(BaseStruct):
    bucket: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Amazon S3 bucket name.\n')
...
class CfnJob_AllowedStatisticsPropertyDef(BaseStruct):
    statistics: typing.Union[typing.Sequence[str], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='One or more column statistics to allow for columns that contain detected entities.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-databrew-job-allowedstatistics.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_databrew as databrew\n\n    allowed_statistics_property = databrew.CfnJob.AllowedStatisticsProperty(\n        statistics=["statistics"]\n    )\n')
...
class CfnJob_DatabaseOutputPropertyDef(BaseStruct):
    database_options: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_databrew.CfnJob_DatabaseTableOutputOptionsPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='Represents options that specify how and where DataBrew writes the database output generated by recipe jobs.\n')
    glue_connection_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The AWS Glue connection that stores the connection information for the target database.\n')
...
class CfnJob_DatabaseTableOutputOptionsPropertyDef(BaseStruct):
    table_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A prefix for the name of a table DataBrew will create in the database.\n')
    temp_directory: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnJob_S3LocationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Represents an Amazon S3 location (bucket name and object key) where DataBrew can store intermediate results.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-databrew-job-databasetableoutputoptions.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_databrew as databrew\n\n    database_table_output_options_property = databrew.CfnJob.DatabaseTableOutputOptionsProperty(\n        table_name="tableName",\n\n        # the properties below are optional\n        temp_directory=databrew.CfnJob.S3LocationProperty(\n            bucket="bucket",\n\n            # the properties below are optional\n            bucket_owner="bucketOwner",\n            key="key"\n        )\n    )\n')
...
class CfnJob_DataCatalogOutputPropertyDef(BaseStruct):
    database_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of a database in the Data Catalog.\n')
    table_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of a table in the Data Catalog.\n')
    catalog_id: typing.Optional[str] = pydantic.Field(None, description='The unique identifier of the AWS account that holds the Data Catalog that stores the data.\n')
    database_options: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnJob_DatabaseTableOutputOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Represents options that specify how and where DataBrew writes the database output generated by recipe jobs.\n')
    overwrite: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='A value that, if true, means that any data in the location specified for output is overwritten with new output. Not supported with DatabaseOptions.\n')
    s3_options: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnJob_S3TableOutputOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Represents options that specify how and where DataBrew writes the Amazon S3 output generated by recipe jobs.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-databrew-job-datacatalogoutput.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_databrew as databrew\n\n    data_catalog_output_property = databrew.CfnJob.DataCatalogOutputProperty(\n        database_name="databaseName",\n        table_name="tableName",\n\n        # the properties below are optional\n        catalog_id="catalogId",\n        database_options=databrew.CfnJob.DatabaseTableOutputOptionsProperty(\n            table_name="tableName",\n\n            # the properties below are optional\n            temp_directory=databrew.CfnJob.S3LocationProperty(\n                bucket="bucket",\n\n                # the properties below are optional\n                bucket_owner="bucketOwner",\n                key="key"\n            )\n        ),\n        overwrite=False,\n        s3_options=databrew.CfnJob.S3TableOutputOptionsProperty(\n            location=databrew.CfnJob.S3LocationProperty(\n                bucket="bucket",\n\n                # the properties below are optional\n                bucket_owner="bucketOwner",\n                key="key"\n            )\n        )\n    )\n')
...
class CfnJob_OutputFormatOptionsPropertyDef(BaseStruct):
    csv: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnJob_CsvOutputOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Represents a set of options that define the structure of comma-separated value (CSV) job output.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-databrew-job-outputformatoptions.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_databrew as databrew\n\n    output_format_options_property = databrew.CfnJob.OutputFormatOptionsProperty(\n        csv=databrew.CfnJob.CsvOutputOptionsProperty(\n            delimiter="delimiter"\n        )\n    )\n')
...
class CfnJob_OutputPropertyDef(BaseStruct):
    location: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_databrew.CfnJob_S3LocationPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The location in Amazon S3 where the job writes its output.\n')
    ...
    format_options: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnJob_OutputFormatOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Represents options that define how DataBrew formats job output files.\n')
    ...
    overwrite: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='A value that, if true, means that any data in the location specified for output is overwritten with new output.\n')
...
class CfnJob_RecipePropertyDef(BaseStruct):
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The unique name for the recipe.\n')
...
class CfnJob_S3TableOutputOptionsPropertyDef(BaseStruct):
    location: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_databrew.CfnJob_S3LocationPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='Represents an Amazon S3 location (bucket name and object key) where DataBrew can write output from a job.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-databrew-job-s3tableoutputoptions.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_databrew as databrew\n\n    s3_table_output_options_property = databrew.CfnJob.S3TableOutputOptionsProperty(\n        location=databrew.CfnJob.S3LocationProperty(\n            bucket="bucket",\n\n            # the properties below are optional\n            bucket_owner="bucketOwner",\n            key="key"\n        )\n    )\n')
...
class CfnJob_StatisticOverridePropertyDef(BaseStruct):
    parameters: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, typing.Mapping[str, str]] = pydantic.Field(REQUIRED_INIT_PARAM, description='A map that includes overrides of an evaluation’s parameters.\n')
    statistic: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of an evaluation.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-databrew-job-statisticoverride.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_databrew as databrew\n\n    statistic_override_property = databrew.CfnJob.StatisticOverrideProperty(\n        parameters={\n            "parameters_key": "parameters"\n        },\n        statistic="statistic"\n    )\n')
...
class CfnJob_StatisticsConfigurationPropertyDef(BaseStruct):
    ...
    overrides: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_databrew.CfnJob_StatisticOverridePropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='List of overrides for evaluations.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-databrew-job-statisticsconfiguration.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_databrew as databrew\n\n    statistics_configuration_property = databrew.CfnJob.StatisticsConfigurationProperty(\n        included_statistics=["includedStatistics"],\n        overrides=[databrew.CfnJob.StatisticOverrideProperty(\n            parameters={\n                "parameters_key": "parameters"\n            },\n            statistic="statistic"\n        )]\n    )\n')
...
class CfnJob_ValidationConfigurationPropertyDef(BaseStruct):
    ruleset_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Amazon Resource Name (ARN) for the ruleset to be validated in the profile job. The TargetArn of the selected ruleset should be the same as the Amazon Resource Name (ARN) of the dataset that is associated with the profile job.\n')
...
class CfnProject_SamplePropertyDef(BaseStruct):
    type: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The way in which DataBrew obtains rows from a dataset.\n')
...
class CfnRecipe_ActionPropertyDef(BaseStruct):
    operation: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of a valid DataBrew transformation to be performed on the data.\n')
    parameters: typing.Union[models.UnsupportedResource, typing.Mapping[str, str], None] = pydantic.Field(None, description='Contextual parameters for the transformation.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-databrew-recipe-action.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_databrew as databrew\n\n    action_property = databrew.CfnRecipe.ActionProperty(\n        operation="operation",\n\n        # the properties below are optional\n        parameters={\n            "parameters_key": "parameters"\n        }\n    )\n')
...
class CfnRecipe_ConditionExpressionPropertyDef(BaseStruct):
    condition: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A specific condition to apply to a recipe action. For more information, see `Recipe structure <https://docs.aws.amazon.com/databrew/latest/dg/recipe-structure.html>`_ in the *AWS Glue DataBrew Developer Guide* .\n')
    target_column: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A column to apply this condition to.\n')
...
class CfnRecipe_InputPropertyDef(BaseStruct):
    data_catalog_input_definition: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnRecipe_DataCatalogInputDefinitionPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The AWS Glue Data Catalog parameters for the data.\n')
    s3_input_definition: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnRecipe_S3LocationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The Amazon S3 location where the data is stored.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-databrew-recipe-input.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_databrew as databrew\n\n    input_property = databrew.CfnRecipe.InputProperty(\n        data_catalog_input_definition=databrew.CfnRecipe.DataCatalogInputDefinitionProperty(\n            catalog_id="catalogId",\n            database_name="databaseName",\n            table_name="tableName",\n            temp_directory=databrew.CfnRecipe.S3LocationProperty(\n                bucket="bucket",\n\n                # the properties below are optional\n                key="key"\n            )\n        ),\n        s3_input_definition=databrew.CfnRecipe.S3LocationProperty(\n            bucket="bucket",\n\n            # the properties below are optional\n            key="key"\n        )\n    )\n')
...
class CfnRecipe_RecipeParametersPropertyDef(BaseStruct):
    ...
    multi_line: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='Specifies whether JSON input contains embedded new line characters.\n')
    ...
    secondary_inputs: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_databrew.CfnRecipe_SecondaryInputPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='A list of secondary inputs in a UNION transform.\n')
    ...
    sheet_indexes: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[int, float]], None] = pydantic.Field(None, description='One or more sheet numbers in the Excel file, which will be included in a dataset.\n')
...
class CfnRuleset_SubstitutionValuePropertyDef(BaseStruct):
    value: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Value or column name.\n')
    value_reference: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Variable name.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-databrew-ruleset-substitutionvalue.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_databrew as databrew\n\n    substitution_value_property = databrew.CfnRuleset.SubstitutionValueProperty(\n        value="value",\n        value_reference="valueReference"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['value', 'value_reference']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnRuleset_ThresholdPropertyDef(BaseStruct):
    value: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The value of a threshold.\n')
...
class CfnDatasetDef(BaseCfnResource):
    input: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_databrew.CfnDataset_InputPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='Information on how DataBrew can find the dataset, in either the AWS Glue Data Catalog or Amazon S3 .\n')
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The unique name of the dataset.\n')
    ...
    format_options: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnDataset_FormatOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A set of options that define how DataBrew interprets the data in the dataset.\n')
    path_options: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnDataset_PathOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A set of options that defines how DataBrew interprets an Amazon S3 path of the dataset.\n')
    ...
    resource_config: typing.Optional[models.aws_databrew.CfnDatasetDefConfig] = pydantic.Field(None)


class CfnDatasetDefConfig(pydantic.BaseModel):
    CsvOptionsProperty: typing.Optional[list[models.aws_databrew.CfnDatasetDefCsvoptionspropertyParams]] = pydantic.Field(None, description='')
    DataCatalogInputDefinitionProperty: typing.Optional[list[models.aws_databrew.CfnDatasetDefDatacataloginputdefinitionpropertyParams]] = pydantic.Field(None, description='')
    DatabaseInputDefinitionProperty: typing.Optional[list[models.aws_databrew.CfnDatasetDefDatabaseinputdefinitionpropertyParams]] = pydantic.Field(None, description='')
    DatasetParameterProperty: typing.Optional[list[models.aws_databrew.CfnDatasetDefDatasetparameterpropertyParams]] = pydantic.Field(None, description='')
    DatetimeOptionsProperty: typing.Optional[list[models.aws_databrew.CfnDatasetDefDatetimeoptionspropertyParams]] = pydantic.Field(None, description='')
    ExcelOptionsProperty: typing.Optional[list[models.aws_databrew.CfnDatasetDefExceloptionspropertyParams]] = pydantic.Field(None, description='')
    FilesLimitProperty: typing.Optional[list[models.aws_databrew.CfnDatasetDefFileslimitpropertyParams]] = pydantic.Field(None, description='')
    FilterExpressionProperty: typing.Optional[list[models.aws_databrew.CfnDatasetDefFilterexpressionpropertyParams]] = pydantic.Field(None, description='')
    FilterValueProperty: typing.Optional[list[models.aws_databrew.CfnDatasetDefFiltervaluepropertyParams]] = pydantic.Field(None, description='')
    FormatOptionsProperty: typing.Optional[list[models.aws_databrew.CfnDatasetDefFormatoptionspropertyParams]] = pydantic.Field(None, description='')
    InputProperty: typing.Optional[list[models.aws_databrew.CfnDatasetDefInputpropertyParams]] = pydantic.Field(None, description='')
    JsonOptionsProperty: typing.Optional[list[models.aws_databrew.CfnDatasetDefJsonoptionspropertyParams]] = pydantic.Field(None, description='')
    MetadataProperty: typing.Optional[list[models.aws_databrew.CfnDatasetDefMetadatapropertyParams]] = pydantic.Field(None, description='')
    PathOptionsProperty: typing.Optional[list[models.aws_databrew.CfnDatasetDefPathoptionspropertyParams]] = pydantic.Field(None, description='')
    PathParameterProperty: typing.Optional[list[models.aws_databrew.CfnDatasetDefPathparameterpropertyParams]] = pydantic.Field(None, description='')
    S3LocationProperty: typing.Optional[list[models.aws_databrew.CfnDatasetDefS3LocationpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_databrew.CfnDatasetDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_databrew.CfnDatasetDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_databrew.CfnDatasetDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_databrew.CfnDatasetDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_databrew.CfnDatasetDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_databrew.CfnDatasetDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_databrew.CfnDatasetDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_databrew.CfnDatasetDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_databrew.CfnDatasetDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_databrew.CfnDatasetDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_databrew.CfnDatasetDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_databrew.CfnDatasetDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_databrew.CfnDatasetDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
class CfnDatasetDefCsvoptionspropertyParams(pydantic.BaseModel):
    ...
    header_row: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
    ...
...
class CfnDatasetDefDatacataloginputdefinitionpropertyParams(pydantic.BaseModel):
    ...
    temp_directory: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnDataset_S3LocationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnDatasetDefDatasetparameterpropertyParams(pydantic.BaseModel):
    ...
    create_column: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
    datetime_options: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnDataset_DatetimeOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    filter: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnDataset_FilterExpressionPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnDatasetDefExceloptionspropertyParams(pydantic.BaseModel):
    header_row: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
    sheet_indexes: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[int, float]], None] = pydantic.Field(None, description='')
...
class CfnDatasetDefFilterexpressionpropertyParams(pydantic.BaseModel):
    ...
    values_map: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_databrew.CfnDataset_FilterValuePropertyDef, dict[str, typing.Any]]]] = pydantic.Field(..., description='')
    ...
...
class CfnDatasetDefFormatoptionspropertyParams(pydantic.BaseModel):
    csv: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnDataset_CsvOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    excel: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnDataset_ExcelOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    json_: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnDataset_JsonOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='', alias='json')
    ...

class CfnDatasetDefInputpropertyParams(pydantic.BaseModel):
    database_input_definition: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnDataset_DatabaseInputDefinitionPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    data_catalog_input_definition: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnDataset_DataCatalogInputDefinitionPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    metadata: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnDataset_MetadataPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    s3_input_definition: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnDataset_S3LocationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...

class CfnDatasetDefJsonoptionspropertyParams(pydantic.BaseModel):
    multi_line: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
    ...
...
class CfnDatasetDefPathoptionspropertyParams(pydantic.BaseModel):
    files_limit: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnDataset_FilesLimitPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    last_modified_date_condition: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnDataset_FilterExpressionPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    parameters: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_databrew.CfnDataset_PathParameterPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    ...

class CfnDatasetDefPathparameterpropertyParams(pydantic.BaseModel):
    dataset_parameter: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnDataset_DatasetParameterPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
...
class CfnJobDef(BaseCfnResource):
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The unique name of the job.\n')
    role_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Amazon Resource Name (ARN) of the role to be assumed for this job.\n')
    type: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The job type of the job, which must be one of the following:. - ``PROFILE`` - A job to analyze a dataset, to determine its size, data types, data distribution, and more. - ``RECIPE`` - A job to apply one or more transformations to a dataset.\n')
    database_outputs: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_databrew.CfnJob_DatabaseOutputPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='Represents a list of JDBC database output objects which defines the output destination for a DataBrew recipe job to write into.\n')
    data_catalog_outputs: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_databrew.CfnJob_DataCatalogOutputPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='One or more artifacts that represent the AWS Glue Data Catalog output from running the job.\n')
    ...
    output_location: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnJob_OutputLocationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The location in Amazon S3 where the job writes its output.\n')
    outputs: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_databrew.CfnJob_OutputPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='One or more artifacts that represent output from running the job.\n')
    profile_configuration: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnJob_ProfileConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Configuration for profile jobs. Configuration can be used to select columns, do evaluations, and override default parameters of evaluations. When configuration is undefined, the profile job will apply default settings to all supported columns.\n')
    project_name: typing.Optional[str] = pydantic.Field(None, description='The name of the project that the job is associated with.\n')
    recipe: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnJob_RecipePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A series of data transformation steps that the job runs.\n')
    ...
    resource_config: typing.Optional[models.aws_databrew.CfnJobDefConfig] = pydantic.Field(None)


class CfnJobDefConfig(pydantic.BaseModel):
    AllowedStatisticsProperty: typing.Optional[list[models.aws_databrew.CfnJobDefAllowedstatisticspropertyParams]] = pydantic.Field(None, description='')
    ColumnSelectorProperty: typing.Optional[list[models.aws_databrew.CfnJobDefColumnselectorpropertyParams]] = pydantic.Field(None, description='')
    ColumnStatisticsConfigurationProperty: typing.Optional[list[models.aws_databrew.CfnJobDefColumnstatisticsconfigurationpropertyParams]] = pydantic.Field(None, description='')
    CsvOutputOptionsProperty: typing.Optional[list[models.aws_databrew.CfnJobDefCsvoutputoptionspropertyParams]] = pydantic.Field(None, description='')
    DataCatalogOutputProperty: typing.Optional[list[models.aws_databrew.CfnJobDefDatacatalogoutputpropertyParams]] = pydantic.Field(None, description='')
    DatabaseOutputProperty: typing.Optional[list[models.aws_databrew.CfnJobDefDatabaseoutputpropertyParams]] = pydantic.Field(None, description='')
    DatabaseTableOutputOptionsProperty: typing.Optional[list[models.aws_databrew.CfnJobDefDatabasetableoutputoptionspropertyParams]] = pydantic.Field(None, description='')
    EntityDetectorConfigurationProperty: typing.Optional[list[models.aws_databrew.CfnJobDefEntitydetectorconfigurationpropertyParams]] = pydantic.Field(None, description='')
    JobSampleProperty: typing.Optional[list[models.aws_databrew.CfnJobDefJobsamplepropertyParams]] = pydantic.Field(None, description='')
    OutputFormatOptionsProperty: typing.Optional[list[models.aws_databrew.CfnJobDefOutputformatoptionspropertyParams]] = pydantic.Field(None, description='')
    OutputLocationProperty: typing.Optional[list[models.aws_databrew.CfnJobDefOutputlocationpropertyParams]] = pydantic.Field(None, description='')
    OutputProperty: typing.Optional[list[models.aws_databrew.CfnJobDefOutputpropertyParams]] = pydantic.Field(None, description='')
    ProfileConfigurationProperty: typing.Optional[list[models.aws_databrew.CfnJobDefProfileconfigurationpropertyParams]] = pydantic.Field(None, description='')
    RecipeProperty: typing.Optional[list[models.aws_databrew.CfnJobDefRecipepropertyParams]] = pydantic.Field(None, description='')
    S3LocationProperty: typing.Optional[list[models.aws_databrew.CfnJobDefS3LocationpropertyParams]] = pydantic.Field(None, description='')
    S3TableOutputOptionsProperty: typing.Optional[list[models.aws_databrew.CfnJobDefS3TableoutputoptionspropertyParams]] = pydantic.Field(None, description='')
    StatisticOverrideProperty: typing.Optional[list[models.aws_databrew.CfnJobDefStatisticoverridepropertyParams]] = pydantic.Field(None, description='')
    StatisticsConfigurationProperty: typing.Optional[list[models.aws_databrew.CfnJobDefStatisticsconfigurationpropertyParams]] = pydantic.Field(None, description='')
    ValidationConfigurationProperty: typing.Optional[list[models.aws_databrew.CfnJobDefValidationconfigurationpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_databrew.CfnJobDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_databrew.CfnJobDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_databrew.CfnJobDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_databrew.CfnJobDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_databrew.CfnJobDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_databrew.CfnJobDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_databrew.CfnJobDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_databrew.CfnJobDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_databrew.CfnJobDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_databrew.CfnJobDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_databrew.CfnJobDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_databrew.CfnJobDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_databrew.CfnJobDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
    tags_config: typing.Optional[models.core.TagManagerDefConfig] = pydantic.Field(None)
...
class CfnJobDefColumnstatisticsconfigurationpropertyParams(pydantic.BaseModel):
    statistics: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnJob_StatisticsConfigurationPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    selectors: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_databrew.CfnJob_ColumnSelectorPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    ...
...
class CfnJobDefDatacatalogoutputpropertyParams(pydantic.BaseModel):
    ...
    catalog_id: typing.Optional[str] = pydantic.Field(None, description='')
    database_options: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnJob_DatabaseTableOutputOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    overwrite: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
    s3_options: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnJob_S3TableOutputOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...

class CfnJobDefDatabaseoutputpropertyParams(pydantic.BaseModel):
    database_options: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnJob_DatabaseTableOutputOptionsPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    glue_connection_name: str = pydantic.Field(..., description='')
...
class CfnJobDefDatabasetableoutputoptionspropertyParams(pydantic.BaseModel):
    table_name: str = pydantic.Field(..., description='')
    temp_directory: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnJob_S3LocationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnJobDefEntitydetectorconfigurationpropertyParams(pydantic.BaseModel):
    ...
    allowed_statistics: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnJob_AllowedStatisticsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnJobDefOutputformatoptionspropertyParams(pydantic.BaseModel):
    csv: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnJob_CsvOutputOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnJobDefOutputpropertyParams(pydantic.BaseModel):
    location: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnJob_S3LocationPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    ...
    format_options: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnJob_OutputFormatOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
...
class CfnJobDefProfileconfigurationpropertyParams(pydantic.BaseModel):
    column_statistics_configurations: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_databrew.CfnJob_ColumnStatisticsConfigurationPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    dataset_statistics_configuration: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnJob_StatisticsConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    entity_detector_configuration: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnJob_EntityDetectorConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    profile_columns: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_databrew.CfnJob_ColumnSelectorPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    ...
...
class CfnJobDefStatisticoverridepropertyParams(pydantic.BaseModel):
    parameters: typing.Union[models.UnsupportedResource, typing.Mapping[str, str]] = pydantic.Field(..., description='')
...
class CfnJobDefStatisticsconfigurationpropertyParams(pydantic.BaseModel):
    ...
    overrides: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_databrew.CfnJob_StatisticOverridePropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    ...
...
class CfnProjectDef(BaseCfnResource):
    dataset_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The dataset that the project is to act upon.\n')
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The unique name of a project.\n')
    recipe_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of a recipe that will be developed during a project session.\n')
    role_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Amazon Resource Name (ARN) of the role that will be assumed for this project.\n')
    sample: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnProject_SamplePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description="The sample size and sampling type to apply to the data. If this parameter isn't specified, then the sample consists of the first 500 rows from the dataset.\n")
    ...
    resource_config: typing.Optional[models.aws_databrew.CfnProjectDefConfig] = pydantic.Field(None)


class CfnProjectDefConfig(pydantic.BaseModel):
    SampleProperty: typing.Optional[list[models.aws_databrew.CfnProjectDefSamplepropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_databrew.CfnProjectDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_databrew.CfnProjectDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_databrew.CfnProjectDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_databrew.CfnProjectDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_databrew.CfnProjectDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_databrew.CfnProjectDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_databrew.CfnProjectDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_databrew.CfnProjectDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_databrew.CfnProjectDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_databrew.CfnProjectDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_databrew.CfnProjectDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_databrew.CfnProjectDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_databrew.CfnProjectDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
    tags_config: typing.Optional[models.core.TagManagerDefConfig] = pydantic.Field(None)
...
class CfnRecipeDef(BaseCfnResource):
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The unique name for the recipe.\n')
    steps: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_databrew.CfnRecipe_RecipeStepPropertyDef, dict[str, typing.Any]]]] = pydantic.Field(REQUIRED_INIT_PARAM, description='A list of steps that are defined by the recipe.\n')
    ...
    resource_config: typing.Optional[models.aws_databrew.CfnRecipeDefConfig] = pydantic.Field(None)


class CfnRecipeDefConfig(pydantic.BaseModel):
    ActionProperty: typing.Optional[list[models.aws_databrew.CfnRecipeDefActionpropertyParams]] = pydantic.Field(None, description='')
    ConditionExpressionProperty: typing.Optional[list[models.aws_databrew.CfnRecipeDefConditionexpressionpropertyParams]] = pydantic.Field(None, description='')
    DataCatalogInputDefinitionProperty: typing.Optional[list[models.aws_databrew.CfnRecipeDefDatacataloginputdefinitionpropertyParams]] = pydantic.Field(None, description='')
    InputProperty: typing.Optional[list[models.aws_databrew.CfnRecipeDefInputpropertyParams]] = pydantic.Field(None, description='')
    RecipeParametersProperty: typing.Optional[list[models.aws_databrew.CfnRecipeDefRecipeparameterspropertyParams]] = pydantic.Field(None, description='')
    RecipeStepProperty: typing.Optional[list[models.aws_databrew.CfnRecipeDefRecipesteppropertyParams]] = pydantic.Field(None, description='')
    S3LocationProperty: typing.Optional[list[models.aws_databrew.CfnRecipeDefS3LocationpropertyParams]] = pydantic.Field(None, description='')
    SecondaryInputProperty: typing.Optional[list[models.aws_databrew.CfnRecipeDefSecondaryinputpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_databrew.CfnRecipeDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_databrew.CfnRecipeDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_databrew.CfnRecipeDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_databrew.CfnRecipeDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_databrew.CfnRecipeDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_databrew.CfnRecipeDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_databrew.CfnRecipeDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_databrew.CfnRecipeDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_databrew.CfnRecipeDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_databrew.CfnRecipeDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_databrew.CfnRecipeDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_databrew.CfnRecipeDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_databrew.CfnRecipeDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
    tags_config: typing.Optional[models.core.TagManagerDefConfig] = pydantic.Field(None)
...
class CfnRecipeDefDatacataloginputdefinitionpropertyParams(pydantic.BaseModel):
    ...
    database_name: typing.Optional[str] = pydantic.Field(None, description='')
    table_name: typing.Optional[str] = pydantic.Field(None, description='')
    temp_directory: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnRecipe_S3LocationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...

class CfnRecipeDefInputpropertyParams(pydantic.BaseModel):
    data_catalog_input_definition: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnRecipe_DataCatalogInputDefinitionPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    s3_input_definition: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnRecipe_S3LocationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnRecipeDefRecipeparameterspropertyParams(pydantic.BaseModel):
    ...
    secondary_inputs: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_databrew.CfnRecipe_SecondaryInputPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
...
class CfnRecipeDefRecipesteppropertyParams(pydantic.BaseModel):
    action: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnRecipe_ActionPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    condition_expressions: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_databrew.CfnRecipe_ConditionExpressionPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    ...
...
class CfnRulesetDef(BaseCfnResource):
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the ruleset.\n')
    rules: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_databrew.CfnRuleset_RulePropertyDef, dict[str, typing.Any]]]] = pydantic.Field(REQUIRED_INIT_PARAM, description='Contains metadata about the ruleset.\n')
    target_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Amazon Resource Name (ARN) of a resource (dataset) that the ruleset is associated with.\n')
    ...
    resource_config: typing.Optional[models.aws_databrew.CfnRulesetDefConfig] = pydantic.Field(None)


class CfnRulesetDefConfig(pydantic.BaseModel):
    ColumnSelectorProperty: typing.Optional[list[models.aws_databrew.CfnRulesetDefColumnselectorpropertyParams]] = pydantic.Field(None, description='')
    RuleProperty: typing.Optional[list[models.aws_databrew.CfnRulesetDefRulepropertyParams]] = pydantic.Field(None, description='')
    SubstitutionValueProperty: typing.Optional[list[models.aws_databrew.CfnRulesetDefSubstitutionvaluepropertyParams]] = pydantic.Field(None, description='')
    ThresholdProperty: typing.Optional[list[models.aws_databrew.CfnRulesetDefThresholdpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_databrew.CfnRulesetDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_databrew.CfnRulesetDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_databrew.CfnRulesetDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_databrew.CfnRulesetDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_databrew.CfnRulesetDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_databrew.CfnRulesetDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_databrew.CfnRulesetDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_databrew.CfnRulesetDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_databrew.CfnRulesetDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_databrew.CfnRulesetDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_databrew.CfnRulesetDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_databrew.CfnRulesetDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_databrew.CfnRulesetDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
    tags_config: typing.Optional[models.core.TagManagerDefConfig] = pydantic.Field(None)
...
class CfnRulesetDefRulepropertyParams(pydantic.BaseModel):
    ...
    name: str = pydantic.Field(..., description='')
    column_selectors: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_databrew.CfnRuleset_ColumnSelectorPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    disabled: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
    substitution_map: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_databrew.CfnRuleset_SubstitutionValuePropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    threshold: typing.Union[models.UnsupportedResource, models.aws_databrew.CfnRuleset_ThresholdPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnScheduleDef(BaseCfnResource):
    cron_expression: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The dates and times when the job is to run. For more information, see `Working with cron expressions for recipe jobs <https://docs.aws.amazon.com/databrew/latest/dg/jobs.recipe.html#jobs.cron>`_ in the *AWS Glue DataBrew Developer Guide* .\n')
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the schedule.\n')
    ...
    resource_config: typing.Optional[models.aws_databrew.CfnScheduleDefConfig] = pydantic.Field(None)


class CfnScheduleDefConfig(pydantic.BaseModel):
    add_deletion_override: typing.Optional[list[models.aws_databrew.CfnScheduleDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_databrew.CfnScheduleDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_databrew.CfnScheduleDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_databrew.CfnScheduleDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_databrew.CfnScheduleDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_databrew.CfnScheduleDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_databrew.CfnScheduleDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_databrew.CfnScheduleDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_databrew.CfnScheduleDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_databrew.CfnScheduleDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_databrew.CfnScheduleDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_databrew.CfnScheduleDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_databrew.CfnScheduleDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
    tags_config: typing.Optional[models.core.TagManagerDefConfig] = pydantic.Field(None)
...
class ModuleModel(pydantic.BaseModel):
    CfnDataset_CsvOptionsProperty: typing.Optional[dict[str, models.aws_databrew.CfnDataset_CsvOptionsPropertyDef]] = pydantic.Field(None)
    CfnDataset_DatabaseInputDefinitionProperty: typing.Optional[dict[str, models.aws_databrew.CfnDataset_DatabaseInputDefinitionPropertyDef]] = pydantic.Field(None)
    CfnDataset_DataCatalogInputDefinitionProperty: typing.Optional[dict[str, models.aws_databrew.CfnDataset_DataCatalogInputDefinitionPropertyDef]] = pydantic.Field(None)
    CfnDataset_DatasetParameterProperty: typing.Optional[dict[str, models.aws_databrew.CfnDataset_DatasetParameterPropertyDef]] = pydantic.Field(None)
    CfnDataset_DatetimeOptionsProperty: typing.Optional[dict[str, models.aws_databrew.CfnDataset_DatetimeOptionsPropertyDef]] = pydantic.Field(None)
    CfnDataset_ExcelOptionsProperty: typing.Optional[dict[str, models.aws_databrew.CfnDataset_ExcelOptionsPropertyDef]] = pydantic.Field(None)
    CfnDataset_FilesLimitProperty: typing.Optional[dict[str, models.aws_databrew.CfnDataset_FilesLimitPropertyDef]] = pydantic.Field(None)
    CfnDataset_FilterExpressionProperty: typing.Optional[dict[str, models.aws_databrew.CfnDataset_FilterExpressionPropertyDef]] = pydantic.Field(None)
    CfnDataset_FilterValueProperty: typing.Optional[dict[str, models.aws_databrew.CfnDataset_FilterValuePropertyDef]] = pydantic.Field(None)
    CfnDataset_FormatOptionsProperty: typing.Optional[dict[str, models.aws_databrew.CfnDataset_FormatOptionsPropertyDef]] = pydantic.Field(None)
    CfnDataset_InputProperty: typing.Optional[dict[str, models.aws_databrew.CfnDataset_InputPropertyDef]] = pydantic.Field(None)
    CfnDataset_JsonOptionsProperty: typing.Optional[dict[str, models.aws_databrew.CfnDataset_JsonOptionsPropertyDef]] = pydantic.Field(None)
    CfnDataset_MetadataProperty: typing.Optional[dict[str, models.aws_databrew.CfnDataset_MetadataPropertyDef]] = pydantic.Field(None)
    CfnDataset_PathOptionsProperty: typing.Optional[dict[str, models.aws_databrew.CfnDataset_PathOptionsPropertyDef]] = pydantic.Field(None)
    CfnDataset_PathParameterProperty: typing.Optional[dict[str, models.aws_databrew.CfnDataset_PathParameterPropertyDef]] = pydantic.Field(None)
    CfnDataset_S3LocationProperty: typing.Optional[dict[str, models.aws_databrew.CfnDataset_S3LocationPropertyDef]] = pydantic.Field(None)
    CfnJob_AllowedStatisticsProperty: typing.Optional[dict[str, models.aws_databrew.CfnJob_AllowedStatisticsPropertyDef]] = pydantic.Field(None)
    CfnJob_ColumnSelectorProperty: typing.Optional[dict[str, models.aws_databrew.CfnJob_ColumnSelectorPropertyDef]] = pydantic.Field(None)
    CfnJob_ColumnStatisticsConfigurationProperty: typing.Optional[dict[str, models.aws_databrew.CfnJob_ColumnStatisticsConfigurationPropertyDef]] = pydantic.Field(None)
    CfnJob_CsvOutputOptionsProperty: typing.Optional[dict[str, models.aws_databrew.CfnJob_CsvOutputOptionsPropertyDef]] = pydantic.Field(None)
    CfnJob_DatabaseOutputProperty: typing.Optional[dict[str, models.aws_databrew.CfnJob_DatabaseOutputPropertyDef]] = pydantic.Field(None)
    CfnJob_DatabaseTableOutputOptionsProperty: typing.Optional[dict[str, models.aws_databrew.CfnJob_DatabaseTableOutputOptionsPropertyDef]] = pydantic.Field(None)
    CfnJob_DataCatalogOutputProperty: typing.Optional[dict[str, models.aws_databrew.CfnJob_DataCatalogOutputPropertyDef]] = pydantic.Field(None)
    CfnJob_EntityDetectorConfigurationProperty: typing.Optional[dict[str, models.aws_databrew.CfnJob_EntityDetectorConfigurationPropertyDef]] = pydantic.Field(None)
    CfnJob_JobSampleProperty: typing.Optional[dict[str, models.aws_databrew.CfnJob_JobSamplePropertyDef]] = pydantic.Field(None)
    CfnJob_OutputFormatOptionsProperty: typing.Optional[dict[str, models.aws_databrew.CfnJob_OutputFormatOptionsPropertyDef]] = pydantic.Field(None)
    CfnJob_OutputLocationProperty: typing.Optional[dict[str, models.aws_databrew.CfnJob_OutputLocationPropertyDef]] = pydantic.Field(None)
    CfnJob_OutputProperty: typing.Optional[dict[str, models.aws_databrew.CfnJob_OutputPropertyDef]] = pydantic.Field(None)
    CfnJob_ProfileConfigurationProperty: typing.Optional[dict[str, models.aws_databrew.CfnJob_ProfileConfigurationPropertyDef]] = pydantic.Field(None)
    CfnJob_RecipeProperty: typing.Optional[dict[str, models.aws_databrew.CfnJob_RecipePropertyDef]] = pydantic.Field(None)
    CfnJob_S3LocationProperty: typing.Optional[dict[str, models.aws_databrew.CfnJob_S3LocationPropertyDef]] = pydantic.Field(None)
    CfnJob_S3TableOutputOptionsProperty: typing.Optional[dict[str, models.aws_databrew.CfnJob_S3TableOutputOptionsPropertyDef]] = pydantic.Field(None)
    CfnJob_StatisticOverrideProperty: typing.Optional[dict[str, models.aws_databrew.CfnJob_StatisticOverridePropertyDef]] = pydantic.Field(None)
    CfnJob_StatisticsConfigurationProperty: typing.Optional[dict[str, models.aws_databrew.CfnJob_StatisticsConfigurationPropertyDef]] = pydantic.Field(None)
    CfnJob_ValidationConfigurationProperty: typing.Optional[dict[str, models.aws_databrew.CfnJob_ValidationConfigurationPropertyDef]] = pydantic.Field(None)
    CfnProject_SampleProperty: typing.Optional[dict[str, models.aws_databrew.CfnProject_SamplePropertyDef]] = pydantic.Field(None)
    CfnRecipe_ActionProperty: typing.Optional[dict[str, models.aws_databrew.CfnRecipe_ActionPropertyDef]] = pydantic.Field(None)
    CfnRecipe_ConditionExpressionProperty: typing.Optional[dict[str, models.aws_databrew.CfnRecipe_ConditionExpressionPropertyDef]] = pydantic.Field(None)
    CfnRecipe_DataCatalogInputDefinitionProperty: typing.Optional[dict[str, models.aws_databrew.CfnRecipe_DataCatalogInputDefinitionPropertyDef]] = pydantic.Field(None)
    CfnRecipe_InputProperty: typing.Optional[dict[str, models.aws_databrew.CfnRecipe_InputPropertyDef]] = pydantic.Field(None)
    CfnRecipe_RecipeParametersProperty: typing.Optional[dict[str, models.aws_databrew.CfnRecipe_RecipeParametersPropertyDef]] = pydantic.Field(None)
    CfnRecipe_RecipeStepProperty: typing.Optional[dict[str, models.aws_databrew.CfnRecipe_RecipeStepPropertyDef]] = pydantic.Field(None)
    CfnRecipe_S3LocationProperty: typing.Optional[dict[str, models.aws_databrew.CfnRecipe_S3LocationPropertyDef]] = pydantic.Field(None)
    CfnRecipe_SecondaryInputProperty: typing.Optional[dict[str, models.aws_databrew.CfnRecipe_SecondaryInputPropertyDef]] = pydantic.Field(None)
    CfnRuleset_ColumnSelectorProperty: typing.Optional[dict[str, models.aws_databrew.CfnRuleset_ColumnSelectorPropertyDef]] = pydantic.Field(None)
    CfnRuleset_RuleProperty: typing.Optional[dict[str, models.aws_databrew.CfnRuleset_RulePropertyDef]] = pydantic.Field(None)
    CfnRuleset_SubstitutionValueProperty: typing.Optional[dict[str, models.aws_databrew.CfnRuleset_SubstitutionValuePropertyDef]] = pydantic.Field(None)
    CfnRuleset_ThresholdProperty: typing.Optional[dict[str, models.aws_databrew.CfnRuleset_ThresholdPropertyDef]] = pydantic.Field(None)
    CfnDataset: typing.Optional[dict[str, models.aws_databrew.CfnDatasetDef]] = pydantic.Field(None)
    CfnJob: typing.Optional[dict[str, models.aws_databrew.CfnJobDef]] = pydantic.Field(None)
    CfnProject: typing.Optional[dict[str, models.aws_databrew.CfnProjectDef]] = pydantic.Field(None)
    CfnRecipe: typing.Optional[dict[str, models.aws_databrew.CfnRecipeDef]] = pydantic.Field(None)
    CfnRuleset: typing.Optional[dict[str, models.aws_databrew.CfnRulesetDef]] = pydantic.Field(None)
    CfnSchedule: typing.Optional[dict[str, models.aws_databrew.CfnScheduleDef]] = pydantic.Field(None)
    CfnDatasetProps: typing.Optional[dict[str, models.aws_databrew.CfnDatasetPropsDef]] = pydantic.Field(None)
    CfnJobProps: typing.Optional[dict[str, models.aws_databrew.CfnJobPropsDef]] = pydantic.Field(None)
    CfnProjectProps: typing.Optional[dict[str, models.aws_databrew.CfnProjectPropsDef]] = pydantic.Field(None)
    CfnRecipeProps: typing.Optional[dict[str, models.aws_databrew.CfnRecipePropsDef]] = pydantic.Field(None)
    CfnRulesetProps: typing.Optional[dict[str, models.aws_databrew.CfnRulesetPropsDef]] = pydantic.Field(None)
    CfnScheduleProps: typing.Optional[dict[str, models.aws_databrew.CfnSchedulePropsDef]] = pydantic.Field(None)
    ...
