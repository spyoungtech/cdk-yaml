...
class CfnStream_StreamModeDetailsPropertyDef(BaseStruct):
    stream_mode: str = pydantic.Field(..., description='Specifies the capacity mode to which you want to set your data stream. Currently, in Kinesis Data Streams, you can choose between an *on-demand* capacity mode and a *provisioned* capacity mode for your data streams.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kinesis-stream-streammodedetails.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_kinesis as kinesis\n\n    stream_mode_details_property = kinesis.CfnStream.StreamModeDetailsProperty(\n        stream_mode="streamMode"\n    )\n')
...
class CfnStreamDef(BaseCfnResource):
    ...
    stream_encryption: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesis.CfnStream_StreamEncryptionPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='When specified, enables or updates server-side encryption using an AWS KMS key for a specified stream. Removing this property from your stack template and updating your stack disables encryption.\n')
...
class CfnStreamConsumerDef(BaseCfnResource):
    consumer_name: str = pydantic.Field(..., description='The name of the consumer is something you choose when you register the consumer.\n')
    stream_arn: str = pydantic.Field(..., description='The ARN of the stream with which you registered the consumer.')
