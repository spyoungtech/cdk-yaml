...
class AwsCliLayerDef(BaseClass):
    ...
    from_layer_version_arn: typing.Optional[models.lambda_layer_awscli.AwsCliLayerDefFromLayerVersionArnParams] = pydantic.Field(None, description='Imports a layer version by ARN.\nAssumes it is compatible with all Lambda runtimes.')
    from_layer_version_attributes: typing.Optional[models.lambda_layer_awscli.AwsCliLayerDefFromLayerVersionAttributesParams] = pydantic.Field(None, description='Imports a Layer that has been defined externally.')
    resource_config: typing.Optional[models.lambda_layer_awscli.AwsCliLayerDefConfig] = pydantic.Field(None)


class AwsCliLayerDefConfig(pydantic.BaseModel):
    add_permission: typing.Optional[list[models.lambda_layer_awscli.AwsCliLayerDefAddPermissionParams]] = pydantic.Field(None, description='Add permission for this layer version to specific entities.\nUsage within\nthe same account where the layer is defined is always allowed and does not\nrequire calling this method. Note that the principal that creates the\nLambda function using the layer (for example, a CloudFormation changeset\nexecution role) also needs to have the ``lambda:GetLayerVersion``\npermission on the layer version.')
...
class ModuleModel(pydantic.BaseModel):
    AwsCliLayer: typing.Optional[dict[str, models.lambda_layer_awscli.AwsCliLayerDef]] = pydantic.Field(None)
    ...
