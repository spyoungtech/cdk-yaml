...
class CfnDefaultViewAssociationDef(BaseCfnResource):
    view_arn: str = pydantic.Field(..., description='The ARN of the view to set as the default for the AWS Region and AWS account in which you call this operation. The specified view must already exist in the specified Region.')
