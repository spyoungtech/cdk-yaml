...
class CfnEndpointDefConfig(pydantic.BaseModel):
    FailedReasonProperty: typing.Optional[list[CfnEndpointDefFailedreasonpropertyParams]] = pydantic.Field(None, description='')
...
class ModuleModel(pydantic.BaseModel):
    ...
    CfnEndpoint_FailedReasonProperty: typing.Optional[dict[str, CfnEndpoint_FailedReasonPropertyDef]] = pydantic.Field(None)
