...
class CfnDeliveryStreamDef(BaseCfnResource):
    ...
    resource_config: typing.Optional[CfnDeliveryStreamDefConfig] = pydantic.Field(None)


class CfnDeliveryStreamDefConfig(pydantic.BaseModel):
    AmazonOpenSearchServerlessBufferingHintsProperty: typing.Optional[list[CfnDeliveryStreamDefAmazonopensearchserverlessbufferinghintspropertyParams]] = pydantic.Field(None, description='')
    AmazonOpenSearchServerlessDestinationConfigurationProperty: typing.Optional[list[CfnDeliveryStreamDefAmazonopensearchserverlessdestinationconfigurationpropertyParams]] = pydantic.Field(None, description='')
    AmazonOpenSearchServerlessRetryOptionsProperty: typing.Optional[list[CfnDeliveryStreamDefAmazonopensearchserverlessretryoptionspropertyParams]] = pydantic.Field(None, description='')
    AmazonopensearchserviceBufferingHintsProperty: typing.Optional[list[CfnDeliveryStreamDefAmazonopensearchservicebufferinghintspropertyParams]] = pydantic.Field(None, description='')
    AmazonopensearchserviceDestinationConfigurationProperty: typing.Optional[list[CfnDeliveryStreamDefAmazonopensearchservicedestinationconfigurationpropertyParams]] = pydantic.Field(None, description='')
    AmazonopensearchserviceRetryOptionsProperty: typing.Optional[list[CfnDeliveryStreamDefAmazonopensearchserviceretryoptionspropertyParams]] = pydantic.Field(None, description='')
    AuthenticationConfigurationProperty: typing.Optional[list[CfnDeliveryStreamDefAuthenticationconfigurationpropertyParams]] = pydantic.Field(None, description='')
    BufferingHintsProperty: typing.Optional[list[CfnDeliveryStreamDefBufferinghintspropertyParams]] = pydantic.Field(None, description='')
    CloudWatchLoggingOptionsProperty: typing.Optional[list[CfnDeliveryStreamDefCloudwatchloggingoptionspropertyParams]] = pydantic.Field(None, description='')
    CopyCommandProperty: typing.Optional[list[CfnDeliveryStreamDefCopycommandpropertyParams]] = pydantic.Field(None, description='')
    DataFormatConversionConfigurationProperty: typing.Optional[list[CfnDeliveryStreamDefDataformatconversionconfigurationpropertyParams]] = pydantic.Field(None, description='')
    DeliveryStreamEncryptionConfigurationInputProperty: typing.Optional[list[CfnDeliveryStreamDefDeliverystreamencryptionconfigurationinputpropertyParams]] = pydantic.Field(None, description='')
    DeserializerProperty: typing.Optional[list[CfnDeliveryStreamDefDeserializerpropertyParams]] = pydantic.Field(None, description='')
    DocumentIdOptionsProperty: typing.Optional[list[CfnDeliveryStreamDefDocumentidoptionspropertyParams]] = pydantic.Field(None, description='')
    DynamicPartitioningConfigurationProperty: typing.Optional[list[CfnDeliveryStreamDefDynamicpartitioningconfigurationpropertyParams]] = pydantic.Field(None, description='')
    ElasticsearchBufferingHintsProperty: typing.Optional[list[CfnDeliveryStreamDefElasticsearchbufferinghintspropertyParams]] = pydantic.Field(None, description='')
    ElasticsearchDestinationConfigurationProperty: typing.Optional[list[CfnDeliveryStreamDefElasticsearchdestinationconfigurationpropertyParams]] = pydantic.Field(None, description='')
    ElasticsearchRetryOptionsProperty: typing.Optional[list[CfnDeliveryStreamDefElasticsearchretryoptionspropertyParams]] = pydantic.Field(None, description='')
    EncryptionConfigurationProperty: typing.Optional[list[CfnDeliveryStreamDefEncryptionconfigurationpropertyParams]] = pydantic.Field(None, description='')
    ExtendedS3DestinationConfigurationProperty: typing.Optional[list[CfnDeliveryStreamDefExtendeds3DestinationconfigurationpropertyParams]] = pydantic.Field(None, description='')
    HiveJsonSerDeProperty: typing.Optional[list[CfnDeliveryStreamDefHivejsonserdepropertyParams]] = pydantic.Field(None, description='')
    HttpEndpointCommonAttributeProperty: typing.Optional[list[CfnDeliveryStreamDefHttpendpointcommonattributepropertyParams]] = pydantic.Field(None, description='')
    HttpEndpointConfigurationProperty: typing.Optional[list[CfnDeliveryStreamDefHttpendpointconfigurationpropertyParams]] = pydantic.Field(None, description='')
    HttpEndpointDestinationConfigurationProperty: typing.Optional[list[CfnDeliveryStreamDefHttpendpointdestinationconfigurationpropertyParams]] = pydantic.Field(None, description='')
    HttpEndpointRequestConfigurationProperty: typing.Optional[list[CfnDeliveryStreamDefHttpendpointrequestconfigurationpropertyParams]] = pydantic.Field(None, description='')
    InputFormatConfigurationProperty: typing.Optional[list[CfnDeliveryStreamDefInputformatconfigurationpropertyParams]] = pydantic.Field(None, description='')
    KMSEncryptionConfigProperty: typing.Optional[list[CfnDeliveryStreamDefKmsencryptionconfigpropertyParams]] = pydantic.Field(None, description='')
    KinesisStreamSourceConfigurationProperty: typing.Optional[list[CfnDeliveryStreamDefKinesisstreamsourceconfigurationpropertyParams]] = pydantic.Field(None, description='')
    MSKSourceConfigurationProperty: typing.Optional[list[CfnDeliveryStreamDefMsksourceconfigurationpropertyParams]] = pydantic.Field(None, description='')
    OpenXJsonSerDeProperty: typing.Optional[list[CfnDeliveryStreamDefOpenxjsonserdepropertyParams]] = pydantic.Field(None, description='')
    OrcSerDeProperty: typing.Optional[list[CfnDeliveryStreamDefOrcserdepropertyParams]] = pydantic.Field(None, description='')
    OutputFormatConfigurationProperty: typing.Optional[list[CfnDeliveryStreamDefOutputformatconfigurationpropertyParams]] = pydantic.Field(None, description='')
    ParquetSerDeProperty: typing.Optional[list[CfnDeliveryStreamDefParquetserdepropertyParams]] = pydantic.Field(None, description='')
    ProcessingConfigurationProperty: typing.Optional[list[CfnDeliveryStreamDefProcessingconfigurationpropertyParams]] = pydantic.Field(None, description='')
    ProcessorParameterProperty: typing.Optional[list[CfnDeliveryStreamDefProcessorparameterpropertyParams]] = pydantic.Field(None, description='')
    ProcessorProperty: typing.Optional[list[CfnDeliveryStreamDefProcessorpropertyParams]] = pydantic.Field(None, description='')
    RedshiftDestinationConfigurationProperty: typing.Optional[list[CfnDeliveryStreamDefRedshiftdestinationconfigurationpropertyParams]] = pydantic.Field(None, description='')
    RedshiftRetryOptionsProperty: typing.Optional[list[CfnDeliveryStreamDefRedshiftretryoptionspropertyParams]] = pydantic.Field(None, description='')
    RetryOptionsProperty: typing.Optional[list[CfnDeliveryStreamDefRetryoptionspropertyParams]] = pydantic.Field(None, description='')
    S3DestinationConfigurationProperty: typing.Optional[list[CfnDeliveryStreamDefS3DestinationconfigurationpropertyParams]] = pydantic.Field(None, description='')
    SchemaConfigurationProperty: typing.Optional[list[CfnDeliveryStreamDefSchemaconfigurationpropertyParams]] = pydantic.Field(None, description='')
    SerializerProperty: typing.Optional[list[CfnDeliveryStreamDefSerializerpropertyParams]] = pydantic.Field(None, description='')
    SplunkDestinationConfigurationProperty: typing.Optional[list[CfnDeliveryStreamDefSplunkdestinationconfigurationpropertyParams]] = pydantic.Field(None, description='')
    SplunkRetryOptionsProperty: typing.Optional[list[CfnDeliveryStreamDefSplunkretryoptionspropertyParams]] = pydantic.Field(None, description='')
    VpcConfigurationProperty: typing.Optional[list[CfnDeliveryStreamDefVpcconfigurationpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[CfnDeliveryStreamDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[CfnDeliveryStreamDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[CfnDeliveryStreamDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[CfnDeliveryStreamDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[CfnDeliveryStreamDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[CfnDeliveryStreamDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[CfnDeliveryStreamDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[CfnDeliveryStreamDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[CfnDeliveryStreamDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[CfnDeliveryStreamDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[CfnDeliveryStreamDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[CfnDeliveryStreamDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[CfnDeliveryStreamDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
class ModuleModel(pydantic.BaseModel):
    CfnDeliveryStream_AmazonOpenSearchServerlessBufferingHintsProperty: typing.Optional[dict[str, CfnDeliveryStream_AmazonOpenSearchServerlessBufferingHintsPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_AmazonOpenSearchServerlessDestinationConfigurationProperty: typing.Optional[dict[str, CfnDeliveryStream_AmazonOpenSearchServerlessDestinationConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_AmazonOpenSearchServerlessRetryOptionsProperty: typing.Optional[dict[str, CfnDeliveryStream_AmazonOpenSearchServerlessRetryOptionsPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_AmazonopensearchserviceBufferingHintsProperty: typing.Optional[dict[str, CfnDeliveryStream_AmazonopensearchserviceBufferingHintsPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_AmazonopensearchserviceDestinationConfigurationProperty: typing.Optional[dict[str, CfnDeliveryStream_AmazonopensearchserviceDestinationConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_AmazonopensearchserviceRetryOptionsProperty: typing.Optional[dict[str, CfnDeliveryStream_AmazonopensearchserviceRetryOptionsPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_AuthenticationConfigurationProperty: typing.Optional[dict[str, CfnDeliveryStream_AuthenticationConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_BufferingHintsProperty: typing.Optional[dict[str, CfnDeliveryStream_BufferingHintsPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_CloudWatchLoggingOptionsProperty: typing.Optional[dict[str, CfnDeliveryStream_CloudWatchLoggingOptionsPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_CopyCommandProperty: typing.Optional[dict[str, CfnDeliveryStream_CopyCommandPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_DataFormatConversionConfigurationProperty: typing.Optional[dict[str, CfnDeliveryStream_DataFormatConversionConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_DeliveryStreamEncryptionConfigurationInputProperty: typing.Optional[dict[str, CfnDeliveryStream_DeliveryStreamEncryptionConfigurationInputPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_DeserializerProperty: typing.Optional[dict[str, CfnDeliveryStream_DeserializerPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_DocumentIdOptionsProperty: typing.Optional[dict[str, CfnDeliveryStream_DocumentIdOptionsPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_DynamicPartitioningConfigurationProperty: typing.Optional[dict[str, CfnDeliveryStream_DynamicPartitioningConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_ElasticsearchBufferingHintsProperty: typing.Optional[dict[str, CfnDeliveryStream_ElasticsearchBufferingHintsPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_ElasticsearchDestinationConfigurationProperty: typing.Optional[dict[str, CfnDeliveryStream_ElasticsearchDestinationConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_ElasticsearchRetryOptionsProperty: typing.Optional[dict[str, CfnDeliveryStream_ElasticsearchRetryOptionsPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_EncryptionConfigurationProperty: typing.Optional[dict[str, CfnDeliveryStream_EncryptionConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_ExtendedS3DestinationConfigurationProperty: typing.Optional[dict[str, CfnDeliveryStream_ExtendedS3DestinationConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_HiveJsonSerDeProperty: typing.Optional[dict[str, CfnDeliveryStream_HiveJsonSerDePropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_HttpEndpointCommonAttributeProperty: typing.Optional[dict[str, CfnDeliveryStream_HttpEndpointCommonAttributePropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_HttpEndpointConfigurationProperty: typing.Optional[dict[str, CfnDeliveryStream_HttpEndpointConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_HttpEndpointDestinationConfigurationProperty: typing.Optional[dict[str, CfnDeliveryStream_HttpEndpointDestinationConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_HttpEndpointRequestConfigurationProperty: typing.Optional[dict[str, CfnDeliveryStream_HttpEndpointRequestConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_InputFormatConfigurationProperty: typing.Optional[dict[str, CfnDeliveryStream_InputFormatConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_KinesisStreamSourceConfigurationProperty: typing.Optional[dict[str, CfnDeliveryStream_KinesisStreamSourceConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_KMSEncryptionConfigProperty: typing.Optional[dict[str, CfnDeliveryStream_KMSEncryptionConfigPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_MSKSourceConfigurationProperty: typing.Optional[dict[str, CfnDeliveryStream_MSKSourceConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_OpenXJsonSerDeProperty: typing.Optional[dict[str, CfnDeliveryStream_OpenXJsonSerDePropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_OrcSerDeProperty: typing.Optional[dict[str, CfnDeliveryStream_OrcSerDePropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_OutputFormatConfigurationProperty: typing.Optional[dict[str, CfnDeliveryStream_OutputFormatConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_ParquetSerDeProperty: typing.Optional[dict[str, CfnDeliveryStream_ParquetSerDePropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_ProcessingConfigurationProperty: typing.Optional[dict[str, CfnDeliveryStream_ProcessingConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_ProcessorParameterProperty: typing.Optional[dict[str, CfnDeliveryStream_ProcessorParameterPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_ProcessorProperty: typing.Optional[dict[str, CfnDeliveryStream_ProcessorPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_RedshiftDestinationConfigurationProperty: typing.Optional[dict[str, CfnDeliveryStream_RedshiftDestinationConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_RedshiftRetryOptionsProperty: typing.Optional[dict[str, CfnDeliveryStream_RedshiftRetryOptionsPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_RetryOptionsProperty: typing.Optional[dict[str, CfnDeliveryStream_RetryOptionsPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_S3DestinationConfigurationProperty: typing.Optional[dict[str, CfnDeliveryStream_S3DestinationConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_SchemaConfigurationProperty: typing.Optional[dict[str, CfnDeliveryStream_SchemaConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_SerializerProperty: typing.Optional[dict[str, CfnDeliveryStream_SerializerPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_SplunkDestinationConfigurationProperty: typing.Optional[dict[str, CfnDeliveryStream_SplunkDestinationConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_SplunkRetryOptionsProperty: typing.Optional[dict[str, CfnDeliveryStream_SplunkRetryOptionsPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_VpcConfigurationProperty: typing.Optional[dict[str, CfnDeliveryStream_VpcConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream: typing.Optional[dict[str, CfnDeliveryStreamDef]] = pydantic.Field(None)
    CfnDeliveryStreamProps: typing.Optional[dict[str, CfnDeliveryStreamPropsDef]] = pydantic.Field(None)
    ...
