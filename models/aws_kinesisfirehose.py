...
class CfnDeliveryStream_AmazonOpenSearchServerlessDestinationConfigurationPropertyDef(BaseStruct):
    ...
    role_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Amazon Resource Name (ARN) of the IAM role to be assumed by Firehose for calling the Serverless offering for Amazon OpenSearch Service Configuration API and for indexing documents.\n')
    ...
    retry_options: typing.Union[models.UnsupportedResource, models.aws_kinesisfirehose.CfnDeliveryStream_AmazonOpenSearchServerlessRetryOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The retry behavior in case Firehose is unable to deliver documents to the Serverless offering for Amazon OpenSearch Service. The default value is 300 (5 minutes).\n')
    s3_backup_mode: typing.Optional[str] = pydantic.Field(None, description='Defines how documents should be delivered to Amazon S3. When it is set to FailedDocumentsOnly, Firehose writes any documents that could not be indexed to the configured Amazon S3 destination, with AmazonOpenSearchService-failed/ appended to the key prefix. When set to AllDocuments, Firehose delivers all incoming records to Amazon S3, and also writes failed documents with AmazonOpenSearchService-failed/ appended to the prefix.\n')
...
class CfnDeliveryStream_DataFormatConversionConfigurationPropertyDef(BaseStruct):
    ...
    input_format_configuration: typing.Union[models.UnsupportedResource, models.aws_kinesisfirehose.CfnDeliveryStream_InputFormatConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Specifies the deserializer that you want Firehose to use to convert the format of your data from JSON. This parameter is required if ``Enabled`` is set to true.\n')
    output_format_configuration: typing.Union[models.UnsupportedResource, models.aws_kinesisfirehose.CfnDeliveryStream_OutputFormatConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Specifies the serializer that you want Firehose to use to convert the format of your data to the Parquet or ORC format. This parameter is required if ``Enabled`` is set to true.\n')
...
class CfnDeliveryStream_DeserializerPropertyDef(BaseStruct):
    hive_json_ser_de: typing.Union[models.UnsupportedResource, models.aws_kinesisfirehose.CfnDeliveryStream_HiveJsonSerDePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The native Hive / HCatalog JsonSerDe. Used by Firehose for deserializing data, which means converting it from the JSON format in preparation for serializing it to the Parquet or ORC format. This is one of two deserializers you can choose, depending on which one offers the functionality you need. The other option is the OpenX SerDe.\n')
    open_x_json_ser_de: typing.Union[models.UnsupportedResource, models.aws_kinesisfirehose.CfnDeliveryStream_OpenXJsonSerDePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The OpenX SerDe. Used by Firehose for deserializing data, which means converting it from the JSON format in preparation for serializing it to the Parquet or ORC format. This is one of two deserializers you can choose, depending on which one offers the functionality you need. The other option is the native Hive / HCatalog JsonSerDe.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kinesisfirehose-deliverystream-deserializer.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_kinesisfirehose as kinesisfirehose\n\n    deserializer_property = kinesisfirehose.CfnDeliveryStream.DeserializerProperty(\n        hive_json_ser_de=kinesisfirehose.CfnDeliveryStream.HiveJsonSerDeProperty(\n            timestamp_formats=["timestampFormats"]\n        ),\n        open_xJson_ser_de=kinesisfirehose.CfnDeliveryStream.OpenXJsonSerDeProperty(\n            case_insensitive=False,\n            column_to_json_key_mappings={\n                "column_to_json_key_mappings_key": "columnToJsonKeyMappings"\n            },\n            convert_dots_in_json_keys_to_underscores=False\n        )\n    )\n')
...
class CfnDeliveryStream_ExtendedS3DestinationConfigurationPropertyDef(BaseStruct):
    ...
    custom_time_zone: typing.Optional[str] = pydantic.Field(None, description='The time zone you prefer. UTC is the default.\n')
    ...
    file_extension: typing.Optional[str] = pydantic.Field(None, description='Specify a file extension. It will override the default file extension\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['bucket_arn', 'role_arn', 'buffering_hints', 'cloud_watch_logging_options', 'compression_format', 'custom_time_zone', 'data_format_conversion_configuration', 'dynamic_partitioning_configuration', 'encryption_configuration', 'error_output_prefix', 'file_extension', 'prefix', 'processing_configuration', 's3_backup_configuration', 's3_backup_mode']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnDeliveryStream_OpenXJsonSerDePropertyDef(BaseStruct):
    case_insensitive: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='When set to ``true`` , which is the default, Firehose converts JSON keys to lowercase before deserializing them.\n')
...
class CfnDeliveryStream_OrcSerDePropertyDef(BaseStruct):
    ...
    bloom_filter_columns: typing.Optional[typing.Sequence[str]] = pydantic.Field(None, description='The column names for which you want Firehose to create bloom filters. The default is ``null`` .\n')
...
class CfnDeliveryStream_RedshiftDestinationConfigurationPropertyDef(BaseStruct):
    ...
    password: typing.Optional[str] = pydantic.Field(None, description='The password for the Amazon Redshift user that you specified in the ``Username`` property.\n')
    processing_configuration: typing.Union[models.UnsupportedResource, models.aws_kinesisfirehose.CfnDeliveryStream_ProcessingConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The data processing configuration for the Kinesis Data Firehose delivery stream.\n')
    retry_options: typing.Union[models.UnsupportedResource, models.aws_kinesisfirehose.CfnDeliveryStream_RedshiftRetryOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The retry behavior in case Firehose is unable to deliver documents to Amazon Redshift. Default value is 3600 (60 minutes).\n')
    s3_backup_configuration: typing.Union[models.UnsupportedResource, models.aws_kinesisfirehose.CfnDeliveryStream_S3DestinationConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The configuration for backup in Amazon S3.\n')
    s3_backup_mode: typing.Optional[str] = pydantic.Field(None, description="The Amazon S3 backup mode. After you create a delivery stream, you can update it to enable Amazon S3 backup if it is disabled. If backup is enabled, you can't update the delivery stream to disable it.\n")
    secrets_manager_configuration: typing.Union[models.UnsupportedResource, aws_cdk.aws_kinesisfirehose.CfnDeliveryStream.SecretsManagerConfigurationProperty, dict[str, typing.Any], None] = pydantic.Field(None, description='The configuration that defines how you access secrets for Amazon Redshift.\n')
    username: typing.Optional[str] = pydantic.Field(None, description='The Amazon Redshift user that has permission to access the Amazon Redshift cluster. This user must have ``INSERT`` privileges for copying data from the Amazon S3 bucket to the cluster.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kinesisfirehose-deliverystream-redshiftdestinationconfiguration.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_kinesisfirehose as kinesisfirehose\n\n    redshift_destination_configuration_property = kinesisfirehose.CfnDeliveryStream.RedshiftDestinationConfigurationProperty(\n        cluster_jdbcurl="clusterJdbcurl",\n        copy_command=kinesisfirehose.CfnDeliveryStream.CopyCommandProperty(\n            data_table_name="dataTableName",\n\n            # the properties below are optional\n            copy_options="copyOptions",\n            data_table_columns="dataTableColumns"\n        ),\n        role_arn="roleArn",\n        s3_configuration=kinesisfirehose.CfnDeliveryStream.S3DestinationConfigurationProperty(\n            bucket_arn="bucketArn",\n            role_arn="roleArn",\n\n            # the properties below are optional\n            buffering_hints=kinesisfirehose.CfnDeliveryStream.BufferingHintsProperty(\n                interval_in_seconds=123,\n                size_in_mBs=123\n            ),\n            cloud_watch_logging_options=kinesisfirehose.CfnDeliveryStream.CloudWatchLoggingOptionsProperty(\n                enabled=False,\n                log_group_name="logGroupName",\n                log_stream_name="logStreamName"\n            ),\n            compression_format="compressionFormat",\n            encryption_configuration=kinesisfirehose.CfnDeliveryStream.EncryptionConfigurationProperty(\n                kms_encryption_config=kinesisfirehose.CfnDeliveryStream.KMSEncryptionConfigProperty(\n                    awskms_key_arn="awskmsKeyArn"\n                ),\n                no_encryption_config="noEncryptionConfig"\n            ),\n            error_output_prefix="errorOutputPrefix",\n            prefix="prefix"\n        ),\n\n        # the properties below are optional\n        cloud_watch_logging_options=kinesisfirehose.CfnDeliveryStream.CloudWatchLoggingOptionsProperty(\n            enabled=False,\n            log_group_name="logGroupName",\n            log_stream_name="logStreamName"\n        ),\n        password="password",\n        processing_configuration=kinesisfirehose.CfnDeliveryStream.ProcessingConfigurationProperty(\n            enabled=False,\n            processors=[kinesisfirehose.CfnDeliveryStream.ProcessorProperty(\n                type="type",\n\n                # the properties below are optional\n                parameters=[kinesisfirehose.CfnDeliveryStream.ProcessorParameterProperty(\n                    parameter_name="parameterName",\n                    parameter_value="parameterValue"\n                )]\n            )]\n        ),\n        retry_options=kinesisfirehose.CfnDeliveryStream.RedshiftRetryOptionsProperty(\n            duration_in_seconds=123\n        ),\n        s3_backup_configuration=kinesisfirehose.CfnDeliveryStream.S3DestinationConfigurationProperty(\n            bucket_arn="bucketArn",\n            role_arn="roleArn",\n\n            # the properties below are optional\n            buffering_hints=kinesisfirehose.CfnDeliveryStream.BufferingHintsProperty(\n                interval_in_seconds=123,\n                size_in_mBs=123\n            ),\n            cloud_watch_logging_options=kinesisfirehose.CfnDeliveryStream.CloudWatchLoggingOptionsProperty(\n                enabled=False,\n                log_group_name="logGroupName",\n                log_stream_name="logStreamName"\n            ),\n            compression_format="compressionFormat",\n            encryption_configuration=kinesisfirehose.CfnDeliveryStream.EncryptionConfigurationProperty(\n                kms_encryption_config=kinesisfirehose.CfnDeliveryStream.KMSEncryptionConfigProperty(\n                    awskms_key_arn="awskmsKeyArn"\n                ),\n                no_encryption_config="noEncryptionConfig"\n            ),\n            error_output_prefix="errorOutputPrefix",\n            prefix="prefix"\n        ),\n        s3_backup_mode="s3BackupMode",\n        secrets_manager_configuration=kinesisfirehose.CfnDeliveryStream.SecretsManagerConfigurationProperty(\n            enabled=False,\n\n            # the properties below are optional\n            role_arn="roleArn",\n            secret_arn="secretArn"\n        ),\n        username="username"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['cluster_jdbcurl', 'copy_command', 'role_arn', 's3_configuration', 'cloud_watch_logging_options', 'password', 'processing_configuration', 'retry_options', 's3_backup_configuration', 's3_backup_mode', 'secrets_manager_configuration', 'username']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnDeliveryStream_SchemaConfigurationPropertyDef(BaseStruct):
    ...
    version_id: typing.Optional[str] = pydantic.Field(None, description='Specifies the table version for the output data schema. If you don\'t specify this version ID, or if you set it to ``LATEST`` , Firehose uses the most recent version. This means that any updates to the table are automatically picked up.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kinesisfirehose-deliverystream-schemaconfiguration.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_kinesisfirehose as kinesisfirehose\n\n    schema_configuration_property = kinesisfirehose.CfnDeliveryStream.SchemaConfigurationProperty(\n        catalog_id="catalogId",\n        database_name="databaseName",\n        region="region",\n        role_arn="roleArn",\n        table_name="tableName",\n        version_id="versionId"\n    )\n')
...
#  autogenerated from aws_cdk.aws_kinesisfirehose.CfnDeliveryStream.SnowflakeDestinationConfigurationProperty
class CfnDeliveryStream_SnowflakeDestinationConfigurationPropertyDef(BaseStruct):
    account_url: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='URL for accessing your Snowflake account. This URL must include your `account identifier <https://docs.aws.amazon.com/https://docs.snowflake.com/en/user-guide/admin-account-identifier>`_ . Note that the protocol (https://) and port number are optional.\n')
    database: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='All data in Snowflake is maintained in databases.\n')
    role_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Amazon Resource Name (ARN) of the Snowflake role.\n')
    s3_configuration: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_kinesisfirehose.CfnDeliveryStream_S3DestinationConfigurationPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='')
    schema_: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Each database consists of one or more schemas, which are logical groupings of database objects, such as tables and views.\n', alias='schema')
    table: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='All data in Snowflake is stored in database tables, logically structured as collections of columns and rows.\n')
    cloud_watch_logging_options: typing.Union[models.UnsupportedResource, models.aws_kinesisfirehose.CfnDeliveryStream_CloudWatchLoggingOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    content_column_name: typing.Optional[str] = pydantic.Field(None, description='The name of the record content column.\n')
    data_loading_option: typing.Optional[str] = pydantic.Field(None, description='Choose to load JSON keys mapped to table column names or choose to split the JSON payload where content is mapped to a record content column and source metadata is mapped to a record metadata column.\n')
    key_passphrase: typing.Optional[str] = pydantic.Field(None, description='Passphrase to decrypt the private key when the key is encrypted. For information, see `Using Key Pair Authentication & Key Rotation <https://docs.aws.amazon.com/https://docs.snowflake.com/en/user-guide/data-load-snowpipe-streaming-configuration#using-key-pair-authentication-key-rotation>`_ .\n')
    meta_data_column_name: typing.Optional[str] = pydantic.Field(None, description='The name of the record metadata column.\n')
    private_key: typing.Optional[str] = pydantic.Field(None, description='The private key used to encrypt your Snowflake client. For information, see `Using Key Pair Authentication & Key Rotation <https://docs.aws.amazon.com/https://docs.snowflake.com/en/user-guide/data-load-snowpipe-streaming-configuration#using-key-pair-authentication-key-rotation>`_ .\n')
    processing_configuration: typing.Union[models.UnsupportedResource, models.aws_kinesisfirehose.CfnDeliveryStream_ProcessingConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    retry_options: typing.Union[models.UnsupportedResource, models.aws_kinesisfirehose.CfnDeliveryStream_SnowflakeRetryOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The time period where Firehose will retry sending data to the chosen HTTP endpoint.\n')
    s3_backup_mode: typing.Optional[str] = pydantic.Field(None, description='Choose an S3 backup mode.\n')
    secrets_manager_configuration: typing.Union[models.UnsupportedResource, aws_cdk.aws_kinesisfirehose.CfnDeliveryStream.SecretsManagerConfigurationProperty, dict[str, typing.Any], None] = pydantic.Field(None, description='The configuration that defines how you access secrets for Snowflake.\n')
    snowflake_role_configuration: typing.Union[models.UnsupportedResource, models.aws_kinesisfirehose.CfnDeliveryStream_SnowflakeRoleConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Optionally configure a Snowflake role. Otherwise the default user role will be used.\n')
    snowflake_vpc_configuration: typing.Union[models.UnsupportedResource, models.aws_kinesisfirehose.CfnDeliveryStream_SnowflakeVpcConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The VPCE ID for Firehose to privately connect with Snowflake. The ID format is com.amazonaws.vpce.[region].vpce-svc-<[id]>. For more information, see `Amazon PrivateLink & Snowflake <https://docs.aws.amazon.com/https://docs.snowflake.com/en/user-guide/admin-security-privatelink>`_\n')
    user: typing.Optional[str] = pydantic.Field(None, description='User login name for the Snowflake account.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kinesisfirehose-deliverystream-snowflakedestinationconfiguration.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_kinesisfirehose as kinesisfirehose\n\n    snowflake_destination_configuration_property = kinesisfirehose.CfnDeliveryStream.SnowflakeDestinationConfigurationProperty(\n        account_url="accountUrl",\n        database="database",\n        role_arn="roleArn",\n        s3_configuration=kinesisfirehose.CfnDeliveryStream.S3DestinationConfigurationProperty(\n            bucket_arn="bucketArn",\n            role_arn="roleArn",\n\n            # the properties below are optional\n            buffering_hints=kinesisfirehose.CfnDeliveryStream.BufferingHintsProperty(\n                interval_in_seconds=123,\n                size_in_mBs=123\n            ),\n            cloud_watch_logging_options=kinesisfirehose.CfnDeliveryStream.CloudWatchLoggingOptionsProperty(\n                enabled=False,\n                log_group_name="logGroupName",\n                log_stream_name="logStreamName"\n            ),\n            compression_format="compressionFormat",\n            encryption_configuration=kinesisfirehose.CfnDeliveryStream.EncryptionConfigurationProperty(\n                kms_encryption_config=kinesisfirehose.CfnDeliveryStream.KMSEncryptionConfigProperty(\n                    awskms_key_arn="awskmsKeyArn"\n                ),\n                no_encryption_config="noEncryptionConfig"\n            ),\n            error_output_prefix="errorOutputPrefix",\n            prefix="prefix"\n        ),\n        schema="schema",\n        table="table",\n\n        # the properties below are optional\n        cloud_watch_logging_options=kinesisfirehose.CfnDeliveryStream.CloudWatchLoggingOptionsProperty(\n            enabled=False,\n            log_group_name="logGroupName",\n            log_stream_name="logStreamName"\n        ),\n        content_column_name="contentColumnName",\n        data_loading_option="dataLoadingOption",\n        key_passphrase="keyPassphrase",\n        meta_data_column_name="metaDataColumnName",\n        private_key="privateKey",\n        processing_configuration=kinesisfirehose.CfnDeliveryStream.ProcessingConfigurationProperty(\n            enabled=False,\n            processors=[kinesisfirehose.CfnDeliveryStream.ProcessorProperty(\n                type="type",\n\n                # the properties below are optional\n                parameters=[kinesisfirehose.CfnDeliveryStream.ProcessorParameterProperty(\n                    parameter_name="parameterName",\n                    parameter_value="parameterValue"\n                )]\n            )]\n        ),\n        retry_options=kinesisfirehose.CfnDeliveryStream.SnowflakeRetryOptionsProperty(\n            duration_in_seconds=123\n        ),\n        s3_backup_mode="s3BackupMode",\n        secrets_manager_configuration=kinesisfirehose.CfnDeliveryStream.SecretsManagerConfigurationProperty(\n            enabled=False,\n\n            # the properties below are optional\n            role_arn="roleArn",\n            secret_arn="secretArn"\n        ),\n        snowflake_role_configuration=kinesisfirehose.CfnDeliveryStream.SnowflakeRoleConfigurationProperty(\n            enabled=False,\n            snowflake_role="snowflakeRole"\n        ),\n        snowflake_vpc_configuration=kinesisfirehose.CfnDeliveryStream.SnowflakeVpcConfigurationProperty(\n            private_link_vpce_id="privateLinkVpceId"\n        ),\n        user="user"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['account_url', 'database', 'role_arn', 's3_configuration', 'schema', 'table', 'cloud_watch_logging_options', 'content_column_name', 'data_loading_option', 'key_passphrase', 'meta_data_column_name', 'private_key', 'processing_configuration', 'retry_options', 's3_backup_mode', 'secrets_manager_configuration', 'snowflake_role_configuration', 'snowflake_vpc_configuration', 'user']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_kinesisfirehose.CfnDeliveryStream.SnowflakeDestinationConfigurationProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
#  autogenerated from aws_cdk.aws_kinesisfirehose.CfnDeliveryStream.SnowflakeRetryOptionsProperty
class CfnDeliveryStream_SnowflakeRetryOptionsPropertyDef(BaseStruct):
    duration_in_seconds: typing.Union[int, float, None] = pydantic.Field(None, description='the time period where Firehose will retry sending data to the chosen HTTP endpoint.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kinesisfirehose-deliverystream-snowflakeretryoptions.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_kinesisfirehose as kinesisfirehose\n\n    snowflake_retry_options_property = kinesisfirehose.CfnDeliveryStream.SnowflakeRetryOptionsProperty(\n        duration_in_seconds=123\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['duration_in_seconds']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_kinesisfirehose.CfnDeliveryStream.SnowflakeRetryOptionsProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
#  autogenerated from aws_cdk.aws_kinesisfirehose.CfnDeliveryStream.SnowflakeRoleConfigurationProperty
class CfnDeliveryStream_SnowflakeRoleConfigurationPropertyDef(BaseStruct):
    enabled: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='Enable Snowflake role.\n')
    snowflake_role: typing.Optional[str] = pydantic.Field(None, description='The Snowflake role you wish to configure.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kinesisfirehose-deliverystream-snowflakeroleconfiguration.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_kinesisfirehose as kinesisfirehose\n\n    snowflake_role_configuration_property = kinesisfirehose.CfnDeliveryStream.SnowflakeRoleConfigurationProperty(\n        enabled=False,\n        snowflake_role="snowflakeRole"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['enabled', 'snowflake_role']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_kinesisfirehose.CfnDeliveryStream.SnowflakeRoleConfigurationProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
#  autogenerated from aws_cdk.aws_kinesisfirehose.CfnDeliveryStream.SnowflakeVpcConfigurationProperty
class CfnDeliveryStream_SnowflakeVpcConfigurationPropertyDef(BaseStruct):
    private_link_vpce_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The VPCE ID for Firehose to privately connect with Snowflake. The ID format is com.amazonaws.vpce.[region].vpce-svc-<[id]>. For more information, see `Amazon PrivateLink & Snowflake <https://docs.aws.amazon.com/https://docs.snowflake.com/en/user-guide/admin-security-privatelink>`_\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kinesisfirehose-deliverystream-snowflakevpcconfiguration.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_kinesisfirehose as kinesisfirehose\n\n    snowflake_vpc_configuration_property = kinesisfirehose.CfnDeliveryStream.SnowflakeVpcConfigurationProperty(\n        private_link_vpce_id="privateLinkVpceId"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['private_link_vpce_id']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_kinesisfirehose.CfnDeliveryStream.SnowflakeVpcConfigurationProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
#  autogenerated from aws_cdk.aws_kinesisfirehose.CfnDeliveryStream.SplunkBufferingHintsProperty
class CfnDeliveryStream_SplunkBufferingHintsPropertyDef(BaseStruct):
    interval_in_seconds: typing.Union[int, float, None] = pydantic.Field(None, description='Buffer incoming data for the specified period of time, in seconds, before delivering it to the destination. The default value is 60 (1 minute).\n')
    size_in_m_bs: typing.Union[int, float, None] = pydantic.Field(None, description='Buffer incoming data to the specified size, in MBs, before delivering it to the destination. The default value is 5.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kinesisfirehose-deliverystream-splunkbufferinghints.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_kinesisfirehose as kinesisfirehose\n\n    splunk_buffering_hints_property = kinesisfirehose.CfnDeliveryStream.SplunkBufferingHintsProperty(\n        interval_in_seconds=123,\n        size_in_mBs=123\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['interval_in_seconds', 'size_in_m_bs']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_kinesisfirehose.CfnDeliveryStream.SplunkBufferingHintsProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class CfnDeliveryStream_SplunkDestinationConfigurationPropertyDef(BaseStruct):
    hec_endpoint: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The HTTP Event Collector (HEC) endpoint to which Firehose sends your data.\n')
    ...
    buffering_hints: typing.Union[models.UnsupportedResource, models.aws_kinesisfirehose.CfnDeliveryStream_SplunkBufferingHintsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The buffering options. If no value is specified, the default values for Splunk are used.\n')
    cloud_watch_logging_options: typing.Union[models.UnsupportedResource, models.aws_kinesisfirehose.CfnDeliveryStream_CloudWatchLoggingOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The Amazon CloudWatch logging options for your delivery stream.\n')
    ...
    hec_token: typing.Optional[str] = pydantic.Field(None, description='This is a GUID that you obtain from your Splunk cluster when you create a new HEC endpoint.\n')
    ...
    retry_options: typing.Union[models.UnsupportedResource, models.aws_kinesisfirehose.CfnDeliveryStream_SplunkRetryOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description="The retry behavior in case Firehose is unable to deliver data to Splunk, or if it doesn't receive an acknowledgment of receipt from Splunk.\n")
    s3_backup_mode: typing.Optional[str] = pydantic.Field(None, description="Defines how documents should be delivered to Amazon S3. When set to ``FailedEventsOnly`` , Firehose writes any data that could not be indexed to the configured Amazon S3 destination. When set to ``AllEvents`` , Firehose delivers all incoming records to Amazon S3, and also writes failed documents to Amazon S3. The default value is ``FailedEventsOnly`` . You can update this backup mode from ``FailedEventsOnly`` to ``AllEvents`` . You can't update it from ``AllEvents`` to ``FailedEventsOnly`` .\n")
    secrets_manager_configuration: typing.Union[models.UnsupportedResource, aws_cdk.aws_kinesisfirehose.CfnDeliveryStream.SecretsManagerConfigurationProperty, dict[str, typing.Any], None] = pydantic.Field(None, description='The configuration that defines how you access secrets for Splunk.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kinesisfirehose-deliverystream-splunkdestinationconfiguration.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_kinesisfirehose as kinesisfirehose\n\n    splunk_destination_configuration_property = kinesisfirehose.CfnDeliveryStream.SplunkDestinationConfigurationProperty(\n        hec_endpoint="hecEndpoint",\n        hec_endpoint_type="hecEndpointType",\n        s3_configuration=kinesisfirehose.CfnDeliveryStream.S3DestinationConfigurationProperty(\n            bucket_arn="bucketArn",\n            role_arn="roleArn",\n\n            # the properties below are optional\n            buffering_hints=kinesisfirehose.CfnDeliveryStream.BufferingHintsProperty(\n                interval_in_seconds=123,\n                size_in_mBs=123\n            ),\n            cloud_watch_logging_options=kinesisfirehose.CfnDeliveryStream.CloudWatchLoggingOptionsProperty(\n                enabled=False,\n                log_group_name="logGroupName",\n                log_stream_name="logStreamName"\n            ),\n            compression_format="compressionFormat",\n            encryption_configuration=kinesisfirehose.CfnDeliveryStream.EncryptionConfigurationProperty(\n                kms_encryption_config=kinesisfirehose.CfnDeliveryStream.KMSEncryptionConfigProperty(\n                    awskms_key_arn="awskmsKeyArn"\n                ),\n                no_encryption_config="noEncryptionConfig"\n            ),\n            error_output_prefix="errorOutputPrefix",\n            prefix="prefix"\n        ),\n\n        # the properties below are optional\n        buffering_hints=kinesisfirehose.CfnDeliveryStream.SplunkBufferingHintsProperty(\n            interval_in_seconds=123,\n            size_in_mBs=123\n        ),\n        cloud_watch_logging_options=kinesisfirehose.CfnDeliveryStream.CloudWatchLoggingOptionsProperty(\n            enabled=False,\n            log_group_name="logGroupName",\n            log_stream_name="logStreamName"\n        ),\n        hec_acknowledgment_timeout_in_seconds=123,\n        hec_token="hecToken",\n        processing_configuration=kinesisfirehose.CfnDeliveryStream.ProcessingConfigurationProperty(\n            enabled=False,\n            processors=[kinesisfirehose.CfnDeliveryStream.ProcessorProperty(\n                type="type",\n\n                # the properties below are optional\n                parameters=[kinesisfirehose.CfnDeliveryStream.ProcessorParameterProperty(\n                    parameter_name="parameterName",\n                    parameter_value="parameterValue"\n                )]\n            )]\n        ),\n        retry_options=kinesisfirehose.CfnDeliveryStream.SplunkRetryOptionsProperty(\n            duration_in_seconds=123\n        ),\n        s3_backup_mode="s3BackupMode",\n        secrets_manager_configuration=kinesisfirehose.CfnDeliveryStream.SecretsManagerConfigurationProperty(\n            enabled=False,\n\n            # the properties below are optional\n            role_arn="roleArn",\n            secret_arn="secretArn"\n        )\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['hec_endpoint', 'hec_endpoint_type', 's3_configuration', 'buffering_hints', 'cloud_watch_logging_options', 'hec_acknowledgment_timeout_in_seconds', 'hec_token', 'processing_configuration', 'retry_options', 's3_backup_mode', 'secrets_manager_configuration']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnDeliveryStreamDef(BaseCfnResource):
    ...
    snowflake_destination_configuration: typing.Union[models.UnsupportedResource, models.aws_kinesisfirehose.CfnDeliveryStream_SnowflakeDestinationConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Configure Snowflake destination.\n')
...
class CfnDeliveryStreamDefConfig(pydantic.BaseModel):
    ...
    SecretsManagerConfigurationProperty: typing.Optional[list[models.aws_kinesisfirehose.CfnDeliveryStreamDefSecretsmanagerconfigurationpropertyParams]] = pydantic.Field(None, description='')
    ...
    SnowflakeDestinationConfigurationProperty: typing.Optional[list[models.aws_kinesisfirehose.CfnDeliveryStreamDefSnowflakedestinationconfigurationpropertyParams]] = pydantic.Field(None, description='')
    SnowflakeRetryOptionsProperty: typing.Optional[list[models.aws_kinesisfirehose.CfnDeliveryStreamDefSnowflakeretryoptionspropertyParams]] = pydantic.Field(None, description='')
    SnowflakeRoleConfigurationProperty: typing.Optional[list[models.aws_kinesisfirehose.CfnDeliveryStreamDefSnowflakeroleconfigurationpropertyParams]] = pydantic.Field(None, description='')
    SnowflakeVpcConfigurationProperty: typing.Optional[list[models.aws_kinesisfirehose.CfnDeliveryStreamDefSnowflakevpcconfigurationpropertyParams]] = pydantic.Field(None, description='')
    SplunkBufferingHintsProperty: typing.Optional[list[models.aws_kinesisfirehose.CfnDeliveryStreamDefSplunkbufferinghintspropertyParams]] = pydantic.Field(None, description='')
...
class CfnDeliveryStreamDefExtendeds3DestinationconfigurationpropertyParams(pydantic.BaseModel):
    ...
    custom_time_zone: typing.Optional[str] = pydantic.Field(None, description='')
    ...
    file_extension: typing.Optional[str] = pydantic.Field(None, description='')
...
class CfnDeliveryStreamDefHttpendpointdestinationconfigurationpropertyParams(pydantic.BaseModel):
    ...
    s3_backup_mode: typing.Optional[str] = pydantic.Field(None, description='')
    secrets_manager_configuration: typing.Union[models.UnsupportedResource, aws_cdk.aws_kinesisfirehose.CfnDeliveryStream.SecretsManagerConfigurationProperty, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnDeliveryStreamDefSecretsmanagerconfigurationpropertyParams(pydantic.BaseModel):
...
class CfnDeliveryStreamDefSnowflakedestinationconfigurationpropertyParams(pydantic.BaseModel):
    account_url: str = pydantic.Field(..., description='')
    database: str = pydantic.Field(..., description='')
    role_arn: str = pydantic.Field(..., description='')
    s3_configuration: typing.Union[models.UnsupportedResource, models.aws_kinesisfirehose.CfnDeliveryStream_S3DestinationConfigurationPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    schema_: str = pydantic.Field(..., description='', alias='schema')
    table: str = pydantic.Field(..., description='')
    cloud_watch_logging_options: typing.Union[models.UnsupportedResource, models.aws_kinesisfirehose.CfnDeliveryStream_CloudWatchLoggingOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    content_column_name: typing.Optional[str] = pydantic.Field(None, description='')
    data_loading_option: typing.Optional[str] = pydantic.Field(None, description='')
    key_passphrase: typing.Optional[str] = pydantic.Field(None, description='')
    meta_data_column_name: typing.Optional[str] = pydantic.Field(None, description='')
    private_key: typing.Optional[str] = pydantic.Field(None, description='')
    processing_configuration: typing.Union[models.UnsupportedResource, models.aws_kinesisfirehose.CfnDeliveryStream_ProcessingConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    retry_options: typing.Union[models.UnsupportedResource, models.aws_kinesisfirehose.CfnDeliveryStream_SnowflakeRetryOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    s3_backup_mode: typing.Optional[str] = pydantic.Field(None, description='')
    secrets_manager_configuration: typing.Union[models.UnsupportedResource, aws_cdk.aws_kinesisfirehose.CfnDeliveryStream.SecretsManagerConfigurationProperty, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    snowflake_role_configuration: typing.Union[models.UnsupportedResource, models.aws_kinesisfirehose.CfnDeliveryStream_SnowflakeRoleConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    snowflake_vpc_configuration: typing.Union[models.UnsupportedResource, models.aws_kinesisfirehose.CfnDeliveryStream_SnowflakeVpcConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    user: typing.Optional[str] = pydantic.Field(None, description='')
    ...

class CfnDeliveryStreamDefSnowflakeretryoptionspropertyParams(pydantic.BaseModel):
    duration_in_seconds: typing.Union[int, float, None] = pydantic.Field(None, description='')
    ...

class CfnDeliveryStreamDefSnowflakeroleconfigurationpropertyParams(pydantic.BaseModel):
    enabled: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
    snowflake_role: typing.Optional[str] = pydantic.Field(None, description='')
    ...

class CfnDeliveryStreamDefSnowflakevpcconfigurationpropertyParams(pydantic.BaseModel):
    private_link_vpce_id: str = pydantic.Field(..., description='')
    ...

class CfnDeliveryStreamDefSplunkbufferinghintspropertyParams(pydantic.BaseModel):
    interval_in_seconds: typing.Union[int, float, None] = pydantic.Field(None, description='')
    size_in_m_bs: typing.Union[int, float, None] = pydantic.Field(None, description='')
    ...
...
class CfnDeliveryStreamDefSplunkdestinationconfigurationpropertyParams(pydantic.BaseModel):
    ...
    s3_configuration: typing.Union[models.UnsupportedResource, models.aws_kinesisfirehose.CfnDeliveryStream_S3DestinationConfigurationPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    buffering_hints: typing.Union[models.UnsupportedResource, models.aws_kinesisfirehose.CfnDeliveryStream_SplunkBufferingHintsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    cloud_watch_logging_options: typing.Union[models.UnsupportedResource, models.aws_kinesisfirehose.CfnDeliveryStream_CloudWatchLoggingOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    hec_acknowledgment_timeout_in_seconds: typing.Union[int, float, None] = pydantic.Field(None, description='')
    hec_token: typing.Optional[str] = pydantic.Field(None, description='')
    processing_configuration: typing.Union[models.UnsupportedResource, models.aws_kinesisfirehose.CfnDeliveryStream_ProcessingConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
...
class ModuleModel(pydantic.BaseModel):
    ...
    CfnDeliveryStream_SnowflakeDestinationConfigurationProperty: typing.Optional[dict[str, models.aws_kinesisfirehose.CfnDeliveryStream_SnowflakeDestinationConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_SnowflakeRetryOptionsProperty: typing.Optional[dict[str, models.aws_kinesisfirehose.CfnDeliveryStream_SnowflakeRetryOptionsPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_SnowflakeRoleConfigurationProperty: typing.Optional[dict[str, models.aws_kinesisfirehose.CfnDeliveryStream_SnowflakeRoleConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_SnowflakeVpcConfigurationProperty: typing.Optional[dict[str, models.aws_kinesisfirehose.CfnDeliveryStream_SnowflakeVpcConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDeliveryStream_SplunkBufferingHintsProperty: typing.Optional[dict[str, models.aws_kinesisfirehose.CfnDeliveryStream_SplunkBufferingHintsPropertyDef]] = pydantic.Field(None)
