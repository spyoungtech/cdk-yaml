...
class CfnDataset_SchemaPropertyDef(BaseStruct):
    attributes: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_forecast.CfnDataset_AttributesItemsPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='An array of attributes specifying the name and type of each field in a dataset.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-forecast-dataset-schema.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_forecast as forecast\n\n    schema_property = forecast.CfnDataset.SchemaProperty(\n        attributes=[forecast.CfnDataset.AttributesItemsProperty(\n            attribute_name="attributeName",\n            attribute_type="attributeType"\n        )]\n    )\n')
...
class CfnDatasetDef(BaseCfnResource):
    dataset_name: str = pydantic.Field(..., description='The name of the dataset.\n')
    dataset_type: str = pydantic.Field(..., description='The dataset type.\n')
    domain: str = pydantic.Field(..., description='The domain associated with the dataset.\n')
    schema_: typing.Any = pydantic.Field(..., description='The schema for the dataset. The schema attributes and their order must match the fields in your data. The dataset ``Domain`` and ``DatasetType`` that you choose determine the minimum required fields in your training data. For information about the required fields for a specific dataset domain and type, see `Dataset Domains and Dataset Types <https://docs.aws.amazon.com/forecast/latest/dg/howitworks-domains-ds-types.html>`_ .\n', alias='schema')
