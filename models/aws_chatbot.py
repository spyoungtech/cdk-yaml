...
class SlackChannelConfigurationDef(BaseConstruct):
    ...
    user_role_required: typing.Optional[bool] = pydantic.Field(None, description='Enables use of a user role requirement in your chat configuration. Default: false')
    _init_params: typing.ClassVar[list[str]] = ['slack_channel_configuration_name', 'slack_channel_id', 'slack_workspace_id', 'guardrail_policies', 'logging_level', 'log_retention', 'log_retention_retry_options', 'log_retention_role', 'notification_topics', 'role', 'user_role_required']
...
class CfnMicrosoftTeamsChannelConfigurationDef(BaseCfnResource):
    ...
    teams_channel_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The ID of the Microsoft Teams channel. To get the channel ID, open Microsoft Teams, right click on the channel name in the left pane, then choose Copy. An example of the channel ID syntax is: ``19%3ab6ef35dc342d56ba5654e6fc6d25a071%40thread.tacv2`` .\n')
    ...
    tags: typing.Optional[typing.Sequence[typing.Union[models.CfnTagDef, dict[str, typing.Any]]]] = pydantic.Field(None, description='The tags to add to the configuration.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['configuration_name', 'iam_role_arn', 'team_id', 'teams_channel_id', 'teams_tenant_id', 'guardrail_policies', 'logging_level', 'sns_topic_arns', 'tags', 'user_role_required']
...
class CfnSlackChannelConfigurationDef(BaseCfnResource):
    ...
    tags: typing.Optional[typing.Sequence[typing.Union[models.CfnTagDef, dict[str, typing.Any]]]] = pydantic.Field(None, description='The tags to add to the configuration.\n')
    user_role_required: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='Enables use of a user role requirement in your chat configuration. Default: - false')
    _init_params: typing.ClassVar[list[str]] = ['configuration_name', 'iam_role_arn', 'slack_channel_id', 'slack_workspace_id', 'guardrail_policies', 'logging_level', 'sns_topic_arns', 'tags', 'user_role_required']
    _method_names: typing.ClassVar[list[str]] = ['add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
