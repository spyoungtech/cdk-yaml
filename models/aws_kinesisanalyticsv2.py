...
class CfnApplication_ApplicationConfigurationPropertyDef(BaseStruct):
    ...
    sql_application_configuration: typing.Union[models.UnsupportedResource, models.aws_kinesisanalyticsv2.CfnApplication_SqlApplicationConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The creation and update parameters for a SQL-based Managed Service for Apache Flink application.\n')
...
class CfnApplicationOutputDef(BaseCfnResource):
    application_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the application.\n')
    output: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_kinesisanalyticsv2.CfnApplicationOutput_OutputPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description="Describes a SQL-based Managed Service for Apache Flink application's output configuration, in which you identify an in-application stream and a destination where you want the in-application stream data to be written. The destination can be a Kinesis data stream or a Kinesis Data Firehose delivery stream.")
