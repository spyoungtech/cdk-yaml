...
class CfnComponent_ComponentBindingPropertiesValuePropertiesPropertyDef(BaseStruct):
    ...
    slot_name: typing.Optional[str] = pydantic.Field(None, description='The name of a component slot.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['bucket', 'default_value', 'field', 'key', 'model', 'predicates', 'slot_name', 'user_attribute']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnComponent_ComponentEventPropertyDef(BaseStruct):
    ...
    binding_event: typing.Optional[str] = pydantic.Field(None, description='Binds an event to an action on a component. When you specify a ``bindingEvent`` , the event is called when the action is performed.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['action', 'binding_event', 'parameters']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnComponent_PredicatePropertyDef(BaseStruct):
    ...
    operand_type: typing.Optional[str] = pydantic.Field(None, description='The type of value to use when performing the evaluation.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['and_', 'field', 'operand', 'operand_type', 'operator', 'or_']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
#  autogenerated from aws_cdk.aws_amplifyuibuilder.CfnForm.FormInputBindingPropertiesValuePropertiesProperty
class CfnForm_FormInputBindingPropertiesValuePropertiesPropertyDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['model']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_amplifyuibuilder.CfnForm.FormInputBindingPropertiesValuePropertiesProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
#  autogenerated from aws_cdk.aws_amplifyuibuilder.CfnForm.FormInputBindingPropertiesValueProperty
class CfnForm_FormInputBindingPropertiesValuePropertyDef(BaseStruct):
    binding_properties: typing.Union[models.UnsupportedResource, models.aws_amplifyuibuilder.CfnForm_FormInputBindingPropertiesValuePropertiesPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Describes the properties to customize with data at runtime.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['binding_properties', 'type']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_amplifyuibuilder.CfnForm.FormInputBindingPropertiesValueProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
#  autogenerated from aws_cdk.aws_amplifyuibuilder.CfnForm.FormInputValuePropertyBindingPropertiesProperty
class CfnForm_FormInputValuePropertyBindingPropertiesPropertyDef(BaseStruct):
    property: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The form property to bind to the data field.\n')
    ...
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_amplifyuibuilder.CfnForm.FormInputValuePropertyBindingPropertiesProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class CfnForm_FormInputValuePropertyPropertyDef(BaseStruct):
    binding_properties: typing.Union[models.UnsupportedResource, models.aws_amplifyuibuilder.CfnForm_FormInputValuePropertyBindingPropertiesPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The information to bind fields to data at runtime.\n')
    concat: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_amplifyuibuilder.CfnForm_FormInputValuePropertyPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='A list of form properties to concatenate to create the value to assign to this field property.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['binding_properties', 'concat', 'value']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnForm_ValueMappingsPropertyDef(BaseStruct):
    ...
    binding_properties: typing.Union[models.UnsupportedResource, typing.Mapping[str, typing.Union[models.UnsupportedResource, models.aws_amplifyuibuilder.CfnForm_FormInputBindingPropertiesValuePropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The information to bind fields to data at runtime.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-amplifyuibuilder-form-valuemappings.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_amplifyuibuilder as amplifyuibuilder\n\n    # form_input_value_property_property_: amplifyuibuilder.CfnForm.FormInputValuePropertyProperty\n\n    value_mappings_property = amplifyuibuilder.CfnForm.ValueMappingsProperty(\n        values=[amplifyuibuilder.CfnForm.ValueMappingProperty(\n            value=amplifyuibuilder.CfnForm.FormInputValuePropertyProperty(\n                binding_properties=amplifyuibuilder.CfnForm.FormInputValuePropertyBindingPropertiesProperty(\n                    property="property",\n\n                    # the properties below are optional\n                    field="field"\n                ),\n                concat=[form_input_value_property_property_],\n                value="value"\n            ),\n\n            # the properties below are optional\n            display_value=amplifyuibuilder.CfnForm.FormInputValuePropertyProperty(\n                binding_properties=amplifyuibuilder.CfnForm.FormInputValuePropertyBindingPropertiesProperty(\n                    property="property",\n\n                    # the properties below are optional\n                    field="field"\n                ),\n                concat=[form_input_value_property_property_],\n                value="value"\n            )\n        )],\n\n        # the properties below are optional\n        binding_properties={\n            "binding_properties_key": amplifyuibuilder.CfnForm.FormInputBindingPropertiesValueProperty(\n                binding_properties=amplifyuibuilder.CfnForm.FormInputBindingPropertiesValuePropertiesProperty(\n                    model="model"\n                ),\n                type="type"\n            )\n        }\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['values', 'binding_properties']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnComponentDef(BaseCfnResource):
    ...
    binding_properties: typing.Union[models.UnsupportedResource, typing.Mapping[str, typing.Union[models.UnsupportedResource, models.aws_amplifyuibuilder.CfnComponent_ComponentBindingPropertiesValuePropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description="The information to connect a component's properties to data at runtime. You can't specify ``tags`` as a valid property for ``bindingProperties`` .\n")
    ...
    component_type: typing.Optional[str] = pydantic.Field(None, description='The type of the component. This can be an Amplify custom UI component or another custom component.\n')
    ...
    name: typing.Optional[str] = pydantic.Field(None, description='The name of the component.\n')
    overrides: typing.Any = pydantic.Field(None, description="Describes the component's properties that can be overriden in a customized instance of the component. You can't specify ``tags`` as a valid property for ``overrides`` .\n")
    properties: typing.Union[models.UnsupportedResource, typing.Mapping[str, typing.Union[models.UnsupportedResource, models.aws_amplifyuibuilder.CfnComponent_ComponentPropertyPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description="Describes the component's properties. You can't specify ``tags`` as a valid property for ``properties`` .\n")
    ...
    variants: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_amplifyuibuilder.CfnComponent_ComponentVariantPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description="A list of the component's variants. A variant is a unique style configuration of a main component.")
    _init_params: typing.ClassVar[list[str]] = ['app_id', 'binding_properties', 'children', 'collection_properties', 'component_type', 'environment_name', 'events', 'name', 'overrides', 'properties', 'schema_version', 'source_id', 'tags', 'variants']
    ...
    resource_config: typing.Optional[models.aws_amplifyuibuilder.CfnComponentDefConfig] = pydantic.Field(None)


class CfnComponentDefConfig(pydantic.BaseModel):
    ActionParametersProperty: typing.Optional[list[models.aws_amplifyuibuilder.CfnComponentDefActionparameterspropertyParams]] = pydantic.Field(None, description='')
    ComponentBindingPropertiesValuePropertiesProperty: typing.Optional[list[models.aws_amplifyuibuilder.CfnComponentDefComponentbindingpropertiesvaluepropertiespropertyParams]] = pydantic.Field(None, description='')
    ComponentBindingPropertiesValueProperty: typing.Optional[list[models.aws_amplifyuibuilder.CfnComponentDefComponentbindingpropertiesvaluepropertyParams]] = pydantic.Field(None, description='')
    ComponentChildProperty: typing.Optional[list[models.aws_amplifyuibuilder.CfnComponentDefComponentchildpropertyParams]] = pydantic.Field(None, description='')
    ComponentConditionPropertyProperty: typing.Optional[list[models.aws_amplifyuibuilder.CfnComponentDefComponentconditionpropertypropertyParams]] = pydantic.Field(None, description='')
    ComponentDataConfigurationProperty: typing.Optional[list[models.aws_amplifyuibuilder.CfnComponentDefComponentdataconfigurationpropertyParams]] = pydantic.Field(None, description='')
    ComponentEventProperty: typing.Optional[list[models.aws_amplifyuibuilder.CfnComponentDefComponenteventpropertyParams]] = pydantic.Field(None, description='')
    ComponentPropertyBindingPropertiesProperty: typing.Optional[list[models.aws_amplifyuibuilder.CfnComponentDefComponentpropertybindingpropertiespropertyParams]] = pydantic.Field(None, description='')
    ComponentPropertyProperty: typing.Optional[list[models.aws_amplifyuibuilder.CfnComponentDefComponentpropertypropertyParams]] = pydantic.Field(None, description='')
    ComponentVariantProperty: typing.Optional[list[models.aws_amplifyuibuilder.CfnComponentDefComponentvariantpropertyParams]] = pydantic.Field(None, description='')
    FormBindingElementProperty: typing.Optional[list[models.aws_amplifyuibuilder.CfnComponentDefFormbindingelementpropertyParams]] = pydantic.Field(None, description='')
    MutationActionSetStateParameterProperty: typing.Optional[list[models.aws_amplifyuibuilder.CfnComponentDefMutationactionsetstateparameterpropertyParams]] = pydantic.Field(None, description='')
    PredicateProperty: typing.Optional[list[models.aws_amplifyuibuilder.CfnComponentDefPredicatepropertyParams]] = pydantic.Field(None, description='')
    SortPropertyProperty: typing.Optional[list[models.aws_amplifyuibuilder.CfnComponentDefSortpropertypropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_amplifyuibuilder.CfnComponentDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_amplifyuibuilder.CfnComponentDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_amplifyuibuilder.CfnComponentDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_amplifyuibuilder.CfnComponentDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_amplifyuibuilder.CfnComponentDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_amplifyuibuilder.CfnComponentDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_amplifyuibuilder.CfnComponentDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_amplifyuibuilder.CfnComponentDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_amplifyuibuilder.CfnComponentDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_amplifyuibuilder.CfnComponentDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_amplifyuibuilder.CfnComponentDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_amplifyuibuilder.CfnComponentDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_amplifyuibuilder.CfnComponentDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
class CfnComponentDefComponentchildpropertyParams(pydantic.BaseModel):
    ...
    source_id: typing.Optional[str] = pydantic.Field(None, description='')
    ...
...
class CfnComponentDefComponenteventpropertyParams(pydantic.BaseModel):
    ...
    binding_event: typing.Optional[str] = pydantic.Field(None, description='')
...
class CfnFormDef(BaseCfnResource):
    ...
    data_type: typing.Union[models.UnsupportedResource, models.aws_amplifyuibuilder.CfnForm_FormDataTypeConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The type of data source to use to create the form.\n')
    environment_name: typing.Optional[str] = pydantic.Field(None, description='The name of the backend environment that is a part of the Amplify app.\n')
    fields: typing.Union[models.UnsupportedResource, typing.Mapping[str, typing.Union[models.UnsupportedResource, models.aws_amplifyuibuilder.CfnForm_FieldConfigPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description="The configuration information for the form's fields.\n")
    form_action_type: typing.Optional[str] = pydantic.Field(None, description='Specifies whether to perform a create or update action on the form.\n')
    ...
    name: typing.Optional[str] = pydantic.Field(None, description='The name of the form.\n')
    schema_version: typing.Optional[str] = pydantic.Field(None, description='The schema version of the form.\n')
    sectional_elements: typing.Union[models.UnsupportedResource, typing.Mapping[str, typing.Union[models.UnsupportedResource, models.aws_amplifyuibuilder.CfnForm_SectionalElementPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The configuration information for the visual helper elements for the form. These elements are not associated with any data.\n')
    style: typing.Union[models.UnsupportedResource, models.aws_amplifyuibuilder.CfnForm_FormStylePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description="The configuration for the form's style.\n")
    ...
    _init_params: typing.ClassVar[list[str]] = ['app_id', 'cta', 'data_type', 'environment_name', 'fields', 'form_action_type', 'label_decorator', 'name', 'schema_version', 'sectional_elements', 'style', 'tags']
    _method_names: typing.ClassVar[list[str]] = ['FieldConfigProperty', 'FieldInputConfigProperty', 'FieldPositionProperty', 'FieldValidationConfigurationProperty', 'FileUploaderFieldConfigProperty', 'FormButtonProperty', 'FormCTAProperty', 'FormDataTypeConfigProperty', 'FormInputBindingPropertiesValuePropertiesProperty', 'FormInputBindingPropertiesValueProperty', 'FormInputValuePropertyBindingPropertiesProperty', 'FormInputValuePropertyProperty', 'FormStyleConfigProperty', 'FormStyleProperty', 'SectionalElementProperty', 'ValueMappingProperty', 'ValueMappingsProperty', 'add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
    ...
    resource_config: typing.Optional[models.aws_amplifyuibuilder.CfnFormDefConfig] = pydantic.Field(None)


class CfnFormDefConfig(pydantic.BaseModel):
    FieldConfigProperty: typing.Optional[list[models.aws_amplifyuibuilder.CfnFormDefFieldconfigpropertyParams]] = pydantic.Field(None, description='')
    FieldInputConfigProperty: typing.Optional[list[models.aws_amplifyuibuilder.CfnFormDefFieldinputconfigpropertyParams]] = pydantic.Field(None, description='')
    FieldPositionProperty: typing.Optional[list[models.aws_amplifyuibuilder.CfnFormDefFieldpositionpropertyParams]] = pydantic.Field(None, description='')
    FieldValidationConfigurationProperty: typing.Optional[list[models.aws_amplifyuibuilder.CfnFormDefFieldvalidationconfigurationpropertyParams]] = pydantic.Field(None, description='')
    FileUploaderFieldConfigProperty: typing.Optional[list[models.aws_amplifyuibuilder.CfnFormDefFileuploaderfieldconfigpropertyParams]] = pydantic.Field(None, description='')
    FormButtonProperty: typing.Optional[list[models.aws_amplifyuibuilder.CfnFormDefFormbuttonpropertyParams]] = pydantic.Field(None, description='')
    FormCTAProperty: typing.Optional[list[models.aws_amplifyuibuilder.CfnFormDefFormctapropertyParams]] = pydantic.Field(None, description='')
    FormDataTypeConfigProperty: typing.Optional[list[models.aws_amplifyuibuilder.CfnFormDefFormdatatypeconfigpropertyParams]] = pydantic.Field(None, description='')
    FormInputBindingPropertiesValuePropertiesProperty: typing.Optional[list[models.aws_amplifyuibuilder.CfnFormDefForminputbindingpropertiesvaluepropertiespropertyParams]] = pydantic.Field(None, description='')
    FormInputBindingPropertiesValueProperty: typing.Optional[list[models.aws_amplifyuibuilder.CfnFormDefForminputbindingpropertiesvaluepropertyParams]] = pydantic.Field(None, description='')
    FormInputValuePropertyBindingPropertiesProperty: typing.Optional[list[models.aws_amplifyuibuilder.CfnFormDefForminputvaluepropertybindingpropertiespropertyParams]] = pydantic.Field(None, description='')
    FormInputValuePropertyProperty: typing.Optional[list[models.aws_amplifyuibuilder.CfnFormDefForminputvaluepropertypropertyParams]] = pydantic.Field(None, description='')
    FormStyleConfigProperty: typing.Optional[list[models.aws_amplifyuibuilder.CfnFormDefFormstyleconfigpropertyParams]] = pydantic.Field(None, description='')
    FormStyleProperty: typing.Optional[list[models.aws_amplifyuibuilder.CfnFormDefFormstylepropertyParams]] = pydantic.Field(None, description='')
    SectionalElementProperty: typing.Optional[list[models.aws_amplifyuibuilder.CfnFormDefSectionalelementpropertyParams]] = pydantic.Field(None, description='')
    ValueMappingProperty: typing.Optional[list[models.aws_amplifyuibuilder.CfnFormDefValuemappingpropertyParams]] = pydantic.Field(None, description='')
    ValueMappingsProperty: typing.Optional[list[models.aws_amplifyuibuilder.CfnFormDefValuemappingspropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_amplifyuibuilder.CfnFormDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_amplifyuibuilder.CfnFormDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_amplifyuibuilder.CfnFormDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_amplifyuibuilder.CfnFormDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_amplifyuibuilder.CfnFormDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_amplifyuibuilder.CfnFormDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_amplifyuibuilder.CfnFormDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_amplifyuibuilder.CfnFormDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_amplifyuibuilder.CfnFormDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_amplifyuibuilder.CfnFormDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_amplifyuibuilder.CfnFormDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_amplifyuibuilder.CfnFormDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_amplifyuibuilder.CfnFormDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
    tags_config: typing.Optional[models.core.TagManagerDefConfig] = pydantic.Field(None)
...
class CfnFormDefForminputbindingpropertiesvaluepropertiespropertyParams(pydantic.BaseModel):
    model: typing.Optional[str] = pydantic.Field(None, description='')
    ...

class CfnFormDefForminputbindingpropertiesvaluepropertyParams(pydantic.BaseModel):
    binding_properties: typing.Union[models.UnsupportedResource, models.aws_amplifyuibuilder.CfnForm_FormInputBindingPropertiesValuePropertiesPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    type: typing.Optional[str] = pydantic.Field(None, description='')
    ...

class CfnFormDefForminputvaluepropertybindingpropertiespropertyParams(pydantic.BaseModel):
    property: str = pydantic.Field(..., description='')
    field: typing.Optional[str] = pydantic.Field(None, description='')
    ...

class CfnFormDefForminputvaluepropertypropertyParams(pydantic.BaseModel):
    binding_properties: typing.Union[models.UnsupportedResource, models.aws_amplifyuibuilder.CfnForm_FormInputValuePropertyBindingPropertiesPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    concat: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_amplifyuibuilder.CfnForm_FormInputValuePropertyPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    value: typing.Optional[str] = pydantic.Field(None, description='')
    ...
...
class CfnFormDefValuemappingspropertyParams(pydantic.BaseModel):
    ...
    binding_properties: typing.Union[models.UnsupportedResource, typing.Mapping[str, typing.Union[models.UnsupportedResource, models.aws_amplifyuibuilder.CfnForm_FormInputBindingPropertiesValuePropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    ...
...
class CfnThemeDef(BaseCfnResource):
    ...
    environment_name: typing.Optional[str] = pydantic.Field(None, description='The name of the backend environment that is a part of the Amplify app.\n')
    name: typing.Optional[str] = pydantic.Field(None, description='The name of the theme.\n')
    ...
    values: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_amplifyuibuilder.CfnTheme_ThemeValuesPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='A list of key-value pairs that defines the properties of the theme.')
    _init_params: typing.ClassVar[list[str]] = ['app_id', 'environment_name', 'name', 'overrides', 'tags', 'values']
    ...
    resource_config: typing.Optional[models.aws_amplifyuibuilder.CfnThemeDefConfig] = pydantic.Field(None)


class CfnThemeDefConfig(pydantic.BaseModel):
    ThemeValueProperty: typing.Optional[list[models.aws_amplifyuibuilder.CfnThemeDefThemevaluepropertyParams]] = pydantic.Field(None, description='')
    ThemeValuesProperty: typing.Optional[list[models.aws_amplifyuibuilder.CfnThemeDefThemevaluespropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_amplifyuibuilder.CfnThemeDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_amplifyuibuilder.CfnThemeDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_amplifyuibuilder.CfnThemeDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_amplifyuibuilder.CfnThemeDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_amplifyuibuilder.CfnThemeDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_amplifyuibuilder.CfnThemeDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_amplifyuibuilder.CfnThemeDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_amplifyuibuilder.CfnThemeDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_amplifyuibuilder.CfnThemeDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_amplifyuibuilder.CfnThemeDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_amplifyuibuilder.CfnThemeDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_amplifyuibuilder.CfnThemeDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_amplifyuibuilder.CfnThemeDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
    tags_config: typing.Optional[models.core.TagManagerDefConfig] = pydantic.Field(None)
...
class ModuleModel(pydantic.BaseModel):
    CfnComponent_ActionParametersProperty: typing.Optional[dict[str, models.aws_amplifyuibuilder.CfnComponent_ActionParametersPropertyDef]] = pydantic.Field(None)
    CfnComponent_ComponentBindingPropertiesValuePropertiesProperty: typing.Optional[dict[str, models.aws_amplifyuibuilder.CfnComponent_ComponentBindingPropertiesValuePropertiesPropertyDef]] = pydantic.Field(None)
    CfnComponent_ComponentBindingPropertiesValueProperty: typing.Optional[dict[str, models.aws_amplifyuibuilder.CfnComponent_ComponentBindingPropertiesValuePropertyDef]] = pydantic.Field(None)
    CfnComponent_ComponentChildProperty: typing.Optional[dict[str, models.aws_amplifyuibuilder.CfnComponent_ComponentChildPropertyDef]] = pydantic.Field(None)
    CfnComponent_ComponentConditionPropertyProperty: typing.Optional[dict[str, models.aws_amplifyuibuilder.CfnComponent_ComponentConditionPropertyPropertyDef]] = pydantic.Field(None)
    CfnComponent_ComponentDataConfigurationProperty: typing.Optional[dict[str, models.aws_amplifyuibuilder.CfnComponent_ComponentDataConfigurationPropertyDef]] = pydantic.Field(None)
    CfnComponent_ComponentEventProperty: typing.Optional[dict[str, models.aws_amplifyuibuilder.CfnComponent_ComponentEventPropertyDef]] = pydantic.Field(None)
    CfnComponent_ComponentPropertyBindingPropertiesProperty: typing.Optional[dict[str, models.aws_amplifyuibuilder.CfnComponent_ComponentPropertyBindingPropertiesPropertyDef]] = pydantic.Field(None)
    CfnComponent_ComponentPropertyProperty: typing.Optional[dict[str, models.aws_amplifyuibuilder.CfnComponent_ComponentPropertyPropertyDef]] = pydantic.Field(None)
    CfnComponent_ComponentVariantProperty: typing.Optional[dict[str, models.aws_amplifyuibuilder.CfnComponent_ComponentVariantPropertyDef]] = pydantic.Field(None)
    CfnComponent_FormBindingElementProperty: typing.Optional[dict[str, models.aws_amplifyuibuilder.CfnComponent_FormBindingElementPropertyDef]] = pydantic.Field(None)
    CfnComponent_MutationActionSetStateParameterProperty: typing.Optional[dict[str, models.aws_amplifyuibuilder.CfnComponent_MutationActionSetStateParameterPropertyDef]] = pydantic.Field(None)
    CfnComponent_PredicateProperty: typing.Optional[dict[str, models.aws_amplifyuibuilder.CfnComponent_PredicatePropertyDef]] = pydantic.Field(None)
    CfnComponent_SortPropertyProperty: typing.Optional[dict[str, models.aws_amplifyuibuilder.CfnComponent_SortPropertyPropertyDef]] = pydantic.Field(None)
    CfnForm_FieldConfigProperty: typing.Optional[dict[str, models.aws_amplifyuibuilder.CfnForm_FieldConfigPropertyDef]] = pydantic.Field(None)
    CfnForm_FieldInputConfigProperty: typing.Optional[dict[str, models.aws_amplifyuibuilder.CfnForm_FieldInputConfigPropertyDef]] = pydantic.Field(None)
    CfnForm_FieldPositionProperty: typing.Optional[dict[str, models.aws_amplifyuibuilder.CfnForm_FieldPositionPropertyDef]] = pydantic.Field(None)
    CfnForm_FieldValidationConfigurationProperty: typing.Optional[dict[str, models.aws_amplifyuibuilder.CfnForm_FieldValidationConfigurationPropertyDef]] = pydantic.Field(None)
    CfnForm_FileUploaderFieldConfigProperty: typing.Optional[dict[str, models.aws_amplifyuibuilder.CfnForm_FileUploaderFieldConfigPropertyDef]] = pydantic.Field(None)
    CfnForm_FormButtonProperty: typing.Optional[dict[str, models.aws_amplifyuibuilder.CfnForm_FormButtonPropertyDef]] = pydantic.Field(None)
    CfnForm_FormCTAProperty: typing.Optional[dict[str, models.aws_amplifyuibuilder.CfnForm_FormCTAPropertyDef]] = pydantic.Field(None)
    CfnForm_FormDataTypeConfigProperty: typing.Optional[dict[str, models.aws_amplifyuibuilder.CfnForm_FormDataTypeConfigPropertyDef]] = pydantic.Field(None)
    CfnForm_FormInputBindingPropertiesValuePropertiesProperty: typing.Optional[dict[str, models.aws_amplifyuibuilder.CfnForm_FormInputBindingPropertiesValuePropertiesPropertyDef]] = pydantic.Field(None)
    CfnForm_FormInputBindingPropertiesValueProperty: typing.Optional[dict[str, models.aws_amplifyuibuilder.CfnForm_FormInputBindingPropertiesValuePropertyDef]] = pydantic.Field(None)
    CfnForm_FormInputValuePropertyBindingPropertiesProperty: typing.Optional[dict[str, models.aws_amplifyuibuilder.CfnForm_FormInputValuePropertyBindingPropertiesPropertyDef]] = pydantic.Field(None)
    CfnForm_FormInputValuePropertyProperty: typing.Optional[dict[str, models.aws_amplifyuibuilder.CfnForm_FormInputValuePropertyPropertyDef]] = pydantic.Field(None)
    CfnForm_FormStyleConfigProperty: typing.Optional[dict[str, models.aws_amplifyuibuilder.CfnForm_FormStyleConfigPropertyDef]] = pydantic.Field(None)
    CfnForm_FormStyleProperty: typing.Optional[dict[str, models.aws_amplifyuibuilder.CfnForm_FormStylePropertyDef]] = pydantic.Field(None)
    CfnForm_SectionalElementProperty: typing.Optional[dict[str, models.aws_amplifyuibuilder.CfnForm_SectionalElementPropertyDef]] = pydantic.Field(None)
    CfnForm_ValueMappingProperty: typing.Optional[dict[str, models.aws_amplifyuibuilder.CfnForm_ValueMappingPropertyDef]] = pydantic.Field(None)
    CfnForm_ValueMappingsProperty: typing.Optional[dict[str, models.aws_amplifyuibuilder.CfnForm_ValueMappingsPropertyDef]] = pydantic.Field(None)
    CfnTheme_ThemeValueProperty: typing.Optional[dict[str, models.aws_amplifyuibuilder.CfnTheme_ThemeValuePropertyDef]] = pydantic.Field(None)
    CfnTheme_ThemeValuesProperty: typing.Optional[dict[str, models.aws_amplifyuibuilder.CfnTheme_ThemeValuesPropertyDef]] = pydantic.Field(None)
    CfnComponent: typing.Optional[dict[str, models.aws_amplifyuibuilder.CfnComponentDef]] = pydantic.Field(None)
    CfnForm: typing.Optional[dict[str, models.aws_amplifyuibuilder.CfnFormDef]] = pydantic.Field(None)
    CfnTheme: typing.Optional[dict[str, models.aws_amplifyuibuilder.CfnThemeDef]] = pydantic.Field(None)
    CfnComponentProps: typing.Optional[dict[str, models.aws_amplifyuibuilder.CfnComponentPropsDef]] = pydantic.Field(None)
    CfnFormProps: typing.Optional[dict[str, models.aws_amplifyuibuilder.CfnFormPropsDef]] = pydantic.Field(None)
    CfnThemeProps: typing.Optional[dict[str, models.aws_amplifyuibuilder.CfnThemePropsDef]] = pydantic.Field(None)
    ...
