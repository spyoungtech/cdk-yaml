...
class ApiGatewayDef(BaseClass):
    api: models.aws_apigateway.RestApiBaseDef = pydantic.Field(..., description='-')
...
class ApiGatewayDomainDef(BaseClass):
    domain_name: typing.Union[models.aws_apigateway.DomainNameDef] = pydantic.Field(..., description='-')
...
class CloudFrontTargetDef(BaseClass):
    distribution: typing.Union[models.aws_cloudfront.CloudFrontWebDistributionDef, models.aws_cloudfront.DistributionDef] = pydantic.Field(..., description='-')
...
class ElasticBeanstalkEnvironmentEndpointTargetDef(BaseClass):
    environment_endpoint: str = pydantic.Field(..., description='-')
...
class GlobalAcceleratorDomainTargetDef(BaseClass):
    accelerator_domain_name: str = pydantic.Field(..., description='-')
...
class GlobalAcceleratorTargetDef(BaseClass):
    accelerator: typing.Union[models.aws_globalaccelerator.AcceleratorDef] = pydantic.Field(..., description='-')
...
class InterfaceVpcEndpointTargetDef(BaseClass):
    vpc_endpoint: models.aws_ec2.InterfaceVpcEndpointDef = pydantic.Field(..., description='-')
...
class UserPoolDomainTargetDef(BaseClass):
    domain: models.aws_cognito.UserPoolDomainDef = pydantic.Field(..., description='-')
