...
class CfnResponsePlan_ChatChannelPropertyDef(BaseStruct):
    chatbot_sns: typing.Optional[typing.Sequence[str]] = pydantic.Field(None, description='The Amazon SNS targets that AWS Chatbot uses to notify the chat channel of updates to an incident. You can also make updates to the incident through the chat channel by using the Amazon SNS topics\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ssmincidents-responseplan-chatchannel.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_ssmincidents as ssmincidents\n\n    chat_channel_property = ssmincidents.CfnResponsePlan.ChatChannelProperty(\n        chatbot_sns=["chatbotSns"]\n    )\n')
...
class CfnResponsePlan_IncidentTemplatePropertyDef(BaseStruct):
    ...
    notification_targets: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_ssmincidents.CfnResponsePlan_NotificationTargetItemPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The Amazon Simple Notification Service ( Amazon SNS ) targets that AWS Chatbot uses to notify the chat channel of updates to an incident. You can also make updates to the incident through the chat channel using the Amazon SNS topics.\n')
...
class CfnResponsePlan_SsmAutomationPropertyDef(BaseStruct):
    ...
    document_version: typing.Optional[str] = pydantic.Field(None, description='The version of the runbook to use when running.\n')
    ...
    parameters: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_ssmincidents.CfnResponsePlan_SsmParameterPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The key-value pair parameters to use when running the runbook.\n')
...
class CfnResponsePlan_SsmParameterPropertyDef(BaseStruct):
    key: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The key parameter to use when running the Automation runbook.\n')
    values: typing.Union[typing.Sequence[str], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The value parameter to use when running the Automation runbook.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ssmincidents-responseplan-ssmparameter.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_ssmincidents as ssmincidents\n\n    ssm_parameter_property = ssmincidents.CfnResponsePlan.SsmParameterProperty(\n        key="key",\n        values=["values"]\n    )\n')
...
class CfnReplicationSetDef(BaseCfnResource):
    ...
    resource_config: typing.Optional[models.aws_ssmincidents.CfnReplicationSetDefConfig] = pydantic.Field(None)


class CfnReplicationSetDefConfig(pydantic.BaseModel):
    RegionConfigurationProperty: typing.Optional[list[models.aws_ssmincidents.CfnReplicationSetDefRegionconfigurationpropertyParams]] = pydantic.Field(None, description='')
    ReplicationRegionProperty: typing.Optional[list[models.aws_ssmincidents.CfnReplicationSetDefReplicationregionpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_ssmincidents.CfnReplicationSetDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_ssmincidents.CfnReplicationSetDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_ssmincidents.CfnReplicationSetDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_ssmincidents.CfnReplicationSetDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_ssmincidents.CfnReplicationSetDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_ssmincidents.CfnReplicationSetDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_ssmincidents.CfnReplicationSetDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_ssmincidents.CfnReplicationSetDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_ssmincidents.CfnReplicationSetDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_ssmincidents.CfnReplicationSetDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_ssmincidents.CfnReplicationSetDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_ssmincidents.CfnReplicationSetDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_ssmincidents.CfnReplicationSetDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
class CfnResponsePlanDef(BaseCfnResource):
    ...
    resource_config: typing.Optional[models.aws_ssmincidents.CfnResponsePlanDefConfig] = pydantic.Field(None)


class CfnResponsePlanDefConfig(pydantic.BaseModel):
    ActionProperty: typing.Optional[list[models.aws_ssmincidents.CfnResponsePlanDefActionpropertyParams]] = pydantic.Field(None, description='')
    ChatChannelProperty: typing.Optional[list[models.aws_ssmincidents.CfnResponsePlanDefChatchannelpropertyParams]] = pydantic.Field(None, description='')
    DynamicSsmParameterProperty: typing.Optional[list[models.aws_ssmincidents.CfnResponsePlanDefDynamicssmparameterpropertyParams]] = pydantic.Field(None, description='')
    DynamicSsmParameterValueProperty: typing.Optional[list[models.aws_ssmincidents.CfnResponsePlanDefDynamicssmparametervaluepropertyParams]] = pydantic.Field(None, description='')
    IncidentTemplateProperty: typing.Optional[list[models.aws_ssmincidents.CfnResponsePlanDefIncidenttemplatepropertyParams]] = pydantic.Field(None, description='')
    IntegrationProperty: typing.Optional[list[models.aws_ssmincidents.CfnResponsePlanDefIntegrationpropertyParams]] = pydantic.Field(None, description='')
    NotificationTargetItemProperty: typing.Optional[list[models.aws_ssmincidents.CfnResponsePlanDefNotificationtargetitempropertyParams]] = pydantic.Field(None, description='')
    PagerDutyConfigurationProperty: typing.Optional[list[models.aws_ssmincidents.CfnResponsePlanDefPagerdutyconfigurationpropertyParams]] = pydantic.Field(None, description='')
    PagerDutyIncidentConfigurationProperty: typing.Optional[list[models.aws_ssmincidents.CfnResponsePlanDefPagerdutyincidentconfigurationpropertyParams]] = pydantic.Field(None, description='')
    SsmAutomationProperty: typing.Optional[list[models.aws_ssmincidents.CfnResponsePlanDefSsmautomationpropertyParams]] = pydantic.Field(None, description='')
    SsmParameterProperty: typing.Optional[list[models.aws_ssmincidents.CfnResponsePlanDefSsmparameterpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_ssmincidents.CfnResponsePlanDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_ssmincidents.CfnResponsePlanDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_ssmincidents.CfnResponsePlanDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_ssmincidents.CfnResponsePlanDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_ssmincidents.CfnResponsePlanDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_ssmincidents.CfnResponsePlanDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_ssmincidents.CfnResponsePlanDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_ssmincidents.CfnResponsePlanDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_ssmincidents.CfnResponsePlanDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_ssmincidents.CfnResponsePlanDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_ssmincidents.CfnResponsePlanDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_ssmincidents.CfnResponsePlanDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_ssmincidents.CfnResponsePlanDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
    tags_config: typing.Optional[models.core.TagManagerDefConfig] = pydantic.Field(None)
...
class ModuleModel(pydantic.BaseModel):
    CfnReplicationSet_RegionConfigurationProperty: typing.Optional[dict[str, models.aws_ssmincidents.CfnReplicationSet_RegionConfigurationPropertyDef]] = pydantic.Field(None)
    CfnReplicationSet_ReplicationRegionProperty: typing.Optional[dict[str, models.aws_ssmincidents.CfnReplicationSet_ReplicationRegionPropertyDef]] = pydantic.Field(None)
    CfnResponsePlan_ActionProperty: typing.Optional[dict[str, models.aws_ssmincidents.CfnResponsePlan_ActionPropertyDef]] = pydantic.Field(None)
    CfnResponsePlan_ChatChannelProperty: typing.Optional[dict[str, models.aws_ssmincidents.CfnResponsePlan_ChatChannelPropertyDef]] = pydantic.Field(None)
    CfnResponsePlan_DynamicSsmParameterProperty: typing.Optional[dict[str, models.aws_ssmincidents.CfnResponsePlan_DynamicSsmParameterPropertyDef]] = pydantic.Field(None)
    CfnResponsePlan_DynamicSsmParameterValueProperty: typing.Optional[dict[str, models.aws_ssmincidents.CfnResponsePlan_DynamicSsmParameterValuePropertyDef]] = pydantic.Field(None)
    CfnResponsePlan_IncidentTemplateProperty: typing.Optional[dict[str, models.aws_ssmincidents.CfnResponsePlan_IncidentTemplatePropertyDef]] = pydantic.Field(None)
    CfnResponsePlan_IntegrationProperty: typing.Optional[dict[str, models.aws_ssmincidents.CfnResponsePlan_IntegrationPropertyDef]] = pydantic.Field(None)
    CfnResponsePlan_NotificationTargetItemProperty: typing.Optional[dict[str, models.aws_ssmincidents.CfnResponsePlan_NotificationTargetItemPropertyDef]] = pydantic.Field(None)
    CfnResponsePlan_PagerDutyConfigurationProperty: typing.Optional[dict[str, models.aws_ssmincidents.CfnResponsePlan_PagerDutyConfigurationPropertyDef]] = pydantic.Field(None)
    CfnResponsePlan_PagerDutyIncidentConfigurationProperty: typing.Optional[dict[str, models.aws_ssmincidents.CfnResponsePlan_PagerDutyIncidentConfigurationPropertyDef]] = pydantic.Field(None)
    CfnResponsePlan_SsmAutomationProperty: typing.Optional[dict[str, models.aws_ssmincidents.CfnResponsePlan_SsmAutomationPropertyDef]] = pydantic.Field(None)
    CfnResponsePlan_SsmParameterProperty: typing.Optional[dict[str, models.aws_ssmincidents.CfnResponsePlan_SsmParameterPropertyDef]] = pydantic.Field(None)
    CfnReplicationSet: typing.Optional[dict[str, models.aws_ssmincidents.CfnReplicationSetDef]] = pydantic.Field(None)
    CfnResponsePlan: typing.Optional[dict[str, models.aws_ssmincidents.CfnResponsePlanDef]] = pydantic.Field(None)
    CfnReplicationSetProps: typing.Optional[dict[str, models.aws_ssmincidents.CfnReplicationSetPropsDef]] = pydantic.Field(None)
    CfnResponsePlanProps: typing.Optional[dict[str, models.aws_ssmincidents.CfnResponsePlanPropsDef]] = pydantic.Field(None)
    ...
