...
class ActionDef(BaseClass):
    ...
    resource_config: typing.Optional[models.aws_codepipeline.ActionDefConfig] = pydantic.Field(None)


class ActionDefConfig(pydantic.BaseModel):
    bind: typing.Optional[list[models.aws_codepipeline.ActionDefBindParams]] = pydantic.Field(None, description='The callback invoked when this Action is added to a Pipeline.')
    on_state_change: typing.Optional[list[models.aws_codepipeline.ActionDefOnStateChangeParams]] = pydantic.Field(None, description='Creates an Event that will be triggered whenever the state of this Action changes.')
...
class ArtifactDef(BaseClass):
    ...
    resource_config: typing.Optional[models.aws_codepipeline.ArtifactDefConfig] = pydantic.Field(None)


class ArtifactDefConfig(pydantic.BaseModel):
    artifact: typing.Optional[list[models.aws_codepipeline.ArtifactDefArtifactParams]] = pydantic.Field(None, description='A static factory method used to create instances of the Artifact class.\nMainly meant to be used from ``decdk``.')
    at_path: typing.Optional[list[models.aws_codepipeline.ArtifactDefAtPathParams]] = pydantic.Field(None, description='Returns an ArtifactPath for a file within this artifact.\nCfnOutput is in the form "::"')
    get_metadata: typing.Optional[list[models.aws_codepipeline.ArtifactDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve the metadata stored in this artifact under the given key.\nIf there is no metadata stored under the given key,\nnull will be returned.')
    get_param: typing.Optional[list[models.aws_codepipeline.ArtifactDefGetParamParams]] = pydantic.Field(None, description='Returns a token for a value inside a JSON file within this artifact.')
    set_metadata: typing.Optional[list[models.aws_codepipeline.ArtifactDefSetMetadataParams]] = pydantic.Field(None, description='Add arbitrary extra payload to the artifact under a given key.\nThis can be used by CodePipeline actions to communicate data between themselves.\nIf metadata was already present under the given key,\nit will be overwritten with the new value.')
...
class ArtifactPathDef(BaseClass):
    artifact: typing.Union[models.aws_codepipeline.ArtifactDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='-')
    file_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='-')
    ...
    resource_config: typing.Optional[models.aws_codepipeline.ArtifactPathDefConfig] = pydantic.Field(None)


class ArtifactPathDefConfig(pydantic.BaseModel):
    artifact_path: typing.Optional[list[models.aws_codepipeline.ArtifactPathDefArtifactPathParams]] = pydantic.Field(None, description='')
...
class CustomActionRegistrationDef(BaseConstruct):
    ...
    category: typing.Union[aws_cdk.aws_codepipeline.ActionCategory, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The category of the Action.\n')
    provider: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description="The provider of the Action. For example, ``'MyCustomActionProvider'``\n")
...
class PipelineDef(BaseConstruct):
    ...
    from_pipeline_arn: typing.Optional[models.aws_codepipeline.PipelineDefFromPipelineArnParams] = pydantic.Field(None, description='Import a pipeline into this app.')
    resource_config: typing.Optional[models.aws_codepipeline.PipelineDefConfig] = pydantic.Field(None)
...
class PipelineDefConfig(pydantic.BaseModel):
    ...
    notify_on_any_action_state_change: typing.Optional[list[models.aws_codepipeline.PipelineDefNotifyOnAnyActionStateChangeParams]] = pydantic.Field(None, description='Define an notification rule triggered by the set of the "Action execution" events emitted from this pipeline.')
    notify_on_any_manual_approval_state_change: typing.Optional[list[models.aws_codepipeline.PipelineDefNotifyOnAnyManualApprovalStateChangeParams]] = pydantic.Field(None, description='Define an notification rule triggered by the set of the "Manual approval" events emitted from this pipeline.')
    notify_on_any_stage_state_change: typing.Optional[list[models.aws_codepipeline.PipelineDefNotifyOnAnyStageStateChangeParams]] = pydantic.Field(None, description='Define an notification rule triggered by the set of the "Stage execution" events emitted from this pipeline.')
    notify_on_execution_state_change: typing.Optional[list[models.aws_codepipeline.PipelineDefNotifyOnExecutionStateChangeParams]] = pydantic.Field(None, description='Define an notification rule triggered by the set of the "Pipeline execution" events emitted from this pipeline.')
    on_event: typing.Optional[list[models.aws_codepipeline.PipelineDefOnEventParams]] = pydantic.Field(None, description='Defines an event rule triggered by this CodePipeline.')
    on_state_change: typing.Optional[list[models.aws_codepipeline.PipelineDefOnStateChangeParams]] = pydantic.Field(None, description='Defines an event rule triggered by the "CodePipeline Pipeline Execution State Change" event emitted from this pipeline.')
    stage: typing.Optional[list[models.aws_codepipeline.PipelineDefStageParams]] = pydantic.Field(None, description="Access one of the pipeline's stages by stage name.")
...
class ActionArtifactBoundsDef(BaseStruct):
    max_inputs: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='')
    max_outputs: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='')
    min_inputs: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='')
    min_outputs: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='')
...
class ActionBindOptionsDef(BaseStruct):
    ...
    role: typing.Union[_REQUIRED_INIT_PARAM, models.aws_iam.LazyRoleDef, models.aws_iam.RoleDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='')
    ...
    resource_config: typing.Optional[models.aws_codepipeline.ActionBindOptionsDefConfig] = pydantic.Field(None)
...
class ActionPropertiesDef(BaseStruct):
    action_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='')
    artifact_bounds: typing.Union[_REQUIRED_INIT_PARAM, models.aws_codepipeline.ActionArtifactBoundsDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='')
    category: typing.Union[aws_cdk.aws_codepipeline.ActionCategory, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The category of the action. The category defines which action type the owner (the entity that performs the action) performs.\n')
    provider: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The service provider that the action calls.\n')
...
class CfnCustomActionType_ArtifactDetailsPropertyDef(BaseStruct):
    maximum_count: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The maximum number of artifacts allowed for the action type.\n')
    minimum_count: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The minimum number of artifacts allowed for the action type.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-codepipeline-customactiontype-artifactdetails.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_codepipeline as codepipeline\n\n    artifact_details_property = codepipeline.CfnCustomActionType.ArtifactDetailsProperty(\n        maximum_count=123,\n        minimum_count=123\n    )\n')
...
class CfnCustomActionType_ConfigurationPropertiesPropertyDef(BaseStruct):
    key: typing.Union[_REQUIRED_INIT_PARAM, bool, models.UnsupportedResource] = pydantic.Field(REQUIRED_INIT_PARAM, description='Whether the configuration property is a key.\n')
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the action configuration property.\n')
    required: typing.Union[_REQUIRED_INIT_PARAM, bool, models.UnsupportedResource] = pydantic.Field(REQUIRED_INIT_PARAM, description='Whether the configuration property is a required value.\n')
    secret: typing.Union[_REQUIRED_INIT_PARAM, bool, models.UnsupportedResource] = pydantic.Field(REQUIRED_INIT_PARAM, description='Whether the configuration property is secret. Secrets are hidden from all calls except for ``GetJobDetails`` , ``GetThirdPartyJobDetails`` , ``PollForJobs`` , and ``PollForThirdPartyJobs`` . When updating a pipeline, passing * * * * * without changing any other values of the action preserves the previous value of the secret.\n')
    ...
    queryable: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='Indicates that the property is used with ``PollForJobs`` . When creating a custom action, an action can have up to one queryable property. If it has one, that property must be both required and not secret. If you create a pipeline with a custom action type, and that custom action contains a queryable property, the value for that configuration property is subject to other restrictions. The value must be less than or equal to twenty (20) characters. The value can contain only alphanumeric characters, underscores, and hyphens.\n')
...
class CfnPipeline_ActionDeclarationPropertyDef(BaseStruct):
    action_type_id: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_codepipeline.CfnPipeline_ActionTypeIdPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='Specifies the action type and the provider of the action.\n')
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description="The action declaration's name.\n")
...
class CfnPipeline_ActionTypeIdPropertyDef(BaseStruct):
    category: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A category defines what kind of action can be taken in the stage, and constrains the provider type for the action. Valid categories are limited to one of the values below. - ``Source`` - ``Build`` - ``Test`` - ``Deploy`` - ``Invoke`` - ``Approval``\n')
    owner: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The creator of the action being called. There are three valid values for the ``Owner`` field in the action category section within your pipeline structure: ``AWS`` , ``ThirdParty`` , and ``Custom`` . For more information, see `Valid Action Types and Providers in CodePipeline <https://docs.aws.amazon.com/codepipeline/latest/userguide/reference-pipeline-structure.html#actions-valid-providers>`_ .\n')
    provider: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The provider of the service being called by the action. Valid providers are determined by the action category. For example, an action in the Deploy category type might have a provider of CodeDeploy, which would be specified as ``CodeDeploy`` . For more information, see `Valid Action Types and Providers in CodePipeline <https://docs.aws.amazon.com/codepipeline/latest/userguide/reference-pipeline-structure.html#actions-valid-providers>`_ .\n')
    version: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A string that describes the action version.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-codepipeline-pipeline-actiontypeid.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_codepipeline as codepipeline\n\n    action_type_id_property = codepipeline.CfnPipeline.ActionTypeIdProperty(\n        category="category",\n        owner="owner",\n        provider="provider",\n        version="version"\n    )\n')
...
class CfnPipeline_BlockerDeclarationPropertyDef(BaseStruct):
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Reserved for future use.\n')
    type: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Reserved for future use.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-codepipeline-pipeline-blockerdeclaration.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_codepipeline as codepipeline\n\n    blocker_declaration_property = codepipeline.CfnPipeline.BlockerDeclarationProperty(\n        name="name",\n        type="type"\n    )\n')
...
class CfnPipeline_EncryptionKeyPropertyDef(BaseStruct):
    type: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The type of encryption key, such as an AWS KMS key. When creating or updating a pipeline, the value must be set to \'KMS\'.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-codepipeline-pipeline-encryptionkey.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_codepipeline as codepipeline\n\n    encryption_key_property = codepipeline.CfnPipeline.EncryptionKeyProperty(\n        id="id",\n        type="type"\n    )\n')
...
class CfnPipeline_StageTransitionPropertyDef(BaseStruct):
    reason: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The reason given to the user that a stage is disabled, such as waiting for manual approval or manual tests. This message is displayed in the pipeline console UI.\n')
    stage_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the stage where you want to disable the inbound or outbound transition of artifacts.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-codepipeline-pipeline-stagetransition.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_codepipeline as codepipeline\n\n    stage_transition_property = codepipeline.CfnPipeline.StageTransitionProperty(\n        reason="reason",\n        stage_name="stageName"\n    )\n')
...
class CfnWebhook_WebhookFilterRulePropertyDef(BaseStruct):
    json_path: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A JsonPath expression that is applied to the body/payload of the webhook. The value selected by the JsonPath expression must match the value specified in the ``MatchEquals`` field. Otherwise, the request is ignored. For more information, see `Java JsonPath implementation <https://docs.aws.amazon.com/https://github.com/json-path/JsonPath>`_ in GitHub.\n')
...
class CommonActionPropsDef(BaseStruct):
    action_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The physical, human-readable name of the Action. Note that Action names must be unique within a single Stage.\n')
...
class CrossRegionSupportDef(BaseStruct):
    replication_bucket: typing.Union[_REQUIRED_INIT_PARAM, models.aws_s3.BucketBaseDef, models.aws_s3.BucketDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The replication Bucket used by CodePipeline to operate in this region. Belongs to ``stack``.\n')
    stack: typing.Union[models.StackDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Stack that has been created to house the replication Bucket required for this region.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    import aws_cdk as cdk\n    from aws_cdk import aws_codepipeline as codepipeline\n    from aws_cdk import aws_s3 as s3\n\n    # bucket: s3.Bucket\n    # stack: cdk.Stack\n\n    cross_region_support = codepipeline.CrossRegionSupport(\n        replication_bucket=bucket,\n        stack=stack\n    )\n')
    ...
    resource_config: typing.Optional[models.aws_codepipeline.CrossRegionSupportDefConfig] = pydantic.Field(None)
...
class CustomActionPropertyDef(BaseStruct):
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the property. You use this name in the ``configuration`` attribute when defining your custom Action class.\n')
    required: typing.Union[bool, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Whether this property is required.\n')
...
class StageOptionsDef(BaseStruct):
    stage_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The physical, human-readable name to assign to this Pipeline Stage.')
    actions: typing.Optional[typing.Sequence[typing.Union[models.aws_codepipeline.ActionDef, models.aws_codepipeline_actions.ActionDef, models.aws_codepipeline_actions.AlexaSkillDeployActionDef, models.aws_codepipeline_actions.CloudFormationCreateReplaceChangeSetActionDef, models.aws_codepipeline_actions.CloudFormationCreateUpdateStackActionDef, models.aws_codepipeline_actions.CloudFormationDeleteStackActionDef, models.aws_codepipeline_actions.CloudFormationDeployStackInstancesActionDef, models.aws_codepipeline_actions.CloudFormationDeployStackSetActionDef, models.aws_codepipeline_actions.CloudFormationExecuteChangeSetActionDef, models.aws_codepipeline_actions.CodeBuildActionDef, models.aws_codepipeline_actions.CodeCommitSourceActionDef, models.aws_codepipeline_actions.CodeDeployEcsDeployActionDef, models.aws_codepipeline_actions.CodeDeployServerDeployActionDef, models.aws_codepipeline_actions.CodeStarConnectionsSourceActionDef, models.aws_codepipeline_actions.EcrSourceActionDef, models.aws_codepipeline_actions.EcsDeployActionDef, models.aws_codepipeline_actions.ElasticBeanstalkDeployActionDef, models.aws_codepipeline_actions.GitHubSourceActionDef, models.aws_codepipeline_actions.JenkinsActionDef, models.aws_codepipeline_actions.LambdaInvokeActionDef, models.aws_codepipeline_actions.ManualApprovalActionDef, models.aws_codepipeline_actions.S3DeployActionDef, models.aws_codepipeline_actions.S3SourceActionDef, models.aws_codepipeline_actions.ServiceCatalogDeployActionBeta1Def, models.aws_codepipeline_actions.StepFunctionInvokeActionDef]]] = pydantic.Field(None, description='The list of Actions to create this Stage with. You can always add more Actions later by calling ``IStage#addAction``.\n')
    transition_disabled_reason: typing.Optional[str] = pydantic.Field(None, description="The reason for disabling transition to this stage. Only applicable if ``transitionToEnabled`` is set to ``false``. Default: 'Transition disabled'\n")
    transition_to_enabled: typing.Optional[bool] = pydantic.Field(None, description='Whether to enable transition to this stage. Default: true\n')
    placement: typing.Union[models.aws_codepipeline.StagePlacementDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
...
class CfnCustomActionTypeDef(BaseCfnResource):
    category: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The category of the custom action, such as a build action or a test action.\n')
    input_artifact_details: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_codepipeline.CfnCustomActionType_ArtifactDetailsPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The details of the input artifact for the action, such as its commit ID.\n')
    output_artifact_details: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_codepipeline.CfnCustomActionType_ArtifactDetailsPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The details of the output artifact of the action, such as its commit ID.\n')
    provider: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The provider of the service used in the custom action, such as CodeDeploy.\n')
    version: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The version identifier of the custom action.\n')
    configuration_properties: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_codepipeline.CfnCustomActionType_ConfigurationPropertiesPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The configuration properties for the custom action. .. epigraph:: You can refer to a name in the configuration properties of the custom action within the URL templates by following the format of {Config:name}, as long as the configuration property is both required and not secret. For more information, see `Create a Custom Action for a Pipeline <https://docs.aws.amazon.com/codepipeline/latest/userguide/how-to-create-custom-action.html>`_ .\n')
    settings: typing.Union[models.UnsupportedResource, models.aws_codepipeline.CfnCustomActionType_SettingsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='URLs that provide users information about this custom action.\n')
    ...
    resource_config: typing.Optional[models.aws_codepipeline.CfnCustomActionTypeDefConfig] = pydantic.Field(None)


class CfnCustomActionTypeDefConfig(pydantic.BaseModel):
    ArtifactDetailsProperty: typing.Optional[list[models.aws_codepipeline.CfnCustomActionTypeDefArtifactdetailspropertyParams]] = pydantic.Field(None, description='')
    ConfigurationPropertiesProperty: typing.Optional[list[models.aws_codepipeline.CfnCustomActionTypeDefConfigurationpropertiespropertyParams]] = pydantic.Field(None, description='')
    SettingsProperty: typing.Optional[list[models.aws_codepipeline.CfnCustomActionTypeDefSettingspropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_codepipeline.CfnCustomActionTypeDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_codepipeline.CfnCustomActionTypeDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_codepipeline.CfnCustomActionTypeDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_codepipeline.CfnCustomActionTypeDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_codepipeline.CfnCustomActionTypeDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_codepipeline.CfnCustomActionTypeDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_codepipeline.CfnCustomActionTypeDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_codepipeline.CfnCustomActionTypeDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_codepipeline.CfnCustomActionTypeDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_codepipeline.CfnCustomActionTypeDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_codepipeline.CfnCustomActionTypeDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_codepipeline.CfnCustomActionTypeDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_codepipeline.CfnCustomActionTypeDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
class CfnCustomActionTypeDefConfigurationpropertiespropertyParams(pydantic.BaseModel):
    key: typing.Union[bool, models.UnsupportedResource] = pydantic.Field(..., description='')
    name: str = pydantic.Field(..., description='')
    required: typing.Union[bool, models.UnsupportedResource] = pydantic.Field(..., description='')
    secret: typing.Union[bool, models.UnsupportedResource] = pydantic.Field(..., description='')
    description: typing.Optional[str] = pydantic.Field(None, description='')
    queryable: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
...
class CfnPipelineDef(BaseCfnResource):
    role_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Amazon Resource Name (ARN) for CodePipeline to use to either perform actions with no ``actionRoleArn`` , or to use to assume roles for actions with an ``actionRoleArn`` .\n')
    stages: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_codepipeline.CfnPipeline_StageDeclarationPropertyDef, dict[str, typing.Any]]]] = pydantic.Field(REQUIRED_INIT_PARAM, description='Represents information about a stage and its definition.\n')
    ...
    resource_config: typing.Optional[models.aws_codepipeline.CfnPipelineDefConfig] = pydantic.Field(None)


class CfnPipelineDefConfig(pydantic.BaseModel):
    ActionDeclarationProperty: typing.Optional[list[models.aws_codepipeline.CfnPipelineDefActiondeclarationpropertyParams]] = pydantic.Field(None, description='')
    ActionTypeIdProperty: typing.Optional[list[models.aws_codepipeline.CfnPipelineDefActiontypeidpropertyParams]] = pydantic.Field(None, description='')
    ArtifactStoreMapProperty: typing.Optional[list[models.aws_codepipeline.CfnPipelineDefArtifactstoremappropertyParams]] = pydantic.Field(None, description='')
    ...
    add_metadata: typing.Optional[list[models.aws_codepipeline.CfnPipelineDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_codepipeline.CfnPipelineDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_codepipeline.CfnPipelineDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_codepipeline.CfnPipelineDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_codepipeline.CfnPipelineDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_codepipeline.CfnPipelineDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_codepipeline.CfnPipelineDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_codepipeline.CfnPipelineDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_codepipeline.CfnPipelineDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_codepipeline.CfnPipelineDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
    tags_config: typing.Optional[models.core.TagManagerDefConfig] = pydantic.Field(None)

class CfnPipelineDefActiondeclarationpropertyParams(pydantic.BaseModel):
    action_type_id: typing.Union[models.UnsupportedResource, models.aws_codepipeline.CfnPipeline_ActionTypeIdPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    name: str = pydantic.Field(..., description='')
    configuration: typing.Any = pydantic.Field(None, description='')
    input_artifacts: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_codepipeline.CfnPipeline_InputArtifactPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    namespace: typing.Optional[str] = pydantic.Field(None, description='')
    output_artifacts: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_codepipeline.CfnPipeline_OutputArtifactPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
...
class CfnPipelineDefArtifactstoremappropertyParams(pydantic.BaseModel):
    artifact_store: typing.Union[models.UnsupportedResource, models.aws_codepipeline.CfnPipeline_ArtifactStorePropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
...
class CfnPipelineDefArtifactstorepropertyParams(pydantic.BaseModel):
    ...
    encryption_key: typing.Union[models.UnsupportedResource, models.aws_codepipeline.CfnPipeline_EncryptionKeyPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnWebhookDef(BaseCfnResource):
    authentication: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Supported options are GITHUB_HMAC, IP, and UNAUTHENTICATED. - For information about the authentication scheme implemented by GITHUB_HMAC, see `Securing your webhooks <https://docs.aws.amazon.com/https://developer.github.com/webhooks/securing/>`_ on the GitHub Developer website. - IP rejects webhooks trigger requests unless they originate from an IP address in the IP range whitelisted in the authentication configuration. - UNAUTHENTICATED accepts all webhook trigger requests regardless of origin.\n')
    authentication_configuration: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_codepipeline.CfnWebhook_WebhookAuthConfigurationPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='Properties that configure the authentication applied to incoming webhook trigger requests. The required properties depend on the authentication type. For GITHUB_HMAC, only the ``SecretToken`` property must be set. For IP, only the ``AllowedIPRange`` property must be set to a valid CIDR range. For UNAUTHENTICATED, no properties can be set.\n')
    filters: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_codepipeline.CfnWebhook_WebhookFilterRulePropertyDef, dict[str, typing.Any]]]] = pydantic.Field(REQUIRED_INIT_PARAM, description='A list of rules applied to the body/payload sent in the POST request to a webhook URL. All defined rules must pass for the request to be accepted and the pipeline started.\n')
    target_action: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the action in a pipeline you want to connect to the webhook. The action must be from the source (first) stage of the pipeline.\n')
    target_pipeline: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the pipeline you want to connect to the webhook.\n')
    target_pipeline_version: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The version number of the pipeline to be connected to the trigger request. Required: Yes Type: Integer Update requires: `No interruption <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-no-interrupt>`_\n')
    name: typing.Optional[str] = pydantic.Field(None, description='The name of the webhook.\n')
    register_with_third_party: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='Configures a connection between the webhook that was created and the external tool with events to be detected.')
    ...
    resource_config: typing.Optional[models.aws_codepipeline.CfnWebhookDefConfig] = pydantic.Field(None)


class CfnWebhookDefConfig(pydantic.BaseModel):
    WebhookAuthConfigurationProperty: typing.Optional[list[models.aws_codepipeline.CfnWebhookDefWebhookauthconfigurationpropertyParams]] = pydantic.Field(None, description='')
    WebhookFilterRuleProperty: typing.Optional[list[models.aws_codepipeline.CfnWebhookDefWebhookfilterrulepropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_codepipeline.CfnWebhookDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_codepipeline.CfnWebhookDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_codepipeline.CfnWebhookDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_codepipeline.CfnWebhookDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_codepipeline.CfnWebhookDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_codepipeline.CfnWebhookDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_codepipeline.CfnWebhookDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_codepipeline.CfnWebhookDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_codepipeline.CfnWebhookDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_codepipeline.CfnWebhookDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_codepipeline.CfnWebhookDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_codepipeline.CfnWebhookDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_codepipeline.CfnWebhookDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
class ModuleModel(pydantic.BaseModel):
    Action: typing.Optional[dict[str, models.aws_codepipeline.ActionDef]] = pydantic.Field(None)
    ...
    ActionBindOptions: typing.Optional[dict[str, models.aws_codepipeline.ActionBindOptionsDef]] = pydantic.Field(None)
    ActionConfig: typing.Optional[dict[str, models.aws_codepipeline.ActionConfigDef]] = pydantic.Field(None)
    ActionProperties: typing.Optional[dict[str, models.aws_codepipeline.ActionPropertiesDef]] = pydantic.Field(None)
    CfnCustomActionType_ArtifactDetailsProperty: typing.Optional[dict[str, models.aws_codepipeline.CfnCustomActionType_ArtifactDetailsPropertyDef]] = pydantic.Field(None)
    CfnCustomActionType_ConfigurationPropertiesProperty: typing.Optional[dict[str, models.aws_codepipeline.CfnCustomActionType_ConfigurationPropertiesPropertyDef]] = pydantic.Field(None)
    CfnCustomActionType_SettingsProperty: typing.Optional[dict[str, models.aws_codepipeline.CfnCustomActionType_SettingsPropertyDef]] = pydantic.Field(None)
    CfnPipeline_ActionDeclarationProperty: typing.Optional[dict[str, models.aws_codepipeline.CfnPipeline_ActionDeclarationPropertyDef]] = pydantic.Field(None)
    CfnPipeline_ActionTypeIdProperty: typing.Optional[dict[str, models.aws_codepipeline.CfnPipeline_ActionTypeIdPropertyDef]] = pydantic.Field(None)
    CfnPipeline_ArtifactStoreMapProperty: typing.Optional[dict[str, models.aws_codepipeline.CfnPipeline_ArtifactStoreMapPropertyDef]] = pydantic.Field(None)
    ...
    CommonAwsActionProps: typing.Optional[dict[str, models.aws_codepipeline.CommonAwsActionPropsDef]] = pydantic.Field(None)
    ...
    CfnCustomActionTypeProps: typing.Optional[dict[str, models.aws_codepipeline.CfnCustomActionTypePropsDef]] = pydantic.Field(None)
    CfnPipelineProps: typing.Optional[dict[str, models.aws_codepipeline.CfnPipelinePropsDef]] = pydantic.Field(None)
    CfnWebhookProps: typing.Optional[dict[str, models.aws_codepipeline.CfnWebhookPropsDef]] = pydantic.Field(None)
    ...
