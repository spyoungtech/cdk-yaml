...
class CfnDeviceProfile_LoRaWANDeviceProfilePropertyDef(BaseStruct):
    ...
    factory_preset_freqs_list: typing.Union[typing.Sequence[typing.Union[int, float]], typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description='The list of values that make up the FactoryPresetFreqs value. Valid range of values include a minimum value of 1000000 and a maximum value of 16700000.\n')
    ...
    supports32_bit_f_cnt: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description='The Supports32BitFCnt value.\n')
    supports_class_b: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description='The SupportsClassB value.\n')
    supports_class_c: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description='The SupportsClassC value.\n')
    supports_join: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description='The SupportsJoin value.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iotwireless-deviceprofile-lorawandeviceprofile.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_iotwireless as iotwireless\n\n    lo_ra_wANDevice_profile_property = iotwireless.CfnDeviceProfile.LoRaWANDeviceProfileProperty(\n        class_bTimeout=123,\n        class_cTimeout=123,\n        factory_preset_freqs_list=[123],\n        mac_version="macVersion",\n        max_duty_cycle=123,\n        max_eirp=123,\n        ping_slot_dr=123,\n        ping_slot_freq=123,\n        ping_slot_period=123,\n        reg_params_revision="regParamsRevision",\n        rf_region="rfRegion",\n        rx_data_rate2=123,\n        rx_delay1=123,\n        rx_dr_offset1=123,\n        rx_freq2=123,\n        supports32_bit_fCnt=False,\n        supports_class_b=False,\n        supports_class_c=False,\n        supports_join=False\n    )\n')
...
class CfnFuotaTask_LoRaWANPropertyDef(BaseStruct):
    rf_region: str = pydantic.Field(..., description='The frequency band (RFRegion) value.\n')
...
class CfnMulticastGroup_LoRaWANPropertyDef(BaseStruct):
    dl_class: str = pydantic.Field(..., description='DlClass for LoRaWAN. Valid values are ClassB and ClassC.\n')
    rf_region: str = pydantic.Field(..., description='The frequency band (RFRegion) value.\n')
...
class CfnServiceProfile_LoRaWANServiceProfilePropertyDef(BaseStruct):
    add_gw_metadata: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description='The AddGWMetaData value.\n')
    ...
    hr_allowed: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description="The HRAllowed value that describes whether handover roaming is allowed. This property is ``ReadOnly`` and can't be inputted for create. It's returned with ``Fn::GetAtt``\n")
    ...
    nwk_geo_loc: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description="The NwkGeoLoc value. This property is ``ReadOnly`` and can't be inputted for create. It's returned with ``Fn::GetAtt``\n")
    pr_allowed: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description="The PRAllowed value that describes whether passive roaming is allowed. This property is ``ReadOnly`` and can't be inputted for create. It's returned with ``Fn::GetAtt``\n")
    ra_allowed: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description='The RAAllowed value that describes whether roaming activation is allowed.\n')
    report_dev_status_battery: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description="The ReportDevStatusBattery value. This property is ``ReadOnly`` and can't be inputted for create. It's returned with ``Fn::GetAtt``\n")
    report_dev_status_margin: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description="The ReportDevStatusMargin value. This property is ``ReadOnly`` and can't be inputted for create. It's returned with ``Fn::GetAtt``\n")
...
class CfnTaskDefinition_LoRaWANUpdateGatewayTaskCreatePropertyDef(BaseStruct):
    current_version: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotwireless.CfnTaskDefinition_LoRaWANGatewayVersionPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The version of the gateways that should receive the update.\n')
    ...
    update_version: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotwireless.CfnTaskDefinition_LoRaWANGatewayVersionPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The firmware version to update the gateway to.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iotwireless-taskdefinition-lorawanupdategatewaytaskcreate.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_iotwireless as iotwireless\n\n    lo_ra_wANUpdate_gateway_task_create_property = iotwireless.CfnTaskDefinition.LoRaWANUpdateGatewayTaskCreateProperty(\n        current_version=iotwireless.CfnTaskDefinition.LoRaWANGatewayVersionProperty(\n            model="model",\n            package_version="packageVersion",\n            station="station"\n        ),\n        sig_key_crc=123,\n        update_signature="updateSignature",\n        update_version=iotwireless.CfnTaskDefinition.LoRaWANGatewayVersionProperty(\n            model="model",\n            package_version="packageVersion",\n            station="station"\n        )\n    )\n')
...
class CfnTaskDefinition_UpdateWirelessGatewayTaskCreatePropertyDef(BaseStruct):
    lo_ra_wan: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotwireless.CfnTaskDefinition_LoRaWANUpdateGatewayTaskCreatePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The properties that relate to the LoRaWAN wireless gateway.\n')
...
class CfnWirelessDevice_AbpV10xPropertyDef(BaseStruct):
    dev_addr: str = pydantic.Field(..., description='The DevAddr value.\n')
    session_keys: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotwireless.CfnWirelessDevice_SessionKeysAbpV10xPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='Session keys for ABP v1.0.x.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iotwireless-wirelessdevice-abpv10x.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_iotwireless as iotwireless\n\n    abp_v10x_property = iotwireless.CfnWirelessDevice.AbpV10xProperty(\n        dev_addr="devAddr",\n        session_keys=iotwireless.CfnWirelessDevice.SessionKeysAbpV10xProperty(\n            app_sKey="appSKey",\n            nwk_sKey="nwkSKey"\n        )\n    )\n')
...
class CfnWirelessDevice_AbpV11PropertyDef(BaseStruct):
    dev_addr: str = pydantic.Field(..., description='The DevAddr value.\n')
    session_keys: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotwireless.CfnWirelessDevice_SessionKeysAbpV11PropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='Session keys for ABP v1.1.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iotwireless-wirelessdevice-abpv11.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_iotwireless as iotwireless\n\n    abp_v11_property = iotwireless.CfnWirelessDevice.AbpV11Property(\n        dev_addr="devAddr",\n        session_keys=iotwireless.CfnWirelessDevice.SessionKeysAbpV11Property(\n            app_sKey="appSKey",\n            f_nwk_sInt_key="fNwkSIntKey",\n            nwk_sEnc_key="nwkSEncKey",\n            s_nwk_sInt_key="sNwkSIntKey"\n        )\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['dev_addr', 'session_keys']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnWirelessDevice_LoRaWANDevicePropertyDef(BaseStruct):
    abp_v10_x: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotwireless.CfnWirelessDevice_AbpV10xPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='LoRaWAN object for create APIs.\n')
    abp_v11: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotwireless.CfnWirelessDevice_AbpV11PropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='ABP device object for create APIs for v1.1.\n')
    ...
    otaa_v10_x: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotwireless.CfnWirelessDevice_OtaaV10xPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='OTAA device object for create APIs for v1.0.x.\n')
    otaa_v11: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotwireless.CfnWirelessDevice_OtaaV11PropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='OTAA device object for v1.1 for create APIs.\n')
...
class CfnWirelessGateway_LoRaWANGatewayPropertyDef(BaseStruct):
    gateway_eui: str = pydantic.Field(..., description="The gateway's EUI value.\n")
...
class CfnDestinationDef(BaseCfnResource):
    expression: str = pydantic.Field(..., description='The rule name to send messages to.\n')
    expression_type: str = pydantic.Field(..., description='The type of value in ``Expression`` .\n')
    name: str = pydantic.Field(..., description='The name of the new resource.\n')
    role_arn: str = pydantic.Field(..., description='The ARN of the IAM Role that authorizes the destination.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['expression', 'expression_type', 'name', 'role_arn', 'description', 'tags']
...
class CfnDeviceProfileDef(BaseCfnResource):
    lo_ra_wan: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotwireless.CfnDeviceProfile_LoRaWANDeviceProfilePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='LoRaWAN device profile object.\n')
...
class CfnFuotaTaskDef(BaseCfnResource):
    firmware_update_image: str = pydantic.Field(..., description='The S3 URI points to a firmware update image that is to be used with a FUOTA task.\n')
    firmware_update_role: str = pydantic.Field(..., description='The firmware update role that is to be used with a FUOTA task.\n')
    lo_ra_wan: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotwireless.CfnFuotaTask_LoRaWANPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='The LoRaWAN information used with a FUOTA task.\n')
...
class CfnMulticastGroupDef(BaseCfnResource):
    lo_ra_wan: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotwireless.CfnMulticastGroup_LoRaWANPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='The LoRaWAN information that is to be used with the multicast group.\n')
    associate_wireless_device: typing.Optional[str] = pydantic.Field(None, description='The ID of the wireless device to associate with a multicast group.\n')
...
class CfnNetworkAnalyzerConfigurationDef(BaseCfnResource):
    name: str = pydantic.Field(..., description='Name of the network analyzer configuration.\n')
...
class CfnPartnerAccountDef(BaseCfnResource):
    account_linked: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description='``AWS::IoTWireless::PartnerAccount.AccountLinked``.\n')
    partner_account_id: typing.Optional[str] = pydantic.Field(None, description='The ID of the partner account to update.\n')
    partner_type: typing.Optional[str] = pydantic.Field(None, description='``AWS::IoTWireless::PartnerAccount.PartnerType``.\n')
    sidewalk: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotwireless.CfnPartnerAccount_SidewalkAccountInfoPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The Sidewalk account credentials.\n')
    sidewalk_response: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotwireless.CfnPartnerAccount_SidewalkAccountInfoWithFingerprintPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='``AWS::IoTWireless::PartnerAccount.SidewalkResponse``.\n')
    sidewalk_update: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotwireless.CfnPartnerAccount_SidewalkUpdateAccountPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='``AWS::IoTWireless::PartnerAccount.SidewalkUpdate``.\n')
    tags: typing.Optional[typing.Sequence[typing.Union[models.CfnTagDef, dict[str, typing.Any]]]] = pydantic.Field(None, description='The tags are an array of key-value pairs to attach to the specified resource. Tags can have a minimum of 0 and a maximum of 50 items.')
...
class CfnServiceProfileDef(BaseCfnResource):
    lo_ra_wan: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotwireless.CfnServiceProfile_LoRaWANServiceProfilePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='LoRaWAN service profile object.\n')
    name: typing.Optional[str] = pydantic.Field(None, description='The name of the new resource.\n')
    tags: typing.Optional[typing.Sequence[typing.Union[models.CfnTagDef, dict[str, typing.Any]]]] = pydantic.Field(None, description='The tags are an array of key-value pairs to attach to the specified resource. Tags can have a minimum of 0 and a maximum of 50 items.')
    _init_params: typing.ClassVar[list[str]] = ['lo_ra_wan', 'name', 'tags']
...
class CfnServiceProfileDefConfig(pydantic.BaseModel):
    ...
    attr_lo_ra_wan_pr_allowed_config: typing.Optional[models._interface_methods.CoreIResolvableDefConfig] = pydantic.Field(None)
    attr_lo_ra_wan_ra_allowed_config: typing.Optional[models._interface_methods.CoreIResolvableDefConfig] = pydantic.Field(None)
...
class CfnTaskDefinitionDef(BaseCfnResource):
    auto_create_tasks: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef]] = pydantic.Field(..., description='Whether to automatically create tasks using this task definition for all gateways with the specified current version. If ``false`` , the task must be created by calling ``CreateWirelessGatewayTask`` .\n')
    lo_ra_wan_update_gateway_task_entry: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotwireless.CfnTaskDefinition_LoRaWANUpdateGatewayTaskEntryPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='``AWS::IoTWireless::TaskDefinition.LoRaWANUpdateGatewayTaskEntry``.\n')
    name: typing.Optional[str] = pydantic.Field(None, description='The name of the new resource.\n')
    tags: typing.Optional[typing.Sequence[typing.Union[models.CfnTagDef, dict[str, typing.Any]]]] = pydantic.Field(None, description='The tags are an array of key-value pairs to attach to the specified resource. Tags can have a minimum of 0 and a maximum of 50 items.\n')
    task_definition_type: typing.Optional[str] = pydantic.Field(None, description='``AWS::IoTWireless::TaskDefinition.TaskDefinitionType``.\n')
    update: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotwireless.CfnTaskDefinition_UpdateWirelessGatewayTaskCreatePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Information about the gateways to update.')
...
class CfnTaskDefinitionDefLorawanupdategatewaytaskcreatepropertyParams(pydantic.BaseModel):
    current_version: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotwireless.CfnTaskDefinition_LoRaWANGatewayVersionPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
...
class CfnWirelessDeviceDef(BaseCfnResource):
    destination_name: str = pydantic.Field(..., description="The name of the destination to assign to the new wireless device. Can have only have alphanumeric, - (hyphen) and _ (underscore) characters and it can't have any spaces.\n")
    type: str = pydantic.Field(..., description='The wireless device type.\n')
    ...
    lo_ra_wan: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotwireless.CfnWirelessDevice_LoRaWANDevicePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The device configuration information to use to create the wireless device. Must be at least one of OtaaV10x, OtaaV11, AbpV11, or AbpV10x.\n')
    name: typing.Optional[str] = pydantic.Field(None, description='The name of the new resource.\n')
    tags: typing.Optional[typing.Sequence[typing.Union[models.CfnTagDef, dict[str, typing.Any]]]] = pydantic.Field(None, description='The tags are an array of key-value pairs to attach to the specified resource. Tags can have a minimum of 0 and a maximum of 50 items.\n')
...
class CfnWirelessDeviceDefAbpv10XpropertyParams(pydantic.BaseModel):
    ...
    session_keys: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotwireless.CfnWirelessDevice_SessionKeysAbpV10xPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    ...
...
class CfnWirelessDeviceDefLorawandevicepropertyParams(pydantic.BaseModel):
    abp_v10_x: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotwireless.CfnWirelessDevice_AbpV10xPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    abp_v11: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotwireless.CfnWirelessDevice_AbpV11PropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
    otaa_v10_x: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotwireless.CfnWirelessDevice_OtaaV10xPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    otaa_v11: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotwireless.CfnWirelessDevice_OtaaV11PropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
...
class CfnWirelessDeviceImportTaskDef(BaseCfnResource):
    destination_name: str = pydantic.Field(..., description='The name of the destination that describes the IoT rule to route messages from the Sidewalk devices in the import task to other applications.\n')
    sidewalk: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotwireless.CfnWirelessDeviceImportTask_SidewalkPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='The Sidewalk-related information of the wireless device import task.\n')
...
class CfnWirelessGatewayDef(BaseCfnResource):
    lo_ra_wan: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iotwireless.CfnWirelessGateway_LoRaWANGatewayPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='The gateway configuration information to use to create the wireless gateway.\n')
