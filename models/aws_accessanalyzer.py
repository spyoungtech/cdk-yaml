...
#  autogenerated from aws_cdk.aws_accessanalyzer.CfnAnalyzer.AnalyzerConfigurationProperty
class CfnAnalyzer_AnalyzerConfigurationPropertyDef(BaseStruct):
    unused_access_configuration: typing.Union[models.UnsupportedResource, models.aws_accessanalyzer.CfnAnalyzer_UnusedAccessConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Specifies the configuration of an unused access analyzer for an AWS organization or account. External access analyzers do not support any configuration.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-accessanalyzer-analyzer-analyzerconfiguration.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_accessanalyzer as accessanalyzer\n\n    analyzer_configuration_property = accessanalyzer.CfnAnalyzer.AnalyzerConfigurationProperty(\n        unused_access_configuration=accessanalyzer.CfnAnalyzer.UnusedAccessConfigurationProperty(\n            unused_access_age=123\n        )\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['unused_access_configuration']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_accessanalyzer.CfnAnalyzer.AnalyzerConfigurationProperty'
...
#  autogenerated from aws_cdk.aws_accessanalyzer.CfnAnalyzer.UnusedAccessConfigurationProperty
class CfnAnalyzer_UnusedAccessConfigurationPropertyDef(BaseStruct):
    unused_access_age: typing.Union[int, float, None] = pydantic.Field(None, description="The specified access age in days for which to generate findings for unused access. For example, if you specify 90 days, the analyzer will generate findings for IAM entities within the accounts of the selected organization for any access that hasn't been used in 90 or more days since the analyzer's last scan. You can choose a value between 1 and 180 days.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-accessanalyzer-analyzer-unusedaccessconfiguration.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_accessanalyzer as accessanalyzer\n\n    unused_access_configuration_property = accessanalyzer.CfnAnalyzer.UnusedAccessConfigurationProperty(\n        unused_access_age=123\n    )\n")
    _init_params: typing.ClassVar[list[str]] = ['unused_access_age']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_accessanalyzer.CfnAnalyzer.UnusedAccessConfigurationProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class CfnAnalyzerDef(BaseCfnResource):
    type: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The type represents the zone of trust for the analyzer. *Allowed Values* : ACCOUNT | ORGANIZATION | ACCOUNT_UNUSED_ACCESS | ORGANIZATION_UNUSED_ACCESS\n')
    analyzer_configuration: typing.Union[models.UnsupportedResource, models.aws_accessanalyzer.CfnAnalyzer_AnalyzerConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Contains information about the configuration of an unused access analyzer for an AWS organization or account.\n')
    analyzer_name: typing.Optional[str] = pydantic.Field(None, description='The name of the analyzer.\n')
    archive_rules: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_accessanalyzer.CfnAnalyzer_ArchiveRulePropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='Specifies the archive rules to add for the analyzer. Archive rules automatically archive findings that meet the criteria you define for the rule.\n')
    tags: typing.Optional[typing.Sequence[typing.Union[models.CfnTagDef, dict[str, typing.Any]]]] = pydantic.Field(None, description='An array of key-value pairs to apply to the analyzer.')
    _init_params: typing.ClassVar[list[str]] = ['type', 'analyzer_configuration', 'analyzer_name', 'archive_rules', 'tags']
    _method_names: typing.ClassVar[list[str]] = ['AnalyzerConfigurationProperty', 'ArchiveRuleProperty', 'FilterProperty', 'UnusedAccessConfigurationProperty', 'add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnAnalyzerDefConfig(pydantic.BaseModel):
    AnalyzerConfigurationProperty: typing.Optional[list[models.aws_accessanalyzer.CfnAnalyzerDefAnalyzerconfigurationpropertyParams]] = pydantic.Field(None, description='')
    ...
    UnusedAccessConfigurationProperty: typing.Optional[list[models.aws_accessanalyzer.CfnAnalyzerDefUnusedaccessconfigurationpropertyParams]] = pydantic.Field(None, description='')
...
class CfnAnalyzerDefAnalyzerconfigurationpropertyParams(pydantic.BaseModel):
    unused_access_configuration: typing.Union[models.UnsupportedResource, models.aws_accessanalyzer.CfnAnalyzer_UnusedAccessConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnAnalyzerDefUnusedaccessconfigurationpropertyParams(pydantic.BaseModel):
    unused_access_age: typing.Union[int, float, None] = pydantic.Field(None, description='')
    ...
...
class ModuleModel(pydantic.BaseModel):
    CfnAnalyzer_AnalyzerConfigurationProperty: typing.Optional[dict[str, models.aws_accessanalyzer.CfnAnalyzer_AnalyzerConfigurationPropertyDef]] = pydantic.Field(None)
    ...
    CfnAnalyzer_UnusedAccessConfigurationProperty: typing.Optional[dict[str, models.aws_accessanalyzer.CfnAnalyzer_UnusedAccessConfigurationPropertyDef]] = pydantic.Field(None)
