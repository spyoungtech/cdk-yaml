...
class AuthenticateCognitoActionDef(BaseClass):
    next: models.aws_elasticloadbalancingv2.ListenerActionDef = pydantic.Field(..., description='What action to execute next. Multiple actions form a linked chain; the chain must always terminate in a (weighted)forward, fixedResponse or redirect action.\n')
    user_pool: typing.Union[models.aws_cognito.UserPoolDef] = pydantic.Field(..., description='The Amazon Cognito user pool.\n')
    user_pool_client: typing.Union[models.aws_cognito.UserPoolClientDef] = pydantic.Field(..., description='The Amazon Cognito user pool client.\n')
    user_pool_domain: typing.Union[models.aws_cognito.UserPoolDomainDef] = pydantic.Field(..., description='The domain prefix or fully-qualified domain name of the Amazon Cognito user pool.\n')
