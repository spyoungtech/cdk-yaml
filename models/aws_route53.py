...
#  autogenerated from aws_cdk.aws_route53.GeoLocation
class GeoLocationDef(BaseClass):
    _init_params: typing.ClassVar[list[str]] = []
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = ['continent', 'country', 'default', 'subdivision']
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_route53.GeoLocation'
...
class AaaaRecordDef(BaseConstruct):
    target: typing.Union[models.aws_route53.RecordTargetDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The target.\n')
    zone: typing.Union[_REQUIRED_INIT_PARAM, models.aws_route53.HostedZoneDef, models.aws_route53.PrivateHostedZoneDef, models.aws_route53.PublicHostedZoneDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The hosted zone in which to define the new record.\n')
    ...
    geo_location: typing.Optional[models.aws_route53.GeoLocationDef] = pydantic.Field(None, description="The geographical origin for this record to return DNS records based on the user's location.\n")
    multi_value_answer: typing.Optional[bool] = pydantic.Field(None, description='Whether to return multiple values, such as IP addresses for your web servers, in response to DNS queries. Default: false\n')
    ...
    region: typing.Optional[str] = pydantic.Field(None, description='The Amazon EC2 Region where you created the resource that this resource record set refers to. The resource typically is an AWS resource, such as an EC2 instance or an ELB load balancer, and is referred to by an IP address or a DNS domain name, depending on the record type. When Amazon Route 53 receives a DNS query for a domain name and type for which you have created latency resource record sets, Route 53 selects the latency resource record set that has the lowest latency between the end user and the associated Amazon EC2 Region. Route 53 then returns the value that is associated with the selected resource record set. Default: - Do not set latency based routing\n')
    set_identifier: typing.Optional[str] = pydantic.Field(None, description='A string used to distinguish between different records with the same combination of DNS name and type. It can only be set when either weight or geoLocation is defined. This parameter must be between 1 and 128 characters in length. Default: - Auto generated string\n')
...
class ARecordDef(BaseConstruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['target', 'zone', 'comment', 'delete_existing', 'geo_location', 'multi_value_answer', 'record_name', 'region', 'set_identifier', 'ttl', 'weight']
    _method_names: typing.ClassVar[list[str]] = ['apply_removal_policy']
    _classmethod_names: typing.ClassVar[list[str]] = ['from_a_record_attributes']
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_route53.ARecord'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = ['from_a_record_attributes']
    ...


    from_a_record_attributes: typing.Optional[models.aws_route53.ARecordDefFromARecordAttributesParams] = pydantic.Field(None, description='Creates new A record of type alias with target set to an existing A Record DNS.\nUse when the target A record is created outside of CDK\nFor records created as part of CDK use')
...
class ARecordDefFromARecordAttributesParams(pydantic.BaseModel):
    scope: models.constructs.ConstructDef = pydantic.Field(..., description='the parent Construct for this Construct.\n')
    id: str = pydantic.Field(..., description='Logical Id of the resource.\n')
    target_dns: str = pydantic.Field(..., description='Existing A record DNS name to set RecordTarget.\n')
...
class CaaAmazonRecordDef(BaseConstruct):
    ...
    ttl: typing.Optional[models.DurationDef] = pydantic.Field(None, description='The resource record cache time to live (TTL). Default: Duration.minutes(30)\n')
    weight: typing.Union[int, float, None] = pydantic.Field(None, description="Among resource record sets that have the same combination of DNS name and type, a value that determines the proportion of DNS queries that Amazon Route 53 responds to using the current resource record set. Route 53 calculates the sum of the weights for the resource record sets that have the same combination of DNS name and type. Route 53 then responds to queries based on the ratio of a resource's weight to the total. This value can be a number between 0 and 255. Default: - Do not set weighted routing")
    _init_params: typing.ClassVar[list[str]] = ['zone', 'comment', 'delete_existing', 'geo_location', 'multi_value_answer', 'record_name', 'region', 'set_identifier', 'ttl', 'weight']
    _method_names: typing.ClassVar[list[str]] = ['apply_removal_policy']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CaaRecordDef(BaseConstruct):
    values: typing.Union[typing.Sequence[typing.Union[models.aws_route53.CaaRecordValueDef, dict[str, typing.Any]]], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The values.\n')
    zone: typing.Union[_REQUIRED_INIT_PARAM, models.aws_route53.HostedZoneDef, models.aws_route53.PrivateHostedZoneDef, models.aws_route53.PublicHostedZoneDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The hosted zone in which to define the new record.\n')
    comment: typing.Optional[str] = pydantic.Field(None, description='A comment to add on the record. Default: no comment\n')
    delete_existing: typing.Optional[bool] = pydantic.Field(None, description='Whether to delete the same record set in the hosted zone if it already exists (dangerous!). This allows to deploy a new record set while minimizing the downtime because the new record set will be created immediately after the existing one is deleted. It also avoids "manual" actions to delete existing record sets. .. epigraph:: **N.B.:** this feature is dangerous, use with caution! It can only be used safely when ``deleteExisting`` is set to ``true`` as soon as the resource is added to the stack. Changing an existing Record Set\'s ``deleteExisting`` property from ``false -> true`` after deployment will delete the record! Default: false\n')
    geo_location: typing.Optional[models.aws_route53.GeoLocationDef] = pydantic.Field(None, description="The geographical origin for this record to return DNS records based on the user's location.\n")
    ...
    ttl: typing.Optional[models.DurationDef] = pydantic.Field(None, description='The resource record cache time to live (TTL). Default: Duration.minutes(30)\n')
    weight: typing.Union[int, float, None] = pydantic.Field(None, description="Among resource record sets that have the same combination of DNS name and type, a value that determines the proportion of DNS queries that Amazon Route 53 responds to using the current resource record set. Route 53 calculates the sum of the weights for the resource record sets that have the same combination of DNS name and type. Route 53 then responds to queries based on the ratio of a resource's weight to the total. This value can be a number between 0 and 255. Default: - Do not set weighted routing")
    _init_params: typing.ClassVar[list[str]] = ['values', 'zone', 'comment', 'delete_existing', 'geo_location', 'multi_value_answer', 'record_name', 'region', 'set_identifier', 'ttl', 'weight']
    _method_names: typing.ClassVar[list[str]] = ['apply_removal_policy']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CnameRecordDef(BaseConstruct):
    domain_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The domain name of the target that this record should point to.\n')
    zone: typing.Union[_REQUIRED_INIT_PARAM, models.aws_route53.HostedZoneDef, models.aws_route53.PrivateHostedZoneDef, models.aws_route53.PublicHostedZoneDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The hosted zone in which to define the new record.\n')
    comment: typing.Optional[str] = pydantic.Field(None, description='A comment to add on the record. Default: no comment\n')
    delete_existing: typing.Optional[bool] = pydantic.Field(None, description='Whether to delete the same record set in the hosted zone if it already exists (dangerous!). This allows to deploy a new record set while minimizing the downtime because the new record set will be created immediately after the existing one is deleted. It also avoids "manual" actions to delete existing record sets. .. epigraph:: **N.B.:** this feature is dangerous, use with caution! It can only be used safely when ``deleteExisting`` is set to ``true`` as soon as the resource is added to the stack. Changing an existing Record Set\'s ``deleteExisting`` property from ``false -> true`` after deployment will delete the record! Default: false\n')
    geo_location: typing.Optional[models.aws_route53.GeoLocationDef] = pydantic.Field(None, description="The geographical origin for this record to return DNS records based on the user's location.\n")
    ...
    ttl: typing.Optional[models.DurationDef] = pydantic.Field(None, description='The resource record cache time to live (TTL). Default: Duration.minutes(30)\n')
    weight: typing.Union[int, float, None] = pydantic.Field(None, description="Among resource record sets that have the same combination of DNS name and type, a value that determines the proportion of DNS queries that Amazon Route 53 responds to using the current resource record set. Route 53 calculates the sum of the weights for the resource record sets that have the same combination of DNS name and type. Route 53 then responds to queries based on the ratio of a resource's weight to the total. This value can be a number between 0 and 255. Default: - Do not set weighted routing")
    _init_params: typing.ClassVar[list[str]] = ['domain_name', 'zone', 'comment', 'delete_existing', 'geo_location', 'multi_value_answer', 'record_name', 'region', 'set_identifier', 'ttl', 'weight']
    _method_names: typing.ClassVar[list[str]] = ['apply_removal_policy']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CrossAccountZoneDelegationRecordDef(BaseConstruct):
    delegated_zone: typing.Union[_REQUIRED_INIT_PARAM, models.aws_route53.HostedZoneDef, models.aws_route53.PrivateHostedZoneDef, models.aws_route53.PublicHostedZoneDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The zone to be delegated.\n')
    delegation_role: typing.Union[_REQUIRED_INIT_PARAM, models.aws_iam.LazyRoleDef, models.aws_iam.RoleDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The delegation role in the parent account.\n')
    assume_role_region: typing.Optional[str] = pydantic.Field(None, description='Region from which to obtain temporary credentials. Default: - the Route53 signing region in the current partition\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['delegated_zone', 'delegation_role', 'assume_role_region', 'parent_hosted_zone_id', 'parent_hosted_zone_name', 'removal_policy', 'ttl']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class DsRecordDef(BaseConstruct):
    values: typing.Union[typing.Sequence[str], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The DS values.\n')
    zone: typing.Union[_REQUIRED_INIT_PARAM, models.aws_route53.HostedZoneDef, models.aws_route53.PrivateHostedZoneDef, models.aws_route53.PublicHostedZoneDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The hosted zone in which to define the new record.\n')
    comment: typing.Optional[str] = pydantic.Field(None, description='A comment to add on the record. Default: no comment\n')
    delete_existing: typing.Optional[bool] = pydantic.Field(None, description='Whether to delete the same record set in the hosted zone if it already exists (dangerous!). This allows to deploy a new record set while minimizing the downtime because the new record set will be created immediately after the existing one is deleted. It also avoids "manual" actions to delete existing record sets. .. epigraph:: **N.B.:** this feature is dangerous, use with caution! It can only be used safely when ``deleteExisting`` is set to ``true`` as soon as the resource is added to the stack. Changing an existing Record Set\'s ``deleteExisting`` property from ``false -> true`` after deployment will delete the record! Default: false\n')
    geo_location: typing.Optional[models.aws_route53.GeoLocationDef] = pydantic.Field(None, description="The geographical origin for this record to return DNS records based on the user's location.\n")
...
class HostedZoneDef(BaseConstruct):
    ...
    zone_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the domain. For resource record types that include a domain name, specify a fully qualified domain name.\n')
    ...
    _method_names: typing.ClassVar[list[str]] = ['add_vpc', 'apply_removal_policy', 'enable_dnssec', 'grant_delegation']
...
class HostedZoneDefConfig(pydantic.BaseModel):
    ...
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    enable_dnssec: typing.Optional[list[models.aws_route53.HostedZoneDefEnableDnssecParams]] = pydantic.Field(None, description='Enable DNSSEC for this hosted zone.\nThis will create a key signing key with the given options and enable DNSSEC signing\nfor the hosted zone.')
...
class HostedZoneDefEnableDnssecParams(pydantic.BaseModel):
    kms_key: typing.Union[models.aws_kms.KeyDef] = pydantic.Field(..., description='The customer-managed KMS key that that will be used to sign the records. The KMS Key must be unique for each KSK within a hosted zone. Additionally, the KMS key must be an asymetric customer-managed key using the ECC_NIST_P256 algorithm.\n')
    key_signing_key_name: typing.Optional[str] = pydantic.Field(None, description='The name for the key signing key. This name must be unique within a hosted zone. Default: an autogenerated name')
    return_config: typing.Optional[list[models._interface_methods.AwsRoute53IKeySigningKeyDefConfig]] = pydantic.Field(None)
    ...
...
class HostedZoneDefGrantDelegationParams(pydantic.BaseModel):
    grantee: models.AnyResource = pydantic.Field(..., description='-')
    return_config: typing.Optional[list[models.aws_iam.GrantDefConfig]] = pydantic.Field(None)
    ...


#  autogenerated from aws_cdk.aws_route53.KeySigningKey
class KeySigningKeyDef(BaseConstruct):
    hosted_zone: typing.Union[_REQUIRED_INIT_PARAM, models.aws_route53.HostedZoneDef, models.aws_route53.PrivateHostedZoneDef, models.aws_route53.PublicHostedZoneDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The hosted zone that this key will be used to sign.\n')
    kms_key: typing.Union[_REQUIRED_INIT_PARAM, models.aws_kms.KeyDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The customer-managed KMS key that that will be used to sign the records. The KMS Key must be unique for each KSK within a hosted zone. Additionally, the KMS key must be an asymetric customer-managed key using the ECC_NIST_P256 algorithm.\n')
    key_signing_key_name: typing.Optional[str] = pydantic.Field(None, description='The name for the key signing key. This name must be unique within a hosted zone. Default: an autogenerated name\n')
    status: typing.Optional[aws_cdk.aws_route53.KeySigningKeyStatus] = pydantic.Field(None, description='The status of the key signing key. Default: ACTIVE')
    _init_params: typing.ClassVar[list[str]] = ['hosted_zone', 'kms_key', 'key_signing_key_name', 'status']
    _method_names: typing.ClassVar[list[str]] = ['apply_removal_policy']
    _classmethod_names: typing.ClassVar[list[str]] = ['from_key_signing_key_attributes']
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_route53.KeySigningKey'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = ['from_key_signing_key_attributes']
    ...


    from_key_signing_key_attributes: typing.Optional[models.aws_route53.KeySigningKeyDefFromKeySigningKeyAttributesParams] = pydantic.Field(None, description='Imports a key signing key from its attributes.')
    resource_config: typing.Optional[models.aws_route53.KeySigningKeyDefConfig] = pydantic.Field(None)


class KeySigningKeyDefConfig(pydantic.BaseModel):
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    hosted_zone_config: typing.Optional[models._interface_methods.AwsRoute53IHostedZoneDefConfig] = pydantic.Field(None)

class KeySigningKeyDefApplyRemovalPolicyParams(pydantic.BaseModel):
    policy: aws_cdk.RemovalPolicy = pydantic.Field(..., description='-')
    ...

class KeySigningKeyDefFromKeySigningKeyAttributesParams(pydantic.BaseModel):
    scope: models.constructs.ConstructDef = pydantic.Field(..., description='-\n')
    id: str = pydantic.Field(..., description='-\n')
    hosted_zone: typing.Union[models.aws_route53.HostedZoneDef, models.aws_route53.PrivateHostedZoneDef, models.aws_route53.PublicHostedZoneDef] = pydantic.Field(..., description='The hosted zone that the key signing key signs.\n')
    key_signing_key_name: str = pydantic.Field(..., description='The name of the key signing key.')
    ...


#  autogenerated from aws_cdk.aws_route53.MxRecord
class MxRecordDef(BaseConstruct):
    values: typing.Union[typing.Sequence[typing.Union[models.aws_route53.MxRecordValueDef, dict[str, typing.Any]]], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The values.\n')
    zone: typing.Union[_REQUIRED_INIT_PARAM, models.aws_route53.HostedZoneDef, models.aws_route53.PrivateHostedZoneDef, models.aws_route53.PublicHostedZoneDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The hosted zone in which to define the new record.\n')
    comment: typing.Optional[str] = pydantic.Field(None, description='A comment to add on the record. Default: no comment\n')
    delete_existing: typing.Optional[bool] = pydantic.Field(None, description='Whether to delete the same record set in the hosted zone if it already exists (dangerous!). This allows to deploy a new record set while minimizing the downtime because the new record set will be created immediately after the existing one is deleted. It also avoids "manual" actions to delete existing record sets. .. epigraph:: **N.B.:** this feature is dangerous, use with caution! It can only be used safely when ``deleteExisting`` is set to ``true`` as soon as the resource is added to the stack. Changing an existing Record Set\'s ``deleteExisting`` property from ``false -> true`` after deployment will delete the record! Default: false\n')
    geo_location: typing.Optional[models.aws_route53.GeoLocationDef] = pydantic.Field(None, description="The geographical origin for this record to return DNS records based on the user's location.\n")
...
class NsRecordDef(BaseConstruct):
    values: typing.Union[typing.Sequence[str], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The NS values.\n')
    zone: typing.Union[_REQUIRED_INIT_PARAM, models.aws_route53.HostedZoneDef, models.aws_route53.PrivateHostedZoneDef, models.aws_route53.PublicHostedZoneDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The hosted zone in which to define the new record.\n')
    comment: typing.Optional[str] = pydantic.Field(None, description='A comment to add on the record. Default: no comment\n')
    delete_existing: typing.Optional[bool] = pydantic.Field(None, description='Whether to delete the same record set in the hosted zone if it already exists (dangerous!). This allows to deploy a new record set while minimizing the downtime because the new record set will be created immediately after the existing one is deleted. It also avoids "manual" actions to delete existing record sets. .. epigraph:: **N.B.:** this feature is dangerous, use with caution! It can only be used safely when ``deleteExisting`` is set to ``true`` as soon as the resource is added to the stack. Changing an existing Record Set\'s ``deleteExisting`` property from ``false -> true`` after deployment will delete the record! Default: false\n')
    geo_location: typing.Optional[models.aws_route53.GeoLocationDef] = pydantic.Field(None, description="The geographical origin for this record to return DNS records based on the user's location.\n")
...
class PrivateHostedZoneDef(BaseConstruct):
    vpc: typing.Union[_REQUIRED_INIT_PARAM, models.aws_ec2.VpcDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='A VPC that you want to associate with this hosted zone. Private hosted zones must be associated with at least one VPC. You can associated additional VPCs using ``addVpc(vpc)``.\n')
    zone_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the domain. For resource record types that include a domain name, specify a fully qualified domain name.\n')
    add_trailing_dot: typing.Optional[bool] = pydantic.Field(None, description='Whether to add a trailing dot to the zone name. Default: true\n')
    comment: typing.Optional[str] = pydantic.Field(None, description='Any comments that you want to include about the hosted zone. Default: none\n')
    query_logs_log_group_arn: typing.Optional[str] = pydantic.Field(None, description='The Amazon Resource Name (ARN) for the log group that you want Amazon Route 53 to send query logs to. Default: disabled')
...
class PrivateHostedZoneDefConfig(pydantic.BaseModel):
    ...
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    enable_dnssec: typing.Optional[list[models.aws_route53.PrivateHostedZoneDefEnableDnssecParams]] = pydantic.Field(None, description='Enable DNSSEC for this hosted zone.\nThis will create a key signing key with the given options and enable DNSSEC signing\nfor the hosted zone.')
...
class PrivateHostedZoneDefEnableDnssecParams(pydantic.BaseModel):
    kms_key: typing.Union[models.aws_kms.KeyDef] = pydantic.Field(..., description='The customer-managed KMS key that that will be used to sign the records. The KMS Key must be unique for each KSK within a hosted zone. Additionally, the KMS key must be an asymetric customer-managed key using the ECC_NIST_P256 algorithm.\n')
    key_signing_key_name: typing.Optional[str] = pydantic.Field(None, description='The name for the key signing key. This name must be unique within a hosted zone. Default: an autogenerated name')
    return_config: typing.Optional[list[models._interface_methods.AwsRoute53IKeySigningKeyDefConfig]] = pydantic.Field(None)
    ...
...
class PrivateHostedZoneDefGrantDelegationParams(pydantic.BaseModel):
    grantee: models.AnyResource = pydantic.Field(..., description='-')
    return_config: typing.Optional[list[models.aws_iam.GrantDefConfig]] = pydantic.Field(None)
    ...
...
class PublicHostedZoneDef(BaseConstruct):
    ...
    _method_names: typing.ClassVar[list[str]] = ['add_delegation', 'add_vpc', 'apply_removal_policy', 'enable_dnssec', 'grant_delegation']
...
class PublicHostedZoneDefConfig(pydantic.BaseModel):
    ...
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    enable_dnssec: typing.Optional[list[models.aws_route53.PublicHostedZoneDefEnableDnssecParams]] = pydantic.Field(None, description='Enable DNSSEC for this hosted zone.\nThis will create a key signing key with the given options and enable DNSSEC signing\nfor the hosted zone.')
...
class PublicHostedZoneDefEnableDnssecParams(pydantic.BaseModel):
    kms_key: typing.Union[models.aws_kms.KeyDef] = pydantic.Field(..., description='The customer-managed KMS key that that will be used to sign the records. The KMS Key must be unique for each KSK within a hosted zone. Additionally, the KMS key must be an asymetric customer-managed key using the ECC_NIST_P256 algorithm.\n')
    key_signing_key_name: typing.Optional[str] = pydantic.Field(None, description='The name for the key signing key. This name must be unique within a hosted zone. Default: an autogenerated name')
    return_config: typing.Optional[list[models._interface_methods.AwsRoute53IKeySigningKeyDefConfig]] = pydantic.Field(None)
    ...
...
class RecordSetDef(BaseConstruct):
    record_type: typing.Union[aws_cdk.aws_route53.RecordType, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The record type.\n')
    target: typing.Union[models.aws_route53.RecordTargetDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The target for this record, either ``RecordTarget.fromValues()`` or ``RecordTarget.fromAlias()``.\n')
    zone: typing.Union[_REQUIRED_INIT_PARAM, models.aws_route53.HostedZoneDef, models.aws_route53.PrivateHostedZoneDef, models.aws_route53.PublicHostedZoneDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The hosted zone in which to define the new record.\n')
    comment: typing.Optional[str] = pydantic.Field(None, description='A comment to add on the record. Default: no comment\n')
    delete_existing: typing.Optional[bool] = pydantic.Field(None, description='Whether to delete the same record set in the hosted zone if it already exists (dangerous!). This allows to deploy a new record set while minimizing the downtime because the new record set will be created immediately after the existing one is deleted. It also avoids "manual" actions to delete existing record sets. .. epigraph:: **N.B.:** this feature is dangerous, use with caution! It can only be used safely when ``deleteExisting`` is set to ``true`` as soon as the resource is added to the stack. Changing an existing Record Set\'s ``deleteExisting`` property from ``false -> true`` after deployment will delete the record! Default: false\n')
    geo_location: typing.Optional[models.aws_route53.GeoLocationDef] = pydantic.Field(None, description="The geographical origin for this record to return DNS records based on the user's location.\n")
    ...
    ttl: typing.Optional[models.DurationDef] = pydantic.Field(None, description='The resource record cache time to live (TTL). Default: Duration.minutes(30)\n')
    weight: typing.Union[int, float, None] = pydantic.Field(None, description="Among resource record sets that have the same combination of DNS name and type, a value that determines the proportion of DNS queries that Amazon Route 53 responds to using the current resource record set. Route 53 calculates the sum of the weights for the resource record sets that have the same combination of DNS name and type. Route 53 then responds to queries based on the ratio of a resource's weight to the total. This value can be a number between 0 and 255. Default: - Do not set weighted routing")
    _init_params: typing.ClassVar[list[str]] = ['record_type', 'target', 'zone', 'comment', 'delete_existing', 'geo_location', 'multi_value_answer', 'record_name', 'region', 'set_identifier', 'ttl', 'weight']
    _method_names: typing.ClassVar[list[str]] = ['apply_removal_policy']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class SrvRecordDef(BaseConstruct):
    values: typing.Union[typing.Sequence[typing.Union[models.aws_route53.SrvRecordValueDef, dict[str, typing.Any]]], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The values.\n')
    zone: typing.Union[_REQUIRED_INIT_PARAM, models.aws_route53.HostedZoneDef, models.aws_route53.PrivateHostedZoneDef, models.aws_route53.PublicHostedZoneDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The hosted zone in which to define the new record.\n')
    comment: typing.Optional[str] = pydantic.Field(None, description='A comment to add on the record. Default: no comment\n')
    delete_existing: typing.Optional[bool] = pydantic.Field(None, description='Whether to delete the same record set in the hosted zone if it already exists (dangerous!). This allows to deploy a new record set while minimizing the downtime because the new record set will be created immediately after the existing one is deleted. It also avoids "manual" actions to delete existing record sets. .. epigraph:: **N.B.:** this feature is dangerous, use with caution! It can only be used safely when ``deleteExisting`` is set to ``true`` as soon as the resource is added to the stack. Changing an existing Record Set\'s ``deleteExisting`` property from ``false -> true`` after deployment will delete the record! Default: false\n')
    geo_location: typing.Optional[models.aws_route53.GeoLocationDef] = pydantic.Field(None, description="The geographical origin for this record to return DNS records based on the user's location.\n")
...
class TxtRecordDef(BaseConstruct):
    values: typing.Union[typing.Sequence[str], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The text values.\n')
    zone: typing.Union[_REQUIRED_INIT_PARAM, models.aws_route53.HostedZoneDef, models.aws_route53.PrivateHostedZoneDef, models.aws_route53.PublicHostedZoneDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The hosted zone in which to define the new record.\n')
    comment: typing.Optional[str] = pydantic.Field(None, description='A comment to add on the record. Default: no comment\n')
    delete_existing: typing.Optional[bool] = pydantic.Field(None, description='Whether to delete the same record set in the hosted zone if it already exists (dangerous!). This allows to deploy a new record set while minimizing the downtime because the new record set will be created immediately after the existing one is deleted. It also avoids "manual" actions to delete existing record sets. .. epigraph:: **N.B.:** this feature is dangerous, use with caution! It can only be used safely when ``deleteExisting`` is set to ``true`` as soon as the resource is added to the stack. Changing an existing Record Set\'s ``deleteExisting`` property from ``false -> true`` after deployment will delete the record! Default: false\n')
    geo_location: typing.Optional[models.aws_route53.GeoLocationDef] = pydantic.Field(None, description="The geographical origin for this record to return DNS records based on the user's location.\n")
...
class VpcEndpointServiceDomainNameDef(BaseConstruct):
    domain_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The domain name to use. This domain name must be owned by this account (registered through Route53), or delegated to this account. Domain ownership will be verified by AWS before private DNS can be used.\n')
    endpoint_service: typing.Union[_REQUIRED_INIT_PARAM, models.aws_ec2.VpcEndpointServiceDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The VPC Endpoint Service to configure Private DNS for.\n')
    public_hosted_zone: typing.Union[_REQUIRED_INIT_PARAM, models.aws_route53.PublicHostedZoneDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The public hosted zone to use for the domain.')
...
class ZoneDelegationRecordDef(BaseConstruct):
    name_servers: typing.Union[typing.Sequence[str], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name servers to report in the delegation records.\n')
    zone: typing.Union[_REQUIRED_INIT_PARAM, models.aws_route53.HostedZoneDef, models.aws_route53.PrivateHostedZoneDef, models.aws_route53.PublicHostedZoneDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The hosted zone in which to define the new record.\n')
    comment: typing.Optional[str] = pydantic.Field(None, description='A comment to add on the record. Default: no comment\n')
    delete_existing: typing.Optional[bool] = pydantic.Field(None, description='Whether to delete the same record set in the hosted zone if it already exists (dangerous!). This allows to deploy a new record set while minimizing the downtime because the new record set will be created immediately after the existing one is deleted. It also avoids "manual" actions to delete existing record sets. .. epigraph:: **N.B.:** this feature is dangerous, use with caution! It can only be used safely when ``deleteExisting`` is set to ``true`` as soon as the resource is added to the stack. Changing an existing Record Set\'s ``deleteExisting`` property from ``false -> true`` after deployment will delete the record! Default: false\n')
    geo_location: typing.Optional[models.aws_route53.GeoLocationDef] = pydantic.Field(None, description="The geographical origin for this record to return DNS records based on the user's location.\n")
    ...
    ttl: typing.Optional[models.DurationDef] = pydantic.Field(None, description='The resource record cache time to live (TTL). Default: Duration.minutes(30)\n')
    weight: typing.Union[int, float, None] = pydantic.Field(None, description="Among resource record sets that have the same combination of DNS name and type, a value that determines the proportion of DNS queries that Amazon Route 53 responds to using the current resource record set. Route 53 calculates the sum of the weights for the resource record sets that have the same combination of DNS name and type. Route 53 then responds to queries based on the ratio of a resource's weight to the total. This value can be a number between 0 and 255. Default: - Do not set weighted routing")
    _init_params: typing.ClassVar[list[str]] = ['name_servers', 'zone', 'comment', 'delete_existing', 'geo_location', 'multi_value_answer', 'record_name', 'region', 'set_identifier', 'ttl', 'weight']
    _method_names: typing.ClassVar[list[str]] = ['apply_removal_policy']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class AaaaRecordPropsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['zone', 'comment', 'delete_existing', 'geo_location', 'multi_value_answer', 'record_name', 'region', 'set_identifier', 'ttl', 'weight', 'target']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class AliasRecordTargetConfigDef(BaseStruct):
    ...
    hosted_zone_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Hosted zone ID of the target.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_route53 as route53\n\n    alias_record_target_config = route53.AliasRecordTargetConfig(\n        dns_name="dnsName",\n        hosted_zone_id="hostedZoneId"\n    )\n')
...
#  autogenerated from aws_cdk.aws_route53.ARecordAttrs
class ARecordAttrsDef(BaseStruct):
    zone: typing.Union[_REQUIRED_INIT_PARAM, models.aws_route53.HostedZoneDef, models.aws_route53.PrivateHostedZoneDef, models.aws_route53.PublicHostedZoneDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The hosted zone in which to define the new record.\n')
    comment: typing.Optional[str] = pydantic.Field(None, description='A comment to add on the record. Default: no comment\n')
    delete_existing: typing.Optional[bool] = pydantic.Field(None, description='Whether to delete the same record set in the hosted zone if it already exists (dangerous!). This allows to deploy a new record set while minimizing the downtime because the new record set will be created immediately after the existing one is deleted. It also avoids "manual" actions to delete existing record sets. .. epigraph:: **N.B.:** this feature is dangerous, use with caution! It can only be used safely when ``deleteExisting`` is set to ``true`` as soon as the resource is added to the stack. Changing an existing Record Set\'s ``deleteExisting`` property from ``false -> true`` after deployment will delete the record! Default: false\n')
    geo_location: typing.Optional[models.aws_route53.GeoLocationDef] = pydantic.Field(None, description="The geographical origin for this record to return DNS records based on the user's location.\n")
    ...
    ttl: typing.Optional[models.DurationDef] = pydantic.Field(None, description='The resource record cache time to live (TTL). Default: Duration.minutes(30)\n')
    weight: typing.Union[int, float, None] = pydantic.Field(None, description="Among resource record sets that have the same combination of DNS name and type, a value that determines the proportion of DNS queries that Amazon Route 53 responds to using the current resource record set. Route 53 calculates the sum of the weights for the resource record sets that have the same combination of DNS name and type. Route 53 then responds to queries based on the ratio of a resource's weight to the total. This value can be a number between 0 and 255. Default: - Do not set weighted routing\n")
    target_dns: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Existing A record DNS name to set RecordTarget.\n\n:exampleMetadata: infused\n\nExample::\n\n    # my_zone: route53.HostedZone\n\n    target_record = "existing.record.cdk.local"\n    record = route53.ARecord.from_aRecord_attributes(self, "A",\n        zone=my_zone,\n        record_name="test",\n        target_dNS=target_record\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['zone', 'comment', 'delete_existing', 'geo_location', 'multi_value_answer', 'record_name', 'region', 'set_identifier', 'ttl', 'weight', 'target_dns']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_route53.ARecordAttrs'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...


    resource_config: typing.Optional[models.aws_route53.ARecordAttrsDefConfig] = pydantic.Field(None)


class ARecordAttrsDefConfig(pydantic.BaseModel):
    zone_config: typing.Optional[models._interface_methods.AwsRoute53IHostedZoneDefConfig] = pydantic.Field(None)
...
class CaaRecordPropsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['zone', 'comment', 'delete_existing', 'geo_location', 'multi_value_answer', 'record_name', 'region', 'set_identifier', 'ttl', 'weight', 'values']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CaaRecordValueDef(BaseStruct):
    flag: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The flag.\n')
    tag: typing.Union[aws_cdk.aws_route53.CaaTag, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The tag.\n')
    value: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The value associated with the tag.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_route53 as route53\n\n    caa_record_value = route53.CaaRecordValue(\n        flag=123,\n        tag=route53.CaaTag.ISSUE,\n        value="value"\n    )\n')
...
class CfnCidrCollection_LocationPropertyDef(BaseStruct):
    cidr_list: typing.Union[typing.Sequence[str], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='List of CIDR blocks.\n')
    location_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The CIDR collection location name.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-route53-cidrcollection-location.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_route53 as route53\n\n    location_property = route53.CfnCidrCollection.LocationProperty(\n        cidr_list=["cidrList"],\n        location_name="locationName"\n    )\n')
...
class CfnHealthCheck_HealthCheckConfigPropertyDef(BaseStruct):
    ...
    enable_sni: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description="Specify whether you want Amazon Route 53 to send the value of ``FullyQualifiedDomainName`` to the endpoint in the ``client_hello`` message during TLS negotiation. This allows the endpoint to respond to ``HTTPS`` health check requests with the applicable SSL/TLS certificate. Some endpoints require that ``HTTPS`` requests include the host name in the ``client_hello`` message. If you don't enable SNI, the status of the health check will be ``SSL alert handshake_failure`` . A health check can also have that status for other reasons. If SNI is enabled and you're still getting the error, check the SSL/TLS configuration on your endpoint and confirm that your certificate is valid. The SSL/TLS certificate on your endpoint includes a domain name in the ``Common Name`` field and possibly several more in the ``Subject Alternative Names`` field. One of the domain names in the certificate should match the value that you specify for ``FullyQualifiedDomainName`` . If the endpoint responds to the ``client_hello`` message with a certificate that does not include the domain name that you specified in ``FullyQualifiedDomainName`` , a health checker will retry the handshake. In the second attempt, the health checker will omit ``FullyQualifiedDomainName`` from the ``client_hello`` message.\n")
    ...
    inverted: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='Specify whether you want Amazon Route 53 to invert the status of a health check, for example, to consider a health check unhealthy when it otherwise would be considered healthy.\n')
    ...
    measure_latency: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description="Specify whether you want Amazon Route 53 to measure the latency between health checkers in multiple AWS regions and your endpoint, and to display CloudWatch latency graphs on the *Health Checks* page in the Route 53 console. .. epigraph:: You can't change the value of ``MeasureLatency`` after you create a health check.\n")
    ...
    routing_control_arn: typing.Optional[str] = pydantic.Field(None, description='The Amazon Resource Name (ARN) for the Route 53 Application Recovery Controller routing control. For more information about Route 53 Application Recovery Controller, see `Route 53 Application Recovery Controller Developer Guide. <https://docs.aws.amazon.com/r53recovery/latest/dg/what-is-route-53-recovery.html>`_ .\n')
...
class CfnHealthCheck_HealthCheckTagPropertyDef(BaseStruct):
    key: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description="The value of ``Key`` depends on the operation that you want to perform:. - *Add a tag to a health check or hosted zone* : ``Key`` is the name that you want to give the new tag. - *Edit a tag* : ``Key`` is the name of the tag that you want to change the ``Value`` for. - *Delete a key* : ``Key`` is the name of the tag you want to remove. - *Give a name to a health check* : Edit the default ``Name`` tag. In the Amazon Route 53 console, the list of your health checks includes a *Name* column that lets you see the name that you've given to each health check.\n")
    value: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The value of ``Value`` depends on the operation that you want to perform:. - *Add a tag to a health check or hosted zone* : ``Value`` is the value that you want to give the new tag. - *Edit a tag* : ``Value`` is the new value that you want to assign the tag.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-route53-healthcheck-healthchecktag.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_route53 as route53\n\n    health_check_tag_property = route53.CfnHealthCheck.HealthCheckTagProperty(\n        key="key",\n        value="value"\n    )\n')
...
class CfnHostedZone_QueryLoggingConfigPropertyDef(BaseStruct):
    cloud_watch_logs_log_group_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Amazon Resource Name (ARN) of the CloudWatch Logs log group that Amazon Route 53 is publishing logs to.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-route53-hostedzone-queryloggingconfig.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_route53 as route53\n\n    query_logging_config_property = route53.CfnHostedZone.QueryLoggingConfigProperty(\n        cloud_watch_logs_log_group_arn="cloudWatchLogsLogGroupArn"\n    )\n')
...
class CfnHostedZone_VPCPropertyDef(BaseStruct):
    vpc_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='*Private hosted zones only:* The ID of an Amazon VPC. .. epigraph:: For public hosted zones, omit ``VPCs`` , ``VPCId`` , and ``VPCRegion`` .\n')
    vpc_region: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='*Private hosted zones only:* The region that an Amazon VPC was created in. .. epigraph:: For public hosted zones, omit ``VPCs`` , ``VPCId`` , and ``VPCRegion`` .\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-route53-hostedzone-vpc.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_route53 as route53\n\n    v_pCProperty = route53.CfnHostedZone.VPCProperty(\n        vpc_id="vpcId",\n        vpc_region="vpcRegion"\n    )\n')
...
class CfnRecordSet_CidrRoutingConfigPropertyDef(BaseStruct):
    collection_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The CIDR collection ID.\n')
...
#  autogenerated from aws_cdk.aws_route53.CfnRecordSet.CoordinatesProperty
class CfnRecordSet_CoordinatesPropertyDef(BaseStruct):
    latitude: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Specifies a coordinate of the north–south position of a geographic point on the surface of the Earth (-90 - 90).\n')
    longitude: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Specifies a coordinate of the east–west position of a geographic point on the surface of the Earth (-180 - 180).\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-route53-recordset-coordinates.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_route53 as route53\n\n    coordinates_property = route53.CfnRecordSet.CoordinatesProperty(\n        latitude="latitude",\n        longitude="longitude"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['latitude', 'longitude']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_route53.CfnRecordSet.CoordinatesProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
#  autogenerated from aws_cdk.aws_route53.CfnRecordSet.GeoProximityLocationProperty
class CfnRecordSet_GeoProximityLocationPropertyDef(BaseStruct):
    aws_region: typing.Optional[str] = pydantic.Field(None, description='The AWS Region the resource you are directing DNS traffic to, is in.\n')
    bias: typing.Union[int, float, None] = pydantic.Field(None, description='The bias increases or decreases the size of the geographic region from which Route 53 routes traffic to a resource. To use ``Bias`` to change the size of the geographic region, specify the applicable value for the bias: - To expand the size of the geographic region from which Route 53 routes traffic to a resource, specify a positive integer from 1 to 99 for the bias. Route 53 shrinks the size of adjacent regions. - To shrink the size of the geographic region from which Route 53 routes traffic to a resource, specify a negative bias of -1 to -99. Route 53 expands the size of adjacent regions.\n')
    coordinates: typing.Union[models.UnsupportedResource, models.aws_route53.CfnRecordSet_CoordinatesPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Contains the longitude and latitude for a geographic region.\n')
    local_zone_group: typing.Optional[str] = pydantic.Field(None, description='Specifies an AWS Local Zone Group. A local Zone Group is usually the Local Zone code without the ending character. For example, if the Local Zone is ``us-east-1-bue-1a`` the Local Zone Group is ``us-east-1-bue-1`` . You can identify the Local Zones Group for a specific Local Zone by using the `describe-availability-zones <https://docs.aws.amazon.com/cli/latest/reference/ec2/describe-availability-zones.html>`_ CLI command: This command returns: ``"GroupName": "us-west-2-den-1"`` , specifying that the Local Zone ``us-west-2-den-1a`` belongs to the Local Zone Group ``us-west-2-den-1`` .\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-route53-recordset-geoproximitylocation.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_route53 as route53\n\n    geo_proximity_location_property = route53.CfnRecordSet.GeoProximityLocationProperty(\n        aws_region="awsRegion",\n        bias=123,\n        coordinates=route53.CfnRecordSet.CoordinatesProperty(\n            latitude="latitude",\n            longitude="longitude"\n        ),\n        local_zone_group="localZoneGroup"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['aws_region', 'bias', 'coordinates', 'local_zone_group']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_route53.CfnRecordSet.GeoProximityLocationProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class CfnRecordSetGroup_AliasTargetPropertyDef(BaseStruct):
    dns_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description="*Alias records only:* The value that you specify depends on where you want to route queries:. - **Amazon API Gateway custom regional APIs and edge-optimized APIs** - Specify the applicable domain name for your API. You can get the applicable value using the AWS CLI command `get-domain-names <https://docs.aws.amazon.com/cli/latest/reference/apigateway/get-domain-names.html>`_ : - For regional APIs, specify the value of ``regionalDomainName`` . - For edge-optimized APIs, specify the value of ``distributionDomainName`` . This is the name of the associated CloudFront distribution, such as ``da1b2c3d4e5.cloudfront.net`` . .. epigraph:: The name of the record that you're creating must match a custom domain name for your API, such as ``api.example.com`` . - **Amazon Virtual Private Cloud interface VPC endpoint** - Enter the API endpoint for the interface endpoint, such as ``vpce-123456789abcdef01-example-us-east-1a.elasticloadbalancing.us-east-1.vpce.amazonaws.com`` . For edge-optimized APIs, this is the domain name for the corresponding CloudFront distribution. You can get the value of ``DnsName`` using the AWS CLI command `describe-vpc-endpoints <https://docs.aws.amazon.com/cli/latest/reference/ec2/describe-vpc-endpoints.html>`_ . - **CloudFront distribution** - Specify the domain name that CloudFront assigned when you created your distribution. Your CloudFront distribution must include an alternate domain name that matches the name of the record. For example, if the name of the record is *acme.example.com* , your CloudFront distribution must include *acme.example.com* as one of the alternate domain names. For more information, see `Using Alternate Domain Names (CNAMEs) <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/CNAMEs.html>`_ in the *Amazon CloudFront Developer Guide* . You can't create a record in a private hosted zone to route traffic to a CloudFront distribution. .. epigraph:: For failover alias records, you can't specify a CloudFront distribution for both the primary and secondary records. A distribution must include an alternate domain name that matches the name of the record. However, the primary and secondary records have the same name, and you can't include the same alternate domain name in more than one distribution. - **Elastic Beanstalk environment** - If the domain name for your Elastic Beanstalk environment includes the region that you deployed the environment in, you can create an alias record that routes traffic to the environment. For example, the domain name ``my-environment. *us-west-2* .elasticbeanstalk.com`` is a regionalized domain name. .. epigraph:: For environments that were created before early 2016, the domain name doesn't include the region. To route traffic to these environments, you must create a CNAME record instead of an alias record. Note that you can't create a CNAME record for the root domain name. For example, if your domain name is example.com, you can create a record that routes traffic for acme.example.com to your Elastic Beanstalk environment, but you can't create a record that routes traffic for example.com to your Elastic Beanstalk environment. For Elastic Beanstalk environments that have regionalized subdomains, specify the ``CNAME`` attribute for the environment. You can use the following methods to get the value of the CNAME attribute: - *AWS Management Console* : For information about how to get the value by using the console, see `Using Custom Domains with AWS Elastic Beanstalk <https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/customdomains.html>`_ in the *AWS Elastic Beanstalk Developer Guide* . - *Elastic Beanstalk API* : Use the ``DescribeEnvironments`` action to get the value of the ``CNAME`` attribute. For more information, see `DescribeEnvironments <https://docs.aws.amazon.com/elasticbeanstalk/latest/api/API_DescribeEnvironments.html>`_ in the *AWS Elastic Beanstalk API Reference* . - *AWS CLI* : Use the ``describe-environments`` command to get the value of the ``CNAME`` attribute. For more information, see `describe-environments <https://docs.aws.amazon.com/cli/latest/reference/elasticbeanstalk/describe-environments.html>`_ in the *AWS CLI* . - **ELB load balancer** - Specify the DNS name that is associated with the load balancer. Get the DNS name by using the AWS Management Console , the ELB API, or the AWS CLI . - *AWS Management Console* : Go to the EC2 page, choose *Load Balancers* in the navigation pane, choose the load balancer, choose the *Description* tab, and get the value of the *DNS name* field. If you're routing traffic to a Classic Load Balancer, get the value that begins with *dualstack* . If you're routing traffic to another type of load balancer, get the value that applies to the record type, A or AAAA. - *Elastic Load Balancing API* : Use ``DescribeLoadBalancers`` to get the value of ``DNSName`` . For more information, see the applicable guide: - Classic Load Balancers: `DescribeLoadBalancers <https://docs.aws.amazon.com/elasticloadbalancing/2012-06-01/APIReference/API_DescribeLoadBalancers.html>`_ - Application and Network Load Balancers: `DescribeLoadBalancers <https://docs.aws.amazon.com/elasticloadbalancing/latest/APIReference/API_DescribeLoadBalancers.html>`_ - *CloudFormation Fn::GetAtt intrinsic function* : Use the `Fn::GetAtt <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/intrinsic-function-reference-getatt.html>`_ intrinsic function to get the value of ``DNSName`` : - `Classic Load Balancers <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-elb.html#aws-properties-ec2-elb-return-values>`_ . - `Application and Network Load Balancers <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-elasticloadbalancingv2-loadbalancer.html#aws-resource-elasticloadbalancingv2-loadbalancer-return-values>`_ . - *AWS CLI* : Use ``describe-load-balancers`` to get the value of ``DNSName`` . For more information, see the applicable guide: - Classic Load Balancers: `describe-load-balancers <https://docs.aws.amazon.com/cli/latest/reference/elb/describe-load-balancers.html>`_ - Application and Network Load Balancers: `describe-load-balancers <https://docs.aws.amazon.com/cli/latest/reference/elbv2/describe-load-balancers.html>`_ - **Global Accelerator accelerator** - Specify the DNS name for your accelerator: - *Global Accelerator API* : To get the DNS name, use `DescribeAccelerator <https://docs.aws.amazon.com/global-accelerator/latest/api/API_DescribeAccelerator.html>`_ . - *AWS CLI* : To get the DNS name, use `describe-accelerator <https://docs.aws.amazon.com/cli/latest/reference/globalaccelerator/describe-accelerator.html>`_ . - **Amazon S3 bucket that is configured as a static website** - Specify the domain name of the Amazon S3 website endpoint that you created the bucket in, for example, ``s3-website.us-east-2.amazonaws.com`` . For more information about valid values, see the table `Amazon S3 Website Endpoints <https://docs.aws.amazon.com/general/latest/gr/s3.html#s3_website_region_endpoints>`_ in the *Amazon Web Services General Reference* . For more information about using S3 buckets for websites, see `Getting Started with Amazon Route 53 <https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/getting-started.html>`_ in the *Amazon Route 53 Developer Guide.* - **Another Route 53 record** - Specify the value of the ``Name`` element for a record in the current hosted zone. .. epigraph:: If you're creating an alias record that has the same name as the hosted zone (known as the zone apex), you can't specify the domain name for a record for which the value of ``Type`` is ``CNAME`` . This is because the alias record must have the same type as the record that you're routing traffic to, and creating a CNAME record for the zone apex isn't supported even for an alias record.\n")
    hosted_zone_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='*Alias resource records sets only* : The value used depends on where you want to route traffic:. - **Amazon API Gateway custom regional APIs and edge-optimized APIs** - Specify the hosted zone ID for your API. You can get the applicable value using the AWS CLI command `get-domain-names <https://docs.aws.amazon.com/cli/latest/reference/apigateway/get-domain-names.html>`_ : - For regional APIs, specify the value of ``regionalHostedZoneId`` . - For edge-optimized APIs, specify the value of ``distributionHostedZoneId`` . - **Amazon Virtual Private Cloud interface VPC endpoint** - Specify the hosted zone ID for your interface endpoint. You can get the value of ``HostedZoneId`` using the AWS CLI command `describe-vpc-endpoints <https://docs.aws.amazon.com/cli/latest/reference/ec2/describe-vpc-endpoints.html>`_ . - **CloudFront distribution** - Specify ``Z2FDTNDATAQYW2`` . This is always the hosted zone ID when you create an alias record that routes traffic to a CloudFront distribution. .. epigraph:: Alias records for CloudFront can\'t be created in a private zone. - **Elastic Beanstalk environment** - Specify the hosted zone ID for the region that you created the environment in. The environment must have a regionalized subdomain. For a list of regions and the corresponding hosted zone IDs, see `AWS Elastic Beanstalk endpoints and quotas <https://docs.aws.amazon.com/general/latest/gr/elasticbeanstalk.html>`_ in the *Amazon Web Services General Reference* . - **ELB load balancer** - Specify the value of the hosted zone ID for the load balancer. Use the following methods to get the hosted zone ID: - `Service Endpoints <https://docs.aws.amazon.com/general/latest/gr/elb.html>`_ table in the "Elastic Load Balancing endpoints and quotas" topic in the *Amazon Web Services General Reference* : Use the value that corresponds with the region that you created your load balancer in. Note that there are separate columns for Application and Classic Load Balancers and for Network Load Balancers. - *AWS Management Console* : Go to the Amazon EC2 page, choose *Load Balancers* in the navigation pane, select the load balancer, and get the value of the *Hosted zone* field on the *Description* tab. - *Elastic Load Balancing API* : Use ``DescribeLoadBalancers`` to get the applicable value. For more information, see the applicable guide: - Classic Load Balancers: Use `DescribeLoadBalancers <https://docs.aws.amazon.com/elasticloadbalancing/2012-06-01/APIReference/API_DescribeLoadBalancers.html>`_ to get the value of ``CanonicalHostedZoneNameID`` . - Application and Network Load Balancers: Use `DescribeLoadBalancers <https://docs.aws.amazon.com/elasticloadbalancing/latest/APIReference/API_DescribeLoadBalancers.html>`_ to get the value of ``CanonicalHostedZoneID`` . - *CloudFormation Fn::GetAtt intrinsic function* : Use the `Fn::GetAtt <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/intrinsic-function-reference-getatt.html>`_ intrinsic function to get the applicable value: - Classic Load Balancers: Get `CanonicalHostedZoneNameID <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-elb.html#aws-properties-ec2-elb-return-values>`_ . - Application and Network Load Balancers: Get `CanonicalHostedZoneID <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-elasticloadbalancingv2-loadbalancer.html#aws-resource-elasticloadbalancingv2-loadbalancer-return-values>`_ . - *AWS CLI* : Use ``describe-load-balancers`` to get the applicable value. For more information, see the applicable guide: - Classic Load Balancers: Use `describe-load-balancers <https://docs.aws.amazon.com/cli/latest/reference/elb/describe-load-balancers.html>`_ to get the value of ``CanonicalHostedZoneNameID`` . - Application and Network Load Balancers: Use `describe-load-balancers <https://docs.aws.amazon.com/cli/latest/reference/elbv2/describe-load-balancers.html>`_ to get the value of ``CanonicalHostedZoneID`` . - **Global Accelerator accelerator** - Specify ``Z2BJ6XQ5FK7U4H`` . - **An Amazon S3 bucket configured as a static website** - Specify the hosted zone ID for the region that you created the bucket in. For more information about valid values, see the table `Amazon S3 Website Endpoints <https://docs.aws.amazon.com/general/latest/gr/s3.html#s3_website_region_endpoints>`_ in the *Amazon Web Services General Reference* . - **Another Route 53 record in your hosted zone** - Specify the hosted zone ID of your hosted zone. (An alias record can\'t reference a record in a different hosted zone.)\n')
    evaluate_target_health: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='*Applies only to alias records with any routing policy:* When ``EvaluateTargetHealth`` is ``true`` , an alias record inherits the health of the referenced AWS resource, such as an ELB load balancer or another record in the hosted zone. Note the following: - **CloudFront distributions** - You can\'t set ``EvaluateTargetHealth`` to ``true`` when the alias target is a CloudFront distribution. - **Elastic Beanstalk environments that have regionalized subdomains** - If you specify an Elastic Beanstalk environment in ``DNSName`` and the environment contains an ELB load balancer, Elastic Load Balancing routes queries only to the healthy Amazon EC2 instances that are registered with the load balancer. (An environment automatically contains an ELB load balancer if it includes more than one Amazon EC2 instance.) If you set ``EvaluateTargetHealth`` to ``true`` and either no Amazon EC2 instances are healthy or the load balancer itself is unhealthy, Route 53 routes queries to other available resources that are healthy, if any. If the environment contains a single Amazon EC2 instance, there are no special requirements. - **ELB load balancers** - Health checking behavior depends on the type of load balancer: - *Classic Load Balancers* : If you specify an ELB Classic Load Balancer in ``DNSName`` , Elastic Load Balancing routes queries only to the healthy Amazon EC2 instances that are registered with the load balancer. If you set ``EvaluateTargetHealth`` to ``true`` and either no EC2 instances are healthy or the load balancer itself is unhealthy, Route 53 routes queries to other resources. - *Application and Network Load Balancers* : If you specify an ELB Application or Network Load Balancer and you set ``EvaluateTargetHealth`` to ``true`` , Route 53 routes queries to the load balancer based on the health of the target groups that are associated with the load balancer: - For an Application or Network Load Balancer to be considered healthy, every target group that contains targets must contain at least one healthy target. If any target group contains only unhealthy targets, the load balancer is considered unhealthy, and Route 53 routes queries to other resources. - A target group that has no registered targets is considered unhealthy. .. epigraph:: When you create a load balancer, you configure settings for Elastic Load Balancing health checks; they\'re not Route 53 health checks, but they perform a similar function. Do not create Route 53 health checks for the EC2 instances that you register with an ELB load balancer. - **S3 buckets** - There are no special requirements for setting ``EvaluateTargetHealth`` to ``true`` when the alias target is an S3 bucket. - **Other records in the same hosted zone** - If the AWS resource that you specify in ``DNSName`` is a record or a group of records (for example, a group of weighted records) but is not another alias record, we recommend that you associate a health check with all of the records in the alias target. For more information, see `What Happens When You Omit Health Checks? <https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/dns-failover-complex-configs.html#dns-failover-complex-configs-hc-omitting>`_ in the *Amazon Route 53 Developer Guide* . For more information and examples, see `Amazon Route 53 Health Checks and DNS Failover <https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/dns-failover.html>`_ in the *Amazon Route 53 Developer Guide* .\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-route53-recordsetgroup-aliastarget.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_route53 as route53\n\n    alias_target_property = route53.CfnRecordSetGroup.AliasTargetProperty(\n        dns_name="dnsName",\n        hosted_zone_id="hostedZoneId",\n\n        # the properties below are optional\n        evaluate_target_health=False\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['dns_name', 'hosted_zone_id', 'evaluate_target_health']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
#  autogenerated from aws_cdk.aws_route53.CfnRecordSetGroup.CoordinatesProperty
class CfnRecordSetGroup_CoordinatesPropertyDef(BaseStruct):
    latitude: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Specifies a coordinate of the north–south position of a geographic point on the surface of the Earth (-90 - 90).\n')
    ...
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_route53.CfnRecordSetGroup.CoordinatesProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
#  autogenerated from aws_cdk.aws_route53.CfnRecordSetGroup.GeoProximityLocationProperty
class CfnRecordSetGroup_GeoProximityLocationPropertyDef(BaseStruct):
    aws_region: typing.Optional[str] = pydantic.Field(None, description='The AWS Region the resource you are directing DNS traffic to, is in.\n')
    bias: typing.Union[int, float, None] = pydantic.Field(None, description='The bias increases or decreases the size of the geographic region from which Route 53 routes traffic to a resource. To use ``Bias`` to change the size of the geographic region, specify the applicable value for the bias: - To expand the size of the geographic region from which Route 53 routes traffic to a resource, specify a positive integer from 1 to 99 for the bias. Route 53 shrinks the size of adjacent regions. - To shrink the size of the geographic region from which Route 53 routes traffic to a resource, specify a negative bias of -1 to -99. Route 53 expands the size of adjacent regions.\n')
    coordinates: typing.Union[models.UnsupportedResource, models.aws_route53.CfnRecordSetGroup_CoordinatesPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Contains the longitude and latitude for a geographic region.\n')
    ...
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_route53.CfnRecordSetGroup.GeoProximityLocationProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class CfnRecordSetGroup_RecordSetPropertyDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['name', 'type', 'alias_target', 'cidr_routing_config', 'failover', 'geo_location', 'geo_proximity_location', 'health_check_id', 'hosted_zone_id', 'hosted_zone_name', 'multi_value_answer', 'region', 'resource_records', 'set_identifier', 'ttl', 'weight']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CnameRecordPropsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['zone', 'comment', 'delete_existing', 'geo_location', 'multi_value_answer', 'record_name', 'region', 'set_identifier', 'ttl', 'weight', 'domain_name']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class HostedZoneAttributesDef(BaseStruct):
    hosted_zone_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Identifier of the hosted zone.\n')
    zone_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Name of the hosted zone.\n\n:exampleMetadata: infused\n\nExample::\n\n    # app: App\n\n    stack = Stack(app, "Stack",\n        cross_region_references=True,\n        env=Environment(\n            region="us-east-2"\n        )\n    )\n\n    patterns.HttpsRedirect(self, "Redirect",\n        record_names=["foo.example.com"],\n        target_domain="bar.example.com",\n        zone=route53.HostedZone.from_hosted_zone_attributes(self, "HostedZone",\n            hosted_zone_id="ID",\n            zone_name="example.com"\n        )\n    )\n')
...
class HostedZoneProviderPropsDef(BaseStruct):
    domain_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The zone domain e.g. example.com.\n')
    private_zone: typing.Optional[bool] = pydantic.Field(None, description='Whether the zone that is being looked up is a private hosted zone. Default: false\n')
...
#  autogenerated from aws_cdk.aws_route53.KeySigningKeyAttributes
class KeySigningKeyAttributesDef(BaseStruct):
    hosted_zone: typing.Union[_REQUIRED_INIT_PARAM, models.aws_route53.HostedZoneDef, models.aws_route53.PrivateHostedZoneDef, models.aws_route53.PublicHostedZoneDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The hosted zone that the key signing key signs.\n')
    key_signing_key_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the key signing key.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_route53 as route53\n\n    # hosted_zone: route53.HostedZone\n\n    key_signing_key_attributes = route53.KeySigningKeyAttributes(\n        hosted_zone=hosted_zone,\n        key_signing_key_name="keySigningKeyName"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['hosted_zone', 'key_signing_key_name']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_route53.KeySigningKeyAttributes'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...


    resource_config: typing.Optional[models.aws_route53.KeySigningKeyAttributesDefConfig] = pydantic.Field(None)


class KeySigningKeyAttributesDefConfig(pydantic.BaseModel):
    hosted_zone_config: typing.Optional[models._interface_methods.AwsRoute53IHostedZoneDefConfig] = pydantic.Field(None)


#  autogenerated from aws_cdk.aws_route53.KeySigningKeyProps
class KeySigningKeyPropsDef(BaseStruct):
    hosted_zone: typing.Union[_REQUIRED_INIT_PARAM, models.aws_route53.HostedZoneDef, models.aws_route53.PrivateHostedZoneDef, models.aws_route53.PublicHostedZoneDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The hosted zone that this key will be used to sign.\n')
    kms_key: typing.Union[_REQUIRED_INIT_PARAM, models.aws_kms.KeyDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The customer-managed KMS key that that will be used to sign the records. The KMS Key must be unique for each KSK within a hosted zone. Additionally, the KMS key must be an asymetric customer-managed key using the ECC_NIST_P256 algorithm.\n')
    key_signing_key_name: typing.Optional[str] = pydantic.Field(None, description='The name for the key signing key. This name must be unique within a hosted zone. Default: an autogenerated name\n')
    ...
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_route53.KeySigningKeyProps'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...


    resource_config: typing.Optional[models.aws_route53.KeySigningKeyPropsDefConfig] = pydantic.Field(None)


class KeySigningKeyPropsDefConfig(pydantic.BaseModel):
    hosted_zone_config: typing.Optional[models._interface_methods.AwsRoute53IHostedZoneDefConfig] = pydantic.Field(None)
    kms_key_config: typing.Optional[models._interface_methods.AwsKmsIKeyDefConfig] = pydantic.Field(None)
...
class MxRecordValueDef(BaseStruct):
    host_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The mail server host name.\n')
    priority: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The priority.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_route53 as route53\n\n    mx_record_value = route53.MxRecordValue(\n        host_name="hostName",\n        priority=123\n    )\n')
...
class RecordSetPropsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['zone', 'comment', 'delete_existing', 'geo_location', 'multi_value_answer', 'record_name', 'region', 'set_identifier', 'ttl', 'weight', 'record_type', 'target']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class SrvRecordValueDef(BaseStruct):
    host_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The server host name.\n')
    port: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The port.\n')
    priority: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The priority.\n')
    weight: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The weight.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_route53 as route53\n\n    srv_record_value = route53.SrvRecordValue(\n        host_name="hostName",\n        port=123,\n        priority=123,\n        weight=123\n    )\n')
...
class ZoneDelegationRecordPropsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['zone', 'comment', 'delete_existing', 'geo_location', 'multi_value_answer', 'record_name', 'region', 'set_identifier', 'ttl', 'weight', 'name_servers']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
#  autogenerated from aws_cdk.aws_route53.ZoneSigningOptions
class ZoneSigningOptionsDef(BaseStruct):
    kms_key: typing.Union[_REQUIRED_INIT_PARAM, models.aws_kms.KeyDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The customer-managed KMS key that that will be used to sign the records. The KMS Key must be unique for each KSK within a hosted zone. Additionally, the KMS key must be an asymetric customer-managed key using the ECC_NIST_P256 algorithm.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['kms_key', 'key_signing_key_name']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_route53.ZoneSigningOptions'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...


    resource_config: typing.Optional[models.aws_route53.ZoneSigningOptionsDefConfig] = pydantic.Field(None)


class ZoneSigningOptionsDefConfig(pydantic.BaseModel):
    kms_key_config: typing.Optional[models._interface_methods.AwsKmsIKeyDefConfig] = pydantic.Field(None)
...
#  autogenerated from aws_cdk.aws_route53.Continent
# skipping emum

#  autogenerated from aws_cdk.aws_route53.KeySigningKeyStatus
# skipping emum
...
#  autogenerated from aws_cdk.aws_route53.IKeySigningKey
#  skipping Interface
...
class CfnCidrCollectionDef(BaseCfnResource):
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of a CIDR collection.\n')
    locations: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_route53.CfnCidrCollection_LocationPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='A complex type that contains information about the list of CIDR locations.')
...
class CfnDNSSECDef(BaseCfnResource):
    hosted_zone_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A unique string (ID) that is used to identify a hosted zone. For example: ``Z00001111A1ABCaaABC11`` .')
...
class CfnHealthCheckDef(BaseCfnResource):
    health_check_config: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_route53.CfnHealthCheck_HealthCheckConfigPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='A complex type that contains detailed information about one health check. For the values to enter for ``HealthCheckConfig`` , see `HealthCheckConfig <https://docs.aws.amazon.com/Route53/latest/APIReference/API_HealthCheckConfig.html>`_\n')
    health_check_tags: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_route53.CfnHealthCheck_HealthCheckTagPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The ``HealthCheckTags`` property describes key-value pairs that are associated with an ``AWS::Route53::HealthCheck`` resource.')
...
class CfnHealthCheckDefHealthcheckconfigpropertyParams(pydantic.BaseModel):
    ...
    alarm_identifier: typing.Union[models.UnsupportedResource, models.aws_route53.CfnHealthCheck_AlarmIdentifierPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    child_health_checks: typing.Optional[typing.Sequence[str]] = pydantic.Field(None, description='')
    enable_sni: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
    ...
    inverted: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
    ip_address: typing.Optional[str] = pydantic.Field(None, description='')
    measure_latency: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
...
class CfnHostedZoneDef(BaseCfnResource):
    hosted_zone_config: typing.Union[models.UnsupportedResource, models.aws_route53.CfnHostedZone_HostedZoneConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description="A complex type that contains an optional comment. If you don't want to specify a comment, omit the ``HostedZoneConfig`` and ``Comment`` elements.\n")
...
class CfnKeySigningKeyDef(BaseCfnResource):
    hosted_zone_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The unique string (ID) that is used to identify a hosted zone. For example: ``Z00001111A1ABCaaABC11`` .\n')
    key_management_service_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Amazon resource name (ARN) for a customer managed customer master key (CMK) in AWS Key Management Service ( AWS KMS ). The ``KeyManagementServiceArn`` must be unique for each key-signing key (KSK) in a single hosted zone. For example: ``arn:aws:kms:us-east-1:111122223333:key/111a2222-a11b-1ab1-2ab2-1ab21a2b3a111`` .\n')
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A string used to identify a key-signing key (KSK). ``Name`` can include numbers, letters, and underscores (_). ``Name`` must be unique for each key-signing key in the same hosted zone.\n')
    status: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A string that represents the current key-signing key (KSK) status. Status can have one of the following values: - **ACTIVE** - The KSK is being used for signing. - **INACTIVE** - The KSK is not being used for signing. - **DELETING** - The KSK is in the process of being deleted. - **ACTION_NEEDED** - There is a problem with the KSK that requires you to take action to resolve. For example, the customer managed key might have been deleted, or the permissions for the customer managed key might have been changed. - **INTERNAL_FAILURE** - There was an error during a request. Before you can continue to work with DNSSEC signing, including actions that involve this KSK, you must correct the problem. For example, you may need to activate or deactivate the KSK.')
...
class CfnRecordSetDef(BaseCfnResource):
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description="For ``ChangeResourceRecordSets`` requests, the name of the record that you want to create, update, or delete. For ``ListResourceRecordSets`` responses, the name of a record in the specified hosted zone. *ChangeResourceRecordSets Only* Enter a fully qualified domain name, for example, ``www.example.com`` . You can optionally include a trailing dot. If you omit the trailing dot, Amazon Route 53 assumes that the domain name that you specify is fully qualified. This means that Route 53 treats ``www.example.com`` (without a trailing dot) and ``www.example.com.`` (with a trailing dot) as identical. For information about how to specify characters other than ``a-z`` , ``0-9`` , and ``-`` (hyphen) and how to specify internationalized domain names, see `DNS Domain Name Format <https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/DomainNameFormat.html>`_ in the *Amazon Route 53 Developer Guide* . You can use the asterisk (*) wildcard to replace the leftmost label in a domain name, for example, ``*.example.com`` . Note the following: - The * must replace the entire label. For example, you can't specify ``*prod.example.com`` or ``prod*.example.com`` . - The * can't replace any of the middle labels, for example, marketing.*.example.com. - If you include * in any position other than the leftmost label in a domain name, DNS treats it as an * character (ASCII 42), not as a wildcard. .. epigraph:: You can't use the * wildcard for resource records sets that have a type of NS.\n")
    type: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The DNS record type. For information about different record types and how data is encoded for them, see `Supported DNS Resource Record Types <https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/ResourceRecordTypes.html>`_ in the *Amazon Route 53 Developer Guide* . Valid values for basic resource record sets: ``A`` | ``AAAA`` | ``CAA`` | ``CNAME`` | ``DS`` | ``MX`` | ``NAPTR`` | ``NS`` | ``PTR`` | ``SOA`` | ``SPF`` | ``SRV`` | ``TXT`` Values for weighted, latency, geolocation, and failover resource record sets: ``A`` | ``AAAA`` | ``CAA`` | ``CNAME`` | ``MX`` | ``NAPTR`` | ``PTR`` | ``SPF`` | ``SRV`` | ``TXT`` . When creating a group of weighted, latency, geolocation, or failover resource record sets, specify the same value for all of the resource record sets in the group. Valid values for multivalue answer resource record sets: ``A`` | ``AAAA`` | ``MX`` | ``NAPTR`` | ``PTR`` | ``SPF`` | ``SRV`` | ``TXT`` | ``CAA`` .. epigraph:: SPF records were formerly used to verify the identity of the sender of email messages. However, we no longer recommend that you create resource record sets for which the value of ``Type`` is ``SPF`` . RFC 7208, *Sender Policy Framework (SPF) for Authorizing Use of Domains in Email, Version 1* , has been updated to say, "...[I]ts existence and mechanism defined in [RFC4408] have led to some interoperability issues. Accordingly, its use is no longer appropriate for SPF version 1; implementations are not to use it." In RFC 7208, see section 14.1, `The SPF DNS Record Type <https://docs.aws.amazon.com/http://tools.ietf.org/html/rfc7208#section-14.1>`_ . Values for alias resource record sets: - *Amazon API Gateway custom regional APIs and edge-optimized APIs:* ``A`` - *CloudFront distributions:* ``A`` If IPv6 is enabled for the distribution, create two resource record sets to route traffic to your distribution, one with a value of ``A`` and one with a value of ``AAAA`` . - *Amazon API Gateway environment that has a regionalized subdomain* : ``A`` - *ELB load balancers:* ``A`` | ``AAAA`` - *Amazon S3 buckets:* ``A`` - *Amazon Virtual Private Cloud interface VPC endpoints* ``A`` - *Another resource record set in this hosted zone:* Specify the type of the resource record set that you\'re creating the alias for. All values are supported except ``NS`` and ``SOA`` . .. epigraph:: If you\'re creating an alias record that has the same name as the hosted zone (known as the zone apex), you can\'t route traffic to a record for which the value of ``Type`` is ``CNAME`` . This is because the alias record must have the same type as the record you\'re routing traffic to, and creating a CNAME record for the zone apex isn\'t supported even for an alias record.\n')
    alias_target: typing.Union[models.UnsupportedResource, models.aws_route53.CfnRecordSet_AliasTargetPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description="*Alias resource record sets only:* Information about the AWS resource, such as a CloudFront distribution or an Amazon S3 bucket, that you want to route traffic to. If you're creating resource records sets for a private hosted zone, note the following: - You can't create an alias resource record set in a private hosted zone to route traffic to a CloudFront distribution. - For information about creating failover resource record sets in a private hosted zone, see `Configuring Failover in a Private Hosted Zone <https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/dns-failover-private-hosted-zones.html>`_ in the *Amazon Route 53 Developer Guide* .\n")
    cidr_routing_config: typing.Union[models.UnsupportedResource, models.aws_route53.CfnRecordSet_CidrRoutingConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The object that is specified in resource record set object when you are linking a resource record set to a CIDR location. A ``LocationName`` with an asterisk “*” can be used to create a default CIDR record. ``CollectionId`` is still required for default record.\n')
    ...
    failover: typing.Optional[str] = pydantic.Field(None, description="*Failover resource record sets only:* To configure failover, you add the ``Failover`` element to two resource record sets. For one resource record set, you specify ``PRIMARY`` as the value for ``Failover`` ; for the other resource record set, you specify ``SECONDARY`` . In addition, you include the ``HealthCheckId`` element and specify the health check that you want Amazon Route 53 to perform for each resource record set. Except where noted, the following failover behaviors assume that you have included the ``HealthCheckId`` element in both resource record sets: - When the primary resource record set is healthy, Route 53 responds to DNS queries with the applicable value from the primary resource record set regardless of the health of the secondary resource record set. - When the primary resource record set is unhealthy and the secondary resource record set is healthy, Route 53 responds to DNS queries with the applicable value from the secondary resource record set. - When the secondary resource record set is unhealthy, Route 53 responds to DNS queries with the applicable value from the primary resource record set regardless of the health of the primary resource record set. - If you omit the ``HealthCheckId`` element for the secondary resource record set, and if the primary resource record set is unhealthy, Route 53 always responds to DNS queries with the applicable value from the secondary resource record set. This is true regardless of the health of the associated endpoint. You can't create non-failover resource record sets that have the same values for the ``Name`` and ``Type`` elements as failover resource record sets. For failover alias resource record sets, you must also include the ``EvaluateTargetHealth`` element and set the value to true. For more information about configuring failover for Route 53, see the following topics in the *Amazon Route 53 Developer Guide* : - `Route 53 Health Checks and DNS Failover <https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/dns-failover.html>`_ - `Configuring Failover in a Private Hosted Zone <https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/dns-failover-private-hosted-zones.html>`_\n")
    geo_location: typing.Union[models.UnsupportedResource, models.aws_route53.CfnRecordSet_GeoLocationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='*Geolocation resource record sets only:* A complex type that lets you control how Amazon Route 53 responds to DNS queries based on the geographic origin of the query. For example, if you want all queries from Africa to be routed to a web server with an IP address of ``192.0.2.111`` , create a resource record set with a ``Type`` of ``A`` and a ``ContinentCode`` of ``AF`` . If you create separate resource record sets for overlapping geographic regions (for example, one resource record set for a continent and one for a country on the same continent), priority goes to the smallest geographic region. This allows you to route most queries for a continent to one resource and to route queries for a country on that continent to a different resource. You can\'t create two geolocation resource record sets that specify the same geographic location. The value ``*`` in the ``CountryCode`` element matches all geographic locations that aren\'t specified in other geolocation resource record sets that have the same values for the ``Name`` and ``Type`` elements. .. epigraph:: Geolocation works by mapping IP addresses to locations. However, some IP addresses aren\'t mapped to geographic locations, so even if you create geolocation resource record sets that cover all seven continents, Route 53 will receive some DNS queries from locations that it can\'t identify. We recommend that you create a resource record set for which the value of ``CountryCode`` is ``*`` . Two groups of queries are routed to the resource that you specify in this record: queries that come from locations for which you haven\'t created geolocation resource record sets and queries from IP addresses that aren\'t mapped to a location. If you don\'t create a ``*`` resource record set, Route 53 returns a "no answer" response for queries from those locations. You can\'t create non-geolocation resource record sets that have the same values for the ``Name`` and ``Type`` elements as geolocation resource record sets.\n')
    geo_proximity_location: typing.Union[models.UnsupportedResource, models.aws_route53.CfnRecordSet_GeoProximityLocationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='*GeoproximityLocation resource record sets only:* A complex type that lets you control how Route 53 responds to DNS queries based on the geographic origin of the query and your resources.\n')
    health_check_id: typing.Optional[str] = pydantic.Field(None, description="If you want Amazon Route 53 to return this resource record set in response to a DNS query only when the status of a health check is healthy, include the ``HealthCheckId`` element and specify the ID of the applicable health check. Route 53 determines whether a resource record set is healthy based on one of the following: - By periodically sending a request to the endpoint that is specified in the health check - By aggregating the status of a specified group of health checks (calculated health checks) - By determining the current state of a CloudWatch alarm (CloudWatch metric health checks) .. epigraph:: Route 53 doesn't check the health of the endpoint that is specified in the resource record set, for example, the endpoint specified by the IP address in the ``Value`` element. When you add a ``HealthCheckId`` element to a resource record set, Route 53 checks the health of the endpoint that you specified in the health check. For more information, see the following topics in the *Amazon Route 53 Developer Guide* : - `How Amazon Route 53 Determines Whether an Endpoint Is Healthy <https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/dns-failover-determining-health-of-endpoints.html>`_ - `Route 53 Health Checks and DNS Failover <https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/dns-failover.html>`_ - `Configuring Failover in a Private Hosted Zone <https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/dns-failover-private-hosted-zones.html>`_ *When to Specify HealthCheckId* Specifying a value for ``HealthCheckId`` is useful only when Route 53 is choosing between two or more resource record sets to respond to a DNS query, and you want Route 53 to base the choice in part on the status of a health check. Configuring health checks makes sense only in the following configurations: - *Non-alias resource record sets* : You're checking the health of a group of non-alias resource record sets that have the same routing policy, name, and type (such as multiple weighted records named www.example.com with a type of A) and you specify health check IDs for all the resource record sets. If the health check status for a resource record set is healthy, Route 53 includes the record among the records that it responds to DNS queries with. If the health check status for a resource record set is unhealthy, Route 53 stops responding to DNS queries using the value for that resource record set. If the health check status for all resource record sets in the group is unhealthy, Route 53 considers all resource record sets in the group healthy and responds to DNS queries accordingly. - *Alias resource record sets* : You specify the following settings: - You set ``EvaluateTargetHealth`` to true for an alias resource record set in a group of resource record sets that have the same routing policy, name, and type (such as multiple weighted records named www.example.com with a type of A). - You configure the alias resource record set to route traffic to a non-alias resource record set in the same hosted zone. - You specify a health check ID for the non-alias resource record set. If the health check status is healthy, Route 53 considers the alias resource record set to be healthy and includes the alias record among the records that it responds to DNS queries with. If the health check status is unhealthy, Route 53 stops responding to DNS queries using the alias resource record set. .. epigraph:: The alias resource record set can also route traffic to a *group* of non-alias resource record sets that have the same routing policy, name, and type. In that configuration, associate health checks with all of the resource record sets in the group of non-alias resource record sets. *Geolocation Routing* For geolocation resource record sets, if an endpoint is unhealthy, Route 53 looks for a resource record set for the larger, associated geographic region. For example, suppose you have resource record sets for a state in the United States, for the entire United States, for North America, and a resource record set that has ``*`` for ``CountryCode`` is ``*`` , which applies to all locations. If the endpoint for the state resource record set is unhealthy, Route 53 checks for healthy resource record sets in the following order until it finds a resource record set for which the endpoint is healthy: - The United States - North America - The default resource record set *Specifying the Health Check Endpoint by Domain Name* If your health checks specify the endpoint only by domain name, we recommend that you create a separate health check for each endpoint. For example, create a health check for each ``HTTP`` server that is serving content for ``www.example.com`` . For the value of ``FullyQualifiedDomainName`` , specify the domain name of the server (such as ``us-east-2-www.example.com`` ), not the name of the resource record sets ( ``www.example.com`` ). .. epigraph:: Health check results will be unpredictable if you do the following: - Create a health check that has the same value for ``FullyQualifiedDomainName`` as the name of a resource record set. - Associate that health check with the resource record set.\n")
    ...
    ttl: typing.Optional[str] = pydantic.Field(None, description="The resource record cache time to live (TTL), in seconds. Note the following:. - If you're creating or updating an alias resource record set, omit ``TTL`` . Amazon Route 53 uses the value of ``TTL`` for the alias target. - If you're associating this resource record set with a health check (if you're adding a ``HealthCheckId`` element), we recommend that you specify a ``TTL`` of 60 seconds or less so clients respond quickly to changes in health status. - All of the resource record sets in a group of weighted resource record sets must have the same value for ``TTL`` . - If a group of weighted resource record sets includes one or more weighted alias resource record sets for which the alias target is an ELB load balancer, we recommend that you specify a ``TTL`` of 60 seconds for all of the non-alias weighted resource record sets that have the same name and type. Values other than 60 seconds (the TTL for load balancers) will change the effect of the values that you specify for ``Weight`` .\n")
    weight: typing.Union[int, float, None] = pydantic.Field(None, description="*Weighted resource record sets only:* Among resource record sets that have the same combination of DNS name and type, a value that determines the proportion of DNS queries that Amazon Route 53 responds to using the current resource record set. Route 53 calculates the sum of the weights for the resource record sets that have the same combination of DNS name and type. Route 53 then responds to queries based on the ratio of a resource's weight to the total. Note the following: - You must specify a value for the ``Weight`` element for every weighted resource record set. - You can only specify one ``ResourceRecord`` per weighted resource record set. - You can't create latency, failover, or geolocation resource record sets that have the same values for the ``Name`` and ``Type`` elements as weighted resource record sets. - You can create a maximum of 100 weighted resource record sets that have the same values for the ``Name`` and ``Type`` elements. - For weighted (but not weighted alias) resource record sets, if you set ``Weight`` to ``0`` for a resource record set, Route 53 never responds to queries with the applicable value for that resource record set. However, if you set ``Weight`` to ``0`` for all resource record sets that have the same combination of DNS name and type, traffic is routed to all resources with equal probability. The effect of setting ``Weight`` to ``0`` is different when you associate health checks with weighted resource record sets. For more information, see `Options for Configuring Route 53 Active-Active and Active-Passive Failover <https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/dns-failover-configuring-options.html>`_ in the *Amazon Route 53 Developer Guide* .")
    _init_params: typing.ClassVar[list[str]] = ['name', 'type', 'alias_target', 'cidr_routing_config', 'comment', 'failover', 'geo_location', 'geo_proximity_location', 'health_check_id', 'hosted_zone_id', 'hosted_zone_name', 'multi_value_answer', 'region', 'resource_records', 'set_identifier', 'ttl', 'weight']
    _method_names: typing.ClassVar[list[str]] = ['AliasTargetProperty', 'CidrRoutingConfigProperty', 'CoordinatesProperty', 'GeoLocationProperty', 'GeoProximityLocationProperty', 'add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnRecordSetDefConfig(pydantic.BaseModel):
    ...
    CoordinatesProperty: typing.Optional[list[models.aws_route53.CfnRecordSetDefCoordinatespropertyParams]] = pydantic.Field(None, description='')
    ...
    GeoProximityLocationProperty: typing.Optional[list[models.aws_route53.CfnRecordSetDefGeoproximitylocationpropertyParams]] = pydantic.Field(None, description='')
...
class CfnRecordSetDefCoordinatespropertyParams(pydantic.BaseModel):
...
class CfnRecordSetDefGeoproximitylocationpropertyParams(pydantic.BaseModel):
    aws_region: typing.Optional[str] = pydantic.Field(None, description='')
    bias: typing.Union[int, float, None] = pydantic.Field(None, description='')
    coordinates: typing.Union[models.UnsupportedResource, models.aws_route53.CfnRecordSet_CoordinatesPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    local_zone_group: typing.Optional[str] = pydantic.Field(None, description='')
    ...
...
class CfnRecordSetGroupDefConfig(pydantic.BaseModel):
    ...
    CoordinatesProperty: typing.Optional[list[models.aws_route53.CfnRecordSetGroupDefCoordinatespropertyParams]] = pydantic.Field(None, description='')
    ...
    GeoProximityLocationProperty: typing.Optional[list[models.aws_route53.CfnRecordSetGroupDefGeoproximitylocationpropertyParams]] = pydantic.Field(None, description='')
...
class CfnRecordSetGroupDefCoordinatespropertyParams(pydantic.BaseModel):
    latitude: str = pydantic.Field(..., description='')
    longitude: str = pydantic.Field(..., description='')
    ...
...
class CfnRecordSetGroupDefGeoproximitylocationpropertyParams(pydantic.BaseModel):
    aws_region: typing.Optional[str] = pydantic.Field(None, description='')
    bias: typing.Union[int, float, None] = pydantic.Field(None, description='')
    coordinates: typing.Union[models.UnsupportedResource, models.aws_route53.CfnRecordSetGroup_CoordinatesPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    local_zone_group: typing.Optional[str] = pydantic.Field(None, description='')
    ...
...
class CfnRecordSetGroupDefRecordsetpropertyParams(pydantic.BaseModel):
    name: str = pydantic.Field(..., description='')
    type: str = pydantic.Field(..., description='')
    alias_target: typing.Union[models.UnsupportedResource, models.aws_route53.CfnRecordSetGroup_AliasTargetPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    cidr_routing_config: typing.Union[models.UnsupportedResource, models.aws_route53.CfnRecordSetGroup_CidrRoutingConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    failover: typing.Optional[str] = pydantic.Field(None, description='')
    geo_location: typing.Union[models.UnsupportedResource, models.aws_route53.CfnRecordSetGroup_GeoLocationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    geo_proximity_location: typing.Union[models.UnsupportedResource, models.aws_route53.CfnRecordSetGroup_GeoProximityLocationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
    multi_value_answer: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
...
class ModuleModel(pydantic.BaseModel):
    ...
    KeySigningKey: typing.Optional[dict[str, models.aws_route53.KeySigningKeyDef]] = pydantic.Field(None)
    ...
    ARecordAttrs: typing.Optional[dict[str, models.aws_route53.ARecordAttrsDef]] = pydantic.Field(None)
    ...
    CfnRecordSet_CoordinatesProperty: typing.Optional[dict[str, models.aws_route53.CfnRecordSet_CoordinatesPropertyDef]] = pydantic.Field(None)
    ...
    CfnRecordSet_GeoProximityLocationProperty: typing.Optional[dict[str, models.aws_route53.CfnRecordSet_GeoProximityLocationPropertyDef]] = pydantic.Field(None)
    ...
    CfnRecordSetGroup_CoordinatesProperty: typing.Optional[dict[str, models.aws_route53.CfnRecordSetGroup_CoordinatesPropertyDef]] = pydantic.Field(None)
    ...
    CfnRecordSetGroup_GeoProximityLocationProperty: typing.Optional[dict[str, models.aws_route53.CfnRecordSetGroup_GeoProximityLocationPropertyDef]] = pydantic.Field(None)
    ...
    KeySigningKeyAttributes: typing.Optional[dict[str, models.aws_route53.KeySigningKeyAttributesDef]] = pydantic.Field(None)
    KeySigningKeyProps: typing.Optional[dict[str, models.aws_route53.KeySigningKeyPropsDef]] = pydantic.Field(None)
    ...
    ZoneSigningOptions: typing.Optional[dict[str, models.aws_route53.ZoneSigningOptionsDef]] = pydantic.Field(None)
