...
class AaaaRecordDef(BaseConstruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['target', 'zone', 'comment', 'delete_existing', 'geo_location', 'record_name', 'ttl']
...
class CaaAmazonRecordDef(BaseConstruct):
    ...
    record_name: typing.Optional[str] = pydantic.Field(None, description='The subdomain name for this record. This should be relative to the zone root name. For example, if you want to create a record for acme.example.com, specify "acme". You can also specify the fully qualified domain name which terminates with a ".". For example, "acme.example.com.". Default: zone root\n')
    ttl: typing.Optional[models.DurationDef] = pydantic.Field(None, description='The resource record cache time to live (TTL). Default: Duration.minutes(30)')
    _init_params: typing.ClassVar[list[str]] = ['zone', 'comment', 'delete_existing', 'geo_location', 'record_name', 'ttl']
    _method_names: typing.ClassVar[list[str]] = ['apply_removal_policy']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CaaRecordDef(BaseConstruct):
    ...
    record_name: typing.Optional[str] = pydantic.Field(None, description='The subdomain name for this record. This should be relative to the zone root name. For example, if you want to create a record for acme.example.com, specify "acme". You can also specify the fully qualified domain name which terminates with a ".". For example, "acme.example.com.". Default: zone root\n')
    ttl: typing.Optional[models.DurationDef] = pydantic.Field(None, description='The resource record cache time to live (TTL). Default: Duration.minutes(30)')
    _init_params: typing.ClassVar[list[str]] = ['values', 'zone', 'comment', 'delete_existing', 'geo_location', 'record_name', 'ttl']
    _method_names: typing.ClassVar[list[str]] = ['apply_removal_policy']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CnameRecordDef(BaseConstruct):
    ...
    record_name: typing.Optional[str] = pydantic.Field(None, description='The subdomain name for this record. This should be relative to the zone root name. For example, if you want to create a record for acme.example.com, specify "acme". You can also specify the fully qualified domain name which terminates with a ".". For example, "acme.example.com.". Default: zone root\n')
    ttl: typing.Optional[models.DurationDef] = pydantic.Field(None, description='The resource record cache time to live (TTL). Default: Duration.minutes(30)')
    _init_params: typing.ClassVar[list[str]] = ['domain_name', 'zone', 'comment', 'delete_existing', 'geo_location', 'record_name', 'ttl']
    _method_names: typing.ClassVar[list[str]] = ['apply_removal_policy']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class HostedZoneDef(BaseConstruct):
    ...
    _method_names: typing.ClassVar[list[str]] = ['add_vpc', 'apply_removal_policy', 'grant_delegation']
...
class RecordSetDef(BaseConstruct):
    ...
    record_name: typing.Optional[str] = pydantic.Field(None, description='The subdomain name for this record. This should be relative to the zone root name. For example, if you want to create a record for acme.example.com, specify "acme". You can also specify the fully qualified domain name which terminates with a ".". For example, "acme.example.com.". Default: zone root\n')
    ttl: typing.Optional[models.DurationDef] = pydantic.Field(None, description='The resource record cache time to live (TTL). Default: Duration.minutes(30)')
    _init_params: typing.ClassVar[list[str]] = ['record_type', 'target', 'zone', 'comment', 'delete_existing', 'geo_location', 'record_name', 'ttl']
    _method_names: typing.ClassVar[list[str]] = ['apply_removal_policy']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class ZoneDelegationRecordDef(BaseConstruct):
    ...
    record_name: typing.Optional[str] = pydantic.Field(None, description='The subdomain name for this record. This should be relative to the zone root name. For example, if you want to create a record for acme.example.com, specify "acme". You can also specify the fully qualified domain name which terminates with a ".". For example, "acme.example.com.". Default: zone root\n')
    ttl: typing.Optional[models.DurationDef] = pydantic.Field(None, description='The resource record cache time to live (TTL). Default: Duration.minutes(30)')
    _init_params: typing.ClassVar[list[str]] = ['name_servers', 'zone', 'comment', 'delete_existing', 'geo_location', 'record_name', 'ttl']
    _method_names: typing.ClassVar[list[str]] = ['apply_removal_policy']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class AaaaRecordPropsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['zone', 'comment', 'delete_existing', 'geo_location', 'record_name', 'ttl', 'target']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CaaRecordPropsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['zone', 'comment', 'delete_existing', 'geo_location', 'record_name', 'ttl', 'values']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CnameRecordPropsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['zone', 'comment', 'delete_existing', 'geo_location', 'record_name', 'ttl', 'domain_name']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class RecordSetPropsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['zone', 'comment', 'delete_existing', 'geo_location', 'record_name', 'ttl', 'record_type', 'target']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class ZoneDelegationRecordPropsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['zone', 'comment', 'delete_existing', 'geo_location', 'record_name', 'ttl', 'name_servers']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
