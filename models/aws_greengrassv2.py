...
class CfnComponentVersionDef(BaseCfnResource):
    ...
    resource_config: typing.Optional[models.aws_greengrassv2.CfnComponentVersionDefConfig] = pydantic.Field(None)


class CfnComponentVersionDefConfig(pydantic.BaseModel):
    ComponentDependencyRequirementProperty: typing.Optional[list[models.aws_greengrassv2.CfnComponentVersionDefComponentdependencyrequirementpropertyParams]] = pydantic.Field(None, description='')
    ComponentPlatformProperty: typing.Optional[list[models.aws_greengrassv2.CfnComponentVersionDefComponentplatformpropertyParams]] = pydantic.Field(None, description='')
    LambdaContainerParamsProperty: typing.Optional[list[models.aws_greengrassv2.CfnComponentVersionDefLambdacontainerparamspropertyParams]] = pydantic.Field(None, description='')
    LambdaDeviceMountProperty: typing.Optional[list[models.aws_greengrassv2.CfnComponentVersionDefLambdadevicemountpropertyParams]] = pydantic.Field(None, description='')
    LambdaEventSourceProperty: typing.Optional[list[models.aws_greengrassv2.CfnComponentVersionDefLambdaeventsourcepropertyParams]] = pydantic.Field(None, description='')
    LambdaExecutionParametersProperty: typing.Optional[list[models.aws_greengrassv2.CfnComponentVersionDefLambdaexecutionparameterspropertyParams]] = pydantic.Field(None, description='')
    LambdaFunctionRecipeSourceProperty: typing.Optional[list[models.aws_greengrassv2.CfnComponentVersionDefLambdafunctionrecipesourcepropertyParams]] = pydantic.Field(None, description='')
    LambdaLinuxProcessParamsProperty: typing.Optional[list[models.aws_greengrassv2.CfnComponentVersionDefLambdalinuxprocessparamspropertyParams]] = pydantic.Field(None, description='')
    LambdaVolumeMountProperty: typing.Optional[list[models.aws_greengrassv2.CfnComponentVersionDefLambdavolumemountpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_greengrassv2.CfnComponentVersionDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_greengrassv2.CfnComponentVersionDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_greengrassv2.CfnComponentVersionDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_greengrassv2.CfnComponentVersionDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_greengrassv2.CfnComponentVersionDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_greengrassv2.CfnComponentVersionDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_greengrassv2.CfnComponentVersionDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_greengrassv2.CfnComponentVersionDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_greengrassv2.CfnComponentVersionDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_greengrassv2.CfnComponentVersionDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_greengrassv2.CfnComponentVersionDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_greengrassv2.CfnComponentVersionDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_greengrassv2.CfnComponentVersionDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
class CfnDeploymentDef(BaseCfnResource):
    ...
    resource_config: typing.Optional[models.aws_greengrassv2.CfnDeploymentDefConfig] = pydantic.Field(None)


class CfnDeploymentDefConfig(pydantic.BaseModel):
    ComponentConfigurationUpdateProperty: typing.Optional[list[models.aws_greengrassv2.CfnDeploymentDefComponentconfigurationupdatepropertyParams]] = pydantic.Field(None, description='')
    ComponentDeploymentSpecificationProperty: typing.Optional[list[models.aws_greengrassv2.CfnDeploymentDefComponentdeploymentspecificationpropertyParams]] = pydantic.Field(None, description='')
    ComponentRunWithProperty: typing.Optional[list[models.aws_greengrassv2.CfnDeploymentDefComponentrunwithpropertyParams]] = pydantic.Field(None, description='')
    DeploymentComponentUpdatePolicyProperty: typing.Optional[list[models.aws_greengrassv2.CfnDeploymentDefDeploymentcomponentupdatepolicypropertyParams]] = pydantic.Field(None, description='')
    DeploymentConfigurationValidationPolicyProperty: typing.Optional[list[models.aws_greengrassv2.CfnDeploymentDefDeploymentconfigurationvalidationpolicypropertyParams]] = pydantic.Field(None, description='')
    DeploymentIoTJobConfigurationProperty: typing.Optional[list[models.aws_greengrassv2.CfnDeploymentDefDeploymentiotjobconfigurationpropertyParams]] = pydantic.Field(None, description='')
    DeploymentPoliciesProperty: typing.Optional[list[models.aws_greengrassv2.CfnDeploymentDefDeploymentpoliciespropertyParams]] = pydantic.Field(None, description='')
    IoTJobAbortConfigProperty: typing.Optional[list[models.aws_greengrassv2.CfnDeploymentDefIotjobabortconfigpropertyParams]] = pydantic.Field(None, description='')
    IoTJobAbortCriteriaProperty: typing.Optional[list[models.aws_greengrassv2.CfnDeploymentDefIotjobabortcriteriapropertyParams]] = pydantic.Field(None, description='')
    IoTJobExecutionsRolloutConfigProperty: typing.Optional[list[models.aws_greengrassv2.CfnDeploymentDefIotjobexecutionsrolloutconfigpropertyParams]] = pydantic.Field(None, description='')
    IoTJobExponentialRolloutRateProperty: typing.Optional[list[models.aws_greengrassv2.CfnDeploymentDefIotjobexponentialrolloutratepropertyParams]] = pydantic.Field(None, description='')
    IoTJobTimeoutConfigProperty: typing.Optional[list[models.aws_greengrassv2.CfnDeploymentDefIotjobtimeoutconfigpropertyParams]] = pydantic.Field(None, description='')
    SystemResourceLimitsProperty: typing.Optional[list[models.aws_greengrassv2.CfnDeploymentDefSystemresourcelimitspropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_greengrassv2.CfnDeploymentDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_greengrassv2.CfnDeploymentDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_greengrassv2.CfnDeploymentDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_greengrassv2.CfnDeploymentDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_greengrassv2.CfnDeploymentDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_greengrassv2.CfnDeploymentDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_greengrassv2.CfnDeploymentDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_greengrassv2.CfnDeploymentDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_greengrassv2.CfnDeploymentDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_greengrassv2.CfnDeploymentDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_greengrassv2.CfnDeploymentDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_greengrassv2.CfnDeploymentDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_greengrassv2.CfnDeploymentDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
    tags_config: typing.Optional[models.core.TagManagerDefConfig] = pydantic.Field(None)
...
class ModuleModel(pydantic.BaseModel):
    CfnComponentVersion_ComponentDependencyRequirementProperty: typing.Optional[dict[str, models.aws_greengrassv2.CfnComponentVersion_ComponentDependencyRequirementPropertyDef]] = pydantic.Field(None)
    CfnComponentVersion_ComponentPlatformProperty: typing.Optional[dict[str, models.aws_greengrassv2.CfnComponentVersion_ComponentPlatformPropertyDef]] = pydantic.Field(None)
    CfnComponentVersion_LambdaContainerParamsProperty: typing.Optional[dict[str, models.aws_greengrassv2.CfnComponentVersion_LambdaContainerParamsPropertyDef]] = pydantic.Field(None)
    CfnComponentVersion_LambdaDeviceMountProperty: typing.Optional[dict[str, models.aws_greengrassv2.CfnComponentVersion_LambdaDeviceMountPropertyDef]] = pydantic.Field(None)
    CfnComponentVersion_LambdaEventSourceProperty: typing.Optional[dict[str, models.aws_greengrassv2.CfnComponentVersion_LambdaEventSourcePropertyDef]] = pydantic.Field(None)
    CfnComponentVersion_LambdaExecutionParametersProperty: typing.Optional[dict[str, models.aws_greengrassv2.CfnComponentVersion_LambdaExecutionParametersPropertyDef]] = pydantic.Field(None)
    CfnComponentVersion_LambdaFunctionRecipeSourceProperty: typing.Optional[dict[str, models.aws_greengrassv2.CfnComponentVersion_LambdaFunctionRecipeSourcePropertyDef]] = pydantic.Field(None)
    CfnComponentVersion_LambdaLinuxProcessParamsProperty: typing.Optional[dict[str, models.aws_greengrassv2.CfnComponentVersion_LambdaLinuxProcessParamsPropertyDef]] = pydantic.Field(None)
    CfnComponentVersion_LambdaVolumeMountProperty: typing.Optional[dict[str, models.aws_greengrassv2.CfnComponentVersion_LambdaVolumeMountPropertyDef]] = pydantic.Field(None)
    CfnDeployment_ComponentConfigurationUpdateProperty: typing.Optional[dict[str, models.aws_greengrassv2.CfnDeployment_ComponentConfigurationUpdatePropertyDef]] = pydantic.Field(None)
    CfnDeployment_ComponentDeploymentSpecificationProperty: typing.Optional[dict[str, models.aws_greengrassv2.CfnDeployment_ComponentDeploymentSpecificationPropertyDef]] = pydantic.Field(None)
    CfnDeployment_ComponentRunWithProperty: typing.Optional[dict[str, models.aws_greengrassv2.CfnDeployment_ComponentRunWithPropertyDef]] = pydantic.Field(None)
    CfnDeployment_DeploymentComponentUpdatePolicyProperty: typing.Optional[dict[str, models.aws_greengrassv2.CfnDeployment_DeploymentComponentUpdatePolicyPropertyDef]] = pydantic.Field(None)
    CfnDeployment_DeploymentConfigurationValidationPolicyProperty: typing.Optional[dict[str, models.aws_greengrassv2.CfnDeployment_DeploymentConfigurationValidationPolicyPropertyDef]] = pydantic.Field(None)
    CfnDeployment_DeploymentIoTJobConfigurationProperty: typing.Optional[dict[str, models.aws_greengrassv2.CfnDeployment_DeploymentIoTJobConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDeployment_DeploymentPoliciesProperty: typing.Optional[dict[str, models.aws_greengrassv2.CfnDeployment_DeploymentPoliciesPropertyDef]] = pydantic.Field(None)
    CfnDeployment_IoTJobAbortConfigProperty: typing.Optional[dict[str, models.aws_greengrassv2.CfnDeployment_IoTJobAbortConfigPropertyDef]] = pydantic.Field(None)
    CfnDeployment_IoTJobAbortCriteriaProperty: typing.Optional[dict[str, models.aws_greengrassv2.CfnDeployment_IoTJobAbortCriteriaPropertyDef]] = pydantic.Field(None)
    CfnDeployment_IoTJobExecutionsRolloutConfigProperty: typing.Optional[dict[str, models.aws_greengrassv2.CfnDeployment_IoTJobExecutionsRolloutConfigPropertyDef]] = pydantic.Field(None)
    CfnDeployment_IoTJobExponentialRolloutRateProperty: typing.Optional[dict[str, models.aws_greengrassv2.CfnDeployment_IoTJobExponentialRolloutRatePropertyDef]] = pydantic.Field(None)
    CfnDeployment_IoTJobTimeoutConfigProperty: typing.Optional[dict[str, models.aws_greengrassv2.CfnDeployment_IoTJobTimeoutConfigPropertyDef]] = pydantic.Field(None)
    CfnDeployment_SystemResourceLimitsProperty: typing.Optional[dict[str, models.aws_greengrassv2.CfnDeployment_SystemResourceLimitsPropertyDef]] = pydantic.Field(None)
    CfnComponentVersion: typing.Optional[dict[str, models.aws_greengrassv2.CfnComponentVersionDef]] = pydantic.Field(None)
    CfnDeployment: typing.Optional[dict[str, models.aws_greengrassv2.CfnDeploymentDef]] = pydantic.Field(None)
    CfnComponentVersionProps: typing.Optional[dict[str, models.aws_greengrassv2.CfnComponentVersionPropsDef]] = pydantic.Field(None)
    CfnDeploymentProps: typing.Optional[dict[str, models.aws_greengrassv2.CfnDeploymentPropsDef]] = pydantic.Field(None)
    ...
