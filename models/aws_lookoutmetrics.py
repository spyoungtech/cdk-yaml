...
class CfnAlertDef(BaseCfnResource):
    ...
    resource_config: typing.Optional[models.aws_lookoutmetrics.CfnAlertDefConfig] = pydantic.Field(None)


class CfnAlertDefConfig(pydantic.BaseModel):
    ActionProperty: typing.Optional[list[models.aws_lookoutmetrics.CfnAlertDefActionpropertyParams]] = pydantic.Field(None, description='')
    LambdaConfigurationProperty: typing.Optional[list[models.aws_lookoutmetrics.CfnAlertDefLambdaconfigurationpropertyParams]] = pydantic.Field(None, description='')
    SNSConfigurationProperty: typing.Optional[list[models.aws_lookoutmetrics.CfnAlertDefSnsconfigurationpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_lookoutmetrics.CfnAlertDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_lookoutmetrics.CfnAlertDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_lookoutmetrics.CfnAlertDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_lookoutmetrics.CfnAlertDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_lookoutmetrics.CfnAlertDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_lookoutmetrics.CfnAlertDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_lookoutmetrics.CfnAlertDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_lookoutmetrics.CfnAlertDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_lookoutmetrics.CfnAlertDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_lookoutmetrics.CfnAlertDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_lookoutmetrics.CfnAlertDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_lookoutmetrics.CfnAlertDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_lookoutmetrics.CfnAlertDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
class CfnAnomalyDetectorDef(BaseCfnResource):
    ...
    resource_config: typing.Optional[models.aws_lookoutmetrics.CfnAnomalyDetectorDefConfig] = pydantic.Field(None)


class CfnAnomalyDetectorDefConfig(pydantic.BaseModel):
    AnomalyDetectorConfigProperty: typing.Optional[list[models.aws_lookoutmetrics.CfnAnomalyDetectorDefAnomalydetectorconfigpropertyParams]] = pydantic.Field(None, description='')
    AppFlowConfigProperty: typing.Optional[list[models.aws_lookoutmetrics.CfnAnomalyDetectorDefAppflowconfigpropertyParams]] = pydantic.Field(None, description='')
    CloudwatchConfigProperty: typing.Optional[list[models.aws_lookoutmetrics.CfnAnomalyDetectorDefCloudwatchconfigpropertyParams]] = pydantic.Field(None, description='')
    CsvFormatDescriptorProperty: typing.Optional[list[models.aws_lookoutmetrics.CfnAnomalyDetectorDefCsvformatdescriptorpropertyParams]] = pydantic.Field(None, description='')
    FileFormatDescriptorProperty: typing.Optional[list[models.aws_lookoutmetrics.CfnAnomalyDetectorDefFileformatdescriptorpropertyParams]] = pydantic.Field(None, description='')
    JsonFormatDescriptorProperty: typing.Optional[list[models.aws_lookoutmetrics.CfnAnomalyDetectorDefJsonformatdescriptorpropertyParams]] = pydantic.Field(None, description='')
    MetricProperty: typing.Optional[list[models.aws_lookoutmetrics.CfnAnomalyDetectorDefMetricpropertyParams]] = pydantic.Field(None, description='')
    MetricSetProperty: typing.Optional[list[models.aws_lookoutmetrics.CfnAnomalyDetectorDefMetricsetpropertyParams]] = pydantic.Field(None, description='')
    MetricSourceProperty: typing.Optional[list[models.aws_lookoutmetrics.CfnAnomalyDetectorDefMetricsourcepropertyParams]] = pydantic.Field(None, description='')
    RDSSourceConfigProperty: typing.Optional[list[models.aws_lookoutmetrics.CfnAnomalyDetectorDefRdssourceconfigpropertyParams]] = pydantic.Field(None, description='')
    RedshiftSourceConfigProperty: typing.Optional[list[models.aws_lookoutmetrics.CfnAnomalyDetectorDefRedshiftsourceconfigpropertyParams]] = pydantic.Field(None, description='')
    S3SourceConfigProperty: typing.Optional[list[models.aws_lookoutmetrics.CfnAnomalyDetectorDefS3SourceconfigpropertyParams]] = pydantic.Field(None, description='')
    TimestampColumnProperty: typing.Optional[list[models.aws_lookoutmetrics.CfnAnomalyDetectorDefTimestampcolumnpropertyParams]] = pydantic.Field(None, description='')
    VpcConfigurationProperty: typing.Optional[list[models.aws_lookoutmetrics.CfnAnomalyDetectorDefVpcconfigurationpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_lookoutmetrics.CfnAnomalyDetectorDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_lookoutmetrics.CfnAnomalyDetectorDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_lookoutmetrics.CfnAnomalyDetectorDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_lookoutmetrics.CfnAnomalyDetectorDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_lookoutmetrics.CfnAnomalyDetectorDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_lookoutmetrics.CfnAnomalyDetectorDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_lookoutmetrics.CfnAnomalyDetectorDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_lookoutmetrics.CfnAnomalyDetectorDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_lookoutmetrics.CfnAnomalyDetectorDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_lookoutmetrics.CfnAnomalyDetectorDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_lookoutmetrics.CfnAnomalyDetectorDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_lookoutmetrics.CfnAnomalyDetectorDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_lookoutmetrics.CfnAnomalyDetectorDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
class ModuleModel(pydantic.BaseModel):
    CfnAlert_ActionProperty: typing.Optional[dict[str, models.aws_lookoutmetrics.CfnAlert_ActionPropertyDef]] = pydantic.Field(None)
    CfnAlert_LambdaConfigurationProperty: typing.Optional[dict[str, models.aws_lookoutmetrics.CfnAlert_LambdaConfigurationPropertyDef]] = pydantic.Field(None)
    CfnAlert_SNSConfigurationProperty: typing.Optional[dict[str, models.aws_lookoutmetrics.CfnAlert_SNSConfigurationPropertyDef]] = pydantic.Field(None)
    CfnAnomalyDetector_AnomalyDetectorConfigProperty: typing.Optional[dict[str, models.aws_lookoutmetrics.CfnAnomalyDetector_AnomalyDetectorConfigPropertyDef]] = pydantic.Field(None)
    CfnAnomalyDetector_AppFlowConfigProperty: typing.Optional[dict[str, models.aws_lookoutmetrics.CfnAnomalyDetector_AppFlowConfigPropertyDef]] = pydantic.Field(None)
    CfnAnomalyDetector_CloudwatchConfigProperty: typing.Optional[dict[str, models.aws_lookoutmetrics.CfnAnomalyDetector_CloudwatchConfigPropertyDef]] = pydantic.Field(None)
    CfnAnomalyDetector_CsvFormatDescriptorProperty: typing.Optional[dict[str, models.aws_lookoutmetrics.CfnAnomalyDetector_CsvFormatDescriptorPropertyDef]] = pydantic.Field(None)
    CfnAnomalyDetector_FileFormatDescriptorProperty: typing.Optional[dict[str, models.aws_lookoutmetrics.CfnAnomalyDetector_FileFormatDescriptorPropertyDef]] = pydantic.Field(None)
    CfnAnomalyDetector_JsonFormatDescriptorProperty: typing.Optional[dict[str, models.aws_lookoutmetrics.CfnAnomalyDetector_JsonFormatDescriptorPropertyDef]] = pydantic.Field(None)
    CfnAnomalyDetector_MetricProperty: typing.Optional[dict[str, models.aws_lookoutmetrics.CfnAnomalyDetector_MetricPropertyDef]] = pydantic.Field(None)
    CfnAnomalyDetector_MetricSetProperty: typing.Optional[dict[str, models.aws_lookoutmetrics.CfnAnomalyDetector_MetricSetPropertyDef]] = pydantic.Field(None)
    CfnAnomalyDetector_MetricSourceProperty: typing.Optional[dict[str, models.aws_lookoutmetrics.CfnAnomalyDetector_MetricSourcePropertyDef]] = pydantic.Field(None)
    CfnAnomalyDetector_RDSSourceConfigProperty: typing.Optional[dict[str, models.aws_lookoutmetrics.CfnAnomalyDetector_RDSSourceConfigPropertyDef]] = pydantic.Field(None)
    CfnAnomalyDetector_RedshiftSourceConfigProperty: typing.Optional[dict[str, models.aws_lookoutmetrics.CfnAnomalyDetector_RedshiftSourceConfigPropertyDef]] = pydantic.Field(None)
    CfnAnomalyDetector_S3SourceConfigProperty: typing.Optional[dict[str, models.aws_lookoutmetrics.CfnAnomalyDetector_S3SourceConfigPropertyDef]] = pydantic.Field(None)
    CfnAnomalyDetector_TimestampColumnProperty: typing.Optional[dict[str, models.aws_lookoutmetrics.CfnAnomalyDetector_TimestampColumnPropertyDef]] = pydantic.Field(None)
    CfnAnomalyDetector_VpcConfigurationProperty: typing.Optional[dict[str, models.aws_lookoutmetrics.CfnAnomalyDetector_VpcConfigurationPropertyDef]] = pydantic.Field(None)
    CfnAlert: typing.Optional[dict[str, models.aws_lookoutmetrics.CfnAlertDef]] = pydantic.Field(None)
    CfnAnomalyDetector: typing.Optional[dict[str, models.aws_lookoutmetrics.CfnAnomalyDetectorDef]] = pydantic.Field(None)
    CfnAlertProps: typing.Optional[dict[str, models.aws_lookoutmetrics.CfnAlertPropsDef]] = pydantic.Field(None)
    CfnAnomalyDetectorProps: typing.Optional[dict[str, models.aws_lookoutmetrics.CfnAnomalyDetectorPropsDef]] = pydantic.Field(None)
    ...
