...
class CfnStreamProcessorDefConfig(pydantic.BaseModel):
    ...
    PointProperty: typing.Optional[list[CfnStreamProcessorDefPointpropertyParams]] = pydantic.Field(None, description='')
...
class ModuleModel(pydantic.BaseModel):
    ...
    CfnStreamProcessor_PointProperty: typing.Optional[dict[str, CfnStreamProcessor_PointPropertyDef]] = pydantic.Field(None)
