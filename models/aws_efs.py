...
class FileSystemDef(BaseConstruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['vpc', 'allow_anonymous_access', 'enable_automatic_backups', 'encrypted', 'file_system_name', 'file_system_policy', 'kms_key', 'lifecycle_policy', 'out_of_infrequent_access_policy', 'performance_mode', 'provisioned_throughput_per_second', 'removal_policy', 'security_group', 'throughput_mode', 'vpc_subnets']
...
class FileSystemDefConfig(pydantic.BaseModel):
    ...
    grant_read: typing.Optional[list[FileSystemDefGrantReadParams]] = pydantic.Field(None, description='Grant read permissions for this file system to an IAM principal.')
    grant_read_write: typing.Optional[list[FileSystemDefGrantReadWriteParams]] = pydantic.Field(None, description='Grant read and write permissions for this file system to an IAM principal.')
    grant_root_access: typing.Optional[list[FileSystemDefGrantRootAccessParams]] = pydantic.Field(None, description='As root user, grant read and write permissions for this file system to an IAM principal.')
...
class CfnFileSystem_ReplicationDestinationPropertyDef(BaseStruct):
    ...
    region: typing.Optional[str] = pydantic.Field(None, description='The AWS Region in which the destination file system is located. .. epigraph:: For file systems using Standard storage classes, the replication configuration must specify the AWS Region in which the destination file system is located.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-efs-filesystem-replicationdestination.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_efs as efs\n\n    replication_destination_property = efs.CfnFileSystem.ReplicationDestinationProperty(\n        availability_zone_name="availabilityZoneName",\n        file_system_id="fileSystemId",\n        kms_key_id="kmsKeyId",\n        region="region"\n    )\n')
...
class CfnAccessPointDef(BaseCfnResource):
    ...
    root_directory: typing.Union[models.UnsupportedResource, models.aws_efs.CfnAccessPoint_RootDirectoryPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The directory on the Amazon EFS file system that the access point exposes as the root directory to NFS clients using the access point.')
...
class CfnFileSystemDef(BaseCfnResource):
    ...
    performance_mode: typing.Optional[str] = pydantic.Field(None, description="The performance mode of the file system. We recommend ``generalPurpose`` performance mode for all file systems. File systems using the ``maxIO`` performance mode can scale to higher levels of aggregate throughput and operations per second with a tradeoff of slightly higher latencies for most file operations. The performance mode can't be changed after the file system has been created. The ``maxIO`` mode is not supported on file systems using One Zone storage classes. .. epigraph:: Due to the higher per-operation latencies with Max I/O, we recommend using General Purpose performance mode for all file systems. Default is ``generalPurpose`` .\n")
    ...
    _init_params: typing.ClassVar[list[str]] = ['availability_zone_name', 'backup_policy', 'bypass_policy_lockout_safety_check', 'encrypted', 'file_system_policy', 'file_system_tags', 'kms_key_id', 'lifecycle_policies', 'performance_mode', 'provisioned_throughput_in_mibps', 'replication_configuration', 'throughput_mode']
    _method_names: typing.ClassVar[list[str]] = ['BackupPolicyProperty', 'ElasticFileSystemTagProperty', 'LifecyclePolicyProperty', 'ReplicationConfigurationProperty', 'ReplicationDestinationProperty', 'add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnFileSystemDefConfig(pydantic.BaseModel):
    ...
    ReplicationConfigurationProperty: typing.Optional[list[CfnFileSystemDefReplicationconfigurationpropertyParams]] = pydantic.Field(None, description='')
    ReplicationDestinationProperty: typing.Optional[list[CfnFileSystemDefReplicationdestinationpropertyParams]] = pydantic.Field(None, description='')
...
class CfnMountTargetDef(BaseCfnResource):
    ...
    subnet_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description="The ID of the subnet to add the mount target in. For file systems that use One Zone storage classes, use the subnet that is associated with the file system's Availability Zone.\n")
...
class ModuleModel(pydantic.BaseModel):
    ...
    CfnFileSystem_ReplicationConfigurationProperty: typing.Optional[dict[str, CfnFileSystem_ReplicationConfigurationPropertyDef]] = pydantic.Field(None)
    CfnFileSystem_ReplicationDestinationProperty: typing.Optional[dict[str, CfnFileSystem_ReplicationDestinationPropertyDef]] = pydantic.Field(None)
