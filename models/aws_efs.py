...
class AccessPointDef(BaseConstruct):
    file_system: typing.Union[models.aws_efs.FileSystemDef] = pydantic.Field(..., description='The efs filesystem.\n')
    ...
    from_access_point_attributes: typing.Optional[AccessPointDefFromAccessPointAttributesParams] = pydantic.Field(None, description='Import an existing Access Point by attributes.')
    from_access_point_id: typing.Optional[AccessPointDefFromAccessPointIdParams] = pydantic.Field(None, description='Import an existing Access Point by id.')
    resource_config: typing.Optional[AccessPointDefConfig] = pydantic.Field(None)
...
class FileSystemDef(BaseConstruct):
    vpc: typing.Union[models.aws_ec2.VpcDef] = pydantic.Field(..., description='VPC to launch the file system in.\n')
    ...
    kms_key: typing.Optional[typing.Union[models.aws_kms.KeyDef]] = pydantic.Field(None, description="The KMS key used for encryption. This is required to encrypt the data at rest if @encrypted is set to true. Default: - if 'encrypted' is true, the default key for EFS (/aws/elasticfilesystem) is used\n")
    ...
    _init_params: typing.ClassVar[list[str]] = ['vpc', 'enable_automatic_backups', 'encrypted', 'file_system_name', 'file_system_policy', 'kms_key', 'lifecycle_policy', 'out_of_infrequent_access_policy', 'performance_mode', 'provisioned_throughput_per_second', 'removal_policy', 'security_group', 'throughput_mode', 'vpc_subnets']
    _method_names: typing.ClassVar[list[str]] = ['add_access_point', 'add_to_resource_policy', 'apply_removal_policy', 'grant']
    ...
    from_file_system_attributes: typing.Optional[FileSystemDefFromFileSystemAttributesParams] = pydantic.Field(None, description='Import an existing File System from the given properties.')
    resource_config: typing.Optional[FileSystemDefConfig] = pydantic.Field(None)


class FileSystemDefConfig(pydantic.BaseModel):
    add_access_point: typing.Optional[list[FileSystemDefAddAccessPointParams]] = pydantic.Field(None, description='create access point from this filesystem.')
    add_to_resource_policy: typing.Optional[list[FileSystemDefAddToResourcePolicyParams]] = pydantic.Field(None, description='Adds a statement to the resource policy associated with this file system.\nA resource policy will be automatically created upon the first call to ``addToResourcePolicy``.\n\nNote that this does not work with imported file systems.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    grant: typing.Optional[list[FileSystemDefGrantParams]] = pydantic.Field(None, description='Grant the actions defined in actions to the given grantee on this File System resource.')
...
class AclDef(BaseStruct):
    owner_gid: str = pydantic.Field(..., description='Specifies the POSIX group ID to apply to the RootDirectory. Accepts values from 0 to 2^32 (4294967295).\n')
    owner_uid: str = pydantic.Field(..., description='Specifies the POSIX user ID to apply to the RootDirectory. Accepts values from 0 to 2^32 (4294967295).\n')
    permissions: str = pydantic.Field(..., description='Specifies the POSIX permissions to apply to the RootDirectory, in the format of an octal number representing the file\'s mode bits.\n\n:exampleMetadata: infused\n\nExample::\n\n    import aws_cdk.aws_ec2 as ec2\n    import aws_cdk.aws_efs as efs\n\n\n    # create a new VPC\n    vpc = ec2.Vpc(self, "VPC")\n\n    # create a new Amazon EFS filesystem\n    file_system = efs.FileSystem(self, "Efs", vpc=vpc)\n\n    # create a new access point from the filesystem\n    access_point = file_system.add_access_point("AccessPoint",\n        # set /export/lambda as the root of the access point\n        path="/export/lambda",\n        # as /export/lambda does not exist in a new efs filesystem, the efs will create the directory with the following createAcl\n        create_acl=efs.Acl(\n            owner_uid="1001",\n            owner_gid="1001",\n            permissions="750"\n        ),\n        # enforce the POSIX identity so lambda function will access with this identity\n        posix_user=efs.PosixUser(\n            uid="1001",\n            gid="1001"\n        )\n    )\n\n    fn = lambda_.Function(self, "MyLambda",\n        # mount the access point to /mnt/msg in the lambda runtime environment\n        filesystem=lambda_.FileSystem.from_efs_access_point(access_point, "/mnt/msg"),\n        runtime=lambda_.Runtime.NODEJS_18_X,\n        handler="index.handler",\n        code=lambda_.Code.from_asset(path.join(__dirname, "lambda-handler")),\n        vpc=vpc\n    )\n')
...
class CfnAccessPoint_PosixUserPropertyDef(BaseStruct):
    gid: str = pydantic.Field(..., description='The POSIX group ID used for all file system operations using this access point.\n')
    uid: str = pydantic.Field(..., description='The POSIX user ID used for all file system operations using this access point.\n')
...
class CfnFileSystem_BackupPolicyPropertyDef(BaseStruct):
    status: str = pydantic.Field(..., description='Set the backup policy status for the file system. - *``ENABLED``* - Turns automatic backups on for the file system. - *``DISABLED``* - Turns automatic backups off for the file system.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-efs-filesystem-backuppolicy.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_efs as efs\n\n    backup_policy_property = efs.CfnFileSystem.BackupPolicyProperty(\n        status="status"\n    )\n')
...
class CfnFileSystem_LifecyclePolicyPropertyDef(BaseStruct):
    transition_to_ia: typing.Optional[str] = pydantic.Field(None, description="Describes the period of time that a file is not accessed, after which it transitions to IA storage. Metadata operations such as listing the contents of a directory don't count as file access events.\n")
    transition_to_primary_storage_class: typing.Optional[str] = pydantic.Field(None, description='Describes when to transition a file from IA storage to primary storage. Metadata operations such as listing the contents of a directory don\'t count as file access events.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-efs-filesystem-lifecyclepolicy.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_efs as efs\n\n    lifecycle_policy_property = efs.CfnFileSystem.LifecyclePolicyProperty(\n        transition_to_ia="transitionToIa",\n        transition_to_primary_storage_class="transitionToPrimaryStorageClass"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['transition_to_ia', 'transition_to_primary_storage_class']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnAccessPointDef(BaseCfnResource):
    file_system_id: str = pydantic.Field(..., description='The ID of the EFS file system that the access point applies to. Accepts only the ID format for input when specifying a file system, for example ``fs-0123456789abcedf2`` .\n')
    ...
    posix_user: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_efs.CfnAccessPoint_PosixUserPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The full POSIX identity, including the user ID, group ID, and secondary group IDs on the access point that is used for all file operations by NFS clients using the access point.\n')
    root_directory: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_efs.CfnAccessPoint_RootDirectoryPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The directory on the Amazon EFS file system that the access point exposes as the root directory to NFS clients using the access point.')
...
class CfnAccessPointDefConfig(pydantic.BaseModel):
    AccessPointTagProperty: typing.Optional[list[CfnAccessPointDefAccesspointtagpropertyParams]] = pydantic.Field(None, description='')
    CreationInfoProperty: typing.Optional[list[CfnAccessPointDefCreationinfopropertyParams]] = pydantic.Field(None, description='')
    PosixUserProperty: typing.Optional[list[CfnAccessPointDefPosixuserpropertyParams]] = pydantic.Field(None, description='')
    RootDirectoryProperty: typing.Optional[list[CfnAccessPointDefRootdirectorypropertyParams]] = pydantic.Field(None, description='')
...
class CfnAccessPointDefRootdirectorypropertyParams(pydantic.BaseModel):
    creation_info: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_efs.CfnAccessPoint_CreationInfoPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
...
class CfnFileSystemDef(BaseCfnResource):
    availability_zone_name: typing.Optional[str] = pydantic.Field(None, description='Used to create a file system that uses One Zone storage classes. It specifies the AWS Availability Zone in which to create the file system. Use the format ``us-east-1a`` to specify the Availability Zone. For more information about One Zone storage classes, see `Using EFS storage classes <https://docs.aws.amazon.com/efs/latest/ug/storage-classes.html>`_ in the *Amazon EFS User Guide* . .. epigraph:: One Zone storage classes are not available in all Availability Zones in AWS Regions where Amazon EFS is available.\n')
    backup_policy: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_efs.CfnFileSystem_BackupPolicyPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Use the ``BackupPolicy`` to turn automatic backups on or off for the file system.\n')
    ...
    encrypted: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description="A Boolean value that, if true, creates an encrypted file system. When creating an encrypted file system, you have the option of specifying a KmsKeyId for an existing AWS KMS key . If you don't specify a KMS key , then the default KMS key for Amazon EFS , ``/aws/elasticfilesystem`` , is used to protect the encrypted file system.\n")
    ...
    _init_params: typing.ClassVar[list[str]] = ['availability_zone_name', 'backup_policy', 'bypass_policy_lockout_safety_check', 'encrypted', 'file_system_policy', 'file_system_tags', 'kms_key_id', 'lifecycle_policies', 'performance_mode', 'provisioned_throughput_in_mibps', 'throughput_mode']
...
class CfnFileSystemDefConfig(pydantic.BaseModel):
    BackupPolicyProperty: typing.Optional[list[CfnFileSystemDefBackuppolicypropertyParams]] = pydantic.Field(None, description='')
    ElasticFileSystemTagProperty: typing.Optional[list[CfnFileSystemDefElasticfilesystemtagpropertyParams]] = pydantic.Field(None, description='')
    LifecyclePolicyProperty: typing.Optional[list[CfnFileSystemDefLifecyclepolicypropertyParams]] = pydantic.Field(None, description='')
...
class CfnMountTargetDef(BaseCfnResource):
    file_system_id: str = pydantic.Field(..., description='The ID of the file system for which to create the mount target.\n')
    security_groups: typing.Sequence[str] = pydantic.Field(..., description='Up to five VPC security group IDs, of the form ``sg-xxxxxxxx`` . These must be for the same VPC as subnet specified.\n')
    subnet_id: str = pydantic.Field(..., description="The ID of the subnet to add the mount target in. For file systems that use One Zone storage classes, use the subnet that is associated with the file system's Availability Zone.\n")
    ...
    resource_config: typing.Optional[CfnMountTargetDefConfig] = pydantic.Field(None)


class CfnMountTargetDefConfig(pydantic.BaseModel):
    add_deletion_override: typing.Optional[list[CfnMountTargetDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[CfnMountTargetDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[CfnMountTargetDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[CfnMountTargetDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[CfnMountTargetDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[CfnMountTargetDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[CfnMountTargetDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[CfnMountTargetDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[CfnMountTargetDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[CfnMountTargetDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[CfnMountTargetDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[CfnMountTargetDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[CfnMountTargetDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
class ModuleModel(pydantic.BaseModel):
    AccessPoint: typing.Optional[dict[str, AccessPointDef]] = pydantic.Field(None)
    FileSystem: typing.Optional[dict[str, FileSystemDef]] = pydantic.Field(None)
    AccessPointAttributes: typing.Optional[dict[str, AccessPointAttributesDef]] = pydantic.Field(None)
    AccessPointOptions: typing.Optional[dict[str, AccessPointOptionsDef]] = pydantic.Field(None)
    AccessPointProps: typing.Optional[dict[str, AccessPointPropsDef]] = pydantic.Field(None)
    Acl: typing.Optional[dict[str, AclDef]] = pydantic.Field(None)
    CfnAccessPoint_AccessPointTagProperty: typing.Optional[dict[str, CfnAccessPoint_AccessPointTagPropertyDef]] = pydantic.Field(None)
    CfnAccessPoint_CreationInfoProperty: typing.Optional[dict[str, CfnAccessPoint_CreationInfoPropertyDef]] = pydantic.Field(None)
    CfnAccessPoint_PosixUserProperty: typing.Optional[dict[str, CfnAccessPoint_PosixUserPropertyDef]] = pydantic.Field(None)
    CfnAccessPoint_RootDirectoryProperty: typing.Optional[dict[str, CfnAccessPoint_RootDirectoryPropertyDef]] = pydantic.Field(None)
    CfnFileSystem_BackupPolicyProperty: typing.Optional[dict[str, CfnFileSystem_BackupPolicyPropertyDef]] = pydantic.Field(None)
    CfnFileSystem_ElasticFileSystemTagProperty: typing.Optional[dict[str, CfnFileSystem_ElasticFileSystemTagPropertyDef]] = pydantic.Field(None)
    CfnFileSystem_LifecyclePolicyProperty: typing.Optional[dict[str, CfnFileSystem_LifecyclePolicyPropertyDef]] = pydantic.Field(None)
    ...
    PosixUser: typing.Optional[dict[str, PosixUserDef]] = pydantic.Field(None)
    ...
    CfnMountTarget: typing.Optional[dict[str, CfnMountTargetDef]] = pydantic.Field(None)
    ...
    CfnMountTargetProps: typing.Optional[dict[str, CfnMountTargetPropsDef]] = pydantic.Field(None)
    ...
