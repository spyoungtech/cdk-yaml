...
class CfnPipelineDef(BaseCfnResource):
    ...
    parameter_objects: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_datapipeline.CfnPipeline_ParameterObjectPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The parameter objects used with the pipeline.\n')
    ...
    pipeline_tags: typing.Optional[typing.Sequence[typing.Union[models.aws_datapipeline.CfnPipeline_PipelineTagPropertyDef, dict[str, typing.Any]]]] = pydantic.Field(None, description='A list of arbitrary tags (key-value pairs) to associate with the pipeline, which you can use to control permissions. For more information, see `Controlling Access to Pipelines and Resources <https://docs.aws.amazon.com/datapipeline/latest/DeveloperGuide/dp-control-access.html>`_ in the *AWS Data Pipeline Developer Guide* .')
