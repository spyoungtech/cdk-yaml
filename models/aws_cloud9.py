...
class CfnEnvironmentEC2Def(BaseCfnResource):
    ...
    _init_params: typing.ClassVar[list[str]] = ['image_id', 'instance_type', 'automatic_stop_time_minutes', 'connection_type', 'description', 'name', 'owner_arn', 'repositories', 'subnet_id', 'tags']
