...
class AlarmBaseDefAddAlarmActionParams(pydantic.BaseModel):
    actions: list[typing.Union[models.aws_cloudwatch_actions.ApplicationScalingActionDef, models.aws_cloudwatch_actions.AutoScalingActionDef, models.aws_cloudwatch_actions.Ec2ActionDef, models.aws_cloudwatch_actions.LambdaActionDef, models.aws_cloudwatch_actions.SnsActionDef, models.aws_cloudwatch_actions.SsmActionDef, models.aws_cloudwatch_actions.SsmIncidentActionDef]] = pydantic.Field(...)
    ...
...
class ColumnDefAddWidgetParams(pydantic.BaseModel):
    w: typing.Union[models.aws_cloudwatch.AlarmStatusWidgetDef, models.aws_cloudwatch.AlarmWidgetDef, models.aws_cloudwatch.ColumnDef, models.aws_cloudwatch.ConcreteWidgetDef, models.aws_cloudwatch.CustomWidgetDef, models.aws_cloudwatch.GaugeWidgetDef, models.aws_cloudwatch.GraphWidgetDef, models.aws_cloudwatch.LogQueryWidgetDef, models.aws_cloudwatch.RowDef, models.aws_cloudwatch.SingleValueWidgetDef, models.aws_cloudwatch.SpacerDef, models.aws_cloudwatch.TableWidgetDef, models.aws_cloudwatch.TextWidgetDef] = pydantic.Field(..., description='-')
    ...
...
#  autogenerated from aws_cdk.aws_cloudwatch.TableThreshold
class TableThresholdDef(BaseClass):
    _init_params: typing.ClassVar[list[str]] = []
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = ['above', 'below', 'between']
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_cloudwatch.TableThreshold'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...


    resource_config: typing.Optional[models.aws_cloudwatch.TableThresholdDefConfig] = pydantic.Field(None)


class TableThresholdDefConfig(pydantic.BaseModel):
    above: typing.Optional[list[models.aws_cloudwatch.TableThresholdDefAboveParams]] = pydantic.Field(None, description='A threshold for highlighting and coloring cells above the specified value.')
    below: typing.Optional[list[models.aws_cloudwatch.TableThresholdDefBelowParams]] = pydantic.Field(None, description='A threshold for highlighting and coloring cells below the specified value.')
    between: typing.Optional[list[models.aws_cloudwatch.TableThresholdDefBetweenParams]] = pydantic.Field(None, description='A threshold for highlighting and coloring cells within the specified values.')

class TableThresholdDefAboveParams(pydantic.BaseModel):
    value: typing.Union[int, float] = pydantic.Field(..., description='lower bound of threshold range.\n')
    color: typing.Optional[str] = pydantic.Field(None, description='cell color for values within threshold range.')
    return_config: typing.Optional[list[models.aws_cloudwatch.TableThresholdDefConfig]] = pydantic.Field(None)
    ...

class TableThresholdDefBelowParams(pydantic.BaseModel):
    value: typing.Union[int, float] = pydantic.Field(..., description='upper bound of threshold range.\n')
    color: typing.Optional[str] = pydantic.Field(None, description='cell color for values within threshold range.')
    return_config: typing.Optional[list[models.aws_cloudwatch.TableThresholdDefConfig]] = pydantic.Field(None)
    ...

class TableThresholdDefBetweenParams(pydantic.BaseModel):
    lower_bound: typing.Union[int, float] = pydantic.Field(..., description='lower bound of threshold range.\n')
    upper_bound: typing.Union[int, float] = pydantic.Field(..., description='upper bound of threshold range.\n')
    color: typing.Optional[str] = pydantic.Field(None, description='cell color for values within threshold range.')
    return_config: typing.Optional[list[models.aws_cloudwatch.TableThresholdDefConfig]] = pydantic.Field(None)
    ...


#  autogenerated from aws_cdk.aws_cloudwatch.TableWidget
class TableWidgetDef(BaseClass):
    end: typing.Optional[str] = pydantic.Field(None, description='The end of the time range to use for each widget independently from those of the dashboard. If you specify a value for end, you must also specify a value for start. Specify an absolute time in the ISO 8601 format. For example, 2018-12-17T06:00:00.000Z. Default: When the dashboard loads, the end date will be the current time.')
    full_precision: typing.Optional[bool] = pydantic.Field(None, description='Whether to show as many digits as can fit, before rounding. Default: false\n')
    layout: typing.Optional[aws_cdk.aws_cloudwatch.TableLayout] = pydantic.Field(None, description='Table layout. Default: - TableLayout.HORIZONTAL\n')
    live_data: typing.Optional[bool] = pydantic.Field(None, description='Whether the graph should show live data. Default: false\n')
    metrics: typing.Optional[typing.Sequence[typing.Union[models.aws_cloudwatch.MathExpressionDef, models.aws_cloudwatch.MetricDef]]] = pydantic.Field(None, description='Metrics to display in the table. Default: - No metrics\n')
    period: typing.Optional[models.DurationDef] = pydantic.Field(None, description='The default period for all metrics in this widget. The period is the length of time represented by one data point on the graph. This default can be overridden within each metric definition. Default: cdk.Duration.seconds(300)\n')
    set_period_to_time_range: typing.Optional[bool] = pydantic.Field(None, description='Whether to show the value from the entire time range. Only applicable for Bar and Pie charts. If false, values will be from the most recent period of your chosen time range; if true, shows the value from the entire time range. Default: false\n')
    show_units_in_label: typing.Optional[bool] = pydantic.Field(None, description='Show the metrics units in the label column. Default: - false\n')
    start: typing.Optional[str] = pydantic.Field(None, description='The start of the time range to use for each widget independently from those of the dashboard. You can specify start without specifying end to specify a relative time range that ends with the current time. In this case, the value of start must begin with -P, and you can use M, H, D, W and M as abbreviations for minutes, hours, days, weeks and months. For example, -PT8H shows the last 8 hours and -P3M shows the last three months. You can also use start along with an end field, to specify an absolute time range. When specifying an absolute time range, use the ISO 8601 format. For example, 2018-12-17T06:00:00.000Z. Default: When the dashboard loads, the start time will be the default time range.\n')
    statistic: typing.Optional[str] = pydantic.Field(None, description='The default statistic to be displayed for each metric. This default can be overridden within the definition of each individual metric Default: - The statistic for each metric is used\n')
    summary: typing.Union[models.aws_cloudwatch.TableSummaryPropsDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Properties for displaying summary columns. Default: - no summary columns are shown\n')
    thresholds: typing.Optional[typing.Sequence[models.aws_cloudwatch.TableThresholdDef]] = pydantic.Field(None, description='Thresholds for highlighting table cells. Default: - No thresholds\n')
    height: typing.Union[int, float, None] = pydantic.Field(None, description='Height of the widget. Default: - 6 for Alarm and Graph widgets. 3 for single value widgets where most recent value of a metric is displayed.\n')
    region: typing.Optional[str] = pydantic.Field(None, description='The region the metrics of this graph should be taken from. Default: - Current region\n')
    title: typing.Optional[str] = pydantic.Field(None, description='Title for the graph. Default: - None\n')
    width: typing.Union[int, float, None] = pydantic.Field(None, description='Width of the widget, in a grid of 24 units wide. Default: 6')
    _init_params: typing.ClassVar[list[str]] = ['end', 'full_precision', 'layout', 'live_data', 'metrics', 'period', 'set_period_to_time_range', 'show_units_in_label', 'start', 'statistic', 'summary', 'thresholds', 'height', 'region', 'title', 'width']
    _method_names: typing.ClassVar[list[str]] = ['add_metric', 'position']
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_cloudwatch.TableWidget'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...


    resource_config: typing.Optional[models.aws_cloudwatch.TableWidgetDefConfig] = pydantic.Field(None)


class TableWidgetDefConfig(pydantic.BaseModel):
    add_metric: typing.Optional[list[models.aws_cloudwatch.TableWidgetDefAddMetricParams]] = pydantic.Field(None, description='Add another metric.')
    position: typing.Optional[list[models.aws_cloudwatch.TableWidgetDefPositionParams]] = pydantic.Field(None, description='Place the widget at a given position.')

class TableWidgetDefAddMetricParams(pydantic.BaseModel):
    metric: typing.Union[models.aws_cloudwatch.MathExpressionDef, models.aws_cloudwatch.MetricDef] = pydantic.Field(..., description='the metric to add.')
    ...

class TableWidgetDefPositionParams(pydantic.BaseModel):
    x: typing.Union[int, float] = pydantic.Field(..., description='-\n')
    y: typing.Union[int, float] = pydantic.Field(..., description='-')
    ...
...
class DashboardDef(BaseConstruct):
    ...
    widgets: typing.Optional[typing.Sequence[typing.Sequence[typing.Union[models.aws_cloudwatch.AlarmStatusWidgetDef, models.aws_cloudwatch.AlarmWidgetDef, models.aws_cloudwatch.ColumnDef, models.aws_cloudwatch.ConcreteWidgetDef, models.aws_cloudwatch.CustomWidgetDef, models.aws_cloudwatch.GaugeWidgetDef, models.aws_cloudwatch.GraphWidgetDef, models.aws_cloudwatch.LogQueryWidgetDef, models.aws_cloudwatch.RowDef, models.aws_cloudwatch.SingleValueWidgetDef, models.aws_cloudwatch.SpacerDef, models.aws_cloudwatch.TableWidgetDef, models.aws_cloudwatch.TextWidgetDef]]]] = pydantic.Field(None, description='Initial set of widgets on the dashboard. One array represents a row of widgets. Default: - No widgets')
...
class DashboardDefAddWidgetsParams(pydantic.BaseModel):
    widgets: list[typing.Union[models.aws_cloudwatch.AlarmStatusWidgetDef, models.aws_cloudwatch.AlarmWidgetDef, models.aws_cloudwatch.ColumnDef, models.aws_cloudwatch.ConcreteWidgetDef, models.aws_cloudwatch.CustomWidgetDef, models.aws_cloudwatch.GaugeWidgetDef, models.aws_cloudwatch.GraphWidgetDef, models.aws_cloudwatch.LogQueryWidgetDef, models.aws_cloudwatch.RowDef, models.aws_cloudwatch.SingleValueWidgetDef, models.aws_cloudwatch.SpacerDef, models.aws_cloudwatch.TableWidgetDef, models.aws_cloudwatch.TextWidgetDef]] = pydantic.Field(...)
    ...
...
#  autogenerated from aws_cdk.aws_cloudwatch.CfnAnomalyDetector.MetricCharacteristicsProperty
class CfnAnomalyDetector_MetricCharacteristicsPropertyDef(BaseStruct):
    periodic_spikes: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description="Set this parameter to true if values for this metric consistently include spikes that should not be considered to be anomalies. With this set to true, CloudWatch will expect to see spikes that occurred consistently during the model training period, and won't flag future similar spikes as anomalies.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudwatch-anomalydetector-metriccharacteristics.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_cloudwatch as cloudwatch\n\n    metric_characteristics_property = cloudwatch.CfnAnomalyDetector.MetricCharacteristicsProperty(\n        periodic_spikes=False\n    )\n")
    _init_params: typing.ClassVar[list[str]] = ['periodic_spikes']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_cloudwatch.CfnAnomalyDetector.MetricCharacteristicsProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class CfnAnomalyDetector_SingleMetricAnomalyDetectorPropertyDef(BaseStruct):
    account_id: typing.Optional[str] = pydantic.Field(None, description='If the CloudWatch metric that provides the time series that the anomaly detector uses as input is in another account, specify that account ID here. If you omit this parameter, the current account is used.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['account_id', 'dimensions', 'metric_name', 'namespace', 'stat']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
#  autogenerated from aws_cdk.aws_cloudwatch.TableSummaryProps
class TableSummaryPropsDef(BaseStruct):
    columns: typing.Optional[typing.Sequence[aws_cdk.aws_cloudwatch.TableSummaryColumn]] = pydantic.Field(None, description='Summary columns. Default: - No summary columns will be shown\n')
    hide_non_summary_columns: typing.Optional[bool] = pydantic.Field(None, description='Prevent the columns of datapoints from being displayed, so that only the label and summary columns are displayed. Default: - false\n')
    sticky: typing.Optional[bool] = pydantic.Field(None, description='Make the summary columns sticky, so that they remain in view while scrolling. Default: - false\n\n:exampleMetadata: infused\n\nExample::\n\n    # dashboard: cloudwatch.Dashboard\n\n\n    dashboard.add_widgets(cloudwatch.TableWidget(\n        # ...\n\n        summary=cloudwatch.TableSummaryProps(\n            columns=[cloudwatch.TableSummaryColumn.AVERAGE],\n            hide_non_summary_columns=True,\n            sticky=True\n        )\n    ))\n')
    _init_params: typing.ClassVar[list[str]] = ['columns', 'hide_non_summary_columns', 'sticky']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_cloudwatch.TableSummaryProps'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
#  autogenerated from aws_cdk.aws_cloudwatch.TableWidgetProps
class TableWidgetPropsDef(BaseStruct):
    height: typing.Union[int, float, None] = pydantic.Field(None, description='Height of the widget. Default: - 6 for Alarm and Graph widgets. 3 for single value widgets where most recent value of a metric is displayed.\n')
    region: typing.Optional[str] = pydantic.Field(None, description='The region the metrics of this graph should be taken from. Default: - Current region\n')
    title: typing.Optional[str] = pydantic.Field(None, description='Title for the graph. Default: - None\n')
    width: typing.Union[int, float, None] = pydantic.Field(None, description='Width of the widget, in a grid of 24 units wide. Default: 6\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['height', 'region', 'title', 'width', 'end', 'full_precision', 'layout', 'live_data', 'metrics', 'period', 'set_period_to_time_range', 'show_units_in_label', 'start', 'statistic', 'summary', 'thresholds']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_cloudwatch.TableWidgetProps'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
#  autogenerated from aws_cdk.aws_cloudwatch.TableLayout
# skipping emum

#  autogenerated from aws_cdk.aws_cloudwatch.TableSummaryColumn
# skipping emum
...
class CfnAlarmDef(BaseCfnResource):
    comparison_operator: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The arithmetic operation to use when comparing the specified statistic and threshold. The specified statistic value is used as the first operand.\n')
    ...
    tags: typing.Optional[typing.Sequence[typing.Union[models.CfnTagDef, dict[str, typing.Any]]]] = pydantic.Field(None, description='A list of key-value pairs to associate with the alarm. You can associate as many as 50 tags with an alarm. To be able to associate tags with the alarm when you create the alarm, you must have the ``cloudwatch:TagResource`` permission. Tags can help you organize and categorize your resources. You can also use them to scope user permissions by granting a user permission to access or change only resources with certain tag values.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['comparison_operator', 'evaluation_periods', 'actions_enabled', 'alarm_actions', 'alarm_description', 'alarm_name', 'datapoints_to_alarm', 'dimensions', 'evaluate_low_sample_count_percentile', 'extended_statistic', 'insufficient_data_actions', 'metric_name', 'metrics', 'namespace', 'ok_actions', 'period', 'statistic', 'tags', 'threshold', 'threshold_metric_id', 'treat_missing_data', 'unit']
...
class CfnAnomalyDetectorDef(BaseCfnResource):
    ...
    metric_characteristics: typing.Union[models.UnsupportedResource, models.aws_cloudwatch.CfnAnomalyDetector_MetricCharacteristicsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Use this object to include parameters to provide information about your metric to CloudWatch to help it build more accurate anomaly detection models. Currently, it includes the ``PeriodicSpikes`` parameter.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['configuration', 'dimensions', 'metric_characteristics', 'metric_math_anomaly_detector', 'metric_name', 'namespace', 'single_metric_anomaly_detector', 'stat']
    _method_names: typing.ClassVar[list[str]] = ['ConfigurationProperty', 'DimensionProperty', 'MetricCharacteristicsProperty', 'MetricDataQueryProperty', 'MetricMathAnomalyDetectorProperty', 'MetricProperty', 'MetricStatProperty', 'RangeProperty', 'SingleMetricAnomalyDetectorProperty', 'add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnAnomalyDetectorDefConfig(pydantic.BaseModel):
    ...
    MetricCharacteristicsProperty: typing.Optional[list[models.aws_cloudwatch.CfnAnomalyDetectorDefMetriccharacteristicspropertyParams]] = pydantic.Field(None, description='')
...
class CfnAnomalyDetectorDefMetriccharacteristicspropertyParams(pydantic.BaseModel):
    periodic_spikes: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
    ...
...
class CfnCompositeAlarmDef(BaseCfnResource):
    ...
    tags: typing.Optional[typing.Sequence[typing.Union[models.CfnTagDef, dict[str, typing.Any]]]] = pydantic.Field(None, description='A list of key-value pairs to associate with the alarm. You can associate as many as 50 tags with an alarm. To be able to associate tags with the alarm when you create the alarm, you must have the ``cloudwatch:TagResource`` permission. Tags can help you organize and categorize your resources. You can also use them to scope user permissions by granting a user permission to access or change only resources with certain tag values.')
    _init_params: typing.ClassVar[list[str]] = ['alarm_rule', 'actions_enabled', 'actions_suppressor', 'actions_suppressor_extension_period', 'actions_suppressor_wait_period', 'alarm_actions', 'alarm_description', 'alarm_name', 'insufficient_data_actions', 'ok_actions', 'tags']
...
class ModuleModel(pydantic.BaseModel):
    ...
    TableThreshold: typing.Optional[dict[str, models.aws_cloudwatch.TableThresholdDef]] = pydantic.Field(None)
    TableWidget: typing.Optional[dict[str, models.aws_cloudwatch.TableWidgetDef]] = pydantic.Field(None)
    ...
    CfnAnomalyDetector_MetricCharacteristicsProperty: typing.Optional[dict[str, models.aws_cloudwatch.CfnAnomalyDetector_MetricCharacteristicsPropertyDef]] = pydantic.Field(None)
    ...
    TableSummaryProps: typing.Optional[dict[str, models.aws_cloudwatch.TableSummaryPropsDef]] = pydantic.Field(None)
    TableWidgetProps: typing.Optional[dict[str, models.aws_cloudwatch.TableWidgetPropsDef]] = pydantic.Field(None)
