...
class CfnConnectionAlias_ConnectionAliasAssociationPropertyDef(BaseStruct):
    associated_account_id: typing.Optional[str] = pydantic.Field(None, description='``CfnConnectionAlias.ConnectionAliasAssociationProperty.AssociatedAccountId``.')
    association_status: typing.Optional[str] = pydantic.Field(None, description='``CfnConnectionAlias.ConnectionAliasAssociationProperty.AssociationStatus``.\n')
    connection_identifier: typing.Optional[str] = pydantic.Field(None, description='``CfnConnectionAlias.ConnectionAliasAssociationProperty.ConnectionIdentifier``.\n')
    resource_id: typing.Optional[str] = pydantic.Field(None, description='``CfnConnectionAlias.ConnectionAliasAssociationProperty.ResourceId``.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-workspaces-connectionalias-connectionaliasassociation.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_workspaces as workspaces\n\n    connection_alias_association_property = workspaces.CfnConnectionAlias.ConnectionAliasAssociationProperty(\n        associated_account_id="associatedAccountId",\n        association_status="associationStatus",\n        connection_identifier="connectionIdentifier",\n        resource_id="resourceId"\n    )\n')
...
class CfnConnectionAliasDef(BaseCfnResource):
    connection_string: str = pydantic.Field(..., description='The connection string specified for the connection alias. The connection string must be in the form of a fully qualified domain name (FQDN), such as ``www.example.com`` .\n')
...
class CfnWorkspaceDef(BaseCfnResource):
    bundle_id: str = pydantic.Field(..., description='The identifier of the bundle for the WorkSpace.\n')
    directory_id: str = pydantic.Field(..., description='The identifier of the AWS Directory Service directory for the WorkSpace.\n')
    user_name: str = pydantic.Field(..., description='The user name of the user for the WorkSpace. This user name must exist in the AWS Directory Service directory for the WorkSpace.\n')
    root_volume_encryption_enabled: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description='Indicates whether the data stored on the root volume is encrypted.\n')
    ...
    user_volume_encryption_enabled: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description='Indicates whether the data stored on the user volume is encrypted.\n')
    volume_encryption_key: typing.Optional[str] = pydantic.Field(None, description='The symmetric AWS KMS key used to encrypt data stored on your WorkSpace. Amazon WorkSpaces does not support asymmetric KMS keys.\n')
    workspace_properties: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_workspaces.CfnWorkspace_WorkspacePropertiesPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The WorkSpace properties.')
