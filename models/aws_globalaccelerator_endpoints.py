...
class ApplicationLoadBalancerEndpointDef(BaseClass):
    load_balancer: typing.Union[_REQUIRED_INIT_PARAM, models.aws_elasticloadbalancingv2.ApplicationLoadBalancerDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='-')
...
class CfnEipEndpointDef(BaseClass):
    eip: typing.Union[models.aws_ec2.CfnEIPDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='-')
    weight: typing.Union[int, float, None] = pydantic.Field(None, description='Endpoint weight across all endpoints in the group. Must be a value between 0 and 255. Default: 128')
...
class InstanceEndpointDef(BaseClass):
    instance: typing.Union[_REQUIRED_INIT_PARAM, models.aws_ec2.BastionHostLinuxDef, models.aws_ec2.InstanceDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='-')
...
class NetworkLoadBalancerEndpointDef(BaseClass):
    load_balancer: typing.Union[_REQUIRED_INIT_PARAM, models.aws_elasticloadbalancingv2.NetworkLoadBalancerDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='-')
