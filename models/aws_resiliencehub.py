...
class CfnApp_PhysicalResourceIdPropertyDef(BaseStruct):
    ...
    aws_account_id: typing.Optional[str] = pydantic.Field(None, description='The account that owns the physical resource.\n')
    aws_region: typing.Optional[str] = pydantic.Field(None, description='The that the physical resource is located in.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-resiliencehub-app-physicalresourceid.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_resiliencehub as resiliencehub\n\n    physical_resource_id_property = resiliencehub.CfnApp.PhysicalResourceIdProperty(\n        identifier="identifier",\n        type="type",\n\n        # the properties below are optional\n        aws_account_id="awsAccountId",\n        aws_region="awsRegion"\n    )\n')
...
class CfnApp_ResourceMappingPropertyDef(BaseStruct):
    ...
    logical_stack_name: typing.Optional[str] = pydantic.Field(None, description='The name of the AWS CloudFormation stack this resource is mapped to.\n')
    resource_name: typing.Optional[str] = pydantic.Field(None, description='Name of the resource that the resource is mapped to.\n')
...
class CfnAppDefConfig(pydantic.BaseModel):
    EventSubscriptionProperty: typing.Optional[list[CfnAppDefEventsubscriptionpropertyParams]] = pydantic.Field(None, description='')
    PermissionModelProperty: typing.Optional[list[CfnAppDefPermissionmodelpropertyParams]] = pydantic.Field(None, description='')
...
class ModuleModel(pydantic.BaseModel):
    CfnApp_EventSubscriptionProperty: typing.Optional[dict[str, CfnApp_EventSubscriptionPropertyDef]] = pydantic.Field(None)
    CfnApp_PermissionModelProperty: typing.Optional[dict[str, CfnApp_PermissionModelPropertyDef]] = pydantic.Field(None)
