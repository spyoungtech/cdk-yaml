...
class CfnOriginEndpoint_HlsManifestConfigurationPropertyDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['manifest_name', 'child_manifest_name', 'manifest_window_seconds', 'program_date_time_interval_seconds', 'scte_hls', 'url']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnChannelDef(BaseCfnResource):
    channel_group_name: typing.Optional[str] = pydantic.Field(None, description='The name of the channel group associated with the channel configuration.\n')
...
class CfnChannelGroupDef(BaseCfnResource):
    channel_group_name: typing.Optional[str] = pydantic.Field(None, description='The name of the channel group.\n')
...
class CfnChannelPolicyDef(BaseCfnResource):
    ...
    channel_group_name: typing.Optional[str] = pydantic.Field(None, description='The name of the channel group associated with the channel policy.\n')
    channel_name: typing.Optional[str] = pydantic.Field(None, description='The name of the channel associated with the channel policy.')
    _init_params: typing.ClassVar[list[str]] = ['policy', 'channel_group_name', 'channel_name']
    _method_names: typing.ClassVar[list[str]] = ['add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnOriginEndpointDef(BaseCfnResource):
    container_type: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The container type associated with the origin endpoint configuration.\n')
    channel_group_name: typing.Optional[str] = pydantic.Field(None, description='The name of the channel group associated with the origin endpoint configuration.\n')
    channel_name: typing.Optional[str] = pydantic.Field(None, description='The channel name associated with the origin endpoint.\n')
    ...
    origin_endpoint_name: typing.Optional[str] = pydantic.Field(None, description='The name of the origin endpoint associated with the origin endpoint configuration.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['container_type', 'channel_group_name', 'channel_name', 'description', 'hls_manifests', 'low_latency_hls_manifests', 'origin_endpoint_name', 'segment', 'startover_window_seconds', 'tags']
    _method_names: typing.ClassVar[list[str]] = ['EncryptionContractConfigurationProperty', 'EncryptionMethodProperty', 'EncryptionProperty', 'HlsManifestConfigurationProperty', 'LowLatencyHlsManifestConfigurationProperty', 'ScteHlsProperty', 'ScteProperty', 'SegmentProperty', 'SpekeKeyProviderProperty', 'add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnOriginEndpointPolicyDef(BaseCfnResource):
    ...
    channel_group_name: typing.Optional[str] = pydantic.Field(None, description='The name of the channel group associated with the origin endpoint policy.\n')
    channel_name: typing.Optional[str] = pydantic.Field(None, description='The channel name associated with the origin endpoint policy.\n')
    origin_endpoint_name: typing.Optional[str] = pydantic.Field(None, description='The name of the origin endpoint associated with the origin endpoint policy.')
    _init_params: typing.ClassVar[list[str]] = ['policy', 'channel_group_name', 'channel_name', 'origin_endpoint_name']
    _method_names: typing.ClassVar[list[str]] = ['add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
