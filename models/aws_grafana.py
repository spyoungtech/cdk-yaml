...
class CfnWorkspace_SamlConfigurationPropertyDef(BaseStruct):
    idp_metadata: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_grafana.CfnWorkspace_IdpMetadataPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='A structure containing the identity provider (IdP) metadata used to integrate the identity provider with this workspace.\n')
...
class CfnWorkspace_VpcConfigurationPropertyDef(BaseStruct):
    security_group_ids: typing.Union[typing.Sequence[str], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The list of Amazon EC2 security group IDs attached to the Amazon VPC for your Grafana workspace to connect. Duplicates not allowed. *Array Members* : Minimum number of 1 items. Maximum number of 5 items. *Length* : Minimum length of 0. Maximum length of 255.\n')
    subnet_ids: typing.Union[typing.Sequence[str], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The list of Amazon EC2 subnet IDs created in the Amazon VPC for your Grafana workspace to connect. Duplicates not allowed. *Array Members* : Minimum number of 2 items. Maximum number of 6 items. *Length* : Minimum length of 0. Maximum length of 255.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-grafana-workspace-vpcconfiguration.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_grafana as grafana\n\n    vpc_configuration_property = grafana.CfnWorkspace.VpcConfigurationProperty(\n        security_group_ids=["securityGroupIds"],\n        subnet_ids=["subnetIds"]\n    )\n')
...
class CfnWorkspaceDef(BaseCfnResource):
    ...
    grafana_version: typing.Optional[str] = pydantic.Field(None, description='Specifies the version of Grafana to support in the workspace. Defaults to the latest version on create (for example, 9.4), or the current version of the workspace on update. Can only be used to upgrade (for example, from 8.4 to 9.4), not downgrade (for example, from 9.4 to 8.4). To know what versions are available to upgrade to for a specific workspace, see the `ListVersions <https://docs.aws.amazon.com/grafana/latest/APIReference/API_ListVersions.html>`_ operation.\n')
    name: typing.Optional[str] = pydantic.Field(None, description='The name of the workspace.\n')
    network_access_control: typing.Union[models.UnsupportedResource, models.aws_grafana.CfnWorkspace_NetworkAccessControlPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The configuration settings for network access to your workspace.\n')
    notification_destinations: typing.Optional[typing.Sequence[str]] = pydantic.Field(None, description='The AWS notification channels that Amazon Managed Grafana can automatically create IAM roles and permissions for, to allow Amazon Managed Grafana to use these channels. *AllowedValues* : ``SNS``\n')
    ...
    plugin_admin_enabled: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='Whether plugin administration is enabled in the workspace. Setting to ``true`` allows workspace admins to install, uninstall, and update plugins from within the Grafana workspace. .. epigraph:: This option is only valid for workspaces that support Grafana version 9 or newer.\n')
...
class CfnWorkspaceDefSamlconfigurationpropertyParams(pydantic.BaseModel):
    idp_metadata: typing.Union[models.UnsupportedResource, models.aws_grafana.CfnWorkspace_IdpMetadataPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    allowed_organizations: typing.Optional[typing.Sequence[str]] = pydantic.Field(None, description='')
    assertion_attributes: typing.Union[models.UnsupportedResource, models.aws_grafana.CfnWorkspace_AssertionAttributesPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    login_validity_duration: typing.Union[int, float, None] = pydantic.Field(None, description='')
    role_values: typing.Union[models.UnsupportedResource, models.aws_grafana.CfnWorkspace_RoleValuesPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
