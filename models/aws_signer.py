...
class PlatformDef(BaseClass):
    ...
    resource_config: typing.Optional[models.aws_signer.PlatformDefConfig] = pydantic.Field(None)


class PlatformDefConfig(pydantic.BaseModel):
    of: typing.Optional[list[models.aws_signer.PlatformDefOfParams]] = pydantic.Field(None, description='Custom signing profile platform.')

class PlatformDefOfParams(pydantic.BaseModel):
    platform_id: str = pydantic.Field(..., description='- The id of signing platform.\n\n:see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-signer-signingprofile.html#cfn-signer-signingprofile-platformid\n')
    return_config: typing.Optional[list[models.aws_signer.PlatformDefConfig]] = pydantic.Field(None)
    ...
...
class SigningProfilePropsDef(BaseStruct):
    ...
    resource_config: typing.Optional[models.aws_signer.SigningProfilePropsDefConfig] = pydantic.Field(None)


class SigningProfilePropsDefConfig(pydantic.BaseModel):
    platform_config: typing.Optional[models.aws_signer.PlatformDefConfig] = pydantic.Field(None)
...
class CfnSigningProfileDef(BaseCfnResource):
    ...
    profile_name: typing.Optional[str] = pydantic.Field(None, description='The name of the signing profile.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['platform_id', 'profile_name', 'signature_validity_period', 'tags']
