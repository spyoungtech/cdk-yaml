...
class CfnContainer_MetricPolicyRulePropertyDef(BaseStruct):
    object_group: str = pydantic.Field(..., description='A path or file name that defines which objects to include in the group. Wildcards (*) are acceptable.\n')
    object_group_name: str = pydantic.Field(..., description='A name that allows you to refer to the object group.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-mediastore-container-metricpolicyrule.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_mediastore as mediastore\n\n    metric_policy_rule_property = mediastore.CfnContainer.MetricPolicyRuleProperty(\n        object_group="objectGroup",\n        object_group_name="objectGroupName"\n    )\n')
...
class CfnContainerDef(BaseCfnResource):
    container_name: str = pydantic.Field(..., description='The name for the container. The name must be from 1 to 255 characters. Container names must be unique to your AWS account within a specific region. As an example, you could create a container named ``movies`` in every region, as long as you don’t have an existing container with that name.\n')
    access_logging_enabled: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description='The state of access logging on the container. This value is ``false`` by default, indicating that AWS Elemental MediaStore does not send access logs to Amazon CloudWatch Logs. When you enable access logging on the container, MediaStore changes this value to ``true`` , indicating that the service delivers access logs for objects stored in that container to CloudWatch Logs.\n')
    cors_policy: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_mediastore.CfnContainer_CorsRulePropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description="Sets the cross-origin resource sharing (CORS) configuration on a container so that the container can service cross-origin requests. For example, you might want to enable a request whose origin is http://www.example.com to access your AWS Elemental MediaStore container at my.example.container.com by using the browser's XMLHttpRequest capability. To enable CORS on a container, you attach a CORS policy to the container. In the CORS policy, you configure rules that identify origins and the HTTP methods that can be executed on your container. The policy can contain up to 398,000 characters. You can add up to 100 rules to a CORS policy. If more than one rule applies, the service uses the first applicable rule listed. To learn more about CORS, see `Cross-Origin Resource Sharing (CORS) in AWS Elemental MediaStore <https://docs.aws.amazon.com/mediastore/latest/ug/cors-policy.html>`_ .\n")
    ...
    metric_policy: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_mediastore.CfnContainer_MetricPolicyPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='``AWS::MediaStore::Container.MetricPolicy``.\n')
    ...
    tags: typing.Optional[typing.Sequence[typing.Union[models.CfnTagDef, dict[str, typing.Any]]]] = pydantic.Field(None, description='``AWS::MediaStore::Container.Tags``.')
...
class CfnContainerDefConfig(pydantic.BaseModel):
    CorsRuleProperty: typing.Optional[list[CfnContainerDefCorsrulepropertyParams]] = pydantic.Field(None, description='')
    MetricPolicyProperty: typing.Optional[list[CfnContainerDefMetricpolicypropertyParams]] = pydantic.Field(None, description='')
    MetricPolicyRuleProperty: typing.Optional[list[CfnContainerDefMetricpolicyrulepropertyParams]] = pydantic.Field(None, description='')
...
class ModuleModel(pydantic.BaseModel):
    CfnContainer_CorsRuleProperty: typing.Optional[dict[str, CfnContainer_CorsRulePropertyDef]] = pydantic.Field(None)
    CfnContainer_MetricPolicyProperty: typing.Optional[dict[str, CfnContainer_MetricPolicyPropertyDef]] = pydantic.Field(None)
    CfnContainer_MetricPolicyRuleProperty: typing.Optional[dict[str, CfnContainer_MetricPolicyRulePropertyDef]] = pydantic.Field(None)
