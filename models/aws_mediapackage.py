...
class CfnAssetDef(BaseCfnResource):
    ...
    resource_config: typing.Optional[models.aws_mediapackage.CfnAssetDefConfig] = pydantic.Field(None)


class CfnAssetDefConfig(pydantic.BaseModel):
    EgressEndpointProperty: typing.Optional[list[models.aws_mediapackage.CfnAssetDefEgressendpointpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_mediapackage.CfnAssetDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_mediapackage.CfnAssetDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_mediapackage.CfnAssetDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_mediapackage.CfnAssetDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_mediapackage.CfnAssetDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_mediapackage.CfnAssetDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_mediapackage.CfnAssetDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_mediapackage.CfnAssetDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_mediapackage.CfnAssetDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_mediapackage.CfnAssetDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_mediapackage.CfnAssetDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_mediapackage.CfnAssetDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_mediapackage.CfnAssetDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
class CfnChannelDef(BaseCfnResource):
    ...
    resource_config: typing.Optional[models.aws_mediapackage.CfnChannelDefConfig] = pydantic.Field(None)


class CfnChannelDefConfig(pydantic.BaseModel):
    HlsIngestProperty: typing.Optional[list[models.aws_mediapackage.CfnChannelDefHlsingestpropertyParams]] = pydantic.Field(None, description='')
    IngestEndpointProperty: typing.Optional[list[models.aws_mediapackage.CfnChannelDefIngestendpointpropertyParams]] = pydantic.Field(None, description='')
    LogConfigurationProperty: typing.Optional[list[models.aws_mediapackage.CfnChannelDefLogconfigurationpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_mediapackage.CfnChannelDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_mediapackage.CfnChannelDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_mediapackage.CfnChannelDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_mediapackage.CfnChannelDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_mediapackage.CfnChannelDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_mediapackage.CfnChannelDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_mediapackage.CfnChannelDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_mediapackage.CfnChannelDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_mediapackage.CfnChannelDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_mediapackage.CfnChannelDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_mediapackage.CfnChannelDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_mediapackage.CfnChannelDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_mediapackage.CfnChannelDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
    tags_config: typing.Optional[models.core.TagManagerDefConfig] = pydantic.Field(None)
...
class CfnOriginEndpointDef(BaseCfnResource):
    ...
    resource_config: typing.Optional[models.aws_mediapackage.CfnOriginEndpointDefConfig] = pydantic.Field(None)


class CfnOriginEndpointDefConfig(pydantic.BaseModel):
    AuthorizationProperty: typing.Optional[list[models.aws_mediapackage.CfnOriginEndpointDefAuthorizationpropertyParams]] = pydantic.Field(None, description='')
    CmafEncryptionProperty: typing.Optional[list[models.aws_mediapackage.CfnOriginEndpointDefCmafencryptionpropertyParams]] = pydantic.Field(None, description='')
    CmafPackageProperty: typing.Optional[list[models.aws_mediapackage.CfnOriginEndpointDefCmafpackagepropertyParams]] = pydantic.Field(None, description='')
    DashEncryptionProperty: typing.Optional[list[models.aws_mediapackage.CfnOriginEndpointDefDashencryptionpropertyParams]] = pydantic.Field(None, description='')
    DashPackageProperty: typing.Optional[list[models.aws_mediapackage.CfnOriginEndpointDefDashpackagepropertyParams]] = pydantic.Field(None, description='')
    EncryptionContractConfigurationProperty: typing.Optional[list[models.aws_mediapackage.CfnOriginEndpointDefEncryptioncontractconfigurationpropertyParams]] = pydantic.Field(None, description='')
    HlsEncryptionProperty: typing.Optional[list[models.aws_mediapackage.CfnOriginEndpointDefHlsencryptionpropertyParams]] = pydantic.Field(None, description='')
    HlsManifestProperty: typing.Optional[list[models.aws_mediapackage.CfnOriginEndpointDefHlsmanifestpropertyParams]] = pydantic.Field(None, description='')
    HlsPackageProperty: typing.Optional[list[models.aws_mediapackage.CfnOriginEndpointDefHlspackagepropertyParams]] = pydantic.Field(None, description='')
    MssEncryptionProperty: typing.Optional[list[models.aws_mediapackage.CfnOriginEndpointDefMssencryptionpropertyParams]] = pydantic.Field(None, description='')
    MssPackageProperty: typing.Optional[list[models.aws_mediapackage.CfnOriginEndpointDefMsspackagepropertyParams]] = pydantic.Field(None, description='')
    SpekeKeyProviderProperty: typing.Optional[list[models.aws_mediapackage.CfnOriginEndpointDefSpekekeyproviderpropertyParams]] = pydantic.Field(None, description='')
    StreamSelectionProperty: typing.Optional[list[models.aws_mediapackage.CfnOriginEndpointDefStreamselectionpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_mediapackage.CfnOriginEndpointDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_mediapackage.CfnOriginEndpointDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_mediapackage.CfnOriginEndpointDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_mediapackage.CfnOriginEndpointDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_mediapackage.CfnOriginEndpointDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_mediapackage.CfnOriginEndpointDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_mediapackage.CfnOriginEndpointDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_mediapackage.CfnOriginEndpointDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_mediapackage.CfnOriginEndpointDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_mediapackage.CfnOriginEndpointDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_mediapackage.CfnOriginEndpointDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_mediapackage.CfnOriginEndpointDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_mediapackage.CfnOriginEndpointDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
    tags_config: typing.Optional[models.core.TagManagerDefConfig] = pydantic.Field(None)
...
class CfnPackagingConfigurationDef(BaseCfnResource):
    ...
    resource_config: typing.Optional[models.aws_mediapackage.CfnPackagingConfigurationDefConfig] = pydantic.Field(None)


class CfnPackagingConfigurationDefConfig(pydantic.BaseModel):
    CmafEncryptionProperty: typing.Optional[list[models.aws_mediapackage.CfnPackagingConfigurationDefCmafencryptionpropertyParams]] = pydantic.Field(None, description='')
    CmafPackageProperty: typing.Optional[list[models.aws_mediapackage.CfnPackagingConfigurationDefCmafpackagepropertyParams]] = pydantic.Field(None, description='')
    DashEncryptionProperty: typing.Optional[list[models.aws_mediapackage.CfnPackagingConfigurationDefDashencryptionpropertyParams]] = pydantic.Field(None, description='')
    DashManifestProperty: typing.Optional[list[models.aws_mediapackage.CfnPackagingConfigurationDefDashmanifestpropertyParams]] = pydantic.Field(None, description='')
    DashPackageProperty: typing.Optional[list[models.aws_mediapackage.CfnPackagingConfigurationDefDashpackagepropertyParams]] = pydantic.Field(None, description='')
    EncryptionContractConfigurationProperty: typing.Optional[list[models.aws_mediapackage.CfnPackagingConfigurationDefEncryptioncontractconfigurationpropertyParams]] = pydantic.Field(None, description='')
    HlsEncryptionProperty: typing.Optional[list[models.aws_mediapackage.CfnPackagingConfigurationDefHlsencryptionpropertyParams]] = pydantic.Field(None, description='')
    HlsManifestProperty: typing.Optional[list[models.aws_mediapackage.CfnPackagingConfigurationDefHlsmanifestpropertyParams]] = pydantic.Field(None, description='')
    HlsPackageProperty: typing.Optional[list[models.aws_mediapackage.CfnPackagingConfigurationDefHlspackagepropertyParams]] = pydantic.Field(None, description='')
    MssEncryptionProperty: typing.Optional[list[models.aws_mediapackage.CfnPackagingConfigurationDefMssencryptionpropertyParams]] = pydantic.Field(None, description='')
    MssManifestProperty: typing.Optional[list[models.aws_mediapackage.CfnPackagingConfigurationDefMssmanifestpropertyParams]] = pydantic.Field(None, description='')
    MssPackageProperty: typing.Optional[list[models.aws_mediapackage.CfnPackagingConfigurationDefMsspackagepropertyParams]] = pydantic.Field(None, description='')
    SpekeKeyProviderProperty: typing.Optional[list[models.aws_mediapackage.CfnPackagingConfigurationDefSpekekeyproviderpropertyParams]] = pydantic.Field(None, description='')
    StreamSelectionProperty: typing.Optional[list[models.aws_mediapackage.CfnPackagingConfigurationDefStreamselectionpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_mediapackage.CfnPackagingConfigurationDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_mediapackage.CfnPackagingConfigurationDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_mediapackage.CfnPackagingConfigurationDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_mediapackage.CfnPackagingConfigurationDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_mediapackage.CfnPackagingConfigurationDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_mediapackage.CfnPackagingConfigurationDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_mediapackage.CfnPackagingConfigurationDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_mediapackage.CfnPackagingConfigurationDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_mediapackage.CfnPackagingConfigurationDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_mediapackage.CfnPackagingConfigurationDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_mediapackage.CfnPackagingConfigurationDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_mediapackage.CfnPackagingConfigurationDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_mediapackage.CfnPackagingConfigurationDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
    tags_config: typing.Optional[models.core.TagManagerDefConfig] = pydantic.Field(None)
...
class CfnPackagingGroupDef(BaseCfnResource):
    ...
    resource_config: typing.Optional[models.aws_mediapackage.CfnPackagingGroupDefConfig] = pydantic.Field(None)


class CfnPackagingGroupDefConfig(pydantic.BaseModel):
    AuthorizationProperty: typing.Optional[list[models.aws_mediapackage.CfnPackagingGroupDefAuthorizationpropertyParams]] = pydantic.Field(None, description='')
    LogConfigurationProperty: typing.Optional[list[models.aws_mediapackage.CfnPackagingGroupDefLogconfigurationpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_mediapackage.CfnPackagingGroupDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_mediapackage.CfnPackagingGroupDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_mediapackage.CfnPackagingGroupDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_mediapackage.CfnPackagingGroupDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_mediapackage.CfnPackagingGroupDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_mediapackage.CfnPackagingGroupDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_mediapackage.CfnPackagingGroupDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_mediapackage.CfnPackagingGroupDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_mediapackage.CfnPackagingGroupDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_mediapackage.CfnPackagingGroupDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_mediapackage.CfnPackagingGroupDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_mediapackage.CfnPackagingGroupDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_mediapackage.CfnPackagingGroupDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
    tags_config: typing.Optional[models.core.TagManagerDefConfig] = pydantic.Field(None)
...
class ModuleModel(pydantic.BaseModel):
    CfnAsset_EgressEndpointProperty: typing.Optional[dict[str, models.aws_mediapackage.CfnAsset_EgressEndpointPropertyDef]] = pydantic.Field(None)
    CfnChannel_HlsIngestProperty: typing.Optional[dict[str, models.aws_mediapackage.CfnChannel_HlsIngestPropertyDef]] = pydantic.Field(None)
    CfnChannel_IngestEndpointProperty: typing.Optional[dict[str, models.aws_mediapackage.CfnChannel_IngestEndpointPropertyDef]] = pydantic.Field(None)
    CfnChannel_LogConfigurationProperty: typing.Optional[dict[str, models.aws_mediapackage.CfnChannel_LogConfigurationPropertyDef]] = pydantic.Field(None)
    CfnOriginEndpoint_AuthorizationProperty: typing.Optional[dict[str, models.aws_mediapackage.CfnOriginEndpoint_AuthorizationPropertyDef]] = pydantic.Field(None)
    CfnOriginEndpoint_CmafEncryptionProperty: typing.Optional[dict[str, models.aws_mediapackage.CfnOriginEndpoint_CmafEncryptionPropertyDef]] = pydantic.Field(None)
    CfnOriginEndpoint_CmafPackageProperty: typing.Optional[dict[str, models.aws_mediapackage.CfnOriginEndpoint_CmafPackagePropertyDef]] = pydantic.Field(None)
    CfnOriginEndpoint_DashEncryptionProperty: typing.Optional[dict[str, models.aws_mediapackage.CfnOriginEndpoint_DashEncryptionPropertyDef]] = pydantic.Field(None)
    CfnOriginEndpoint_DashPackageProperty: typing.Optional[dict[str, models.aws_mediapackage.CfnOriginEndpoint_DashPackagePropertyDef]] = pydantic.Field(None)
    CfnOriginEndpoint_EncryptionContractConfigurationProperty: typing.Optional[dict[str, models.aws_mediapackage.CfnOriginEndpoint_EncryptionContractConfigurationPropertyDef]] = pydantic.Field(None)
    CfnOriginEndpoint_HlsEncryptionProperty: typing.Optional[dict[str, models.aws_mediapackage.CfnOriginEndpoint_HlsEncryptionPropertyDef]] = pydantic.Field(None)
    CfnOriginEndpoint_HlsManifestProperty: typing.Optional[dict[str, models.aws_mediapackage.CfnOriginEndpoint_HlsManifestPropertyDef]] = pydantic.Field(None)
    CfnOriginEndpoint_HlsPackageProperty: typing.Optional[dict[str, models.aws_mediapackage.CfnOriginEndpoint_HlsPackagePropertyDef]] = pydantic.Field(None)
    CfnOriginEndpoint_MssEncryptionProperty: typing.Optional[dict[str, models.aws_mediapackage.CfnOriginEndpoint_MssEncryptionPropertyDef]] = pydantic.Field(None)
    CfnOriginEndpoint_MssPackageProperty: typing.Optional[dict[str, models.aws_mediapackage.CfnOriginEndpoint_MssPackagePropertyDef]] = pydantic.Field(None)
    CfnOriginEndpoint_SpekeKeyProviderProperty: typing.Optional[dict[str, models.aws_mediapackage.CfnOriginEndpoint_SpekeKeyProviderPropertyDef]] = pydantic.Field(None)
    CfnOriginEndpoint_StreamSelectionProperty: typing.Optional[dict[str, models.aws_mediapackage.CfnOriginEndpoint_StreamSelectionPropertyDef]] = pydantic.Field(None)
    CfnPackagingConfiguration_CmafEncryptionProperty: typing.Optional[dict[str, models.aws_mediapackage.CfnPackagingConfiguration_CmafEncryptionPropertyDef]] = pydantic.Field(None)
    CfnPackagingConfiguration_CmafPackageProperty: typing.Optional[dict[str, models.aws_mediapackage.CfnPackagingConfiguration_CmafPackagePropertyDef]] = pydantic.Field(None)
    CfnPackagingConfiguration_DashEncryptionProperty: typing.Optional[dict[str, models.aws_mediapackage.CfnPackagingConfiguration_DashEncryptionPropertyDef]] = pydantic.Field(None)
    CfnPackagingConfiguration_DashManifestProperty: typing.Optional[dict[str, models.aws_mediapackage.CfnPackagingConfiguration_DashManifestPropertyDef]] = pydantic.Field(None)
    CfnPackagingConfiguration_DashPackageProperty: typing.Optional[dict[str, models.aws_mediapackage.CfnPackagingConfiguration_DashPackagePropertyDef]] = pydantic.Field(None)
    CfnPackagingConfiguration_EncryptionContractConfigurationProperty: typing.Optional[dict[str, models.aws_mediapackage.CfnPackagingConfiguration_EncryptionContractConfigurationPropertyDef]] = pydantic.Field(None)
    CfnPackagingConfiguration_HlsEncryptionProperty: typing.Optional[dict[str, models.aws_mediapackage.CfnPackagingConfiguration_HlsEncryptionPropertyDef]] = pydantic.Field(None)
    CfnPackagingConfiguration_HlsManifestProperty: typing.Optional[dict[str, models.aws_mediapackage.CfnPackagingConfiguration_HlsManifestPropertyDef]] = pydantic.Field(None)
    CfnPackagingConfiguration_HlsPackageProperty: typing.Optional[dict[str, models.aws_mediapackage.CfnPackagingConfiguration_HlsPackagePropertyDef]] = pydantic.Field(None)
    CfnPackagingConfiguration_MssEncryptionProperty: typing.Optional[dict[str, models.aws_mediapackage.CfnPackagingConfiguration_MssEncryptionPropertyDef]] = pydantic.Field(None)
    CfnPackagingConfiguration_MssManifestProperty: typing.Optional[dict[str, models.aws_mediapackage.CfnPackagingConfiguration_MssManifestPropertyDef]] = pydantic.Field(None)
    CfnPackagingConfiguration_MssPackageProperty: typing.Optional[dict[str, models.aws_mediapackage.CfnPackagingConfiguration_MssPackagePropertyDef]] = pydantic.Field(None)
    CfnPackagingConfiguration_SpekeKeyProviderProperty: typing.Optional[dict[str, models.aws_mediapackage.CfnPackagingConfiguration_SpekeKeyProviderPropertyDef]] = pydantic.Field(None)
    CfnPackagingConfiguration_StreamSelectionProperty: typing.Optional[dict[str, models.aws_mediapackage.CfnPackagingConfiguration_StreamSelectionPropertyDef]] = pydantic.Field(None)
    CfnPackagingGroup_AuthorizationProperty: typing.Optional[dict[str, models.aws_mediapackage.CfnPackagingGroup_AuthorizationPropertyDef]] = pydantic.Field(None)
    CfnPackagingGroup_LogConfigurationProperty: typing.Optional[dict[str, models.aws_mediapackage.CfnPackagingGroup_LogConfigurationPropertyDef]] = pydantic.Field(None)
    CfnAsset: typing.Optional[dict[str, models.aws_mediapackage.CfnAssetDef]] = pydantic.Field(None)
    CfnChannel: typing.Optional[dict[str, models.aws_mediapackage.CfnChannelDef]] = pydantic.Field(None)
    CfnOriginEndpoint: typing.Optional[dict[str, models.aws_mediapackage.CfnOriginEndpointDef]] = pydantic.Field(None)
    CfnPackagingConfiguration: typing.Optional[dict[str, models.aws_mediapackage.CfnPackagingConfigurationDef]] = pydantic.Field(None)
    CfnPackagingGroup: typing.Optional[dict[str, models.aws_mediapackage.CfnPackagingGroupDef]] = pydantic.Field(None)
    CfnAssetProps: typing.Optional[dict[str, models.aws_mediapackage.CfnAssetPropsDef]] = pydantic.Field(None)
    CfnChannelProps: typing.Optional[dict[str, models.aws_mediapackage.CfnChannelPropsDef]] = pydantic.Field(None)
    CfnOriginEndpointProps: typing.Optional[dict[str, models.aws_mediapackage.CfnOriginEndpointPropsDef]] = pydantic.Field(None)
    CfnPackagingConfigurationProps: typing.Optional[dict[str, models.aws_mediapackage.CfnPackagingConfigurationPropsDef]] = pydantic.Field(None)
    CfnPackagingGroupProps: typing.Optional[dict[str, models.aws_mediapackage.CfnPackagingGroupPropsDef]] = pydantic.Field(None)
    ...
