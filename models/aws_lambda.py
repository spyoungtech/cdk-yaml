...
class AssetImageCodeDef(BaseClass):
    ...
    follow_symlinks: typing.Optional[aws_cdk.SymlinkFollowMode] = pydantic.Field(None, description='A strategy for how to handle symlinks. Default: SymlinkFollowMode.NEVER\n')
    ignore_mode: typing.Optional[aws_cdk.IgnoreMode] = pydantic.Field(None, description='The ignore behavior to use for ``exclude`` patterns. Default: IgnoreMode.GLOB')
    _init_params: typing.ClassVar[list[str]] = ['directory', 'cmd', 'entrypoint', 'working_directory', 'asset_name', 'build_args', 'build_secrets', 'build_ssh', 'cache_from', 'cache_to', 'file', 'invalidation', 'network_mode', 'outputs', 'platform', 'target', 'extra_hash', 'exclude', 'follow_symlinks', 'ignore_mode']
    _method_names: typing.ClassVar[list[str]] = ['bind', 'bind_to_resource']
    _classmethod_names: typing.ClassVar[list[str]] = ['from_asset', 'from_asset_image', 'from_bucket', 'from_cfn_parameters', 'from_docker_build', 'from_ecr_image', 'from_inline']
...
class FunctionBaseDef(BaseClass):
    ...
    _method_names: typing.ClassVar[list[str]] = ['add_event_source', 'add_event_source_mapping', 'add_function_url', 'add_permission', 'add_to_role_policy', 'apply_removal_policy', 'configure_async_invoke', 'consider_warning_on_invoke_function_permissions', 'grant_invoke', 'grant_invoke_composite_principal', 'grant_invoke_url', 'metric', 'metric_duration', 'metric_errors', 'metric_invocations', 'metric_throttles']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class SingletonFunctionDef(BaseConstruct):
    ...
    _method_names: typing.ClassVar[list[str]] = ['add_dependency', 'add_environment', 'add_event_source', 'add_event_source_mapping', 'add_function_url', 'add_layers', 'add_permission', 'add_to_role_policy', 'apply_removal_policy', 'configure_async_invoke', 'consider_warning_on_invoke_function_permissions', 'depend_on', 'grant_invoke', 'grant_invoke_composite_principal', 'grant_invoke_url', 'metric', 'metric_duration', 'metric_errors', 'metric_invocations', 'metric_throttles']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class AssetImageCodePropsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['exclude', 'follow_symlinks', 'ignore_mode', 'extra_hash', 'asset_name', 'build_args', 'build_secrets', 'build_ssh', 'cache_from', 'cache_to', 'file', 'invalidation', 'network_mode', 'outputs', 'platform', 'target', 'cmd', 'entrypoint', 'working_directory']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class DockerBuildAssetOptionsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['build_args', 'cache_from', 'cache_to', 'file', 'platform', 'target_stage', 'image_path', 'output_path']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnAliasDef(BaseCfnResource):
    function_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the Lambda function. **Name formats** - *Function name* - ``MyFunction`` . - *Function ARN* - ``arn:aws:lambda:us-west-2:123456789012:function:MyFunction`` . - *Partial ARN* - ``123456789012:function:MyFunction`` . The length constraint applies only to the full ARN. If you specify only the function name, it is limited to 64 characters in length.\n')
...
class CfnEventSourceMappingDef(BaseCfnResource):
    function_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description="The name of the Lambda function. **Name formats** - *Function name* – ``MyFunction`` . - *Function ARN* – ``arn:aws:lambda:us-west-2:123456789012:function:MyFunction`` . - *Version or Alias ARN* – ``arn:aws:lambda:us-west-2:123456789012:function:MyFunction:PROD`` . - *Partial ARN* – ``123456789012:function:MyFunction`` . The length constraint applies only to the full ARN. If you specify only the function name, it's limited to 64 characters in length.\n")
    ...
    destination_config: typing.Union[models.UnsupportedResource, models.aws_lambda.CfnEventSourceMapping_DestinationConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='(Kinesis and DynamoDB Streams only) An Amazon SQS queue or Amazon SNS topic destination for discarded records.\n')
...
class CfnPermissionDef(BaseCfnResource):
    ...
    function_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the Lambda function, version, or alias. **Name formats** - *Function name* – ``my-function`` (name-only), ``my-function:v1`` (with alias). - *Function ARN* – ``arn:aws:lambda:us-west-2:123456789012:function:my-function`` . - *Partial ARN* – ``123456789012:function:my-function`` . You can append a version number or alias to any of the formats. The length constraint applies only to the full ARN. If you specify only the function name, it is limited to 64 characters in length.\n')
...
class CfnVersionDef(BaseCfnResource):
    ...
    _init_params: typing.ClassVar[list[str]] = ['function_name', 'code_sha256', 'description', 'provisioned_concurrency_config', 'runtime_policy']
