...
class CfnChannel_DashPlaylistSettingsPropertyDef(BaseStruct):
    manifest_window_seconds: typing.Union[int, float, None] = pydantic.Field(None, description='The total duration (in seconds) of each manifest. Minimum value: ``30`` seconds. Maximum value: ``3600`` seconds.\n')
    min_buffer_time_seconds: typing.Union[int, float, None] = pydantic.Field(None, description='Minimum amount of content (measured in seconds) that a player must keep available in the buffer. Minimum value: ``2`` seconds. Maximum value: ``60`` seconds.\n')
    min_update_period_seconds: typing.Union[int, float, None] = pydantic.Field(None, description='Minimum amount of time (in seconds) that the player should wait before requesting updates to the manifest. Minimum value: ``2`` seconds. Maximum value: ``60`` seconds.\n')
    suggested_presentation_delay_seconds: typing.Union[int, float, None] = pydantic.Field(None, description='Amount of time (in seconds) that the player should be from the live point at the end of the manifest. Minimum value: ``2`` seconds. Maximum value: ``60`` seconds.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-mediatailor-channel-dashplaylistsettings.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_mediatailor as mediatailor\n\n    dash_playlist_settings_property = mediatailor.CfnChannel.DashPlaylistSettingsProperty(\n        manifest_window_seconds=123,\n        min_buffer_time_seconds=123,\n        min_update_period_seconds=123,\n        suggested_presentation_delay_seconds=123\n    )\n')
...
#  autogenerated from aws_cdk.aws_mediatailor.CfnChannel.TimeShiftConfigurationProperty
class CfnChannel_TimeShiftConfigurationPropertyDef(BaseStruct):
    max_time_delay_seconds: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The maximum time delay for time-shifted viewing. The minimum allowed maximum time delay is 0 seconds, and the maximum allowed maximum time delay is 21600 seconds (6 hours).\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-mediatailor-channel-timeshiftconfiguration.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_mediatailor as mediatailor\n\n    time_shift_configuration_property = mediatailor.CfnChannel.TimeShiftConfigurationProperty(\n        max_time_delay_seconds=123\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['max_time_delay_seconds']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_mediatailor.CfnChannel.TimeShiftConfigurationProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class CfnPlaybackConfiguration_AvailSuppressionPropertyDef(BaseStruct):
    fill_policy: typing.Optional[str] = pydantic.Field(None, description='Defines the policy to apply to the avail suppression mode. ``BEHIND_LIVE_EDGE`` will always use the full avail suppression policy. ``AFTER_LIVE_EDGE`` mode can be used to invoke partial ad break fills when a session starts mid-break.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['fill_policy', 'mode', 'value']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnChannelDef(BaseCfnResource):
    ...
    audiences: typing.Optional[typing.Sequence[str]] = pydantic.Field(None, description='The list of audiences defined in channel.\n')
    ...
    time_shift_configuration: typing.Union[models.UnsupportedResource, models.aws_mediatailor.CfnChannel_TimeShiftConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The configuration for time-shifted viewing.')
    _init_params: typing.ClassVar[list[str]] = ['channel_name', 'outputs', 'playback_mode', 'audiences', 'filler_slate', 'log_configuration', 'tags', 'tier', 'time_shift_configuration']
    _method_names: typing.ClassVar[list[str]] = ['DashPlaylistSettingsProperty', 'HlsPlaylistSettingsProperty', 'LogConfigurationForChannelProperty', 'RequestOutputItemProperty', 'SlateSourceProperty', 'TimeShiftConfigurationProperty', 'add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
    ...
    resource_config: typing.Optional[models.aws_mediatailor.CfnChannelDefConfig] = pydantic.Field(None)


class CfnChannelDefConfig(pydantic.BaseModel):
    DashPlaylistSettingsProperty: typing.Optional[list[models.aws_mediatailor.CfnChannelDefDashplaylistsettingspropertyParams]] = pydantic.Field(None, description='')
    HlsPlaylistSettingsProperty: typing.Optional[list[models.aws_mediatailor.CfnChannelDefHlsplaylistsettingspropertyParams]] = pydantic.Field(None, description='')
    LogConfigurationForChannelProperty: typing.Optional[list[models.aws_mediatailor.CfnChannelDefLogconfigurationforchannelpropertyParams]] = pydantic.Field(None, description='')
    RequestOutputItemProperty: typing.Optional[list[models.aws_mediatailor.CfnChannelDefRequestoutputitempropertyParams]] = pydantic.Field(None, description='')
    SlateSourceProperty: typing.Optional[list[models.aws_mediatailor.CfnChannelDefSlatesourcepropertyParams]] = pydantic.Field(None, description='')
    TimeShiftConfigurationProperty: typing.Optional[list[models.aws_mediatailor.CfnChannelDefTimeshiftconfigurationpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_mediatailor.CfnChannelDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_mediatailor.CfnChannelDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_mediatailor.CfnChannelDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_mediatailor.CfnChannelDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_mediatailor.CfnChannelDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_mediatailor.CfnChannelDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_mediatailor.CfnChannelDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_mediatailor.CfnChannelDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_mediatailor.CfnChannelDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_mediatailor.CfnChannelDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_mediatailor.CfnChannelDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_mediatailor.CfnChannelDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_mediatailor.CfnChannelDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
class CfnChannelDefTimeshiftconfigurationpropertyParams(pydantic.BaseModel):
    max_time_delay_seconds: typing.Union[int, float] = pydantic.Field(..., description='')
    ...
...
class CfnChannelPolicyDef(BaseCfnResource):
    ...
    resource_config: typing.Optional[models.aws_mediatailor.CfnChannelPolicyDefConfig] = pydantic.Field(None)


class CfnChannelPolicyDefConfig(pydantic.BaseModel):
    add_deletion_override: typing.Optional[list[models.aws_mediatailor.CfnChannelPolicyDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_mediatailor.CfnChannelPolicyDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_mediatailor.CfnChannelPolicyDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_mediatailor.CfnChannelPolicyDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_mediatailor.CfnChannelPolicyDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_mediatailor.CfnChannelPolicyDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_mediatailor.CfnChannelPolicyDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_mediatailor.CfnChannelPolicyDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_mediatailor.CfnChannelPolicyDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_mediatailor.CfnChannelPolicyDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_mediatailor.CfnChannelPolicyDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_mediatailor.CfnChannelPolicyDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_mediatailor.CfnChannelPolicyDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
class CfnLiveSourceDef(BaseCfnResource):
    ...
    resource_config: typing.Optional[models.aws_mediatailor.CfnLiveSourceDefConfig] = pydantic.Field(None)


class CfnLiveSourceDefConfig(pydantic.BaseModel):
    HttpPackageConfigurationProperty: typing.Optional[list[models.aws_mediatailor.CfnLiveSourceDefHttppackageconfigurationpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_mediatailor.CfnLiveSourceDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_mediatailor.CfnLiveSourceDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_mediatailor.CfnLiveSourceDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_mediatailor.CfnLiveSourceDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_mediatailor.CfnLiveSourceDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_mediatailor.CfnLiveSourceDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_mediatailor.CfnLiveSourceDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_mediatailor.CfnLiveSourceDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_mediatailor.CfnLiveSourceDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_mediatailor.CfnLiveSourceDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_mediatailor.CfnLiveSourceDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_mediatailor.CfnLiveSourceDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_mediatailor.CfnLiveSourceDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
    cdk_tag_manager_config: typing.Optional[models.core.TagManagerDefConfig] = pydantic.Field(None)
...
class CfnPlaybackConfigurationDef(BaseCfnResource):
    ...
    resource_config: typing.Optional[models.aws_mediatailor.CfnPlaybackConfigurationDefConfig] = pydantic.Field(None)


class CfnPlaybackConfigurationDefConfig(pydantic.BaseModel):
    AdMarkerPassthroughProperty: typing.Optional[list[models.aws_mediatailor.CfnPlaybackConfigurationDefAdmarkerpassthroughpropertyParams]] = pydantic.Field(None, description='')
    AvailSuppressionProperty: typing.Optional[list[models.aws_mediatailor.CfnPlaybackConfigurationDefAvailsuppressionpropertyParams]] = pydantic.Field(None, description='')
    BumperProperty: typing.Optional[list[models.aws_mediatailor.CfnPlaybackConfigurationDefBumperpropertyParams]] = pydantic.Field(None, description='')
    CdnConfigurationProperty: typing.Optional[list[models.aws_mediatailor.CfnPlaybackConfigurationDefCdnconfigurationpropertyParams]] = pydantic.Field(None, description='')
    DashConfigurationProperty: typing.Optional[list[models.aws_mediatailor.CfnPlaybackConfigurationDefDashconfigurationpropertyParams]] = pydantic.Field(None, description='')
    HlsConfigurationProperty: typing.Optional[list[models.aws_mediatailor.CfnPlaybackConfigurationDefHlsconfigurationpropertyParams]] = pydantic.Field(None, description='')
    LivePreRollConfigurationProperty: typing.Optional[list[models.aws_mediatailor.CfnPlaybackConfigurationDefLiveprerollconfigurationpropertyParams]] = pydantic.Field(None, description='')
    ManifestProcessingRulesProperty: typing.Optional[list[models.aws_mediatailor.CfnPlaybackConfigurationDefManifestprocessingrulespropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_mediatailor.CfnPlaybackConfigurationDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_mediatailor.CfnPlaybackConfigurationDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_mediatailor.CfnPlaybackConfigurationDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_mediatailor.CfnPlaybackConfigurationDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_mediatailor.CfnPlaybackConfigurationDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_mediatailor.CfnPlaybackConfigurationDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_mediatailor.CfnPlaybackConfigurationDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_mediatailor.CfnPlaybackConfigurationDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_mediatailor.CfnPlaybackConfigurationDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_mediatailor.CfnPlaybackConfigurationDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_mediatailor.CfnPlaybackConfigurationDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_mediatailor.CfnPlaybackConfigurationDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_mediatailor.CfnPlaybackConfigurationDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
class CfnPlaybackConfigurationDefAvailsuppressionpropertyParams(pydantic.BaseModel):
    fill_policy: typing.Optional[str] = pydantic.Field(None, description='')
...
class CfnSourceLocationDef(BaseCfnResource):
    ...
    resource_config: typing.Optional[models.aws_mediatailor.CfnSourceLocationDefConfig] = pydantic.Field(None)


class CfnSourceLocationDefConfig(pydantic.BaseModel):
    AccessConfigurationProperty: typing.Optional[list[models.aws_mediatailor.CfnSourceLocationDefAccessconfigurationpropertyParams]] = pydantic.Field(None, description='')
    DefaultSegmentDeliveryConfigurationProperty: typing.Optional[list[models.aws_mediatailor.CfnSourceLocationDefDefaultsegmentdeliveryconfigurationpropertyParams]] = pydantic.Field(None, description='')
    HttpConfigurationProperty: typing.Optional[list[models.aws_mediatailor.CfnSourceLocationDefHttpconfigurationpropertyParams]] = pydantic.Field(None, description='')
    SecretsManagerAccessTokenConfigurationProperty: typing.Optional[list[models.aws_mediatailor.CfnSourceLocationDefSecretsmanageraccesstokenconfigurationpropertyParams]] = pydantic.Field(None, description='')
    SegmentDeliveryConfigurationProperty: typing.Optional[list[models.aws_mediatailor.CfnSourceLocationDefSegmentdeliveryconfigurationpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_mediatailor.CfnSourceLocationDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_mediatailor.CfnSourceLocationDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_mediatailor.CfnSourceLocationDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_mediatailor.CfnSourceLocationDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_mediatailor.CfnSourceLocationDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_mediatailor.CfnSourceLocationDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_mediatailor.CfnSourceLocationDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_mediatailor.CfnSourceLocationDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_mediatailor.CfnSourceLocationDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_mediatailor.CfnSourceLocationDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_mediatailor.CfnSourceLocationDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_mediatailor.CfnSourceLocationDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_mediatailor.CfnSourceLocationDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
    cdk_tag_manager_config: typing.Optional[models.core.TagManagerDefConfig] = pydantic.Field(None)
...
class CfnVodSourceDef(BaseCfnResource):
    ...
    resource_config: typing.Optional[models.aws_mediatailor.CfnVodSourceDefConfig] = pydantic.Field(None)


class CfnVodSourceDefConfig(pydantic.BaseModel):
    HttpPackageConfigurationProperty: typing.Optional[list[models.aws_mediatailor.CfnVodSourceDefHttppackageconfigurationpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_mediatailor.CfnVodSourceDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_mediatailor.CfnVodSourceDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_mediatailor.CfnVodSourceDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_mediatailor.CfnVodSourceDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_mediatailor.CfnVodSourceDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_mediatailor.CfnVodSourceDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_mediatailor.CfnVodSourceDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_mediatailor.CfnVodSourceDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_mediatailor.CfnVodSourceDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_mediatailor.CfnVodSourceDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_mediatailor.CfnVodSourceDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_mediatailor.CfnVodSourceDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_mediatailor.CfnVodSourceDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
    cdk_tag_manager_config: typing.Optional[models.core.TagManagerDefConfig] = pydantic.Field(None)
...
class ModuleModel(pydantic.BaseModel):
    CfnChannel_DashPlaylistSettingsProperty: typing.Optional[dict[str, models.aws_mediatailor.CfnChannel_DashPlaylistSettingsPropertyDef]] = pydantic.Field(None)
    CfnChannel_HlsPlaylistSettingsProperty: typing.Optional[dict[str, models.aws_mediatailor.CfnChannel_HlsPlaylistSettingsPropertyDef]] = pydantic.Field(None)
    CfnChannel_LogConfigurationForChannelProperty: typing.Optional[dict[str, models.aws_mediatailor.CfnChannel_LogConfigurationForChannelPropertyDef]] = pydantic.Field(None)
    CfnChannel_RequestOutputItemProperty: typing.Optional[dict[str, models.aws_mediatailor.CfnChannel_RequestOutputItemPropertyDef]] = pydantic.Field(None)
    CfnChannel_SlateSourceProperty: typing.Optional[dict[str, models.aws_mediatailor.CfnChannel_SlateSourcePropertyDef]] = pydantic.Field(None)
    CfnChannel_TimeShiftConfigurationProperty: typing.Optional[dict[str, models.aws_mediatailor.CfnChannel_TimeShiftConfigurationPropertyDef]] = pydantic.Field(None)
    CfnLiveSource_HttpPackageConfigurationProperty: typing.Optional[dict[str, models.aws_mediatailor.CfnLiveSource_HttpPackageConfigurationPropertyDef]] = pydantic.Field(None)
    CfnPlaybackConfiguration_AdMarkerPassthroughProperty: typing.Optional[dict[str, models.aws_mediatailor.CfnPlaybackConfiguration_AdMarkerPassthroughPropertyDef]] = pydantic.Field(None)
    CfnPlaybackConfiguration_AvailSuppressionProperty: typing.Optional[dict[str, models.aws_mediatailor.CfnPlaybackConfiguration_AvailSuppressionPropertyDef]] = pydantic.Field(None)
    CfnPlaybackConfiguration_BumperProperty: typing.Optional[dict[str, models.aws_mediatailor.CfnPlaybackConfiguration_BumperPropertyDef]] = pydantic.Field(None)
    CfnPlaybackConfiguration_CdnConfigurationProperty: typing.Optional[dict[str, models.aws_mediatailor.CfnPlaybackConfiguration_CdnConfigurationPropertyDef]] = pydantic.Field(None)
    CfnPlaybackConfiguration_DashConfigurationProperty: typing.Optional[dict[str, models.aws_mediatailor.CfnPlaybackConfiguration_DashConfigurationPropertyDef]] = pydantic.Field(None)
    CfnPlaybackConfiguration_HlsConfigurationProperty: typing.Optional[dict[str, models.aws_mediatailor.CfnPlaybackConfiguration_HlsConfigurationPropertyDef]] = pydantic.Field(None)
    CfnPlaybackConfiguration_LivePreRollConfigurationProperty: typing.Optional[dict[str, models.aws_mediatailor.CfnPlaybackConfiguration_LivePreRollConfigurationPropertyDef]] = pydantic.Field(None)
    CfnPlaybackConfiguration_ManifestProcessingRulesProperty: typing.Optional[dict[str, models.aws_mediatailor.CfnPlaybackConfiguration_ManifestProcessingRulesPropertyDef]] = pydantic.Field(None)
    CfnSourceLocation_AccessConfigurationProperty: typing.Optional[dict[str, models.aws_mediatailor.CfnSourceLocation_AccessConfigurationPropertyDef]] = pydantic.Field(None)
    CfnSourceLocation_DefaultSegmentDeliveryConfigurationProperty: typing.Optional[dict[str, models.aws_mediatailor.CfnSourceLocation_DefaultSegmentDeliveryConfigurationPropertyDef]] = pydantic.Field(None)
    CfnSourceLocation_HttpConfigurationProperty: typing.Optional[dict[str, models.aws_mediatailor.CfnSourceLocation_HttpConfigurationPropertyDef]] = pydantic.Field(None)
    CfnSourceLocation_SecretsManagerAccessTokenConfigurationProperty: typing.Optional[dict[str, models.aws_mediatailor.CfnSourceLocation_SecretsManagerAccessTokenConfigurationPropertyDef]] = pydantic.Field(None)
    CfnSourceLocation_SegmentDeliveryConfigurationProperty: typing.Optional[dict[str, models.aws_mediatailor.CfnSourceLocation_SegmentDeliveryConfigurationPropertyDef]] = pydantic.Field(None)
    CfnVodSource_HttpPackageConfigurationProperty: typing.Optional[dict[str, models.aws_mediatailor.CfnVodSource_HttpPackageConfigurationPropertyDef]] = pydantic.Field(None)
    CfnChannel: typing.Optional[dict[str, models.aws_mediatailor.CfnChannelDef]] = pydantic.Field(None)
    CfnChannelPolicy: typing.Optional[dict[str, models.aws_mediatailor.CfnChannelPolicyDef]] = pydantic.Field(None)
    CfnLiveSource: typing.Optional[dict[str, models.aws_mediatailor.CfnLiveSourceDef]] = pydantic.Field(None)
    CfnPlaybackConfiguration: typing.Optional[dict[str, models.aws_mediatailor.CfnPlaybackConfigurationDef]] = pydantic.Field(None)
    CfnSourceLocation: typing.Optional[dict[str, models.aws_mediatailor.CfnSourceLocationDef]] = pydantic.Field(None)
    CfnVodSource: typing.Optional[dict[str, models.aws_mediatailor.CfnVodSourceDef]] = pydantic.Field(None)
    CfnChannelPolicyProps: typing.Optional[dict[str, models.aws_mediatailor.CfnChannelPolicyPropsDef]] = pydantic.Field(None)
    CfnChannelProps: typing.Optional[dict[str, models.aws_mediatailor.CfnChannelPropsDef]] = pydantic.Field(None)
    CfnLiveSourceProps: typing.Optional[dict[str, models.aws_mediatailor.CfnLiveSourcePropsDef]] = pydantic.Field(None)
    CfnPlaybackConfigurationProps: typing.Optional[dict[str, models.aws_mediatailor.CfnPlaybackConfigurationPropsDef]] = pydantic.Field(None)
    CfnSourceLocationProps: typing.Optional[dict[str, models.aws_mediatailor.CfnSourceLocationPropsDef]] = pydantic.Field(None)
    CfnVodSourceProps: typing.Optional[dict[str, models.aws_mediatailor.CfnVodSourcePropsDef]] = pydantic.Field(None)
    ...
