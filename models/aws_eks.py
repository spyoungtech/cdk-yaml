...
class AwsAuthDef(BaseConstruct):
    cluster: models.aws_eks.ClusterDef = pydantic.Field(..., description='The EKS cluster to apply this configuration to. [disable-awslint:ref-via-interface]')
...
class ClusterDef(BaseConstruct):
    ...
    masters_role: typing.Optional[typing.Union[models.aws_iam.LazyRoleDef, models.aws_iam.RoleDef]] = pydantic.Field(None, description='An IAM role that will be added to the ``system:masters`` Kubernetes RBAC group. Default: - a role that assumable by anyone with permissions in the same account will automatically be defined\n')
    ...
    version: models.aws_eks.KubernetesVersionDef = pydantic.Field(..., description='The Kubernetes version to run in the cluster.\n')
    ...
    vpc_subnets: typing.Optional[typing.Sequence[typing.Union[models.aws_ec2.SubnetSelectionDef, dict[str, typing.Any]]]] = pydantic.Field(None, description='Where to place EKS Control Plane ENIs. If you want to create public load balancers, this must include public subnets. For example, to only select private subnets, supply the following: ``vpcSubnets: [{ subnetType: ec2.SubnetType.PRIVATE_WITH_EGRESS }]`` Default: - All public and private subnets')
    _init_params: typing.ClassVar[list[str]] = ['default_capacity', 'default_capacity_instance', 'default_capacity_type', 'kubectl_lambda_role', 'tags', 'alb_controller', 'awscli_layer', 'cluster_handler_environment', 'cluster_handler_security_group', 'cluster_logging', 'core_dns_compute_type', 'endpoint_access', 'kubectl_environment', 'kubectl_layer', 'kubectl_memory', 'masters_role', 'on_event_layer', 'output_masters_role_arn', 'place_cluster_handler_in_vpc', 'prune', 'secrets_encryption_key', 'service_ipv4_cidr', 'version', 'cluster_name', 'output_cluster_name', 'output_config_command', 'role', 'security_group', 'vpc', 'vpc_subnets']
    _method_names: typing.ClassVar[list[str]] = ['add_auto_scaling_group_capacity', 'add_cdk8s_chart', 'add_fargate_profile', 'add_helm_chart', 'add_manifest', 'add_nodegroup_capacity', 'add_service_account', 'apply_removal_policy', 'connect_auto_scaling_group_capacity', 'get_ingress_load_balancer_address', 'get_service_load_balancer_address']
...
class FargateClusterDef(BaseConstruct):
    ...
    vpc: typing.Optional[typing.Union[models.aws_ec2.VpcDef]] = pydantic.Field(None, description='The VPC in which to create the Cluster. Default: - a VPC with default configuration will be created and can be accessed through ``cluster.vpc``.\n')
    vpc_subnets: typing.Optional[typing.Sequence[typing.Union[models.aws_ec2.SubnetSelectionDef, dict[str, typing.Any]]]] = pydantic.Field(None, description='Where to place EKS Control Plane ENIs. If you want to create public load balancers, this must include public subnets. For example, to only select private subnets, supply the following: ``vpcSubnets: [{ subnetType: ec2.SubnetType.PRIVATE_WITH_EGRESS }]`` Default: - All public and private subnets')
    _init_params: typing.ClassVar[list[str]] = ['default_profile', 'alb_controller', 'awscli_layer', 'cluster_handler_environment', 'cluster_handler_security_group', 'cluster_logging', 'core_dns_compute_type', 'endpoint_access', 'kubectl_environment', 'kubectl_layer', 'kubectl_memory', 'masters_role', 'on_event_layer', 'output_masters_role_arn', 'place_cluster_handler_in_vpc', 'prune', 'secrets_encryption_key', 'service_ipv4_cidr', 'version', 'cluster_name', 'output_cluster_name', 'output_config_command', 'role', 'security_group', 'vpc', 'vpc_subnets']
    _method_names: typing.ClassVar[list[str]] = ['add_auto_scaling_group_capacity', 'add_cdk8s_chart', 'add_fargate_profile', 'add_helm_chart', 'add_manifest', 'add_nodegroup_capacity', 'add_service_account', 'apply_removal_policy', 'connect_auto_scaling_group_capacity', 'get_ingress_load_balancer_address', 'get_service_load_balancer_address']
    _classmethod_names: typing.ClassVar[list[str]] = ['from_cluster_attributes']
...
class FargateProfileDef(BaseConstruct):
    cluster: models.aws_eks.ClusterDef = pydantic.Field(..., description='The EKS cluster to apply the Fargate profile to. [disable-awslint:ref-via-interface]\n')
    selectors: typing.Sequence[typing.Union[models.aws_eks.SelectorDef, dict[str, typing.Any]]] = pydantic.Field(..., description='The selectors to match for pods to use this Fargate profile. Each selector must have an associated namespace. Optionally, you can also specify labels for a namespace. At least one selector is required and you may specify up to five selectors.\n')
    fargate_profile_name: typing.Optional[str] = pydantic.Field(None, description='The name of the Fargate profile. Default: - generated\n')
    pod_execution_role: typing.Optional[typing.Union[models.aws_iam.LazyRoleDef, models.aws_iam.RoleDef]] = pydantic.Field(None, description='The pod execution role to use for pods that match the selectors in the Fargate profile. The pod execution role allows Fargate infrastructure to register with your cluster as a node, and it provides read access to Amazon ECR image repositories. Default: - a role will be automatically created\n')
    subnet_selection: typing.Union[models.aws_ec2.SubnetSelectionDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Select which subnets to launch your pods into. At this time, pods running on Fargate are not assigned public IP addresses, so only private subnets (with no direct route to an Internet Gateway) are allowed. You must specify the VPC to customize the subnet selection Default: - all private subnets of the VPC are selected.\n')
...
class HelmChartDef(BaseConstruct):
    cluster: typing.Union[models.aws_eks.ClusterDef, models.aws_eks.FargateClusterDef] = pydantic.Field(..., description='The EKS cluster to apply this configuration to. [disable-awslint:ref-via-interface]\n')
    chart: typing.Optional[str] = pydantic.Field(None, description='The name of the chart. Either this or ``chartAsset`` must be specified. Default: - No chart name. Implies ``chartAsset`` is used.\n')
    chart_asset: typing.Optional[models.aws_s3_assets.AssetDef] = pydantic.Field(None, description='The chart in the form of an asset. Either this or ``chart`` must be specified. Default: - No chart asset. Implies ``chart`` is used.\n')
    create_namespace: typing.Optional[bool] = pydantic.Field(None, description='create namespace if not exist. Default: true\n')
    namespace: typing.Optional[str] = pydantic.Field(None, description='The Kubernetes namespace scope of the requests. Default: default\n')
    ...
    version: typing.Optional[str] = pydantic.Field(None, description='The chart version to install. Default: - If this is not specified, the latest version is installed\n')
    wait: typing.Optional[bool] = pydantic.Field(None, description='Whether or not Helm should wait until all Pods, PVCs, Services, and minimum number of Pods of a Deployment, StatefulSet, or ReplicaSet are in a ready state before marking the release as successful. Default: - Helm will not wait before marking release as successful')
    _init_params: typing.ClassVar[list[str]] = ['cluster', 'chart', 'chart_asset', 'create_namespace', 'namespace', 'release', 'repository', 'skip_crds', 'timeout', 'values', 'version', 'wait']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class KubectlProviderDef(BaseConstruct):
    cluster: typing.Union[models.aws_eks.ClusterDef, models.aws_eks.FargateClusterDef] = pydantic.Field(..., description='The cluster to control.')
    _init_params: typing.ClassVar[list[str]] = ['cluster']
...
class KubectlProviderDefFromKubectlProviderAttributesParams(pydantic.BaseModel):
    ...
    function_arn: str = pydantic.Field(..., description='The kubectl provider lambda arn.\n')
...
class KubernetesManifestDef(BaseConstruct):
    cluster: typing.Union[models.aws_eks.ClusterDef, models.aws_eks.FargateClusterDef] = pydantic.Field(..., description='The EKS cluster to apply this manifest to. [disable-awslint:ref-via-interface]\n')
    manifest: typing.Sequence[typing.Mapping[str, typing.Any]] = pydantic.Field(..., description='The manifest to apply. Consists of any number of child resources. When the resources are created/updated, this manifest will be applied to the cluster through ``kubectl apply`` and when the resources or the stack is deleted, the resources in the manifest will be deleted through ``kubectl delete``.\n')
...
class KubernetesObjectValueDef(BaseConstruct):
    cluster: typing.Union[models.aws_eks.ClusterDef, models.aws_eks.FargateClusterDef] = pydantic.Field(..., description='The EKS cluster to fetch attributes from. [disable-awslint:ref-via-interface]\n')
    json_path: str = pydantic.Field(..., description='JSONPath to the specific value.\n')
    object_name: str = pydantic.Field(..., description='The name of the object to query.\n')
    object_type: str = pydantic.Field(..., description="The object type to query. (e.g 'service', 'pod'...)\n")
...
class KubernetesPatchDef(BaseConstruct):
    apply_patch: typing.Mapping[str, typing.Any] = pydantic.Field(..., description='The JSON object to pass to ``kubectl patch`` when the resource is created/updated.\n')
    cluster: typing.Union[models.aws_eks.ClusterDef, models.aws_eks.FargateClusterDef] = pydantic.Field(..., description='The cluster to apply the patch to. [disable-awslint:ref-via-interface]\n')
    resource_name: str = pydantic.Field(..., description='The full name of the resource to patch (e.g. ``deployment/coredns``).\n')
    restore_patch: typing.Mapping[str, typing.Any] = pydantic.Field(..., description='The JSON object to pass to ``kubectl patch`` when the resource is removed.\n')
...
class NodegroupDef(BaseConstruct):
    cluster: typing.Union[models.aws_eks.ClusterDef, models.aws_eks.FargateClusterDef] = pydantic.Field(..., description='Cluster resource.\n')
    ami_type: typing.Optional[aws_cdk.aws_eks.NodegroupAmiType] = pydantic.Field(None, description='The AMI type for your node group. If you explicitly specify the launchTemplate with custom AMI, do not specify this property, or the node group deployment will fail. In other cases, you will need to specify correct amiType for the nodegroup. Default: - auto-determined from the instanceTypes property when launchTemplateSpec property is not specified\n')
    capacity_type: typing.Optional[aws_cdk.aws_eks.CapacityType] = pydantic.Field(None, description='The capacity type of the nodegroup. Default: - ON_DEMAND\n')
    desired_size: typing.Union[int, float, None] = pydantic.Field(None, description='The current number of worker nodes that the managed node group should maintain. If not specified, the nodewgroup will initially create ``minSize`` instances. Default: 2\n')
    disk_size: typing.Union[int, float, None] = pydantic.Field(None, description='The root device disk size (in GiB) for your node group instances. Default: 20\n')
    ...
    tags: typing.Optional[typing.Mapping[str, str]] = pydantic.Field(None, description='The metadata to apply to the node group to assist with categorization and organization. Each tag consists of a key and an optional value, both of which you define. Node group tags do not propagate to any other resources associated with the node group, such as the Amazon EC2 instances or subnets. Default: - None\n')
    taints: typing.Optional[typing.Sequence[typing.Union[models.aws_eks.TaintSpecDef, dict[str, typing.Any]]]] = pydantic.Field(None, description='The Kubernetes taints to be applied to the nodes in the node group when they are created. Default: - None')
    _init_params: typing.ClassVar[list[str]] = ['cluster', 'ami_type', 'capacity_type', 'desired_size', 'disk_size', 'force_update', 'instance_types', 'labels', 'launch_template_spec', 'max_size', 'min_size', 'nodegroup_name', 'node_role', 'release_version', 'remote_access', 'subnets', 'tags', 'taints']
...
class OpenIdConnectProviderDef(BaseConstruct):
    url: str = pydantic.Field(..., description='The URL of the identity provider. The URL must begin with https:// and should correspond to the iss claim in the provider\'s OpenID Connect ID tokens. Per the OIDC standard, path components are allowed but query parameters are not. Typically the URL consists of only a hostname, like https://server.example.org or https://example.com. You can find your OIDC Issuer URL by: aws eks describe-cluster --name %cluster_name% --query "cluster.identity.oidc.issuer" --output text')
...
class ServiceAccountDef(BaseConstruct):
    cluster: typing.Union[models.aws_eks.ClusterDef, models.aws_eks.FargateClusterDef] = pydantic.Field(..., description='The cluster to apply the patch to.\n')
    annotations: typing.Optional[typing.Mapping[str, str]] = pydantic.Field(None, description='Additional annotations of the service account. Default: - no additional annotations\n')
    labels: typing.Optional[typing.Mapping[str, str]] = pydantic.Field(None, description='Additional labels of the service account. Default: - no additional labels\n')
    name: typing.Optional[str] = pydantic.Field(None, description='The name of the service account. The name of a ServiceAccount object must be a valid DNS subdomain name. https://kubernetes.io/docs/tasks/configure-pod-container/configure-service-account/ Default: - If no name is given, it will use the id of the resource.\n')
    namespace: typing.Optional[str] = pydantic.Field(None, description='The namespace of the service account. All namespace names must be valid RFC 1123 DNS labels. https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/#namespaces-and-dns Default: "default"')
    _init_params: typing.ClassVar[list[str]] = ['cluster', 'annotations', 'labels', 'name', 'namespace']
...
class AutoScalingGroupCapacityOptionsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['allow_all_outbound', 'associate_public_ip_address', 'auto_scaling_group_name', 'block_devices', 'capacity_rebalance', 'cooldown', 'default_instance_warmup', 'desired_capacity', 'group_metrics', 'health_check', 'ignore_unmodified_size_properties', 'instance_monitoring', 'key_name', 'max_capacity', 'max_instance_lifetime', 'min_capacity', 'new_instances_protected_from_scale_in', 'notifications', 'signals', 'spot_price', 'ssm_session_permissions', 'termination_policies', 'update_policy', 'vpc_subnets', 'instance_type', 'bootstrap_enabled', 'bootstrap_options', 'machine_image_type', 'map_role', 'spot_interrupt_handler']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnCluster_EncryptionConfigPropertyDef(BaseStruct):
    provider: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_eks.CfnCluster_ProviderPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The encryption provider for the cluster.\n')
...
class CfnCluster_LoggingPropertyDef(BaseStruct):
    cluster_logging: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_eks.CfnCluster_ClusterLoggingPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The cluster control plane logging configuration for your cluster.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-eks-cluster-logging.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_eks as eks\n\n    logging_property = eks.CfnCluster.LoggingProperty(\n        cluster_logging=eks.CfnCluster.ClusterLoggingProperty(\n            enabled_types=[eks.CfnCluster.LoggingTypeConfigProperty(\n                type="type"\n            )]\n        )\n    )\n')
...
class CfnCluster_OutpostConfigPropertyDef(BaseStruct):
    control_plane_instance_type: str = pydantic.Field(..., description="The Amazon EC2 instance type that you want to use for your local Amazon EKS cluster on Outposts. Choose an instance type based on the number of nodes that your cluster will have. For more information, see `Capacity considerations <https://docs.aws.amazon.com/eks/latest/userguide/eks-outposts-capacity-considerations.html>`_ in the *Amazon EKS User Guide* . The instance type that you specify is used for all Kubernetes control plane instances. The instance type can't be changed after cluster creation. The control plane is not automatically scaled by Amazon EKS.\n")
    outpost_arns: typing.Sequence[str] = pydantic.Field(..., description='The ARN of the Outpost that you want to use for your local Amazon EKS cluster on Outposts. Only a single Outpost ARN is supported.\n')
    control_plane_placement: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_eks.CfnCluster_ControlPlanePlacementPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='An object representing the placement configuration for all the control plane instances of your local Amazon EKS cluster on an AWS Outpost. For more information, see `Capacity considerations <https://docs.aws.amazon.com/eks/latest/userguide/eks-outposts-capacity-considerations.html>`_ in the *Amazon EKS User Guide* .\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-eks-cluster-outpostconfig.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_eks as eks\n\n    outpost_config_property = eks.CfnCluster.OutpostConfigProperty(\n        control_plane_instance_type="controlPlaneInstanceType",\n        outpost_arns=["outpostArns"],\n\n        # the properties below are optional\n        control_plane_placement=eks.CfnCluster.ControlPlanePlacementProperty(\n            group_name="groupName"\n        )\n    )\n')
...
class CfnCluster_ResourcesVpcConfigPropertyDef(BaseStruct):
    subnet_ids: typing.Sequence[str] = pydantic.Field(..., description='Specify subnets for your Amazon EKS nodes. Amazon EKS creates cross-account elastic network interfaces in these subnets to allow communication between your nodes and the Kubernetes control plane.\n')
    endpoint_private_access: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description="Set this value to ``true`` to enable private access for your cluster's Kubernetes API server endpoint. If you enable private access, Kubernetes API requests from within your cluster's VPC use the private VPC endpoint. The default value for this parameter is ``false`` , which disables private access for your Kubernetes API server. If you disable private access and you have nodes or AWS Fargate pods in the cluster, then ensure that ``publicAccessCidrs`` includes the necessary CIDR blocks for communication with the nodes or Fargate pods. For more information, see `Amazon EKS cluster endpoint access control <https://docs.aws.amazon.com/eks/latest/userguide/cluster-endpoint.html>`_ in the **Amazon EKS User Guide** .\n")
    endpoint_public_access: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description="Set this value to ``false`` to disable public access to your cluster's Kubernetes API server endpoint. If you disable public access, your cluster's Kubernetes API server can only receive requests from within the cluster VPC. The default value for this parameter is ``true`` , which enables public access for your Kubernetes API server. For more information, see `Amazon EKS cluster endpoint access control <https://docs.aws.amazon.com/eks/latest/userguide/cluster-endpoint.html>`_ in the **Amazon EKS User Guide** .\n")
...
class CfnFargateProfile_SelectorPropertyDef(BaseStruct):
    namespace: str = pydantic.Field(..., description='The Kubernetes namespace that the selector should match.\n')
    labels: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_eks.CfnFargateProfile_LabelPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The Kubernetes labels that the selector should match. A pod must contain all of the labels that are specified in the selector for it to be considered a match.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-eks-fargateprofile-selector.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_eks as eks\n\n    selector_property = eks.CfnFargateProfile.SelectorProperty(\n        namespace="namespace",\n\n        # the properties below are optional\n        labels=[eks.CfnFargateProfile.LabelProperty(\n            key="key",\n            value="value"\n        )]\n    )\n')
...
class CfnIdentityProviderConfig_OidcIdentityProviderConfigPropertyDef(BaseStruct):
    client_id: str = pydantic.Field(..., description='This is also known as *audience* . The ID of the client application that makes authentication requests to the OIDC identity provider.\n')
    issuer_url: str = pydantic.Field(..., description='The URL of the OIDC identity provider that allows the API server to discover public signing keys for verifying tokens.\n')
    ...
    required_claims: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_eks.CfnIdentityProviderConfig_RequiredClaimPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The key-value pairs that describe required claims in the identity token. If set, each claim is verified to be present in the token with a matching value.\n')
...
class CfnNodegroup_ScalingConfigPropertyDef(BaseStruct):
    desired_size: typing.Union[int, float, None] = pydantic.Field(None, description="The current number of nodes that the managed node group should maintain. .. epigraph:: If you use Cluster Autoscaler, you shouldn't change the desiredSize value directly, as this can cause the Cluster Autoscaler to suddenly scale up or scale down. Whenever this parameter changes, the number of worker nodes in the node group is updated to the specified size. If this parameter is given a value that is smaller than the current number of running worker nodes, the necessary number of worker nodes are terminated to match the given value. When using CloudFormation, no action occurs if you remove this parameter from your CFN template. This parameter can be different from minSize in some cases, such as when starting with extra hosts for testing. This parameter can also be different when you want to start with an estimated number of needed hosts, but let Cluster Autoscaler reduce the number if there are too many. When Cluster Autoscaler is used, the desiredSize parameter is altered by Cluster Autoscaler (but can be out-of-date for short periods of time). Cluster Autoscaler doesn't scale a managed node group lower than minSize or higher than maxSize.\n")
...
class CfnNodegroup_UpdateConfigPropertyDef(BaseStruct):
    max_unavailable: typing.Union[int, float, None] = pydantic.Field(None, description='The maximum number of nodes unavailable at once during a version update. Nodes will be updated in parallel. This value or ``maxUnavailablePercentage`` is required to have a value.The maximum number is 100.\n')
    max_unavailable_percentage: typing.Union[int, float, None] = pydantic.Field(None, description='The maximum percentage of nodes unavailable during a version update. This percentage of nodes will be updated in parallel, up to 100 nodes at once. This value or ``maxUnavailable`` is required to have a value.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-eks-nodegroup-updateconfig.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_eks as eks\n\n    update_config_property = eks.CfnNodegroup.UpdateConfigProperty(\n        max_unavailable=123,\n        max_unavailable_percentage=123\n    )\n')
...
class ClusterPropsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['version', 'cluster_name', 'output_cluster_name', 'output_config_command', 'role', 'security_group', 'vpc', 'vpc_subnets', 'alb_controller', 'awscli_layer', 'cluster_handler_environment', 'cluster_handler_security_group', 'cluster_logging', 'core_dns_compute_type', 'endpoint_access', 'kubectl_environment', 'kubectl_layer', 'kubectl_memory', 'masters_role', 'on_event_layer', 'output_masters_role_arn', 'place_cluster_handler_in_vpc', 'prune', 'secrets_encryption_key', 'service_ipv4_cidr', 'default_capacity', 'default_capacity_instance', 'default_capacity_type', 'kubectl_lambda_role', 'tags']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class HelmChartOptionsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['chart', 'chart_asset', 'create_namespace', 'namespace', 'release', 'repository', 'skip_crds', 'timeout', 'values', 'version', 'wait']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class HelmChartPropsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['chart', 'chart_asset', 'create_namespace', 'namespace', 'release', 'repository', 'skip_crds', 'timeout', 'values', 'version', 'wait', 'cluster']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class NodegroupOptionsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['ami_type', 'capacity_type', 'desired_size', 'disk_size', 'force_update', 'instance_types', 'labels', 'launch_template_spec', 'max_size', 'min_size', 'nodegroup_name', 'node_role', 'release_version', 'remote_access', 'subnets', 'tags', 'taints']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class NodegroupPropsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['ami_type', 'capacity_type', 'desired_size', 'disk_size', 'force_update', 'instance_types', 'labels', 'launch_template_spec', 'max_size', 'min_size', 'nodegroup_name', 'node_role', 'release_version', 'remote_access', 'subnets', 'tags', 'taints', 'cluster']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class NodegroupRemoteAccessDef(BaseStruct):
    ssh_key_name: str = pydantic.Field(..., description='The Amazon EC2 SSH key that provides access for SSH communication with the worker nodes in the managed node group.\n')
...
class SelectorDef(BaseStruct):
    namespace: str = pydantic.Field(..., description='The Kubernetes namespace that the selector should match. You must specify a namespace for a selector. The selector only matches pods that are created in this namespace, but you can create multiple selectors to target multiple namespaces.\n')
...
class ServiceAccountOptionsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['annotations', 'labels', 'name', 'namespace']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class ServiceAccountPropsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['annotations', 'labels', 'name', 'namespace', 'cluster']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnAddonDef(BaseCfnResource):
    addon_name: str = pydantic.Field(..., description='The name of the add-on.\n')
    ...
    preserve_on_delete: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description="Specifying this option preserves the add-on software on your cluster but Amazon EKS stops managing any settings for the add-on. If an IAM account is associated with the add-on, it isn't removed.\n")
    ...
    _init_params: typing.ClassVar[list[str]] = ['addon_name', 'cluster_name', 'addon_version', 'configuration_values', 'preserve_on_delete', 'resolve_conflicts', 'service_account_role_arn', 'tags']
...
class CfnClusterDef(BaseCfnResource):
    resources_vpc_config: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_eks.CfnCluster_ResourcesVpcConfigPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description="The VPC configuration that's used by the cluster control plane. Amazon EKS VPC resources have specific requirements to work properly with Kubernetes. For more information, see `Cluster VPC Considerations <https://docs.aws.amazon.com/eks/latest/userguide/network_reqs.html>`_ and `Cluster Security Group Considerations <https://docs.aws.amazon.com/eks/latest/userguide/sec-group-reqs.html>`_ in the *Amazon EKS User Guide* . You must specify at least two subnets. You can specify up to five security groups, but we recommend that you use a dedicated security group for your cluster control plane. .. epigraph:: Updates require replacement of the ``SecurityGroupIds`` and ``SubnetIds`` sub-properties.\n")
    role_arn: str = pydantic.Field(..., description='The Amazon Resource Name (ARN) of the IAM role that provides permissions for the Kubernetes control plane to make calls to AWS API operations on your behalf. For more information, see `Amazon EKS Service IAM Role <https://docs.aws.amazon.com/eks/latest/userguide/service_IAM_role.html>`_ in the **Amazon EKS User Guide** .\n')
    encryption_config: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_eks.CfnCluster_EncryptionConfigPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The encryption configuration for the cluster.\n')
    kubernetes_network_config: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_eks.CfnCluster_KubernetesNetworkConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The Kubernetes network configuration for the cluster.\n')
    logging: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_eks.CfnCluster_LoggingPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The logging configuration for your cluster.\n')
    name: typing.Optional[str] = pydantic.Field(None, description='The unique name to give to your cluster.\n')
    outpost_config: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_eks.CfnCluster_OutpostConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description="An object representing the configuration of your local Amazon EKS cluster on an AWS Outpost. This object isn't available for clusters on the AWS cloud.\n")
    ...
    _init_params: typing.ClassVar[list[str]] = ['resources_vpc_config', 'role_arn', 'encryption_config', 'kubernetes_network_config', 'logging', 'name', 'outpost_config', 'tags', 'version']
    _method_names: typing.ClassVar[list[str]] = ['ClusterLoggingProperty', 'ControlPlanePlacementProperty', 'EncryptionConfigProperty', 'KubernetesNetworkConfigProperty', 'LoggingProperty', 'LoggingTypeConfigProperty', 'OutpostConfigProperty', 'ProviderProperty', 'ResourcesVpcConfigProperty', 'add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnClusterDefClusterloggingpropertyParams(pydantic.BaseModel):
    enabled_types: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_eks.CfnCluster_LoggingTypeConfigPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    ...
...
class CfnClusterDefEncryptionconfigpropertyParams(pydantic.BaseModel):
    provider: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_eks.CfnCluster_ProviderPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
...
class CfnClusterDefOutpostconfigpropertyParams(pydantic.BaseModel):
    ...
    control_plane_placement: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_eks.CfnCluster_ControlPlanePlacementPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnFargateProfileDef(BaseCfnResource):
    cluster_name: str = pydantic.Field(..., description='The name of the Amazon EKS cluster to apply the Fargate profile to.\n')
    pod_execution_role_arn: str = pydantic.Field(..., description='The Amazon Resource Name (ARN) of the pod execution role to use for pods that match the selectors in the Fargate profile. The pod execution role allows Fargate infrastructure to register with your cluster as a node, and it provides read access to Amazon ECR image repositories. For more information, see `Pod Execution Role <https://docs.aws.amazon.com/eks/latest/userguide/pod-execution-role.html>`_ in the *Amazon EKS User Guide* .\n')
    selectors: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_eks.CfnFargateProfile_SelectorPropertyDef, dict[str, typing.Any]]]] = pydantic.Field(..., description='The selectors to match for pods to use this Fargate profile. Each selector must have an associated namespace. Optionally, you can also specify labels for a namespace. You may specify up to five selectors in a Fargate profile.\n')
    fargate_profile_name: typing.Optional[str] = pydantic.Field(None, description='The name of the Fargate profile.\n')
    subnets: typing.Optional[typing.Sequence[str]] = pydantic.Field(None, description='The IDs of subnets to launch your pods into. At this time, pods running on Fargate are not assigned public IP addresses, so only private subnets (with no direct route to an Internet Gateway) are accepted for this parameter.\n')
    tags: typing.Optional[typing.Sequence[typing.Union[models.CfnTagDef, dict[str, typing.Any]]]] = pydantic.Field(None, description='The metadata to apply to the Fargate profile to assist with categorization and organization. Each tag consists of a key and an optional value. You define both. Fargate profile tags do not propagate to any other resources associated with the Fargate profile, such as the pods that are scheduled with it.')
...
class CfnFargateProfileDefSelectorpropertyParams(pydantic.BaseModel):
    ...
    labels: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_eks.CfnFargateProfile_LabelPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    ...
...
class CfnIdentityProviderConfigDef(BaseCfnResource):
    cluster_name: str = pydantic.Field(..., description='The cluster that the configuration is associated to.\n')
    type: str = pydantic.Field(..., description='The type of the identity provider configuration. The only type available is ``oidc`` .\n')
    identity_provider_config_name: typing.Optional[str] = pydantic.Field(None, description='The name of the configuration.\n')
    oidc: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_eks.CfnIdentityProviderConfig_OidcIdentityProviderConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='An object representing an OpenID Connect (OIDC) identity provider configuration.\n')
    tags: typing.Optional[typing.Sequence[typing.Union[models.CfnTagDef, dict[str, typing.Any]]]] = pydantic.Field(None, description='The metadata to apply to the provider configuration to assist with categorization and organization. Each tag consists of a key and an optional value. You define both.')
...
class CfnIdentityProviderConfigDefOidcidentityproviderconfigpropertyParams(pydantic.BaseModel):
    ...
    required_claims: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_eks.CfnIdentityProviderConfig_RequiredClaimPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
...
class CfnNodegroupDef(BaseCfnResource):
    cluster_name: str = pydantic.Field(..., description='The name of the cluster to create the node group in.\n')
    node_role: str = pydantic.Field(..., description="The Amazon Resource Name (ARN) of the IAM role to associate with your node group. The Amazon EKS worker node ``kubelet`` daemon makes calls to AWS APIs on your behalf. Nodes receive permissions for these API calls through an IAM instance profile and associated policies. Before you can launch nodes and register them into a cluster, you must create an IAM role for those nodes to use when they are launched. For more information, see `Amazon EKS node IAM role <https://docs.aws.amazon.com/eks/latest/userguide/create-node-role.html>`_ in the **Amazon EKS User Guide** . If you specify ``launchTemplate`` , then don't specify ```IamInstanceProfile`` <https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_IamInstanceProfile.html>`_ in your launch template, or the node group deployment will fail. For more information about using launch templates with Amazon EKS, see `Launch template support <https://docs.aws.amazon.com/eks/latest/userguide/launch-templates.html>`_ in the *Amazon EKS User Guide* .\n")
    subnets: typing.Sequence[str] = pydantic.Field(..., description="The subnets to use for the Auto Scaling group that is created for your node group. If you specify ``launchTemplate`` , then don't specify ```SubnetId`` <https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_CreateNetworkInterface.html>`_ in your launch template, or the node group deployment will fail. For more information about using launch templates with Amazon EKS, see `Launch template support <https://docs.aws.amazon.com/eks/latest/userguide/launch-templates.html>`_ in the *Amazon EKS User Guide* .\n")
    ...
    force_update_enabled: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description="Force the update if the existing node group's pods are unable to be drained due to a pod disruption budget issue. If an update fails because pods could not be drained, you can force the update after it fails to terminate the old node whether or not any pods are running on the node.\n")
    ...
    labels: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Mapping[str, str], None] = pydantic.Field(None, description='The Kubernetes labels applied to the nodes in the node group. .. epigraph:: Only labels that are applied with the Amazon EKS API are shown here. There may be other Kubernetes labels applied to the nodes in this group.\n')
    launch_template: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_eks.CfnNodegroup_LaunchTemplateSpecificationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description="An object representing a node group's launch template specification. If specified, then do not specify ``instanceTypes`` , ``diskSize`` , or ``remoteAccess`` and make sure that the launch template meets the requirements in ``launchTemplateSpecification`` .\n")
    ...
    remote_access: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_eks.CfnNodegroup_RemoteAccessPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description="The remote access configuration to use with your node group. For Linux, the protocol is SSH. For Windows, the protocol is RDP. If you specify ``launchTemplate`` , then don't specify ``remoteAccess`` , or the node group deployment will fail. For more information about using launch templates with Amazon EKS, see `Launch template support <https://docs.aws.amazon.com/eks/latest/userguide/launch-templates.html>`_ in the *Amazon EKS User Guide* .\n")
    scaling_config: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_eks.CfnNodegroup_ScalingConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The scaling configuration details for the Auto Scaling group that is created for your node group.\n')
    tags: typing.Optional[typing.Mapping[str, str]] = pydantic.Field(None, description='The metadata applied to the node group to assist with categorization and organization. Each tag consists of a key and an optional value. You define both. Node group tags do not propagate to any other resources associated with the node group, such as the Amazon EC2 instances or subnets.\n')
    taints: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_eks.CfnNodegroup_TaintPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The Kubernetes taints to be applied to the nodes in the node group when they are created. Effect is one of ``No_Schedule`` , ``Prefer_No_Schedule`` , or ``No_Execute`` . Kubernetes taints can be used together with tolerations to control how workloads are scheduled to your nodes. For more information, see `Node taints on managed node groups <https://docs.aws.amazon.com/eks/latest/userguide/node-taints-managed-node-groups.html>`_ .\n')
    update_config: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_eks.CfnNodegroup_UpdateConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The node group update configuration.\n')
