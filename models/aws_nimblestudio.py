...
class CfnLaunchProfile_StreamConfigurationPropertyDef(BaseStruct):
    clipboard_mode: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Allows or deactivates the use of the system clipboard to copy and paste between the streaming session and streaming client.\n')
    ec2_instance_types: typing.Union[typing.Sequence[str], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The EC2 instance types that users can select from when launching a streaming session with this launch profile.\n')
    streaming_image_ids: typing.Union[typing.Sequence[str], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The streaming images that users can select from when launching a streaming session with this launch profile.\n')
    automatic_termination_mode: typing.Optional[str] = pydantic.Field(None, description='Indicates if a streaming session created from this launch profile should be terminated automatically or retained without termination after being in a ``STOPPED`` state. - When ``ACTIVATED`` , the streaming session is scheduled for termination after being in the ``STOPPED`` state for the time specified in ``maxStoppedSessionLengthInMinutes`` . - When ``DEACTIVATED`` , the streaming session can remain in the ``STOPPED`` state indefinitely. This parameter is only allowed when ``sessionPersistenceMode`` is ``ACTIVATED`` . When allowed, the default value for this parameter is ``DEACTIVATED`` .\n')
...
class CfnLaunchProfile_StreamConfigurationSessionBackupPropertyDef(BaseStruct):
    max_backups_to_retain: typing.Union[int, float, None] = pydantic.Field(None, description='The maximum number of backups that each streaming session created from this launch profile can have. Default: - 0\n')
    mode: typing.Optional[str] = pydantic.Field(None, description='Specifies how artists sessions are backed up. Configures backups for streaming sessions launched with this launch profile. The default value is ``DEACTIVATED`` , which means that backups are deactivated. To allow backups, set this value to ``AUTOMATIC`` .\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-nimblestudio-launchprofile-streamconfigurationsessionbackup.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_nimblestudio as nimblestudio\n\n    stream_configuration_session_backup_property = nimblestudio.CfnLaunchProfile.StreamConfigurationSessionBackupProperty(\n        max_backups_to_retain=123,\n        mode="mode"\n    )\n')
...
class CfnLaunchProfile_StreamConfigurationSessionStoragePropertyDef(BaseStruct):
    mode: typing.Union[typing.Sequence[str], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Allows artists to upload files to their workstations. The only valid option is ``UPLOAD`` .\n')
    root: typing.Union[models.UnsupportedResource, models.aws_nimblestudio.CfnLaunchProfile_StreamingSessionStorageRootPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The configuration for the upload storage root of the streaming session.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-nimblestudio-launchprofile-streamconfigurationsessionstorage.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_nimblestudio as nimblestudio\n\n    stream_configuration_session_storage_property = nimblestudio.CfnLaunchProfile.StreamConfigurationSessionStorageProperty(\n        mode=["mode"],\n\n        # the properties below are optional\n        root=nimblestudio.CfnLaunchProfile.StreamingSessionStorageRootProperty(\n            linux="linux",\n            windows="windows"\n        )\n    )\n')
...
class CfnLaunchProfile_VolumeConfigurationPropertyDef(BaseStruct):
    iops: typing.Union[int, float, None] = pydantic.Field(None, description='The number of I/O operations per second for the root volume that is attached to streaming session. Default: - 3000\n')
    size: typing.Union[int, float, None] = pydantic.Field(None, description='The size of the root volume that is attached to the streaming session. The root volume size is measured in GiBs. Default: - 500\n')
    throughput: typing.Union[int, float, None] = pydantic.Field(None, description='The throughput to provision for the root volume that is attached to the streaming session. The throughput is measured in MiB/s. Default: - 125\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-nimblestudio-launchprofile-volumeconfiguration.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_nimblestudio as nimblestudio\n\n    volume_configuration_property = nimblestudio.CfnLaunchProfile.VolumeConfigurationProperty(\n        iops=123,\n        size=123,\n        throughput=123\n    )\n')
...
class CfnStreamingImage_StreamingImageEncryptionConfigurationPropertyDef(BaseStruct):
    key_type: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The type of KMS key that is used to encrypt studio data.\n')
...
class CfnLaunchProfileDef(BaseCfnResource):
    ec2_subnet_ids: typing.Union[typing.Sequence[str], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Unique identifiers for a collection of EC2 subnets.\n')
    launch_profile_protocol_versions: typing.Union[typing.Sequence[str], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The version number of the protocol that is used by the launch profile. The only valid version is "2021-03-31".\n')
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A friendly name for the launch profile.\n')
    stream_configuration: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_nimblestudio.CfnLaunchProfile_StreamConfigurationPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='A configuration for a streaming session.\n')
    studio_component_ids: typing.Union[typing.Sequence[str], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Unique identifiers for a collection of studio components that can be used with this launch profile.\n')
    studio_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The unique identifier for a studio resource. In Nimble Studio , all other resources are contained in a studio resource.\n')
    ...
    resource_config: typing.Optional[models.aws_nimblestudio.CfnLaunchProfileDefConfig] = pydantic.Field(None)


class CfnLaunchProfileDefConfig(pydantic.BaseModel):
    StreamConfigurationProperty: typing.Optional[list[models.aws_nimblestudio.CfnLaunchProfileDefStreamconfigurationpropertyParams]] = pydantic.Field(None, description='')
    StreamConfigurationSessionBackupProperty: typing.Optional[list[models.aws_nimblestudio.CfnLaunchProfileDefStreamconfigurationsessionbackuppropertyParams]] = pydantic.Field(None, description='')
    StreamConfigurationSessionStorageProperty: typing.Optional[list[models.aws_nimblestudio.CfnLaunchProfileDefStreamconfigurationsessionstoragepropertyParams]] = pydantic.Field(None, description='')
    StreamingSessionStorageRootProperty: typing.Optional[list[models.aws_nimblestudio.CfnLaunchProfileDefStreamingsessionstoragerootpropertyParams]] = pydantic.Field(None, description='')
    VolumeConfigurationProperty: typing.Optional[list[models.aws_nimblestudio.CfnLaunchProfileDefVolumeconfigurationpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_nimblestudio.CfnLaunchProfileDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_nimblestudio.CfnLaunchProfileDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_nimblestudio.CfnLaunchProfileDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_nimblestudio.CfnLaunchProfileDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_nimblestudio.CfnLaunchProfileDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_nimblestudio.CfnLaunchProfileDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_nimblestudio.CfnLaunchProfileDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_nimblestudio.CfnLaunchProfileDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_nimblestudio.CfnLaunchProfileDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_nimblestudio.CfnLaunchProfileDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_nimblestudio.CfnLaunchProfileDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_nimblestudio.CfnLaunchProfileDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_nimblestudio.CfnLaunchProfileDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
class CfnLaunchProfileDefStreamconfigurationpropertyParams(pydantic.BaseModel):
    ...
    session_backup: typing.Union[models.UnsupportedResource, models.aws_nimblestudio.CfnLaunchProfile_StreamConfigurationSessionBackupPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    session_persistence_mode: typing.Optional[str] = pydantic.Field(None, description='')
    session_storage: typing.Union[models.UnsupportedResource, models.aws_nimblestudio.CfnLaunchProfile_StreamConfigurationSessionStoragePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    volume_configuration: typing.Union[models.UnsupportedResource, models.aws_nimblestudio.CfnLaunchProfile_VolumeConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnLaunchProfileDefStreamconfigurationsessionstoragepropertyParams(pydantic.BaseModel):
    ...
    root: typing.Union[models.UnsupportedResource, models.aws_nimblestudio.CfnLaunchProfile_StreamingSessionStorageRootPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnStreamingImageDef(BaseCfnResource):
    ec2_image_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The ID of an EC2 machine image with which to create the streaming image.\n')
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A friendly name for a streaming image resource.\n')
    studio_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The unique identifier for a studio resource. In Nimble Studio , all other resources are contained in a studio resource.\n')
    ...
    resource_config: typing.Optional[models.aws_nimblestudio.CfnStreamingImageDefConfig] = pydantic.Field(None)


class CfnStreamingImageDefConfig(pydantic.BaseModel):
    StreamingImageEncryptionConfigurationProperty: typing.Optional[list[models.aws_nimblestudio.CfnStreamingImageDefStreamingimageencryptionconfigurationpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_nimblestudio.CfnStreamingImageDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_nimblestudio.CfnStreamingImageDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_nimblestudio.CfnStreamingImageDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_nimblestudio.CfnStreamingImageDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_nimblestudio.CfnStreamingImageDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_nimblestudio.CfnStreamingImageDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_nimblestudio.CfnStreamingImageDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_nimblestudio.CfnStreamingImageDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_nimblestudio.CfnStreamingImageDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_nimblestudio.CfnStreamingImageDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_nimblestudio.CfnStreamingImageDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_nimblestudio.CfnStreamingImageDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_nimblestudio.CfnStreamingImageDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
    attr_encryption_configuration_config: typing.Optional[models._interface_methods.CoreIResolvableDefConfig] = pydantic.Field(None)
    tags_config: typing.Optional[models.core.TagManagerDefConfig] = pydantic.Field(None)
...
class CfnStudioDef(BaseCfnResource):
    admin_role_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The IAM role that studio admins assume when logging in to the Nimble Studio portal.\n')
    display_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A friendly name for the studio.\n')
    studio_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the studio, as included in the URL when accessing it in the Nimble Studio portal.\n')
    user_role_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The IAM role that studio users assume when logging in to the Nimble Studio portal.\n')
    studio_encryption_configuration: typing.Union[models.UnsupportedResource, models.aws_nimblestudio.CfnStudio_StudioEncryptionConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Configuration of the encryption method that is used for the studio.\n')
    tags: typing.Optional[typing.Mapping[str, str]] = pydantic.Field(None, description='An array of key-value pairs to apply to this resource. For more information, see `Tag <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-resource-tags.html>`_ .')
    ...
    resource_config: typing.Optional[models.aws_nimblestudio.CfnStudioDefConfig] = pydantic.Field(None)


class CfnStudioDefConfig(pydantic.BaseModel):
    StudioEncryptionConfigurationProperty: typing.Optional[list[models.aws_nimblestudio.CfnStudioDefStudioencryptionconfigurationpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_nimblestudio.CfnStudioDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_nimblestudio.CfnStudioDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_nimblestudio.CfnStudioDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_nimblestudio.CfnStudioDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_nimblestudio.CfnStudioDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_nimblestudio.CfnStudioDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_nimblestudio.CfnStudioDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_nimblestudio.CfnStudioDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_nimblestudio.CfnStudioDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_nimblestudio.CfnStudioDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_nimblestudio.CfnStudioDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_nimblestudio.CfnStudioDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_nimblestudio.CfnStudioDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
    tags_config: typing.Optional[models.core.TagManagerDefConfig] = pydantic.Field(None)
...
class CfnStudioComponentDef(BaseCfnResource):
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A friendly name for the studio component resource.\n')
    studio_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The unique identifier for a studio resource. In Nimble Studio , all other resources are contained in a studio resource.\n')
    type: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The type of the studio component.\n')
    configuration: typing.Union[models.UnsupportedResource, models.aws_nimblestudio.CfnStudioComponent_StudioComponentConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The configuration of the studio component, based on component type.\n')
    ...
    initialization_scripts: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_nimblestudio.CfnStudioComponent_StudioComponentInitializationScriptPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='Initialization scripts for studio components.\n')
    runtime_role_arn: typing.Optional[str] = pydantic.Field(None, description='An IAM role attached to a Studio Component that gives the studio component access to AWS resources at anytime while the instance is running.\n')
    script_parameters: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_nimblestudio.CfnStudioComponent_ScriptParameterKeyValuePropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='Parameters for the studio component scripts.\n')
    secure_initialization_role_arn: typing.Optional[str] = pydantic.Field(None, description='An IAM role attached to Studio Component when the system initialization script runs which give the studio component access to AWS resources when the system initialization script runs.\n')
    subtype: typing.Optional[str] = pydantic.Field(None, description='The specific subtype of a studio component.\n')
    tags: typing.Optional[typing.Mapping[str, str]] = pydantic.Field(None, description='An array of key-value pairs to apply to this resource. For more information, see `Tag <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-resource-tags.html>`_ .')
    _init_params: typing.ClassVar[list[str]] = ['name', 'studio_id', 'type', 'configuration', 'description', 'ec2_security_group_ids', 'initialization_scripts', 'runtime_role_arn', 'script_parameters', 'secure_initialization_role_arn', 'subtype', 'tags']
    ...
    resource_config: typing.Optional[models.aws_nimblestudio.CfnStudioComponentDefConfig] = pydantic.Field(None)


class CfnStudioComponentDefConfig(pydantic.BaseModel):
    ActiveDirectoryComputerAttributeProperty: typing.Optional[list[models.aws_nimblestudio.CfnStudioComponentDefActivedirectorycomputerattributepropertyParams]] = pydantic.Field(None, description='')
    ActiveDirectoryConfigurationProperty: typing.Optional[list[models.aws_nimblestudio.CfnStudioComponentDefActivedirectoryconfigurationpropertyParams]] = pydantic.Field(None, description='')
    ComputeFarmConfigurationProperty: typing.Optional[list[models.aws_nimblestudio.CfnStudioComponentDefComputefarmconfigurationpropertyParams]] = pydantic.Field(None, description='')
    LicenseServiceConfigurationProperty: typing.Optional[list[models.aws_nimblestudio.CfnStudioComponentDefLicenseserviceconfigurationpropertyParams]] = pydantic.Field(None, description='')
    ScriptParameterKeyValueProperty: typing.Optional[list[models.aws_nimblestudio.CfnStudioComponentDefScriptparameterkeyvaluepropertyParams]] = pydantic.Field(None, description='')
    SharedFileSystemConfigurationProperty: typing.Optional[list[models.aws_nimblestudio.CfnStudioComponentDefSharedfilesystemconfigurationpropertyParams]] = pydantic.Field(None, description='')
    StudioComponentConfigurationProperty: typing.Optional[list[models.aws_nimblestudio.CfnStudioComponentDefStudiocomponentconfigurationpropertyParams]] = pydantic.Field(None, description='')
    StudioComponentInitializationScriptProperty: typing.Optional[list[models.aws_nimblestudio.CfnStudioComponentDefStudiocomponentinitializationscriptpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_nimblestudio.CfnStudioComponentDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_nimblestudio.CfnStudioComponentDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_nimblestudio.CfnStudioComponentDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_nimblestudio.CfnStudioComponentDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_nimblestudio.CfnStudioComponentDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_nimblestudio.CfnStudioComponentDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_nimblestudio.CfnStudioComponentDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_nimblestudio.CfnStudioComponentDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_nimblestudio.CfnStudioComponentDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_nimblestudio.CfnStudioComponentDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_nimblestudio.CfnStudioComponentDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_nimblestudio.CfnStudioComponentDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_nimblestudio.CfnStudioComponentDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
    tags_config: typing.Optional[models.core.TagManagerDefConfig] = pydantic.Field(None)
...
class CfnStudioComponentDefActivedirectoryconfigurationpropertyParams(pydantic.BaseModel):
    computer_attributes: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_nimblestudio.CfnStudioComponent_ActiveDirectoryComputerAttributePropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
...
class CfnStudioComponentDefStudiocomponentconfigurationpropertyParams(pydantic.BaseModel):
    active_directory_configuration: typing.Union[models.UnsupportedResource, models.aws_nimblestudio.CfnStudioComponent_ActiveDirectoryConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    compute_farm_configuration: typing.Union[models.UnsupportedResource, models.aws_nimblestudio.CfnStudioComponent_ComputeFarmConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    license_service_configuration: typing.Union[models.UnsupportedResource, models.aws_nimblestudio.CfnStudioComponent_LicenseServiceConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    shared_file_system_configuration: typing.Union[models.UnsupportedResource, models.aws_nimblestudio.CfnStudioComponent_SharedFileSystemConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class ModuleModel(pydantic.BaseModel):
    CfnLaunchProfile_StreamConfigurationProperty: typing.Optional[dict[str, models.aws_nimblestudio.CfnLaunchProfile_StreamConfigurationPropertyDef]] = pydantic.Field(None)
    CfnLaunchProfile_StreamConfigurationSessionBackupProperty: typing.Optional[dict[str, models.aws_nimblestudio.CfnLaunchProfile_StreamConfigurationSessionBackupPropertyDef]] = pydantic.Field(None)
    CfnLaunchProfile_StreamConfigurationSessionStorageProperty: typing.Optional[dict[str, models.aws_nimblestudio.CfnLaunchProfile_StreamConfigurationSessionStoragePropertyDef]] = pydantic.Field(None)
    CfnLaunchProfile_StreamingSessionStorageRootProperty: typing.Optional[dict[str, models.aws_nimblestudio.CfnLaunchProfile_StreamingSessionStorageRootPropertyDef]] = pydantic.Field(None)
    CfnLaunchProfile_VolumeConfigurationProperty: typing.Optional[dict[str, models.aws_nimblestudio.CfnLaunchProfile_VolumeConfigurationPropertyDef]] = pydantic.Field(None)
    CfnStreamingImage_StreamingImageEncryptionConfigurationProperty: typing.Optional[dict[str, models.aws_nimblestudio.CfnStreamingImage_StreamingImageEncryptionConfigurationPropertyDef]] = pydantic.Field(None)
    CfnStudio_StudioEncryptionConfigurationProperty: typing.Optional[dict[str, models.aws_nimblestudio.CfnStudio_StudioEncryptionConfigurationPropertyDef]] = pydantic.Field(None)
    CfnStudioComponent_ActiveDirectoryComputerAttributeProperty: typing.Optional[dict[str, models.aws_nimblestudio.CfnStudioComponent_ActiveDirectoryComputerAttributePropertyDef]] = pydantic.Field(None)
    CfnStudioComponent_ActiveDirectoryConfigurationProperty: typing.Optional[dict[str, models.aws_nimblestudio.CfnStudioComponent_ActiveDirectoryConfigurationPropertyDef]] = pydantic.Field(None)
    CfnStudioComponent_ComputeFarmConfigurationProperty: typing.Optional[dict[str, models.aws_nimblestudio.CfnStudioComponent_ComputeFarmConfigurationPropertyDef]] = pydantic.Field(None)
    CfnStudioComponent_LicenseServiceConfigurationProperty: typing.Optional[dict[str, models.aws_nimblestudio.CfnStudioComponent_LicenseServiceConfigurationPropertyDef]] = pydantic.Field(None)
    CfnStudioComponent_ScriptParameterKeyValueProperty: typing.Optional[dict[str, models.aws_nimblestudio.CfnStudioComponent_ScriptParameterKeyValuePropertyDef]] = pydantic.Field(None)
    CfnStudioComponent_SharedFileSystemConfigurationProperty: typing.Optional[dict[str, models.aws_nimblestudio.CfnStudioComponent_SharedFileSystemConfigurationPropertyDef]] = pydantic.Field(None)
    CfnStudioComponent_StudioComponentConfigurationProperty: typing.Optional[dict[str, models.aws_nimblestudio.CfnStudioComponent_StudioComponentConfigurationPropertyDef]] = pydantic.Field(None)
    CfnStudioComponent_StudioComponentInitializationScriptProperty: typing.Optional[dict[str, models.aws_nimblestudio.CfnStudioComponent_StudioComponentInitializationScriptPropertyDef]] = pydantic.Field(None)
    CfnLaunchProfile: typing.Optional[dict[str, models.aws_nimblestudio.CfnLaunchProfileDef]] = pydantic.Field(None)
    CfnStreamingImage: typing.Optional[dict[str, models.aws_nimblestudio.CfnStreamingImageDef]] = pydantic.Field(None)
    CfnStudio: typing.Optional[dict[str, models.aws_nimblestudio.CfnStudioDef]] = pydantic.Field(None)
    CfnStudioComponent: typing.Optional[dict[str, models.aws_nimblestudio.CfnStudioComponentDef]] = pydantic.Field(None)
    CfnLaunchProfileProps: typing.Optional[dict[str, models.aws_nimblestudio.CfnLaunchProfilePropsDef]] = pydantic.Field(None)
    CfnStreamingImageProps: typing.Optional[dict[str, models.aws_nimblestudio.CfnStreamingImagePropsDef]] = pydantic.Field(None)
    CfnStudioComponentProps: typing.Optional[dict[str, models.aws_nimblestudio.CfnStudioComponentPropsDef]] = pydantic.Field(None)
    CfnStudioProps: typing.Optional[dict[str, models.aws_nimblestudio.CfnStudioPropsDef]] = pydantic.Field(None)
    ...
