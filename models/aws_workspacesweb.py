...
class CfnPortalDef(BaseCfnResource):
    ...
    _init_params: typing.ClassVar[list[str]] = ['additional_encryption_context', 'authentication_type', 'browser_settings_arn', 'customer_managed_key', 'display_name', 'ip_access_settings_arn', 'network_settings_arn', 'tags', 'trust_store_arn', 'user_access_logging_settings_arn', 'user_settings_arn']
    _method_names: typing.ClassVar[list[str]] = ['add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnUserSettingsDef(BaseCfnResource):
    ...
    additional_encryption_context: typing.Union[models.UnsupportedResource, typing.Mapping[str, str], None] = pydantic.Field(None, description='')
    ...
    customer_managed_key: typing.Optional[str] = pydantic.Field(None, description='')
