...
class IncludedNestedStackDef(BaseStruct):
    included_template: models.cloudformation_include.CfnIncludeDef = pydantic.Field(..., description='The CfnInclude that represents the template, which can be used to access Resources and other template elements.\n')
    stack: models.NestedStackDef = pydantic.Field(..., description='The NestedStack object which represents the scope of the template.\n\n:exampleMetadata: infused\n\nExample::\n\n    # parent_template: cfn_inc.CfnInclude\n\n\n    included_child_stack = parent_template.get_nested_stack("ChildStack")\n    child_stack = included_child_stack.stack\n    child_template = included_child_stack.included_template\n')
