...
class AlexaSkillDeployActionDef(BaseClass):
    client_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The client id of the developer console token.')
    client_secret: typing.Union[models.SecretValueDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The client secret of the developer console token.\n')
    input: typing.Union[models.aws_codepipeline.ArtifactDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The source artifact containing the voice model and skill manifest.\n')
    refresh_token: typing.Union[models.SecretValueDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The refresh token of the developer console token.\n')
    skill_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Alexa skill id.\n')
...
class CacheControlDefConfig(pydantic.BaseModel):
    immutable: typing.Optional[list[models.aws_codepipeline_actions.CacheControlDefImmutableParams]] = pydantic.Field(None, description="The 'immutable' cache control directive.")
    ...
    must_understand: typing.Optional[list[models.aws_codepipeline_actions.CacheControlDefMustUnderstandParams]] = pydantic.Field(None, description="The 'must-understand' cache control directive.")
    ...
    no_store: typing.Optional[list[models.aws_codepipeline_actions.CacheControlDefNoStoreParams]] = pydantic.Field(None, description="The 'no-store' cache control directive.")
    ...
    stale_if_error: typing.Optional[list[models.aws_codepipeline_actions.CacheControlDefStaleIfErrorParams]] = pydantic.Field(None, description="The 'stale-if-error' cache control directive.")
    stale_while_revalidate: typing.Optional[list[models.aws_codepipeline_actions.CacheControlDefStaleWhileRevalidateParams]] = pydantic.Field(None, description="The 'stale-while-revalidate' cache control directive.")
...
class CloudFormationCreateReplaceChangeSetActionDef(BaseClass):
    admin_permissions: typing.Union[bool, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description="Whether to grant full permissions to CloudFormation while deploying this template. Setting this to ``true`` affects the defaults for ``role`` and ``capabilities``, if you don't specify any alternatives. The default role that will be created for you will have full (i.e., ``*``) permissions on all resources, and the deployment will have named IAM capabilities (i.e., able to create all IAM resources). This is a shorthand that you can use if you fully trust the templates that are deployed in this pipeline. If you want more fine-grained permissions, use ``addToRolePolicy`` and ``capabilities`` to control what the CloudFormation deployment is allowed to do.")
    change_set_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Name of the change set to create or update.\n')
    stack_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the stack to apply this action to.\n')
    template_path: typing.Union[models.aws_codepipeline.ArtifactPathDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description="Input artifact with the ChangeSet's CloudFormation template.\n")
...
class CloudFormationCreateUpdateStackActionDef(BaseClass):
    admin_permissions: typing.Union[bool, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description="Whether to grant full permissions to CloudFormation while deploying this template. Setting this to ``true`` affects the defaults for ``role`` and ``capabilities``, if you don't specify any alternatives. The default role that will be created for you will have full (i.e., ``*``) permissions on all resources, and the deployment will have named IAM capabilities (i.e., able to create all IAM resources). This is a shorthand that you can use if you fully trust the templates that are deployed in this pipeline. If you want more fine-grained permissions, use ``addToRolePolicy`` and ``capabilities`` to control what the CloudFormation deployment is allowed to do.")
    stack_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the stack to apply this action to.\n')
    template_path: typing.Union[models.aws_codepipeline.ArtifactPathDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Input artifact with the CloudFormation template to deploy.\n')
    account: typing.Optional[str] = pydantic.Field(None, description='The AWS account this Action is supposed to operate in. **Note**: if you specify the ``role`` property, this is ignored - the action will operate in the same region the passed role does. Default: - action resides in the same account as the pipeline\n')
    cfn_capabilities: typing.Optional[typing.Sequence[aws_cdk.CfnCapabilities]] = pydantic.Field(None, description='Acknowledge certain changes made as part of deployment. For stacks that contain certain resources, explicit acknowledgement is required that AWS CloudFormation might create or update those resources. For example, you must specify ``ANONYMOUS_IAM`` or ``NAMED_IAM`` if your stack template contains AWS Identity and Access Management (IAM) resources. For more information, see the link below. Default: None, unless ``adminPermissions`` is true\n')
    deployment_role: typing.Optional[typing.Union[models.aws_iam.LazyRoleDef, models.aws_iam.RoleDef]] = pydantic.Field(None, description='IAM role to assume when deploying changes. If not specified, a fresh role is created. The role is created with zero permissions unless ``adminPermissions`` is true, in which case the role will have full permissions. Default: A fresh role with full or no permissions (depending on the value of ``adminPermissions``).\n')
    extra_inputs: typing.Optional[typing.Sequence[models.aws_codepipeline.ArtifactDef]] = pydantic.Field(None, description='The list of additional input Artifacts for this Action. This is especially useful when used in conjunction with the ``parameterOverrides`` property. For example, if you have: parameterOverrides: { \'Param1\': action1.outputArtifact.bucketName, \'Param2\': action2.outputArtifact.objectKey, } , if the output Artifacts of ``action1`` and ``action2`` were not used to set either the ``templateConfiguration`` or the ``templatePath`` properties, you need to make sure to include them in the ``extraInputs`` - otherwise, you\'ll get an "unrecognized Artifact" error during your Pipeline\'s execution.\n')
...
class CloudFormationDeployStackInstancesActionDef(BaseClass):
    stack_instances: typing.Union[models.aws_codepipeline_actions.StackInstancesDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Specify where to create or update Stack Instances. You can specify either AWS Accounts Ids or AWS Organizations Organizational Units.')
    stack_set_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the StackSet we are adding instances to.\n')
...
class CloudFormationDeployStackSetActionDef(BaseClass):
    stack_set_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name to associate with the stack set. This name must be unique in the Region where it is created. The name may only contain alphanumeric and hyphen characters. It must begin with an alphabetic character and be 128 characters or fewer.')
    template: typing.Union[models.aws_codepipeline_actions.StackSetTemplateDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The location of the template that defines the resources in the stack set. This must point to a template with a maximum size of 460,800 bytes. Enter the path to the source artifact name and template file.\n')
...
class CloudFormationExecuteChangeSetActionDef(BaseClass):
    change_set_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Name of the change set to execute.')
    stack_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the stack to apply this action to.\n')
    account: typing.Optional[str] = pydantic.Field(None, description='The AWS account this Action is supposed to operate in. **Note**: if you specify the ``role`` property, this is ignored - the action will operate in the same region the passed role does. Default: - action resides in the same account as the pipeline\n')
    output: typing.Optional[models.aws_codepipeline.ArtifactDef] = pydantic.Field(None, description='The name of the output artifact to generate. Only applied if ``outputFileName`` is set as well. Default: Automatically generated artifact name.\n')
    output_file_name: typing.Optional[str] = pydantic.Field(None, description="A name for the filename in the output artifact to store the AWS CloudFormation call's result. The file will contain the result of the call to AWS CloudFormation (for example the call to UpdateStack or CreateChangeSet). AWS CodePipeline adds the file to the output artifact after performing the specified action. Default: No output artifact generated\n")
...
class CodeBuildActionDef(BaseClass):
    input: typing.Union[models.aws_codepipeline.ArtifactDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The source to use as input for this action.')
    project: typing.Union[_REQUIRED_INIT_PARAM, models.aws_codebuild.PipelineProjectDef, models.aws_codebuild.ProjectDef] = pydantic.Field(REQUIRED_INIT_PARAM, description="The action's Project.\n")
...
class CodeCommitSourceActionDef(BaseClass):
    output: typing.Union[models.aws_codepipeline.ArtifactDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='')
    repository: typing.Union[_REQUIRED_INIT_PARAM, models.aws_codecommit.RepositoryDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The CodeCommit repository.\n')
    ...
    run_order: typing.Union[int, float, None] = pydantic.Field(None, description='The runOrder property for this Action. RunOrder determines the relative order in which multiple Actions in the same Stage execute. Default: 1\n')
    variables_namespace: typing.Optional[str] = pydantic.Field(None, description="The name of the namespace to use for variables emitted by this action. Default: - a name will be generated, based on the stage and action names, if any of the action's variables were referenced - otherwise, no namespace will be set")
    _init_params: typing.ClassVar[list[str]] = ['output', 'repository', 'branch', 'code_build_clone_output', 'custom_event_rule', 'event_role', 'trigger', 'role', 'action_name', 'run_order', 'variables_namespace']
    _method_names: typing.ClassVar[list[str]] = ['bind', 'on_state_change']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CodeDeployEcsDeployActionDef(BaseClass):
    deployment_group: typing.Union[_REQUIRED_INIT_PARAM, models.aws_codedeploy.EcsDeploymentGroupDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The CodeDeploy ECS Deployment Group to deploy to.')
...
class CodeDeployServerDeployActionDef(BaseClass):
    deployment_group: typing.Union[_REQUIRED_INIT_PARAM, models.aws_codedeploy.ServerDeploymentGroupDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The CodeDeploy server Deployment Group to deploy to.')
    input: typing.Union[models.aws_codepipeline.ArtifactDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The source to use as input for deployment.\n')
    role: typing.Optional[typing.Union[models.aws_iam.LazyRoleDef, models.aws_iam.RoleDef]] = pydantic.Field(None, description="The Role in which context's this Action will be executing in. The Pipeline's Role will assume this Role (the required permissions for that will be granted automatically) right before executing this Action. This Action will be passed into your ``IAction.bind`` method in the ``ActionBindOptions.role`` property. Default: a new Role will be generated\n")
    action_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The physical, human-readable name of the Action. Note that Action names must be unique within a single Stage.\n')
    run_order: typing.Union[int, float, None] = pydantic.Field(None, description='The runOrder property for this Action. RunOrder determines the relative order in which multiple Actions in the same Stage execute. Default: 1\n')
    variables_namespace: typing.Optional[str] = pydantic.Field(None, description="The name of the namespace to use for variables emitted by this action. Default: - a name will be generated, based on the stage and action names, if any of the action's variables were referenced - otherwise, no namespace will be set")
...
class CodeStarConnectionsSourceActionDef(BaseClass):
    connection_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The ARN of the CodeStar Connection created in the AWS console that has permissions to access this GitHub or BitBucket repository.')
    output: typing.Union[models.aws_codepipeline.ArtifactDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The output artifact that this action produces. Can be used as input for further pipeline actions.\n')
    owner: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The owning user or organization of the repository.\n')
    repo: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the repository.\n')
...
class EcrSourceActionDef(BaseClass):
    output: typing.Union[models.aws_codepipeline.ArtifactDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='')
    repository: typing.Union[_REQUIRED_INIT_PARAM, models.aws_ecr.RepositoryBaseDef, models.aws_ecr.RepositoryDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The repository that will be watched for changes.\n')
...
class EcsDeployActionDef(BaseClass):
    service: typing.Union[_REQUIRED_INIT_PARAM, models.aws_ecs.BaseServiceDef, models.aws_ecs.Ec2ServiceDef, models.aws_ecs.ExternalServiceDef, models.aws_ecs.FargateServiceDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The ECS Service to deploy.')
...
class ElasticBeanstalkDeployActionDef(BaseClass):
    application_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the AWS Elastic Beanstalk application to deploy.')
    environment_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the AWS Elastic Beanstalk environment to deploy to.\n')
    input: typing.Union[models.aws_codepipeline.ArtifactDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The source to use as input for deployment.\n')
    role: typing.Optional[typing.Union[models.aws_iam.LazyRoleDef, models.aws_iam.RoleDef]] = pydantic.Field(None, description="The Role in which context's this Action will be executing in. The Pipeline's Role will assume this Role (the required permissions for that will be granted automatically) right before executing this Action. This Action will be passed into your ``IAction.bind`` method in the ``ActionBindOptions.role`` property. Default: a new Role will be generated\n")
    action_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The physical, human-readable name of the Action. Note that Action names must be unique within a single Stage.\n')
    run_order: typing.Union[int, float, None] = pydantic.Field(None, description='The runOrder property for this Action. RunOrder determines the relative order in which multiple Actions in the same Stage execute. Default: 1\n')
...
class JenkinsActionDef(BaseClass):
    jenkins_provider: typing.Union[_REQUIRED_INIT_PARAM, models.aws_codepipeline_actions.BaseJenkinsProviderDef, models.aws_codepipeline_actions.JenkinsProviderDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Jenkins Provider for this Action.')
    project_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the project (sometimes also called job, or task) on your Jenkins installation that will be invoked by this Action.\n')
    type: typing.Union[aws_cdk.aws_codepipeline_actions.JenkinsActionType, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The type of the Action - Build, or Test.\n')
...
class ManualApprovalActionDefGrantManualApprovalParams(pydantic.BaseModel):
    grantable: models.AnyResource = pydantic.Field(..., description='the grantable to attach the permissions to.')
    ...
...
class S3DeployActionDef(BaseClass):
    bucket: typing.Union[_REQUIRED_INIT_PARAM, models.aws_s3.BucketBaseDef, models.aws_s3.BucketDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Amazon S3 bucket that is the deploy target.')
    input: typing.Union[models.aws_codepipeline.ArtifactDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The input Artifact to deploy to Amazon S3.\n')
...
class S3SourceActionDef(BaseClass):
    bucket: typing.Union[_REQUIRED_INIT_PARAM, models.aws_s3.BucketBaseDef, models.aws_s3.BucketDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Amazon S3 bucket that stores the source code. If you import an encrypted bucket in your stack, please specify the encryption key at import time by using ``Bucket.fromBucketAttributes()`` method.')
    bucket_key: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The key within the S3 bucket that stores the source code.\n')
    output: typing.Union[models.aws_codepipeline.ArtifactDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='')
...
class ServiceCatalogDeployActionBeta1Def(BaseClass):
    product_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The identifier of the product in the Service Catalog. This product must already exist.')
    product_version_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the version of the Service Catalog product to be deployed.\n')
    template_path: typing.Union[models.aws_codepipeline.ArtifactPathDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The path to the cloudformation artifact.\n')
...
class StepFunctionInvokeActionDef(BaseClass):
    state_machine: typing.Union[_REQUIRED_INIT_PARAM, models.aws_stepfunctions.StateMachineDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The state machine to invoke.')
...
class JenkinsProviderDef(BaseConstruct):
    provider_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the Jenkins provider that you set in the AWS CodePipeline plugin configuration of your Jenkins project.\n')
    server_url: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The base URL of your Jenkins server.\n')
...
class CodeCommitSourceActionPropsDef(BaseStruct):
    ...
    event_role: typing.Optional[typing.Union[models.aws_iam.LazyRoleDef, models.aws_iam.RoleDef]] = pydantic.Field(None, description='Role to be used by on commit event rule. Used only when trigger value is CodeCommitTrigger.EVENTS. Default: a new role will be created.\n')
    trigger: typing.Optional[aws_cdk.aws_codepipeline_actions.CodeCommitTrigger] = pydantic.Field(None, description='How should CodePipeline detect source changes for this Action. Default: CodeCommitTrigger.EVENTS\n\n:exampleMetadata: lit=aws-codepipeline-actions/test/integ.cfn-template-from-repo.lit.ts infused\n\nExample::\n\n    # Source stage: read from repository\n    repo = codecommit.Repository(stack, "TemplateRepo",\n        repository_name="template-repo"\n    )\n    source_output = codepipeline.Artifact("SourceArtifact")\n    source = cpactions.CodeCommitSourceAction(\n        action_name="Source",\n        repository=repo,\n        output=source_output,\n        trigger=cpactions.CodeCommitTrigger.POLL\n    )\n    source_stage = {\n        "stage_name": "Source",\n        "actions": [source]\n    }\n\n    # Deployment stage: create and deploy changeset with manual approval\n    stack_name = "OurStack"\n    change_set_name = "StagedChangeSet"\n\n    prod_stage = {\n        "stage_name": "Deploy",\n        "actions": [\n            cpactions.CloudFormationCreateReplaceChangeSetAction(\n                action_name="PrepareChanges",\n                stack_name=stack_name,\n                change_set_name=change_set_name,\n                admin_permissions=True,\n                template_path=source_output.at_path("template.yaml"),\n                run_order=1\n            ),\n            cpactions.ManualApprovalAction(\n                action_name="ApproveChanges",\n                run_order=2\n            ),\n            cpactions.CloudFormationExecuteChangeSetAction(\n                action_name="ExecuteChanges",\n                stack_name=stack_name,\n                change_set_name=change_set_name,\n                run_order=3\n            )\n        ]\n    }\n\n    codepipeline.Pipeline(stack, "Pipeline",\n        cross_account_keys=True,\n        stages=[source_stage, prod_stage\n        ]\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['action_name', 'run_order', 'variables_namespace', 'role', 'output', 'repository', 'branch', 'code_build_clone_output', 'custom_event_rule', 'event_role', 'trigger']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CodeCommitSourceVariablesDef(BaseStruct):
    author_date: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The date the currently last commit on the tracked branch was authored, in ISO-8601 format.\n')
    branch_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the branch this action tracks.\n')
    commit_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The SHA1 hash of the currently last commit on the tracked branch.\n')
    commit_message: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The message of the currently last commit on the tracked branch.\n')
    committer_date: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The date the currently last commit on the tracked branch was committed, in ISO-8601 format.\n')
    repository_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the repository this action points to.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_codepipeline_actions as codepipeline_actions\n\n    code_commit_source_variables = codepipeline_actions.CodeCommitSourceVariables(\n        author_date="authorDate",\n        branch_name="branchName",\n        commit_id="commitId",\n        commit_message="commitMessage",\n        committer_date="committerDate",\n        repository_name="repositoryName"\n    )\n')
...
class CodeDeployEcsContainerImageInputDef(BaseStruct):
    input: typing.Union[models.aws_codepipeline.ArtifactDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The artifact that contains an ``imageDetails.json`` file with the image URI. The artifact\'s ``imageDetails.json`` file must be a JSON file containing an ``ImageURI`` property. For example: ``{ "ImageURI": "ACCOUNTID.dkr.ecr.us-west-2.amazonaws.com/dk-image-repo@sha256:example3" }``\n')
...
class CodeStarSourceVariablesDef(BaseStruct):
    ...
    commit_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The SHA1 hash of the currently last commit on the tracked branch.\n')
    commit_message: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The message of the currently last commit on the tracked branch.\n')
    connection_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The connection ARN this source uses.\n')
    full_repository_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the repository this action points to.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_codepipeline_actions as codepipeline_actions\n\n    code_star_source_variables = codepipeline_actions.CodeStarSourceVariables(\n        author_date="authorDate",\n        branch_name="branchName",\n        commit_id="commitId",\n        commit_message="commitMessage",\n        connection_arn="connectionArn",\n        full_repository_name="fullRepositoryName"\n    )\n')
...
class EcrSourceVariablesDef(BaseStruct):
    image_digest: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description="The digest of the current image, in the form ':'.\n")
    image_tag: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Docker tag of the current image.\n')
    image_uri: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The full ECR Docker URI of the current image.\n')
    registry_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The identifier of the registry. In ECR, this is usually the ID of the AWS account owning it.\n')
    repository_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The physical name of the repository that this action tracks.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_codepipeline_actions as codepipeline_actions\n\n    ecr_source_variables = codepipeline_actions.EcrSourceVariables(\n        image_digest="imageDigest",\n        image_tag="imageTag",\n        image_uri="imageUri",\n        registry_id="registryId",\n        repository_name="repositoryName"\n    )\n')
...
class GitHubSourceVariablesDef(BaseStruct):
    ...
    commit_message: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The message of the currently last commit on the tracked branch.\n')
    committer_date: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The date the currently last commit on the tracked branch was committed, in ISO-8601 format.\n')
    commit_url: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The GitHub API URL of the currently last commit on the tracked branch.\n')
...
class S3SourceVariablesDef(BaseStruct):
    e_tag: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The e-tag of the S3 version of the object that triggered the build.\n')
    version_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The identifier of the S3 version of the object that triggered the build.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_codepipeline_actions as codepipeline_actions\n\n    s3_source_variables = codepipeline_actions.S3SourceVariables(\n        e_tag="eTag",\n        version_id="versionId"\n    )\n')
...
#  autogenerated from aws_cdk.aws_codepipeline_actions.ICustomEventRule
#  skipping Interface
