...
class LustreMaintenanceTimeDef(BaseClass):
    ...
    hour: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The hour of the day (from 0-24) for maintenance to be performed.\n')
...
class CfnVolume_OntapConfigurationPropertyDef(BaseStruct):
    size_in_megabytes: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Specifies the size of the volume, in megabytes (MB), that you are creating.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['size_in_megabytes', 'storage_virtual_machine_id', 'copy_tags_to_backups', 'junction_path', 'ontap_volume_type', 'security_style', 'snaplock_configuration', 'snapshot_policy', 'storage_efficiency_enabled', 'tiering_policy']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnVolume_UserAndGroupQuotasPropertyDef(BaseStruct):
    storage_capacity_quota_gib: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The amount of storage that the user or group can use in gibibytes (GiB).\n')
    type: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A value that specifies whether the quota applies to a user or group.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-volume-userandgroupquotas.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_fsx as fsx\n\n    user_and_group_quotas_property = fsx.CfnVolume.UserAndGroupQuotasProperty(\n        id=123,\n        storage_capacity_quota_gi_b=123,\n        type="type"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['storage_capacity_quota_gib', 'type']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnVolumeDefConfig(pydantic.BaseModel):
    AutocommitPeriodProperty: typing.Optional[list[CfnVolumeDefAutocommitperiodpropertyParams]] = pydantic.Field(None, description='')
    ...
    RetentionPeriodProperty: typing.Optional[list[CfnVolumeDefRetentionperiodpropertyParams]] = pydantic.Field(None, description='')
    SnaplockConfigurationProperty: typing.Optional[list[CfnVolumeDefSnaplockconfigurationpropertyParams]] = pydantic.Field(None, description='')
    SnaplockRetentionPeriodProperty: typing.Optional[list[CfnVolumeDefSnaplockretentionperiodpropertyParams]] = pydantic.Field(None, description='')
...
class ModuleModel(pydantic.BaseModel):
    ...
    CfnVolume_AutocommitPeriodProperty: typing.Optional[dict[str, CfnVolume_AutocommitPeriodPropertyDef]] = pydantic.Field(None)
    ...
    CfnVolume_RetentionPeriodProperty: typing.Optional[dict[str, CfnVolume_RetentionPeriodPropertyDef]] = pydantic.Field(None)
    CfnVolume_SnaplockConfigurationProperty: typing.Optional[dict[str, CfnVolume_SnaplockConfigurationPropertyDef]] = pydantic.Field(None)
    CfnVolume_SnaplockRetentionPeriodProperty: typing.Optional[dict[str, CfnVolume_SnaplockRetentionPeriodPropertyDef]] = pydantic.Field(None)
