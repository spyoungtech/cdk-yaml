...
class AccountPrincipalDef(BaseClass):
    account_id: typing.Any = pydantic.Field(..., description="AWS account ID (i.e. '123456789012').")
...
class ArnPrincipalDef(BaseClass):
    arn: str = pydantic.Field(..., description='Amazon Resource Name (ARN) of the principal entity (i.e. arn:aws:iam::123456789012:user/user-name).')
...
class CanonicalUserPrincipalDef(BaseClass):
    canonical_user_id: str = pydantic.Field(..., description='unique identifier assigned by AWS for every account. root user and IAM users for an account all see the same ID. (i.e. 79a59df900b949e55d96a1e698fbacedfd6e09d98eacf8f8d5218e7cd47ef2be)')
...
class CompositeDependableDef(BaseClass):
    dependables: list[typing.Union[models.aws_iam.CompositeDependableDef, models.aws_iam.GrantDef, models.constructs.DependencyGroupDef]] = pydantic.Field(...)
...
class FederatedPrincipalDef(BaseClass):
    federated: str = pydantic.Field(..., description="federated identity provider (i.e. 'cognito-identity.amazonaws.com' for users authenticated through Cognito).")
...
class GrantDefDropParams(pydantic.BaseModel):
    grantee: typing.Union[models.aws_appsync.BackedDataSourceDef, models.aws_appsync.DynamoDbDataSourceDef, models.aws_appsync.ElasticsearchDataSourceDef, models.aws_appsync.EventBridgeDataSourceDef, models.aws_appsync.HttpDataSourceDef, models.aws_appsync.LambdaDataSourceDef, models.aws_appsync.OpenSearchDataSourceDef, models.aws_appsync.RdsDataSourceDef, models.aws_backup.BackupSelectionDef, models.aws_codebuild.UntrustedCodeBoundaryPolicyDef, models.aws_ec2.LaunchTemplateDef, models.aws_iam.ManagedPolicyDef, models.aws_iam.PolicyDef, models.aws_stepfunctions_tasks.EmrContainersStartJobRunDef, models.aws_stepfunctions_tasks.SageMakerCreateModelDef, models.aws_stepfunctions_tasks.SageMakerCreateTrainingJobDef, models.custom_resources.AwsCustomResourceDef] = pydantic.Field(..., description='The intended grantee.\n')
...
class OpenIdConnectPrincipalDef(BaseClass):
    open_id_connect_provider: typing.Union[models.aws_eks.OpenIdConnectProviderDef, models.aws_iam.OpenIdConnectProviderDef] = pydantic.Field(..., description='OpenID Connect provider.')
...
class OrganizationPrincipalDef(BaseClass):
    organization_id: str = pydantic.Field(..., description='The unique identifier (ID) of an organization (i.e. o-12345abcde).')
...
class PrincipalPolicyFragmentDef(BaseClass):
    principal_json: typing.Mapping[str, typing.Sequence[str]] = pydantic.Field(..., description='JSON of the "Principal" section in a policy statement.')
...
class PrincipalWithConditionsDef(BaseClass):
    principal: typing.Union[models.aws_eks.ServiceAccountDef, models.aws_iam.UnknownPrincipalDef] = pydantic.Field(..., description='-')
    conditions: typing.Mapping[str, typing.Any] = pydantic.Field(..., description='-')
...
class SamlPrincipalDef(BaseClass):
    saml_provider: typing.Union[models.aws_iam.SamlProviderDef] = pydantic.Field(..., description='-')
    conditions: typing.Mapping[str, typing.Any] = pydantic.Field(..., description='The conditions under which the policy is in effect.')
    _init_params: typing.ClassVar[list[str]] = ['saml_provider', 'conditions']
    _method_names: typing.ClassVar[list[str]] = ['add_to_assume_role_policy', 'add_to_policy', 'add_to_principal_policy', 'dedupe_string', 'with_conditions', 'with_session_tags']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class ServicePrincipalDef(BaseClass):
    service: str = pydantic.Field(..., description='AWS service (i.e. sqs.amazonaws.com).\n')
    conditions: typing.Optional[typing.Mapping[str, typing.Any]] = pydantic.Field(None, description='Additional conditions to add to the Service Principal. Default: - No conditions\n')
    region: typing.Optional[str] = pydantic.Field(None, description="The region in which you want to reference the service. This is only necessary for *cross-region* references to *opt-in* regions. In those cases, the region name needs to be included to reference the correct service principal. In all other cases, the global service principal name is sufficient. This field behaves differently depending on whether the ``@aws-cdk/aws-iam:standardizedServicePrincipals`` flag is set or not: - If the flag is set, the input service principal is assumed to be of the form ``SERVICE.amazonaws.com``. That value will always be returned, unless the given region is an opt-in region and the service principal is rendered in a stack in a different region, in which case ``SERVICE.REGION.amazonaws.com`` will be rendered. Under this regime, there is no downside to always specifying the region property: it will be rendered only if necessary. - If the flag is not set, the service principal will resolve to a single principal whose name comes from the ``@aws-cdk/region-info`` package, using the region to override the stack region. If there is no entry for this service principal in the database,, the input service name is returned literally. This is legacy behavior and is not recommended. Default: - the resolving Stack's region.")
...
class UnknownPrincipalDef(BaseClass):
    resource: models.AnyResource = pydantic.Field(..., description='The resource the role proxy is for.')
...
class WebIdentityPrincipalDef(BaseClass):
    identity_provider: str = pydantic.Field(..., description="identity provider (i.e. 'cognito-identity.amazonaws.com' for users authenticated through Cognito).")
    conditions: typing.Optional[typing.Mapping[str, typing.Any]] = pydantic.Field(None, description='The conditions under which the policy is in effect. See `the IAM documentation <https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_elements_condition.html>`_.')
...
class AccessKeyDef(BaseConstruct):
    user: typing.Union[models.aws_iam.UserDef] = pydantic.Field(..., description='The IAM user this key will belong to. Changing this value will result in the access key being deleted and a new access key (with a different ID and secret value) being assigned to the new user.\n')
...
class LazyRoleDef(BaseConstruct):
    assumed_by: typing.Union[models.aws_eks.ServiceAccountDef, models.aws_iam.UnknownPrincipalDef] = pydantic.Field(..., description="The IAM principal (i.e. ``new ServicePrincipal('sns.amazonaws.com')``) which can assume this role. You can later modify the assume role policy document by accessing it via the ``assumeRolePolicy`` property.\n")
...
class SamlProviderDef(BaseConstruct):
    metadata_document: models.aws_iam.SamlMetadataDocumentDef = pydantic.Field(..., description="An XML document generated by an identity provider (IdP) that supports SAML 2.0. The document includes the issuer's name, expiration information, and keys that can be used to validate the SAML authentication response (assertions) that are received from the IdP. You must generate the metadata document using the identity management software that is used as your organization's IdP.\n")
...
class AddToPrincipalPolicyResultDef(BaseStruct):
    statement_added: bool = pydantic.Field(..., description="Whether the statement was added to the identity's policies.\n")
    policy_dependable: typing.Optional[typing.Union[models.aws_iam.CompositeDependableDef, models.aws_iam.GrantDef, models.constructs.DependencyGroupDef]] = pydantic.Field(None, description='Dependable which allows depending on the policy change being applied. Default: - Required if ``statementAdded`` is true.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_iam as iam\n    import constructs as constructs\n\n    # dependable: constructs.IDependable\n\n    add_to_principal_policy_result = iam.AddToPrincipalPolicyResult(\n        statement_added=False,\n\n        # the properties below are optional\n        policy_dependable=dependable\n    )\n')
...
class AddToResourcePolicyResultDef(BaseStruct):
    statement_added: bool = pydantic.Field(..., description='Whether the statement was added.\n')
    policy_dependable: typing.Optional[typing.Union[models.aws_iam.CompositeDependableDef, models.aws_iam.GrantDef, models.constructs.DependencyGroupDef]] = pydantic.Field(None, description='Dependable which allows depending on the policy change being applied. Default: - If ``statementAdded`` is true, the resource object itself. Otherwise, no dependable.\n\n:exampleMetadata: infused\n\nExample::\n\n    bucket = s3.Bucket.from_bucket_name(self, "existingBucket", "bucket-name")\n\n    # No policy statement will be added to the resource\n    result = bucket.add_to_resource_policy(\n        iam.PolicyStatement(\n            actions=["s3:GetObject"],\n            resources=[bucket.arn_for_objects("file.txt")],\n            principals=[iam.AccountRootPrincipal()]\n        ))\n')
    _init_params: typing.ClassVar[list[str]] = ['statement_added', 'policy_dependable']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnGroup_PolicyPropertyDef(BaseStruct):
    policy_document: typing.Any = pydantic.Field(..., description='The policy document.\n')
    policy_name: str = pydantic.Field(..., description='The friendly name (not ARN) identifying the policy.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iam-policy.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_iam as iam\n\n    # policy_document: Any\n\n    policy_property = iam.CfnGroup.PolicyProperty(\n        policy_document=policy_document,\n        policy_name="policyName"\n    )\n')
...
class CfnRole_PolicyPropertyDef(BaseStruct):
    policy_document: typing.Any = pydantic.Field(..., description='The entire contents of the policy that defines permissions. For more information, see `Overview of JSON policies <https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies.html#access_policies-json>`_ .\n')
...
class CfnUser_LoginProfilePropertyDef(BaseStruct):
    password: str = pydantic.Field(..., description="The user's password.\n")
    password_reset_required: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description='Specifies whether the user is required to set a new password on next sign-in.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iam-user-loginprofile.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_iam as iam\n\n    login_profile_property = iam.CfnUser.LoginProfileProperty(\n        password="password",\n\n        # the properties below are optional\n        password_reset_required=False\n    )\n')
...
class CfnGroupDef(BaseCfnResource):
    ...
    policies: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iam.CfnGroup_PolicyPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description="Adds or updates an inline policy document that is embedded in the specified IAM group. To view AWS::IAM::Group snippets, see `Declaring an IAM Group Resource <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/quickref-iam.html#scenario-iam-group>`_ . .. epigraph:: The name of each inline policy for a role, user, or group must be unique. If you don't choose unique names, updates to the IAM identity will fail. For information about limits on the number of inline policies that you can embed in a group, see `Limitations on IAM Entities <https://docs.aws.amazon.com/IAM/latest/UserGuide/LimitationsOnEntities.html>`_ in the *IAM User Guide* .")
...
class CfnInstanceProfileDef(BaseCfnResource):
    roles: typing.Sequence[str] = pydantic.Field(..., description='The name of the role to associate with the instance profile. Only one role can be assigned to an EC2 instance at a time, and all applications on the instance share the same role and permissions.\n')
...
class CfnOIDCProviderDef(BaseCfnResource):
    thumbprint_list: typing.Sequence[str] = pydantic.Field(..., description='A list of certificate thumbprints that are associated with the specified IAM OIDC provider resource object. For more information, see `CreateOpenIDConnectProvider <https://docs.aws.amazon.com/IAM/latest/APIReference/API_CreateOpenIDConnectProvider.html>`_ .\n')
...
class CfnPolicyDef(BaseCfnResource):
    policy_document: typing.Any = pydantic.Field(..., description='The policy document. You must provide policies in JSON format in IAM. However, for AWS CloudFormation templates formatted in YAML, you can provide the policy in JSON or YAML format. AWS CloudFormation always converts a YAML policy to JSON format before submitting it to IAM. The `regex pattern <https://docs.aws.amazon.com/http://wikipedia.org/wiki/regex>`_ used to validate this parameter is a string of characters consisting of the following: - Any printable ASCII character ranging from the space character ( ``\\ u0020`` ) through the end of the ASCII character range - The printable characters in the Basic Latin and Latin-1 Supplement character set (through ``\\ u00FF`` ) - The special characters tab ( ``\\ u0009`` ), line feed ( ``\\ u000A`` ), and carriage return ( ``\\ u000D`` )\n')
    policy_name: str = pydantic.Field(..., description='The name of the policy document. This parameter allows (through its `regex pattern <https://docs.aws.amazon.com/http://wikipedia.org/wiki/regex>`_ ) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-\n')
...
class CfnRoleDef(BaseCfnResource):
    ...
    policies: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_iam.CfnRole_PolicyPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description="Adds or updates an inline policy document that is embedded in the specified IAM role. When you embed an inline policy in a role, the inline policy is used as part of the role's access (permissions) policy. The role's trust policy is created at the same time as the role. You can update a role's trust policy later. For more information about IAM roles, go to `Using Roles to Delegate Permissions and Federate Identities <https://docs.aws.amazon.com/IAM/latest/UserGuide/roles-toplevel.html>`_ . A role can also have an attached managed policy. For information about policies, see `Managed Policies and Inline Policies <https://docs.aws.amazon.com/IAM/latest/UserGuide/policies-managed-vs-inline.html>`_ in the *IAM User Guide* . For information about limits on the number of inline policies that you can embed with a role, see `Limitations on IAM Entities <https://docs.aws.amazon.com/IAM/latest/UserGuide/LimitationsOnEntities.html>`_ in the *IAM User Guide* . .. epigraph:: If an external policy (such as ``AWS::IAM::Policy`` or ``AWS::IAM::ManagedPolicy`` ) has a ``Ref`` to a role and if a resource (such as ``AWS::ECS::Service`` ) also has a ``Ref`` to the same role, add a ``DependsOn`` attribute to the resource to make the resource depend on the external policy. This dependency ensures that the role's policy is available throughout the resource's lifecycle. For example, when you delete a stack with an ``AWS::ECS::Service`` resource, the ``DependsOn`` attribute ensures that AWS CloudFormation deletes the ``AWS::ECS::Service`` resource before deleting its role's policy.\n")
...
class CfnServiceLinkedRoleDef(BaseCfnResource):
    aws_service_name: str = pydantic.Field(..., description='The service principal for the AWS service to which this role is attached. You use a string similar to a URL but without the http:// in front. For example: ``elasticbeanstalk.amazonaws.com`` . Service principals are unique and case-sensitive. To find the exact service principal for your service-linked role, see `AWS services that work with IAM <https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-services-that-work-with-iam.html>`_ in the *IAM User Guide* . Look for the services that have *Yes* in the *Service-Linked Role* column. Choose the *Yes* link to view the service-linked role documentation for that service.\n')
...
class CfnUserToGroupAdditionDef(BaseCfnResource):
    group_name: str = pydantic.Field(..., description='The name of the group to update. This parameter allows (through its `regex pattern <https://docs.aws.amazon.com/http://wikipedia.org/wiki/regex>`_ ) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-\n')
    users: typing.Sequence[str] = pydantic.Field(..., description='A list of the names of the users that you want to add to the group.')
...
class CfnVirtualMFADeviceDef(BaseCfnResource):
    users: typing.Sequence[str] = pydantic.Field(..., description='The IAM user associated with this virtual MFA device.\n')
