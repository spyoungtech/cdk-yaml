...
class CfnAccessPoint_ContentTransformationPropertyDef(BaseStruct):
    aws_lambda: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3objectlambda.CfnAccessPoint_AwsLambdaPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='``CfnAccessPoint.ContentTransformationProperty.AwsLambda``.')
...
class CfnAccessPoint_ObjectLambdaConfigurationPropertyDef(BaseStruct):
    supporting_access_point: str = pydantic.Field(..., description='Standard access point associated with the Object Lambda Access Point.\n')
    transformation_configurations: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3objectlambda.CfnAccessPoint_TransformationConfigurationPropertyDef, dict[str, typing.Any]]]] = pydantic.Field(..., description='A container for transformation configurations for an Object Lambda Access Point.\n')
...
class CfnAccessPoint_PolicyStatusPropertyDef(BaseStruct):
    is_public: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description='``CfnAccessPoint.PolicyStatusProperty.IsPublic``.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3objectlambda-accesspoint-policystatus.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3objectlambda as s3objectlambda\n\n    policy_status_property = s3objectlambda.CfnAccessPoint.PolicyStatusProperty(\n        is_public=False\n    )\n')
...
class CfnAccessPoint_PublicAccessBlockConfigurationPropertyDef(BaseStruct):
    block_public_acls: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description="Specifies whether Amazon S3 should block public access control lists (ACLs) for buckets in this account. Setting this element to ``TRUE`` causes the following behavior: - ``PutBucketAcl`` and ``PutObjectAcl`` calls fail if the specified ACL is public. - PUT Object calls fail if the request includes a public ACL. - PUT Bucket calls fail if the request includes a public ACL. Enabling this setting doesn't affect existing policies or ACLs. This property is not supported for Amazon S3 on Outposts.\n")
    block_public_policy: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description="Specifies whether Amazon S3 should block public bucket policies for buckets in this account. Setting this element to ``TRUE`` causes Amazon S3 to reject calls to PUT Bucket policy if the specified bucket policy allows public access. Enabling this setting doesn't affect existing bucket policies. This property is not supported for Amazon S3 on Outposts.\n")
    ignore_public_acls: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description="Specifies whether Amazon S3 should ignore public ACLs for buckets in this account. Setting this element to ``TRUE`` causes Amazon S3 to ignore all public ACLs on buckets in this account and any objects that they contain. Enabling this setting doesn't affect the persistence of any existing ACLs and doesn't prevent new public ACLs from being set. This property is not supported for Amazon S3 on Outposts.\n")
...
class CfnAccessPointDef(BaseCfnResource):
    object_lambda_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3objectlambda.CfnAccessPoint_ObjectLambdaConfigurationPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='A configuration used when creating an Object Lambda Access Point.\n')
...
class CfnAccessPointDefConfig(pydantic.BaseModel):
    AliasProperty: typing.Optional[list[CfnAccessPointDefAliaspropertyParams]] = pydantic.Field(None, description='')
    AwsLambdaProperty: typing.Optional[list[CfnAccessPointDefAwslambdapropertyParams]] = pydantic.Field(None, description='')
    ContentTransformationProperty: typing.Optional[list[CfnAccessPointDefContenttransformationpropertyParams]] = pydantic.Field(None, description='')
    ObjectLambdaConfigurationProperty: typing.Optional[list[CfnAccessPointDefObjectlambdaconfigurationpropertyParams]] = pydantic.Field(None, description='')
    PolicyStatusProperty: typing.Optional[list[CfnAccessPointDefPolicystatuspropertyParams]] = pydantic.Field(None, description='')
    ...
    TransformationConfigurationProperty: typing.Optional[list[CfnAccessPointDefTransformationconfigurationpropertyParams]] = pydantic.Field(None, description='')
...
class CfnAccessPointDefContenttransformationpropertyParams(pydantic.BaseModel):
    aws_lambda: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3objectlambda.CfnAccessPoint_AwsLambdaPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    ...
...
class CfnAccessPointPolicyDef(BaseCfnResource):
    object_lambda_access_point: str = pydantic.Field(..., description='An access point with an attached AWS Lambda function used to access transformed data from an Amazon S3 bucket.\n')
    policy_document: typing.Any = pydantic.Field(..., description='Object Lambda Access Point resource policy document.')
    ...
    resource_config: typing.Optional[CfnAccessPointPolicyDefConfig] = pydantic.Field(None)


class CfnAccessPointPolicyDefConfig(pydantic.BaseModel):
    add_deletion_override: typing.Optional[list[CfnAccessPointPolicyDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[CfnAccessPointPolicyDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[CfnAccessPointPolicyDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[CfnAccessPointPolicyDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[CfnAccessPointPolicyDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[CfnAccessPointPolicyDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[CfnAccessPointPolicyDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[CfnAccessPointPolicyDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[CfnAccessPointPolicyDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[CfnAccessPointPolicyDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[CfnAccessPointPolicyDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[CfnAccessPointPolicyDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[CfnAccessPointPolicyDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
class ModuleModel(pydantic.BaseModel):
    CfnAccessPoint_AliasProperty: typing.Optional[dict[str, CfnAccessPoint_AliasPropertyDef]] = pydantic.Field(None)
    CfnAccessPoint_AwsLambdaProperty: typing.Optional[dict[str, CfnAccessPoint_AwsLambdaPropertyDef]] = pydantic.Field(None)
    CfnAccessPoint_ContentTransformationProperty: typing.Optional[dict[str, CfnAccessPoint_ContentTransformationPropertyDef]] = pydantic.Field(None)
    CfnAccessPoint_ObjectLambdaConfigurationProperty: typing.Optional[dict[str, CfnAccessPoint_ObjectLambdaConfigurationPropertyDef]] = pydantic.Field(None)
    CfnAccessPoint_PolicyStatusProperty: typing.Optional[dict[str, CfnAccessPoint_PolicyStatusPropertyDef]] = pydantic.Field(None)
    ...
    CfnAccessPoint_TransformationConfigurationProperty: typing.Optional[dict[str, CfnAccessPoint_TransformationConfigurationPropertyDef]] = pydantic.Field(None)
    CfnAccessPoint: typing.Optional[dict[str, CfnAccessPointDef]] = pydantic.Field(None)
    CfnAccessPointPolicy: typing.Optional[dict[str, CfnAccessPointPolicyDef]] = pydantic.Field(None)
    CfnAccessPointPolicyProps: typing.Optional[dict[str, CfnAccessPointPolicyPropsDef]] = pydantic.Field(None)
