...
class CfnAccessPoint_TransformationConfigurationPropertyDef(BaseStruct):
    actions: typing.Union[typing.Sequence[str], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A container for the action of an Object Lambda Access Point configuration. Valid inputs are ``GetObject`` , ``HeadObject`` , ``ListObjects`` , and ``ListObjectsV2`` .\n')
