...
class EcsFargateContainerDefinitionDef(BaseConstruct):
    ...
    fargate_cpu_architecture: typing.Optional[models.aws_ecs.CpuArchitectureDef] = pydantic.Field(None, description='The vCPU architecture of Fargate Runtime. Default: - X86_64\n')
    fargate_operating_system_family: typing.Optional[models.aws_ecs.OperatingSystemFamilyDef] = pydantic.Field(None, description='The operating system for the compute environment. Default: - LINUX\n')
    ...
    user: typing.Optional[str] = pydantic.Field(None, description='The user name to use inside the container. Default: - no user\n')
    volumes: typing.Optional[typing.Sequence[models.aws_batch.EcsVolumeDef]] = pydantic.Field(None, description='The volumes to mount to this container. Automatically added to the job definition. Default: - no volumes')
    _init_params: typing.ClassVar[list[str]] = ['assign_public_ip', 'ephemeral_storage_size', 'fargate_cpu_architecture', 'fargate_operating_system_family', 'fargate_platform_version', 'cpu', 'image', 'memory', 'command', 'environment', 'execution_role', 'job_role', 'linux_parameters', 'logging', 'readonly_root_filesystem', 'secrets', 'user', 'volumes']
...
class JobQueueDef(BaseConstruct):
    ...
    job_state_time_limit_actions: typing.Optional[typing.Sequence[typing.Union[models.aws_batch.JobStateTimeLimitActionDef, dict[str, typing.Any]]]] = pydantic.Field(None, description='The set of actions that AWS Batch perform on jobs that remain at the head of the job queue in the specified state longer than specified times. Default: - no actions\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['compute_environments', 'enabled', 'job_queue_name', 'job_state_time_limit_actions', 'priority', 'scheduling_policy']
...
class CfnJobDefinition_ContainerPropertiesPropertyDef(BaseStruct):
    ...
    network_configuration: typing.Union[models.UnsupportedResource, models.aws_batch.CfnJobDefinition_NetworkConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The network configuration for jobs that are running on Fargate resources. Jobs that are running on Amazon EC2 resources must not specify this parameter.\n')
    ...
    repository_credentials: typing.Union[models.UnsupportedResource, models.aws_batch.CfnJobDefinition_RepositoryCredentialsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The private repository authentication credentials to use.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['image', 'command', 'environment', 'ephemeral_storage', 'execution_role_arn', 'fargate_platform_configuration', 'instance_type', 'job_role_arn', 'linux_parameters', 'log_configuration', 'memory', 'mount_points', 'network_configuration', 'privileged', 'readonly_root_filesystem', 'repository_credentials', 'resource_requirements', 'runtime_platform', 'secrets', 'ulimits', 'user', 'vcpus', 'volumes']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
#  autogenerated from aws_cdk.aws_batch.CfnJobDefinition.EcsPropertiesProperty
class CfnJobDefinition_EcsPropertiesPropertyDef(BaseStruct):
    task_properties: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_batch.CfnJobDefinition_EcsTaskPropertiesPropertyDef, dict[str, typing.Any]]]] = pydantic.Field(REQUIRED_INIT_PARAM, description='An object that contains the properties for the Amazon ECS task definition of a job. .. epigraph:: This object is currently limited to one element.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-batch-jobdefinition-ecsproperties.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_batch as batch\n\n    # options: Any\n\n    ecs_properties_property = batch.CfnJobDefinition.EcsPropertiesProperty(\n        task_properties=[batch.CfnJobDefinition.EcsTaskPropertiesProperty(\n            containers=[batch.CfnJobDefinition.TaskContainerPropertiesProperty(\n                image="image",\n\n                # the properties below are optional\n                command=["command"],\n                depends_on=[batch.CfnJobDefinition.TaskContainerDependencyProperty(\n                    condition="condition",\n                    container_name="containerName"\n                )],\n                environment=[batch.CfnJobDefinition.EnvironmentProperty(\n                    name="name",\n                    value="value"\n                )],\n                essential=False,\n                linux_parameters=batch.CfnJobDefinition.LinuxParametersProperty(\n                    devices=[batch.CfnJobDefinition.DeviceProperty(\n                        container_path="containerPath",\n                        host_path="hostPath",\n                        permissions=["permissions"]\n                    )],\n                    init_process_enabled=False,\n                    max_swap=123,\n                    shared_memory_size=123,\n                    swappiness=123,\n                    tmpfs=[batch.CfnJobDefinition.TmpfsProperty(\n                        container_path="containerPath",\n                        size=123,\n\n                        # the properties below are optional\n                        mount_options=["mountOptions"]\n                    )]\n                ),\n                log_configuration=batch.CfnJobDefinition.LogConfigurationProperty(\n                    log_driver="logDriver",\n\n                    # the properties below are optional\n                    options=options,\n                    secret_options=[batch.CfnJobDefinition.SecretProperty(\n                        name="name",\n                        value_from="valueFrom"\n                    )]\n                ),\n                mount_points=[batch.CfnJobDefinition.MountPointsProperty(\n                    container_path="containerPath",\n                    read_only=False,\n                    source_volume="sourceVolume"\n                )],\n                name="name",\n                privileged=False,\n                readonly_root_filesystem=False,\n                repository_credentials=batch.CfnJobDefinition.RepositoryCredentialsProperty(\n                    credentials_parameter="credentialsParameter"\n                ),\n                resource_requirements=[batch.CfnJobDefinition.ResourceRequirementProperty(\n                    type="type",\n                    value="value"\n                )],\n                secrets=[batch.CfnJobDefinition.SecretProperty(\n                    name="name",\n                    value_from="valueFrom"\n                )],\n                ulimits=[batch.CfnJobDefinition.UlimitProperty(\n                    hard_limit=123,\n                    name="name",\n                    soft_limit=123\n                )],\n                user="user"\n            )],\n            ephemeral_storage=batch.CfnJobDefinition.EphemeralStorageProperty(\n                size_in_gi_b=123\n            ),\n            execution_role_arn="executionRoleArn",\n            ipc_mode="ipcMode",\n            network_configuration=batch.CfnJobDefinition.NetworkConfigurationProperty(\n                assign_public_ip="assignPublicIp"\n            ),\n            pid_mode="pidMode",\n            platform_version="platformVersion",\n            runtime_platform=batch.CfnJobDefinition.RuntimePlatformProperty(\n                cpu_architecture="cpuArchitecture",\n                operating_system_family="operatingSystemFamily"\n            ),\n            task_role_arn="taskRoleArn",\n            volumes=[batch.CfnJobDefinition.VolumesProperty(\n                efs_volume_configuration=batch.CfnJobDefinition.EfsVolumeConfigurationProperty(\n                    file_system_id="fileSystemId",\n\n                    # the properties below are optional\n                    authorization_config=batch.CfnJobDefinition.AuthorizationConfigProperty(\n                        access_point_id="accessPointId",\n                        iam="iam"\n                    ),\n                    root_directory="rootDirectory",\n                    transit_encryption="transitEncryption",\n                    transit_encryption_port=123\n                ),\n                host=batch.CfnJobDefinition.VolumesHostProperty(\n                    source_path="sourcePath"\n                ),\n                name="name"\n            )]\n        )]\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['task_properties']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_batch.CfnJobDefinition.EcsPropertiesProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
#  autogenerated from aws_cdk.aws_batch.CfnJobDefinition.EcsTaskPropertiesProperty
class CfnJobDefinition_EcsTaskPropertiesPropertyDef(BaseStruct):
    containers: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_batch.CfnJobDefinition_TaskContainerPropertiesPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='This object is a list of containers.\n')
    ephemeral_storage: typing.Union[models.UnsupportedResource, models.aws_batch.CfnJobDefinition_EphemeralStoragePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The amount of ephemeral storage to allocate for the task. This parameter is used to expand the total amount of ephemeral storage available, beyond the default amount, for tasks hosted on AWS Fargate .\n')
    execution_role_arn: typing.Optional[str] = pydantic.Field(None, description='The Amazon Resource Name (ARN) of the execution role that AWS Batch can assume. For jobs that run on Fargate resources, you must provide an execution role. For more information, see `AWS Batch execution IAM role <https://docs.aws.amazon.com/batch/latest/userguide/execution-IAM-role.html>`_ in the *AWS Batch User Guide* .\n')
    ipc_mode: typing.Optional[str] = pydantic.Field(None, description='The IPC resource namespace to use for the containers in the task. The valid values are ``host`` , ``task`` , or ``none`` . If ``host`` is specified, all containers within the tasks that specified the ``host`` IPC mode on the same container instance share the same IPC resources with the host Amazon EC2 instance. If ``task`` is specified, all containers within the specified ``task`` share the same IPC resources. If ``none`` is specified, the IPC resources within the containers of a task are private, and are not shared with other containers in a task or on the container instance. If no value is specified, then the IPC resource namespace sharing depends on the Docker daemon setting on the container instance. For more information, see `IPC settings <https://docs.aws.amazon.com/https://docs.docker.com/engine/reference/run/#ipc-settings---ipc>`_ in the Docker run reference.\n')
    network_configuration: typing.Union[models.UnsupportedResource, models.aws_batch.CfnJobDefinition_NetworkConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The network configuration for jobs that are running on Fargate resources. Jobs that are running on Amazon EC2 resources must not specify this parameter.\n')
    pid_mode: typing.Optional[str] = pydantic.Field(None, description='The process namespace to use for the containers in the task. The valid values are ``host`` or ``task`` . For example, monitoring sidecars might need ``pidMode`` to access information about other containers running in the same task. If ``host`` is specified, all containers within the tasks that specified the ``host`` PID mode on the same container instance share the process namespace with the host Amazon EC2 instance. If ``task`` is specified, all containers within the specified task share the same process namespace. If no value is specified, the default is a private namespace for each container. For more information, see `PID settings <https://docs.aws.amazon.com/https://docs.docker.com/engine/reference/run/#pid-settings---pid>`_ in the Docker run reference.\n')
    platform_version: typing.Optional[str] = pydantic.Field(None, description="The Fargate platform version where the jobs are running. A platform version is specified only for jobs that are running on Fargate resources. If one isn't specified, the ``LATEST`` platform version is used by default. This uses a recent, approved version of the Fargate platform for compute resources. For more information, see `AWS Fargate platform versions <https://docs.aws.amazon.com/AmazonECS/latest/developerguide/platform_versions.html>`_ in the *Amazon Elastic Container Service Developer Guide* .\n")
    runtime_platform: typing.Union[models.UnsupportedResource, models.aws_batch.CfnJobDefinition_RuntimePlatformPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='An object that represents the compute environment architecture for AWS Batch jobs on Fargate.\n')
    task_role_arn: typing.Optional[str] = pydantic.Field(None, description="The Amazon Resource Name (ARN) that's associated with the Amazon ECS task. .. epigraph:: This is object is comparable to `ContainerProperties:jobRoleArn <https://docs.aws.amazon.com/batch/latest/APIReference/API_ContainerProperties.html>`_ .\n")
    volumes: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_batch.CfnJobDefinition_VolumesPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='A list of volumes that are associated with the job.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-batch-jobdefinition-ecstaskproperties.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_batch as batch\n\n    # options: Any\n\n    ecs_task_properties_property = batch.CfnJobDefinition.EcsTaskPropertiesProperty(\n        containers=[batch.CfnJobDefinition.TaskContainerPropertiesProperty(\n            image="image",\n\n            # the properties below are optional\n            command=["command"],\n            depends_on=[batch.CfnJobDefinition.TaskContainerDependencyProperty(\n                condition="condition",\n                container_name="containerName"\n            )],\n            environment=[batch.CfnJobDefinition.EnvironmentProperty(\n                name="name",\n                value="value"\n            )],\n            essential=False,\n            linux_parameters=batch.CfnJobDefinition.LinuxParametersProperty(\n                devices=[batch.CfnJobDefinition.DeviceProperty(\n                    container_path="containerPath",\n                    host_path="hostPath",\n                    permissions=["permissions"]\n                )],\n                init_process_enabled=False,\n                max_swap=123,\n                shared_memory_size=123,\n                swappiness=123,\n                tmpfs=[batch.CfnJobDefinition.TmpfsProperty(\n                    container_path="containerPath",\n                    size=123,\n\n                    # the properties below are optional\n                    mount_options=["mountOptions"]\n                )]\n            ),\n            log_configuration=batch.CfnJobDefinition.LogConfigurationProperty(\n                log_driver="logDriver",\n\n                # the properties below are optional\n                options=options,\n                secret_options=[batch.CfnJobDefinition.SecretProperty(\n                    name="name",\n                    value_from="valueFrom"\n                )]\n            ),\n            mount_points=[batch.CfnJobDefinition.MountPointsProperty(\n                container_path="containerPath",\n                read_only=False,\n                source_volume="sourceVolume"\n            )],\n            name="name",\n            privileged=False,\n            readonly_root_filesystem=False,\n            repository_credentials=batch.CfnJobDefinition.RepositoryCredentialsProperty(\n                credentials_parameter="credentialsParameter"\n            ),\n            resource_requirements=[batch.CfnJobDefinition.ResourceRequirementProperty(\n                type="type",\n                value="value"\n            )],\n            secrets=[batch.CfnJobDefinition.SecretProperty(\n                name="name",\n                value_from="valueFrom"\n            )],\n            ulimits=[batch.CfnJobDefinition.UlimitProperty(\n                hard_limit=123,\n                name="name",\n                soft_limit=123\n            )],\n            user="user"\n        )],\n        ephemeral_storage=batch.CfnJobDefinition.EphemeralStorageProperty(\n            size_in_gi_b=123\n        ),\n        execution_role_arn="executionRoleArn",\n        ipc_mode="ipcMode",\n        network_configuration=batch.CfnJobDefinition.NetworkConfigurationProperty(\n            assign_public_ip="assignPublicIp"\n        ),\n        pid_mode="pidMode",\n        platform_version="platformVersion",\n        runtime_platform=batch.CfnJobDefinition.RuntimePlatformProperty(\n            cpu_architecture="cpuArchitecture",\n            operating_system_family="operatingSystemFamily"\n        ),\n        task_role_arn="taskRoleArn",\n        volumes=[batch.CfnJobDefinition.VolumesProperty(\n            efs_volume_configuration=batch.CfnJobDefinition.EfsVolumeConfigurationProperty(\n                file_system_id="fileSystemId",\n\n                # the properties below are optional\n                authorization_config=batch.CfnJobDefinition.AuthorizationConfigProperty(\n                    access_point_id="accessPointId",\n                    iam="iam"\n                ),\n                root_directory="rootDirectory",\n                transit_encryption="transitEncryption",\n                transit_encryption_port=123\n            ),\n            host=batch.CfnJobDefinition.VolumesHostProperty(\n                source_path="sourcePath"\n            ),\n            name="name"\n        )]\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['containers', 'ephemeral_storage', 'execution_role_arn', 'ipc_mode', 'network_configuration', 'pid_mode', 'platform_version', 'runtime_platform', 'task_role_arn', 'volumes']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_batch.CfnJobDefinition.EcsTaskPropertiesProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
#  autogenerated from aws_cdk.aws_batch.CfnJobDefinition.ImagePullSecretProperty
class CfnJobDefinition_ImagePullSecretPropertyDef(BaseStruct):
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Provides a unique identifier for the ``ImagePullSecret`` . This object is required when ``EksPodProperties$imagePullSecrets`` is used.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-batch-jobdefinition-imagepullsecret.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_batch as batch\n\n    image_pull_secret_property = batch.CfnJobDefinition.ImagePullSecretProperty(\n        name="name"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['name']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_batch.CfnJobDefinition.ImagePullSecretProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class CfnJobDefinition_NodeRangePropertyPropertyDef(BaseStruct):
    ...
    ecs_properties: typing.Union[models.UnsupportedResource, models.aws_batch.CfnJobDefinition_EcsPropertiesPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='This is an object that represents the properties of the node range for a multi-node parallel job.\n')
    instance_types: typing.Optional[typing.Sequence[str]] = pydantic.Field(None, description='The instance types of the underlying host infrastructure of a multi-node parallel job. .. epigraph:: This parameter isn\'t applicable to jobs that are running on Fargate resources. In addition, this list object is currently limited to one element.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-batch-jobdefinition-noderangeproperty.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_batch as batch\n\n    # options: Any\n\n    node_range_property_property = batch.CfnJobDefinition.NodeRangePropertyProperty(\n        target_nodes="targetNodes",\n\n        # the properties below are optional\n        container=batch.CfnJobDefinition.ContainerPropertiesProperty(\n            image="image",\n\n            # the properties below are optional\n            command=["command"],\n            environment=[batch.CfnJobDefinition.EnvironmentProperty(\n                name="name",\n                value="value"\n            )],\n            ephemeral_storage=batch.CfnJobDefinition.EphemeralStorageProperty(\n                size_in_gi_b=123\n            ),\n            execution_role_arn="executionRoleArn",\n            fargate_platform_configuration=batch.CfnJobDefinition.FargatePlatformConfigurationProperty(\n                platform_version="platformVersion"\n            ),\n            instance_type="instanceType",\n            job_role_arn="jobRoleArn",\n            linux_parameters=batch.CfnJobDefinition.LinuxParametersProperty(\n                devices=[batch.CfnJobDefinition.DeviceProperty(\n                    container_path="containerPath",\n                    host_path="hostPath",\n                    permissions=["permissions"]\n                )],\n                init_process_enabled=False,\n                max_swap=123,\n                shared_memory_size=123,\n                swappiness=123,\n                tmpfs=[batch.CfnJobDefinition.TmpfsProperty(\n                    container_path="containerPath",\n                    size=123,\n\n                    # the properties below are optional\n                    mount_options=["mountOptions"]\n                )]\n            ),\n            log_configuration=batch.CfnJobDefinition.LogConfigurationProperty(\n                log_driver="logDriver",\n\n                # the properties below are optional\n                options=options,\n                secret_options=[batch.CfnJobDefinition.SecretProperty(\n                    name="name",\n                    value_from="valueFrom"\n                )]\n            ),\n            memory=123,\n            mount_points=[batch.CfnJobDefinition.MountPointsProperty(\n                container_path="containerPath",\n                read_only=False,\n                source_volume="sourceVolume"\n            )],\n            network_configuration=batch.CfnJobDefinition.NetworkConfigurationProperty(\n                assign_public_ip="assignPublicIp"\n            ),\n            privileged=False,\n            readonly_root_filesystem=False,\n            repository_credentials=batch.CfnJobDefinition.RepositoryCredentialsProperty(\n                credentials_parameter="credentialsParameter"\n            ),\n            resource_requirements=[batch.CfnJobDefinition.ResourceRequirementProperty(\n                type="type",\n                value="value"\n            )],\n            runtime_platform=batch.CfnJobDefinition.RuntimePlatformProperty(\n                cpu_architecture="cpuArchitecture",\n                operating_system_family="operatingSystemFamily"\n            ),\n            secrets=[batch.CfnJobDefinition.SecretProperty(\n                name="name",\n                value_from="valueFrom"\n            )],\n            ulimits=[batch.CfnJobDefinition.UlimitProperty(\n                hard_limit=123,\n                name="name",\n                soft_limit=123\n            )],\n            user="user",\n            vcpus=123,\n            volumes=[batch.CfnJobDefinition.VolumesProperty(\n                efs_volume_configuration=batch.CfnJobDefinition.EfsVolumeConfigurationProperty(\n                    file_system_id="fileSystemId",\n\n                    # the properties below are optional\n                    authorization_config=batch.CfnJobDefinition.AuthorizationConfigProperty(\n                        access_point_id="accessPointId",\n                        iam="iam"\n                    ),\n                    root_directory="rootDirectory",\n                    transit_encryption="transitEncryption",\n                    transit_encryption_port=123\n                ),\n                host=batch.CfnJobDefinition.VolumesHostProperty(\n                    source_path="sourcePath"\n                ),\n                name="name"\n            )]\n        ),\n        ecs_properties=batch.CfnJobDefinition.EcsPropertiesProperty(\n            task_properties=[batch.CfnJobDefinition.EcsTaskPropertiesProperty(\n                containers=[batch.CfnJobDefinition.TaskContainerPropertiesProperty(\n                    image="image",\n\n                    # the properties below are optional\n                    command=["command"],\n                    depends_on=[batch.CfnJobDefinition.TaskContainerDependencyProperty(\n                        condition="condition",\n                        container_name="containerName"\n                    )],\n                    environment=[batch.CfnJobDefinition.EnvironmentProperty(\n                        name="name",\n                        value="value"\n                    )],\n                    essential=False,\n                    linux_parameters=batch.CfnJobDefinition.LinuxParametersProperty(\n                        devices=[batch.CfnJobDefinition.DeviceProperty(\n                            container_path="containerPath",\n                            host_path="hostPath",\n                            permissions=["permissions"]\n                        )],\n                        init_process_enabled=False,\n                        max_swap=123,\n                        shared_memory_size=123,\n                        swappiness=123,\n                        tmpfs=[batch.CfnJobDefinition.TmpfsProperty(\n                            container_path="containerPath",\n                            size=123,\n\n                            # the properties below are optional\n                            mount_options=["mountOptions"]\n                        )]\n                    ),\n                    log_configuration=batch.CfnJobDefinition.LogConfigurationProperty(\n                        log_driver="logDriver",\n\n                        # the properties below are optional\n                        options=options,\n                        secret_options=[batch.CfnJobDefinition.SecretProperty(\n                            name="name",\n                            value_from="valueFrom"\n                        )]\n                    ),\n                    mount_points=[batch.CfnJobDefinition.MountPointsProperty(\n                        container_path="containerPath",\n                        read_only=False,\n                        source_volume="sourceVolume"\n                    )],\n                    name="name",\n                    privileged=False,\n                    readonly_root_filesystem=False,\n                    repository_credentials=batch.CfnJobDefinition.RepositoryCredentialsProperty(\n                        credentials_parameter="credentialsParameter"\n                    ),\n                    resource_requirements=[batch.CfnJobDefinition.ResourceRequirementProperty(\n                        type="type",\n                        value="value"\n                    )],\n                    secrets=[batch.CfnJobDefinition.SecretProperty(\n                        name="name",\n                        value_from="valueFrom"\n                    )],\n                    ulimits=[batch.CfnJobDefinition.UlimitProperty(\n                        hard_limit=123,\n                        name="name",\n                        soft_limit=123\n                    )],\n                    user="user"\n                )],\n                ephemeral_storage=batch.CfnJobDefinition.EphemeralStorageProperty(\n                    size_in_gi_b=123\n                ),\n                execution_role_arn="executionRoleArn",\n                ipc_mode="ipcMode",\n                network_configuration=batch.CfnJobDefinition.NetworkConfigurationProperty(\n                    assign_public_ip="assignPublicIp"\n                ),\n                pid_mode="pidMode",\n                platform_version="platformVersion",\n                runtime_platform=batch.CfnJobDefinition.RuntimePlatformProperty(\n                    cpu_architecture="cpuArchitecture",\n                    operating_system_family="operatingSystemFamily"\n                ),\n                task_role_arn="taskRoleArn",\n                volumes=[batch.CfnJobDefinition.VolumesProperty(\n                    efs_volume_configuration=batch.CfnJobDefinition.EfsVolumeConfigurationProperty(\n                        file_system_id="fileSystemId",\n\n                        # the properties below are optional\n                        authorization_config=batch.CfnJobDefinition.AuthorizationConfigProperty(\n                            access_point_id="accessPointId",\n                            iam="iam"\n                        ),\n                        root_directory="rootDirectory",\n                        transit_encryption="transitEncryption",\n                        transit_encryption_port=123\n                    ),\n                    host=batch.CfnJobDefinition.VolumesHostProperty(\n                        source_path="sourcePath"\n                    ),\n                    name="name"\n                )]\n            )]\n        ),\n        instance_types=["instanceTypes"]\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['target_nodes', 'container', 'ecs_properties', 'instance_types']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnJobDefinition_PodPropertiesPropertyDef(BaseStruct):
    ...
    image_pull_secrets: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_batch.CfnJobDefinition_ImagePullSecretPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    init_containers: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_batch.CfnJobDefinition_EksContainerPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='These containers run before application containers, always runs to completion, and must complete successfully before the next container starts. These containers are registered with the Amazon EKS Connector agent and persists the registration information in the Kubernetes backend data store. For more information, see `Init Containers <https://docs.aws.amazon.com/https://kubernetes.io/docs/concepts/workloads/pods/init-containers/>`_ in the *Kubernetes documentation* . .. epigraph:: This object is limited to 10 elements\n')
    metadata: typing.Union[models.UnsupportedResource, models.aws_batch.CfnJobDefinition_MetadataPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Metadata about the Kubernetes pod. For more information, see `Understanding Kubernetes Objects <https://docs.aws.amazon.com/https://kubernetes.io/docs/concepts/overview/working-with-objects/kubernetes-objects/>`_ in the *Kubernetes documentation* .\n')
    ...
    share_process_namespace: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='Indicates if the processes in a container are shared, or visible, to other containers in the same pod. For more information, see `Share Process Namespace between Containers in a Pod <https://docs.aws.amazon.com/https://kubernetes.io/docs/tasks/configure-pod-container/share-process-namespace/>`_ .\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['containers', 'dns_policy', 'host_network', 'image_pull_secrets', 'init_containers', 'metadata', 'service_account_name', 'share_process_namespace', 'volumes']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
#  autogenerated from aws_cdk.aws_batch.CfnJobDefinition.RepositoryCredentialsProperty
class CfnJobDefinition_RepositoryCredentialsPropertyDef(BaseStruct):
    credentials_parameter: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Amazon Resource Name (ARN) of the secret containing the private repository credentials.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-batch-jobdefinition-repositorycredentials.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_batch as batch\n\n    repository_credentials_property = batch.CfnJobDefinition.RepositoryCredentialsProperty(\n        credentials_parameter="credentialsParameter"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['credentials_parameter']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_batch.CfnJobDefinition.RepositoryCredentialsProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class CfnJobDefinition_SecurityContextPropertyDef(BaseStruct):
    allow_privilege_escalation: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
    ...
    _init_params: typing.ClassVar[list[str]] = ['allow_privilege_escalation', 'privileged', 'read_only_root_filesystem', 'run_as_group', 'run_as_non_root', 'run_as_user']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
#  autogenerated from aws_cdk.aws_batch.CfnJobDefinition.TaskContainerPropertiesProperty
class CfnJobDefinition_TaskContainerPropertiesPropertyDef(BaseStruct):
    ...
    depends_on: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_batch.CfnJobDefinition_TaskContainerDependencyPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='A list of containers that this container depends on.\n')
    environment: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_batch.CfnJobDefinition_EnvironmentPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description="The environment variables to pass to a container. This parameter maps to Env inthe `Create a container <https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.23/#create-a-container>`_ section of the `Docker Remote API <https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.23/>`_ and the ``--env`` parameter to `docker run <https://docs.aws.amazon.com/https://docs.docker.com/engine/reference/run/>`_ . .. epigraph:: We don't recommend using plaintext environment variables for sensitive information, such as credential data. > Environment variables cannot start with ``AWS_BATCH`` . This naming convention is reserved for variables that AWS Batch sets.\n")
    ...
    linux_parameters: typing.Union[models.UnsupportedResource, models.aws_batch.CfnJobDefinition_LinuxParametersPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Linux-specific modifications that are applied to the container, such as Linux kernel capabilities. For more information, see `KernelCapabilities <https://docs.aws.amazon.com/AmazonECS/latest/APIReference/API_KernelCapabilities.html>`_ .\n')
    ...
    name: typing.Optional[str] = pydantic.Field(None, description='The name of a container. The name can be used as a unique identifier to target your ``dependsOn`` and ``Overrides`` objects.\n')
    ...
    repository_credentials: typing.Union[models.UnsupportedResource, models.aws_batch.CfnJobDefinition_RepositoryCredentialsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The private repository authentication credentials to use.\n')
    resource_requirements: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_batch.CfnJobDefinition_ResourceRequirementPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The type and amount of a resource to assign to a container. The only supported resource is a GPU.\n')
    secrets: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_batch.CfnJobDefinition_SecretPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The secrets to pass to the container. For more information, see `Specifying Sensitive Data <https://docs.aws.amazon.com/AmazonECS/latest/developerguide/specifying-sensitive-data.html>`_ in the Amazon Elastic Container Service Developer Guide.\n')
    ulimits: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_batch.CfnJobDefinition_UlimitPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description="A list of ``ulimits`` to set in the container. If a ``ulimit`` value is specified in a task definition, it overrides the default values set by Docker. This parameter maps to ``Ulimits`` in the `Create a container <https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/#operation/ContainerCreate>`_ section of the `Docker Remote API <https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/>`_ and the ``--ulimit`` option to `docker run <https://docs.aws.amazon.com/https://docs.docker.com/engine/reference/run/#security-configuration>`_ . Amazon ECS tasks hosted on Fargate use the default resource limit values set by the operating system with the exception of the nofile resource limit parameter which Fargate overrides. The ``nofile`` resource limit sets a restriction on the number of open files that a container can use. The default ``nofile`` soft limit is ``1024`` and the default hard limit is ``65535`` . This parameter requires version 1.18 of the Docker Remote API or greater on your container instance. To check the Docker Remote API version on your container instance, log in to your container instance and run the following command: sudo docker version ``--format '{{.Server.APIVersion}}'`` .. epigraph:: This parameter is not supported for Windows containers.\n")
    user: typing.Optional[str] = pydantic.Field(None, description='The user to use inside the container. This parameter maps to User in the Create a container section of the Docker Remote API and the --user option to docker run. .. epigraph:: When running tasks using the ``host`` network mode, don\'t run containers using the ``root user (UID 0)`` . We recommend using a non-root user for better security. You can specify the ``user`` using the following formats. If specifying a UID or GID, you must specify it as a positive integer. - ``user`` - ``user:group`` - ``uid`` - ``uid:gid`` - ``user:gi`` - ``uid:group`` .. epigraph:: This parameter is not supported for Windows containers.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-batch-jobdefinition-taskcontainerproperties.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_batch as batch\n\n    # options: Any\n\n    task_container_properties_property = batch.CfnJobDefinition.TaskContainerPropertiesProperty(\n        image="image",\n\n        # the properties below are optional\n        command=["command"],\n        depends_on=[batch.CfnJobDefinition.TaskContainerDependencyProperty(\n            condition="condition",\n            container_name="containerName"\n        )],\n        environment=[batch.CfnJobDefinition.EnvironmentProperty(\n            name="name",\n            value="value"\n        )],\n        essential=False,\n        linux_parameters=batch.CfnJobDefinition.LinuxParametersProperty(\n            devices=[batch.CfnJobDefinition.DeviceProperty(\n                container_path="containerPath",\n                host_path="hostPath",\n                permissions=["permissions"]\n            )],\n            init_process_enabled=False,\n            max_swap=123,\n            shared_memory_size=123,\n            swappiness=123,\n            tmpfs=[batch.CfnJobDefinition.TmpfsProperty(\n                container_path="containerPath",\n                size=123,\n\n                # the properties below are optional\n                mount_options=["mountOptions"]\n            )]\n        ),\n        log_configuration=batch.CfnJobDefinition.LogConfigurationProperty(\n            log_driver="logDriver",\n\n            # the properties below are optional\n            options=options,\n            secret_options=[batch.CfnJobDefinition.SecretProperty(\n                name="name",\n                value_from="valueFrom"\n            )]\n        ),\n        mount_points=[batch.CfnJobDefinition.MountPointsProperty(\n            container_path="containerPath",\n            read_only=False,\n            source_volume="sourceVolume"\n        )],\n        name="name",\n        privileged=False,\n        readonly_root_filesystem=False,\n        repository_credentials=batch.CfnJobDefinition.RepositoryCredentialsProperty(\n            credentials_parameter="credentialsParameter"\n        ),\n        resource_requirements=[batch.CfnJobDefinition.ResourceRequirementProperty(\n            type="type",\n            value="value"\n        )],\n        secrets=[batch.CfnJobDefinition.SecretProperty(\n            name="name",\n            value_from="valueFrom"\n        )],\n        ulimits=[batch.CfnJobDefinition.UlimitProperty(\n            hard_limit=123,\n            name="name",\n            soft_limit=123\n        )],\n        user="user"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['image', 'command', 'depends_on', 'environment', 'essential', 'linux_parameters', 'log_configuration', 'mount_points', 'name', 'privileged', 'readonly_root_filesystem', 'repository_credentials', 'resource_requirements', 'secrets', 'ulimits', 'user']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_batch.CfnJobDefinition.TaskContainerPropertiesProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
#  autogenerated from aws_cdk.aws_batch.CfnJobQueue.JobStateTimeLimitActionProperty
class CfnJobQueue_JobStateTimeLimitActionPropertyDef(BaseStruct):
    action: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The action to take when a job is at the head of the job queue in the specified state for the specified period of time. The only supported value is ``CANCEL`` , which will cancel the job.\n')
    max_time_seconds: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The approximate amount of time, in seconds, that must pass with the job in the specified state before the action is taken. The minimum value is 600 (10 minutes) and the maximum value is 86,400 (24 hours).\n')
    reason: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The reason to log for the action being taken.\n')
    state: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The state of the job needed to trigger the action. The only supported value is ``RUNNABLE`` .\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-batch-jobqueue-jobstatetimelimitaction.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_batch as batch\n\n    job_state_time_limit_action_property = batch.CfnJobQueue.JobStateTimeLimitActionProperty(\n        action="action",\n        max_time_seconds=123,\n        reason="reason",\n        state="state"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['action', 'max_time_seconds', 'reason', 'state']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_batch.CfnJobQueue.JobStateTimeLimitActionProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class EcsFargateContainerDefinitionPropsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['cpu', 'image', 'memory', 'command', 'environment', 'execution_role', 'job_role', 'linux_parameters', 'logging', 'readonly_root_filesystem', 'secrets', 'user', 'volumes', 'assign_public_ip', 'ephemeral_storage_size', 'fargate_cpu_architecture', 'fargate_operating_system_family', 'fargate_platform_version']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
#  autogenerated from aws_cdk.aws_batch.JobStateTimeLimitAction
class JobStateTimeLimitActionDef(BaseStruct):
    max_time: typing.Union[models.DurationDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The approximate amount of time, that must pass with the job in the specified state before the action is taken. The minimum value is 10 minutes and the maximum value is 24 hours.\n')
    reason: typing.Union[aws_cdk.aws_batch.JobStateTimeLimitActionsReason, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The reason to log for the action being taken.\n')
    action: typing.Optional[aws_cdk.aws_batch.JobStateTimeLimitActionsAction] = pydantic.Field(None, description='The action to take when a job is at the head of the job queue in the specified state for the specified period of time. Default: JobStateTimeLimitActionsAction.CANCEL\n')
    state: typing.Optional[aws_cdk.aws_batch.JobStateTimeLimitActionsState] = pydantic.Field(None, description='The state of the job needed to trigger the action. Default: JobStateTimeLimitActionsState.RUNNABLE\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    import aws_cdk as cdk\n    from aws_cdk import aws_batch as batch\n\n    job_state_time_limit_action = batch.JobStateTimeLimitAction(\n        max_time=cdk.Duration.minutes(30),\n        reason=batch.JobStateTimeLimitActionsReason.INSUFFICIENT_INSTANCE_CAPACITY,\n\n        # the properties below are optional\n        action=batch.JobStateTimeLimitActionsAction.CANCEL,\n        state=batch.JobStateTimeLimitActionsState.RUNNABLE\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['max_time', 'reason', 'action', 'state']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_batch.JobStateTimeLimitAction'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...


    resource_config: typing.Optional[models.aws_batch.JobStateTimeLimitActionDefConfig] = pydantic.Field(None)


class JobStateTimeLimitActionDefConfig(pydantic.BaseModel):
    max_time_config: typing.Optional[models.core.DurationDefConfig] = pydantic.Field(None)
...
#  autogenerated from aws_cdk.aws_batch.JobStateTimeLimitActionsAction
# skipping emum

#  autogenerated from aws_cdk.aws_batch.JobStateTimeLimitActionsReason
# skipping emum

#  autogenerated from aws_cdk.aws_batch.JobStateTimeLimitActionsState
# skipping emum
...
class CfnJobDefinitionDef(BaseCfnResource):
    ...
    container_properties: typing.Union[models.UnsupportedResource, models.aws_batch.CfnJobDefinition_ContainerPropertiesPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description="An object with properties specific to Amazon ECS-based jobs. When ``containerProperties`` is used in the job definition, it can't be used in addition to ``eksProperties`` , ``ecsProperties`` , or ``nodeProperties`` .\n")
    ecs_properties: typing.Union[models.UnsupportedResource, models.aws_batch.CfnJobDefinition_EcsPropertiesPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description="An object that contains the properties for the Amazon ECS resources of a job.When ``ecsProperties`` is used in the job definition, it can't be used in addition to ``containerProperties`` , ``eksProperties`` , or ``nodeProperties`` .\n")
    eks_properties: typing.Union[models.UnsupportedResource, models.aws_batch.CfnJobDefinition_EksPropertiesPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description="An object with properties that are specific to Amazon EKS-based jobs. When ``eksProperties`` is used in the job definition, it can't be used in addition to ``containerProperties`` , ``ecsProperties`` , or ``nodeProperties`` .\n")
    job_definition_name: typing.Optional[str] = pydantic.Field(None, description='The name of the job definition.\n')
    node_properties: typing.Union[models.UnsupportedResource, models.aws_batch.CfnJobDefinition_NodePropertiesPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description="An object with properties that are specific to multi-node parallel jobs. When ``nodeProperties`` is used in the job definition, it can't be used in addition to ``containerProperties`` , ``ecsProperties`` , or ``eksProperties`` . .. epigraph:: If the job runs on Fargate resources, don't specify ``nodeProperties`` . Use ``containerProperties`` instead.\n")
    ...
    _init_params: typing.ClassVar[list[str]] = ['type', 'container_properties', 'ecs_properties', 'eks_properties', 'job_definition_name', 'node_properties', 'parameters', 'platform_capabilities', 'propagate_tags', 'retry_strategy', 'scheduling_priority', 'tags', 'timeout']
    _method_names: typing.ClassVar[list[str]] = ['AuthorizationConfigProperty', 'ContainerPropertiesProperty', 'DeviceProperty', 'EcsPropertiesProperty', 'EcsTaskPropertiesProperty', 'EfsVolumeConfigurationProperty', 'EksContainerEnvironmentVariableProperty', 'EksContainerProperty', 'EksContainerVolumeMountProperty', 'EksPropertiesProperty', 'EksSecretProperty', 'EksVolumeProperty', 'EmptyDirProperty', 'EnvironmentProperty', 'EphemeralStorageProperty', 'EvaluateOnExitProperty', 'FargatePlatformConfigurationProperty', 'HostPathProperty', 'ImagePullSecretProperty', 'LinuxParametersProperty', 'LogConfigurationProperty', 'MetadataProperty', 'MountPointsProperty', 'NetworkConfigurationProperty', 'NodePropertiesProperty', 'NodeRangePropertyProperty', 'PodPropertiesProperty', 'RepositoryCredentialsProperty', 'ResourceRequirementProperty', 'ResourcesProperty', 'RetryStrategyProperty', 'RuntimePlatformProperty', 'SecretProperty', 'SecurityContextProperty', 'TaskContainerDependencyProperty', 'TaskContainerPropertiesProperty', 'TimeoutProperty', 'TmpfsProperty', 'UlimitProperty', 'VolumesHostProperty', 'VolumesProperty', 'add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnJobDefinitionDefConfig(pydantic.BaseModel):
    ...
    EcsPropertiesProperty: typing.Optional[list[models.aws_batch.CfnJobDefinitionDefEcspropertiespropertyParams]] = pydantic.Field(None, description='')
    EcsTaskPropertiesProperty: typing.Optional[list[models.aws_batch.CfnJobDefinitionDefEcstaskpropertiespropertyParams]] = pydantic.Field(None, description='')
    ...
    ImagePullSecretProperty: typing.Optional[list[models.aws_batch.CfnJobDefinitionDefImagepullsecretpropertyParams]] = pydantic.Field(None, description='')
    ...
    RepositoryCredentialsProperty: typing.Optional[list[models.aws_batch.CfnJobDefinitionDefRepositorycredentialspropertyParams]] = pydantic.Field(None, description='')
    ...
    TaskContainerDependencyProperty: typing.Optional[list[models.aws_batch.CfnJobDefinitionDefTaskcontainerdependencypropertyParams]] = pydantic.Field(None, description='')
    TaskContainerPropertiesProperty: typing.Optional[list[models.aws_batch.CfnJobDefinitionDefTaskcontainerpropertiespropertyParams]] = pydantic.Field(None, description='')
...
class CfnJobDefinitionDefContainerpropertiespropertyParams(pydantic.BaseModel):
    ...
    repository_credentials: typing.Union[models.UnsupportedResource, models.aws_batch.CfnJobDefinition_RepositoryCredentialsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
...
class CfnJobDefinitionDefEcspropertiespropertyParams(pydantic.BaseModel):
    task_properties: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_batch.CfnJobDefinition_EcsTaskPropertiesPropertyDef, dict[str, typing.Any]]]] = pydantic.Field(..., description='')
    ...

class CfnJobDefinitionDefEcstaskpropertiespropertyParams(pydantic.BaseModel):
    containers: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_batch.CfnJobDefinition_TaskContainerPropertiesPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    ephemeral_storage: typing.Union[models.UnsupportedResource, models.aws_batch.CfnJobDefinition_EphemeralStoragePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    execution_role_arn: typing.Optional[str] = pydantic.Field(None, description='')
    ipc_mode: typing.Optional[str] = pydantic.Field(None, description='')
    network_configuration: typing.Union[models.UnsupportedResource, models.aws_batch.CfnJobDefinition_NetworkConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    pid_mode: typing.Optional[str] = pydantic.Field(None, description='')
...
class CfnJobDefinitionDefImagepullsecretpropertyParams(pydantic.BaseModel):
    name: str = pydantic.Field(..., description='')
    ...
...
class CfnJobDefinitionDefNoderangepropertypropertyParams(pydantic.BaseModel):
    ...
    ecs_properties: typing.Union[models.UnsupportedResource, models.aws_batch.CfnJobDefinition_EcsPropertiesPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    instance_types: typing.Optional[typing.Sequence[str]] = pydantic.Field(None, description='')
    ...
...
class CfnJobDefinitionDefPodpropertiespropertyParams(pydantic.BaseModel):
    ...
    image_pull_secrets: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_batch.CfnJobDefinition_ImagePullSecretPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    init_containers: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_batch.CfnJobDefinition_EksContainerPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    ...
    share_process_namespace: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
...
class CfnJobDefinitionDefRepositorycredentialspropertyParams(pydantic.BaseModel):
...
class CfnJobDefinitionDefTaskcontainerdependencypropertyParams(pydantic.BaseModel):
    condition: str = pydantic.Field(..., description='')
    container_name: str = pydantic.Field(..., description='')
    ...

class CfnJobDefinitionDefTaskcontainerpropertiespropertyParams(pydantic.BaseModel):
    image: str = pydantic.Field(..., description='')
    command: typing.Optional[typing.Sequence[str]] = pydantic.Field(None, description='')
    depends_on: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_batch.CfnJobDefinition_TaskContainerDependencyPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    environment: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_batch.CfnJobDefinition_EnvironmentPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
...
class CfnJobQueueDef(BaseCfnResource):
    ...
    job_state_time_limit_actions: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_batch.CfnJobQueue_JobStateTimeLimitActionPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The set of actions that AWS Batch perform on jobs that remain at the head of the job queue in the specified state longer than specified times. AWS Batch will perform each action after ``maxTimeSeconds`` has passed.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['compute_environment_order', 'priority', 'job_queue_name', 'job_state_time_limit_actions', 'scheduling_policy_arn', 'state', 'tags']
    _method_names: typing.ClassVar[list[str]] = ['ComputeEnvironmentOrderProperty', 'JobStateTimeLimitActionProperty', 'add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnJobQueueDefConfig(pydantic.BaseModel):
    ...
    JobStateTimeLimitActionProperty: typing.Optional[list[models.aws_batch.CfnJobQueueDefJobstatetimelimitactionpropertyParams]] = pydantic.Field(None, description='')
...
class CfnJobQueueDefJobstatetimelimitactionpropertyParams(pydantic.BaseModel):
    action: str = pydantic.Field(..., description='')
    max_time_seconds: typing.Union[int, float] = pydantic.Field(..., description='')
...
class ModuleModel(pydantic.BaseModel):
    ...
    CfnJobDefinition_EcsPropertiesProperty: typing.Optional[dict[str, models.aws_batch.CfnJobDefinition_EcsPropertiesPropertyDef]] = pydantic.Field(None)
    CfnJobDefinition_EcsTaskPropertiesProperty: typing.Optional[dict[str, models.aws_batch.CfnJobDefinition_EcsTaskPropertiesPropertyDef]] = pydantic.Field(None)
    ...
    CfnJobDefinition_ImagePullSecretProperty: typing.Optional[dict[str, models.aws_batch.CfnJobDefinition_ImagePullSecretPropertyDef]] = pydantic.Field(None)
    ...
    CfnJobDefinition_RepositoryCredentialsProperty: typing.Optional[dict[str, models.aws_batch.CfnJobDefinition_RepositoryCredentialsPropertyDef]] = pydantic.Field(None)
    ...
    CfnJobDefinition_TaskContainerDependencyProperty: typing.Optional[dict[str, models.aws_batch.CfnJobDefinition_TaskContainerDependencyPropertyDef]] = pydantic.Field(None)
    CfnJobDefinition_TaskContainerPropertiesProperty: typing.Optional[dict[str, models.aws_batch.CfnJobDefinition_TaskContainerPropertiesPropertyDef]] = pydantic.Field(None)
    ...
    CfnJobQueue_JobStateTimeLimitActionProperty: typing.Optional[dict[str, models.aws_batch.CfnJobQueue_JobStateTimeLimitActionPropertyDef]] = pydantic.Field(None)
    ...
    JobStateTimeLimitAction: typing.Optional[dict[str, models.aws_batch.JobStateTimeLimitActionDef]] = pydantic.Field(None)
