...
class BucketDeploymentDef(BaseConstruct):
    ...
    log_retention: typing.Optional[aws_cdk.aws_logs.RetentionDays] = pydantic.Field(None, description="The number of days that the lambda function's log events are kept in CloudWatch Logs. This is a legacy API and we strongly recommend you migrate to ``logGroup`` if you can. ``logGroup`` allows you to create a fully customizable log group and instruct the Lambda function to send logs to it. Default: logs.RetentionDays.INFINITE\n")
    ...
    _init_params: typing.ClassVar[list[str]] = ['destination_bucket', 'sources', 'access_control', 'cache_control', 'content_disposition', 'content_encoding', 'content_language', 'content_type', 'destination_key_prefix', 'distribution', 'distribution_paths', 'ephemeral_storage_size', 'exclude', 'expires', 'extract', 'include', 'log_group', 'log_retention', 'memory_limit', 'metadata', 'prune', 'retain_on_delete', 'role', 'server_side_encryption', 'server_side_encryption_aws_kms_key_id', 'server_side_encryption_customer_algorithm', 'sign_content', 'storage_class', 'use_efs', 'vpc', 'vpc_subnets', 'website_redirect_location']
...
class DeployTimeSubstitutedFileDef(BaseConstruct):
    ...
    destination_key: typing.Optional[str] = pydantic.Field(None, description='The object key in the destination bucket where the processed file would be written to. Default: - Fingerprint of the file content would be used as object key\n')
    role: typing.Optional[typing.Union[models.aws_iam.LazyRoleDef, models.aws_iam.RoleDef]] = pydantic.Field(None, description='Execution role associated with this function. Default: - A role is automatically created')
    _init_params: typing.ClassVar[list[str]] = ['destination_bucket', 'source', 'substitutions', 'destination_key', 'role']
    _method_names: typing.ClassVar[list[str]] = ['add_source']
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_s3_deployment.DeployTimeSubstitutedFile'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class DeployTimeSubstitutedFileDefAddSourceParams(pydantic.BaseModel):
    source: models.UnsupportedResource = pydantic.Field(..., description='-\n\nExample::\n\n    # website_bucket: s3.IBucket\n\n    deployment = s3deploy.BucketDeployment(self, "Deployment",\n        sources=[s3deploy.Source.asset("./website-dist")],\n        destination_bucket=website_bucket\n    )\n\n    deployment.add_source(s3deploy.Source.asset("./another-asset"))\n')
    ...
...
class DeploymentSourceContextDef(BaseStruct):
    handler_role: typing.Union[_REQUIRED_INIT_PARAM, models.aws_iam.LazyRoleDef, models.aws_iam.RoleDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The role for the handler.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_iam as iam\n    from aws_cdk import aws_s3_deployment as s3_deployment\n\n    # role: iam.Role\n\n    deployment_source_context = s3_deployment.DeploymentSourceContext(\n        handler_role=role\n    )\n')
...
class DeployTimeSubstitutedFilePropsDef(BaseStruct):
    ...
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_s3_deployment.DeployTimeSubstitutedFileProps'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
