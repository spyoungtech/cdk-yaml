...
class CfnFHIRDatastoreDefConfig(pydantic.BaseModel):
    ...
    IdentityProviderConfigurationProperty: typing.Optional[list[CfnFHIRDatastoreDefIdentityproviderconfigurationpropertyParams]] = pydantic.Field(None, description='')
...
class ModuleModel(pydantic.BaseModel):
    ...
    CfnFHIRDatastore_IdentityProviderConfigurationProperty: typing.Optional[dict[str, CfnFHIRDatastore_IdentityProviderConfigurationPropertyDef]] = pydantic.Field(None)
