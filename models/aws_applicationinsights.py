...
class CfnApplicationDef(BaseCfnResource):
    ...
    attach_missing_permission: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='If set to true, the managed policies for SSM and CW will be attached to the instance roles if they are missing.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['resource_group_name', 'attach_missing_permission', 'auto_configuration_enabled', 'component_monitoring_settings', 'custom_components', 'cwe_monitor_enabled', 'grouping_type', 'log_pattern_sets', 'ops_center_enabled', 'ops_item_sns_topic_arn', 'tags']
