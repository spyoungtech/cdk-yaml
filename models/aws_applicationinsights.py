...
class CfnApplicationDefConfig(pydantic.BaseModel):
    AlarmMetricProperty: typing.Optional[list[CfnApplicationDefAlarmmetricpropertyParams]] = pydantic.Field(None, description='')
    AlarmProperty: typing.Optional[list[CfnApplicationDefAlarmpropertyParams]] = pydantic.Field(None, description='')
    ComponentConfigurationProperty: typing.Optional[list[CfnApplicationDefComponentconfigurationpropertyParams]] = pydantic.Field(None, description='')
    ComponentMonitoringSettingProperty: typing.Optional[list[CfnApplicationDefComponentmonitoringsettingpropertyParams]] = pydantic.Field(None, description='')
    ConfigurationDetailsProperty: typing.Optional[list[CfnApplicationDefConfigurationdetailspropertyParams]] = pydantic.Field(None, description='')
    CustomComponentProperty: typing.Optional[list[CfnApplicationDefCustomcomponentpropertyParams]] = pydantic.Field(None, description='')
    HAClusterPrometheusExporterProperty: typing.Optional[list[CfnApplicationDefHaclusterprometheusexporterpropertyParams]] = pydantic.Field(None, description='')
    HANAPrometheusExporterProperty: typing.Optional[list[CfnApplicationDefHanaprometheusexporterpropertyParams]] = pydantic.Field(None, description='')
    JMXPrometheusExporterProperty: typing.Optional[list[CfnApplicationDefJmxprometheusexporterpropertyParams]] = pydantic.Field(None, description='')
    LogPatternProperty: typing.Optional[list[CfnApplicationDefLogpatternpropertyParams]] = pydantic.Field(None, description='')
    LogPatternSetProperty: typing.Optional[list[CfnApplicationDefLogpatternsetpropertyParams]] = pydantic.Field(None, description='')
    LogProperty: typing.Optional[list[CfnApplicationDefLogpropertyParams]] = pydantic.Field(None, description='')
    SubComponentConfigurationDetailsProperty: typing.Optional[list[CfnApplicationDefSubcomponentconfigurationdetailspropertyParams]] = pydantic.Field(None, description='')
    SubComponentTypeConfigurationProperty: typing.Optional[list[CfnApplicationDefSubcomponenttypeconfigurationpropertyParams]] = pydantic.Field(None, description='')
    WindowsEventProperty: typing.Optional[list[CfnApplicationDefWindowseventpropertyParams]] = pydantic.Field(None, description='')
...
class ModuleModel(pydantic.BaseModel):
    CfnApplication_AlarmMetricProperty: typing.Optional[dict[str, CfnApplication_AlarmMetricPropertyDef]] = pydantic.Field(None)
    CfnApplication_AlarmProperty: typing.Optional[dict[str, CfnApplication_AlarmPropertyDef]] = pydantic.Field(None)
    CfnApplication_ComponentConfigurationProperty: typing.Optional[dict[str, CfnApplication_ComponentConfigurationPropertyDef]] = pydantic.Field(None)
    CfnApplication_ComponentMonitoringSettingProperty: typing.Optional[dict[str, CfnApplication_ComponentMonitoringSettingPropertyDef]] = pydantic.Field(None)
    CfnApplication_ConfigurationDetailsProperty: typing.Optional[dict[str, CfnApplication_ConfigurationDetailsPropertyDef]] = pydantic.Field(None)
    CfnApplication_CustomComponentProperty: typing.Optional[dict[str, CfnApplication_CustomComponentPropertyDef]] = pydantic.Field(None)
    CfnApplication_HAClusterPrometheusExporterProperty: typing.Optional[dict[str, CfnApplication_HAClusterPrometheusExporterPropertyDef]] = pydantic.Field(None)
    CfnApplication_HANAPrometheusExporterProperty: typing.Optional[dict[str, CfnApplication_HANAPrometheusExporterPropertyDef]] = pydantic.Field(None)
    CfnApplication_JMXPrometheusExporterProperty: typing.Optional[dict[str, CfnApplication_JMXPrometheusExporterPropertyDef]] = pydantic.Field(None)
    CfnApplication_LogPatternProperty: typing.Optional[dict[str, CfnApplication_LogPatternPropertyDef]] = pydantic.Field(None)
    CfnApplication_LogPatternSetProperty: typing.Optional[dict[str, CfnApplication_LogPatternSetPropertyDef]] = pydantic.Field(None)
    CfnApplication_LogProperty: typing.Optional[dict[str, CfnApplication_LogPropertyDef]] = pydantic.Field(None)
    CfnApplication_SubComponentConfigurationDetailsProperty: typing.Optional[dict[str, CfnApplication_SubComponentConfigurationDetailsPropertyDef]] = pydantic.Field(None)
    CfnApplication_SubComponentTypeConfigurationProperty: typing.Optional[dict[str, CfnApplication_SubComponentTypeConfigurationPropertyDef]] = pydantic.Field(None)
    CfnApplication_WindowsEventProperty: typing.Optional[dict[str, CfnApplication_WindowsEventPropertyDef]] = pydantic.Field(None)
