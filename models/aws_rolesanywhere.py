...
class CfnTrustAnchorDefConfig(pydantic.BaseModel):
    NotificationSettingProperty: typing.Optional[list[CfnTrustAnchorDefNotificationsettingpropertyParams]] = pydantic.Field(None, description='')
...
class ModuleModel(pydantic.BaseModel):
    CfnTrustAnchor_NotificationSettingProperty: typing.Optional[dict[str, CfnTrustAnchor_NotificationSettingPropertyDef]] = pydantic.Field(None)
