...
class CfnCalculatedAttributeDefinitionDef(BaseCfnResource):
    ...
    resource_config: typing.Optional[CfnCalculatedAttributeDefinitionDefConfig] = pydantic.Field(None)


class CfnCalculatedAttributeDefinitionDefConfig(pydantic.BaseModel):
    AttributeDetailsProperty: typing.Optional[list[CfnCalculatedAttributeDefinitionDefAttributedetailspropertyParams]] = pydantic.Field(None, description='')
    AttributeItemProperty: typing.Optional[list[CfnCalculatedAttributeDefinitionDefAttributeitempropertyParams]] = pydantic.Field(None, description='')
    ConditionsProperty: typing.Optional[list[CfnCalculatedAttributeDefinitionDefConditionspropertyParams]] = pydantic.Field(None, description='')
    RangeProperty: typing.Optional[list[CfnCalculatedAttributeDefinitionDefRangepropertyParams]] = pydantic.Field(None, description='')
    ThresholdProperty: typing.Optional[list[CfnCalculatedAttributeDefinitionDefThresholdpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[CfnCalculatedAttributeDefinitionDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[CfnCalculatedAttributeDefinitionDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[CfnCalculatedAttributeDefinitionDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[CfnCalculatedAttributeDefinitionDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[CfnCalculatedAttributeDefinitionDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[CfnCalculatedAttributeDefinitionDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[CfnCalculatedAttributeDefinitionDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[CfnCalculatedAttributeDefinitionDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[CfnCalculatedAttributeDefinitionDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[CfnCalculatedAttributeDefinitionDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[CfnCalculatedAttributeDefinitionDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[CfnCalculatedAttributeDefinitionDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[CfnCalculatedAttributeDefinitionDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
class CfnDomainDefConfig(pydantic.BaseModel):
    AttributeTypesSelectorProperty: typing.Optional[list[CfnDomainDefAttributetypesselectorpropertyParams]] = pydantic.Field(None, description='')
    AutoMergingProperty: typing.Optional[list[CfnDomainDefAutomergingpropertyParams]] = pydantic.Field(None, description='')
    ConflictResolutionProperty: typing.Optional[list[CfnDomainDefConflictresolutionpropertyParams]] = pydantic.Field(None, description='')
    ConsolidationProperty: typing.Optional[list[CfnDomainDefConsolidationpropertyParams]] = pydantic.Field(None, description='')
    DomainStatsProperty: typing.Optional[list[CfnDomainDefDomainstatspropertyParams]] = pydantic.Field(None, description='')
    ExportingConfigProperty: typing.Optional[list[CfnDomainDefExportingconfigpropertyParams]] = pydantic.Field(None, description='')
    JobScheduleProperty: typing.Optional[list[CfnDomainDefJobschedulepropertyParams]] = pydantic.Field(None, description='')
    MatchingProperty: typing.Optional[list[CfnDomainDefMatchingpropertyParams]] = pydantic.Field(None, description='')
    MatchingRuleProperty: typing.Optional[list[CfnDomainDefMatchingrulepropertyParams]] = pydantic.Field(None, description='')
    RuleBasedMatchingProperty: typing.Optional[list[CfnDomainDefRulebasedmatchingpropertyParams]] = pydantic.Field(None, description='')
    S3ExportingConfigProperty: typing.Optional[list[CfnDomainDefS3ExportingconfigpropertyParams]] = pydantic.Field(None, description='')
...
class CfnEventStreamDefConfig(pydantic.BaseModel):
    DestinationDetailsProperty: typing.Optional[list[CfnEventStreamDefDestinationdetailspropertyParams]] = pydantic.Field(None, description='')
...
class ModuleModel(pydantic.BaseModel):
    CfnCalculatedAttributeDefinition_AttributeDetailsProperty: typing.Optional[dict[str, CfnCalculatedAttributeDefinition_AttributeDetailsPropertyDef]] = pydantic.Field(None)
    CfnCalculatedAttributeDefinition_AttributeItemProperty: typing.Optional[dict[str, CfnCalculatedAttributeDefinition_AttributeItemPropertyDef]] = pydantic.Field(None)
    CfnCalculatedAttributeDefinition_ConditionsProperty: typing.Optional[dict[str, CfnCalculatedAttributeDefinition_ConditionsPropertyDef]] = pydantic.Field(None)
    CfnCalculatedAttributeDefinition_RangeProperty: typing.Optional[dict[str, CfnCalculatedAttributeDefinition_RangePropertyDef]] = pydantic.Field(None)
    CfnCalculatedAttributeDefinition_ThresholdProperty: typing.Optional[dict[str, CfnCalculatedAttributeDefinition_ThresholdPropertyDef]] = pydantic.Field(None)
    CfnDomain_AttributeTypesSelectorProperty: typing.Optional[dict[str, CfnDomain_AttributeTypesSelectorPropertyDef]] = pydantic.Field(None)
    CfnDomain_AutoMergingProperty: typing.Optional[dict[str, CfnDomain_AutoMergingPropertyDef]] = pydantic.Field(None)
    CfnDomain_ConflictResolutionProperty: typing.Optional[dict[str, CfnDomain_ConflictResolutionPropertyDef]] = pydantic.Field(None)
    CfnDomain_ConsolidationProperty: typing.Optional[dict[str, CfnDomain_ConsolidationPropertyDef]] = pydantic.Field(None)
    CfnDomain_DomainStatsProperty: typing.Optional[dict[str, CfnDomain_DomainStatsPropertyDef]] = pydantic.Field(None)
    CfnDomain_ExportingConfigProperty: typing.Optional[dict[str, CfnDomain_ExportingConfigPropertyDef]] = pydantic.Field(None)
    CfnDomain_JobScheduleProperty: typing.Optional[dict[str, CfnDomain_JobSchedulePropertyDef]] = pydantic.Field(None)
    CfnDomain_MatchingProperty: typing.Optional[dict[str, CfnDomain_MatchingPropertyDef]] = pydantic.Field(None)
    CfnDomain_MatchingRuleProperty: typing.Optional[dict[str, CfnDomain_MatchingRulePropertyDef]] = pydantic.Field(None)
    CfnDomain_RuleBasedMatchingProperty: typing.Optional[dict[str, CfnDomain_RuleBasedMatchingPropertyDef]] = pydantic.Field(None)
    CfnDomain_S3ExportingConfigProperty: typing.Optional[dict[str, CfnDomain_S3ExportingConfigPropertyDef]] = pydantic.Field(None)
    CfnEventStream_DestinationDetailsProperty: typing.Optional[dict[str, CfnEventStream_DestinationDetailsPropertyDef]] = pydantic.Field(None)
    ...
    CfnCalculatedAttributeDefinition: typing.Optional[dict[str, CfnCalculatedAttributeDefinitionDef]] = pydantic.Field(None)
    ...
    CfnCalculatedAttributeDefinitionProps: typing.Optional[dict[str, CfnCalculatedAttributeDefinitionPropsDef]] = pydantic.Field(None)
