...
class CfnDomainDef(BaseCfnResource):
    default_expiration_days: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The default number of days until the data within the domain expires.\n')
    domain_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The unique name of the domain.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['default_expiration_days', 'domain_name', 'dead_letter_queue_url', 'default_encryption_key', 'matching', 'rule_based_matching', 'tags']
...
class CfnObjectTypeDef(BaseCfnResource):
    description: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The description of the profile object type mapping.\n')
    domain_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The unique name of the domain.\n')
    object_type_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the profile object type.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['description', 'domain_name', 'object_type_name', 'allow_profile_creation', 'encryption_key', 'expiration_days', 'fields', 'keys', 'source_last_updated_timestamp_format', 'tags', 'template_id']
