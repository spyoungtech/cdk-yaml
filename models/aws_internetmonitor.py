...
class CfnMonitorDef(BaseCfnResource):
    ...
    include_linked_accounts: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description="A boolean option that you can set to ``TRUE`` to include monitors for linked accounts in a list of monitors, when you've set up cross-account sharing in Internet Monitor. You configure cross-account sharing by using Amazon CloudWatch Observability Access Manager. For more information, see `Internet Monitor cross-account observability <https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/cwim-cross-account.html>`_ in the Amazon CloudWatch User Guide.\n")
    ...
    linked_account_id: typing.Optional[str] = pydantic.Field(None, description="The account ID for an account that you've set up cross-account sharing for in Internet Monitor. You configure cross-account sharing by using Amazon CloudWatch Observability Access Manager. For more information, see `Internet Monitor cross-account observability <https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/cwim-cross-account.html>`_ in the Amazon CloudWatch User Guide.\n")
    ...
    _init_params: typing.ClassVar[list[str]] = ['monitor_name', 'health_events_config', 'include_linked_accounts', 'internet_measurements_log_delivery', 'linked_account_id', 'max_city_networks_to_monitor', 'resources', 'resources_to_add', 'resources_to_remove', 'status', 'tags', 'traffic_percentage_to_monitor']
