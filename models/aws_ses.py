...
class ConfigurationSetDef(BaseConstruct):
    ...
    vdm_options: typing.Union[models.aws_ses.VdmOptionsDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The Virtual Deliverability Manager (VDM) options that apply to the configuration set. Default: - VDM options not configured at the configuration set level. In this case, use account level settings. (To set the account level settings using CDK, use the ``VdmAttributes`` Construct.)')
    _init_params: typing.ClassVar[list[str]] = ['configuration_set_name', 'custom_tracking_redirect_domain', 'dedicated_ip_pool', 'reputation_metrics', 'sending_enabled', 'suppression_reasons', 'tls_policy', 'vdm_options']
...
class DedicatedIpPoolDef(BaseConstruct):
    dedicated_ip_pool_name: typing.Optional[str] = pydantic.Field(None, description='A name for the dedicated IP pool. The name must adhere to specific constraints: it can only include lowercase letters (a-z), numbers (0-9), underscores (_), and hyphens (-), and must not exceed 64 characters in length. Default: - a CloudFormation generated name\n')
    scaling_mode: typing.Optional[aws_cdk.aws_ses.ScalingMode] = pydantic.Field(None, description="The type of scailing mode to use for this IP pool. Updating ScalingMode doesn't require a replacement if you're updating its value from ``STANDARD`` to ``MANAGED``. However, updating ScalingMode from ``MANAGED`` to ``STANDARD`` is not supported. Default: ScalingMode.STANDARD")
    _init_params: typing.ClassVar[list[str]] = ['dedicated_ip_pool_name', 'scaling_mode']
    _method_names: typing.ClassVar[list[str]] = ['apply_removal_policy']
...
class EmailIdentityDef(BaseConstruct):
    ...
    _method_names: typing.ClassVar[list[str]] = ['apply_removal_policy', 'grant', 'grant_send_email']
...
class EmailIdentityDefConfig(pydantic.BaseModel):
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    grant: typing.Optional[list[models.aws_ses.EmailIdentityDefGrantParams]] = pydantic.Field(None, description="Adds an IAM policy statement associated with this email identity to an IAM principal's policy.")
    grant_send_email: typing.Optional[list[models.aws_ses.EmailIdentityDefGrantSendEmailParams]] = pydantic.Field(None, description='Permits an IAM principal the send email action.\nActions: SendEmail, SendRawEmail.')
...
class EmailIdentityDefGrantParams(pydantic.BaseModel):
...
class EmailIdentityDefGrantSendEmailParams(pydantic.BaseModel):
...
class ReceiptRuleDefAddActionParams(pydantic.BaseModel):
    action: typing.Union[models.aws_ses_actions.AddHeaderDef, models.aws_ses_actions.BounceDef, models.aws_ses_actions.LambdaDef, models.aws_ses_actions.S3Def, models.aws_ses_actions.SnsDef, models.aws_ses_actions.StopDef, models.aws_ses_actions.WorkMailDef] = pydantic.Field(..., description='-')
    ...
...
class VdmAttributesDef(BaseConstruct):
    ...
    from_vdm_attributes_name: typing.Optional[models.aws_ses.VdmAttributesDefFromVdmAttributesNameParams] = pydantic.Field(None, description='Use an existing Virtual Deliverability Manager attributes resource.')
...
class CfnConfigurationSetEventDestination_EventDestinationPropertyDef(BaseStruct):
    ...
    event_bridge_destination: typing.Union[models.UnsupportedResource, aws_cdk.aws_ses.CfnConfigurationSetEventDestination.EventBridgeDestinationProperty, dict[str, typing.Any], None] = pydantic.Field(None, description='An object that contains Event bus ARN associated with the event bridge destination.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['matching_event_types', 'cloud_watch_destination', 'enabled', 'event_bridge_destination', 'kinesis_firehose_destination', 'name', 'sns_destination']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
#  autogenerated from aws_cdk.aws_ses.VdmOptions
class VdmOptionsDef(BaseStruct):
    engagement_metrics: typing.Optional[bool] = pydantic.Field(None, description='If true, engagement metrics are enabled for the configuration set. Default: - Engagement metrics not configured at the configuration set level. In this case, use account level settings.\n')
    optimized_shared_delivery: typing.Optional[bool] = pydantic.Field(None, description='If true, optimized shared delivery is enabled for the configuration set. Default: - Optimized shared delivery not configured at the configuration set level. In this case, use account level settings.\n\n:exampleMetadata: infused\n\nExample::\n\n    ses.ConfigurationSet(self, "ConfigurationSetWithVdmOptions",\n        vdm_options=ses.VdmOptions(\n            engagement_metrics=True,\n            optimized_shared_delivery=True\n        )\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['engagement_metrics', 'optimized_shared_delivery']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_ses.VdmOptions'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
#  autogenerated from aws_cdk.aws_ses.ScalingMode
# skipping emum
...
class CfnConfigurationSetEventDestinationDef(BaseCfnResource):
    ...
    _method_names: typing.ClassVar[list[str]] = ['CloudWatchDestinationProperty', 'DimensionConfigurationProperty', 'EventBridgeDestinationProperty', 'EventDestinationProperty', 'KinesisFirehoseDestinationProperty', 'SnsDestinationProperty', 'add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnConfigurationSetEventDestinationDefConfig(pydantic.BaseModel):
    ...
    EventBridgeDestinationProperty: typing.Optional[list[models.aws_ses.CfnConfigurationSetEventDestinationDefEventbridgedestinationpropertyParams]] = pydantic.Field(None, description='')
...
class CfnConfigurationSetEventDestinationDefEventbridgedestinationpropertyParams(pydantic.BaseModel):
...
class CfnConfigurationSetEventDestinationDefEventdestinationpropertyParams(pydantic.BaseModel):
    ...
    event_bridge_destination: typing.Union[models.UnsupportedResource, aws_cdk.aws_ses.CfnConfigurationSetEventDestination.EventBridgeDestinationProperty, dict[str, typing.Any], None] = pydantic.Field(None, description='')
...
class ModuleModel(pydantic.BaseModel):
    ...
    VdmOptions: typing.Optional[dict[str, models.aws_ses.VdmOptionsDef]] = pydantic.Field(None)
