...
class CfnRobotApplication_RobotSoftwareSuitePropertyDef(BaseStruct):
    name: str = pydantic.Field(..., description='The name of the robot software suite. ``General`` is the only supported value.\n')
...
class CfnRobotApplication_SourceConfigPropertyDef(BaseStruct):
    architecture: str = pydantic.Field(..., description='The target processor architecture for the application.\n')
    s3_bucket: str = pydantic.Field(..., description='The Amazon S3 bucket name.\n')
    s3_key: str = pydantic.Field(..., description='The s3 object key.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-robomaker-robotapplication-sourceconfig.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_robomaker as robomaker\n\n    source_config_property = robomaker.CfnRobotApplication.SourceConfigProperty(\n        architecture="architecture",\n        s3_bucket="s3Bucket",\n        s3_key="s3Key"\n    )\n')
...
class CfnSimulationApplication_SimulationSoftwareSuitePropertyDef(BaseStruct):
    name: str = pydantic.Field(..., description='The name of the simulation software suite. ``SimulationRuntime`` is the only supported value.\n')
...
class CfnRobotDef(BaseCfnResource):
    architecture: str = pydantic.Field(..., description='The architecture of the robot.\n')
    greengrass_group_id: str = pydantic.Field(..., description='The Greengrass group associated with the robot.\n')
...
class CfnRobotApplicationDef(BaseCfnResource):
    robot_software_suite: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_robomaker.CfnRobotApplication_RobotSoftwareSuitePropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='The robot software suite used by the robot application.\n')
    ...
    sources: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_robomaker.CfnRobotApplication_SourceConfigPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The sources of the robot application.\n')
...
class CfnRobotApplicationVersionDef(BaseCfnResource):
    application: str = pydantic.Field(..., description='The application information for the robot application.\n')
...
class CfnSimulationApplicationDef(BaseCfnResource):
    robot_software_suite: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_robomaker.CfnSimulationApplication_RobotSoftwareSuitePropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='The robot software suite used by the simulation application.\n')
    simulation_software_suite: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_robomaker.CfnSimulationApplication_SimulationSoftwareSuitePropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='The simulation software suite used by the simulation application.\n')
    current_revision_id: typing.Optional[str] = pydantic.Field(None, description='The current revision id.\n')
    ...
    rendering_engine: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_robomaker.CfnSimulationApplication_RenderingEnginePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The rendering engine for the simulation application.\n')
    sources: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_robomaker.CfnSimulationApplication_SourceConfigPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The sources of the simulation application.\n')
...
class CfnSimulationApplicationVersionDef(BaseCfnResource):
    application: str = pydantic.Field(..., description='The application information for the simulation application.\n')
