...
class CfnEndpoint_IbmDb2SettingsPropertyDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['current_lsn', 'max_k_bytes_per_read', 'secrets_manager_access_role_arn', 'secrets_manager_secret_id', 'set_data_capture_changes']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnEndpoint_PostgreSqlSettingsPropertyDef(BaseStruct):
    ...
    ddl_artifacts_schema: typing.Optional[str] = pydantic.Field(None, description='The schema in which the operational DDL database artifacts are created. Example: ``ddlArtifactsSchema=xyzddlschema;``\n')
    ...
    fail_tasks_on_lob_truncation: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='When set to ``true`` , this value causes a task to fail if the actual size of a LOB column is greater than the specified ``LobMaxSize`` . If task is set to Limited LOB mode and this option is set to true, the task fails instead of truncating the LOB data.\n')
    ...
    heartbeat_frequency: typing.Union[int, float, None] = pydantic.Field(None, description='Sets the WAL heartbeat frequency (in minutes).\n')
    heartbeat_schema: typing.Optional[str] = pydantic.Field(None, description='Sets the schema in which the heartbeat artifacts are created.\n')
    map_boolean_as_boolean: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='When true, lets PostgreSQL migrate the boolean type as boolean. By default, PostgreSQL migrates booleans as ``varchar(5)`` . You must set this setting on both the source and target endpoints for it to take effect.\n')
    max_file_size: typing.Union[int, float, None] = pydantic.Field(None, description='Specifies the maximum size (in KB) of any .csv file used to transfer data to PostgreSQL. Example: ``maxFileSize=512``\n')
    plugin_name: typing.Optional[str] = pydantic.Field(None, description='Specifies the plugin to use to create a replication slot.\n')
...
class CfnEndpoint_S3SettingsPropertyDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['add_column_name', 'bucket_folder', 'bucket_name', 'canned_acl_for_objects', 'cdc_inserts_and_updates', 'cdc_inserts_only', 'cdc_max_batch_interval', 'cdc_min_file_size', 'cdc_path', 'compression_type', 'csv_delimiter', 'csv_no_sup_value', 'csv_null_value', 'csv_row_delimiter', 'data_format', 'data_page_size', 'date_partition_delimiter', 'date_partition_enabled', 'date_partition_sequence', 'date_partition_timezone', 'dict_page_size_limit', 'enable_statistics', 'encoding_type', 'encryption_mode', 'external_table_definition', 'ignore_header_rows', 'include_op_for_full_load', 'max_file_size', 'parquet_timestamp_in_millisecond', 'parquet_version', 'preserve_transactions', 'rfc4180', 'row_group_length', 'server_side_encryption_kms_key_id', 'service_access_role_arn', 'timestamp_column_name', 'use_csv_no_sup_value', 'use_task_start_time_for_full_load_timestamp']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnEndpointDefConfig(pydantic.BaseModel):
    DocDbSettingsProperty: typing.Optional[list[CfnEndpointDefDocdbsettingspropertyParams]] = pydantic.Field(None, description='')
    DynamoDbSettingsProperty: typing.Optional[list[CfnEndpointDefDynamodbsettingspropertyParams]] = pydantic.Field(None, description='')
    ElasticsearchSettingsProperty: typing.Optional[list[CfnEndpointDefElasticsearchsettingspropertyParams]] = pydantic.Field(None, description='')
    GcpMySQLSettingsProperty: typing.Optional[list[CfnEndpointDefGcpmysqlsettingspropertyParams]] = pydantic.Field(None, description='')
    IbmDb2SettingsProperty: typing.Optional[list[CfnEndpointDefIbmdb2SettingspropertyParams]] = pydantic.Field(None, description='')
    KafkaSettingsProperty: typing.Optional[list[CfnEndpointDefKafkasettingspropertyParams]] = pydantic.Field(None, description='')
    KinesisSettingsProperty: typing.Optional[list[CfnEndpointDefKinesissettingspropertyParams]] = pydantic.Field(None, description='')
    MicrosoftSqlServerSettingsProperty: typing.Optional[list[CfnEndpointDefMicrosoftsqlserversettingspropertyParams]] = pydantic.Field(None, description='')
    MongoDbSettingsProperty: typing.Optional[list[CfnEndpointDefMongodbsettingspropertyParams]] = pydantic.Field(None, description='')
    MySqlSettingsProperty: typing.Optional[list[CfnEndpointDefMysqlsettingspropertyParams]] = pydantic.Field(None, description='')
    NeptuneSettingsProperty: typing.Optional[list[CfnEndpointDefNeptunesettingspropertyParams]] = pydantic.Field(None, description='')
    OracleSettingsProperty: typing.Optional[list[CfnEndpointDefOraclesettingspropertyParams]] = pydantic.Field(None, description='')
    PostgreSqlSettingsProperty: typing.Optional[list[CfnEndpointDefPostgresqlsettingspropertyParams]] = pydantic.Field(None, description='')
    RedisSettingsProperty: typing.Optional[list[CfnEndpointDefRedissettingspropertyParams]] = pydantic.Field(None, description='')
    RedshiftSettingsProperty: typing.Optional[list[CfnEndpointDefRedshiftsettingspropertyParams]] = pydantic.Field(None, description='')
    S3SettingsProperty: typing.Optional[list[CfnEndpointDefS3SettingspropertyParams]] = pydantic.Field(None, description='')
    SybaseSettingsProperty: typing.Optional[list[CfnEndpointDefSybasesettingspropertyParams]] = pydantic.Field(None, description='')
...
class CfnReplicationConfigDef(BaseCfnResource):
    ...
    resource_config: typing.Optional[CfnReplicationConfigDefConfig] = pydantic.Field(None)


class CfnReplicationConfigDefConfig(pydantic.BaseModel):
    ComputeConfigProperty: typing.Optional[list[CfnReplicationConfigDefComputeconfigpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[CfnReplicationConfigDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[CfnReplicationConfigDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[CfnReplicationConfigDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[CfnReplicationConfigDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[CfnReplicationConfigDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[CfnReplicationConfigDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[CfnReplicationConfigDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[CfnReplicationConfigDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[CfnReplicationConfigDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[CfnReplicationConfigDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[CfnReplicationConfigDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[CfnReplicationConfigDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[CfnReplicationConfigDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
class CfnReplicationInstanceDef(BaseCfnResource):
    ...
    resource_config: typing.Optional[CfnReplicationInstanceDefConfig] = pydantic.Field(None)


class CfnReplicationInstanceDefConfig(pydantic.BaseModel):
    add_deletion_override: typing.Optional[list[CfnReplicationInstanceDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[CfnReplicationInstanceDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[CfnReplicationInstanceDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[CfnReplicationInstanceDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[CfnReplicationInstanceDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[CfnReplicationInstanceDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[CfnReplicationInstanceDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[CfnReplicationInstanceDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[CfnReplicationInstanceDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[CfnReplicationInstanceDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[CfnReplicationInstanceDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[CfnReplicationInstanceDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[CfnReplicationInstanceDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
    tags_config: typing.Optional[models.core.TagManagerDefConfig] = pydantic.Field(None)
...
class CfnReplicationSubnetGroupDef(BaseCfnResource):
    ...
    resource_config: typing.Optional[CfnReplicationSubnetGroupDefConfig] = pydantic.Field(None)


class CfnReplicationSubnetGroupDefConfig(pydantic.BaseModel):
    add_deletion_override: typing.Optional[list[CfnReplicationSubnetGroupDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[CfnReplicationSubnetGroupDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[CfnReplicationSubnetGroupDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[CfnReplicationSubnetGroupDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[CfnReplicationSubnetGroupDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[CfnReplicationSubnetGroupDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[CfnReplicationSubnetGroupDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[CfnReplicationSubnetGroupDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[CfnReplicationSubnetGroupDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[CfnReplicationSubnetGroupDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[CfnReplicationSubnetGroupDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[CfnReplicationSubnetGroupDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[CfnReplicationSubnetGroupDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
    tags_config: typing.Optional[models.core.TagManagerDefConfig] = pydantic.Field(None)
...
class CfnReplicationTaskDef(BaseCfnResource):
    ...
    resource_config: typing.Optional[CfnReplicationTaskDefConfig] = pydantic.Field(None)


class CfnReplicationTaskDefConfig(pydantic.BaseModel):
    add_deletion_override: typing.Optional[list[CfnReplicationTaskDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[CfnReplicationTaskDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[CfnReplicationTaskDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[CfnReplicationTaskDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[CfnReplicationTaskDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[CfnReplicationTaskDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[CfnReplicationTaskDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[CfnReplicationTaskDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[CfnReplicationTaskDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[CfnReplicationTaskDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[CfnReplicationTaskDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[CfnReplicationTaskDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[CfnReplicationTaskDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
    tags_config: typing.Optional[models.core.TagManagerDefConfig] = pydantic.Field(None)
...
class ModuleModel(pydantic.BaseModel):
    CfnEndpoint_DocDbSettingsProperty: typing.Optional[dict[str, CfnEndpoint_DocDbSettingsPropertyDef]] = pydantic.Field(None)
    CfnEndpoint_DynamoDbSettingsProperty: typing.Optional[dict[str, CfnEndpoint_DynamoDbSettingsPropertyDef]] = pydantic.Field(None)
    CfnEndpoint_ElasticsearchSettingsProperty: typing.Optional[dict[str, CfnEndpoint_ElasticsearchSettingsPropertyDef]] = pydantic.Field(None)
    CfnEndpoint_GcpMySQLSettingsProperty: typing.Optional[dict[str, CfnEndpoint_GcpMySQLSettingsPropertyDef]] = pydantic.Field(None)
    CfnEndpoint_IbmDb2SettingsProperty: typing.Optional[dict[str, CfnEndpoint_IbmDb2SettingsPropertyDef]] = pydantic.Field(None)
    CfnEndpoint_KafkaSettingsProperty: typing.Optional[dict[str, CfnEndpoint_KafkaSettingsPropertyDef]] = pydantic.Field(None)
    CfnEndpoint_KinesisSettingsProperty: typing.Optional[dict[str, CfnEndpoint_KinesisSettingsPropertyDef]] = pydantic.Field(None)
    CfnEndpoint_MicrosoftSqlServerSettingsProperty: typing.Optional[dict[str, CfnEndpoint_MicrosoftSqlServerSettingsPropertyDef]] = pydantic.Field(None)
    CfnEndpoint_MongoDbSettingsProperty: typing.Optional[dict[str, CfnEndpoint_MongoDbSettingsPropertyDef]] = pydantic.Field(None)
    CfnEndpoint_MySqlSettingsProperty: typing.Optional[dict[str, CfnEndpoint_MySqlSettingsPropertyDef]] = pydantic.Field(None)
    CfnEndpoint_NeptuneSettingsProperty: typing.Optional[dict[str, CfnEndpoint_NeptuneSettingsPropertyDef]] = pydantic.Field(None)
    CfnEndpoint_OracleSettingsProperty: typing.Optional[dict[str, CfnEndpoint_OracleSettingsPropertyDef]] = pydantic.Field(None)
    CfnEndpoint_PostgreSqlSettingsProperty: typing.Optional[dict[str, CfnEndpoint_PostgreSqlSettingsPropertyDef]] = pydantic.Field(None)
    CfnEndpoint_RedisSettingsProperty: typing.Optional[dict[str, CfnEndpoint_RedisSettingsPropertyDef]] = pydantic.Field(None)
    CfnEndpoint_RedshiftSettingsProperty: typing.Optional[dict[str, CfnEndpoint_RedshiftSettingsPropertyDef]] = pydantic.Field(None)
    CfnEndpoint_S3SettingsProperty: typing.Optional[dict[str, CfnEndpoint_S3SettingsPropertyDef]] = pydantic.Field(None)
    CfnEndpoint_SybaseSettingsProperty: typing.Optional[dict[str, CfnEndpoint_SybaseSettingsPropertyDef]] = pydantic.Field(None)
    CfnReplicationConfig_ComputeConfigProperty: typing.Optional[dict[str, CfnReplicationConfig_ComputeConfigPropertyDef]] = pydantic.Field(None)
    ...
    CfnReplicationConfig: typing.Optional[dict[str, CfnReplicationConfigDef]] = pydantic.Field(None)
    CfnReplicationInstance: typing.Optional[dict[str, CfnReplicationInstanceDef]] = pydantic.Field(None)
    CfnReplicationSubnetGroup: typing.Optional[dict[str, CfnReplicationSubnetGroupDef]] = pydantic.Field(None)
    CfnReplicationTask: typing.Optional[dict[str, CfnReplicationTaskDef]] = pydantic.Field(None)
    ...
    CfnReplicationConfigProps: typing.Optional[dict[str, CfnReplicationConfigPropsDef]] = pydantic.Field(None)
    CfnReplicationInstanceProps: typing.Optional[dict[str, CfnReplicationInstancePropsDef]] = pydantic.Field(None)
    CfnReplicationSubnetGroupProps: typing.Optional[dict[str, CfnReplicationSubnetGroupPropsDef]] = pydantic.Field(None)
    CfnReplicationTaskProps: typing.Optional[dict[str, CfnReplicationTaskPropsDef]] = pydantic.Field(None)
    ...
