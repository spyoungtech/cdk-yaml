...
class CfnApplicationDef(BaseCfnResource):
    application_name: str = pydantic.Field(..., description='The name of the web application.\n')
    role_arn: str = pydantic.Field(..., description='The ARN of the role that the web application assumes when it interacts with AWS IoT Core . .. epigraph:: The name of the role must be in the form ``FleetHub_random_string`` . Pattern: ``^arn:[!-~]+$``\n')
