...
class BucketBaseDef(BaseClass):
    ...
    resource_config: typing.Optional[BucketBaseDefConfig] = pydantic.Field(None)


class BucketBaseDefConfig(pydantic.BaseModel):
    add_event_notification: typing.Optional[list[BucketBaseDefAddEventNotificationParams]] = pydantic.Field(None, description='Adds a bucket notification event destination.')
    add_object_created_notification: typing.Optional[list[BucketBaseDefAddObjectCreatedNotificationParams]] = pydantic.Field(None, description='Subscribes a destination to receive notifications when an object is created in the bucket.\nThis is identical to calling\n``onEvent(EventType.OBJECT_CREATED)``.')
    add_object_removed_notification: typing.Optional[list[BucketBaseDefAddObjectRemovedNotificationParams]] = pydantic.Field(None, description='Subscribes a destination to receive notifications when an object is removed from the bucket.\nThis is identical to calling\n``onEvent(EventType.OBJECT_REMOVED)``.')
    add_to_resource_policy: typing.Optional[list[BucketBaseDefAddToResourcePolicyParams]] = pydantic.Field(None, description="Adds a statement to the resource policy for a principal (i.e. account/role/service) to perform actions on this bucket and/or its contents. Use ``bucketArn`` and ``arnForObjects(keys)`` to obtain ARNs for this bucket or objects.\nNote that the policy statement may or may not be added to the policy.\nFor example, when an ``IBucket`` is created from an existing bucket,\nit's not possible to tell whether the bucket already has a policy\nattached, let alone to re-use that policy to add more statements to it.\nSo it's safest to do nothing in these cases.")
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    arn_for_objects: typing.Optional[list[BucketBaseDefArnForObjectsParams]] = pydantic.Field(None, description='Returns an ARN that represents all objects within the bucket that match the key pattern specified.\nTo represent all keys, specify ``"*"``.\n\nIf you need to specify a keyPattern with multiple components, concatenate them into a single string, e.g.:\n\narnForObjects(``home/${team}/${user}/*``)')
    ...
    grant_delete: typing.Optional[list[BucketBaseDefGrantDeleteParams]] = pydantic.Field(None, description='Grants s3:DeleteObject* permission to an IAM principal for objects in this bucket.')
    grant_public_access: typing.Optional[list[BucketBaseDefGrantPublicAccessParams]] = pydantic.Field(None, description='Allows unrestricted access to objects from this bucket.\nIMPORTANT: This permission allows anyone to perform actions on S3 objects\nin this bucket, which is useful for when you configure your bucket as a\nwebsite and want everyone to be able to read objects in the bucket without\nneeding to authenticate.\n\nWithout arguments, this method will grant read ("s3:GetObject") access to\nall objects ("*") in the bucket.\n\nThe method returns the ``iam.Grant`` object, which can then be modified\nas needed. For example, you can add a condition that will restrict access only\nto an IPv4 range like this::\n\n   const grant = bucket.grantPublicAccess();\n   grant.resourceStatement!.addCondition(‘IpAddress’, { “aws:SourceIp”: “54.240.143.0/24” });\n\nNote that if this ``IBucket`` refers to an existing bucket, possibly not\nmanaged by CloudFormation, this method will have no effect, since it\'s\nimpossible to modify the policy of an existing bucket.')
    grant_put: typing.Optional[list[BucketBaseDefGrantPutParams]] = pydantic.Field(None, description='Grants s3:PutObject* and s3:Abort* permissions for this bucket to an IAM principal.\nIf encryption is used, permission to use the key to encrypt the contents\nof written files will also be granted to the same principal.')
    grant_put_acl: typing.Optional[list[BucketBaseDefGrantPutAclParams]] = pydantic.Field(None, description="Grant the given IAM identity permissions to modify the ACLs of objects in the given Bucket.\nIf your application has the '@aws-cdk/aws-s3:grantWriteWithoutAcl' feature flag set,\ncalling ``grantWrite`` or ``grantReadWrite`` no longer grants permissions to modify the ACLs of the objects;\nin this case, if you need to modify object ACLs, call this method explicitly.")
    grant_read: typing.Optional[list[BucketBaseDefGrantReadParams]] = pydantic.Field(None, description="Grant read permissions for this bucket and it's contents to an IAM principal (Role/Group/User).\nIf encryption is used, permission to use the key to decrypt the contents\nof the bucket will also be granted to the same principal.")
    grant_read_write: typing.Optional[list[BucketBaseDefGrantReadWriteParams]] = pydantic.Field(None, description="Grants read/write permissions for this bucket and it's contents to an IAM principal (Role/Group/User).\nIf an encryption key is used, permission to use the key for\nencrypt/decrypt will also be granted.\n\nBefore CDK version 1.85.0, this method granted the ``s3:PutObject*`` permission that included ``s3:PutObjectAcl``,\nwhich could be used to grant read/write object access to IAM principals in other accounts.\nIf you want to get rid of that behavior, update your CDK version to 1.85.0 or later,\nand make sure the ``@aws-cdk/aws-s3:grantWriteWithoutAcl`` feature flag is set to ``true``\nin the ``context`` key of your cdk.json file.\nIf you've already updated, but still need the principal to have permissions to modify the ACLs,\nuse the ``grantPutAcl`` method.")
    grant_write: typing.Optional[list[BucketBaseDefGrantWriteParams]] = pydantic.Field(None, description="Grant write permissions to this bucket to an IAM principal.\nIf encryption is used, permission to use the key to encrypt the contents\nof written files will also be granted to the same principal.\n\nBefore CDK version 1.85.0, this method granted the ``s3:PutObject*`` permission that included ``s3:PutObjectAcl``,\nwhich could be used to grant read/write object access to IAM principals in other accounts.\nIf you want to get rid of that behavior, update your CDK version to 1.85.0 or later,\nand make sure the ``@aws-cdk/aws-s3:grantWriteWithoutAcl`` feature flag is set to ``true``\nin the ``context`` key of your cdk.json file.\nIf you've already updated, but still need the principal to have permissions to modify the ACLs,\nuse the ``grantPutAcl`` method.")
    on_cloud_trail_event: typing.Optional[list[BucketBaseDefOnCloudTrailEventParams]] = pydantic.Field(None, description='Define a CloudWatch event that triggers when something happens to this repository.\nRequires that there exists at least one CloudTrail Trail in your account\nthat captures the event. This method will not create the Trail.')
    on_cloud_trail_put_object: typing.Optional[list[BucketBaseDefOnCloudTrailPutObjectParams]] = pydantic.Field(None, description='Defines an AWS CloudWatch event that triggers when an object is uploaded to the specified paths (keys) in this bucket using the PutObject API call.\nNote that some tools like ``aws s3 cp`` will automatically use either\nPutObject or the multipart upload API depending on the file size,\nso using ``onCloudTrailWriteObject`` may be preferable.\n\nRequires that there exists at least one CloudTrail Trail in your account\nthat captures the event. This method will not create the Trail.')
    on_cloud_trail_write_object: typing.Optional[list[BucketBaseDefOnCloudTrailWriteObjectParams]] = pydantic.Field(None, description='Defines an AWS CloudWatch event that triggers when an object at the specified paths (keys) in this bucket are written to.\nThis includes\nthe events PutObject, CopyObject, and CompleteMultipartUpload.\n\nNote that some tools like ``aws s3 cp`` will automatically use either\nPutObject or the multipart upload API depending on the file size,\nso using this method may be preferable to ``onCloudTrailPutObject``.\n\nRequires that there exists at least one CloudTrail Trail in your account\nthat captures the event. This method will not create the Trail.')
    s3_url_for_object: typing.Optional[list[BucketBaseDefS3UrlForObjectParams]] = pydantic.Field(None, description='The S3 URL of an S3 object. For example:.\n- ``s3://onlybucket``\n- ``s3://bucket/key``')
    transfer_acceleration_url_for_object: typing.Optional[list[BucketBaseDefTransferAccelerationUrlForObjectParams]] = pydantic.Field(None, description='The https Transfer Acceleration URL of an S3 object.\nSpecify ``dualStack: true`` at the options\nfor dual-stack endpoint (connect to the bucket over IPv6). For example:\n\n- ``https://bucket.s3-accelerate.amazonaws.com``\n- ``https://bucket.s3-accelerate.amazonaws.com/key``')
    url_for_object: typing.Optional[list[BucketBaseDefUrlForObjectParams]] = pydantic.Field(None, description='The https URL of an S3 object. Specify ``regional: false`` at the options for non-regional URLs. For example:.\n- ``https://s3.us-west-1.amazonaws.com/onlybucket``\n- ``https://s3.us-west-1.amazonaws.com/bucket/key``\n- ``https://s3.cn-north-1.amazonaws.com.cn/china-bucket/mykey``')
    virtual_hosted_url_for_object: typing.Optional[list[BucketBaseDefVirtualHostedUrlForObjectParams]] = pydantic.Field(None, description='The virtual hosted-style URL of an S3 object. Specify ``regional: false`` at the options for non-regional URL. For example:.\n- ``https://only-bucket.s3.us-west-1.amazonaws.com``\n- ``https://bucket.s3.us-west-1.amazonaws.com/key``\n- ``https://bucket.s3.amazonaws.com/key``\n- ``https://china-bucket.s3.cn-north-1.amazonaws.com.cn/mykey``')
...
class ReplaceKeyDef(BaseClass):
    ...
    resource_config: typing.Optional[ReplaceKeyDefConfig] = pydantic.Field(None)


class ReplaceKeyDefConfig(pydantic.BaseModel):
    prefix_with: typing.Optional[list[ReplaceKeyDefPrefixWithParams]] = pydantic.Field(None, description='The object key prefix to use in the redirect request.')
    with_: typing.Optional[list[ReplaceKeyDefWithParams]] = pydantic.Field(None, description='The specific object key to use in the redirect request.')
...
class BucketDef(BaseConstruct):
    ...
    encryption: typing.Optional[aws_cdk.aws_s3.BucketEncryption] = pydantic.Field(None, description='The kind of server-side encryption to apply to this bucket. If you choose KMS, you can specify a KMS key via ``encryptionKey``. If encryption key is not specified, a key will automatically be created. Default: - ``Kms`` if ``encryptionKey`` is specified, or ``Managed`` otherwise.\n')
    encryption_key: typing.Optional[typing.Union[models.aws_kms.KeyDef]] = pydantic.Field(None, description='External KMS key to use for bucket encryption. The \'encryption\' property must be either not specified or set to "Kms". An error will be emitted if encryption is set to "Unencrypted" or "Managed". Default: - If encryption is set to "Kms" and this property is undefined, a new KMS key will be created and associated with this bucket.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['access_control', 'auto_delete_objects', 'block_public_access', 'bucket_key_enabled', 'bucket_name', 'cors', 'encryption', 'encryption_key', 'enforce_ssl', 'event_bridge_enabled', 'intelligent_tiering_configurations', 'inventories', 'lifecycle_rules', 'metrics', 'notifications_handler_role', 'object_lock_default_retention', 'object_lock_enabled', 'object_ownership', 'public_read_access', 'removal_policy', 'server_access_logs_bucket', 'server_access_logs_prefix', 'transfer_acceleration', 'versioned', 'website_error_document', 'website_index_document', 'website_redirect', 'website_routing_rules']
    ...
    from_bucket_arn: typing.Optional[BucketDefFromBucketArnParams] = pydantic.Field(None, description='')
    from_bucket_attributes: typing.Optional[BucketDefFromBucketAttributesParams] = pydantic.Field(None, description='Creates a Bucket construct that represents an external bucket.')
    from_bucket_name: typing.Optional[BucketDefFromBucketNameParams] = pydantic.Field(None, description='')
    from_cfn_bucket: typing.Optional[BucketDefFromCfnBucketParams] = pydantic.Field(None, description='Create a mutable ``IBucket`` based on a low-level ``CfnBucket``.')
    resource_config: typing.Optional[BucketDefConfig] = pydantic.Field(None)


class BucketDefConfig(pydantic.BaseModel):
    add_cors_rule: typing.Optional[list[BucketDefAddCorsRuleParams]] = pydantic.Field(None, description='Adds a cross-origin access configuration for objects in an Amazon S3 bucket.')
    add_event_notification: typing.Optional[list[BucketDefAddEventNotificationParams]] = pydantic.Field(None, description='Adds a bucket notification event destination.')
    add_inventory: typing.Optional[list[BucketDefAddInventoryParams]] = pydantic.Field(None, description='Add an inventory configuration.')
    add_lifecycle_rule: typing.Optional[list[BucketDefAddLifecycleRuleParams]] = pydantic.Field(None, description='Add a lifecycle rule to the bucket.')
    add_metric: typing.Optional[list[BucketDefAddMetricParams]] = pydantic.Field(None, description='Adds a metrics configuration for the CloudWatch request metrics from the bucket.')
    add_object_created_notification: typing.Optional[list[BucketDefAddObjectCreatedNotificationParams]] = pydantic.Field(None, description='Subscribes a destination to receive notifications when an object is created in the bucket.\nThis is identical to calling\n``onEvent(EventType.OBJECT_CREATED)``.')
    add_object_removed_notification: typing.Optional[list[BucketDefAddObjectRemovedNotificationParams]] = pydantic.Field(None, description='Subscribes a destination to receive notifications when an object is removed from the bucket.\nThis is identical to calling\n``onEvent(EventType.OBJECT_REMOVED)``.')
    add_to_resource_policy: typing.Optional[list[BucketDefAddToResourcePolicyParams]] = pydantic.Field(None, description="Adds a statement to the resource policy for a principal (i.e. account/role/service) to perform actions on this bucket and/or its contents. Use ``bucketArn`` and ``arnForObjects(keys)`` to obtain ARNs for this bucket or objects.\nNote that the policy statement may or may not be added to the policy.\nFor example, when an ``IBucket`` is created from an existing bucket,\nit's not possible to tell whether the bucket already has a policy\nattached, let alone to re-use that policy to add more statements to it.\nSo it's safest to do nothing in these cases.")
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    arn_for_objects: typing.Optional[list[BucketDefArnForObjectsParams]] = pydantic.Field(None, description='Returns an ARN that represents all objects within the bucket that match the key pattern specified.\nTo represent all keys, specify ``"*"``.\n\nIf you need to specify a keyPattern with multiple components, concatenate them into a single string, e.g.:\n\narnForObjects(``home/${team}/${user}/*``)')
    enable_event_bridge_notification: typing.Optional[bool] = pydantic.Field(None, description='Enables event bridge notification, causing all events below to be sent to EventBridge:.\n- Object Deleted (DeleteObject)\n- Object Deleted (Lifecycle expiration)\n- Object Restore Initiated\n- Object Restore Completed\n- Object Restore Expired\n- Object Storage Class Changed\n- Object Access Tier Changed\n- Object ACL Updated\n- Object Tags Added\n- Object Tags Deleted')
    grant_delete: typing.Optional[list[BucketDefGrantDeleteParams]] = pydantic.Field(None, description='Grants s3:DeleteObject* permission to an IAM principal for objects in this bucket.')
    grant_public_access: typing.Optional[list[BucketDefGrantPublicAccessParams]] = pydantic.Field(None, description='Allows unrestricted access to objects from this bucket.\nIMPORTANT: This permission allows anyone to perform actions on S3 objects\nin this bucket, which is useful for when you configure your bucket as a\nwebsite and want everyone to be able to read objects in the bucket without\nneeding to authenticate.\n\nWithout arguments, this method will grant read ("s3:GetObject") access to\nall objects ("*") in the bucket.\n\nThe method returns the ``iam.Grant`` object, which can then be modified\nas needed. For example, you can add a condition that will restrict access only\nto an IPv4 range like this::\n\n   const grant = bucket.grantPublicAccess();\n   grant.resourceStatement!.addCondition(‘IpAddress’, { “aws:SourceIp”: “54.240.143.0/24” });\n\nNote that if this ``IBucket`` refers to an existing bucket, possibly not\nmanaged by CloudFormation, this method will have no effect, since it\'s\nimpossible to modify the policy of an existing bucket.')
    grant_put: typing.Optional[list[BucketDefGrantPutParams]] = pydantic.Field(None, description='Grants s3:PutObject* and s3:Abort* permissions for this bucket to an IAM principal.\nIf encryption is used, permission to use the key to encrypt the contents\nof written files will also be granted to the same principal.')
    grant_put_acl: typing.Optional[list[BucketDefGrantPutAclParams]] = pydantic.Field(None, description="Grant the given IAM identity permissions to modify the ACLs of objects in the given Bucket.\nIf your application has the '@aws-cdk/aws-s3:grantWriteWithoutAcl' feature flag set,\ncalling ``grantWrite`` or ``grantReadWrite`` no longer grants permissions to modify the ACLs of the objects;\nin this case, if you need to modify object ACLs, call this method explicitly.")
    grant_read: typing.Optional[list[BucketDefGrantReadParams]] = pydantic.Field(None, description="Grant read permissions for this bucket and it's contents to an IAM principal (Role/Group/User).\nIf encryption is used, permission to use the key to decrypt the contents\nof the bucket will also be granted to the same principal.")
    grant_read_write: typing.Optional[list[BucketDefGrantReadWriteParams]] = pydantic.Field(None, description="Grants read/write permissions for this bucket and it's contents to an IAM principal (Role/Group/User).\nIf an encryption key is used, permission to use the key for\nencrypt/decrypt will also be granted.\n\nBefore CDK version 1.85.0, this method granted the ``s3:PutObject*`` permission that included ``s3:PutObjectAcl``,\nwhich could be used to grant read/write object access to IAM principals in other accounts.\nIf you want to get rid of that behavior, update your CDK version to 1.85.0 or later,\nand make sure the ``@aws-cdk/aws-s3:grantWriteWithoutAcl`` feature flag is set to ``true``\nin the ``context`` key of your cdk.json file.\nIf you've already updated, but still need the principal to have permissions to modify the ACLs,\nuse the ``grantPutAcl`` method.")
    grant_write: typing.Optional[list[BucketDefGrantWriteParams]] = pydantic.Field(None, description="Grant write permissions to this bucket to an IAM principal.\nIf encryption is used, permission to use the key to encrypt the contents\nof written files will also be granted to the same principal.\n\nBefore CDK version 1.85.0, this method granted the ``s3:PutObject*`` permission that included ``s3:PutObjectAcl``,\nwhich could be used to grant read/write object access to IAM principals in other accounts.\nIf you want to get rid of that behavior, update your CDK version to 1.85.0 or later,\nand make sure the ``@aws-cdk/aws-s3:grantWriteWithoutAcl`` feature flag is set to ``true``\nin the ``context`` key of your cdk.json file.\nIf you've already updated, but still need the principal to have permissions to modify the ACLs,\nuse the ``grantPutAcl`` method.")
    on_cloud_trail_event: typing.Optional[list[BucketDefOnCloudTrailEventParams]] = pydantic.Field(None, description='Define a CloudWatch event that triggers when something happens to this repository.\nRequires that there exists at least one CloudTrail Trail in your account\nthat captures the event. This method will not create the Trail.')
    on_cloud_trail_put_object: typing.Optional[list[BucketDefOnCloudTrailPutObjectParams]] = pydantic.Field(None, description='Defines an AWS CloudWatch event that triggers when an object is uploaded to the specified paths (keys) in this bucket using the PutObject API call.\nNote that some tools like ``aws s3 cp`` will automatically use either\nPutObject or the multipart upload API depending on the file size,\nso using ``onCloudTrailWriteObject`` may be preferable.\n\nRequires that there exists at least one CloudTrail Trail in your account\nthat captures the event. This method will not create the Trail.')
    on_cloud_trail_write_object: typing.Optional[list[BucketDefOnCloudTrailWriteObjectParams]] = pydantic.Field(None, description='Defines an AWS CloudWatch event that triggers when an object at the specified paths (keys) in this bucket are written to.\nThis includes\nthe events PutObject, CopyObject, and CompleteMultipartUpload.\n\nNote that some tools like ``aws s3 cp`` will automatically use either\nPutObject or the multipart upload API depending on the file size,\nso using this method may be preferable to ``onCloudTrailPutObject``.\n\nRequires that there exists at least one CloudTrail Trail in your account\nthat captures the event. This method will not create the Trail.')
    s3_url_for_object: typing.Optional[list[BucketDefS3UrlForObjectParams]] = pydantic.Field(None, description='The S3 URL of an S3 object. For example:.\n- ``s3://onlybucket``\n- ``s3://bucket/key``')
    transfer_acceleration_url_for_object: typing.Optional[list[BucketDefTransferAccelerationUrlForObjectParams]] = pydantic.Field(None, description='The https Transfer Acceleration URL of an S3 object.\nSpecify ``dualStack: true`` at the options\nfor dual-stack endpoint (connect to the bucket over IPv6). For example:\n\n- ``https://bucket.s3-accelerate.amazonaws.com``\n- ``https://bucket.s3-accelerate.amazonaws.com/key``')
    url_for_object: typing.Optional[list[BucketDefUrlForObjectParams]] = pydantic.Field(None, description='The https URL of an S3 object. Specify ``regional: false`` at the options for non-regional URLs. For example:.\n- ``https://s3.us-west-1.amazonaws.com/onlybucket``\n- ``https://s3.us-west-1.amazonaws.com/bucket/key``\n- ``https://s3.cn-north-1.amazonaws.com.cn/china-bucket/mykey``')
    validate_bucket_name: typing.Optional[list[BucketDefValidateBucketNameParams]] = pydantic.Field(None, description='Thrown an exception if the given bucket name is not valid.')
    virtual_hosted_url_for_object: typing.Optional[list[BucketDefVirtualHostedUrlForObjectParams]] = pydantic.Field(None, description='The virtual hosted-style URL of an S3 object. Specify ``regional: false`` at the options for non-regional URL. For example:.\n- ``https://only-bucket.s3.us-west-1.amazonaws.com``\n- ``https://bucket.s3.us-west-1.amazonaws.com/key``\n- ``https://bucket.s3.amazonaws.com/key``\n- ``https://china-bucket.s3.cn-north-1.amazonaws.com.cn/mykey``')
...
class BucketPolicyDef(BaseConstruct):
    bucket: typing.Union[models.aws_s3.BucketBaseDef, models.aws_s3.BucketDef] = pydantic.Field(..., description='The Amazon S3 bucket that the policy applies to.\n')
...
class BucketNotificationDestinationConfigDef(BaseStruct):
    arn: str = pydantic.Field(..., description='The ARN of the destination (i.e. Lambda, SNS, SQS).\n')
    type: aws_cdk.aws_s3.BucketNotificationDestinationType = pydantic.Field(..., description='The notification type.\n')
    dependencies: typing.Optional[typing.Sequence[typing.Union[models.aws_iam.CompositeDependableDef, models.aws_iam.GrantDef, models.constructs.DependencyGroupDef]]] = pydantic.Field(None, description='Any additional dependencies that should be resolved before the bucket notification can be configured (for example, the SNS Topic Policy resource).\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n    import constructs as constructs\n\n    # dependable: constructs.IDependable\n\n    bucket_notification_destination_config = s3.BucketNotificationDestinationConfig(\n        arn="arn",\n        type=s3.BucketNotificationDestinationType.LAMBDA,\n\n        # the properties below are optional\n        dependencies=[dependable]\n    )\n')
...
class CfnAccessPoint_PublicAccessBlockConfigurationPropertyDef(BaseStruct):
    block_public_acls: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description="Specifies whether Amazon S3 should block public access control lists (ACLs) for this bucket and objects in this bucket. Setting this element to ``TRUE`` causes the following behavior: - PUT Bucket ACL and PUT Object ACL calls fail if the specified ACL is public. - PUT Object calls fail if the request includes a public ACL. - PUT Bucket calls fail if the request includes a public ACL. Enabling this setting doesn't affect existing policies or ACLs.\n")
    block_public_policy: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description="Specifies whether Amazon S3 should block public bucket policies for this bucket. Setting this element to ``TRUE`` causes Amazon S3 to reject calls to PUT Bucket policy if the specified bucket policy allows public access. Enabling this setting doesn't affect existing bucket policies.\n")
    ignore_public_acls: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description="Specifies whether Amazon S3 should ignore public ACLs for this bucket and objects in this bucket. Setting this element to ``TRUE`` causes Amazon S3 to ignore all public ACLs on this bucket and objects in this bucket. Enabling this setting doesn't affect the persistence of any existing ACLs and doesn't prevent new public ACLs from being set.\n")
    restrict_public_buckets: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description="Specifies whether Amazon S3 should restrict public bucket policies for this bucket. Setting this element to ``TRUE`` restricts access to this bucket to only AWS service principals and authorized users within this account if the bucket has a public policy. Enabling this setting doesn't affect previously stored bucket policies, except that public and cross-account access within any public bucket policy, including non-public delegation to specific accounts, is blocked.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-accesspoint-publicaccessblockconfiguration.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n\n    public_access_block_configuration_property = s3.CfnAccessPoint.PublicAccessBlockConfigurationProperty(\n        block_public_acls=False,\n        block_public_policy=False,\n        ignore_public_acls=False,\n        restrict_public_buckets=False\n    )\n")
    _init_params: typing.ClassVar[list[str]] = ['block_public_acls', 'block_public_policy', 'ignore_public_acls', 'restrict_public_buckets']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnBucket_AccessControlTranslationPropertyDef(BaseStruct):
    owner: str = pydantic.Field(..., description='Specifies the replica ownership. For default and valid values, see `PUT bucket replication <https://docs.aws.amazon.com/AmazonS3/latest/API/RESTBucketPUTreplication.html>`_ in the *Amazon S3 API Reference* .\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-accesscontroltranslation.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n\n    access_control_translation_property = s3.CfnBucket.AccessControlTranslationProperty(\n        owner="owner"\n    )\n')
...
class CfnBucket_AnalyticsConfigurationPropertyDef(BaseStruct):
    storage_class_analysis: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_StorageClassAnalysisPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='Contains data related to access patterns to be collected and made available to analyze the tradeoffs between different storage classes.\n')
    ...
    tag_filters: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_TagFilterPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The tags to use when evaluating an analytics filter. The analytics only includes objects that meet the filter\'s criteria. If no filter is specified, all of the contents of the bucket are included in the analysis.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-analyticsconfiguration.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n\n    analytics_configuration_property = s3.CfnBucket.AnalyticsConfigurationProperty(\n        id="id",\n        storage_class_analysis=s3.CfnBucket.StorageClassAnalysisProperty(\n            data_export=s3.CfnBucket.DataExportProperty(\n                destination=s3.CfnBucket.DestinationProperty(\n                    bucket_arn="bucketArn",\n                    format="format",\n\n                    # the properties below are optional\n                    bucket_account_id="bucketAccountId",\n                    prefix="prefix"\n                ),\n                output_schema_version="outputSchemaVersion"\n            )\n        ),\n\n        # the properties below are optional\n        prefix="prefix",\n        tag_filters=[s3.CfnBucket.TagFilterProperty(\n            key="key",\n            value="value"\n        )]\n    )\n')
...
class CfnBucket_BucketEncryptionPropertyDef(BaseStruct):
    server_side_encryption_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_ServerSideEncryptionRulePropertyDef, dict[str, typing.Any]]]] = pydantic.Field(..., description='Specifies the default server-side-encryption configuration.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-bucketencryption.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n\n    bucket_encryption_property = s3.CfnBucket.BucketEncryptionProperty(\n        server_side_encryption_configuration=[s3.CfnBucket.ServerSideEncryptionRuleProperty(\n            bucket_key_enabled=False,\n            server_side_encryption_by_default=s3.CfnBucket.ServerSideEncryptionByDefaultProperty(\n                sse_algorithm="sseAlgorithm",\n\n                # the properties below are optional\n                kms_master_key_id="kmsMasterKeyId"\n            )\n        )]\n    )\n')
...
class CfnBucket_CorsConfigurationPropertyDef(BaseStruct):
    cors_rules: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_CorsRulePropertyDef, dict[str, typing.Any]]]] = pydantic.Field(..., description='A set of origins and methods (cross-origin access that you want to allow). You can add up to 100 rules to the configuration.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-cors.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n\n    cors_configuration_property = s3.CfnBucket.CorsConfigurationProperty(\n        cors_rules=[s3.CfnBucket.CorsRuleProperty(\n            allowed_methods=["allowedMethods"],\n            allowed_origins=["allowedOrigins"],\n\n            # the properties below are optional\n            allowed_headers=["allowedHeaders"],\n            exposed_headers=["exposedHeaders"],\n            id="id",\n            max_age=123\n        )]\n    )\n')
...
class CfnBucket_CorsRulePropertyDef(BaseStruct):
    allowed_methods: typing.Sequence[str] = pydantic.Field(..., description='An HTTP method that you allow the origin to run. *Allowed values* : ``GET`` | ``PUT`` | ``HEAD`` | ``POST`` | ``DELETE``\n')
    allowed_origins: typing.Sequence[str] = pydantic.Field(..., description='One or more origins you want customers to be able to access the bucket from.\n')
...
class CfnBucket_DataExportPropertyDef(BaseStruct):
    destination: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_DestinationPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='The place to store the data for an analysis.\n')
    output_schema_version: str = pydantic.Field(..., description='The version of the output schema to use when exporting data. Must be ``V_1`` .\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-dataexport.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n\n    data_export_property = s3.CfnBucket.DataExportProperty(\n        destination=s3.CfnBucket.DestinationProperty(\n            bucket_arn="bucketArn",\n            format="format",\n\n            # the properties below are optional\n            bucket_account_id="bucketAccountId",\n            prefix="prefix"\n        ),\n        output_schema_version="outputSchemaVersion"\n    )\n')
...
class CfnBucket_DestinationPropertyDef(BaseStruct):
    bucket_arn: str = pydantic.Field(..., description='The Amazon Resource Name (ARN) of the bucket to which data is exported.\n')
    format: str = pydantic.Field(..., description='Specifies the file format used when exporting data to Amazon S3. *Allowed values* : ``CSV`` | ``ORC`` | ``Parquet``\n')
...
class CfnBucket_IntelligentTieringConfigurationPropertyDef(BaseStruct):
    status: str = pydantic.Field(..., description='Specifies the status of the configuration.\n')
    tierings: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_TieringPropertyDef, dict[str, typing.Any]]]] = pydantic.Field(..., description='Specifies a list of S3 Intelligent-Tiering storage class tiers in the configuration. At least one tier must be defined in the list. At most, you can specify two tiers in the list, one for each available AccessTier: ``ARCHIVE_ACCESS`` and ``DEEP_ARCHIVE_ACCESS`` . .. epigraph:: You only need Intelligent Tiering Configuration enabled on a bucket if you want to automatically move objects stored in the Intelligent-Tiering storage class to Archive Access or Deep Archive Access tiers.\n')
    ...
    tag_filters: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_TagFilterPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='A container for a key-value pair.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-intelligenttieringconfiguration.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n\n    intelligent_tiering_configuration_property = s3.CfnBucket.IntelligentTieringConfigurationProperty(\n        id="id",\n        status="status",\n        tierings=[s3.CfnBucket.TieringProperty(\n            access_tier="accessTier",\n            days=123\n        )],\n\n        # the properties below are optional\n        prefix="prefix",\n        tag_filters=[s3.CfnBucket.TagFilterProperty(\n            key="key",\n            value="value"\n        )]\n    )\n')
...
class CfnBucket_InventoryConfigurationPropertyDef(BaseStruct):
    destination: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_DestinationPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='Contains information about where to publish the inventory results.\n')
    enabled: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef]] = pydantic.Field(..., description='Specifies whether the inventory is enabled or disabled. If set to ``True`` , an inventory list is generated. If set to ``False`` , no inventory list is generated.\n')
    included_object_versions: str = pydantic.Field(..., description='Object versions to include in the inventory list. If set to ``All`` , the list includes all the object versions, which adds the version-related fields ``VersionId`` , ``IsLatest`` , and ``DeleteMarker`` to the list. If set to ``Current`` , the list does not contain these version-related fields.\n')
    schedule_frequency: str = pydantic.Field(..., description='Specifies the schedule for generating inventory results. *Allowed values* : ``Daily`` | ``Weekly``\n')
...
class CfnBucket_LambdaConfigurationPropertyDef(BaseStruct):
    event: str = pydantic.Field(..., description='The Amazon S3 bucket event for which to invoke the AWS Lambda function. For more information, see `Supported Event Types <https://docs.aws.amazon.com/AmazonS3/latest/dev/NotificationHowTo.html>`_ in the *Amazon S3 User Guide* .\n')
    function: str = pydantic.Field(..., description='The Amazon Resource Name (ARN) of the AWS Lambda function that Amazon S3 invokes when the specified event type occurs.\n')
    filter: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_NotificationFilterPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The filtering rules that determine which objects invoke the AWS Lambda function. For example, you can create a filter so that only image files with a ``.jpg`` extension invoke the function when they are added to the Amazon S3 bucket.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-notificationconfig-lambdaconfig.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n\n    lambda_configuration_property = s3.CfnBucket.LambdaConfigurationProperty(\n        event="event",\n        function="function",\n\n        # the properties below are optional\n        filter=s3.CfnBucket.NotificationFilterProperty(\n            s3_key=s3.CfnBucket.S3KeyFilterProperty(\n                rules=[s3.CfnBucket.FilterRuleProperty(\n                    name="name",\n                    value="value"\n                )]\n            )\n        )\n    )\n')
...
class CfnBucket_MetricsConfigurationPropertyDef(BaseStruct):
    ...
    prefix: typing.Optional[str] = pydantic.Field(None, description='The prefix that an object must have to be included in the metrics results.\n')
    tag_filters: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_TagFilterPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='Specifies a list of tag filters to use as a metrics configuration filter. The metrics configuration includes only objects that meet the filter\'s criteria.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-metricsconfiguration.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n\n    metrics_configuration_property = s3.CfnBucket.MetricsConfigurationProperty(\n        id="id",\n\n        # the properties below are optional\n        access_point_arn="accessPointArn",\n        prefix="prefix",\n        tag_filters=[s3.CfnBucket.TagFilterProperty(\n            key="key",\n            value="value"\n        )]\n    )\n')
...
class CfnBucket_MetricsPropertyDef(BaseStruct):
    status: str = pydantic.Field(..., description='Specifies whether the replication metrics are enabled.\n')
    event_threshold: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_ReplicationTimeValuePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A container specifying the time threshold for emitting the ``s3:Replication:OperationMissedThreshold`` event.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-metrics.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n\n    metrics_property = s3.CfnBucket.MetricsProperty(\n        status="status",\n\n        # the properties below are optional\n        event_threshold=s3.CfnBucket.ReplicationTimeValueProperty(\n            minutes=123\n        )\n    )\n')
...
class CfnBucket_NoncurrentVersionTransitionPropertyDef(BaseStruct):
    storage_class: str = pydantic.Field(..., description='The class of storage used to store the object.\n')
...
class CfnBucket_NotificationConfigurationPropertyDef(BaseStruct):
    event_bridge_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_EventBridgeConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Enables delivery of events to Amazon EventBridge.\n')
    lambda_configurations: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_LambdaConfigurationPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='Describes the AWS Lambda functions to invoke and the events for which to invoke them.\n')
    queue_configurations: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_QueueConfigurationPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The Amazon Simple Queue Service queues to publish messages to and the events for which to publish messages.\n')
    topic_configurations: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_TopicConfigurationPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The topic to which notifications are sent and the events for which notifications are generated.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-notificationconfig.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n\n    notification_configuration_property = s3.CfnBucket.NotificationConfigurationProperty(\n        event_bridge_configuration=s3.CfnBucket.EventBridgeConfigurationProperty(\n            event_bridge_enabled=False\n        ),\n        lambda_configurations=[s3.CfnBucket.LambdaConfigurationProperty(\n            event="event",\n            function="function",\n\n            # the properties below are optional\n            filter=s3.CfnBucket.NotificationFilterProperty(\n                s3_key=s3.CfnBucket.S3KeyFilterProperty(\n                    rules=[s3.CfnBucket.FilterRuleProperty(\n                        name="name",\n                        value="value"\n                    )]\n                )\n            )\n        )],\n        queue_configurations=[s3.CfnBucket.QueueConfigurationProperty(\n            event="event",\n            queue="queue",\n\n            # the properties below are optional\n            filter=s3.CfnBucket.NotificationFilterProperty(\n                s3_key=s3.CfnBucket.S3KeyFilterProperty(\n                    rules=[s3.CfnBucket.FilterRuleProperty(\n                        name="name",\n                        value="value"\n                    )]\n                )\n            )\n        )],\n        topic_configurations=[s3.CfnBucket.TopicConfigurationProperty(\n            event="event",\n            topic="topic",\n\n            # the properties below are optional\n            filter=s3.CfnBucket.NotificationFilterProperty(\n                s3_key=s3.CfnBucket.S3KeyFilterProperty(\n                    rules=[s3.CfnBucket.FilterRuleProperty(\n                        name="name",\n                        value="value"\n                    )]\n                )\n            )\n        )]\n    )\n')
...
class CfnBucket_NotificationFilterPropertyDef(BaseStruct):
    s3_key: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_S3KeyFilterPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='A container for object key name prefix and suffix filtering rules.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-notificationconfiguration-config-filter.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n\n    notification_filter_property = s3.CfnBucket.NotificationFilterProperty(\n        s3_key=s3.CfnBucket.S3KeyFilterProperty(\n            rules=[s3.CfnBucket.FilterRuleProperty(\n                name="name",\n                value="value"\n            )]\n        )\n    )\n')
...
class CfnBucket_OwnershipControlsPropertyDef(BaseStruct):
    rules: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_OwnershipControlsRulePropertyDef, dict[str, typing.Any]]]] = pydantic.Field(..., description='Specifies the container element for Object Ownership rules.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-ownershipcontrols.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n\n    ownership_controls_property = s3.CfnBucket.OwnershipControlsProperty(\n        rules=[s3.CfnBucket.OwnershipControlsRuleProperty(\n            object_ownership="objectOwnership"\n        )]\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['rules']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnBucket_QueueConfigurationPropertyDef(BaseStruct):
    event: str = pydantic.Field(..., description='The Amazon S3 bucket event about which you want to publish messages to Amazon SQS. For more information, see `Supported Event Types <https://docs.aws.amazon.com/AmazonS3/latest/dev/NotificationHowTo.html>`_ in the *Amazon S3 User Guide* .\n')
    queue: str = pydantic.Field(..., description='The Amazon Resource Name (ARN) of the Amazon SQS queue to which Amazon S3 publishes a message when it detects events of the specified type. FIFO queues are not allowed when enabling an SQS queue as the event notification destination.\n')
...
class CfnBucket_RedirectAllRequestsToPropertyDef(BaseStruct):
    host_name: str = pydantic.Field(..., description='Name of the host where requests are redirected.\n')
...
class CfnBucket_ReplicationDestinationPropertyDef(BaseStruct):
    bucket: str = pydantic.Field(..., description='The Amazon Resource Name (ARN) of the bucket where you want Amazon S3 to store the results.\n')
    access_control_translation: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_AccessControlTranslationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Specify this only in a cross-account scenario (where source and destination bucket owners are not the same), and you want to change replica ownership to the AWS account that owns the destination bucket. If this is not specified in the replication configuration, the replicas are owned by same AWS account that owns the source object.\n')
    ...
    encryption_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_EncryptionConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Specifies encryption-related information.\n')
    metrics: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_MetricsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A container specifying replication metrics-related settings enabling replication metrics and events.\n')
    replication_time: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_ReplicationTimePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A container specifying S3 Replication Time Control (S3 RTC), including whether S3 RTC is enabled and the time when all objects and operations on objects must be replicated. Must be specified together with a ``Metrics`` block.\n')
...
class CfnBucket_ReplicationRuleAndOperatorPropertyDef(BaseStruct):
    prefix: typing.Optional[str] = pydantic.Field(None, description='An object key name prefix that identifies the subset of objects to which the rule applies.\n')
    tag_filters: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_TagFilterPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='An array of tags containing key and value pairs.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-replicationruleandoperator.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n\n    replication_rule_and_operator_property = s3.CfnBucket.ReplicationRuleAndOperatorProperty(\n        prefix="prefix",\n        tag_filters=[s3.CfnBucket.TagFilterProperty(\n            key="key",\n            value="value"\n        )]\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['prefix', 'tag_filters']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnBucket_ReplicationRuleFilterPropertyDef(BaseStruct):
    ...
    tag_filter: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_TagFilterPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A container for specifying a tag key and value. The rule applies only to objects that have the tag in their tag set.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-replicationrulefilter.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n\n    replication_rule_filter_property = s3.CfnBucket.ReplicationRuleFilterProperty(\n        and=s3.CfnBucket.ReplicationRuleAndOperatorProperty(\n            prefix="prefix",\n            tag_filters=[s3.CfnBucket.TagFilterProperty(\n                key="key",\n                value="value"\n            )]\n        ),\n        prefix="prefix",\n        tag_filter=s3.CfnBucket.TagFilterProperty(\n            key="key",\n            value="value"\n        )\n    )\n')
...
class CfnBucket_ReplicationRulePropertyDef(BaseStruct):
    destination: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_ReplicationDestinationPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='A container for information about the replication destination and its configurations including enabling the S3 Replication Time Control (S3 RTC).\n')
    status: str = pydantic.Field(..., description='Specifies whether the rule is enabled.\n')
    delete_marker_replication: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_DeleteMarkerReplicationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Specifies whether Amazon S3 replicates delete markers. If you specify a ``Filter`` in your replication configuration, you must also include a ``DeleteMarkerReplication`` element. If your ``Filter`` includes a ``Tag`` element, the ``DeleteMarkerReplication`` ``Status`` must be set to Disabled, because Amazon S3 does not support replicating delete markers for tag-based rules. For an example configuration, see `Basic Rule Configuration <https://docs.aws.amazon.com/AmazonS3/latest/dev/replication-add-config.html#replication-config-min-rule-config>`_ . For more information about delete marker replication, see `Basic Rule Configuration <https://docs.aws.amazon.com/AmazonS3/latest/dev/delete-marker-replication.html>`_ . .. epigraph:: If you are using an earlier version of the replication configuration, Amazon S3 handles replication of delete markers differently. For more information, see `Backward Compatibility <https://docs.aws.amazon.com/AmazonS3/latest/dev/replication-add-config.html#replication-backward-compat-considerations>`_ .\n')
    filter: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_ReplicationRuleFilterPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description="A filter that identifies the subset of objects to which the replication rule applies. A ``Filter`` must specify exactly one ``Prefix`` , ``TagFilter`` , or an ``And`` child element. The use of the filter field indicates that this is a V2 replication configuration. This field isn't supported in a V1 replication configuration. .. epigraph:: V1 replication configuration only supports filtering by key prefix. To filter using a V1 replication configuration, add the ``Prefix`` directly as a child element of the ``Rule`` element.\n")
    ...
    source_selection_criteria: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_SourceSelectionCriteriaPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A container that describes additional filters for identifying the source objects that you want to replicate. You can choose to enable or disable the replication of these objects.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-replicationconfiguration-rules.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n\n    replication_rule_property = s3.CfnBucket.ReplicationRuleProperty(\n        destination=s3.CfnBucket.ReplicationDestinationProperty(\n            bucket="bucket",\n\n            # the properties below are optional\n            access_control_translation=s3.CfnBucket.AccessControlTranslationProperty(\n                owner="owner"\n            ),\n            account="account",\n            encryption_configuration=s3.CfnBucket.EncryptionConfigurationProperty(\n                replica_kms_key_id="replicaKmsKeyId"\n            ),\n            metrics=s3.CfnBucket.MetricsProperty(\n                status="status",\n\n                # the properties below are optional\n                event_threshold=s3.CfnBucket.ReplicationTimeValueProperty(\n                    minutes=123\n                )\n            ),\n            replication_time=s3.CfnBucket.ReplicationTimeProperty(\n                status="status",\n                time=s3.CfnBucket.ReplicationTimeValueProperty(\n                    minutes=123\n                )\n            ),\n            storage_class="storageClass"\n        ),\n        status="status",\n\n        # the properties below are optional\n        delete_marker_replication=s3.CfnBucket.DeleteMarkerReplicationProperty(\n            status="status"\n        ),\n        filter=s3.CfnBucket.ReplicationRuleFilterProperty(\n            and=s3.CfnBucket.ReplicationRuleAndOperatorProperty(\n                prefix="prefix",\n                tag_filters=[s3.CfnBucket.TagFilterProperty(\n                    key="key",\n                    value="value"\n                )]\n            ),\n            prefix="prefix",\n            tag_filter=s3.CfnBucket.TagFilterProperty(\n                key="key",\n                value="value"\n            )\n        ),\n        id="id",\n        prefix="prefix",\n        priority=123,\n        source_selection_criteria=s3.CfnBucket.SourceSelectionCriteriaProperty(\n            replica_modifications=s3.CfnBucket.ReplicaModificationsProperty(\n                status="status"\n            ),\n            sse_kms_encrypted_objects=s3.CfnBucket.SseKmsEncryptedObjectsProperty(\n                status="status"\n            )\n        )\n    )\n')
...
class CfnBucket_ReplicationTimePropertyDef(BaseStruct):
    status: str = pydantic.Field(..., description='Specifies whether the replication time is enabled.\n')
    time: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_ReplicationTimeValuePropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='A container specifying the time by which replication should be complete for all objects and operations on objects.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-replicationtime.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n\n    replication_time_property = s3.CfnBucket.ReplicationTimeProperty(\n        status="status",\n        time=s3.CfnBucket.ReplicationTimeValueProperty(\n            minutes=123\n        )\n    )\n')
...
class CfnBucket_RoutingRulePropertyDef(BaseStruct):
    redirect_rule: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_RedirectRulePropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='Container for redirect information. You can redirect requests to another host, to another page, or with another protocol. In the event of an error, you can specify a different error code to return.\n')
    routing_rule_condition: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_RoutingRuleConditionPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A container for describing a condition that must be met for the specified redirect to apply. For example, 1. If request is for pages in the ``/docs`` folder, redirect to the ``/documents`` folder. 2. If request results in HTTP error 4xx, redirect request to another host where you might process the error.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-websiteconfiguration-routingrules.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n\n    routing_rule_property = s3.CfnBucket.RoutingRuleProperty(\n        redirect_rule=s3.CfnBucket.RedirectRuleProperty(\n            host_name="hostName",\n            http_redirect_code="httpRedirectCode",\n            protocol="protocol",\n            replace_key_prefix_with="replaceKeyPrefixWith",\n            replace_key_with="replaceKeyWith"\n        ),\n\n        # the properties below are optional\n        routing_rule_condition=s3.CfnBucket.RoutingRuleConditionProperty(\n            http_error_code_returned_equals="httpErrorCodeReturnedEquals",\n            key_prefix_equals="keyPrefixEquals"\n        )\n    )\n')
...
class CfnBucket_RulePropertyDef(BaseStruct):
    ...
    abort_incomplete_multipart_upload: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_AbortIncompleteMultipartUploadPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Specifies a lifecycle rule that stops incomplete multipart uploads to an Amazon S3 bucket.\n')
    expiration_date: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], datetime.datetime, None] = pydantic.Field(None, description='Indicates when objects are deleted from Amazon S3 and Amazon S3 Glacier. The date value must be in ISO 8601 format. The time is always midnight UTC. If you specify an expiration and transition time, you must use the same time unit for both properties (either in days or by date). The expiration time must also be later than the transition time.\n')
    ...
    expired_object_delete_marker: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description='Indicates whether Amazon S3 will remove a delete marker without any noncurrent versions. If set to true, the delete marker will be removed if there are no noncurrent versions. This cannot be specified with ``ExpirationInDays`` , ``ExpirationDate`` , or ``TagFilters`` .\n')
    noncurrent_version_expiration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_NoncurrentVersionExpirationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description="Specifies when noncurrent object versions expire. Upon expiration, Amazon S3 permanently deletes the noncurrent object versions. You set this lifecycle configuration action on a bucket that has versioning enabled (or suspended) to request that Amazon S3 delete noncurrent object versions at a specific period in the object's lifetime.\n")
    ...
    noncurrent_version_transition: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_NoncurrentVersionTransitionPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description="(Deprecated.) For buckets with versioning enabled (or suspended), specifies when non-current objects transition to a specified storage class. If you specify a transition and expiration time, the expiration time must be later than the transition time. If you specify this property, don't specify the ``NoncurrentVersionTransitions`` property.\n")
    noncurrent_version_transitions: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_NoncurrentVersionTransitionPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description="For buckets with versioning enabled (or suspended), one or more transition rules that specify when non-current objects transition to a specified storage class. If you specify a transition and expiration time, the expiration time must be later than the transition time. If you specify this property, don't specify the ``NoncurrentVersionTransition`` property.\n")
    ...
    tag_filters: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_TagFilterPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='Tags to use to identify a subset of objects to which the lifecycle rule applies.\n')
    transition: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_TransitionPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description="(Deprecated.) Specifies when an object transitions to a specified storage class. If you specify an expiration and transition time, you must use the same time unit for both properties (either in days or by date). The expiration time must also be later than the transition time. If you specify this property, don't specify the ``Transitions`` property.\n")
    transitions: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_TransitionPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='One or more transition rules that specify when an object transitions to a specified storage class. If you specify an expiration and transition time, you must use the same time unit for both properties (either in days or by date). The expiration time must also be later than the transition time. If you specify this property, don\'t specify the ``Transition`` property.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-lifecycleconfig-rule.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n\n    rule_property = s3.CfnBucket.RuleProperty(\n        status="status",\n\n        # the properties below are optional\n        abort_incomplete_multipart_upload=s3.CfnBucket.AbortIncompleteMultipartUploadProperty(\n            days_after_initiation=123\n        ),\n        expiration_date=Date(),\n        expiration_in_days=123,\n        expired_object_delete_marker=False,\n        id="id",\n        noncurrent_version_expiration=s3.CfnBucket.NoncurrentVersionExpirationProperty(\n            noncurrent_days=123,\n\n            # the properties below are optional\n            newer_noncurrent_versions=123\n        ),\n        noncurrent_version_expiration_in_days=123,\n        noncurrent_version_transition=s3.CfnBucket.NoncurrentVersionTransitionProperty(\n            storage_class="storageClass",\n            transition_in_days=123,\n\n            # the properties below are optional\n            newer_noncurrent_versions=123\n        ),\n        noncurrent_version_transitions=[s3.CfnBucket.NoncurrentVersionTransitionProperty(\n            storage_class="storageClass",\n            transition_in_days=123,\n\n            # the properties below are optional\n            newer_noncurrent_versions=123\n        )],\n        object_size_greater_than=123,\n        object_size_less_than=123,\n        prefix="prefix",\n        tag_filters=[s3.CfnBucket.TagFilterProperty(\n            key="key",\n            value="value"\n        )],\n        transition=s3.CfnBucket.TransitionProperty(\n            storage_class="storageClass",\n\n            # the properties below are optional\n            transition_date=Date(),\n            transition_in_days=123\n        ),\n        transitions=[s3.CfnBucket.TransitionProperty(\n            storage_class="storageClass",\n\n            # the properties below are optional\n            transition_date=Date(),\n            transition_in_days=123\n        )]\n    )\n')
...
class CfnBucket_S3KeyFilterPropertyDef(BaseStruct):
    rules: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_FilterRulePropertyDef, dict[str, typing.Any]]]] = pydantic.Field(..., description='A list of containers for the key-value pair that defines the criteria for the filter rule.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-notificationconfiguration-config-filter-s3key.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n\n    s3_key_filter_property = s3.CfnBucket.S3KeyFilterProperty(\n        rules=[s3.CfnBucket.FilterRuleProperty(\n            name="name",\n            value="value"\n        )]\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['rules']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnBucket_ServerSideEncryptionByDefaultPropertyDef(BaseStruct):
    sse_algorithm: str = pydantic.Field(..., description='Server-side encryption algorithm to use for the default encryption.\n')
...
class CfnBucket_ServerSideEncryptionRulePropertyDef(BaseStruct):
    bucket_key_enabled: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description='Specifies whether Amazon S3 should use an S3 Bucket Key with server-side encryption using KMS (SSE-KMS) for new objects in the bucket. Existing objects are not affected. Setting the ``BucketKeyEnabled`` element to ``true`` causes Amazon S3 to use an S3 Bucket Key. By default, S3 Bucket Key is not enabled. For more information, see `Amazon S3 Bucket Keys <https://docs.aws.amazon.com/AmazonS3/latest/dev/bucket-key.html>`_ in the *Amazon S3 User Guide* .\n')
    server_side_encryption_by_default: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_ServerSideEncryptionByDefaultPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Specifies the default server-side encryption to apply to new objects in the bucket. If a PUT Object request doesn\'t specify any server-side encryption, this default encryption will be applied.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-serversideencryptionrule.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n\n    server_side_encryption_rule_property = s3.CfnBucket.ServerSideEncryptionRuleProperty(\n        bucket_key_enabled=False,\n        server_side_encryption_by_default=s3.CfnBucket.ServerSideEncryptionByDefaultProperty(\n            sse_algorithm="sseAlgorithm",\n\n            # the properties below are optional\n            kms_master_key_id="kmsMasterKeyId"\n        )\n    )\n')
...
class CfnBucket_SourceSelectionCriteriaPropertyDef(BaseStruct):
    replica_modifications: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_ReplicaModificationsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A filter that you can specify for selection for modifications on replicas.\n')
    sse_kms_encrypted_objects: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_SseKmsEncryptedObjectsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A container for filter information for the selection of Amazon S3 objects encrypted with AWS KMS.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-sourceselectioncriteria.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n\n    source_selection_criteria_property = s3.CfnBucket.SourceSelectionCriteriaProperty(\n        replica_modifications=s3.CfnBucket.ReplicaModificationsProperty(\n            status="status"\n        ),\n        sse_kms_encrypted_objects=s3.CfnBucket.SseKmsEncryptedObjectsProperty(\n            status="status"\n        )\n    )\n')
...
class CfnBucket_StorageClassAnalysisPropertyDef(BaseStruct):
    data_export: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_DataExportPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Specifies how data related to the storage class analysis for an Amazon S3 bucket should be exported.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-storageclassanalysis.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n\n    storage_class_analysis_property = s3.CfnBucket.StorageClassAnalysisProperty(\n        data_export=s3.CfnBucket.DataExportProperty(\n            destination=s3.CfnBucket.DestinationProperty(\n                bucket_arn="bucketArn",\n                format="format",\n\n                # the properties below are optional\n                bucket_account_id="bucketAccountId",\n                prefix="prefix"\n            ),\n            output_schema_version="outputSchemaVersion"\n        )\n    )\n')
...
class CfnBucket_TieringPropertyDef(BaseStruct):
    access_tier: str = pydantic.Field(..., description='S3 Intelligent-Tiering access tier. See `Storage class for automatically optimizing frequently and infrequently accessed objects <https://docs.aws.amazon.com/AmazonS3/latest/dev/storage-class-intro.html#sc-dynamic-data-access>`_ for a list of access tiers in the S3 Intelligent-Tiering storage class.\n')
    days: typing.Union[int, float] = pydantic.Field(..., description='The number of consecutive days of no access after which an object will be eligible to be transitioned to the corresponding tier. The minimum number of days specified for Archive Access tier must be at least 90 days and Deep Archive Access tier must be at least 180 days. The maximum can be up to 2 years (730 days).\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-tiering.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n\n    tiering_property = s3.CfnBucket.TieringProperty(\n        access_tier="accessTier",\n        days=123\n    )\n')
...
class CfnBucket_TopicConfigurationPropertyDef(BaseStruct):
    event: str = pydantic.Field(..., description='The Amazon S3 bucket event about which to send notifications. For more information, see `Supported Event Types <https://docs.aws.amazon.com/AmazonS3/latest/dev/NotificationHowTo.html>`_ in the *Amazon S3 User Guide* .\n')
    topic: str = pydantic.Field(..., description='The Amazon Resource Name (ARN) of the Amazon SNS topic to which Amazon S3 publishes a message when it detects events of the specified type.\n')
    filter: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_NotificationFilterPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The filtering rules that determine for which objects to send notifications. For example, you can create a filter so that Amazon S3 sends notifications only when image files with a ``.jpg`` extension are added to the bucket.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-notificationconfig-topicconfig.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n\n    topic_configuration_property = s3.CfnBucket.TopicConfigurationProperty(\n        event="event",\n        topic="topic",\n\n        # the properties below are optional\n        filter=s3.CfnBucket.NotificationFilterProperty(\n            s3_key=s3.CfnBucket.S3KeyFilterProperty(\n                rules=[s3.CfnBucket.FilterRuleProperty(\n                    name="name",\n                    value="value"\n                )]\n            )\n        )\n    )\n')
...
class CfnBucket_TransitionPropertyDef(BaseStruct):
    storage_class: str = pydantic.Field(..., description='The storage class to which you want the object to transition.\n')
    transition_date: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], datetime.datetime, None] = pydantic.Field(None, description='Indicates when objects are transitioned to the specified storage class. The date value must be in ISO 8601 format. The time is always midnight UTC.\n')
...
class CfnBucket_WebsiteConfigurationPropertyDef(BaseStruct):
    ...
    redirect_all_requests_to: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_RedirectAllRequestsToPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description="The redirect behavior for every request to this bucket's website endpoint. .. epigraph:: If you specify this property, you can't specify any other property.\n")
    routing_rules: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_RoutingRulePropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='Rules that define when a redirect is applied and the redirect behavior.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-websiteconfiguration.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n\n    website_configuration_property = s3.CfnBucket.WebsiteConfigurationProperty(\n        error_document="errorDocument",\n        index_document="indexDocument",\n        redirect_all_requests_to=s3.CfnBucket.RedirectAllRequestsToProperty(\n            host_name="hostName",\n\n            # the properties below are optional\n            protocol="protocol"\n        ),\n        routing_rules=[s3.CfnBucket.RoutingRuleProperty(\n            redirect_rule=s3.CfnBucket.RedirectRuleProperty(\n                host_name="hostName",\n                http_redirect_code="httpRedirectCode",\n                protocol="protocol",\n                replace_key_prefix_with="replaceKeyPrefixWith",\n                replace_key_with="replaceKeyWith"\n            ),\n\n            # the properties below are optional\n            routing_rule_condition=s3.CfnBucket.RoutingRuleConditionProperty(\n                http_error_code_returned_equals="httpErrorCodeReturnedEquals",\n                key_prefix_equals="keyPrefixEquals"\n            )\n        )]\n    )\n')
...
class CfnMultiRegionAccessPoint_RegionPropertyDef(BaseStruct):
    bucket: str = pydantic.Field(..., description='The name of the associated bucket for the Region.\n')
    bucket_account_id: typing.Optional[str] = pydantic.Field(None, description='``CfnMultiRegionAccessPoint.RegionProperty.BucketAccountId``.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-multiregionaccesspoint-region.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n\n    region_property = s3.CfnMultiRegionAccessPoint.RegionProperty(\n        bucket="bucket",\n\n        # the properties below are optional\n        bucket_account_id="bucketAccountId"\n    )\n')
...
class CfnStorageLens_AccountLevelPropertyDef(BaseStruct):
    bucket_level: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnStorageLens_BucketLevelPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='This property contains the details of the account-level bucket-level configurations for Amazon S3 Storage Lens.\n')
    activity_metrics: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnStorageLens_ActivityMetricsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='This property contains the details of account-level activity metrics for S3 Storage Lens.\n')
    advanced_cost_optimization_metrics: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnStorageLens_AdvancedCostOptimizationMetricsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='This property contains the details of account-level advanced cost optimization metrics for S3 Storage Lens.\n')
    advanced_data_protection_metrics: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnStorageLens_AdvancedDataProtectionMetricsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='This property contains the details of account-level advanced data protection metrics for S3 Storage Lens.\n')
    detailed_status_codes_metrics: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnStorageLens_DetailedStatusCodesMetricsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='This property contains the details of account-level detailed status code metrics for S3 Storage Lens.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-storagelens-accountlevel.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n\n    account_level_property = s3.CfnStorageLens.AccountLevelProperty(\n        bucket_level=s3.CfnStorageLens.BucketLevelProperty(\n            activity_metrics=s3.CfnStorageLens.ActivityMetricsProperty(\n                is_enabled=False\n            ),\n            advanced_cost_optimization_metrics=s3.CfnStorageLens.AdvancedCostOptimizationMetricsProperty(\n                is_enabled=False\n            ),\n            advanced_data_protection_metrics=s3.CfnStorageLens.AdvancedDataProtectionMetricsProperty(\n                is_enabled=False\n            ),\n            detailed_status_codes_metrics=s3.CfnStorageLens.DetailedStatusCodesMetricsProperty(\n                is_enabled=False\n            ),\n            prefix_level=s3.CfnStorageLens.PrefixLevelProperty(\n                storage_metrics=s3.CfnStorageLens.PrefixLevelStorageMetricsProperty(\n                    is_enabled=False,\n                    selection_criteria=s3.CfnStorageLens.SelectionCriteriaProperty(\n                        delimiter="delimiter",\n                        max_depth=123,\n                        min_storage_bytes_percentage=123\n                    )\n                )\n            )\n        ),\n\n        # the properties below are optional\n        activity_metrics=s3.CfnStorageLens.ActivityMetricsProperty(\n            is_enabled=False\n        ),\n        advanced_cost_optimization_metrics=s3.CfnStorageLens.AdvancedCostOptimizationMetricsProperty(\n            is_enabled=False\n        ),\n        advanced_data_protection_metrics=s3.CfnStorageLens.AdvancedDataProtectionMetricsProperty(\n            is_enabled=False\n        ),\n        detailed_status_codes_metrics=s3.CfnStorageLens.DetailedStatusCodesMetricsProperty(\n            is_enabled=False\n        )\n    )\n')
...
class CfnStorageLens_ActivityMetricsPropertyDef(BaseStruct):
    is_enabled: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description='A property that indicates whether the activity metrics is enabled.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-storagelens-activitymetrics.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n\n    activity_metrics_property = s3.CfnStorageLens.ActivityMetricsProperty(\n        is_enabled=False\n    )\n')
...
class CfnStorageLens_AdvancedCostOptimizationMetricsPropertyDef(BaseStruct):
    is_enabled: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description='Indicates whether advanced cost optimization metrics are enabled.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-storagelens-advancedcostoptimizationmetrics.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n\n    advanced_cost_optimization_metrics_property = s3.CfnStorageLens.AdvancedCostOptimizationMetricsProperty(\n        is_enabled=False\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['is_enabled']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnStorageLens_AdvancedDataProtectionMetricsPropertyDef(BaseStruct):
    is_enabled: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description='Indicates whether advanced data protection metrics are enabled.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-storagelens-advanceddataprotectionmetrics.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n\n    advanced_data_protection_metrics_property = s3.CfnStorageLens.AdvancedDataProtectionMetricsProperty(\n        is_enabled=False\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['is_enabled']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnStorageLens_BucketLevelPropertyDef(BaseStruct):
    activity_metrics: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnStorageLens_ActivityMetricsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A property for bucket-level activity metrics for S3 Storage Lens.\n')
    advanced_cost_optimization_metrics: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnStorageLens_AdvancedCostOptimizationMetricsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A property for bucket-level advanced cost optimization metrics for S3 Storage Lens.\n')
    advanced_data_protection_metrics: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnStorageLens_AdvancedDataProtectionMetricsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A property for bucket-level advanced data protection metrics for S3 Storage Lens.\n')
    detailed_status_codes_metrics: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnStorageLens_DetailedStatusCodesMetricsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A property for bucket-level detailed status code metrics for S3 Storage Lens.\n')
    prefix_level: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnStorageLens_PrefixLevelPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A property for bucket-level prefix-level storage metrics for S3 Storage Lens.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-storagelens-bucketlevel.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n\n    bucket_level_property = s3.CfnStorageLens.BucketLevelProperty(\n        activity_metrics=s3.CfnStorageLens.ActivityMetricsProperty(\n            is_enabled=False\n        ),\n        advanced_cost_optimization_metrics=s3.CfnStorageLens.AdvancedCostOptimizationMetricsProperty(\n            is_enabled=False\n        ),\n        advanced_data_protection_metrics=s3.CfnStorageLens.AdvancedDataProtectionMetricsProperty(\n            is_enabled=False\n        ),\n        detailed_status_codes_metrics=s3.CfnStorageLens.DetailedStatusCodesMetricsProperty(\n            is_enabled=False\n        ),\n        prefix_level=s3.CfnStorageLens.PrefixLevelProperty(\n            storage_metrics=s3.CfnStorageLens.PrefixLevelStorageMetricsProperty(\n                is_enabled=False,\n                selection_criteria=s3.CfnStorageLens.SelectionCriteriaProperty(\n                    delimiter="delimiter",\n                    max_depth=123,\n                    min_storage_bytes_percentage=123\n                )\n            )\n        )\n    )\n')
...
class CfnStorageLens_CloudWatchMetricsPropertyDef(BaseStruct):
    is_enabled: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef]] = pydantic.Field(..., description='This property identifies whether the CloudWatch publishing option for S3 Storage Lens is enabled.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-storagelens-cloudwatchmetrics.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n\n    cloud_watch_metrics_property = s3.CfnStorageLens.CloudWatchMetricsProperty(\n        is_enabled=False\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['is_enabled']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnStorageLens_DataExportPropertyDef(BaseStruct):
    cloud_watch_metrics: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnStorageLens_CloudWatchMetricsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='This property enables the Amazon CloudWatch publishing option for S3 Storage Lens metrics.\n')
    s3_bucket_destination: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnStorageLens_S3BucketDestinationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='This property contains the details of the bucket where the S3 Storage Lens metrics export will be placed.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-storagelens-dataexport.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n\n    # sses3: Any\n\n    data_export_property = s3.CfnStorageLens.DataExportProperty(\n        cloud_watch_metrics=s3.CfnStorageLens.CloudWatchMetricsProperty(\n            is_enabled=False\n        ),\n        s3_bucket_destination=s3.CfnStorageLens.S3BucketDestinationProperty(\n            account_id="accountId",\n            arn="arn",\n            format="format",\n            output_schema_version="outputSchemaVersion",\n\n            # the properties below are optional\n            encryption=s3.CfnStorageLens.EncryptionProperty(\n                ssekms=s3.CfnStorageLens.SSEKMSProperty(\n                    key_id="keyId"\n                ),\n                sses3=sses3\n            ),\n            prefix="prefix"\n        )\n    )\n')
...
class CfnStorageLens_DetailedStatusCodesMetricsPropertyDef(BaseStruct):
    is_enabled: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description='Indicates whether detailed status code metrics are enabled.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-storagelens-detailedstatuscodesmetrics.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n\n    detailed_status_codes_metrics_property = s3.CfnStorageLens.DetailedStatusCodesMetricsProperty(\n        is_enabled=False\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['is_enabled']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnStorageLens_EncryptionPropertyDef(BaseStruct):
    ssekms: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnStorageLens_SSEKMSPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Specifies the use of AWS Key Management Service keys (SSE-KMS) to encrypt the S3 Storage Lens metrics export file.\n')
...
class CfnStorageLens_PrefixLevelPropertyDef(BaseStruct):
    storage_metrics: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnStorageLens_PrefixLevelStorageMetricsPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='A property for the prefix-level storage metrics for Amazon S3 Storage Lens.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-storagelens-prefixlevel.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n\n    prefix_level_property = s3.CfnStorageLens.PrefixLevelProperty(\n        storage_metrics=s3.CfnStorageLens.PrefixLevelStorageMetricsProperty(\n            is_enabled=False,\n            selection_criteria=s3.CfnStorageLens.SelectionCriteriaProperty(\n                delimiter="delimiter",\n                max_depth=123,\n                min_storage_bytes_percentage=123\n            )\n        )\n    )\n')
...
class CfnStorageLens_PrefixLevelStorageMetricsPropertyDef(BaseStruct):
    is_enabled: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description='This property identifies whether the details of the prefix-level storage metrics for S3 Storage Lens are enabled.\n')
    selection_criteria: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnStorageLens_SelectionCriteriaPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='This property identifies whether the details of the prefix-level storage metrics for S3 Storage Lens are enabled.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-storagelens-prefixlevelstoragemetrics.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n\n    prefix_level_storage_metrics_property = s3.CfnStorageLens.PrefixLevelStorageMetricsProperty(\n        is_enabled=False,\n        selection_criteria=s3.CfnStorageLens.SelectionCriteriaProperty(\n            delimiter="delimiter",\n            max_depth=123,\n            min_storage_bytes_percentage=123\n        )\n    )\n')
...
class CfnStorageLens_S3BucketDestinationPropertyDef(BaseStruct):
    account_id: str = pydantic.Field(..., description='This property contains the details of the AWS account ID of the S3 Storage Lens export bucket destination.\n')
    arn: str = pydantic.Field(..., description='This property contains the details of the ARN of the bucket destination of the S3 Storage Lens export.\n')
    format: str = pydantic.Field(..., description='This property contains the details of the format of the S3 Storage Lens export bucket destination.\n')
    output_schema_version: str = pydantic.Field(..., description='This property contains the details of the output schema version of the S3 Storage Lens export bucket destination.\n')
    encryption: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnStorageLens_EncryptionPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='This property contains the details of the encryption of the bucket destination of the Amazon S3 Storage Lens metrics export.\n')
...
class CfnStorageLens_StorageLensConfigurationPropertyDef(BaseStruct):
    account_level: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnStorageLens_AccountLevelPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='This property contains the details of the account-level metrics for Amazon S3 Storage Lens configuration.\n')
    is_enabled: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef]] = pydantic.Field(..., description='This property contains the details of whether the Amazon S3 Storage Lens configuration is enabled.\n')
    aws_org: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnStorageLens_AwsOrgPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='This property contains the details of the AWS Organization for the S3 Storage Lens configuration.\n')
    data_export: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnStorageLens_DataExportPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description="This property contains the details of this S3 Storage Lens configuration's metrics export.\n")
    exclude: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnStorageLens_BucketsAndRegionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='This property contains the details of the bucket and or Regions excluded for Amazon S3 Storage Lens configuration.\n')
    include: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnStorageLens_BucketsAndRegionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='This property contains the details of the bucket and or Regions included for Amazon S3 Storage Lens configuration.\n')
...
class IntelligentTieringConfigurationDef(BaseStruct):
    name: str = pydantic.Field(..., description='Configuration name.\n')
...
class InventoryDestinationDef(BaseStruct):
    bucket: typing.Union[models.aws_s3.BucketBaseDef, models.aws_s3.BucketDef] = pydantic.Field(..., description='Bucket where all inventories will be saved in.\n')
    ...
    resource_config: typing.Optional[InventoryDestinationDefConfig] = pydantic.Field(None)
...
class NoncurrentVersionTransitionDef(BaseStruct):
    storage_class: models.aws_s3.StorageClassDef = pydantic.Field(..., description='The storage class to which you want the object to transition.\n')
    transition_after: models.DurationDef = pydantic.Field(..., description='Indicates the number of days after creation when objects are transitioned to the specified storage class. Default: - No transition count.\n')
    ...
    resource_config: typing.Optional[NoncurrentVersionTransitionDefConfig] = pydantic.Field(None)
...
class TagDef(BaseStruct):
    key: str = pydantic.Field(..., description='key to e tagged.\n')
    value: str = pydantic.Field(..., description='additional value.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n\n    tag = s3.Tag(\n        key="key",\n        value="value"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['key', 'value']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnAccessPointDef(BaseCfnResource):
    bucket: str = pydantic.Field(..., description='The name of the bucket associated with this access point.\n')
    ...
    public_access_block_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnAccessPoint_PublicAccessBlockConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The PublicAccessBlock configuration that you want to apply to this Amazon S3 bucket. You can enable the configuration options in any combination. For more information about when Amazon S3 considers a bucket or object public, see `The Meaning of "Public" <https://docs.aws.amazon.com/AmazonS3/latest/dev/access-control-block-public-access.html#access-control-block-public-access-policy-status>`_ in the *Amazon S3 User Guide* .\n')
    vpc_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnAccessPoint_VpcConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The Virtual Private Cloud (VPC) configuration for this access point, if one exists.')
...
class CfnAccessPointDefConfig(pydantic.BaseModel):
    PublicAccessBlockConfigurationProperty: typing.Optional[list[CfnAccessPointDefPublicaccessblockconfigurationpropertyParams]] = pydantic.Field(None, description='')
...
class CfnBucketDef(BaseCfnResource):
    accelerate_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_AccelerateConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Configures the transfer acceleration state for an Amazon S3 bucket. For more information, see `Amazon S3 Transfer Acceleration <https://docs.aws.amazon.com/AmazonS3/latest/dev/transfer-acceleration.html>`_ in the *Amazon S3 User Guide* .\n')
    access_control: typing.Optional[str] = pydantic.Field(None, description='A canned access control list (ACL) that grants predefined permissions to the bucket. For more information about canned ACLs, see `Canned ACL <https://docs.aws.amazon.com/AmazonS3/latest/dev/acl-overview.html#canned-acl>`_ in the *Amazon S3 User Guide* . Be aware that the syntax for this property differs from the information provided in the *Amazon S3 User Guide* . The AccessControl property is case-sensitive and must be one of the following values: Private, PublicRead, PublicReadWrite, AuthenticatedRead, LogDeliveryWrite, BucketOwnerRead, BucketOwnerFullControl, or AwsExecRead.\n')
    analytics_configurations: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_AnalyticsConfigurationPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='Specifies the configuration and any analyses for the analytics filter of an Amazon S3 bucket.\n')
    bucket_encryption: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_BucketEncryptionPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Specifies default encryption for a bucket using server-side encryption with Amazon S3-managed keys (SSE-S3) or AWS KMS-managed keys (SSE-KMS) bucket. For information about the Amazon S3 default encryption feature, see `Amazon S3 Default Encryption for S3 Buckets <https://docs.aws.amazon.com/AmazonS3/latest/dev/bucket-encryption.html>`_ in the *Amazon S3 User Guide* .\n')
    ...
    cors_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_CorsConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Describes the cross-origin access configuration for objects in an Amazon S3 bucket. For more information, see `Enabling Cross-Origin Resource Sharing <https://docs.aws.amazon.com/AmazonS3/latest/dev/cors.html>`_ in the *Amazon S3 User Guide* .\n')
    intelligent_tiering_configurations: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_IntelligentTieringConfigurationPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='Defines how Amazon S3 handles Intelligent-Tiering storage.\n')
    inventory_configurations: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_InventoryConfigurationPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='Specifies the inventory configuration for an Amazon S3 bucket. For more information, see `GET Bucket inventory <https://docs.aws.amazon.com/AmazonS3/latest/API/RESTBucketGETInventoryConfig.html>`_ in the *Amazon S3 API Reference* .\n')
    lifecycle_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_LifecycleConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Specifies the lifecycle configuration for objects in an Amazon S3 bucket. For more information, see `Object Lifecycle Management <https://docs.aws.amazon.com/AmazonS3/latest/dev/object-lifecycle-mgmt.html>`_ in the *Amazon S3 User Guide* .\n')
    logging_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_LoggingConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Settings that define where logs are stored.\n')
    metrics_configurations: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_MetricsConfigurationPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description="Specifies a metrics configuration for the CloudWatch request metrics (specified by the metrics configuration ID) from an Amazon S3 bucket. If you're updating an existing metrics configuration, note that this is a full replacement of the existing metrics configuration. If you don't include the elements you want to keep, they are erased. For more information, see `PutBucketMetricsConfiguration <https://docs.aws.amazon.com/AmazonS3/latest/API/RESTBucketPUTMetricConfiguration.html>`_ .\n")
    notification_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_NotificationConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Configuration that defines how Amazon S3 handles bucket notifications.\n')
    object_lock_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_ObjectLockConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Places an Object Lock configuration on the specified bucket. The rule specified in the Object Lock configuration will be applied by default to every new object placed in the specified bucket. For more information, see `Locking Objects <https://docs.aws.amazon.com/AmazonS3/latest/dev/object-lock.html>`_ . .. epigraph:: - The ``DefaultRetention`` settings require both a mode and a period. - The ``DefaultRetention`` period can be either ``Days`` or ``Years`` but you must select one. You cannot specify ``Days`` and ``Years`` at the same time. - You can only enable Object Lock for new buckets. If you want to turn on Object Lock for an existing bucket, contact AWS Support.\n')
    object_lock_enabled: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description='Indicates whether this bucket has an Object Lock configuration enabled. Enable ``ObjectLockEnabled`` when you apply ``ObjectLockConfiguration`` to a bucket.\n')
    ownership_controls: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_OwnershipControlsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Configuration that defines how Amazon S3 handles Object Ownership rules.\n')
    public_access_block_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_PublicAccessBlockConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Configuration that defines how Amazon S3 handles public access.\n')
    replication_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_ReplicationConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Configuration for replicating objects in an S3 bucket. To enable replication, you must also enable versioning by using the ``VersioningConfiguration`` property. Amazon S3 can store replicated objects in a single destination bucket or multiple destination buckets. The destination bucket or buckets must already exist.\n')
    ...
    versioning_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_VersioningConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Enables multiple versions of all objects in this bucket. You might enable versioning to prevent objects from being deleted or overwritten by mistake or to archive objects so that you can retrieve previous versions of them.\n')
    website_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_WebsiteConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Information used to configure the bucket as a static website. For more information, see `Hosting Websites on Amazon S3 <https://docs.aws.amazon.com/AmazonS3/latest/dev/WebsiteHosting.html>`_ .')
...
class CfnBucketDefConfig(pydantic.BaseModel):
    ...
    AccelerateConfigurationProperty: typing.Optional[list[CfnBucketDefAccelerateconfigurationpropertyParams]] = pydantic.Field(None, description='')
    AccessControlTranslationProperty: typing.Optional[list[CfnBucketDefAccesscontroltranslationpropertyParams]] = pydantic.Field(None, description='')
    AnalyticsConfigurationProperty: typing.Optional[list[CfnBucketDefAnalyticsconfigurationpropertyParams]] = pydantic.Field(None, description='')
    BucketEncryptionProperty: typing.Optional[list[CfnBucketDefBucketencryptionpropertyParams]] = pydantic.Field(None, description='')
    CorsConfigurationProperty: typing.Optional[list[CfnBucketDefCorsconfigurationpropertyParams]] = pydantic.Field(None, description='')
    CorsRuleProperty: typing.Optional[list[CfnBucketDefCorsrulepropertyParams]] = pydantic.Field(None, description='')
    DataExportProperty: typing.Optional[list[CfnBucketDefDataexportpropertyParams]] = pydantic.Field(None, description='')
    DefaultRetentionProperty: typing.Optional[list[CfnBucketDefDefaultretentionpropertyParams]] = pydantic.Field(None, description='')
    DeleteMarkerReplicationProperty: typing.Optional[list[CfnBucketDefDeletemarkerreplicationpropertyParams]] = pydantic.Field(None, description='')
    DestinationProperty: typing.Optional[list[CfnBucketDefDestinationpropertyParams]] = pydantic.Field(None, description='')
    EncryptionConfigurationProperty: typing.Optional[list[CfnBucketDefEncryptionconfigurationpropertyParams]] = pydantic.Field(None, description='')
    EventBridgeConfigurationProperty: typing.Optional[list[CfnBucketDefEventbridgeconfigurationpropertyParams]] = pydantic.Field(None, description='')
    FilterRuleProperty: typing.Optional[list[CfnBucketDefFilterrulepropertyParams]] = pydantic.Field(None, description='')
    IntelligentTieringConfigurationProperty: typing.Optional[list[CfnBucketDefIntelligenttieringconfigurationpropertyParams]] = pydantic.Field(None, description='')
    InventoryConfigurationProperty: typing.Optional[list[CfnBucketDefInventoryconfigurationpropertyParams]] = pydantic.Field(None, description='')
    LambdaConfigurationProperty: typing.Optional[list[CfnBucketDefLambdaconfigurationpropertyParams]] = pydantic.Field(None, description='')
    ...
    LoggingConfigurationProperty: typing.Optional[list[CfnBucketDefLoggingconfigurationpropertyParams]] = pydantic.Field(None, description='')
    MetricsConfigurationProperty: typing.Optional[list[CfnBucketDefMetricsconfigurationpropertyParams]] = pydantic.Field(None, description='')
    MetricsProperty: typing.Optional[list[CfnBucketDefMetricspropertyParams]] = pydantic.Field(None, description='')
    NoncurrentVersionExpirationProperty: typing.Optional[list[CfnBucketDefNoncurrentversionexpirationpropertyParams]] = pydantic.Field(None, description='')
    NoncurrentVersionTransitionProperty: typing.Optional[list[CfnBucketDefNoncurrentversiontransitionpropertyParams]] = pydantic.Field(None, description='')
    NotificationConfigurationProperty: typing.Optional[list[CfnBucketDefNotificationconfigurationpropertyParams]] = pydantic.Field(None, description='')
    NotificationFilterProperty: typing.Optional[list[CfnBucketDefNotificationfilterpropertyParams]] = pydantic.Field(None, description='')
    ObjectLockConfigurationProperty: typing.Optional[list[CfnBucketDefObjectlockconfigurationpropertyParams]] = pydantic.Field(None, description='')
    ObjectLockRuleProperty: typing.Optional[list[CfnBucketDefObjectlockrulepropertyParams]] = pydantic.Field(None, description='')
    OwnershipControlsProperty: typing.Optional[list[CfnBucketDefOwnershipcontrolspropertyParams]] = pydantic.Field(None, description='')
    OwnershipControlsRuleProperty: typing.Optional[list[CfnBucketDefOwnershipcontrolsrulepropertyParams]] = pydantic.Field(None, description='')
    PublicAccessBlockConfigurationProperty: typing.Optional[list[CfnBucketDefPublicaccessblockconfigurationpropertyParams]] = pydantic.Field(None, description='')
    QueueConfigurationProperty: typing.Optional[list[CfnBucketDefQueueconfigurationpropertyParams]] = pydantic.Field(None, description='')
    RedirectAllRequestsToProperty: typing.Optional[list[CfnBucketDefRedirectallrequeststopropertyParams]] = pydantic.Field(None, description='')
    RedirectRuleProperty: typing.Optional[list[CfnBucketDefRedirectrulepropertyParams]] = pydantic.Field(None, description='')
    ReplicaModificationsProperty: typing.Optional[list[CfnBucketDefReplicamodificationspropertyParams]] = pydantic.Field(None, description='')
    ReplicationConfigurationProperty: typing.Optional[list[CfnBucketDefReplicationconfigurationpropertyParams]] = pydantic.Field(None, description='')
    ReplicationDestinationProperty: typing.Optional[list[CfnBucketDefReplicationdestinationpropertyParams]] = pydantic.Field(None, description='')
    ReplicationRuleAndOperatorProperty: typing.Optional[list[CfnBucketDefReplicationruleandoperatorpropertyParams]] = pydantic.Field(None, description='')
    ReplicationRuleFilterProperty: typing.Optional[list[CfnBucketDefReplicationrulefilterpropertyParams]] = pydantic.Field(None, description='')
    ReplicationRuleProperty: typing.Optional[list[CfnBucketDefReplicationrulepropertyParams]] = pydantic.Field(None, description='')
    ReplicationTimeProperty: typing.Optional[list[CfnBucketDefReplicationtimepropertyParams]] = pydantic.Field(None, description='')
    ReplicationTimeValueProperty: typing.Optional[list[CfnBucketDefReplicationtimevaluepropertyParams]] = pydantic.Field(None, description='')
    RoutingRuleConditionProperty: typing.Optional[list[CfnBucketDefRoutingruleconditionpropertyParams]] = pydantic.Field(None, description='')
    RoutingRuleProperty: typing.Optional[list[CfnBucketDefRoutingrulepropertyParams]] = pydantic.Field(None, description='')
    RuleProperty: typing.Optional[list[CfnBucketDefRulepropertyParams]] = pydantic.Field(None, description='')
    S3KeyFilterProperty: typing.Optional[list[CfnBucketDefS3KeyfilterpropertyParams]] = pydantic.Field(None, description='')
    ServerSideEncryptionByDefaultProperty: typing.Optional[list[CfnBucketDefServersideencryptionbydefaultpropertyParams]] = pydantic.Field(None, description='')
    ServerSideEncryptionRuleProperty: typing.Optional[list[CfnBucketDefServersideencryptionrulepropertyParams]] = pydantic.Field(None, description='')
    SourceSelectionCriteriaProperty: typing.Optional[list[CfnBucketDefSourceselectioncriteriapropertyParams]] = pydantic.Field(None, description='')
    SseKmsEncryptedObjectsProperty: typing.Optional[list[CfnBucketDefSsekmsencryptedobjectspropertyParams]] = pydantic.Field(None, description='')
    StorageClassAnalysisProperty: typing.Optional[list[CfnBucketDefStorageclassanalysispropertyParams]] = pydantic.Field(None, description='')
    TagFilterProperty: typing.Optional[list[CfnBucketDefTagfilterpropertyParams]] = pydantic.Field(None, description='')
    TieringProperty: typing.Optional[list[CfnBucketDefTieringpropertyParams]] = pydantic.Field(None, description='')
    TopicConfigurationProperty: typing.Optional[list[CfnBucketDefTopicconfigurationpropertyParams]] = pydantic.Field(None, description='')
    TransitionProperty: typing.Optional[list[CfnBucketDefTransitionpropertyParams]] = pydantic.Field(None, description='')
    VersioningConfigurationProperty: typing.Optional[list[CfnBucketDefVersioningconfigurationpropertyParams]] = pydantic.Field(None, description='')
    WebsiteConfigurationProperty: typing.Optional[list[CfnBucketDefWebsiteconfigurationpropertyParams]] = pydantic.Field(None, description='')
...
class CfnBucketDefAnalyticsconfigurationpropertyParams(pydantic.BaseModel):
    id: str = pydantic.Field(..., description='')
    storage_class_analysis: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_StorageClassAnalysisPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    prefix: typing.Optional[str] = pydantic.Field(None, description='')
    tag_filters: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_TagFilterPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    ...

class CfnBucketDefBucketencryptionpropertyParams(pydantic.BaseModel):
    server_side_encryption_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_ServerSideEncryptionRulePropertyDef, dict[str, typing.Any]]]] = pydantic.Field(..., description='')
    ...
...
class CfnBucketDefDataexportpropertyParams(pydantic.BaseModel):
    destination: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_DestinationPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
...
class CfnBucketDefIntelligenttieringconfigurationpropertyParams(pydantic.BaseModel):
    ...
    tierings: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_TieringPropertyDef, dict[str, typing.Any]]]] = pydantic.Field(..., description='')
    prefix: typing.Optional[str] = pydantic.Field(None, description='')
    tag_filters: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_TagFilterPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    ...
...
class CfnBucketDefLambdaconfigurationpropertyParams(pydantic.BaseModel):
    ...
    filter: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_NotificationFilterPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnBucketDefMetricspropertyParams(pydantic.BaseModel):
    status: str = pydantic.Field(..., description='')
    event_threshold: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_ReplicationTimeValuePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnBucketDefNotificationconfigurationpropertyParams(pydantic.BaseModel):
    ...
    lambda_configurations: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_LambdaConfigurationPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    queue_configurations: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_QueueConfigurationPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    topic_configurations: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_TopicConfigurationPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    ...

class CfnBucketDefNotificationfilterpropertyParams(pydantic.BaseModel):
    s3_key: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_S3KeyFilterPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    ...
...
class CfnBucketDefObjectlockconfigurationpropertyParams(pydantic.BaseModel):
    ...
    rule: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_ObjectLockRulePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnBucketDefReplicationconfigurationpropertyParams(pydantic.BaseModel):
    ...
    rules: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_ReplicationRulePropertyDef, dict[str, typing.Any]]]] = pydantic.Field(..., description='')
    ...

class CfnBucketDefReplicationdestinationpropertyParams(pydantic.BaseModel):
    bucket: str = pydantic.Field(..., description='')
    access_control_translation: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_AccessControlTranslationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    account: typing.Optional[str] = pydantic.Field(None, description='')
    encryption_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_EncryptionConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    metrics: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_MetricsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    replication_time: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_ReplicationTimePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
...
class CfnBucketDefReplicationrulepropertyParams(pydantic.BaseModel):
    destination: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_ReplicationDestinationPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    status: str = pydantic.Field(..., description='')
    delete_marker_replication: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_DeleteMarkerReplicationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    filter: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_ReplicationRuleFilterPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    id: typing.Optional[str] = pydantic.Field(None, description='')
    prefix: typing.Optional[str] = pydantic.Field(None, description='')
    priority: typing.Union[int, float, None] = pydantic.Field(None, description='')
    source_selection_criteria: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_SourceSelectionCriteriaPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...

class CfnBucketDefReplicationtimepropertyParams(pydantic.BaseModel):
    status: str = pydantic.Field(..., description='')
    time: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_ReplicationTimeValuePropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    ...
...
class CfnBucketDefRoutingrulepropertyParams(pydantic.BaseModel):
    redirect_rule: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_RedirectRulePropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    routing_rule_condition: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_RoutingRuleConditionPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...

class CfnBucketDefRulepropertyParams(pydantic.BaseModel):
    status: str = pydantic.Field(..., description='')
    abort_incomplete_multipart_upload: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_AbortIncompleteMultipartUploadPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    expiration_date: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], datetime.datetime, None] = pydantic.Field(None, description='')
    ...
    noncurrent_version_transition: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_NoncurrentVersionTransitionPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    noncurrent_version_transitions: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_NoncurrentVersionTransitionPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    ...
    prefix: typing.Optional[str] = pydantic.Field(None, description='')
    tag_filters: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_TagFilterPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    transition: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_TransitionPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    transitions: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_TransitionPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    ...
...
class CfnBucketDefSourceselectioncriteriapropertyParams(pydantic.BaseModel):
    replica_modifications: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_ReplicaModificationsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    sse_kms_encrypted_objects: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_SseKmsEncryptedObjectsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnBucketDefStorageclassanalysispropertyParams(pydantic.BaseModel):
    data_export: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnBucket_DataExportPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnBucketPolicyDef(BaseCfnResource):
    bucket: str = pydantic.Field(..., description='The name of the Amazon S3 bucket to which the policy applies.\n')
...
class CfnMultiRegionAccessPointDef(BaseCfnResource):
    regions: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnMultiRegionAccessPoint_RegionPropertyDef, dict[str, typing.Any]]]] = pydantic.Field(..., description='A collection of the Regions and buckets associated with the Multi-Region Access Point.\n')
    name: typing.Optional[str] = pydantic.Field(None, description='The name of the Multi-Region Access Point.\n')
    public_access_block_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnMultiRegionAccessPoint_PublicAccessBlockConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The PublicAccessBlock configuration that you want to apply to this Multi-Region Access Point. You can enable the configuration options in any combination. For more information about when Amazon S3 considers an object public, see `The Meaning of "Public" <https://docs.aws.amazon.com/AmazonS3/latest/dev/access-control-block-public-access.html#access-control-block-public-access-policy-status>`_ in the *Amazon S3 User Guide* .')
    ...
    resource_config: typing.Optional[CfnMultiRegionAccessPointDefConfig] = pydantic.Field(None)


class CfnMultiRegionAccessPointDefConfig(pydantic.BaseModel):
    PublicAccessBlockConfigurationProperty: typing.Optional[list[CfnMultiRegionAccessPointDefPublicaccessblockconfigurationpropertyParams]] = pydantic.Field(None, description='')
    RegionProperty: typing.Optional[list[CfnMultiRegionAccessPointDefRegionpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[CfnMultiRegionAccessPointDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[CfnMultiRegionAccessPointDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[CfnMultiRegionAccessPointDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[CfnMultiRegionAccessPointDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[CfnMultiRegionAccessPointDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[CfnMultiRegionAccessPointDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[CfnMultiRegionAccessPointDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[CfnMultiRegionAccessPointDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[CfnMultiRegionAccessPointDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[CfnMultiRegionAccessPointDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[CfnMultiRegionAccessPointDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[CfnMultiRegionAccessPointDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[CfnMultiRegionAccessPointDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
class CfnMultiRegionAccessPointPolicyDef(BaseCfnResource):
    mrap_name: str = pydantic.Field(..., description='The name of the Multi-Region Access Point.\n')
    policy: typing.Any = pydantic.Field(..., description='The access policy associated with the Multi-Region Access Point.')
    ...
    resource_config: typing.Optional[CfnMultiRegionAccessPointPolicyDefConfig] = pydantic.Field(None)


class CfnMultiRegionAccessPointPolicyDefConfig(pydantic.BaseModel):
    PolicyStatusProperty: typing.Optional[list[CfnMultiRegionAccessPointPolicyDefPolicystatuspropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[CfnMultiRegionAccessPointPolicyDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[CfnMultiRegionAccessPointPolicyDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[CfnMultiRegionAccessPointPolicyDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[CfnMultiRegionAccessPointPolicyDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[CfnMultiRegionAccessPointPolicyDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[CfnMultiRegionAccessPointPolicyDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[CfnMultiRegionAccessPointPolicyDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[CfnMultiRegionAccessPointPolicyDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[CfnMultiRegionAccessPointPolicyDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[CfnMultiRegionAccessPointPolicyDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[CfnMultiRegionAccessPointPolicyDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[CfnMultiRegionAccessPointPolicyDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[CfnMultiRegionAccessPointPolicyDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
class CfnStorageLensDef(BaseCfnResource):
    storage_lens_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnStorageLens_StorageLensConfigurationPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='This resource contains the details Amazon S3 Storage Lens configuration.\n')
    ...
    resource_config: typing.Optional[CfnStorageLensDefConfig] = pydantic.Field(None)


class CfnStorageLensDefConfig(pydantic.BaseModel):
    AccountLevelProperty: typing.Optional[list[CfnStorageLensDefAccountlevelpropertyParams]] = pydantic.Field(None, description='')
    ActivityMetricsProperty: typing.Optional[list[CfnStorageLensDefActivitymetricspropertyParams]] = pydantic.Field(None, description='')
    AdvancedCostOptimizationMetricsProperty: typing.Optional[list[CfnStorageLensDefAdvancedcostoptimizationmetricspropertyParams]] = pydantic.Field(None, description='')
    AdvancedDataProtectionMetricsProperty: typing.Optional[list[CfnStorageLensDefAdvanceddataprotectionmetricspropertyParams]] = pydantic.Field(None, description='')
    AwsOrgProperty: typing.Optional[list[CfnStorageLensDefAwsorgpropertyParams]] = pydantic.Field(None, description='')
    BucketLevelProperty: typing.Optional[list[CfnStorageLensDefBucketlevelpropertyParams]] = pydantic.Field(None, description='')
    BucketsAndRegionsProperty: typing.Optional[list[CfnStorageLensDefBucketsandregionspropertyParams]] = pydantic.Field(None, description='')
    CloudWatchMetricsProperty: typing.Optional[list[CfnStorageLensDefCloudwatchmetricspropertyParams]] = pydantic.Field(None, description='')
    DataExportProperty: typing.Optional[list[CfnStorageLensDefDataexportpropertyParams]] = pydantic.Field(None, description='')
    DetailedStatusCodesMetricsProperty: typing.Optional[list[CfnStorageLensDefDetailedstatuscodesmetricspropertyParams]] = pydantic.Field(None, description='')
    EncryptionProperty: typing.Optional[list[CfnStorageLensDefEncryptionpropertyParams]] = pydantic.Field(None, description='')
    PrefixLevelProperty: typing.Optional[list[CfnStorageLensDefPrefixlevelpropertyParams]] = pydantic.Field(None, description='')
    PrefixLevelStorageMetricsProperty: typing.Optional[list[CfnStorageLensDefPrefixlevelstoragemetricspropertyParams]] = pydantic.Field(None, description='')
    S3BucketDestinationProperty: typing.Optional[list[CfnStorageLensDefS3BucketdestinationpropertyParams]] = pydantic.Field(None, description='')
    SSEKMSProperty: typing.Optional[list[CfnStorageLensDefSsekmspropertyParams]] = pydantic.Field(None, description='')
    SelectionCriteriaProperty: typing.Optional[list[CfnStorageLensDefSelectioncriteriapropertyParams]] = pydantic.Field(None, description='')
    StorageLensConfigurationProperty: typing.Optional[list[CfnStorageLensDefStoragelensconfigurationpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[CfnStorageLensDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[CfnStorageLensDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[CfnStorageLensDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[CfnStorageLensDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[CfnStorageLensDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[CfnStorageLensDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[CfnStorageLensDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[CfnStorageLensDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[CfnStorageLensDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[CfnStorageLensDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[CfnStorageLensDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[CfnStorageLensDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[CfnStorageLensDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
    tags_config: typing.Optional[models.core.TagManagerDefConfig] = pydantic.Field(None)

class CfnStorageLensDefAccountlevelpropertyParams(pydantic.BaseModel):
    bucket_level: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnStorageLens_BucketLevelPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    activity_metrics: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnStorageLens_ActivityMetricsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    advanced_cost_optimization_metrics: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnStorageLens_AdvancedCostOptimizationMetricsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    advanced_data_protection_metrics: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnStorageLens_AdvancedDataProtectionMetricsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    detailed_status_codes_metrics: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnStorageLens_DetailedStatusCodesMetricsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnStorageLensDefBucketlevelpropertyParams(pydantic.BaseModel):
    ...
    advanced_data_protection_metrics: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnStorageLens_AdvancedDataProtectionMetricsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    detailed_status_codes_metrics: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnStorageLens_DetailedStatusCodesMetricsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    prefix_level: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnStorageLens_PrefixLevelPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnStorageLensDefDataexportpropertyParams(pydantic.BaseModel):
    cloud_watch_metrics: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnStorageLens_CloudWatchMetricsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    s3_bucket_destination: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnStorageLens_S3BucketDestinationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnStorageLensDefPrefixlevelstoragemetricspropertyParams(pydantic.BaseModel):
    is_enabled: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description='')
    selection_criteria: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnStorageLens_SelectionCriteriaPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnStorageLensDefStoragelensconfigurationpropertyParams(pydantic.BaseModel):
    ...
    id: str = pydantic.Field(..., description='')
    is_enabled: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef]] = pydantic.Field(..., description='')
    aws_org: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnStorageLens_AwsOrgPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    data_export: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_s3.CfnStorageLens_DataExportPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
...
class ModuleModel(pydantic.BaseModel):
    BlockPublicAccess: typing.Optional[dict[str, BlockPublicAccessDef]] = pydantic.Field(None)
    BucketBase: typing.Optional[dict[str, BucketBaseDef]] = pydantic.Field(None)
    ObjectLockRetention: typing.Optional[dict[str, ObjectLockRetentionDef]] = pydantic.Field(None)
    ReplaceKey: typing.Optional[dict[str, ReplaceKeyDef]] = pydantic.Field(None)
    StorageClass: typing.Optional[dict[str, StorageClassDef]] = pydantic.Field(None)
    Bucket: typing.Optional[dict[str, BucketDef]] = pydantic.Field(None)
    BucketPolicy: typing.Optional[dict[str, BucketPolicyDef]] = pydantic.Field(None)
    BlockPublicAccessOptions: typing.Optional[dict[str, BlockPublicAccessOptionsDef]] = pydantic.Field(None)
    BucketAttributes: typing.Optional[dict[str, BucketAttributesDef]] = pydantic.Field(None)
    BucketMetrics: typing.Optional[dict[str, BucketMetricsDef]] = pydantic.Field(None)
    BucketNotificationDestinationConfig: typing.Optional[dict[str, BucketNotificationDestinationConfigDef]] = pydantic.Field(None)
    BucketPolicyProps: typing.Optional[dict[str, BucketPolicyPropsDef]] = pydantic.Field(None)
    BucketProps: typing.Optional[dict[str, BucketPropsDef]] = pydantic.Field(None)
    CfnAccessPoint_PublicAccessBlockConfigurationProperty: typing.Optional[dict[str, CfnAccessPoint_PublicAccessBlockConfigurationPropertyDef]] = pydantic.Field(None)
    ...
    CfnBucket_AccelerateConfigurationProperty: typing.Optional[dict[str, CfnBucket_AccelerateConfigurationPropertyDef]] = pydantic.Field(None)
    CfnBucket_AccessControlTranslationProperty: typing.Optional[dict[str, CfnBucket_AccessControlTranslationPropertyDef]] = pydantic.Field(None)
    CfnBucket_AnalyticsConfigurationProperty: typing.Optional[dict[str, CfnBucket_AnalyticsConfigurationPropertyDef]] = pydantic.Field(None)
    CfnBucket_BucketEncryptionProperty: typing.Optional[dict[str, CfnBucket_BucketEncryptionPropertyDef]] = pydantic.Field(None)
    CfnBucket_CorsConfigurationProperty: typing.Optional[dict[str, CfnBucket_CorsConfigurationPropertyDef]] = pydantic.Field(None)
    CfnBucket_CorsRuleProperty: typing.Optional[dict[str, CfnBucket_CorsRulePropertyDef]] = pydantic.Field(None)
    CfnBucket_DataExportProperty: typing.Optional[dict[str, CfnBucket_DataExportPropertyDef]] = pydantic.Field(None)
    CfnBucket_DefaultRetentionProperty: typing.Optional[dict[str, CfnBucket_DefaultRetentionPropertyDef]] = pydantic.Field(None)
    CfnBucket_DeleteMarkerReplicationProperty: typing.Optional[dict[str, CfnBucket_DeleteMarkerReplicationPropertyDef]] = pydantic.Field(None)
    CfnBucket_DestinationProperty: typing.Optional[dict[str, CfnBucket_DestinationPropertyDef]] = pydantic.Field(None)
    CfnBucket_EncryptionConfigurationProperty: typing.Optional[dict[str, CfnBucket_EncryptionConfigurationPropertyDef]] = pydantic.Field(None)
    CfnBucket_EventBridgeConfigurationProperty: typing.Optional[dict[str, CfnBucket_EventBridgeConfigurationPropertyDef]] = pydantic.Field(None)
    CfnBucket_FilterRuleProperty: typing.Optional[dict[str, CfnBucket_FilterRulePropertyDef]] = pydantic.Field(None)
    CfnBucket_IntelligentTieringConfigurationProperty: typing.Optional[dict[str, CfnBucket_IntelligentTieringConfigurationPropertyDef]] = pydantic.Field(None)
    CfnBucket_InventoryConfigurationProperty: typing.Optional[dict[str, CfnBucket_InventoryConfigurationPropertyDef]] = pydantic.Field(None)
    CfnBucket_LambdaConfigurationProperty: typing.Optional[dict[str, CfnBucket_LambdaConfigurationPropertyDef]] = pydantic.Field(None)
    ...
    CfnBucket_LoggingConfigurationProperty: typing.Optional[dict[str, CfnBucket_LoggingConfigurationPropertyDef]] = pydantic.Field(None)
    CfnBucket_MetricsConfigurationProperty: typing.Optional[dict[str, CfnBucket_MetricsConfigurationPropertyDef]] = pydantic.Field(None)
    CfnBucket_MetricsProperty: typing.Optional[dict[str, CfnBucket_MetricsPropertyDef]] = pydantic.Field(None)
    CfnBucket_NoncurrentVersionExpirationProperty: typing.Optional[dict[str, CfnBucket_NoncurrentVersionExpirationPropertyDef]] = pydantic.Field(None)
    CfnBucket_NoncurrentVersionTransitionProperty: typing.Optional[dict[str, CfnBucket_NoncurrentVersionTransitionPropertyDef]] = pydantic.Field(None)
    CfnBucket_NotificationConfigurationProperty: typing.Optional[dict[str, CfnBucket_NotificationConfigurationPropertyDef]] = pydantic.Field(None)
    CfnBucket_NotificationFilterProperty: typing.Optional[dict[str, CfnBucket_NotificationFilterPropertyDef]] = pydantic.Field(None)
    CfnBucket_ObjectLockConfigurationProperty: typing.Optional[dict[str, CfnBucket_ObjectLockConfigurationPropertyDef]] = pydantic.Field(None)
    CfnBucket_ObjectLockRuleProperty: typing.Optional[dict[str, CfnBucket_ObjectLockRulePropertyDef]] = pydantic.Field(None)
    CfnBucket_OwnershipControlsProperty: typing.Optional[dict[str, CfnBucket_OwnershipControlsPropertyDef]] = pydantic.Field(None)
    CfnBucket_OwnershipControlsRuleProperty: typing.Optional[dict[str, CfnBucket_OwnershipControlsRulePropertyDef]] = pydantic.Field(None)
    CfnBucket_PublicAccessBlockConfigurationProperty: typing.Optional[dict[str, CfnBucket_PublicAccessBlockConfigurationPropertyDef]] = pydantic.Field(None)
    CfnBucket_QueueConfigurationProperty: typing.Optional[dict[str, CfnBucket_QueueConfigurationPropertyDef]] = pydantic.Field(None)
    CfnBucket_RedirectAllRequestsToProperty: typing.Optional[dict[str, CfnBucket_RedirectAllRequestsToPropertyDef]] = pydantic.Field(None)
    CfnBucket_RedirectRuleProperty: typing.Optional[dict[str, CfnBucket_RedirectRulePropertyDef]] = pydantic.Field(None)
    CfnBucket_ReplicaModificationsProperty: typing.Optional[dict[str, CfnBucket_ReplicaModificationsPropertyDef]] = pydantic.Field(None)
    CfnBucket_ReplicationConfigurationProperty: typing.Optional[dict[str, CfnBucket_ReplicationConfigurationPropertyDef]] = pydantic.Field(None)
    CfnBucket_ReplicationDestinationProperty: typing.Optional[dict[str, CfnBucket_ReplicationDestinationPropertyDef]] = pydantic.Field(None)
    CfnBucket_ReplicationRuleAndOperatorProperty: typing.Optional[dict[str, CfnBucket_ReplicationRuleAndOperatorPropertyDef]] = pydantic.Field(None)
    CfnBucket_ReplicationRuleFilterProperty: typing.Optional[dict[str, CfnBucket_ReplicationRuleFilterPropertyDef]] = pydantic.Field(None)
    CfnBucket_ReplicationRuleProperty: typing.Optional[dict[str, CfnBucket_ReplicationRulePropertyDef]] = pydantic.Field(None)
    CfnBucket_ReplicationTimeProperty: typing.Optional[dict[str, CfnBucket_ReplicationTimePropertyDef]] = pydantic.Field(None)
    CfnBucket_ReplicationTimeValueProperty: typing.Optional[dict[str, CfnBucket_ReplicationTimeValuePropertyDef]] = pydantic.Field(None)
    CfnBucket_RoutingRuleConditionProperty: typing.Optional[dict[str, CfnBucket_RoutingRuleConditionPropertyDef]] = pydantic.Field(None)
    CfnBucket_RoutingRuleProperty: typing.Optional[dict[str, CfnBucket_RoutingRulePropertyDef]] = pydantic.Field(None)
    CfnBucket_RuleProperty: typing.Optional[dict[str, CfnBucket_RulePropertyDef]] = pydantic.Field(None)
    CfnBucket_S3KeyFilterProperty: typing.Optional[dict[str, CfnBucket_S3KeyFilterPropertyDef]] = pydantic.Field(None)
    CfnBucket_ServerSideEncryptionByDefaultProperty: typing.Optional[dict[str, CfnBucket_ServerSideEncryptionByDefaultPropertyDef]] = pydantic.Field(None)
    CfnBucket_ServerSideEncryptionRuleProperty: typing.Optional[dict[str, CfnBucket_ServerSideEncryptionRulePropertyDef]] = pydantic.Field(None)
    CfnBucket_SourceSelectionCriteriaProperty: typing.Optional[dict[str, CfnBucket_SourceSelectionCriteriaPropertyDef]] = pydantic.Field(None)
    CfnBucket_SseKmsEncryptedObjectsProperty: typing.Optional[dict[str, CfnBucket_SseKmsEncryptedObjectsPropertyDef]] = pydantic.Field(None)
    CfnBucket_StorageClassAnalysisProperty: typing.Optional[dict[str, CfnBucket_StorageClassAnalysisPropertyDef]] = pydantic.Field(None)
    CfnBucket_TagFilterProperty: typing.Optional[dict[str, CfnBucket_TagFilterPropertyDef]] = pydantic.Field(None)
    CfnBucket_TieringProperty: typing.Optional[dict[str, CfnBucket_TieringPropertyDef]] = pydantic.Field(None)
    CfnBucket_TopicConfigurationProperty: typing.Optional[dict[str, CfnBucket_TopicConfigurationPropertyDef]] = pydantic.Field(None)
    CfnBucket_TransitionProperty: typing.Optional[dict[str, CfnBucket_TransitionPropertyDef]] = pydantic.Field(None)
    CfnBucket_VersioningConfigurationProperty: typing.Optional[dict[str, CfnBucket_VersioningConfigurationPropertyDef]] = pydantic.Field(None)
    CfnBucket_WebsiteConfigurationProperty: typing.Optional[dict[str, CfnBucket_WebsiteConfigurationPropertyDef]] = pydantic.Field(None)
    CfnMultiRegionAccessPoint_PublicAccessBlockConfigurationProperty: typing.Optional[dict[str, CfnMultiRegionAccessPoint_PublicAccessBlockConfigurationPropertyDef]] = pydantic.Field(None)
    CfnMultiRegionAccessPoint_RegionProperty: typing.Optional[dict[str, CfnMultiRegionAccessPoint_RegionPropertyDef]] = pydantic.Field(None)
    CfnMultiRegionAccessPointPolicy_PolicyStatusProperty: typing.Optional[dict[str, CfnMultiRegionAccessPointPolicy_PolicyStatusPropertyDef]] = pydantic.Field(None)
    CfnStorageLens_AccountLevelProperty: typing.Optional[dict[str, CfnStorageLens_AccountLevelPropertyDef]] = pydantic.Field(None)
    CfnStorageLens_ActivityMetricsProperty: typing.Optional[dict[str, CfnStorageLens_ActivityMetricsPropertyDef]] = pydantic.Field(None)
    CfnStorageLens_AdvancedCostOptimizationMetricsProperty: typing.Optional[dict[str, CfnStorageLens_AdvancedCostOptimizationMetricsPropertyDef]] = pydantic.Field(None)
    CfnStorageLens_AdvancedDataProtectionMetricsProperty: typing.Optional[dict[str, CfnStorageLens_AdvancedDataProtectionMetricsPropertyDef]] = pydantic.Field(None)
    CfnStorageLens_AwsOrgProperty: typing.Optional[dict[str, CfnStorageLens_AwsOrgPropertyDef]] = pydantic.Field(None)
    CfnStorageLens_BucketLevelProperty: typing.Optional[dict[str, CfnStorageLens_BucketLevelPropertyDef]] = pydantic.Field(None)
    CfnStorageLens_BucketsAndRegionsProperty: typing.Optional[dict[str, CfnStorageLens_BucketsAndRegionsPropertyDef]] = pydantic.Field(None)
    CfnStorageLens_CloudWatchMetricsProperty: typing.Optional[dict[str, CfnStorageLens_CloudWatchMetricsPropertyDef]] = pydantic.Field(None)
    CfnStorageLens_DataExportProperty: typing.Optional[dict[str, CfnStorageLens_DataExportPropertyDef]] = pydantic.Field(None)
    CfnStorageLens_DetailedStatusCodesMetricsProperty: typing.Optional[dict[str, CfnStorageLens_DetailedStatusCodesMetricsPropertyDef]] = pydantic.Field(None)
    CfnStorageLens_EncryptionProperty: typing.Optional[dict[str, CfnStorageLens_EncryptionPropertyDef]] = pydantic.Field(None)
    CfnStorageLens_PrefixLevelProperty: typing.Optional[dict[str, CfnStorageLens_PrefixLevelPropertyDef]] = pydantic.Field(None)
    CfnStorageLens_PrefixLevelStorageMetricsProperty: typing.Optional[dict[str, CfnStorageLens_PrefixLevelStorageMetricsPropertyDef]] = pydantic.Field(None)
    CfnStorageLens_S3BucketDestinationProperty: typing.Optional[dict[str, CfnStorageLens_S3BucketDestinationPropertyDef]] = pydantic.Field(None)
    CfnStorageLens_SelectionCriteriaProperty: typing.Optional[dict[str, CfnStorageLens_SelectionCriteriaPropertyDef]] = pydantic.Field(None)
    CfnStorageLens_SSEKMSProperty: typing.Optional[dict[str, CfnStorageLens_SSEKMSPropertyDef]] = pydantic.Field(None)
    CfnStorageLens_StorageLensConfigurationProperty: typing.Optional[dict[str, CfnStorageLens_StorageLensConfigurationPropertyDef]] = pydantic.Field(None)
    CorsRule: typing.Optional[dict[str, CorsRuleDef]] = pydantic.Field(None)
    IntelligentTieringConfiguration: typing.Optional[dict[str, IntelligentTieringConfigurationDef]] = pydantic.Field(None)
    Inventory: typing.Optional[dict[str, InventoryDef]] = pydantic.Field(None)
    InventoryDestination: typing.Optional[dict[str, InventoryDestinationDef]] = pydantic.Field(None)
    LifecycleRule: typing.Optional[dict[str, LifecycleRuleDef]] = pydantic.Field(None)
    Location: typing.Optional[dict[str, LocationDef]] = pydantic.Field(None)
    NoncurrentVersionTransition: typing.Optional[dict[str, NoncurrentVersionTransitionDef]] = pydantic.Field(None)
    NotificationKeyFilter: typing.Optional[dict[str, NotificationKeyFilterDef]] = pydantic.Field(None)
    OnCloudTrailBucketEventOptions: typing.Optional[dict[str, OnCloudTrailBucketEventOptionsDef]] = pydantic.Field(None)
    RedirectTarget: typing.Optional[dict[str, RedirectTargetDef]] = pydantic.Field(None)
    RoutingRule: typing.Optional[dict[str, RoutingRuleDef]] = pydantic.Field(None)
    RoutingRuleCondition: typing.Optional[dict[str, RoutingRuleConditionDef]] = pydantic.Field(None)
    Tag: typing.Optional[dict[str, TagDef]] = pydantic.Field(None)
    TransferAccelerationUrlOptions: typing.Optional[dict[str, TransferAccelerationUrlOptionsDef]] = pydantic.Field(None)
    Transition: typing.Optional[dict[str, TransitionDef]] = pydantic.Field(None)
    VirtualHostedStyleUrlOptions: typing.Optional[dict[str, VirtualHostedStyleUrlOptionsDef]] = pydantic.Field(None)
    ...
    CfnMultiRegionAccessPoint: typing.Optional[dict[str, CfnMultiRegionAccessPointDef]] = pydantic.Field(None)
    CfnMultiRegionAccessPointPolicy: typing.Optional[dict[str, CfnMultiRegionAccessPointPolicyDef]] = pydantic.Field(None)
    CfnStorageLens: typing.Optional[dict[str, CfnStorageLensDef]] = pydantic.Field(None)
    ...
    CfnMultiRegionAccessPointPolicyProps: typing.Optional[dict[str, CfnMultiRegionAccessPointPolicyPropsDef]] = pydantic.Field(None)
    CfnMultiRegionAccessPointProps: typing.Optional[dict[str, CfnMultiRegionAccessPointPropsDef]] = pydantic.Field(None)
    CfnStorageLensProps: typing.Optional[dict[str, CfnStorageLensPropsDef]] = pydantic.Field(None)
    ...
