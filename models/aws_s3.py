...
class BucketDef(BaseConstruct):
    ...
    server_access_logs_bucket: typing.Optional[models.aws_s3.BucketDef] = pydantic.Field(None, description='Destination bucket for the server access logs. Default: - If "serverAccessLogsPrefix" undefined - access logs disabled, otherwise - log to current bucket.\n')
...
class BucketPolicyDef(BaseConstruct):
    bucket: typing.Union[models.aws_s3.BucketDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Amazon S3 bucket that the policy applies to.\n')
...
class InventoryDestinationDef(BaseStruct):
    bucket: typing.Union[models.aws_s3.BucketDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Bucket where all inventories will be saved in.\n')
