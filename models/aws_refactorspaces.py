...
class CfnRoute_UriPathRouteInputPropertyDef(BaseStruct):
    activation_state: str = pydantic.Field(..., description='If set to ``ACTIVE`` , traffic is forwarded to this route’s service after the route is created.\n')
    append_source_path: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description='If set to ``true`` , this option appends the source path to the service URL endpoint.\n')
    include_child_paths: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description="Indicates whether to match all subpaths of the given source path. If this value is ``false`` , requests must match the source path exactly before they are forwarded to this route's service.\n")
...
class CfnApplicationDef(BaseCfnResource):
    environment_identifier: str = pydantic.Field(..., description='The unique identifier of the environment.\n')
    name: str = pydantic.Field(..., description='The name of the application.\n')
    proxy_type: str = pydantic.Field(..., description='The proxy type of the proxy created within the application.\n')
    vpc_id: str = pydantic.Field(..., description='The ID of the virtual private cloud (VPC).\n')
    api_gateway_proxy: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_refactorspaces.CfnApplication_ApiGatewayProxyInputPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The endpoint URL of the Amazon API Gateway proxy.\n')
...
class CfnApplicationDefConfig(pydantic.BaseModel):
    ApiGatewayProxyInputProperty: typing.Optional[list[CfnApplicationDefApigatewayproxyinputpropertyParams]] = pydantic.Field(None, description='')
...
class CfnEnvironmentDef(BaseCfnResource):
    ...
    network_fabric_type: str = pydantic.Field(..., description='The network fabric type of the environment.\n')
...
class CfnRouteDef(BaseCfnResource):
    application_identifier: str = pydantic.Field(..., description='The unique identifier of the application.\n')
    environment_identifier: str = pydantic.Field(..., description='The unique identifier of the environment.\n')
    route_type: str = pydantic.Field(..., description='The route type of the route.\n')
    service_identifier: str = pydantic.Field(..., description='The unique identifier of the service.\n')
    default_route: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_refactorspaces.CfnRoute_DefaultRouteInputPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Configuration for the default route type.\n')
    ...
    uri_path_route: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_refactorspaces.CfnRoute_UriPathRouteInputPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The configuration for the URI path route type.')
...
class CfnRouteDefConfig(pydantic.BaseModel):
    DefaultRouteInputProperty: typing.Optional[list[CfnRouteDefDefaultrouteinputpropertyParams]] = pydantic.Field(None, description='')
    UriPathRouteInputProperty: typing.Optional[list[CfnRouteDefUripathrouteinputpropertyParams]] = pydantic.Field(None, description='')
...
class CfnServiceDef(BaseCfnResource):
    application_identifier: str = pydantic.Field(..., description='The unique identifier of the application.\n')
    endpoint_type: str = pydantic.Field(..., description='The endpoint type of the service.\n')
    environment_identifier: str = pydantic.Field(..., description='The unique identifier of the environment.\n')
    ...
    lambda_endpoint: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_refactorspaces.CfnService_LambdaEndpointInputPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A summary of the configuration for the AWS Lambda endpoint type.\n')
    ...
    url_endpoint: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_refactorspaces.CfnService_UrlEndpointInputPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The summary of the configuration for the URL endpoint type.\n')
...
class CfnServiceDefConfig(pydantic.BaseModel):
    LambdaEndpointInputProperty: typing.Optional[list[CfnServiceDefLambdaendpointinputpropertyParams]] = pydantic.Field(None, description='')
    UrlEndpointInputProperty: typing.Optional[list[CfnServiceDefUrlendpointinputpropertyParams]] = pydantic.Field(None, description='')
...
class ModuleModel(pydantic.BaseModel):
    CfnApplication_ApiGatewayProxyInputProperty: typing.Optional[dict[str, CfnApplication_ApiGatewayProxyInputPropertyDef]] = pydantic.Field(None)
    CfnRoute_DefaultRouteInputProperty: typing.Optional[dict[str, CfnRoute_DefaultRouteInputPropertyDef]] = pydantic.Field(None)
    CfnRoute_UriPathRouteInputProperty: typing.Optional[dict[str, CfnRoute_UriPathRouteInputPropertyDef]] = pydantic.Field(None)
    CfnService_LambdaEndpointInputProperty: typing.Optional[dict[str, CfnService_LambdaEndpointInputPropertyDef]] = pydantic.Field(None)
    CfnService_UrlEndpointInputProperty: typing.Optional[dict[str, CfnService_UrlEndpointInputPropertyDef]] = pydantic.Field(None)
