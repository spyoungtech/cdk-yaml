...
#  autogenerated from aws_cdk.aws_osis.CfnPipeline.BufferOptionsProperty
class CfnPipeline_BufferOptionsPropertyDef(BaseStruct):
    persistent_buffer_enabled: typing.Union[_REQUIRED_INIT_PARAM, bool, models.UnsupportedResource] = pydantic.Field(REQUIRED_INIT_PARAM, description='Whether persistent buffering should be enabled.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-osis-pipeline-bufferoptions.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_osis as osis\n\n    buffer_options_property = osis.CfnPipeline.BufferOptionsProperty(\n        persistent_buffer_enabled=False\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['persistent_buffer_enabled']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_osis.CfnPipeline.BufferOptionsProperty'
...
class CfnPipeline_CloudWatchLogDestinationPropertyDef(BaseStruct):
    log_group: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the CloudWatch Logs group to send pipeline logs to. You can specify an existing log group or create a new one. For example, ``/aws/vendedlogs/OpenSearchService/pipelines`` .\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-osis-pipeline-cloudwatchlogdestination.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_osis as osis\n\n    cloud_watch_log_destination_property = osis.CfnPipeline.CloudWatchLogDestinationProperty(\n        log_group="logGroup"\n    )\n')
...
#  autogenerated from aws_cdk.aws_osis.CfnPipeline.EncryptionAtRestOptionsProperty
class CfnPipeline_EncryptionAtRestOptionsPropertyDef(BaseStruct):
    kms_key_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The ARN of the KMS key used to encrypt buffer data. By default, data is encrypted using an AWS owned key.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-osis-pipeline-encryptionatrestoptions.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_osis as osis\n\n    encryption_at_rest_options_property = osis.CfnPipeline.EncryptionAtRestOptionsProperty(\n        kms_key_arn="kmsKeyArn"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['kms_key_arn']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_osis.CfnPipeline.EncryptionAtRestOptionsProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class CfnPipeline_VpcOptionsPropertyDef(BaseStruct):
    subnet_ids: typing.Union[typing.Sequence[str], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A list of subnet IDs associated with the VPC endpoint.\n')
    ...
    vpc_endpoint_management: typing.Optional[str] = pydantic.Field(None, description='Defines whether you or Amazon OpenSearch Ingestion service create and manage the VPC endpoint configured for the pipeline.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-osis-pipeline-vpcoptions.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_osis as osis\n\n    vpc_options_property = osis.CfnPipeline.VpcOptionsProperty(\n        subnet_ids=["subnetIds"],\n\n        # the properties below are optional\n        security_group_ids=["securityGroupIds"],\n        vpc_endpoint_management="vpcEndpointManagement"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['subnet_ids', 'security_group_ids', 'vpc_endpoint_management']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnPipelineDef(BaseCfnResource):
    ...
    buffer_options: typing.Union[models.UnsupportedResource, models.aws_osis.CfnPipeline_BufferOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Options that specify the configuration of a persistent buffer. To configure how OpenSearch Ingestion encrypts this data, set the ``EncryptionAtRestOptions`` . For more information, see `Persistent buffering <https://docs.aws.amazon.com/opensearch-service/latest/developerguide/osis-features-overview.html#persistent-buffering>`_ .\n')
    encryption_at_rest_options: typing.Union[models.UnsupportedResource, models.aws_osis.CfnPipeline_EncryptionAtRestOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Options to control how OpenSearch encrypts buffer data.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['max_units', 'min_units', 'pipeline_configuration_body', 'pipeline_name', 'buffer_options', 'encryption_at_rest_options', 'log_publishing_options', 'tags', 'vpc_options']
    _method_names: typing.ClassVar[list[str]] = ['BufferOptionsProperty', 'CloudWatchLogDestinationProperty', 'EncryptionAtRestOptionsProperty', 'LogPublishingOptionsProperty', 'VpcEndpointProperty', 'VpcOptionsProperty', 'add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnPipelineDefConfig(pydantic.BaseModel):
    BufferOptionsProperty: typing.Optional[list[models.aws_osis.CfnPipelineDefBufferoptionspropertyParams]] = pydantic.Field(None, description='')
    ...
    EncryptionAtRestOptionsProperty: typing.Optional[list[models.aws_osis.CfnPipelineDefEncryptionatrestoptionspropertyParams]] = pydantic.Field(None, description='')
...
class CfnPipelineDefBufferoptionspropertyParams(pydantic.BaseModel):
    persistent_buffer_enabled: typing.Union[bool, models.UnsupportedResource] = pydantic.Field(..., description='')
    ...
...
class CfnPipelineDefEncryptionatrestoptionspropertyParams(pydantic.BaseModel):
    kms_key_arn: str = pydantic.Field(..., description='')
    ...
...
class CfnPipelineDefVpcoptionspropertyParams(pydantic.BaseModel):
    ...
    vpc_endpoint_management: typing.Optional[str] = pydantic.Field(None, description='')
    ...
...
class ModuleModel(pydantic.BaseModel):
    CfnPipeline_BufferOptionsProperty: typing.Optional[dict[str, models.aws_osis.CfnPipeline_BufferOptionsPropertyDef]] = pydantic.Field(None)
    ...
    CfnPipeline_EncryptionAtRestOptionsProperty: typing.Optional[dict[str, models.aws_osis.CfnPipeline_EncryptionAtRestOptionsPropertyDef]] = pydantic.Field(None)
