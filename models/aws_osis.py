...
class CfnPipeline_CloudWatchLogDestinationPropertyDef(BaseStruct):
    log_group: typing.Optional[str] = pydantic.Field(None, description='``CfnPipeline.CloudWatchLogDestinationProperty.LogGroup``.')
...
class CfnPipeline_LogPublishingOptionsPropertyDef(BaseStruct):
    cloud_watch_log_destination: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_osis.CfnPipeline_CloudWatchLogDestinationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The destination for OpenSearch Ingestion logs sent to Amazon CloudWatch Logs. This parameter is required if ``IsLoggingEnabled`` is set to ``true`` .\n')
    is_logging_enabled: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description='Whether logs should be published.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-osis-pipeline-logpublishingoptions.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_osis as osis\n\n    log_publishing_options_property = osis.CfnPipeline.LogPublishingOptionsProperty(\n        cloud_watch_log_destination=osis.CfnPipeline.CloudWatchLogDestinationProperty(\n            log_group="logGroup"\n        ),\n        is_logging_enabled=False\n    )\n')
...
class CfnPipeline_VpcEndpointPropertyDef(BaseStruct):
    ...
    vpc_options: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_osis.CfnPipeline_VpcOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Information about the VPC, including associated subnets and security groups.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-osis-pipeline-vpcendpoint.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_osis as osis\n\n    vpc_endpoint_property = osis.CfnPipeline.VpcEndpointProperty(\n        vpc_endpoint_id="vpcEndpointId",\n        vpc_id="vpcId",\n        vpc_options=osis.CfnPipeline.VpcOptionsProperty(\n            security_group_ids=["securityGroupIds"],\n            subnet_ids=["subnetIds"]\n        )\n    )\n')
...
class CfnPipelineDef(BaseCfnResource):
    max_units: typing.Union[int, float] = pydantic.Field(..., description='The maximum pipeline capacity, in Ingestion Compute Units (ICUs).\n')
    min_units: typing.Union[int, float] = pydantic.Field(..., description='The minimum pipeline capacity, in Ingestion Compute Units (ICUs).\n')
    pipeline_configuration_body: str = pydantic.Field(..., description='The Data Prepper pipeline configuration in YAML format.\n')
    pipeline_name: str = pydantic.Field(..., description='The name of the pipeline.\n')
    log_publishing_options: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_osis.CfnPipeline_LogPublishingOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Key-value pairs that represent log publishing settings.\n')
    ...
    vpc_options: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_osis.CfnPipeline_VpcOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Options that specify the subnets and security groups for an OpenSearch Ingestion VPC endpoint.')
...
class CfnPipelineDefConfig(pydantic.BaseModel):
    CloudWatchLogDestinationProperty: typing.Optional[list[CfnPipelineDefCloudwatchlogdestinationpropertyParams]] = pydantic.Field(None, description='')
    LogPublishingOptionsProperty: typing.Optional[list[CfnPipelineDefLogpublishingoptionspropertyParams]] = pydantic.Field(None, description='')
    VpcEndpointProperty: typing.Optional[list[CfnPipelineDefVpcendpointpropertyParams]] = pydantic.Field(None, description='')
    VpcOptionsProperty: typing.Optional[list[CfnPipelineDefVpcoptionspropertyParams]] = pydantic.Field(None, description='')
...
class CfnPipelineDefLogpublishingoptionspropertyParams(pydantic.BaseModel):
    cloud_watch_log_destination: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_osis.CfnPipeline_CloudWatchLogDestinationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
...
class CfnPipelineDefVpcendpointpropertyParams(pydantic.BaseModel):
    ...
    vpc_options: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_osis.CfnPipeline_VpcOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class ModuleModel(pydantic.BaseModel):
    CfnPipeline_CloudWatchLogDestinationProperty: typing.Optional[dict[str, CfnPipeline_CloudWatchLogDestinationPropertyDef]] = pydantic.Field(None)
    CfnPipeline_LogPublishingOptionsProperty: typing.Optional[dict[str, CfnPipeline_LogPublishingOptionsPropertyDef]] = pydantic.Field(None)
    CfnPipeline_VpcEndpointProperty: typing.Optional[dict[str, CfnPipeline_VpcEndpointPropertyDef]] = pydantic.Field(None)
    CfnPipeline_VpcOptionsProperty: typing.Optional[dict[str, CfnPipeline_VpcOptionsPropertyDef]] = pydantic.Field(None)
