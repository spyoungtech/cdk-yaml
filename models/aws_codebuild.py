...
#  autogenerated from aws_cdk.aws_codebuild.LinuxArmLambdaBuildImage
class LinuxArmLambdaBuildImageDef(BaseClass):
    _init_params: typing.ClassVar[list[str]] = []
    _method_names: typing.ClassVar[list[str]] = ['run_script_buildspec', 'validate']
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_codebuild.LinuxArmLambdaBuildImage'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...


    resource_config: typing.Optional[models.aws_codebuild.LinuxArmLambdaBuildImageDefConfig] = pydantic.Field(None)


class LinuxArmLambdaBuildImageDefConfig(pydantic.BaseModel):
    run_script_buildspec: typing.Optional[list[models.aws_codebuild.LinuxArmLambdaBuildImageDefRunScriptBuildspecParams]] = pydantic.Field(None, description='Make a buildspec to run the indicated script.')
    validate_: typing.Optional[list[models.aws_codebuild.LinuxArmLambdaBuildImageDefValidateParams]] = pydantic.Field(None, description='Allows the image a chance to validate whether the passed configuration is correct.', alias='validate')

class LinuxArmLambdaBuildImageDefRunScriptBuildspecParams(pydantic.BaseModel):
    entrypoint: str = pydantic.Field(..., description='-')
    ...

class LinuxArmLambdaBuildImageDefValidateParams(pydantic.BaseModel):
    build_image: typing.Optional[typing.Union[models.aws_codebuild.LinuxArmBuildImageDef, models.aws_codebuild.LinuxArmLambdaBuildImageDef, models.aws_codebuild.LinuxBuildImageDef, models.aws_codebuild.LinuxLambdaBuildImageDef, models.aws_codebuild.WindowsBuildImageDef]] = pydantic.Field(None, description='The image used for the builds. Default: LinuxBuildImage.STANDARD_1_0\n')
    certificate: typing.Union[models.aws_codebuild.BuildEnvironmentCertificateDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The location of the PEM-encoded certificate for the build project. Default: - No external certificate is added to the project\n')
    compute_type: typing.Optional[aws_cdk.aws_codebuild.ComputeType] = pydantic.Field(None, description='The type of compute to use for this build. See the ``ComputeType`` enum for the possible values. Default: taken from ``#buildImage#defaultComputeType``\n')
    environment_variables: typing.Optional[typing.Mapping[str, typing.Union[models.aws_codebuild.BuildEnvironmentVariableDef, dict[str, typing.Any]]]] = pydantic.Field(None, description='The environment variables that your builds can use.\n')
...
#  autogenerated from aws_cdk.aws_codebuild.LinuxLambdaBuildImage
class LinuxLambdaBuildImageDef(BaseClass):
    _init_params: typing.ClassVar[list[str]] = []
    _method_names: typing.ClassVar[list[str]] = ['run_script_buildspec', 'validate']
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_codebuild.LinuxLambdaBuildImage'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...


    resource_config: typing.Optional[models.aws_codebuild.LinuxLambdaBuildImageDefConfig] = pydantic.Field(None)


class LinuxLambdaBuildImageDefConfig(pydantic.BaseModel):
    run_script_buildspec: typing.Optional[list[models.aws_codebuild.LinuxLambdaBuildImageDefRunScriptBuildspecParams]] = pydantic.Field(None, description='Make a buildspec to run the indicated script.')
    validate_: typing.Optional[list[models.aws_codebuild.LinuxLambdaBuildImageDefValidateParams]] = pydantic.Field(None, description='Allows the image a chance to validate whether the passed configuration is correct.', alias='validate')

class LinuxLambdaBuildImageDefRunScriptBuildspecParams(pydantic.BaseModel):
    entrypoint: str = pydantic.Field(..., description='-')
    ...

class LinuxLambdaBuildImageDefValidateParams(pydantic.BaseModel):
    build_image: typing.Optional[typing.Union[models.aws_codebuild.LinuxArmBuildImageDef, models.aws_codebuild.LinuxArmLambdaBuildImageDef, models.aws_codebuild.LinuxBuildImageDef, models.aws_codebuild.LinuxLambdaBuildImageDef, models.aws_codebuild.WindowsBuildImageDef]] = pydantic.Field(None, description='The image used for the builds. Default: LinuxBuildImage.STANDARD_1_0\n')
    certificate: typing.Union[models.aws_codebuild.BuildEnvironmentCertificateDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The location of the PEM-encoded certificate for the build project. Default: - No external certificate is added to the project\n')
    compute_type: typing.Optional[aws_cdk.aws_codebuild.ComputeType] = pydantic.Field(None, description='The type of compute to use for this build. See the ``ComputeType`` enum for the possible values. Default: taken from ``#buildImage#defaultComputeType``\n')
    environment_variables: typing.Optional[typing.Mapping[str, typing.Union[models.aws_codebuild.BuildEnvironmentVariableDef, dict[str, typing.Any]]]] = pydantic.Field(None, description='The environment variables that your builds can use.\n')
...
#  autogenerated from aws_cdk.aws_codebuild.Fleet
class FleetDef(BaseConstruct):
    base_capacity: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The number of machines allocated to the compute ﬂeet. Deﬁnes the number of builds that can run in parallel. Minimum value of 1.\n')
    compute_type: typing.Union[aws_cdk.aws_codebuild.FleetComputeType, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The instance type of the compute fleet.\n')
    environment_type: typing.Union[aws_cdk.aws_codebuild.EnvironmentType, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The build environment (operating system/architecture/accelerator) type made available to projects using this fleet.\n')
    fleet_name: typing.Optional[str] = pydantic.Field(None, description='The name of the Fleet. Default: - CloudFormation generated name')
    _init_params: typing.ClassVar[list[str]] = ['base_capacity', 'compute_type', 'environment_type', 'fleet_name']
    _method_names: typing.ClassVar[list[str]] = ['apply_removal_policy']
    _classmethod_names: typing.ClassVar[list[str]] = ['from_fleet_arn']
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_codebuild.Fleet'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = ['from_fleet_arn']
    ...


    from_fleet_arn: typing.Optional[models.aws_codebuild.FleetDefFromFleetArnParams] = pydantic.Field(None, description='Creates a Fleet construct that represents an external fleet.')
    resource_config: typing.Optional[models.aws_codebuild.FleetDefConfig] = pydantic.Field(None)


class FleetDefConfig(pydantic.BaseModel):
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)

class FleetDefApplyRemovalPolicyParams(pydantic.BaseModel):
    policy: aws_cdk.RemovalPolicy = pydantic.Field(..., description='-')
    ...

class FleetDefFromFleetArnParams(pydantic.BaseModel):
    ...
    fleet_arn: str = pydantic.Field(..., description='The ARN of the fleet.')
    ...
...
class PipelineProjectDef(BaseConstruct):
    ...
    visibility: typing.Optional[aws_cdk.aws_codebuild.ProjectVisibility] = pydantic.Field(None, description="Specifies the visibility of the project's builds. Default: - no visibility is set\n")
...
class ReportGroupDef(BaseConstruct):
    delete_reports: typing.Optional[bool] = pydantic.Field(None, description='If true, deleting the report group force deletes the contents of the report group. If false, the report group must be empty before attempting to delete it. Default: false\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['delete_reports', 'export_bucket', 'removal_policy', 'report_group_name', 'type', 'zip_export']
...
class BuildEnvironmentDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['build_image', 'certificate', 'compute_type', 'environment_variables', 'fleet', 'privileged']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
#  autogenerated from aws_cdk.aws_codebuild.CfnFleet.VpcConfigProperty
class CfnFleet_VpcConfigPropertyDef(BaseStruct):
    security_group_ids: typing.Optional[typing.Sequence[str]] = pydantic.Field(None, description='A list of one or more security groups IDs in your Amazon VPC.\n')
    subnets: typing.Optional[typing.Sequence[str]] = pydantic.Field(None, description='A list of one or more subnet IDs in your Amazon VPC.\n')
    ...
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_codebuild.CfnFleet.VpcConfigProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class CfnProject_EnvironmentPropertyDef(BaseStruct):
    ...
    fleet: typing.Union[models.UnsupportedResource, models.aws_codebuild.CfnProject_ProjectFleetPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
    _init_params: typing.ClassVar[list[str]] = ['compute_type', 'image', 'type', 'certificate', 'environment_variables', 'fleet', 'image_pull_credentials_type', 'privileged_mode', 'registry_credential']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
#  autogenerated from aws_cdk.aws_codebuild.CfnProject.ProjectFleetProperty
class CfnProject_ProjectFleetPropertyDef(BaseStruct):
    fleet_arn: typing.Optional[str] = pydantic.Field(None, description='Specifies the compute fleet ARN for the build project.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-codebuild-project-projectfleet.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_codebuild as codebuild\n\n    project_fleet_property = codebuild.CfnProject.ProjectFleetProperty(\n        fleet_arn="fleetArn"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['fleet_arn']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_codebuild.CfnProject.ProjectFleetProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class CfnProject_ProjectTriggersPropertyDef(BaseStruct):
    ...
    scope_configuration: typing.Union[models.UnsupportedResource, aws_cdk.aws_codebuild.CfnProject.ScopeConfigurationProperty, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
    _init_params: typing.ClassVar[list[str]] = ['build_type', 'filter_groups', 'scope_configuration', 'webhook']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
#  autogenerated from aws_cdk.aws_codebuild.FleetProps
class FleetPropsDef(BaseStruct):
    base_capacity: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The number of machines allocated to the compute ﬂeet. Deﬁnes the number of builds that can run in parallel. Minimum value of 1.\n')
    compute_type: typing.Union[aws_cdk.aws_codebuild.FleetComputeType, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The instance type of the compute fleet.\n')
    environment_type: typing.Union[aws_cdk.aws_codebuild.EnvironmentType, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The build environment (operating system/architecture/accelerator) type made available to projects using this fleet.\n')
    ...
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_codebuild.FleetProps'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class ProjectPropsDef(BaseStruct):
    ...
    secondary_sources: typing.Optional[typing.Sequence[typing.Union[models.aws_codebuild.SourceDef]]] = pydantic.Field(None, description='The secondary sources for the Project. Can be also added after the Project has been created by using the ``Project#addSecondarySource`` method. Default: - No secondary sources.\n')
    source: typing.Optional[typing.Union[models.aws_codebuild.SourceDef]] = pydantic.Field(None, description='The source of the build. *Note*: if ``NoSource`` is given as the source, then you need to provide an explicit ``buildSpec``. Default: - NoSource\n\n:exampleMetadata: infused\n\nExample::\n\n    # ecr_repository: ecr.Repository\n\n\n    codebuild.Project(self, "Project",\n        environment=codebuild.BuildEnvironment(\n            build_image=codebuild.WindowsBuildImage.from_ecr_repository(ecr_repository, "v1.0", codebuild.WindowsImageType.SERVER_2019),\n            # optional certificate to include in the build image\n            certificate=codebuild.BuildEnvironmentCertificate(\n                bucket=s3.Bucket.from_bucket_name(self, "Bucket", "my-bucket"),\n                object_key="path/to/cert.pem"\n            )\n        )\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['allow_all_outbound', 'badge', 'build_spec', 'cache', 'check_secrets_in_plain_text_env_variables', 'concurrent_build_limit', 'description', 'encryption_key', 'environment', 'environment_variables', 'file_system_locations', 'grant_report_group_permissions', 'logging', 'project_name', 'queued_timeout', 'role', 'security_groups', 'ssm_session_permissions', 'subnet_selection', 'timeout', 'visibility', 'vpc', 'artifacts', 'secondary_artifacts', 'secondary_sources', 'source']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
#  autogenerated from aws_cdk.aws_codebuild.EnvironmentType
# skipping emum

#  autogenerated from aws_cdk.aws_codebuild.EventAction
# skipping emum

#  autogenerated from aws_cdk.aws_codebuild.FleetComputeType
# skipping emum
...
#  autogenerated from aws_cdk.aws_codebuild.IFleet
#  skipping Interface
...
#  autogenerated from aws_cdk.aws_codebuild.CfnFleet
class CfnFleetDef(BaseCfnResource):
    base_capacity: typing.Union[int, float, None] = pydantic.Field(None, description='The initial number of machines allocated to the compute ﬂeet, which deﬁnes the number of builds that can run in parallel.\n')
    compute_type: typing.Optional[str] = pydantic.Field(None, description='Information about the compute resources the compute fleet uses. Available values include:. - ``BUILD_GENERAL1_SMALL`` : Use up to 3 GB memory and 2 vCPUs for builds. - ``BUILD_GENERAL1_MEDIUM`` : Use up to 7 GB memory and 4 vCPUs for builds. - ``BUILD_GENERAL1_LARGE`` : Use up to 16 GB memory and 8 vCPUs for builds, depending on your environment type. - ``BUILD_GENERAL1_XLARGE`` : Use up to 70 GB memory and 36 vCPUs for builds, depending on your environment type. - ``BUILD_GENERAL1_2XLARGE`` : Use up to 145 GB memory, 72 vCPUs, and 824 GB of SSD storage for builds. This compute type supports Docker images up to 100 GB uncompressed. If you use ``BUILD_GENERAL1_SMALL`` : - For environment type ``LINUX_CONTAINER`` , you can use up to 3 GB memory and 2 vCPUs for builds. - For environment type ``LINUX_GPU_CONTAINER`` , you can use up to 16 GB memory, 4 vCPUs, and 1 NVIDIA A10G Tensor Core GPU for builds. - For environment type ``ARM_CONTAINER`` , you can use up to 4 GB memory and 2 vCPUs on ARM-based processors for builds. If you use ``BUILD_GENERAL1_LARGE`` : - For environment type ``LINUX_CONTAINER`` , you can use up to 15 GB memory and 8 vCPUs for builds. - For environment type ``LINUX_GPU_CONTAINER`` , you can use up to 255 GB memory, 32 vCPUs, and 4 NVIDIA Tesla V100 GPUs for builds. - For environment type ``ARM_CONTAINER`` , you can use up to 16 GB memory and 8 vCPUs on ARM-based processors for builds. For more information, see `Build environment compute types <https://docs.aws.amazon.com/codebuild/latest/userguide/build-env-ref-compute-types.html>`_ in the *AWS CodeBuild User Guide.*\n')
    environment_type: typing.Optional[str] = pydantic.Field(None, description='The environment type of the compute fleet. - The environment type ``ARM_CONTAINER`` is available only in regions US East (N. Virginia), US East (Ohio), US West (Oregon), EU (Ireland), Asia Pacific (Mumbai), Asia Pacific (Tokyo), Asia Pacific (Singapore), Asia Pacific (Sydney), EU (Frankfurt), and South America (São Paulo). - The environment type ``LINUX_CONTAINER`` is available only in regions US East (N. Virginia), US East (Ohio), US West (Oregon), EU (Ireland), EU (Frankfurt), Asia Pacific (Tokyo), Asia Pacific (Singapore), Asia Pacific (Sydney), South America (São Paulo), and Asia Pacific (Mumbai). - The environment type ``LINUX_GPU_CONTAINER`` is available only in regions US East (N. Virginia), US East (Ohio), US West (Oregon), EU (Ireland), EU (Frankfurt), Asia Pacific (Tokyo), and Asia Pacific (Sydney). - The environment type ``WINDOWS_SERVER_2019_CONTAINER`` is available only in regions US East (N. Virginia), US East (Ohio), US West (Oregon), Asia Pacific (Sydney), Asia Pacific (Tokyo), Asia Pacific (Mumbai) and EU (Ireland). - The environment type ``WINDOWS_SERVER_2022_CONTAINER`` is available only in regions US East (N. Virginia), US East (Ohio), US West (Oregon), EU (Ireland), EU (Frankfurt), Asia Pacific (Sydney), Asia Pacific (Singapore), Asia Pacific (Tokyo), South America (São Paulo) and Asia Pacific (Mumbai). For more information, see `Build environment compute types <https://docs.aws.amazon.com//codebuild/latest/userguide/build-env-ref-compute-types.html>`_ in the *AWS CodeBuild user guide* .\n')
    fleet_service_role: typing.Optional[str] = pydantic.Field(None, description='The service role associated with the compute fleet. For more information, see `Allow a user to add a permission policy for a fleet service role <https://docs.aws.amazon.com/codebuild/latest/userguide/auth-and-access-control-iam-identity-based-access-control.html#customer-managed-policies-example-permission-policy-fleet-service-role.html>`_ in the *AWS CodeBuild User Guide* .\n')
    fleet_vpc_config: typing.Union[models.UnsupportedResource, models.aws_codebuild.CfnFleet_VpcConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Information about the VPC configuration that AWS CodeBuild accesses.\n')
    name: typing.Optional[str] = pydantic.Field(None, description='The name of the compute fleet.\n')
    overflow_behavior: typing.Optional[str] = pydantic.Field(None, description='The compute fleet overflow behavior. - For overflow behavior ``QUEUE`` , your overflow builds need to wait on the existing fleet instance to become available. - For overflow behavior ``ON_DEMAND`` , your overflow builds run on CodeBuild on-demand. .. epigraph:: If you choose to set your overflow behavior to on-demand while creating a VPC-connected fleet, make sure that you add the required VPC permissions to your project service role. For more information, see `Example policy statement to allow CodeBuild access to AWS services required to create a VPC network interface <https://docs.aws.amazon.com/codebuild/latest/userguide/auth-and-access-control-iam-identity-based-access-control.html#customer-managed-policies-example-create-vpc-network-interface>`_ .\n')
    tags: typing.Optional[typing.Sequence[typing.Union[models.CfnTagDef, dict[str, typing.Any]]]] = pydantic.Field(None, description='A list of tag key and value pairs associated with this compute fleet. These tags are available for use by AWS services that support AWS CodeBuild compute fleet tags.')
    _init_params: typing.ClassVar[list[str]] = ['base_capacity', 'compute_type', 'environment_type', 'fleet_service_role', 'fleet_vpc_config', 'name', 'overflow_behavior', 'tags']
    _method_names: typing.ClassVar[list[str]] = ['VpcConfigProperty', 'add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_codebuild.CfnFleet'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...


    resource_config: typing.Optional[models.aws_codebuild.CfnFleetDefConfig] = pydantic.Field(None)


class CfnFleetDefConfig(pydantic.BaseModel):
    VpcConfigProperty: typing.Optional[list[models.aws_codebuild.CfnFleetDefVpcconfigpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_codebuild.CfnFleetDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_codebuild.CfnFleetDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_codebuild.CfnFleetDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_codebuild.CfnFleetDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_codebuild.CfnFleetDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_codebuild.CfnFleetDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_codebuild.CfnFleetDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_codebuild.CfnFleetDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_codebuild.CfnFleetDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_codebuild.CfnFleetDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_codebuild.CfnFleetDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_codebuild.CfnFleetDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_codebuild.CfnFleetDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
class CfnProjectDef(BaseCfnResource):
    ...
    timeout_in_minutes: typing.Union[int, float, None] = pydantic.Field(None, description='How long, in minutes, from 5 to 2160 (36 hours), for AWS CodeBuild to wait before timing out any related build that did not get marked as completed. The default is 60 minutes.\n')
...
class CfnProjectDefConfig(pydantic.BaseModel):
    ...
    ProjectFleetProperty: typing.Optional[list[models.aws_codebuild.CfnProjectDefProjectfleetpropertyParams]] = pydantic.Field(None, description='')
    ...
    ScopeConfigurationProperty: typing.Optional[list[models.aws_codebuild.CfnProjectDefScopeconfigurationpropertyParams]] = pydantic.Field(None, description='')
...
class CfnProjectDefProjectfleetpropertyParams(pydantic.BaseModel):
    fleet_arn: typing.Optional[str] = pydantic.Field(None, description='')
    ...
...
class CfnProjectDefScopeconfigurationpropertyParams(pydantic.BaseModel):
    name: str = pydantic.Field(..., description='')
    ...
...
class CfnSourceCredentialDef(BaseCfnResource):
    auth_type: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The type of authentication used by the credentials. Valid options are OAUTH, BASIC_AUTH, PERSONAL_ACCESS_TOKEN, or CODECONNECTIONS.\n')
    server_type: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The type of source provider. The valid options are GITHUB, GITHUB_ENTERPRISE, GITLAB, GITLAB_SELF_MANAGED, or BITBUCKET.\n')
    token: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='For GitHub or GitHub Enterprise, this is the personal access token. For Bitbucket, this is either the access token or the app password. For the ``authType`` CODECONNECTIONS, this is the ``connectionArn`` .\n')
...
#  autogenerated from aws_cdk.aws_codebuild.CfnFleetProps
class CfnFleetPropsDef(BaseCfnProperty):
    ...
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_codebuild.CfnFleetProps'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class ModuleModel(pydantic.BaseModel):
    ...
    LinuxArmLambdaBuildImage: typing.Optional[dict[str, models.aws_codebuild.LinuxArmLambdaBuildImageDef]] = pydantic.Field(None)
    ...
    LinuxLambdaBuildImage: typing.Optional[dict[str, models.aws_codebuild.LinuxLambdaBuildImageDef]] = pydantic.Field(None)
    ...
    Fleet: typing.Optional[dict[str, models.aws_codebuild.FleetDef]] = pydantic.Field(None)
    ...
    CfnFleet_VpcConfigProperty: typing.Optional[dict[str, models.aws_codebuild.CfnFleet_VpcConfigPropertyDef]] = pydantic.Field(None)
    ...
    CfnProject_ProjectFleetProperty: typing.Optional[dict[str, models.aws_codebuild.CfnProject_ProjectFleetPropertyDef]] = pydantic.Field(None)
    ...
    FleetProps: typing.Optional[dict[str, models.aws_codebuild.FleetPropsDef]] = pydantic.Field(None)
    ...
    CfnFleet: typing.Optional[dict[str, models.aws_codebuild.CfnFleetDef]] = pydantic.Field(None)
    ...
    CfnFleetProps: typing.Optional[dict[str, models.aws_codebuild.CfnFleetPropsDef]] = pydantic.Field(None)
