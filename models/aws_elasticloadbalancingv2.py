...
class BaseLoadBalancerDef(BaseClass):
    base_props: typing.Union[_REQUIRED_INIT_PARAM, models.aws_elasticloadbalancingv2.BaseLoadBalancerPropsDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='-\n')
    additional_props: typing.Union[typing.Any, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='-')
...
class ListenerActionDef(BaseClass):
    default_action_json: typing.Union[_REQUIRED_INIT_PARAM, models.aws_elasticloadbalancingv2.CfnListener_ActionPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='-\n')
...
class ListenerCertificateDef(BaseClass):
    certificate_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The ARN of the certificate to use.')
...
class TargetGroupBaseDef(BaseClass):
    base_props: typing.Union[_REQUIRED_INIT_PARAM, models.aws_elasticloadbalancingv2.BaseTargetGroupPropsDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='-\n')
    additional_props: typing.Union[typing.Any, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='-')
    _init_params: typing.ClassVar[list[str]] = ['base_props', 'additional_props']
...
class TargetGroupBaseDefConfigureHealthCheckParams(pydantic.BaseModel):
    ...
    timeout: typing.Optional[models.DurationDef] = pydantic.Field(None, description='The amount of time, in seconds, during which no response from a target means a failed health check. Must be 2 to 120 seconds. Default: 6 seconds if the protocol is HTTP, 5 seconds if protocol is ``GENEVE``, 30 seconds if target type is ``lambda``, 10 seconds for TCP, TLS, or HTTPS\n')
...
class ApplicationListenerDef(BaseConstruct):
    load_balancer: typing.Union[_REQUIRED_INIT_PARAM, models.aws_elasticloadbalancingv2.ApplicationLoadBalancerDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The load balancer to attach this listener to.\n')
...
class ApplicationListenerCertificateDef(BaseConstruct):
    listener: typing.Union[_REQUIRED_INIT_PARAM, models.aws_elasticloadbalancingv2.ApplicationListenerDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The listener to attach the rule to.\n')
...
class ApplicationListenerRuleDef(BaseConstruct):
    listener: typing.Union[_REQUIRED_INIT_PARAM, models.aws_elasticloadbalancingv2.ApplicationListenerDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The listener to attach the rule to.\n')
    priority: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='Priority of the rule. The rule with the lowest priority will be used for every request. Priorities must be unique.\n')
...
class ApplicationLoadBalancerDef(BaseConstruct):
    client_keep_alive: typing.Optional[models.DurationDef] = pydantic.Field(None, description='The client keep alive duration. The valid range is 60 to 604800 seconds (1 minute to 7 days). Default: - Duration.seconds(3600)\n')
    ...
    ip_address_type: typing.Optional[aws_cdk.aws_elasticloadbalancingv2.IpAddressType] = pydantic.Field(None, description='The type of IP addresses to use. Default: IpAddressType.IPV4\n')
    preserve_host_header: typing.Optional[bool] = pydantic.Field(None, description='Indicates whether the Application Load Balancer should preserve the host header in the HTTP request and send it to the target without any change. Default: false\n')
    preserve_xff_client_port: typing.Optional[bool] = pydantic.Field(None, description='Indicates whether the X-Forwarded-For header should preserve the source port that the client used to connect to the load balancer. Default: false\n')
    ...
    waf_fail_open: typing.Optional[bool] = pydantic.Field(None, description='Indicates whether to allow a WAF-enabled load balancer to route requests to targets if it is unable to forward the request to AWS WAF. Default: false\n')
    x_amzn_tls_version_and_cipher_suite_headers: typing.Optional[bool] = pydantic.Field(None, description='Indicates whether the two headers (x-amzn-tls-version and x-amzn-tls-cipher-suite), which contain information about the negotiated TLS version and cipher suite, are added to the client request before sending it to the target. The x-amzn-tls-version header has information about the TLS protocol version negotiated with the client, and the x-amzn-tls-cipher-suite header has information about the cipher suite negotiated with the client. Both headers are in OpenSSL format. Default: false\n')
    xff_header_processing_mode: typing.Optional[aws_cdk.aws_elasticloadbalancingv2.XffHeaderProcessingMode] = pydantic.Field(None, description='Enables you to modify, preserve, or remove the X-Forwarded-For header in the HTTP request before the Application Load Balancer sends the request to the target. Default: XffHeaderProcessingMode.APPEND\n')
    vpc: typing.Union[_REQUIRED_INIT_PARAM, models.aws_ec2.VpcDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The VPC network to place the load balancer in.\n')
    cross_zone_enabled: typing.Optional[bool] = pydantic.Field(None, description='Indicates whether cross-zone load balancing is enabled. Default: - false for Network Load Balancers and true for Application Load Balancers. This can not be ``false`` for Application Load Balancers.\n')
    ...
    deny_all_igw_traffic: typing.Optional[bool] = pydantic.Field(None, description='Indicates whether the load balancer blocks traffic through the Internet Gateway (IGW). Default: - false for internet-facing load balancers and true for internal load balancers\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['client_keep_alive', 'desync_mitigation_mode', 'drop_invalid_header_fields', 'http2_enabled', 'idle_timeout', 'ip_address_type', 'preserve_host_header', 'preserve_xff_client_port', 'security_group', 'waf_fail_open', 'x_amzn_tls_version_and_cipher_suite_headers', 'xff_header_processing_mode', 'vpc', 'cross_zone_enabled', 'deletion_protection', 'deny_all_igw_traffic', 'internet_facing', 'load_balancer_name', 'vpc_subnets']
...
class NetworkListenerDef(BaseConstruct):
    load_balancer: typing.Union[_REQUIRED_INIT_PARAM, models.aws_elasticloadbalancingv2.NetworkLoadBalancerDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The load balancer to attach this listener to.\n')
    port: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The port on which the listener listens for requests.\n')
...
class NetworkLoadBalancerDef(BaseConstruct):
    client_routing_policy: typing.Optional[aws_cdk.aws_elasticloadbalancingv2.ClientRoutingPolicy] = pydantic.Field(None, description='The AZ affinity routing policy. Default: - AZ affinity is disabled.\n')
    enforce_security_group_inbound_rules_on_private_link_traffic: typing.Optional[bool] = pydantic.Field(None, description='Indicates whether to evaluate inbound security group rules for traffic sent to a Network Load Balancer through AWS PrivateLink. Default: true\n')
    ip_address_type: typing.Optional[aws_cdk.aws_elasticloadbalancingv2.IpAddressType] = pydantic.Field(None, description='The type of IP addresses to use. If you want to add a UDP or TCP_UDP listener to the load balancer, you must choose IPv4. Default: IpAddressType.IPV4\n')
    security_groups: typing.Optional[typing.Sequence[typing.Union[models.aws_ec2.SecurityGroupDef]]] = pydantic.Field(None, description='Security groups to associate with this load balancer. Default: - No security groups associated with the load balancer.\n')
    vpc: typing.Union[_REQUIRED_INIT_PARAM, models.aws_ec2.VpcDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The VPC network to place the load balancer in.\n')
    cross_zone_enabled: typing.Optional[bool] = pydantic.Field(None, description='Indicates whether cross-zone load balancing is enabled. Default: - false for Network Load Balancers and true for Application Load Balancers. This can not be ``false`` for Application Load Balancers.\n')
    deletion_protection: typing.Optional[bool] = pydantic.Field(None, description='Indicates whether deletion protection is enabled. Default: false\n')
    deny_all_igw_traffic: typing.Optional[bool] = pydantic.Field(None, description='Indicates whether the load balancer blocks traffic through the Internet Gateway (IGW). Default: - false for internet-facing load balancers and true for internal load balancers\n')
    ...
    load_balancer_name: typing.Optional[str] = pydantic.Field(None, description='Name of the load balancer. Default: - Automatically generated name.\n')
    vpc_subnets: typing.Union[models.aws_ec2.SubnetSelectionDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Which subnets place the load balancer in. Default: - the Vpc default strategy.')
    _init_params: typing.ClassVar[list[str]] = ['client_routing_policy', 'enforce_security_group_inbound_rules_on_private_link_traffic', 'ip_address_type', 'security_groups', 'vpc', 'cross_zone_enabled', 'deletion_protection', 'deny_all_igw_traffic', 'internet_facing', 'load_balancer_name', 'vpc_subnets']
    _method_names: typing.ClassVar[list[str]] = ['add_listener', 'add_security_group', 'apply_removal_policy', 'log_access_logs', 'metric', 'metric_active_flow_count', 'metric_consumed_lc_us', 'metric_new_flow_count', 'metric_processed_bytes', 'metric_tcp_client_reset_count', 'metric_tcp_elb_reset_count', 'metric_tcp_target_reset_count', 'remove_attribute', 'set_attribute']
...
class NetworkLoadBalancerDefConfig(pydantic.BaseModel):
    ...
    add_security_group: typing.Optional[list[models.aws_elasticloadbalancingv2.NetworkLoadBalancerDefAddSecurityGroupParams]] = pydantic.Field(None, description='Add a security group to this load balancer.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
...
class NetworkLoadBalancerDefAddSecurityGroupParams(pydantic.BaseModel):
    security_group: typing.Union[models.aws_ec2.SecurityGroupDef] = pydantic.Field(..., description='-')
    ...
...
class NetworkLoadBalancerDefFromNetworkLoadBalancerAttributesParams(pydantic.BaseModel):
    ...
    load_balancer_canonical_hosted_zone_id: typing.Optional[str] = pydantic.Field(None, description='The canonical hosted zone ID of this load balancer. Default: - When not provided, LB cannot be used as Route53 Alias target.\n')
    load_balancer_dns_name: typing.Optional[str] = pydantic.Field(None, description='The DNS name of this load balancer. Default: - When not provided, LB cannot be used as Route53 Alias target.\n')
    load_balancer_security_groups: typing.Optional[typing.Sequence[str]] = pydantic.Field(None, description='Security groups to associate with this load balancer. Default: - No security groups associated with the load balancer.\n')
...
class NetworkTargetGroupDef(BaseConstruct):
    port: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The port on which the target receives traffic.\n')
...
class AddApplicationActionPropsDef(BaseStruct):
    conditions: typing.Optional[typing.Sequence[models.aws_elasticloadbalancingv2.ListenerConditionDef]] = pydantic.Field(None, description='Rule applies if matches the conditions. Default: - No conditions.\n')
    priority: typing.Union[int, float, None] = pydantic.Field(None, description='Priority of this target group. The rule with the lowest priority will be used for every request. If priority is not given, these target groups will be added as defaults, and must not have conditions. Priorities must be unique. Default: Target groups are used as defaults\n')
    action: typing.Union[models.aws_elasticloadbalancingv2.ListenerActionDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Action to perform.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['conditions', 'priority', 'action', 'remove_suffix']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class AddNetworkActionPropsDef(BaseStruct):
    action: typing.Union[models.aws_elasticloadbalancingv2.NetworkListenerActionDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Action to perform.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_elasticloadbalancingv2 as elbv2\n\n    # network_listener_action: elbv2.NetworkListenerAction\n\n    add_network_action_props = elbv2.AddNetworkActionProps(\n        action=network_listener_action\n    )\n')
...
class AddNetworkTargetsPropsDef(BaseStruct):
    port: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The port on which the listener listens for requests. Default: Determined from protocol if known\n')
    deregistration_delay: typing.Optional[models.DurationDef] = pydantic.Field(None, description='The amount of time for Elastic Load Balancing to wait before deregistering a target. The range is 0-3600 seconds. Default: Duration.minutes(5)\n')
    health_check: typing.Union[models.aws_elasticloadbalancingv2.HealthCheckDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Health check configuration. Default: - The default value for each property in this configuration varies depending on the target.\n')
    preserve_client_ip: typing.Optional[bool] = pydantic.Field(None, description='Indicates whether client IP preservation is enabled. Default: false if the target group type is IP address and the target group protocol is TCP or TLS. Otherwise, true.\n')
    protocol: typing.Optional[aws_cdk.aws_elasticloadbalancingv2.Protocol] = pydantic.Field(None, description='Protocol for target group, expects TCP, TLS, UDP, or TCP_UDP. Default: - inherits the protocol of the listener\n')
...
class ApplicationListenerAttributesDef(BaseStruct):
    listener_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='ARN of the listener.\n')
    security_group: typing.Union[_REQUIRED_INIT_PARAM, models.aws_ec2.SecurityGroupDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='Security group of the load balancer this listener is associated with.\n')
...
class ApplicationLoadBalancerAttributesDef(BaseStruct):
    load_balancer_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='ARN of the load balancer.\n')
    security_group_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description="ID of the load balancer's security group.\n")
    load_balancer_canonical_hosted_zone_id: typing.Optional[str] = pydantic.Field(None, description='The canonical hosted zone ID of this load balancer. Default: - When not provided, LB cannot be used as Route53 Alias target.\n')
    load_balancer_dns_name: typing.Optional[str] = pydantic.Field(None, description='The DNS name of this load balancer. Default: - When not provided, LB cannot be used as Route53 Alias target.\n')
    security_group_allows_all_outbound: typing.Optional[bool] = pydantic.Field(None, description='Whether the security group allows all outbound traffic or not. Unless set to ``false``, no egress rules will be added to the security group. Default: true\n')
...
class ApplicationLoadBalancerPropsDef(BaseStruct):
    ...
    x_amzn_tls_version_and_cipher_suite_headers: typing.Optional[bool] = pydantic.Field(None, description='Indicates whether the two headers (x-amzn-tls-version and x-amzn-tls-cipher-suite), which contain information about the negotiated TLS version and cipher suite, are added to the client request before sending it to the target. The x-amzn-tls-version header has information about the TLS protocol version negotiated with the client, and the x-amzn-tls-cipher-suite header has information about the cipher suite negotiated with the client. Both headers are in OpenSSL format. Default: false\n')
    xff_header_processing_mode: typing.Optional[aws_cdk.aws_elasticloadbalancingv2.XffHeaderProcessingMode] = pydantic.Field(None, description='Enables you to modify, preserve, or remove the X-Forwarded-For header in the HTTP request before the Application Load Balancer sends the request to the target. Default: XffHeaderProcessingMode.APPEND\n\n:see: https://docs.aws.amazon.com/elasticloadbalancing/latest/application/application-load-balancers.html#load-balancer-attributes\n:exampleMetadata: infused\n\nExample::\n\n    from aws_cdk.aws_autoscaling import AutoScalingGroup\n    # asg: AutoScalingGroup\n    # vpc: ec2.Vpc\n\n\n    # Create the load balancer in a VPC. \'internetFacing\' is \'false\'\n    # by default, which creates an internal load balancer.\n    lb = elbv2.ApplicationLoadBalancer(self, "LB",\n        vpc=vpc,\n        internet_facing=True\n    )\n\n    # Add a listener and open up the load balancer\'s security group\n    # to the world.\n    listener = lb.add_listener("Listener",\n        port=80,\n\n        # \'open: true\' is the default, you can leave it out if you want. Set it\n        # to \'false\' and use `listener.connections` if you want to be selective\n        # about who can access the load balancer.\n        open=True\n    )\n\n    # Create an AutoScaling group and add it as a load balancing\n    # target to the listener.\n    listener.add_targets("ApplicationFleet",\n        port=8080,\n        targets=[asg]\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['vpc', 'cross_zone_enabled', 'deletion_protection', 'deny_all_igw_traffic', 'internet_facing', 'load_balancer_name', 'vpc_subnets', 'client_keep_alive', 'desync_mitigation_mode', 'drop_invalid_header_fields', 'http2_enabled', 'idle_timeout', 'ip_address_type', 'preserve_host_header', 'preserve_xff_client_port', 'security_group', 'waf_fail_open', 'x_amzn_tls_version_and_cipher_suite_headers', 'xff_header_processing_mode']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class AuthenticateOidcOptionsDef(BaseStruct):
    authorization_endpoint: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The authorization endpoint of the IdP. This must be a full URL, including the HTTPS protocol, the domain, and the path.\n')
    client_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The OAuth 2.0 client identifier.\n')
    client_secret: typing.Union[models.SecretValueDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The OAuth 2.0 client secret.\n')
    issuer: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The OIDC issuer identifier of the IdP. This must be a full URL, including the HTTPS protocol, the domain, and the path.\n')
    next: typing.Union[models.aws_elasticloadbalancingv2.ListenerActionDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='What action to execute next.\n')
    token_endpoint: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The token endpoint of the IdP. This must be a full URL, including the HTTPS protocol, the domain, and the path.\n')
    user_info_endpoint: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The user info endpoint of the IdP. This must be a full URL, including the HTTPS protocol, the domain, and the path.\n')
    allow_https_outbound: typing.Optional[bool] = pydantic.Field(None, description="Allow HTTPS outbound traffic to communicate with the IdP. Set this property to false if the IP address used for the IdP endpoint is identifiable and you want to control outbound traffic. Then allow HTTPS outbound traffic to the IdP's IP address using the listener's ``connections`` property. Default: true\n")
    authentication_request_extra_params: typing.Optional[typing.Mapping[str, str]] = pydantic.Field(None, description='The query parameters (up to 10) to include in the redirect request to the authorization endpoint. Default: - No extra parameters\n')
    on_unauthenticated_request: typing.Optional[aws_cdk.aws_elasticloadbalancingv2.UnauthenticatedAction] = pydantic.Field(None, description='The behavior if the user is not authenticated. Default: UnauthenticatedAction.AUTHENTICATE\n')
    session_cookie_name: typing.Optional[str] = pydantic.Field(None, description='The name of the cookie used to maintain session information. Default: "AWSELBAuthSessionCookie"\n')
...
class BaseLoadBalancerPropsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['vpc', 'cross_zone_enabled', 'deletion_protection', 'deny_all_igw_traffic', 'internet_facing', 'load_balancer_name', 'vpc_subnets']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnListener_ActionPropertyDef(BaseStruct):
    type: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The type of action.\n')
    authenticate_cognito_config: typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListener_AuthenticateCognitoConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='[HTTPS listeners] Information for using Amazon Cognito to authenticate users. Specify only when ``Type`` is ``authenticate-cognito`` .\n')
    authenticate_oidc_config: typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListener_AuthenticateOidcConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='[HTTPS listeners] Information about an identity provider that is compliant with OpenID Connect (OIDC). Specify only when ``Type`` is ``authenticate-oidc`` .\n')
    fixed_response_config: typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListener_FixedResponseConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='[Application Load Balancer] Information for creating an action that returns a custom HTTP response. Specify only when ``Type`` is ``fixed-response`` .\n')
    forward_config: typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListener_ForwardConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Information for creating an action that distributes requests among one or more target groups. For Network Load Balancers, you can specify a single target group. Specify only when ``Type`` is ``forward`` . If you specify both ``ForwardConfig`` and ``TargetGroupArn`` , you can specify only one target group using ``ForwardConfig`` and it must be the same target group specified in ``TargetGroupArn`` .\n')
    ...
    redirect_config: typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListener_RedirectConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='[Application Load Balancer] Information for creating a redirect action. Specify only when ``Type`` is ``redirect`` .\n')
...
class CfnListener_AuthenticateCognitoConfigPropertyDef(BaseStruct):
    user_pool_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Amazon Resource Name (ARN) of the Amazon Cognito user pool.\n')
    user_pool_client_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The ID of the Amazon Cognito user pool client.\n')
    user_pool_domain: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The domain prefix or fully-qualified domain name of the Amazon Cognito user pool.\n')
    authentication_request_extra_params: typing.Union[models.UnsupportedResource, typing.Mapping[str, str], None] = pydantic.Field(None, description='The query parameters (up to 10) to include in the redirect request to the authorization endpoint.\n')
...
class CfnListener_AuthenticateOidcConfigPropertyDef(BaseStruct):
    ...
    session_cookie_name: typing.Optional[str] = pydantic.Field(None, description='The name of the cookie used to maintain session information. The default is AWSELBAuthSessionCookie.\n')
    session_timeout: typing.Optional[str] = pydantic.Field(None, description='The maximum duration of the authentication session, in seconds. The default is 604800 seconds (7 days).\n')
    use_existing_client_secret: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='Indicates whether to use the existing client secret when modifying a rule. If you are creating a rule, you can omit this parameter or set it to false.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-elasticloadbalancingv2-listener-authenticateoidcconfig.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_elasticloadbalancingv2 as elbv2\n\n    authenticate_oidc_config_property = elbv2.CfnListener.AuthenticateOidcConfigProperty(\n        authorization_endpoint="authorizationEndpoint",\n        client_id="clientId",\n        issuer="issuer",\n        token_endpoint="tokenEndpoint",\n        user_info_endpoint="userInfoEndpoint",\n\n        # the properties below are optional\n        authentication_request_extra_params={\n            "authentication_request_extra_params_key": "authenticationRequestExtraParams"\n        },\n        client_secret="clientSecret",\n        on_unauthenticated_request="onUnauthenticatedRequest",\n        scope="scope",\n        session_cookie_name="sessionCookieName",\n        session_timeout="sessionTimeout",\n        use_existing_client_secret=False\n    )\n')
...
class CfnListener_FixedResponseConfigPropertyDef(BaseStruct):
    status_code: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The HTTP response code (2XX, 4XX, or 5XX).\n')
...
class CfnListener_ForwardConfigPropertyDef(BaseStruct):
    target_groups: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListener_TargetGroupTuplePropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='Information about how traffic will be distributed between multiple target groups in a forward rule.\n')
    target_group_stickiness_config: typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListener_TargetGroupStickinessConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Information about the target group stickiness for a rule.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-elasticloadbalancingv2-listener-forwardconfig.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_elasticloadbalancingv2 as elbv2\n\n    forward_config_property = elbv2.CfnListener.ForwardConfigProperty(\n        target_groups=[elbv2.CfnListener.TargetGroupTupleProperty(\n            target_group_arn="targetGroupArn",\n            weight=123\n        )],\n        target_group_stickiness_config=elbv2.CfnListener.TargetGroupStickinessConfigProperty(\n            duration_seconds=123,\n            enabled=False\n        )\n    )\n')
...
#  autogenerated from aws_cdk.aws_elasticloadbalancingv2.CfnListener.MutualAuthenticationProperty
class CfnListener_MutualAuthenticationPropertyDef(BaseStruct):
    ignore_client_certificate_expiry: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='Indicates whether expired client certificates are ignored.\n')
    mode: typing.Optional[str] = pydantic.Field(None, description='The client certificate handling method. Options are ``off`` , ``passthrough`` or ``verify`` . The default value is ``off`` .\n')
    trust_store_arn: typing.Optional[str] = pydantic.Field(None, description='The Amazon Resource Name (ARN) of the trust store.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-elasticloadbalancingv2-listener-mutualauthentication.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_elasticloadbalancingv2 as elbv2\n\n    mutual_authentication_property = elbv2.CfnListener.MutualAuthenticationProperty(\n        ignore_client_certificate_expiry=False,\n        mode="mode",\n        trust_store_arn="trustStoreArn"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['ignore_client_certificate_expiry', 'mode', 'trust_store_arn']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_elasticloadbalancingv2.CfnListener.MutualAuthenticationProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class CfnListener_RedirectConfigPropertyDef(BaseStruct):
    status_code: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The HTTP redirect code. The redirect is either permanent (HTTP 301) or temporary (HTTP 302).\n')
...
class CfnListenerRule_ActionPropertyDef(BaseStruct):
    type: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The type of action.\n')
    authenticate_cognito_config: typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListenerRule_AuthenticateCognitoConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='[HTTPS listeners] Information for using Amazon Cognito to authenticate users. Specify only when ``Type`` is ``authenticate-cognito`` .\n')
    authenticate_oidc_config: typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListenerRule_AuthenticateOidcConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='[HTTPS listeners] Information about an identity provider that is compliant with OpenID Connect (OIDC). Specify only when ``Type`` is ``authenticate-oidc`` .\n')
    fixed_response_config: typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListenerRule_FixedResponseConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='[Application Load Balancer] Information for creating an action that returns a custom HTTP response. Specify only when ``Type`` is ``fixed-response`` .\n')
    forward_config: typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListenerRule_ForwardConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Information for creating an action that distributes requests among one or more target groups. For Network Load Balancers, you can specify a single target group. Specify only when ``Type`` is ``forward`` . If you specify both ``ForwardConfig`` and ``TargetGroupArn`` , you can specify only one target group using ``ForwardConfig`` and it must be the same target group specified in ``TargetGroupArn`` .\n')
    order: typing.Union[int, float, None] = pydantic.Field(None, description='The order for the action. This value is required for rules with multiple actions. The action with the lowest value for order is performed first.\n')
    redirect_config: typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListenerRule_RedirectConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='[Application Load Balancer] Information for creating a redirect action. Specify only when ``Type`` is ``redirect`` .\n')
...
class CfnListenerRule_ForwardConfigPropertyDef(BaseStruct):
    target_groups: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListenerRule_TargetGroupTuplePropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='Information about how traffic will be distributed between multiple target groups in a forward rule.\n')
    target_group_stickiness_config: typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListenerRule_TargetGroupStickinessConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Information about the target group stickiness for a rule.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-elasticloadbalancingv2-listenerrule-forwardconfig.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_elasticloadbalancingv2 as elbv2\n\n    forward_config_property = elbv2.CfnListenerRule.ForwardConfigProperty(\n        target_groups=[elbv2.CfnListenerRule.TargetGroupTupleProperty(\n            target_group_arn="targetGroupArn",\n            weight=123\n        )],\n        target_group_stickiness_config=elbv2.CfnListenerRule.TargetGroupStickinessConfigProperty(\n            duration_seconds=123,\n            enabled=False\n        )\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['target_groups', 'target_group_stickiness_config']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnListenerRule_RuleConditionPropertyDef(BaseStruct):
    ...
    host_header_config: typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListenerRule_HostHeaderConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Information for a host header condition. Specify only when ``Field`` is ``host-header`` .\n')
    http_header_config: typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListenerRule_HttpHeaderConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Information for an HTTP header condition. Specify only when ``Field`` is ``http-header`` .\n')
    http_request_method_config: typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListenerRule_HttpRequestMethodConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Information for an HTTP method condition. Specify only when ``Field`` is ``http-request-method`` .\n')
    path_pattern_config: typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListenerRule_PathPatternConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Information for a path pattern condition. Specify only when ``Field`` is ``path-pattern`` .\n')
    query_string_config: typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListenerRule_QueryStringConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Information for a query string condition. Specify only when ``Field`` is ``query-string`` .\n')
    source_ip_config: typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListenerRule_SourceIpConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Information for a source IP condition. Specify only when ``Field`` is ``source-ip`` .\n')
...
class CfnLoadBalancer_SubnetMappingPropertyDef(BaseStruct):
    subnet_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The ID of the subnet.\n')
...
#  autogenerated from aws_cdk.aws_elasticloadbalancingv2.CfnTrustStoreRevocation.RevocationContentProperty
class CfnTrustStoreRevocation_RevocationContentPropertyDef(BaseStruct):
    revocation_type: typing.Optional[str] = pydantic.Field(None, description='The type of revocation file.\n')
    s3_bucket: typing.Optional[str] = pydantic.Field(None, description='The Amazon S3 bucket for the revocation file.\n')
    s3_key: typing.Optional[str] = pydantic.Field(None, description='The Amazon S3 path for the revocation file.\n')
    s3_object_version: typing.Optional[str] = pydantic.Field(None, description='The Amazon S3 object version of the revocation file.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-elasticloadbalancingv2-truststorerevocation-revocationcontent.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_elasticloadbalancingv2 as elbv2\n\n    revocation_content_property = elbv2.CfnTrustStoreRevocation.RevocationContentProperty(\n        revocation_type="revocationType",\n        s3_bucket="s3Bucket",\n        s3_key="s3Key",\n        s3_object_version="s3ObjectVersion"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['revocation_type', 's3_bucket', 's3_key', 's3_object_version']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_elasticloadbalancingv2.CfnTrustStoreRevocation.RevocationContentProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
#  autogenerated from aws_cdk.aws_elasticloadbalancingv2.CfnTrustStoreRevocation.TrustStoreRevocationProperty
class CfnTrustStoreRevocation_TrustStoreRevocationPropertyDef(BaseStruct):
    number_of_revoked_entries: typing.Union[int, float, None] = pydantic.Field(None, description='The number of revoked certificates.\n')
    revocation_id: typing.Optional[str] = pydantic.Field(None, description='The revocation ID of the revocation file.\n')
    revocation_type: typing.Optional[str] = pydantic.Field(None, description='The type of revocation file.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['number_of_revoked_entries', 'revocation_id', 'revocation_type', 'trust_store_arn']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_elasticloadbalancingv2.CfnTrustStoreRevocation.TrustStoreRevocationProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class LoadBalancerTargetPropsDef(BaseStruct):
    target_type: typing.Union[aws_cdk.aws_elasticloadbalancingv2.TargetType, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='What kind of target this is.\n')
...
class NetworkLoadBalancerAttributesDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['load_balancer_arn', 'load_balancer_canonical_hosted_zone_id', 'load_balancer_dns_name', 'load_balancer_security_groups', 'vpc']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class NetworkLoadBalancerPropsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['vpc', 'cross_zone_enabled', 'deletion_protection', 'deny_all_igw_traffic', 'internet_facing', 'load_balancer_name', 'vpc_subnets', 'client_routing_policy', 'enforce_security_group_inbound_rules_on_private_link_traffic', 'ip_address_type', 'security_groups']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class NetworkWeightedTargetGroupDef(BaseStruct):
    target_group: typing.Union[_REQUIRED_INIT_PARAM, models.aws_elasticloadbalancingv2.NetworkTargetGroupDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The target group.\n')
...
class QueryStringConditionDef(BaseStruct):
    value: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The query string value for the condition.\n')
...
class TargetGroupAttributesDef(BaseStruct):
    target_group_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='ARN of the target group.\n')
...
class WeightedTargetGroupDef(BaseStruct):
    target_group: typing.Union[_REQUIRED_INIT_PARAM, models.aws_elasticloadbalancingv2.ApplicationTargetGroupDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The target group.\n')
...
#  autogenerated from aws_cdk.aws_elasticloadbalancingv2.ClientRoutingPolicy
# skipping emum
...
#  autogenerated from aws_cdk.aws_elasticloadbalancingv2.XffHeaderProcessingMode
# skipping emum
...
class CfnListenerDef(BaseCfnResource):
    default_actions: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListener_ActionPropertyDef, dict[str, typing.Any]]]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The actions for the default rule. You cannot define a condition for a default rule. To create additional rules for an Application Load Balancer, use `AWS::ElasticLoadBalancingV2::ListenerRule <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-elasticloadbalancingv2-listenerrule.html>`_ .\n')
    load_balancer_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Amazon Resource Name (ARN) of the load balancer.\n')
    ...
    certificates: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListener_CertificatePropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The default SSL server certificate for a secure listener. You must provide exactly one certificate if the listener protocol is HTTPS or TLS. To create a certificate list for a secure listener, use `AWS::ElasticLoadBalancingV2::ListenerCertificate <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-elasticloadbalancingv2-listenercertificate.html>`_ .\n')
    mutual_authentication: typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListener_MutualAuthenticationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The mutual authentication configuration information.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['default_actions', 'load_balancer_arn', 'alpn_policy', 'certificates', 'mutual_authentication', 'port', 'protocol', 'ssl_policy']
    _method_names: typing.ClassVar[list[str]] = ['ActionProperty', 'AuthenticateCognitoConfigProperty', 'AuthenticateOidcConfigProperty', 'CertificateProperty', 'FixedResponseConfigProperty', 'ForwardConfigProperty', 'MutualAuthenticationProperty', 'RedirectConfigProperty', 'TargetGroupStickinessConfigProperty', 'TargetGroupTupleProperty', 'add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnListenerDefConfig(pydantic.BaseModel):
    ...
    MutualAuthenticationProperty: typing.Optional[list[models.aws_elasticloadbalancingv2.CfnListenerDefMutualauthenticationpropertyParams]] = pydantic.Field(None, description='')
...
class CfnListenerDefActionpropertyParams(pydantic.BaseModel):
    ...
    authenticate_cognito_config: typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListener_AuthenticateCognitoConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    authenticate_oidc_config: typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListener_AuthenticateOidcConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    fixed_response_config: typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListener_FixedResponseConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    forward_config: typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListener_ForwardConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    order: typing.Union[int, float, None] = pydantic.Field(None, description='')
    redirect_config: typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListener_RedirectConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
...
class CfnListenerDefAuthenticatecognitoconfigpropertyParams(pydantic.BaseModel):
    ...
    authentication_request_extra_params: typing.Union[models.UnsupportedResource, typing.Mapping[str, str], None] = pydantic.Field(None, description='')
...
class CfnListenerDefAuthenticateoidcconfigpropertyParams(pydantic.BaseModel):
    ...
    session_cookie_name: typing.Optional[str] = pydantic.Field(None, description='')
    session_timeout: typing.Optional[str] = pydantic.Field(None, description='')
    use_existing_client_secret: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
    ...
...
class CfnListenerDefForwardconfigpropertyParams(pydantic.BaseModel):
    target_groups: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListener_TargetGroupTuplePropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    target_group_stickiness_config: typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListener_TargetGroupStickinessConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...

class CfnListenerDefMutualauthenticationpropertyParams(pydantic.BaseModel):
    ignore_client_certificate_expiry: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
    mode: typing.Optional[str] = pydantic.Field(None, description='')
    trust_store_arn: typing.Optional[str] = pydantic.Field(None, description='')
    ...
...
class CfnListenerCertificateDef(BaseCfnResource):
    certificates: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListenerCertificate_CertificatePropertyDef, dict[str, typing.Any]]]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The certificate. You can specify one certificate per resource.\n')
    listener_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Amazon Resource Name (ARN) of the listener.')
...
class CfnListenerRuleDef(BaseCfnResource):
    actions: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListenerRule_ActionPropertyDef, dict[str, typing.Any]]]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The actions. The rule must include exactly one of the following types of actions: ``forward`` , ``fixed-response`` , or ``redirect`` , and it must be the last action to be performed. If the rule is for an HTTPS listener, it can also optionally include an authentication action.\n')
    conditions: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListenerRule_RuleConditionPropertyDef, dict[str, typing.Any]]]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The conditions. The rule can optionally include up to one of each of the following conditions: ``http-request-method`` , ``host-header`` , ``path-pattern`` , and ``source-ip`` . A rule can also optionally include one or more of each of the following conditions: ``http-header`` and ``query-string`` .\n')
    priority: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description="The rule priority. A listener can't have multiple rules with the same priority. If you try to reorder rules by updating their priorities, do not specify a new priority if an existing rule already uses this priority, as this can cause an error. If you need to reuse a priority with a different rule, you must remove it as a priority first, and then specify it in a subsequent update.\n")
...
class CfnListenerRuleDefActionpropertyParams(pydantic.BaseModel):
    type: str = pydantic.Field(..., description='')
    authenticate_cognito_config: typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListenerRule_AuthenticateCognitoConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    authenticate_oidc_config: typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListenerRule_AuthenticateOidcConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    fixed_response_config: typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListenerRule_FixedResponseConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    forward_config: typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListenerRule_ForwardConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    order: typing.Union[int, float, None] = pydantic.Field(None, description='')
    redirect_config: typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListenerRule_RedirectConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    target_group_arn: typing.Optional[str] = pydantic.Field(None, description='')
    ...
...
class CfnListenerRuleDefForwardconfigpropertyParams(pydantic.BaseModel):
    target_groups: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListenerRule_TargetGroupTuplePropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    target_group_stickiness_config: typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListenerRule_TargetGroupStickinessConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnListenerRuleDefQuerystringconfigpropertyParams(pydantic.BaseModel):
    values: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListenerRule_QueryStringKeyValuePropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    ...
...
class CfnListenerRuleDefRuleconditionpropertyParams(pydantic.BaseModel):
    ...
    host_header_config: typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListenerRule_HostHeaderConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    http_header_config: typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListenerRule_HttpHeaderConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    http_request_method_config: typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListenerRule_HttpRequestMethodConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    path_pattern_config: typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListenerRule_PathPatternConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    query_string_config: typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListenerRule_QueryStringConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    source_ip_config: typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnListenerRule_SourceIpConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    values: typing.Optional[typing.Sequence[str]] = pydantic.Field(None, description='')
    ...
...
class CfnLoadBalancerDef(BaseCfnResource):
    enforce_security_group_inbound_rules_on_private_link_traffic: typing.Optional[str] = pydantic.Field(None, description='Indicates whether to evaluate inbound security group rules for traffic sent to a Network Load Balancer through AWS PrivateLink .\n')
    ip_address_type: typing.Optional[str] = pydantic.Field(None, description='Note: Internal load balancers must use the ``ipv4`` IP address type. [Application Load Balancers] The IP address type. The possible values are ``ipv4`` (for only IPv4 addresses), ``dualstack`` (for IPv4 and IPv6 addresses), and ``dualstack-without-public-ipv4`` (for IPv6 only public addresses, with private IPv4 and IPv6 addresses). Note: Application Load Balancer authentication only supports IPv4 addresses when connecting to an Identity Provider (IdP) or Amazon Cognito endpoint. Without a public IPv4 address the load balancer cannot complete the authentication process, resulting in HTTP 500 errors. [Network Load Balancers] The IP address type. The possible values are ``ipv4`` (for only IPv4 addresses) and ``dualstack`` (for IPv4 and IPv6 addresses). You can’t specify ``dualstack`` for a load balancer with a UDP or TCP_UDP listener. [Gateway Load Balancers] The IP address type. The possible values are ``ipv4`` (for only IPv4 addresses) and ``dualstack`` (for IPv4 and IPv6 addresses).\n')
    load_balancer_attributes: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnLoadBalancer_LoadBalancerAttributePropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The load balancer attributes.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['enforce_security_group_inbound_rules_on_private_link_traffic', 'ip_address_type', 'load_balancer_attributes', 'name', 'scheme', 'security_groups', 'subnet_mappings', 'subnets', 'tags', 'type']
...
class CfnTargetGroupDef(BaseCfnResource):
    health_check_enabled: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='Indicates whether health checks are enabled. If the target type is ``lambda`` , health checks are disabled by default but can be enabled. If the target type is ``instance`` , ``ip`` , or ``alb`` , health checks are always enabled and cannot be disabled.\n')
    ...
    matcher: typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnTargetGroup_MatcherPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='[HTTP/HTTPS health checks] The HTTP or gRPC codes to use when checking for a successful response from a target. For target groups with a protocol of TCP, TCP_UDP, UDP or TLS the range is 200-599. For target groups with a protocol of HTTP or HTTPS, the range is 200-499. For target groups with a protocol of GENEVE, the range is 200-399.\n')
    ...
    target_group_attributes: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnTargetGroup_TargetGroupAttributePropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The attributes.\n')
    targets: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnTargetGroup_TargetDescriptionPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The targets.\n')
...
#  autogenerated from aws_cdk.aws_elasticloadbalancingv2.CfnTrustStore
class CfnTrustStoreDef(BaseCfnResource):
    ca_certificates_bundle_s3_bucket: typing.Optional[str] = pydantic.Field(None, description='The Amazon S3 bucket for the ca certificates bundle.\n')
    ca_certificates_bundle_s3_key: typing.Optional[str] = pydantic.Field(None, description='The Amazon S3 path for the ca certificates bundle.\n')
    ca_certificates_bundle_s3_object_version: typing.Optional[str] = pydantic.Field(None, description='The Amazon S3 object version for the ca certificates bundle. If undefined the current version is used.\n')
    name: typing.Optional[str] = pydantic.Field(None, description='The name of the trust store.\n')
    tags: typing.Optional[typing.Sequence[typing.Union[models.CfnTagDef, dict[str, typing.Any]]]] = pydantic.Field(None, description='The tags to assign to the trust store.')
    _init_params: typing.ClassVar[list[str]] = ['ca_certificates_bundle_s3_bucket', 'ca_certificates_bundle_s3_key', 'ca_certificates_bundle_s3_object_version', 'name', 'tags']
    _method_names: typing.ClassVar[list[str]] = ['add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_elasticloadbalancingv2.CfnTrustStore'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...


    resource_config: typing.Optional[models.aws_elasticloadbalancingv2.CfnTrustStoreDefConfig] = pydantic.Field(None)


class CfnTrustStoreDefConfig(pydantic.BaseModel):
    add_deletion_override: typing.Optional[list[models.aws_elasticloadbalancingv2.CfnTrustStoreDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_elasticloadbalancingv2.CfnTrustStoreDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_elasticloadbalancingv2.CfnTrustStoreDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_elasticloadbalancingv2.CfnTrustStoreDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_elasticloadbalancingv2.CfnTrustStoreDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_elasticloadbalancingv2.CfnTrustStoreDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_elasticloadbalancingv2.CfnTrustStoreDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_elasticloadbalancingv2.CfnTrustStoreDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_elasticloadbalancingv2.CfnTrustStoreDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_elasticloadbalancingv2.CfnTrustStoreDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_elasticloadbalancingv2.CfnTrustStoreDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_elasticloadbalancingv2.CfnTrustStoreDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_elasticloadbalancingv2.CfnTrustStoreDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
#  autogenerated from aws_cdk.aws_elasticloadbalancingv2.CfnTrustStoreRevocation
class CfnTrustStoreRevocationDef(BaseCfnResource):
    revocation_contents: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnTrustStoreRevocation_RevocationContentPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The revocation file to add.\n')
    trust_store_arn: typing.Optional[str] = pydantic.Field(None, description='The Amazon Resource Name (ARN) of the trust store.')
    _init_params: typing.ClassVar[list[str]] = ['revocation_contents', 'trust_store_arn']
    _method_names: typing.ClassVar[list[str]] = ['RevocationContentProperty', 'TrustStoreRevocationProperty', 'add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_elasticloadbalancingv2.CfnTrustStoreRevocation'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...


    resource_config: typing.Optional[models.aws_elasticloadbalancingv2.CfnTrustStoreRevocationDefConfig] = pydantic.Field(None)


class CfnTrustStoreRevocationDefConfig(pydantic.BaseModel):
    RevocationContentProperty: typing.Optional[list[models.aws_elasticloadbalancingv2.CfnTrustStoreRevocationDefRevocationcontentpropertyParams]] = pydantic.Field(None, description='')
    TrustStoreRevocationProperty: typing.Optional[list[models.aws_elasticloadbalancingv2.CfnTrustStoreRevocationDefTruststorerevocationpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_elasticloadbalancingv2.CfnTrustStoreRevocationDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_elasticloadbalancingv2.CfnTrustStoreRevocationDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_elasticloadbalancingv2.CfnTrustStoreRevocationDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_elasticloadbalancingv2.CfnTrustStoreRevocationDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_elasticloadbalancingv2.CfnTrustStoreRevocationDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_elasticloadbalancingv2.CfnTrustStoreRevocationDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_elasticloadbalancingv2.CfnTrustStoreRevocationDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_elasticloadbalancingv2.CfnTrustStoreRevocationDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_elasticloadbalancingv2.CfnTrustStoreRevocationDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_elasticloadbalancingv2.CfnTrustStoreRevocationDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_elasticloadbalancingv2.CfnTrustStoreRevocationDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_elasticloadbalancingv2.CfnTrustStoreRevocationDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_elasticloadbalancingv2.CfnTrustStoreRevocationDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
    attr_trust_store_revocations_config: typing.Optional[models._interface_methods.CoreIResolvableDefConfig] = pydantic.Field(None)

class CfnTrustStoreRevocationDefRevocationcontentpropertyParams(pydantic.BaseModel):
    revocation_type: typing.Optional[str] = pydantic.Field(None, description='')
...
class CfnTrustStoreRevocationDefTruststorerevocationpropertyParams(pydantic.BaseModel):
    number_of_revoked_entries: typing.Union[int, float, None] = pydantic.Field(None, description='')
    revocation_id: typing.Optional[str] = pydantic.Field(None, description='')
    revocation_type: typing.Optional[str] = pydantic.Field(None, description='')
    trust_store_arn: typing.Optional[str] = pydantic.Field(None, description='')
    ...

class CfnTrustStoreRevocationDefAddDeletionOverrideParams(pydantic.BaseModel):
    path: str = pydantic.Field(..., description='The path of the value to delete.')
    ...

class CfnTrustStoreRevocationDefAddDependencyParams(pydantic.BaseModel):
    target: models.CfnResourceDef = pydantic.Field(..., description='-')
    ...

class CfnTrustStoreRevocationDefAddDependsOnParams(pydantic.BaseModel):
    target: models.CfnResourceDef = pydantic.Field(..., description='-\n\n:deprecated: use addDependency\n\n:stability: deprecated\n')
    ...

class CfnTrustStoreRevocationDefAddMetadataParams(pydantic.BaseModel):
    key: str = pydantic.Field(..., description='-\n')
    value: typing.Any = pydantic.Field(..., description='-\n\n:see:\n\nhttps://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/metadata-section-structure.html\n\nNote that this is a different set of metadata from CDK node metadata; this\nmetadata ends up in the stack template under the resource, whereas CDK\nnode metadata ends up in the Cloud Assembly.\n')
    ...

class CfnTrustStoreRevocationDefAddOverrideParams(pydantic.BaseModel):
    path: str = pydantic.Field(..., description='- The path of the property, you can use dot notation to override values in complex types. Any intermediate keys will be created as needed.\n')
    value: typing.Any = pydantic.Field(..., description='- The value. Could be primitive or complex.')
    ...

class CfnTrustStoreRevocationDefAddPropertyDeletionOverrideParams(pydantic.BaseModel):
    property_path: str = pydantic.Field(..., description='The path to the property.')
    ...

class CfnTrustStoreRevocationDefAddPropertyOverrideParams(pydantic.BaseModel):
    property_path: str = pydantic.Field(..., description='The path of the property.\n')
    value: typing.Any = pydantic.Field(..., description='The value.')
    ...

class CfnTrustStoreRevocationDefApplyRemovalPolicyParams(pydantic.BaseModel):
    policy: typing.Optional[aws_cdk.RemovalPolicy] = pydantic.Field(None, description='-\n')
    apply_to_update_replace_policy: typing.Optional[bool] = pydantic.Field(None, description='Apply the same deletion policy to the resource\'s "UpdateReplacePolicy". Default: true\n')
    default: typing.Optional[aws_cdk.RemovalPolicy] = pydantic.Field(None, description="The default policy to apply in case the removal policy is not defined. Default: - Default value is resource specific. To determine the default value for a resource, please consult that specific resource's documentation.\n\n:see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-deletionpolicy.html#aws-attribute-deletionpolicy-options\n")
    ...

class CfnTrustStoreRevocationDefGetAttParams(pydantic.BaseModel):
    attribute_name: str = pydantic.Field(..., description='The name of the attribute.\n')
    type_hint: typing.Optional[aws_cdk.ResolutionTypeHint] = pydantic.Field(None, description='-')
    return_config: typing.Optional[list[models.core.ReferenceDefConfig]] = pydantic.Field(None)
    ...

class CfnTrustStoreRevocationDefGetMetadataParams(pydantic.BaseModel):
    key: str = pydantic.Field(..., description='-\n\n:see:\n\nhttps://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/metadata-section-structure.html\n\nNote that this is a different set of metadata from CDK node metadata; this\nmetadata ends up in the stack template under the resource, whereas CDK\nnode metadata ends up in the Cloud Assembly.\n')
    ...

class CfnTrustStoreRevocationDefInspectParams(pydantic.BaseModel):
    inspector: models.TreeInspectorDef = pydantic.Field(..., description='tree inspector to collect and process attributes.')
    ...

class CfnTrustStoreRevocationDefOverrideLogicalIdParams(pydantic.BaseModel):
    new_logical_id: str = pydantic.Field(..., description='The new logical ID to use for this stack element.')
    ...

class CfnTrustStoreRevocationDefRemoveDependencyParams(pydantic.BaseModel):
    target: models.CfnResourceDef = pydantic.Field(..., description='-')
    ...

class CfnTrustStoreRevocationDefReplaceDependencyParams(pydantic.BaseModel):
    target: models.CfnResourceDef = pydantic.Field(..., description='The dependency to replace.\n')
    new_target: models.CfnResourceDef = pydantic.Field(..., description='The new dependency to add.')
    ...
...
#  autogenerated from aws_cdk.aws_elasticloadbalancingv2.CfnTrustStoreProps
class CfnTrustStorePropsDef(BaseCfnProperty):
    ...
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_elasticloadbalancingv2.CfnTrustStoreProps'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
#  autogenerated from aws_cdk.aws_elasticloadbalancingv2.CfnTrustStoreRevocationProps
class CfnTrustStoreRevocationPropsDef(BaseCfnProperty):
    revocation_contents: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_elasticloadbalancingv2.CfnTrustStoreRevocation_RevocationContentPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The revocation file to add.\n')
    ...
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_elasticloadbalancingv2.CfnTrustStoreRevocationProps'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class ModuleModel(pydantic.BaseModel):
    ...
    CfnListener_MutualAuthenticationProperty: typing.Optional[dict[str, models.aws_elasticloadbalancingv2.CfnListener_MutualAuthenticationPropertyDef]] = pydantic.Field(None)
    ...
    CfnTrustStoreRevocation_RevocationContentProperty: typing.Optional[dict[str, models.aws_elasticloadbalancingv2.CfnTrustStoreRevocation_RevocationContentPropertyDef]] = pydantic.Field(None)
    CfnTrustStoreRevocation_TrustStoreRevocationProperty: typing.Optional[dict[str, models.aws_elasticloadbalancingv2.CfnTrustStoreRevocation_TrustStoreRevocationPropertyDef]] = pydantic.Field(None)
    ...
    CfnTrustStore: typing.Optional[dict[str, models.aws_elasticloadbalancingv2.CfnTrustStoreDef]] = pydantic.Field(None)
    CfnTrustStoreRevocation: typing.Optional[dict[str, models.aws_elasticloadbalancingv2.CfnTrustStoreRevocationDef]] = pydantic.Field(None)
    ...
    CfnTrustStoreProps: typing.Optional[dict[str, models.aws_elasticloadbalancingv2.CfnTrustStorePropsDef]] = pydantic.Field(None)
    CfnTrustStoreRevocationProps: typing.Optional[dict[str, models.aws_elasticloadbalancingv2.CfnTrustStoreRevocationPropsDef]] = pydantic.Field(None)
    ...
