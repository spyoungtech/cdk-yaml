...
class CfnAppBlock_ScriptDetailsPropertyDef(BaseStruct):
    executable_path: str = pydantic.Field(..., description='The run path for the script.\n')
    script_s3_location: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_appstream.CfnAppBlock_S3LocationPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='The S3 object location of the script.\n')
    timeout_in_seconds: typing.Union[int, float] = pydantic.Field(..., description='The run timeout, in seconds, for the script.\n')
...
class CfnDirectoryConfig_ServiceAccountCredentialsPropertyDef(BaseStruct):
    account_name: str = pydantic.Field(..., description='The user name of the account. This account must have the following privileges: create computer objects, join computers to the domain, and change/reset the password on descendant computer objects for the organizational units specified.\n')
    account_password: str = pydantic.Field(..., description='The password for the account.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appstream-directoryconfig-serviceaccountcredentials.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appstream as appstream\n\n    service_account_credentials_property = appstream.CfnDirectoryConfig.ServiceAccountCredentialsProperty(\n        account_name="accountName",\n        account_password="accountPassword"\n    )\n')
...
class CfnEntitlement_AttributePropertyDef(BaseStruct):
    name: str = pydantic.Field(..., description='A supported AWS IAM SAML PrincipalTag attribute that is matched to a value when a user identity federates to an AppStream 2.0 SAML application. The following are supported values: - roles - department - organization - groups - title - costCenter - userType\n')
    value: str = pydantic.Field(..., description='A value that is matched to a supported SAML attribute name when a user identity federates to an AppStream 2.0 SAML application.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appstream-entitlement-attribute.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_appstream as appstream\n\n    attribute_property = appstream.CfnEntitlement.AttributeProperty(\n        name="name",\n        value="value"\n    )\n')
...
class CfnStack_StorageConnectorPropertyDef(BaseStruct):
    connector_type: str = pydantic.Field(..., description='The type of storage connector.\n')
...
class CfnAppBlockDef(BaseCfnResource):
    name: str = pydantic.Field(..., description='The name of the app block. *Pattern* : ``^[a-zA-Z0-9][a-zA-Z0-9_.-]{0,100}$``\n')
    setup_script_details: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_appstream.CfnAppBlock_ScriptDetailsPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='The setup script details of the app block.\n')
    source_s3_location: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_appstream.CfnAppBlock_S3LocationPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='The source S3 location of the app block.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['name', 'setup_script_details', 'source_s3_location', 'description', 'display_name', 'tags']
...
class CfnAppBlockDefScriptdetailspropertyParams(pydantic.BaseModel):
    ...
    script_s3_location: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_appstream.CfnAppBlock_S3LocationPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
...
class CfnApplicationDef(BaseCfnResource):
    app_block_arn: str = pydantic.Field(..., description='The app block ARN with which the application should be associated.\n')
    icon_s3_location: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_appstream.CfnApplication_S3LocationPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='The icon S3 location of the application.\n')
    instance_families: typing.Sequence[str] = pydantic.Field(..., description='The instance families the application supports. *Allowed Values* : ``GENERAL_PURPOSE`` | ``GRAPHICS_G4``\n')
    launch_path: str = pydantic.Field(..., description='The launch path of the application.\n')
    name: str = pydantic.Field(..., description='The name of the application. This name is visible to users when a name is not specified in the DisplayName property. *Pattern* : ``^[a-zA-Z0-9][a-zA-Z0-9_.-]{0,100}$``\n')
    platforms: typing.Sequence[str] = pydantic.Field(..., description='The platforms the application supports. *Allowed Values* : ``WINDOWS_SERVER_2019`` | ``AMAZON_LINUX2``\n')
...
class CfnApplicationEntitlementAssociationDef(BaseCfnResource):
    application_identifier: str = pydantic.Field(..., description='The identifier of the application.\n')
    entitlement_name: str = pydantic.Field(..., description='The name of the entitlement.\n')
    stack_name: str = pydantic.Field(..., description='The name of the stack.')
...
class CfnApplicationFleetAssociationDef(BaseCfnResource):
    application_arn: str = pydantic.Field(..., description='The ARN of the application.\n')
    fleet_name: str = pydantic.Field(..., description='The name of the fleet.')
...
class CfnDirectoryConfigDef(BaseCfnResource):
    directory_name: str = pydantic.Field(..., description='The fully qualified name of the directory (for example, corp.example.com).\n')
    organizational_unit_distinguished_names: typing.Sequence[str] = pydantic.Field(..., description='The distinguished names of the organizational units for computer accounts.\n')
    service_account_credentials: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_appstream.CfnDirectoryConfig_ServiceAccountCredentialsPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='The credentials for the service account used by the streaming instance to connect to the directory. Do not use this parameter directly. Use ``ServiceAccountCredentials`` as an input parameter with ``noEcho`` as shown in the `Parameters <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/parameters-section-structure.html>`_ . For best practices information, see `Do Not Embed Credentials in Your Templates <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/best-practices.html#creds>`_ .\n')
    certificate_based_auth_properties: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_appstream.CfnDirectoryConfig_CertificateBasedAuthPropertiesPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The certificate-based authentication properties used to authenticate SAML 2.0 Identity Provider (IdP) user identities to Active Directory domain-joined streaming instances.')
...
class CfnEntitlementDef(BaseCfnResource):
    app_visibility: str = pydantic.Field(..., description='Specifies whether to entitle all apps or only selected apps.\n')
    attributes: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_appstream.CfnEntitlement_AttributePropertyDef, dict[str, typing.Any]]]] = pydantic.Field(..., description='The attributes of the entitlement.\n')
    name: str = pydantic.Field(..., description='The name of the entitlement.\n')
    stack_name: str = pydantic.Field(..., description='The name of the stack.\n')
...
class CfnFleetDef(BaseCfnResource):
    ...
    name: str = pydantic.Field(..., description='A unique name for the fleet.\n')
    compute_capacity: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_appstream.CfnFleet_ComputeCapacityPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The desired capacity for the fleet. This is not allowed for Elastic fleets.\n')
    ...
    platform: typing.Optional[str] = pydantic.Field(None, description='The platform of the fleet. Platform is a required setting for Elastic fleets, and is not used for other fleet types. *Allowed Values* : ``WINDOWS_SERVER_2019`` | ``AMAZON_LINUX2``\n')
    session_script_s3_location: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_appstream.CfnFleet_S3LocationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The S3 location of the session scripts configuration zip file. This only applies to Elastic fleets.\n')
    ...
    vpc_config: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_appstream.CfnFleet_VpcConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The VPC configuration for the fleet. This is required for Elastic fleets, but not required for other fleet types.')
    _init_params: typing.ClassVar[list[str]] = ['instance_type', 'name', 'compute_capacity', 'description', 'disconnect_timeout_in_seconds', 'display_name', 'domain_join_info', 'enable_default_internet_access', 'fleet_type', 'iam_role_arn', 'idle_disconnect_timeout_in_seconds', 'image_arn', 'image_name', 'max_concurrent_sessions', 'max_user_duration_in_seconds', 'platform', 'session_script_s3_location', 'stream_view', 'tags', 'usb_device_filter_strings', 'vpc_config']
...
class CfnFleetDefComputecapacitypropertyParams(pydantic.BaseModel):
    desired_instances: typing.Union[int, float] = pydantic.Field(..., description='')
    ...
...
class CfnImageBuilderDef(BaseCfnResource):
    ...
    name: str = pydantic.Field(..., description='A unique name for the image builder.\n')
    access_endpoints: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_appstream.CfnImageBuilder_AccessEndpointPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The list of virtual private cloud (VPC) interface endpoint objects. Administrators can connect to the image builder only through the specified endpoints.\n')
    ...
    domain_join_info: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_appstream.CfnImageBuilder_DomainJoinInfoPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The name of the directory and organizational unit (OU) to use to join the image builder to a Microsoft Active Directory domain.\n')
    enable_default_internet_access: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description='Enables or disables default internet access for the image builder.\n')
    ...
    tags: typing.Optional[typing.Sequence[typing.Union[models.CfnTagDef, dict[str, typing.Any]]]] = pydantic.Field(None, description='An array of key-value pairs.\n')
    vpc_config: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_appstream.CfnImageBuilder_VpcConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The VPC configuration for the image builder. You can specify only one subnet.')
...
class CfnStackDef(BaseCfnResource):
    access_endpoints: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_appstream.CfnStack_AccessEndpointPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The list of virtual private cloud (VPC) interface endpoint objects. Users of the stack can connect to AppStream 2.0 only through the specified endpoints.\n')
    application_settings: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_appstream.CfnStack_ApplicationSettingsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The persistent application settings for users of the stack. When these settings are enabled, changes that users make to applications and Windows settings are automatically saved after each session and applied to the next session.\n')
    attributes_to_delete: typing.Optional[typing.Sequence[str]] = pydantic.Field(None, description='The stack attributes to delete.\n')
    delete_storage_connectors: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description='*This parameter has been deprecated.*. Deletes the storage connectors currently enabled for the stack.\n')
    description: typing.Optional[str] = pydantic.Field(None, description='The description to display.\n')
    ...
    storage_connectors: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_appstream.CfnStack_StorageConnectorPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The storage connectors to enable.\n')
    streaming_experience_settings: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_appstream.CfnStack_StreamingExperienceSettingsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The streaming protocol that you want your stack to prefer. This can be UDP or TCP. Currently, UDP is only supported in the Windows native client.\n')
    tags: typing.Optional[typing.Sequence[typing.Union[models.CfnTagDef, dict[str, typing.Any]]]] = pydantic.Field(None, description='An array of key-value pairs.\n')
    user_settings: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_appstream.CfnStack_UserSettingPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The actions that are enabled or disabled for users during their streaming sessions. By default, these actions are enabled.')
...
class CfnStackFleetAssociationDef(BaseCfnResource):
    fleet_name: str = pydantic.Field(..., description='The name of the fleet. To associate a fleet with a stack, you must specify a dependency on the fleet resource. For more information, see `DependsOn Attribute <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-dependson.html>`_ .\n')
    stack_name: str = pydantic.Field(..., description='The name of the stack. To associate a fleet with a stack, you must specify a dependency on the stack resource. For more information, see `DependsOn Attribute <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-dependson.html>`_ .')
...
class CfnStackUserAssociationDef(BaseCfnResource):
    authentication_type: str = pydantic.Field(..., description='The authentication type for the user who is associated with the stack. You must specify USERPOOL.\n')
    stack_name: str = pydantic.Field(..., description='The name of the stack that is associated with the user.\n')
    user_name: str = pydantic.Field(..., description="The email address of the user who is associated with the stack. .. epigraph:: Users' email addresses are case-sensitive.\n")
    send_email_notification: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description='Specifies whether a welcome email is sent to a user after the user is created in the user pool.')
...
class CfnUserDef(BaseCfnResource):
    authentication_type: str = pydantic.Field(..., description='The authentication type for the user. You must specify USERPOOL.\n')
    user_name: str = pydantic.Field(..., description='The email address of the user. Users\' email addresses are case-sensitive. During login, if they specify an email address that doesn\'t use the same capitalization as the email address specified when their user pool account was created, a "user does not exist" error message displays.\n')
