...
#  autogenerated from aws_cdk.aws_certificatemanager.KeyAlgorithm
class KeyAlgorithmDef(BaseClass):
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the algorithm.')
    _init_params: typing.ClassVar[list[str]] = ['name']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_certificatemanager.KeyAlgorithm'
...
class CertificateDef(BaseConstruct):
    domain_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Fully-qualified domain name to request a certificate for. May contain wildcards, such as ``*.domain.com``.\n')
    certificate_name: typing.Optional[str] = pydantic.Field(None, description="The Certificate name. Since the Certificate resource doesn't support providing a physical name, the value provided here will be recorded in the ``Name`` tag Default: the full, absolute path of this construct\n")
    key_algorithm: typing.Optional[models.aws_certificatemanager.KeyAlgorithmDef] = pydantic.Field(None, description='Specifies the algorithm of the public and private key pair that your certificate uses to encrypt data. Default: KeyAlgorithm.RSA_2048\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['domain_name', 'certificate_name', 'key_algorithm', 'subject_alternative_names', 'transparency_logging_enabled', 'validation']
...
class DnsValidatedCertificateDef(BaseConstruct):
    hosted_zone: typing.Union[_REQUIRED_INIT_PARAM, models.aws_route53.HostedZoneDef, models.aws_route53.PrivateHostedZoneDef, models.aws_route53.PublicHostedZoneDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='Route 53 Hosted Zone used to perform DNS validation of the request. The zone must be authoritative for the domain name specified in the Certificate Request.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['hosted_zone', 'cleanup_route53_records', 'custom_resource_role', 'region', 'route53_endpoint', 'domain_name', 'certificate_name', 'key_algorithm', 'subject_alternative_names', 'transparency_logging_enabled', 'validation']
    _method_names: typing.ClassVar[list[str]] = ['apply_removal_policy', 'metric_days_to_expiry']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class PrivateCertificateDef(BaseConstruct):
    certificate_authority: typing.Union[models.UnsupportedResource, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Private certificate authority (CA) that will be used to issue the certificate.\n')
    domain_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Fully-qualified domain name to request a private certificate for. May contain wildcards, such as ``*.domain.com``.\n')
    key_algorithm: typing.Optional[models.aws_certificatemanager.KeyAlgorithmDef] = pydantic.Field(None, description="Specifies the algorithm of the public and private key pair that your certificate uses to encrypt data. When you request a private PKI certificate signed by a CA from AWS Private CA, the specified signing algorithm family (RSA or ECDSA) must match the algorithm family of the CA's secret key. Default: KeyAlgorithm.RSA_2048\n")
    ...
    _init_params: typing.ClassVar[list[str]] = ['certificate_authority', 'domain_name', 'key_algorithm', 'subject_alternative_names']
    _method_names: typing.ClassVar[list[str]] = ['apply_removal_policy', 'metric_days_to_expiry']
    _classmethod_names: typing.ClassVar[list[str]] = ['from_certificate_arn']
...
class CfnCertificate_DomainValidationOptionPropertyDef(BaseStruct):
    domain_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A fully qualified domain name (FQDN) in the certificate request.\n')
...
class DnsValidatedCertificatePropsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['domain_name', 'certificate_name', 'key_algorithm', 'subject_alternative_names', 'transparency_logging_enabled', 'validation', 'hosted_zone', 'cleanup_route53_records', 'custom_resource_role', 'region', 'route53_endpoint']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnCertificateDef(BaseCfnResource):
    domain_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The fully qualified domain name (FQDN), such as www.example.com, with which you want to secure an ACM certificate. Use an asterisk (*) to create a wildcard certificate that protects several sites in the same domain. For example, ``*.example.com`` protects ``www.example.com`` , ``site.example.com`` , and ``images.example.com.``.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['domain_name', 'certificate_authority_arn', 'certificate_transparency_logging_preference', 'domain_validation_options', 'key_algorithm', 'subject_alternative_names', 'tags', 'validation_method']
...
class ModuleModel(pydantic.BaseModel):
    ...
    KeyAlgorithm: typing.Optional[dict[str, models.aws_certificatemanager.KeyAlgorithmDef]] = pydantic.Field(None)
