...
class AutoScalingGroupDef(BaseConstruct, ConnectableMixin):
    ...
    max_healthy_percentage: typing.Union[int, float, None] = pydantic.Field(None, description="Specifies the upper threshold as a percentage of the desired capacity of the Auto Scaling group. It represents the maximum percentage of the group that can be in service and healthy, or pending, to support your workload when replacing instances. Value range is 0 to 100. After it's set, both ``minHealthyPercentage`` and ``maxHealthyPercentage`` to -1 will clear the previously set value. Both or neither of ``minHealthyPercentage`` and ``maxHealthyPercentage`` must be specified, and the difference between them cannot be greater than 100. A large range increases the number of instances that can be replaced at the same time. Default: - No instance maintenance policy.\n")
    min_healthy_percentage: typing.Union[int, float, None] = pydantic.Field(None, description="Specifies the lower threshold as a percentage of the desired capacity of the Auto Scaling group. It represents the minimum percentage of the group to keep in service, healthy, and ready to use to support your workload when replacing instances. Value range is 0 to 100. After it's set, both ``minHealthyPercentage`` and ``maxHealthyPercentage`` to -1 will clear the previously set value. Both or neither of ``minHealthyPercentage`` and ``maxHealthyPercentage`` must be specified, and the difference between them cannot be greater than 100. A large range increases the number of instances that can be replaced at the same time. Default: - No instance maintenance policy.\n")
    ...
    _init_params: typing.ClassVar[list[str]] = ['vpc', 'init', 'init_options', 'instance_type', 'launch_template', 'machine_image', 'max_healthy_percentage', 'min_healthy_percentage', 'mixed_instances_policy', 'require_imdsv2', 'role', 'security_group', 'user_data', 'allow_all_outbound', 'associate_public_ip_address', 'auto_scaling_group_name', 'block_devices', 'capacity_rebalance', 'cooldown', 'default_instance_warmup', 'desired_capacity', 'group_metrics', 'health_check', 'ignore_unmodified_size_properties', 'instance_monitoring', 'key_name', 'key_pair', 'max_capacity', 'max_instance_lifetime', 'min_capacity', 'new_instances_protected_from_scale_in', 'notifications', 'signals', 'spot_price', 'ssm_session_permissions', 'termination_policies', 'termination_policy_custom_lambda_function_arn', 'update_policy', 'vpc_subnets']
...
class StepScalingActionDef(BaseConstruct):
    ...
    cooldown: typing.Optional[models.DurationDef] = pydantic.Field(None, description='(deprecated) Period after a scaling completes before another scaling activity can start. Default: The default cooldown configured on the AutoScalingGroup\n')
    estimated_instance_warmup: typing.Optional[models.DurationDef] = pydantic.Field(None, description='Estimated time until a newly launched instance can send metrics to CloudWatch. Default: Same as the cooldown\n')
...
class StepScalingPolicyDef(BaseConstruct):
    ...
    metric_aggregation_type: typing.Optional[aws_cdk.aws_autoscaling.MetricAggregationType] = pydantic.Field(None, description='Aggregation to apply to all data points over the evaluation periods. Only has meaning if ``evaluationPeriods != 1``. Default: - The statistic from the metric if applicable (MIN, MAX, AVERAGE), otherwise AVERAGE.\n')
    min_adjustment_magnitude: typing.Union[int, float, None] = pydantic.Field(None, description='Minimum absolute number to adjust capacity with as result of percentage scaling. Only when using AdjustmentType = PercentChangeInCapacity, this number controls the minimum absolute effect size. Default: No minimum scaling effect')
    _init_params: typing.ClassVar[list[str]] = ['auto_scaling_group', 'metric', 'scaling_steps', 'adjustment_type', 'cooldown', 'datapoints_to_alarm', 'estimated_instance_warmup', 'evaluation_periods', 'metric_aggregation_type', 'min_adjustment_magnitude']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class AutoScalingGroupPropsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['allow_all_outbound', 'associate_public_ip_address', 'auto_scaling_group_name', 'block_devices', 'capacity_rebalance', 'cooldown', 'default_instance_warmup', 'desired_capacity', 'group_metrics', 'health_check', 'ignore_unmodified_size_properties', 'instance_monitoring', 'key_name', 'key_pair', 'max_capacity', 'max_instance_lifetime', 'min_capacity', 'new_instances_protected_from_scale_in', 'notifications', 'signals', 'spot_price', 'ssm_session_permissions', 'termination_policies', 'termination_policy_custom_lambda_function_arn', 'update_policy', 'vpc_subnets', 'vpc', 'init', 'init_options', 'instance_type', 'launch_template', 'machine_image', 'max_healthy_percentage', 'min_healthy_percentage', 'mixed_instances_policy', 'require_imdsv2', 'role', 'security_group', 'user_data']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class BasicStepScalingPolicyPropsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['metric', 'scaling_steps', 'adjustment_type', 'cooldown', 'datapoints_to_alarm', 'estimated_instance_warmup', 'evaluation_periods', 'metric_aggregation_type', 'min_adjustment_magnitude']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
#  autogenerated from aws_cdk.aws_autoscaling.CfnAutoScalingGroup.InstanceMaintenancePolicyProperty
class CfnAutoScalingGroup_InstanceMaintenancePolicyPropertyDef(BaseStruct):
    ...
    min_healthy_percentage: typing.Union[int, float, None] = pydantic.Field(None, description='Specifies the lower threshold as a percentage of the desired capacity of the Auto Scaling group. It represents the minimum percentage of the group to keep in service, healthy, and ready to use to support your workload when replacing instances. Value range is 0 to 100. To clear a previously set value, specify a value of ``-1`` .\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-autoscaling-autoscalinggroup-instancemaintenancepolicy.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_autoscaling as autoscaling\n\n    instance_maintenance_policy_property = autoscaling.CfnAutoScalingGroup.InstanceMaintenancePolicyProperty(\n        max_healthy_percentage=123,\n        min_healthy_percentage=123\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['max_healthy_percentage', 'min_healthy_percentage']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_autoscaling.CfnAutoScalingGroup.InstanceMaintenancePolicyProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class CfnAutoScalingGroup_InstanceRequirementsPropertyDef(BaseStruct):
    memory_mib: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_autoscaling.CfnAutoScalingGroup_MemoryMiBRequestPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The minimum and maximum instance memory size for an instance type, in MiB.\n')
    v_cpu_count: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_autoscaling.CfnAutoScalingGroup_VCpuCountRequestPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The minimum and maximum number of vCPUs for an instance type.\n')
    ...
    spot_max_price_percentage_over_lowest_price: typing.Union[int, float, None] = pydantic.Field(None, description="[Price protection] The price protection threshold for Spot Instances, as a percentage higher than an identified Spot price. The identified Spot price is the price of the lowest priced current generation C, M, or R instance type with your specified attributes. If no current generation C, M, or R instance type matches your attributes, then the identified price is from either the lowest priced current generation instance types or, failing that, the lowest priced previous generation instance types that match your attributes. When Amazon EC2 Auto Scaling selects instance types with your attributes, we will exclude instance types whose price exceeds your specified threshold. The parameter accepts an integer, which Amazon EC2 Auto Scaling interprets as a percentage. If you set ``DesiredCapacityType`` to ``vcpu`` or ``memory-mib`` , the price protection threshold is based on the per-vCPU or per-memory price instead of the per instance price. .. epigraph:: Only one of ``SpotMaxPricePercentageOverLowestPrice`` or ``MaxSpotPriceAsPercentageOfOptimalOnDemandPrice`` can be specified. If you don't specify either, Amazon EC2 Auto Scaling will automatically apply optimal price protection to consistently select from a wide range of instance types. To indicate no price protection threshold for Spot Instances, meaning you want to consider all instance types that match your attributes, include one of these parameters and specify a high value, such as ``999999`` .\n")
    ...
    _init_params: typing.ClassVar[list[str]] = ['memory_mib', 'v_cpu_count', 'accelerator_count', 'accelerator_manufacturers', 'accelerator_names', 'accelerator_total_memory_mib', 'accelerator_types', 'allowed_instance_types', 'bare_metal', 'baseline_ebs_bandwidth_mbps', 'burstable_performance', 'cpu_manufacturers', 'excluded_instance_types', 'instance_generations', 'local_storage', 'local_storage_types', 'max_spot_price_as_percentage_of_optimal_on_demand_price', 'memory_gib_per_v_cpu', 'network_bandwidth_gbps', 'network_interface_count', 'on_demand_max_price_percentage_over_lowest_price', 'require_hibernate_support', 'spot_max_price_percentage_over_lowest_price', 'total_local_storage_gb']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnLaunchConfiguration_BlockDevicePropertyDef(BaseStruct):
    ...
    volume_type: typing.Optional[str] = pydantic.Field(None, description='The volume type. For more information, see `Amazon EBS volume types <https://docs.aws.amazon.com/ebs/latest/userguide/ebs-volume-types.html>`_ in the *Amazon EBS User Guide* . Valid values: ``standard`` | ``io1`` | ``gp2`` | ``st1`` | ``sc1`` | ``gp3``\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-autoscaling-launchconfiguration-blockdevice.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_autoscaling as autoscaling\n\n    block_device_property = autoscaling.CfnLaunchConfiguration.BlockDeviceProperty(\n        delete_on_termination=False,\n        encrypted=False,\n        iops=123,\n        snapshot_id="snapshotId",\n        throughput=123,\n        volume_size=123,\n        volume_type="volumeType"\n    )\n')
...
class CfnScalingPolicy_CustomizedMetricSpecificationPropertyDef(BaseStruct):
    ...
    metric_name: typing.Optional[str] = pydantic.Field(None, description='The name of the metric. To get the exact metric name, namespace, and dimensions, inspect the `Metric <https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_Metric.html>`_ object that is returned by a call to `ListMetrics <https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_ListMetrics.html>`_ .\n')
    metrics: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_autoscaling.CfnScalingPolicy_TargetTrackingMetricDataQueryPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The metrics to include in the target tracking scaling policy, as a metric data query. This can include both raw metric and metric math expressions.\n')
    namespace: typing.Optional[str] = pydantic.Field(None, description='The namespace of the metric.\n')
    statistic: typing.Optional[str] = pydantic.Field(None, description='The statistic of the metric.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['dimensions', 'metric_name', 'metrics', 'namespace', 'statistic', 'unit']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
#  autogenerated from aws_cdk.aws_autoscaling.CfnScalingPolicy.TargetTrackingMetricDataQueryProperty
class CfnScalingPolicy_TargetTrackingMetricDataQueryPropertyDef(BaseStruct):
    ...
    label: typing.Optional[str] = pydantic.Field(None, description='A human-readable label for this metric or expression. This is especially useful if this is a math expression, so that you know what the value represents.\n')
    metric_stat: typing.Union[models.UnsupportedResource, models.aws_autoscaling.CfnScalingPolicy_TargetTrackingMetricStatPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Information about the metric data to return. Conditional: Within each ``TargetTrackingMetricDataQuery`` object, you must specify either ``Expression`` or ``MetricStat`` , but not both.\n')
    ...
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_autoscaling.CfnScalingPolicy.TargetTrackingMetricDataQueryProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
#  autogenerated from aws_cdk.aws_autoscaling.CfnScalingPolicy.TargetTrackingMetricStatProperty
class CfnScalingPolicy_TargetTrackingMetricStatPropertyDef(BaseStruct):
    metric: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_autoscaling.CfnScalingPolicy_MetricPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The metric to use.\n')
    ...
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_autoscaling.CfnScalingPolicy.TargetTrackingMetricStatProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class CommonAutoScalingGroupPropsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['allow_all_outbound', 'associate_public_ip_address', 'auto_scaling_group_name', 'block_devices', 'capacity_rebalance', 'cooldown', 'default_instance_warmup', 'desired_capacity', 'group_metrics', 'health_check', 'ignore_unmodified_size_properties', 'instance_monitoring', 'key_name', 'key_pair', 'max_capacity', 'max_instance_lifetime', 'min_capacity', 'new_instances_protected_from_scale_in', 'notifications', 'signals', 'spot_price', 'ssm_session_permissions', 'termination_policies', 'termination_policy_custom_lambda_function_arn', 'update_policy', 'vpc_subnets']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class LaunchTemplateOverridesDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['instance_requirements', 'instance_type', 'launch_template', 'weighted_capacity']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class StepScalingPolicyPropsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['metric', 'scaling_steps', 'adjustment_type', 'cooldown', 'datapoints_to_alarm', 'estimated_instance_warmup', 'evaluation_periods', 'metric_aggregation_type', 'min_adjustment_magnitude', 'auto_scaling_group']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnAutoScalingGroupDef(BaseCfnResource):
    ...
    health_check_type: typing.Optional[str] = pydantic.Field(None, description='A comma-separated value string of one or more health check types. The valid values are ``EC2`` , ``ELB`` , and ``VPC_LATTICE`` . ``EC2`` is the default health check and cannot be disabled. For more information, see `Health checks for instances in an Auto Scaling group <https://docs.aws.amazon.com/autoscaling/ec2/userguide/ec2-auto-scaling-health-checks.html>`_ in the *Amazon EC2 Auto Scaling User Guide* . Only specify ``EC2`` if you must clear a value that was previously set.\n')
    ...
    instance_maintenance_policy: typing.Union[models.UnsupportedResource, models.aws_autoscaling.CfnAutoScalingGroup_InstanceMaintenancePolicyPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='An instance maintenance policy. For more information, see `Set instance maintenance policy <https://docs.aws.amazon.com/autoscaling/ec2/userguide/ec2-auto-scaling-instance-maintenance-policy.html>`_ in the *Amazon EC2 Auto Scaling User Guide* .\n')
    ...
    termination_policies: typing.Optional[typing.Sequence[str]] = pydantic.Field(None, description='A policy or a list of policies that are used to select the instance to terminate. These policies are executed in the order that you list them. For more information, see `Configure termination policies for Amazon EC2 Auto Scaling <https://docs.aws.amazon.com/autoscaling/ec2/userguide/ec2-auto-scaling-termination-policies.html>`_ in the *Amazon EC2 Auto Scaling User Guide* . Valid values: ``Default`` | ``AllocationStrategy`` | ``ClosestToNextInstanceHour`` | ``NewestInstance`` | ``OldestInstance`` | ``OldestLaunchConfiguration`` | ``OldestLaunchTemplate`` | ``arn:aws:lambda:region:account-id:function:my-function:my-alias``\n')
...
class CfnAutoScalingGroupDefConfig(pydantic.BaseModel):
    ...
    InstanceMaintenancePolicyProperty: typing.Optional[list[models.aws_autoscaling.CfnAutoScalingGroupDefInstancemaintenancepolicypropertyParams]] = pydantic.Field(None, description='')
...
class CfnAutoScalingGroupDefInstancemaintenancepolicypropertyParams(pydantic.BaseModel):
    max_healthy_percentage: typing.Union[int, float, None] = pydantic.Field(None, description='')
    min_healthy_percentage: typing.Union[int, float, None] = pydantic.Field(None, description='')
    ...

class CfnAutoScalingGroupDefInstancerequirementspropertyParams(pydantic.BaseModel):
    memory_mib: typing.Union[models.UnsupportedResource, models.aws_autoscaling.CfnAutoScalingGroup_MemoryMiBRequestPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    v_cpu_count: typing.Union[models.UnsupportedResource, models.aws_autoscaling.CfnAutoScalingGroup_VCpuCountRequestPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    ...
    max_spot_price_as_percentage_of_optimal_on_demand_price: typing.Union[int, float, None] = pydantic.Field(None, description='')
...
class CfnLaunchConfigurationDef(BaseCfnResource):
    ...
    key_name: typing.Optional[str] = pydantic.Field(None, description='The name of the key pair. For more information, see `Amazon EC2 key pairs and Amazon EC2 instances <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-key-pairs.html>`_ in the *Amazon EC2 User Guide for Linux Instances* .\n')
    ...
    metadata_options: typing.Union[models.UnsupportedResource, models.aws_autoscaling.CfnLaunchConfiguration_MetadataOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The metadata options for the instances. For more information, see `Configure the instance metadata options <https://docs.aws.amazon.com/autoscaling/ec2/userguide/create-launch-config.html#launch-configurations-imds>`_ in the *Amazon EC2 Auto Scaling User Guide* .\n')
    placement_tenancy: typing.Optional[str] = pydantic.Field(None, description='The tenancy of the instance, either ``default`` or ``dedicated`` . An instance with ``dedicated`` tenancy runs on isolated, single-tenant hardware and can only be launched into a VPC. To launch dedicated instances into a shared tenancy VPC (a VPC with the instance placement tenancy attribute set to ``default`` ), you must set the value of this property to ``dedicated`` . If you specify ``PlacementTenancy`` , you must specify at least one subnet for ``VPCZoneIdentifier`` when you create your group. Valid values: ``default`` | ``dedicated``\n')
...
class CfnScalingPolicyDefConfig(pydantic.BaseModel):
    ...
    TargetTrackingMetricDataQueryProperty: typing.Optional[list[models.aws_autoscaling.CfnScalingPolicyDefTargettrackingmetricdataquerypropertyParams]] = pydantic.Field(None, description='')
    TargetTrackingMetricStatProperty: typing.Optional[list[models.aws_autoscaling.CfnScalingPolicyDefTargettrackingmetricstatpropertyParams]] = pydantic.Field(None, description='')
...
class CfnScalingPolicyDefCustomizedmetricspecificationpropertyParams(pydantic.BaseModel):
    ...
    metrics: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_autoscaling.CfnScalingPolicy_TargetTrackingMetricDataQueryPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
...
class CfnScalingPolicyDefTargettrackingmetricdataquerypropertyParams(pydantic.BaseModel):
    id: str = pydantic.Field(..., description='')
    expression: typing.Optional[str] = pydantic.Field(None, description='')
    label: typing.Optional[str] = pydantic.Field(None, description='')
    metric_stat: typing.Union[models.UnsupportedResource, models.aws_autoscaling.CfnScalingPolicy_TargetTrackingMetricStatPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    return_data: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
    ...

class CfnScalingPolicyDefTargettrackingmetricstatpropertyParams(pydantic.BaseModel):
    metric: typing.Union[models.UnsupportedResource, models.aws_autoscaling.CfnScalingPolicy_MetricPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    stat: str = pydantic.Field(..., description='')
    unit: typing.Optional[str] = pydantic.Field(None, description='')
    ...
...
class ModuleModel(pydantic.BaseModel):
    ...
    CfnAutoScalingGroup_InstanceMaintenancePolicyProperty: typing.Optional[dict[str, models.aws_autoscaling.CfnAutoScalingGroup_InstanceMaintenancePolicyPropertyDef]] = pydantic.Field(None)
    ...
    CfnScalingPolicy_TargetTrackingMetricDataQueryProperty: typing.Optional[dict[str, models.aws_autoscaling.CfnScalingPolicy_TargetTrackingMetricDataQueryPropertyDef]] = pydantic.Field(None)
    CfnScalingPolicy_TargetTrackingMetricStatProperty: typing.Optional[dict[str, models.aws_autoscaling.CfnScalingPolicy_TargetTrackingMetricStatPropertyDef]] = pydantic.Field(None)
