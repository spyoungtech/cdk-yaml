...
class CfnLifecyclePolicy_CrossRegionCopyRulePropertyDef(BaseStruct):
    ...
    deprecate_rule: typing.Union[models.UnsupportedResource, models.aws_dlm.CfnLifecyclePolicy_CrossRegionCopyDeprecateRulePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='*[AMI policies only]* The AMI deprecation rule for cross-Region AMI copies created by the rule.\n')
    ...
    target: typing.Optional[str] = pydantic.Field(None, description='.. epigraph:: Use this parameter for snapshot policies only. For AMI policies, use *TargetRegion* instead. *[Snapshot policies only]* The target Region or the Amazon Resource Name (ARN) of the target Outpost for the snapshot copies.\n')
...
class CfnLifecyclePolicy_ParametersPropertyDef(BaseStruct):
    exclude_boot_volume: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='*[Snapshot policies that target instances only]* Indicates whether to exclude the root volume from multi-volume snapshot sets. The default is ``false`` . If you specify ``true`` , then the root volumes attached to targeted instances will be excluded from the multi-volume snapshot sets created by the policy.\n')
    exclude_data_volume_tags: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.CfnTagDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='*[Snapshot policies that target instances only]* The tags used to identify data (non-root) volumes to exclude from multi-volume snapshot sets. If you create a snapshot lifecycle policy that targets instances and you specify tags for this parameter, then data volumes with the specified tags that are attached to targeted instances will be excluded from the multi-volume snapshot sets created by the policy.\n')
    no_reboot: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='*[AMI policies only]* Indicates whether targeted instances are rebooted when the lifecycle policy runs. ``true`` indicates that targeted instances are not rebooted when the policy runs. ``false`` indicates that target instances are rebooted when the policy runs. The default is ``true`` (instances are not rebooted).\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dlm-lifecyclepolicy-parameters.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_dlm as dlm\n\n    parameters_property = dlm.CfnLifecyclePolicy.ParametersProperty(\n        exclude_boot_volume=False,\n        exclude_data_volume_tags=[CfnTag(\n            key="key",\n            value="value"\n        )],\n        no_reboot=False\n    )\n')
...
class CfnLifecyclePolicy_SchedulePropertyDef(BaseStruct):
    ...
    deprecate_rule: typing.Union[models.UnsupportedResource, models.aws_dlm.CfnLifecyclePolicy_DeprecateRulePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='*[AMI policies only]* The AMI deprecation rule for the schedule.\n')
    fast_restore_rule: typing.Union[models.UnsupportedResource, models.aws_dlm.CfnLifecyclePolicy_FastRestoreRulePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='*[Snapshot policies only]* The rule for enabling fast snapshot restore.\n')
    ...
    share_rules: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_dlm.CfnLifecyclePolicy_ShareRulePropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='*[Snapshot policies only]* The rule for sharing snapshots with other AWS accounts .\n')
...
class CfnLifecyclePolicyDef(BaseCfnResource):
    ...
    policy_details: typing.Union[models.UnsupportedResource, models.aws_dlm.CfnLifecyclePolicy_PolicyDetailsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The configuration details of the lifecycle policy.\n')
