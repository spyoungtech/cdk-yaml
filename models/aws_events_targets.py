...
class ApiGatewayDef(BaseClass):
    rest_api: typing.Union[_REQUIRED_INIT_PARAM, models.aws_apigateway.RestApiBaseDef, models.aws_apigateway.LambdaRestApiDef, models.aws_apigateway.RestApiDef, models.aws_apigateway.SpecRestApiDef, models.aws_apigateway.StepFunctionsRestApiDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='- IRestApi implementation to use as event target.')
...
class ApiGatewayDefConfig(pydantic.BaseModel):
    ...
    i_rest_api_config: typing.Optional[models._interface_methods.AwsApigatewayIRestApiDefConfig] = pydantic.Field(None)
...
#  autogenerated from aws_cdk.aws_events_targets.AppSync
class AppSyncDef(BaseClass):
    appsync_api: typing.Union[_REQUIRED_INIT_PARAM, models.aws_appsync.GraphqlApiBaseDef, models.aws_appsync.GraphqlApiDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='-')
    graph_ql_operation: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The GraphQL operation; that is, the query, mutation, or subscription to be parsed and executed by the GraphQL service.\n')
    event_role: typing.Optional[typing.Union[models.aws_iam.LazyRoleDef, models.aws_iam.RoleDef]] = pydantic.Field(None, description='The role to assume before invoking the target (i.e., the pipeline) when the given rule is triggered. Default: - a new role with permissions to access mutations will be created\n')
    variables: typing.Optional[models.aws_events.RuleTargetInputDef] = pydantic.Field(None, description='The variables that are include in the GraphQL operation. Default: - The entire event is used\n')
    dead_letter_queue: typing.Optional[typing.Union[models.aws_sqs.QueueBaseDef, models.aws_sqs.QueueDef]] = pydantic.Field(None, description='The SQS queue to be used as deadLetterQueue. Check out the `considerations for using a dead-letter queue <https://docs.aws.amazon.com/eventbridge/latest/userguide/rule-dlq.html#dlq-considerations>`_. The events not successfully delivered are automatically retried for a specified period of time, depending on the retry policy of the target. If an event is not delivered before all retry attempts are exhausted, it will be sent to the dead letter queue. Default: - no dead-letter queue\n')
    max_event_age: typing.Optional[models.DurationDef] = pydantic.Field(None, description='The maximum age of a request that Lambda sends to a function for processing. Minimum value of 60. Maximum value of 86400. Default: Duration.hours(24)\n')
    retry_attempts: typing.Union[int, float, None] = pydantic.Field(None, description='The maximum number of times to retry when the function returns an error. Minimum value of 0. Maximum value of 185. Default: 185')
    _init_params: typing.ClassVar[list[str]] = ['appsync_api', 'graph_ql_operation', 'event_role', 'variables', 'dead_letter_queue', 'max_event_age', 'retry_attempts']
    _method_names: typing.ClassVar[list[str]] = ['bind']
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_events_targets.AppSync'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...


    resource_config: typing.Optional[models.aws_events_targets.AppSyncDefConfig] = pydantic.Field(None)


class AppSyncDefConfig(pydantic.BaseModel):
    bind: typing.Optional[list[models.aws_events_targets.AppSyncDefBindParams]] = pydantic.Field(None, description='Returns a RuleTarget that can be used to trigger this AppSync GraphQL API as a result from an EventBridge event.')

class AppSyncDefBindParams(pydantic.BaseModel):
    rule: typing.Union[models.aws_events.RuleDef] = pydantic.Field(..., description='-\n')
    ...
...
class CloudWatchLogGroupDef(BaseClass):
    ...
    install_latest_aws_sdk: typing.Optional[bool] = pydantic.Field(None, description='Whether the custom resource created wll default to install latest AWS SDK. Default: - install latest AWS SDK\n')
    ...
    max_event_age: typing.Optional[models.DurationDef] = pydantic.Field(None, description='The maximum age of a request that Lambda sends to a function for processing. Minimum value of 60. Maximum value of 86400. Default: Duration.hours(24)\n')
    retry_attempts: typing.Union[int, float, None] = pydantic.Field(None, description='The maximum number of times to retry when the function returns an error. Minimum value of 0. Maximum value of 185. Default: 185')
    _init_params: typing.ClassVar[list[str]] = ['log_group', 'event', 'install_latest_aws_sdk', 'log_event', 'dead_letter_queue', 'max_event_age', 'retry_attempts']
    _method_names: typing.ClassVar[list[str]] = ['bind']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class EcsTaskDef(BaseClass):
    ...
    launch_type: typing.Optional[aws_cdk.aws_ecs.LaunchType] = pydantic.Field(None, description="Specifies the launch type on which your task is running. The launch type that you specify here must match one of the launch type (compatibilities) of the target task. Default: - 'EC2' if ``isEc2Compatible`` for the ``taskDefinition`` is true, otherwise 'FARGATE'\n")
    ...
    max_event_age: typing.Optional[models.DurationDef] = pydantic.Field(None, description='The maximum age of a request that Lambda sends to a function for processing. Minimum value of 60. Maximum value of 86400. Default: Duration.hours(24)\n')
    retry_attempts: typing.Union[int, float, None] = pydantic.Field(None, description='The maximum number of times to retry when the function returns an error. Minimum value of 0. Maximum value of 185. Default: 185')
    _init_params: typing.ClassVar[list[str]] = ['cluster', 'task_definition', 'assign_public_ip', 'container_overrides', 'enable_execute_command', 'launch_type', 'platform_version', 'propagate_tags', 'role', 'security_groups', 'subnet_selection', 'tags', 'task_count', 'dead_letter_queue', 'max_event_age', 'retry_attempts']
    _method_names: typing.ClassVar[list[str]] = ['bind']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class KinesisFirehoseStreamDefConfig(pydantic.BaseModel):
    bind: typing.Optional[list[models.aws_events_targets.KinesisFirehoseStreamDefBindParams]] = pydantic.Field(None, description='(deprecated) Returns a RuleTarget that can be used to trigger this Firehose Stream as a result from a Event Bridge event.')

class KinesisFirehoseStreamDefBindParams(pydantic.BaseModel):
    ...


#  autogenerated from aws_cdk.aws_events_targets.KinesisFirehoseStreamV2
class KinesisFirehoseStreamV2Def(BaseClass):
    stream: typing.Union[models.UnsupportedResource, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='-')
    message: typing.Optional[models.aws_events.RuleTargetInputDef] = pydantic.Field(None, description='The message to send to the stream. Must be a valid JSON text passed to the target stream. Default: - the entire Event Bridge event')
    _init_params: typing.ClassVar[list[str]] = ['stream', 'message']
    _method_names: typing.ClassVar[list[str]] = ['bind']
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_events_targets.KinesisFirehoseStreamV2'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...


    resource_config: typing.Optional[models.aws_events_targets.KinesisFirehoseStreamV2DefConfig] = pydantic.Field(None)


class KinesisFirehoseStreamV2DefConfig(pydantic.BaseModel):
    bind: typing.Optional[list[models.aws_events_targets.KinesisFirehoseStreamV2DefBindParams]] = pydantic.Field(None, description='Returns a RuleTarget that can be used to trigger this Firehose Stream as a result from a Event Bridge event.')

class KinesisFirehoseStreamV2DefBindParams(pydantic.BaseModel):
    ...
...
#  autogenerated from aws_cdk.aws_events_targets.AppSyncGraphQLApiProps
class AppSyncGraphQLApiPropsDef(BaseStruct):
    dead_letter_queue: typing.Optional[typing.Union[models.aws_sqs.QueueBaseDef, models.aws_sqs.QueueDef]] = pydantic.Field(None, description='The SQS queue to be used as deadLetterQueue. Check out the `considerations for using a dead-letter queue <https://docs.aws.amazon.com/eventbridge/latest/userguide/rule-dlq.html#dlq-considerations>`_. The events not successfully delivered are automatically retried for a specified period of time, depending on the retry policy of the target. If an event is not delivered before all retry attempts are exhausted, it will be sent to the dead letter queue. Default: - no dead-letter queue\n')
    max_event_age: typing.Optional[models.DurationDef] = pydantic.Field(None, description='The maximum age of a request that Lambda sends to a function for processing. Minimum value of 60. Maximum value of 86400. Default: Duration.hours(24)\n')
    retry_attempts: typing.Union[int, float, None] = pydantic.Field(None, description='The maximum number of times to retry when the function returns an error. Minimum value of 0. Maximum value of 185. Default: 185\n')
    graph_ql_operation: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The GraphQL operation; that is, the query, mutation, or subscription to be parsed and executed by the GraphQL service.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['dead_letter_queue', 'max_event_age', 'retry_attempts', 'graph_ql_operation', 'event_role', 'variables']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_events_targets.AppSyncGraphQLApiProps'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class EcsTaskPropsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['dead_letter_queue', 'max_event_age', 'retry_attempts', 'cluster', 'task_definition', 'assign_public_ip', 'container_overrides', 'enable_execute_command', 'launch_type', 'platform_version', 'propagate_tags', 'role', 'security_groups', 'subnet_selection', 'tags', 'task_count']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class LogGroupPropsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['dead_letter_queue', 'max_event_age', 'retry_attempts', 'event', 'install_latest_aws_sdk', 'log_event']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
#  autogenerated from aws_cdk.aws_events_targets.IDeliveryStream
#  skipping Interface
...
class ModuleModel(pydantic.BaseModel):
    ...
    AppSync: typing.Optional[dict[str, models.aws_events_targets.AppSyncDef]] = pydantic.Field(None)
    ...
    KinesisFirehoseStreamV2: typing.Optional[dict[str, models.aws_events_targets.KinesisFirehoseStreamV2Def]] = pydantic.Field(None)
    ...
    AppSyncGraphQLApiProps: typing.Optional[dict[str, models.aws_events_targets.AppSyncGraphQLApiPropsDef]] = pydantic.Field(None)
