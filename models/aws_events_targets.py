...
class ApiDestinationDef(BaseClass):
    api_destination: typing.Union[models.aws_events.ApiDestinationDef] = pydantic.Field(..., description='-')
...
class ApiGatewayDef(BaseClass):
    rest_api: models.aws_apigateway.RestApiDef = pydantic.Field(..., description='-')
...
class AwsApiDef(BaseClass):
    ...
    action: str = pydantic.Field(..., description='The service action to call.\n')
    service: str = pydantic.Field(..., description='The service to call.\n')
...
class BatchJobDef(BaseClass):
    job_queue_arn: str = pydantic.Field(..., description='The JobQueue arn.')
    job_queue_scope: models.AnyResource = pydantic.Field(..., description='The JobQueue Resource.\n')
    job_definition_arn: str = pydantic.Field(..., description='The jobDefinition arn.\n')
    job_definition_scope: models.AnyResource = pydantic.Field(..., description='The JobQueue Resource.\n')
...
class CodePipelineDef(BaseClass):
    pipeline: typing.Union[models.aws_codepipeline.PipelineDef] = pydantic.Field(..., description='-')
    event_role: typing.Optional[typing.Union[models.aws_iam.LazyRoleDef, models.aws_iam.RoleDef]] = pydantic.Field(None, description='The role to assume before invoking the target (i.e., the pipeline) when the given rule is triggered. Default: - a new role will be created\n')
    dead_letter_queue: typing.Optional[typing.Union[models.aws_sqs.QueueBaseDef, models.aws_sqs.QueueDef]] = pydantic.Field(None, description='The SQS queue to be used as deadLetterQueue. Check out the `considerations for using a dead-letter queue <https://docs.aws.amazon.com/eventbridge/latest/userguide/rule-dlq.html#dlq-considerations>`_. The events not successfully delivered are automatically retried for a specified period of time, depending on the retry policy of the target. If an event is not delivered before all retry attempts are exhausted, it will be sent to the dead letter queue. Default: - no dead-letter queue\n')
    max_event_age: typing.Optional[models.DurationDef] = pydantic.Field(None, description='The maximum age of a request that Lambda sends to a function for processing. Minimum value of 60. Maximum value of 86400. Default: Duration.hours(24)\n')
    retry_attempts: typing.Union[int, float, None] = pydantic.Field(None, description='The maximum number of times to retry when the function returns an error. Minimum value of 0. Maximum value of 185. Default: 185')
...
class EcsTaskDef(BaseClass):
    cluster: typing.Union[models.aws_ecs.ClusterDef] = pydantic.Field(..., description='Cluster where service will be deployed.')
    task_definition: typing.Union[models.aws_ecs.Ec2TaskDefinitionDef, models.aws_ecs.ExternalTaskDefinitionDef, models.aws_ecs.FargateTaskDefinitionDef, models.aws_ecs.TaskDefinitionDef] = pydantic.Field(..., description='Task Definition of the task that should be started.\n')
    ...
    max_event_age: typing.Optional[models.DurationDef] = pydantic.Field(None, description='The maximum age of a request that Lambda sends to a function for processing. Minimum value of 60. Maximum value of 86400. Default: Duration.hours(24)\n')
    retry_attempts: typing.Union[int, float, None] = pydantic.Field(None, description='The maximum number of times to retry when the function returns an error. Minimum value of 0. Maximum value of 185. Default: 185')
    _init_params: typing.ClassVar[list[str]] = ['cluster', 'task_definition', 'container_overrides', 'enable_execute_command', 'platform_version', 'propagate_tags', 'role', 'security_groups', 'subnet_selection', 'tags', 'task_count', 'dead_letter_queue', 'max_event_age', 'retry_attempts']
    _method_names: typing.ClassVar[list[str]] = ['bind']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class EventBusDef(BaseClass):
    event_bus: typing.Union[models.aws_events.EventBusDef] = pydantic.Field(..., description='-')
    dead_letter_queue: typing.Optional[typing.Union[models.aws_sqs.QueueBaseDef, models.aws_sqs.QueueDef]] = pydantic.Field(None, description='The SQS queue to be used as deadLetterQueue. Check out the `considerations for using a dead-letter queue <https://docs.aws.amazon.com/eventbridge/latest/userguide/rule-dlq.html#dlq-considerations>`_. The events not successfully delivered are automatically retried for a specified period of time, depending on the retry policy of the target. If an event is not delivered before all retry attempts are exhausted, it will be sent to the dead letter queue. Default: - no dead-letter queue\n')
...
class KinesisFirehoseStreamDef(BaseClass):
    stream: models.aws_kinesisfirehose.CfnDeliveryStreamDef = pydantic.Field(..., description='-')
...
class SfnStateMachineDef(BaseClass):
    machine: typing.Union[models.aws_stepfunctions.StateMachineDef] = pydantic.Field(..., description='-')
...
class ContainerOverrideDef(BaseStruct):
    container_name: str = pydantic.Field(..., description='Name of the container inside the task definition.')
...
class EcsTaskPropsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['dead_letter_queue', 'max_event_age', 'retry_attempts', 'cluster', 'task_definition', 'container_overrides', 'enable_execute_command', 'platform_version', 'propagate_tags', 'role', 'security_groups', 'subnet_selection', 'tags', 'task_count']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class TagDef(BaseStruct):
    key: str = pydantic.Field(..., description='Key is the name of the tag.\n')
    value: str = pydantic.Field(..., description='Value is the metadata contents of the tag.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_events_targets as events_targets\n\n    tag = events_targets.Tag(\n        key="key",\n        value="value"\n    )\n')
...
class TaskEnvironmentVariableDef(BaseStruct):
    name: str = pydantic.Field(..., description='Name for the environment variable. Exactly one of ``name`` and ``namePath`` must be specified.\n')
    value: str = pydantic.Field(..., description='Value of the environment variable. Exactly one of ``value`` and ``valuePath`` must be specified.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_events_targets as events_targets\n\n    task_environment_variable = events_targets.TaskEnvironmentVariable(\n        name="name",\n        value="value"\n    )\n')
