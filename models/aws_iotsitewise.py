...
class CfnAccessPolicy_AccessPolicyResourcePropertyDef(BaseStruct):
    portal: typing.Union[models.UnsupportedResource, models.aws_iotsitewise.CfnAccessPolicy_PortalPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Identifies an AWS IoT SiteWise Monitor portal.\n')
    project: typing.Union[models.UnsupportedResource, models.aws_iotsitewise.CfnAccessPolicy_ProjectPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Identifies a specific AWS IoT SiteWise Monitor project.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iotsitewise-accesspolicy-accesspolicyresource.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_iotsitewise as iotsitewise\n\n    access_policy_resource_property = iotsitewise.CfnAccessPolicy.AccessPolicyResourceProperty(\n        portal=iotsitewise.CfnAccessPolicy.PortalProperty(\n            id="id"\n        ),\n        project=iotsitewise.CfnAccessPolicy.ProjectProperty(\n            id="id"\n        )\n    )\n')
...
class CfnAsset_AssetPropertyPropertyDef(BaseStruct):
    alias: typing.Optional[str] = pydantic.Field(None, description='The alias that identifies the property, such as an OPC-UA server data stream path (for example, ``/company/windfarm/3/turbine/7/temperature`` ). For more information, see `Mapping industrial data streams to asset properties <https://docs.aws.amazon.com/iot-sitewise/latest/userguide/connect-data-streams.html>`_ in the *AWS IoT SiteWise User Guide* .\n')
    external_id: typing.Optional[str] = pydantic.Field(None, description='The external ID of the property. For more information, see `Using external IDs <https://docs.aws.amazon.com/iot-sitewise/latest/userguide/object-ids.html#external-ids>`_ in the *AWS IoT SiteWise User Guide* .\n')
    logical_id: typing.Optional[str] = pydantic.Field(None, description='The ``LogicalID`` of the asset property.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['alias', 'external_id', 'logical_id', 'notification_state', 'unit']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnAssetModel_AssetModelCompositeModelPropertyDef(BaseStruct):
    ...
    composed_asset_model_id: typing.Optional[str] = pydantic.Field(None, description='The ID of a component model which is reused to create this composite model.\n')
...
class CfnAssetModel_AssetModelPropertyPropertyDef(BaseStruct):
    data_type: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The data type of the asset model property.\n')
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the asset model property.\n')
    ...
    external_id: typing.Optional[str] = pydantic.Field(None, description='The external ID of the asset property. For more information, see `Using external IDs <https://docs.aws.amazon.com/iot-sitewise/latest/userguide/object-ids.html#external-ids>`_ in the *AWS IoT SiteWise User Guide* . .. epigraph:: One of ``ExternalId`` or ``LogicalId`` must be specified.\n')
    logical_id: typing.Optional[str] = pydantic.Field(None, description='The ``LogicalID`` of the asset model property. .. epigraph:: One of ``ExternalId`` or ``LogicalId`` must be specified.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['data_type', 'name', 'type', 'data_type_spec', 'external_id', 'logical_id', 'unit']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnAssetModel_ExpressionVariablePropertyDef(BaseStruct):
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The friendly name of the variable to be used in the expression.\n')
...
#  autogenerated from aws_cdk.aws_iotsitewise.CfnAssetModel.PropertyPathDefinitionProperty
class CfnAssetModel_PropertyPathDefinitionPropertyDef(BaseStruct):
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the path segment.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iotsitewise-assetmodel-propertypathdefinition.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_iotsitewise as iotsitewise\n\n    property_path_definition_property = iotsitewise.CfnAssetModel.PropertyPathDefinitionProperty(\n        name="name"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['name']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_iotsitewise.CfnAssetModel.PropertyPathDefinitionProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class CfnAssetModel_PropertyTypePropertyDef(BaseStruct):
    ...
    metric: typing.Union[models.UnsupportedResource, models.aws_iotsitewise.CfnAssetModel_MetricPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Specifies an asset metric property. A metric contains a mathematical expression that uses aggregate functions to process all input data points over a time interval and output a single data point, such as to calculate the average hourly temperature.\n')
...
class CfnAssetModel_VariableValuePropertyDef(BaseStruct):
    hierarchy_external_id: typing.Optional[str] = pydantic.Field(None, description='The external ID of the hierarchy being referenced. For more information, see `Using external IDs <https://docs.aws.amazon.com/iot-sitewise/latest/userguide/object-ids.html#external-ids>`_ in the *AWS IoT SiteWise User Guide* .\n')
    hierarchy_id: typing.Optional[str] = pydantic.Field(None, description="The ID of the hierarchy to query for the property ID. You can use the hierarchy's name instead of the hierarchy's ID. If the hierarchy has an external ID, you can specify ``externalId:`` followed by the external ID. For more information, see `Using external IDs <https://docs.aws.amazon.com/iot-sitewise/latest/userguide/object-ids.html#external-ids>`_ in the *AWS IoT SiteWise User Guide* . You use a hierarchy ID instead of a model ID because you can have several hierarchies using the same model and therefore the same ``propertyId`` . For example, you might have separately grouped assets that come from the same asset model. For more information, see `Asset hierarchies <https://docs.aws.amazon.com/iot-sitewise/latest/userguide/asset-hierarchies.html>`_ in the *AWS IoT SiteWise User Guide* .\n")
    ...
    property_external_id: typing.Optional[str] = pydantic.Field(None, description='The external ID of the property being referenced. For more information, see `Using external IDs <https://docs.aws.amazon.com/iot-sitewise/latest/userguide/object-ids.html#external-ids>`_ in the *AWS IoT SiteWise User Guide* .\n')
    property_id: typing.Optional[str] = pydantic.Field(None, description="The ID of the property to use as the variable. You can use the property ``name`` if it's from the same asset model. If the property has an external ID, you can specify ``externalId:`` followed by the external ID. For more information, see `Using external IDs <https://docs.aws.amazon.com/iot-sitewise/latest/userguide/object-ids.html#external-ids>`_ in the *AWS IoT SiteWise User Guide* . .. epigraph:: This is a return value and can't be set.\n")
    property_logical_id: typing.Optional[str] = pydantic.Field(None, description='The ``LogicalID`` of the property that is being referenced.\n')
    property_path: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_iotsitewise.CfnAssetModel_PropertyPathDefinitionPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The path of the property. Each step of the path is the name of the step. See the following example: ``PropertyPath: Name: AssetModelName Name: Composite1 Name: NestedComposite``\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iotsitewise-assetmodel-variablevalue.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_iotsitewise as iotsitewise\n\n    variable_value_property = iotsitewise.CfnAssetModel.VariableValueProperty(\n        hierarchy_external_id="hierarchyExternalId",\n        hierarchy_id="hierarchyId",\n        hierarchy_logical_id="hierarchyLogicalId",\n        property_external_id="propertyExternalId",\n        property_id="propertyId",\n        property_logical_id="propertyLogicalId",\n        property_path=[iotsitewise.CfnAssetModel.PropertyPathDefinitionProperty(\n            name="name"\n        )]\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['hierarchy_external_id', 'hierarchy_id', 'hierarchy_logical_id', 'property_external_id', 'property_id', 'property_logical_id', 'property_path']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnGateway_GatewayCapabilitySummaryPropertyDef(BaseStruct):
    capability_namespace: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The namespace of the capability configuration. For example, if you configure OPC-UA sources from the AWS IoT SiteWise console, your OPC-UA capability configuration has the namespace ``iotsitewise:opcuacollector:version`` , where ``version`` is a number such as ``1`` .\n')
...
class CfnAccessPolicyDef(BaseCfnResource):
    ...
    access_policy_permission: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The permission level for this access policy. Note that a project ``ADMINISTRATOR`` is also known as a project owner.\n')
...
class CfnAssetDef(BaseCfnResource):
    asset_model_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The ID of the asset model from which to create the asset. This can be either the actual ID in UUID format, or else ``externalId:`` followed by the external ID, if it has one. For more information, see `Referencing objects with external IDs <https://docs.aws.amazon.com/iot-sitewise/latest/userguide/object-ids.html#external-id-references>`_ in the *AWS IoT SiteWise User Guide* .\n')
    asset_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A friendly name for the asset.\n')
    asset_description: typing.Optional[str] = pydantic.Field(None, description='The ID of the asset, in UUID format.\n')
    asset_external_id: typing.Optional[str] = pydantic.Field(None, description='The external ID of the asset model composite model. For more information, see `Using external IDs <https://docs.aws.amazon.com/iot-sitewise/latest/userguide/object-ids.html#external-ids>`_ in the *AWS IoT SiteWise User Guide* .\n')
    asset_hierarchies: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_iotsitewise.CfnAsset_AssetHierarchyPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='A list of asset hierarchies that each contain a ``hierarchyId`` . A hierarchy specifies allowed parent/child asset relationships.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['asset_model_id', 'asset_name', 'asset_description', 'asset_external_id', 'asset_hierarchies', 'asset_properties', 'tags']
...
class CfnAssetDefAssethierarchypropertyParams(pydantic.BaseModel):
    ...
    id: typing.Optional[str] = pydantic.Field(None, description='')
    logical_id: typing.Optional[str] = pydantic.Field(None, description='')
    ...
...
class CfnAssetModelDef(BaseCfnResource):
    ...
    asset_model_type: typing.Optional[str] = pydantic.Field(None, description="The type of asset model. - *ASSET_MODEL* – (default) An asset model that you can use to create assets. Can't be included as a component in another asset model. - *COMPONENT_MODEL* – A reusable component that you can include in the composite models of other asset models. You can't create assets directly from this type of asset model.\n")
    tags: typing.Optional[typing.Sequence[typing.Union[models.CfnTagDef, dict[str, typing.Any]]]] = pydantic.Field(None, description='A list of key-value pairs that contain metadata for the asset. For more information, see `Tagging your AWS IoT SiteWise resources <https://docs.aws.amazon.com/iot-sitewise/latest/userguide/tag-resources.html>`_ in the *AWS IoT SiteWise User Guide* .')
    _init_params: typing.ClassVar[list[str]] = ['asset_model_name', 'asset_model_composite_models', 'asset_model_description', 'asset_model_external_id', 'asset_model_hierarchies', 'asset_model_properties', 'asset_model_type', 'tags']
...
class CfnAssetModelDefConfig(pydantic.BaseModel):
    ...
    PropertyPathDefinitionProperty: typing.Optional[list[models.aws_iotsitewise.CfnAssetModelDefPropertypathdefinitionpropertyParams]] = pydantic.Field(None, description='')
...
class CfnAssetModelDefAssetmodelcompositemodelpropertyParams(pydantic.BaseModel):
    ...
    composed_asset_model_id: typing.Optional[str] = pydantic.Field(None, description='')
    ...
    external_id: typing.Optional[str] = pydantic.Field(None, description='')
    id: typing.Optional[str] = pydantic.Field(None, description='')
    parent_asset_model_composite_model_external_id: typing.Optional[str] = pydantic.Field(None, description='')
    path: typing.Optional[typing.Sequence[str]] = pydantic.Field(None, description='')
    ...
...
class CfnAssetModelDefPropertypathdefinitionpropertyParams(pydantic.BaseModel):
    name: str = pydantic.Field(..., description='')
    ...
...
class CfnAssetModelDefVariablevaluepropertyParams(pydantic.BaseModel):
    hierarchy_external_id: typing.Optional[str] = pydantic.Field(None, description='')
    hierarchy_id: typing.Optional[str] = pydantic.Field(None, description='')
    hierarchy_logical_id: typing.Optional[str] = pydantic.Field(None, description='')
    property_external_id: typing.Optional[str] = pydantic.Field(None, description='')
    property_id: typing.Optional[str] = pydantic.Field(None, description='')
    property_logical_id: typing.Optional[str] = pydantic.Field(None, description='')
    property_path: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_iotsitewise.CfnAssetModel_PropertyPathDefinitionPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    ...
...
class CfnGatewayDef(BaseCfnResource):
    gateway_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A unique, friendly name for the gateway.\n')
...
class ModuleModel(pydantic.BaseModel):
    ...
    CfnAssetModel_PropertyPathDefinitionProperty: typing.Optional[dict[str, models.aws_iotsitewise.CfnAssetModel_PropertyPathDefinitionPropertyDef]] = pydantic.Field(None)
