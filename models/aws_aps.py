...
class CfnRuleGroupsNamespaceDef(BaseCfnResource):
    data: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The rules definition file for this namespace.\n')
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the rule groups namespace. This property is required.\n')
    workspace: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The ARN of the workspace that contains this rule groups namespace.\n')
...
class CfnWorkspaceDef(BaseCfnResource):
    ...
    logging_configuration: typing.Union[models.UnsupportedResource, models.aws_aps.CfnWorkspace_LoggingConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The LoggingConfiguration attribute is used to set the logging configuration for the workspace.\n')
