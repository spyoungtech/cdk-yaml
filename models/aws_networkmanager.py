...
class CfnConnectAttachmentDef(BaseCfnResource):
    ...
    tags: typing.Optional[typing.Sequence[typing.Union[models.CfnTagDef, dict[str, typing.Any]]]] = pydantic.Field(None, description='Tags for the attachment.')
...
class CfnDeviceDefConfig(pydantic.BaseModel):
    AWSLocationProperty: typing.Optional[list[CfnDeviceDefAwslocationpropertyParams]] = pydantic.Field(None, description='')
...
class ModuleModel(pydantic.BaseModel):
    ...
    CfnDevice_AWSLocationProperty: typing.Optional[dict[str, CfnDevice_AWSLocationPropertyDef]] = pydantic.Field(None)
