...
class ProductStackDef(BaseConstruct):
    asset_bucket: typing.Optional[models.aws_s3.BucketDef] = pydantic.Field(None, description='A Bucket can be passed to store assets, enabling ProductStack Asset support. Default: - No Bucket provided and Assets will not be supported.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['asset_bucket', 'server_side_encryption', 'server_side_encryption_aws_kms_key_id']
...
class CloudFormationTemplateConfigDef(BaseStruct):
    ...
    asset_bucket: typing.Optional[models.aws_s3.BucketDef] = pydantic.Field(None, description='The S3 bucket containing product stack assets. Default: - None - no assets are used in this product\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_s3 as s3\n    from aws_cdk import aws_servicecatalog as servicecatalog\n\n    # bucket: s3.Bucket\n\n    cloud_formation_template_config = servicecatalog.CloudFormationTemplateConfig(\n        http_url="httpUrl",\n\n        # the properties below are optional\n        asset_bucket=bucket\n    )\n')
