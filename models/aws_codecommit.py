...
class RepositoryDef(BaseConstruct):
    repository_name: str = pydantic.Field(..., description='Name of the repository. This property is required for all CodeCommit repositories.\n')
...
class CfnRepository_CodePropertyDef(BaseStruct):
    s3: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_codecommit.CfnRepository_S3PropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='Information about the Amazon S3 bucket that contains a ZIP file of code to be committed to the repository. Changes to this property are ignored after initial resource creation.\n')
...
class CfnRepository_RepositoryTriggerPropertyDef(BaseStruct):
    destination_arn: str = pydantic.Field(..., description='The ARN of the resource that is the target for a trigger (for example, the ARN of a topic in Amazon SNS).\n')
    events: typing.Sequence[str] = pydantic.Field(..., description='The repository events that cause the trigger to run actions in another service, such as sending a notification through Amazon SNS. .. epigraph:: The valid value "all" cannot be used with any other values.\n')
    name: str = pydantic.Field(..., description='The name of the trigger.\n')
...
class CfnRepository_S3PropertyDef(BaseStruct):
    bucket: str = pydantic.Field(..., description='The name of the Amazon S3 bucket that contains the ZIP file with the content that will be committed to the new repository. This can be specified using the name of the bucket in the AWS account . Changes to this property are ignored after initial resource creation.\n')
    key: str = pydantic.Field(..., description='The key to use for accessing the Amazon S3 bucket. Changes to this property are ignored after initial resource creation. For more information, see `Creating object key names <https://docs.aws.amazon.com/AmazonS3/latest/userguide/object-keys.html>`_ and `Uploading objects <https://docs.aws.amazon.com/AmazonS3/latest/userguide/upload-objects.html>`_ in the Amazon S3 User Guide.\n')
...
class CodeConfigDef(BaseStruct):
    code: typing.Union[models.aws_codecommit.CfnRepository_CodePropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='represents the underlying code structure.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_codecommit as codecommit\n\n    code_config = codecommit.CodeConfig(\n        code=codecommit.CfnRepository.CodeProperty(\n            s3=codecommit.CfnRepository.S3Property(\n                bucket="bucket",\n                key="key",\n\n                # the properties below are optional\n                object_version="objectVersion"\n            ),\n\n            # the properties below are optional\n            branch_name="branchName"\n        )\n    )\n')
...
class CfnRepositoryDef(BaseCfnResource):
    ...
    triggers: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_codecommit.CfnRepository_RepositoryTriggerPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The JSON block of configuration information for each trigger.')
...
class CfnRepositoryDefCodepropertyParams(pydantic.BaseModel):
    s3: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_codecommit.CfnRepository_S3PropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
