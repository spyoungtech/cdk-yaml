...
class RepositoryDef(BaseConstruct):
    ...
    kms_key: typing.Optional[typing.Union[models.aws_kms.KeyDef]] = pydantic.Field(None, description='The customer managed key used to encrypt and decrypt the data in repository. Default: - Use an AWS managed key')
    _init_params: typing.ClassVar[list[str]] = ['repository_name', 'code', 'description', 'kms_key']
...
class CfnRepositoryDef(BaseCfnResource):
    ...
    kms_key_id: typing.Optional[str] = pydantic.Field(None, description='The ID of the AWS Key Management Service encryption key used to encrypt and decrypt the repository. .. epigraph:: The input can be the full ARN, the key ID, or the key alias. For more information, see `Finding the key ID and key ARN <https://docs.aws.amazon.com/kms/latest/developerguide/find-cmk-id-arn.html>`_ .\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['repository_name', 'code', 'kms_key_id', 'repository_description', 'tags', 'triggers']
