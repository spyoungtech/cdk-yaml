...
class CfnCollaboration_MemberSpecificationPropertyDef(BaseStruct):
    account_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The identifier used to reference members of the collaboration. Currently only supports ID.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['account_id', 'display_name', 'member_abilities']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnConfiguredTable_AnalysisRuleCustomPropertyDef(BaseStruct):
    allowed_analyses: typing.Union[typing.Sequence[str], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The analysis templates that are allowed by the custom analysis rule.\n')
    allowed_analysis_providers: typing.Optional[typing.Sequence[str]] = pydantic.Field(None, description='The accounts that are allowed to query by the custom analysis rule. Required when ``allowedAnalyses`` is ``ANY_QUERY`` .\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cleanrooms-configuredtable-analysisrulecustom.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_cleanrooms as cleanrooms\n\n    analysis_rule_custom_property = cleanrooms.CfnConfiguredTable.AnalysisRuleCustomProperty(\n        allowed_analyses=["allowedAnalyses"],\n\n        # the properties below are optional\n        allowed_analysis_providers=["allowedAnalysisProviders"]\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['allowed_analyses', 'allowed_analysis_providers']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnCollaborationDef(BaseCfnResource):
    ...
    tags: typing.Optional[typing.Sequence[typing.Union[models.CfnTagDef, dict[str, typing.Any]]]] = pydantic.Field(None, description='An optional label that you can assign to a resource when you create it. Each tag consists of a key and an optional value, both of which you define. When you use tagging, you can also use tag-based access control in IAM policies to control access to this resource.')
    _init_params: typing.ClassVar[list[str]] = ['creator_display_name', 'creator_member_abilities', 'description', 'members', 'name', 'query_log_status', 'data_encryption_metadata', 'tags']
    _method_names: typing.ClassVar[list[str]] = ['DataEncryptionMetadataProperty', 'MemberSpecificationProperty', 'add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnMembershipDef(BaseCfnResource):
    ...
    tags: typing.Optional[typing.Sequence[typing.Union[models.CfnTagDef, dict[str, typing.Any]]]] = pydantic.Field(None, description='An optional label that you can assign to a resource when you create it. Each tag consists of a key and an optional value, both of which you define. When you use tagging, you can also use tag-based access control in IAM policies to control access to this resource.')
    _init_params: typing.ClassVar[list[str]] = ['collaboration_identifier', 'query_log_status', 'default_result_configuration', 'tags']
    _method_names: typing.ClassVar[list[str]] = ['MembershipProtectedQueryOutputConfigurationProperty', 'MembershipProtectedQueryResultConfigurationProperty', 'ProtectedQueryS3OutputConfigurationProperty', 'add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
