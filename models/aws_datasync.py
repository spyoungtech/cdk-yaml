...
class CfnTask_S3PropertyDef(BaseStruct):
    bucket_access_role_arn: typing.Optional[str] = pydantic.Field(None, description='Specifies the Amazon Resource Name (ARN) of the IAM policy that allows DataSync to upload a task report to your S3 bucket. For more information, see `Allowing DataSync to upload a task report to an Amazon S3 bucket <https://docs.aws.amazon.com/datasync/latest/userguide/creating-task-reports.html>`_ .\n')
    s3_bucket_arn: typing.Optional[str] = pydantic.Field(None, description='Specifies the ARN of the S3 bucket where DataSync uploads your report.\n')
    subdirectory: typing.Optional[str] = pydantic.Field(None, description='Specifies a bucket prefix for your report.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-datasync-task-s3.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_datasync as datasync\n\n    s3_property = datasync.CfnTask.S3Property(\n        bucket_access_role_arn="bucketAccessRoleArn",\n        s3_bucket_arn="s3BucketArn",\n        subdirectory="subdirectory"\n    )\n')
...
class CfnTask_TaskSchedulePropertyDef(BaseStruct):
    schedule_expression: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A cron expression that specifies when AWS DataSync initiates a scheduled transfer from a source to a destination location.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-datasync-task-taskschedule.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_datasync as datasync\n\n    task_schedule_property = datasync.CfnTask.TaskScheduleProperty(\n        schedule_expression="scheduleExpression"\n    )\n')
...
class CfnLocationAzureBlobDef(BaseCfnResource):
    ...
    resource_config: typing.Optional[CfnLocationAzureBlobDefConfig] = pydantic.Field(None)


class CfnLocationAzureBlobDefConfig(pydantic.BaseModel):
    AzureBlobSasConfigurationProperty: typing.Optional[list[CfnLocationAzureBlobDefAzureblobsasconfigurationpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[CfnLocationAzureBlobDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[CfnLocationAzureBlobDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[CfnLocationAzureBlobDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[CfnLocationAzureBlobDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[CfnLocationAzureBlobDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[CfnLocationAzureBlobDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[CfnLocationAzureBlobDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[CfnLocationAzureBlobDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[CfnLocationAzureBlobDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[CfnLocationAzureBlobDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[CfnLocationAzureBlobDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[CfnLocationAzureBlobDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[CfnLocationAzureBlobDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
class CfnLocationFSxWindowsDef(BaseCfnResource):
    ...
    domain: typing.Optional[str] = pydantic.Field(None, description='Specifies the name of the Windows domain that the FSx for Windows File Server belongs to. If you have multiple domains in your environment, configuring this parameter makes sure that DataSync connects to the right file server. For more information, see `required permissions <https://docs.aws.amazon.com/datasync/latest/userguide/create-fsx-location.html#create-fsx-windows-location-permissions>`_ for FSx for Windows File Server locations.\n')
    ...
    password: typing.Optional[str] = pydantic.Field(None, description='Specifies the password of the user who has the permissions to access files and folders in the file system. For more information, see `required permissions <https://docs.aws.amazon.com/datasync/latest/userguide/create-fsx-location.html#create-fsx-windows-location-permissions>`_ for FSx for Windows File Server locations.\n')
...
class CfnLocationSMBDef(BaseCfnResource):
    ...
    domain: typing.Optional[str] = pydantic.Field(None, description='Specifies the Windows domain name that your SMB file server belongs to. If you have multiple domains in your environment, configuring this parameter makes sure that DataSync connects to the right file server. For more information, see `required permissions <https://docs.aws.amazon.com/datasync/latest/userguide/create-smb-location.html#configuring-smb-permissions>`_ for SMB locations.\n')
...
class CfnTaskDef(BaseCfnResource):
    ...
    source_location_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Amazon Resource Name (ARN) of the source location for the task.\n')
    ...
    excludes: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_datasync.CfnTask_FilterRulePropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='Specifies a list of filter rules that exclude specific data during your transfer. For more information and examples, see `Filtering data transferred by DataSync <https://docs.aws.amazon.com/datasync/latest/userguide/filtering.html>`_ .\n')
    includes: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_datasync.CfnTask_FilterRulePropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='Specifies a list of filter rules that include specific data during your transfer. For more information and examples, see `Filtering data transferred by DataSync <https://docs.aws.amazon.com/datasync/latest/userguide/filtering.html>`_ .\n')
    ...
    task_report_config: typing.Union[models.UnsupportedResource, models.aws_datasync.CfnTask_TaskReportConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Specifies how you want to configure a task report, which provides detailed information about for your DataSync transfer.')
    _init_params: typing.ClassVar[list[str]] = ['destination_location_arn', 'source_location_arn', 'cloud_watch_log_group_arn', 'excludes', 'includes', 'name', 'options', 'schedule', 'tags', 'task_report_config']
    _method_names: typing.ClassVar[list[str]] = ['DeletedProperty', 'DestinationProperty', 'FilterRuleProperty', 'OptionsProperty', 'OverridesProperty', 'S3Property', 'SkippedProperty', 'TaskReportConfigProperty', 'TaskScheduleProperty', 'TransferredProperty', 'VerifiedProperty', 'add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnTaskDefConfig(pydantic.BaseModel):
    DeletedProperty: typing.Optional[list[CfnTaskDefDeletedpropertyParams]] = pydantic.Field(None, description='')
    DestinationProperty: typing.Optional[list[CfnTaskDefDestinationpropertyParams]] = pydantic.Field(None, description='')
    ...
    OverridesProperty: typing.Optional[list[CfnTaskDefOverridespropertyParams]] = pydantic.Field(None, description='')
    S3Property: typing.Optional[list[CfnTaskDefS3PropertyParams]] = pydantic.Field(None, description='')
    SkippedProperty: typing.Optional[list[CfnTaskDefSkippedpropertyParams]] = pydantic.Field(None, description='')
    TaskReportConfigProperty: typing.Optional[list[CfnTaskDefTaskreportconfigpropertyParams]] = pydantic.Field(None, description='')
    TaskScheduleProperty: typing.Optional[list[CfnTaskDefTaskschedulepropertyParams]] = pydantic.Field(None, description='')
    TransferredProperty: typing.Optional[list[CfnTaskDefTransferredpropertyParams]] = pydantic.Field(None, description='')
    VerifiedProperty: typing.Optional[list[CfnTaskDefVerifiedpropertyParams]] = pydantic.Field(None, description='')
...
class ModuleModel(pydantic.BaseModel):
    CfnLocationAzureBlob_AzureBlobSasConfigurationProperty: typing.Optional[dict[str, CfnLocationAzureBlob_AzureBlobSasConfigurationPropertyDef]] = pydantic.Field(None)
    ...
    CfnTask_DeletedProperty: typing.Optional[dict[str, CfnTask_DeletedPropertyDef]] = pydantic.Field(None)
    CfnTask_DestinationProperty: typing.Optional[dict[str, CfnTask_DestinationPropertyDef]] = pydantic.Field(None)
    ...
    CfnTask_OverridesProperty: typing.Optional[dict[str, CfnTask_OverridesPropertyDef]] = pydantic.Field(None)
    CfnTask_S3Property: typing.Optional[dict[str, CfnTask_S3PropertyDef]] = pydantic.Field(None)
    CfnTask_SkippedProperty: typing.Optional[dict[str, CfnTask_SkippedPropertyDef]] = pydantic.Field(None)
    CfnTask_TaskReportConfigProperty: typing.Optional[dict[str, CfnTask_TaskReportConfigPropertyDef]] = pydantic.Field(None)
    CfnTask_TaskScheduleProperty: typing.Optional[dict[str, CfnTask_TaskSchedulePropertyDef]] = pydantic.Field(None)
    CfnTask_TransferredProperty: typing.Optional[dict[str, CfnTask_TransferredPropertyDef]] = pydantic.Field(None)
    CfnTask_VerifiedProperty: typing.Optional[dict[str, CfnTask_VerifiedPropertyDef]] = pydantic.Field(None)
    CfnAgent: typing.Optional[dict[str, CfnAgentDef]] = pydantic.Field(None)
    CfnLocationAzureBlob: typing.Optional[dict[str, CfnLocationAzureBlobDef]] = pydantic.Field(None)
    ...
    CfnLocationAzureBlobProps: typing.Optional[dict[str, CfnLocationAzureBlobPropsDef]] = pydantic.Field(None)
