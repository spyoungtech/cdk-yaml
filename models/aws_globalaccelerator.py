...
class RawEndpointDef(BaseClass):
    endpoint_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Identifier of the endpoint. Load balancer ARN, instance ID or EIP allocation ID.')
...
class AcceleratorDefFromAcceleratorAttributesParams(pydantic.BaseModel):
    ...
    dual_stack_dns_name: typing.Optional[str] = pydantic.Field(None, description="The DNS name that points to the dual-stack accelerator's four static IP addresses: two IPv4 addresses and two IPv6 addresses. Default: - undefined\n")
    ipv4_addresses: typing.Optional[typing.Sequence[str]] = pydantic.Field(None, description='The array of IPv4 addresses in the IP address set. Default: - undefined\n')
    ipv6_addresses: typing.Optional[typing.Sequence[str]] = pydantic.Field(None, description='The array of IPv6 addresses in the IP address set. Default: - undefined')
    ...


#  autogenerated from aws_cdk.aws_globalaccelerator.EndpointGroup
class EndpointGroupDef(BaseConstruct):
    listener: typing.Union[_REQUIRED_INIT_PARAM, models.aws_globalaccelerator.ListenerDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Amazon Resource Name (ARN) of the listener.\n')
...
class ListenerDef(BaseConstruct):
    accelerator: typing.Union[_REQUIRED_INIT_PARAM, models.aws_globalaccelerator.AcceleratorDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The accelerator for this listener.\n')
    port_ranges: typing.Union[typing.Sequence[typing.Union[models.aws_globalaccelerator.PortRangeDef, dict[str, typing.Any]]], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The list of port ranges for the connections from clients to the accelerator.\n')
    client_affinity: typing.Optional[aws_cdk.aws_globalaccelerator.ClientAffinity] = pydantic.Field(None, description='Client affinity to direct all requests from a user to the same endpoint. If you have stateful applications, client affinity lets you direct all requests from a user to the same endpoint. By default, each connection from each client is routed to seperate endpoints. Set client affinity to SOURCE_IP to route all connections from a single client to the same endpoint. Default: ClientAffinity.NONE\n')
    listener_name: typing.Optional[str] = pydantic.Field(None, description='Name of the listener. Default: - logical ID of the resource\n')
    protocol: typing.Optional[aws_cdk.aws_globalaccelerator.ConnectionProtocol] = pydantic.Field(None, description='The protocol for the connections from clients to the accelerator. Default: ConnectionProtocol.TCP')
...
class AcceleratorAttributesDef(BaseStruct):
    accelerator_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The ARN of the accelerator.\n')
    dns_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The DNS name of the accelerator.\n')
    dual_stack_dns_name: typing.Optional[str] = pydantic.Field(None, description="The DNS name that points to the dual-stack accelerator's four static IP addresses: two IPv4 addresses and two IPv6 addresses. Default: - undefined\n")
    ipv4_addresses: typing.Optional[typing.Sequence[str]] = pydantic.Field(None, description='The array of IPv4 addresses in the IP address set. Default: - undefined\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['accelerator_arn', 'dns_name', 'dual_stack_dns_name', 'ipv4_addresses', 'ipv6_addresses']
...
#  autogenerated from aws_cdk.aws_globalaccelerator.CfnCrossAccountAttachment.ResourceProperty
class CfnCrossAccountAttachment_ResourcePropertyDef(BaseStruct):
    endpoint_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The endpoint ID for the endpoint that is specified as a AWS resource. An endpoint ID for the cross-account feature is the ARN of an AWS resource, such as a Network Load Balancer, that Global Accelerator supports as an endpoint for an accelerator.\n')
    region: typing.Optional[str] = pydantic.Field(None, description='The AWS Region where a shared endpoint resource is located.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-globalaccelerator-crossaccountattachment-resource.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_globalaccelerator as globalaccelerator\n\n    resource_property = globalaccelerator.CfnCrossAccountAttachment.ResourceProperty(\n        endpoint_id="endpointId",\n\n        # the properties below are optional\n        region="region"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['endpoint_id', 'region']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_globalaccelerator.CfnCrossAccountAttachment.ResourceProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class CfnEndpointGroup_EndpointConfigurationPropertyDef(BaseStruct):
    endpoint_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='An ID for the endpoint. If the endpoint is a Network Load Balancer or Application Load Balancer, this is the Amazon Resource Name (ARN) of the resource. If the endpoint is an Elastic IP address, this is the Elastic IP address allocation ID. For Amazon EC2 instances, this is the EC2 instance ID. A resource must be valid and active when you add it as an endpoint. For cross-account endpoints, this must be the ARN of the resource.\n')
    attachment_arn: typing.Optional[str] = pydantic.Field(None, description='The Amazon Resource Name (ARN) of the cross-account attachment that specifies the endpoints (resources) that can be added to accelerators and principals that have permission to add the endpoints.\n')
    client_ip_preservation_enabled: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description="Indicates whether client IP address preservation is enabled for an Application Load Balancer endpoint. The value is true or false. The default value is true for new accelerators. If the value is set to true, the client's IP address is preserved in the ``X-Forwarded-For`` request header as traffic travels to applications on the Application Load Balancer endpoint fronted by the accelerator. For more information, see `Preserve Client IP Addresses <https://docs.aws.amazon.com/global-accelerator/latest/dg/preserve-client-ip-address.html>`_ in the *AWS Global Accelerator Developer Guide* . Default: - true\n")
    ...
    _init_params: typing.ClassVar[list[str]] = ['endpoint_id', 'attachment_arn', 'client_ip_preservation_enabled', 'weight']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnEndpointGroup_PortOverridePropertyDef(BaseStruct):
    endpoint_port: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The endpoint port that you want a listener port to be mapped to. This is the port on the endpoint, such as the Application Load Balancer or Amazon EC2 instance.\n')
    listener_port: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The listener port that you want to map to a specific endpoint port. This is the port that user traffic arrives to the Global Accelerator on.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-globalaccelerator-endpointgroup-portoverride.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_globalaccelerator as globalaccelerator\n\n    port_override_property = globalaccelerator.CfnEndpointGroup.PortOverrideProperty(\n        endpoint_port=123,\n        listener_port=123\n    )\n')
...
class CfnListener_PortRangePropertyDef(BaseStruct):
    from_port: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The first port in the range of ports, inclusive.\n')
    to_port: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The last port in the range of ports, inclusive.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-globalaccelerator-listener-portrange.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_globalaccelerator as globalaccelerator\n\n    port_range_property = globalaccelerator.CfnListener.PortRangeProperty(\n        from_port=123,\n        to_port=123\n    )\n')
...
#  autogenerated from aws_cdk.aws_globalaccelerator.IpAddressType
# skipping emum
...
class CfnAcceleratorDef(BaseCfnResource):
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the accelerator. The name must contain only alphanumeric characters or hyphens (-), and must not begin or end with a hyphen.\n')
    enabled: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='Indicates whether the accelerator is enabled. The value is true or false. The default value is true. If the value is set to true, the accelerator cannot be deleted. If set to false, accelerator can be deleted. Default: - true\n')
    ...
    ip_address_type: typing.Optional[str] = pydantic.Field(None, description='The IP address type that an accelerator supports. For a standard accelerator, the value can be IPV4 or DUAL_STACK. Default: - "IPV4"\n')
...
#  autogenerated from aws_cdk.aws_globalaccelerator.CfnCrossAccountAttachment
class CfnCrossAccountAttachmentDef(BaseCfnResource):
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the cross-account attachment.\n')
    principals: typing.Optional[typing.Sequence[str]] = pydantic.Field(None, description='The principals included in the cross-account attachment.\n')
    resources: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_globalaccelerator.CfnCrossAccountAttachment_ResourcePropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The resources included in the cross-account attachment.\n')
    tags: typing.Optional[typing.Sequence[typing.Union[models.CfnTagDef, dict[str, typing.Any]]]] = pydantic.Field(None, description='Add tags for a cross-account attachment. For more information, see `Tagging in AWS Global Accelerator <https://docs.aws.amazon.com/global-accelerator/latest/dg/tagging-in-global-accelerator.html>`_ in the *AWS Global Accelerator Developer Guide* .')
    _init_params: typing.ClassVar[list[str]] = ['name', 'principals', 'resources', 'tags']
    _method_names: typing.ClassVar[list[str]] = ['ResourceProperty', 'add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_globalaccelerator.CfnCrossAccountAttachment'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...


    resource_config: typing.Optional[models.aws_globalaccelerator.CfnCrossAccountAttachmentDefConfig] = pydantic.Field(None)


class CfnCrossAccountAttachmentDefConfig(pydantic.BaseModel):
    ResourceProperty: typing.Optional[list[models.aws_globalaccelerator.CfnCrossAccountAttachmentDefResourcepropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_globalaccelerator.CfnCrossAccountAttachmentDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_globalaccelerator.CfnCrossAccountAttachmentDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_globalaccelerator.CfnCrossAccountAttachmentDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_globalaccelerator.CfnCrossAccountAttachmentDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_globalaccelerator.CfnCrossAccountAttachmentDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_globalaccelerator.CfnCrossAccountAttachmentDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_globalaccelerator.CfnCrossAccountAttachmentDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_globalaccelerator.CfnCrossAccountAttachmentDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_globalaccelerator.CfnCrossAccountAttachmentDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_globalaccelerator.CfnCrossAccountAttachmentDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_globalaccelerator.CfnCrossAccountAttachmentDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_globalaccelerator.CfnCrossAccountAttachmentDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_globalaccelerator.CfnCrossAccountAttachmentDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
    cdk_tag_manager_config: typing.Optional[models.core.TagManagerDefConfig] = pydantic.Field(None)

class CfnCrossAccountAttachmentDefResourcepropertyParams(pydantic.BaseModel):
    endpoint_id: str = pydantic.Field(..., description='')
    region: typing.Optional[str] = pydantic.Field(None, description='')
    ...

class CfnCrossAccountAttachmentDefAddDeletionOverrideParams(pydantic.BaseModel):
    path: str = pydantic.Field(..., description='The path of the value to delete.')
    ...

class CfnCrossAccountAttachmentDefAddDependencyParams(pydantic.BaseModel):
    target: models.CfnResourceDef = pydantic.Field(..., description='-')
    ...

class CfnCrossAccountAttachmentDefAddDependsOnParams(pydantic.BaseModel):
    target: models.CfnResourceDef = pydantic.Field(..., description='-\n\n:deprecated: use addDependency\n\n:stability: deprecated\n')
    ...

class CfnCrossAccountAttachmentDefAddMetadataParams(pydantic.BaseModel):
    key: str = pydantic.Field(..., description='-\n')
    value: typing.Any = pydantic.Field(..., description='-\n\n:see:\n\nhttps://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/metadata-section-structure.html\n\nNote that this is a different set of metadata from CDK node metadata; this\nmetadata ends up in the stack template under the resource, whereas CDK\nnode metadata ends up in the Cloud Assembly.\n')
    ...

class CfnCrossAccountAttachmentDefAddOverrideParams(pydantic.BaseModel):
    path: str = pydantic.Field(..., description='- The path of the property, you can use dot notation to override values in complex types. Any intermediate keys will be created as needed.\n')
    value: typing.Any = pydantic.Field(..., description='- The value. Could be primitive or complex.')
    ...

class CfnCrossAccountAttachmentDefAddPropertyDeletionOverrideParams(pydantic.BaseModel):
    property_path: str = pydantic.Field(..., description='The path to the property.')
    ...

class CfnCrossAccountAttachmentDefAddPropertyOverrideParams(pydantic.BaseModel):
    property_path: str = pydantic.Field(..., description='The path of the property.\n')
    value: typing.Any = pydantic.Field(..., description='The value.')
    ...

class CfnCrossAccountAttachmentDefApplyRemovalPolicyParams(pydantic.BaseModel):
    policy: typing.Optional[aws_cdk.RemovalPolicy] = pydantic.Field(None, description='-\n')
    apply_to_update_replace_policy: typing.Optional[bool] = pydantic.Field(None, description='Apply the same deletion policy to the resource\'s "UpdateReplacePolicy". Default: true\n')
    default: typing.Optional[aws_cdk.RemovalPolicy] = pydantic.Field(None, description="The default policy to apply in case the removal policy is not defined. Default: - Default value is resource specific. To determine the default value for a resource, please consult that specific resource's documentation.\n\n:see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-deletionpolicy.html#aws-attribute-deletionpolicy-options\n")
    ...

class CfnCrossAccountAttachmentDefGetAttParams(pydantic.BaseModel):
    attribute_name: str = pydantic.Field(..., description='The name of the attribute.\n')
    type_hint: typing.Optional[aws_cdk.ResolutionTypeHint] = pydantic.Field(None, description='-')
    return_config: typing.Optional[list[models.core.ReferenceDefConfig]] = pydantic.Field(None)
    ...

class CfnCrossAccountAttachmentDefGetMetadataParams(pydantic.BaseModel):
    key: str = pydantic.Field(..., description='-\n\n:see:\n\nhttps://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/metadata-section-structure.html\n\nNote that this is a different set of metadata from CDK node metadata; this\nmetadata ends up in the stack template under the resource, whereas CDK\nnode metadata ends up in the Cloud Assembly.\n')
    ...

class CfnCrossAccountAttachmentDefInspectParams(pydantic.BaseModel):
    inspector: models.TreeInspectorDef = pydantic.Field(..., description='tree inspector to collect and process attributes.')
    ...

class CfnCrossAccountAttachmentDefOverrideLogicalIdParams(pydantic.BaseModel):
    new_logical_id: str = pydantic.Field(..., description='The new logical ID to use for this stack element.')
    ...

class CfnCrossAccountAttachmentDefRemoveDependencyParams(pydantic.BaseModel):
    target: models.CfnResourceDef = pydantic.Field(..., description='-')
    ...

class CfnCrossAccountAttachmentDefReplaceDependencyParams(pydantic.BaseModel):
    target: models.CfnResourceDef = pydantic.Field(..., description='The dependency to replace.\n')
    new_target: models.CfnResourceDef = pydantic.Field(..., description='The new dependency to add.')
    ...
...
class CfnEndpointGroupDef(BaseCfnResource):
    endpoint_group_region: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The AWS Regions where the endpoint group is located.\n')
    ...
    endpoint_configurations: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_globalaccelerator.CfnEndpointGroup_EndpointConfigurationPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The list of endpoint objects.\n')
    health_check_interval_seconds: typing.Union[int, float, None] = pydantic.Field(None, description='The time—10 seconds or 30 seconds—between health checks for each endpoint. The default value is 30. Default: - 30\n')
    health_check_path: typing.Optional[str] = pydantic.Field(None, description='If the protocol is HTTP/S, then this value provides the ping path that Global Accelerator uses for the destination on the endpoints for health checks. The default is slash (/). Default: - "/"\n')
    ...
    health_check_protocol: typing.Optional[str] = pydantic.Field(None, description='The protocol that Global Accelerator uses to perform health checks on endpoints that are part of this endpoint group. The default value is TCP. Default: - "TCP"\n')
    port_overrides: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_globalaccelerator.CfnEndpointGroup_PortOverridePropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='Allows you to override the destination ports used to route traffic to an endpoint. Using a port override lets you map a list of external destination ports (that your users send traffic to) to a list of internal destination ports that you want an application endpoint to receive traffic on.\n')
    threshold_count: typing.Union[int, float, None] = pydantic.Field(None, description='The number of consecutive health checks required to set the state of a healthy endpoint to unhealthy, or to set an unhealthy endpoint to healthy. The default value is 3. Default: - 3\n')
...
class CfnEndpointGroupDefEndpointconfigurationpropertyParams(pydantic.BaseModel):
    endpoint_id: str = pydantic.Field(..., description='')
    attachment_arn: typing.Optional[str] = pydantic.Field(None, description='')
    client_ip_preservation_enabled: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
...
class CfnListenerDef(BaseCfnResource):
    accelerator_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Amazon Resource Name (ARN) of your accelerator.\n')
    port_ranges: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_globalaccelerator.CfnListener_PortRangePropertyDef, dict[str, typing.Any]]]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The list of port ranges for the connections from clients to the accelerator.\n')
    protocol: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The protocol for the connections from clients to the accelerator. Default: - "TCP"\n')
...
#  autogenerated from aws_cdk.aws_globalaccelerator.CfnCrossAccountAttachmentProps
class CfnCrossAccountAttachmentPropsDef(BaseCfnProperty):
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the cross-account attachment.\n')
    principals: typing.Optional[typing.Sequence[str]] = pydantic.Field(None, description='The principals included in the cross-account attachment.\n')
    resources: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_globalaccelerator.CfnCrossAccountAttachment_ResourcePropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The resources included in the cross-account attachment.\n')
    ...
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_globalaccelerator.CfnCrossAccountAttachmentProps'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class ModuleModel(pydantic.BaseModel):
    ...
    CfnCrossAccountAttachment_ResourceProperty: typing.Optional[dict[str, models.aws_globalaccelerator.CfnCrossAccountAttachment_ResourcePropertyDef]] = pydantic.Field(None)
    ...
    CfnCrossAccountAttachment: typing.Optional[dict[str, models.aws_globalaccelerator.CfnCrossAccountAttachmentDef]] = pydantic.Field(None)
    ...
    CfnCrossAccountAttachmentProps: typing.Optional[dict[str, models.aws_globalaccelerator.CfnCrossAccountAttachmentPropsDef]] = pydantic.Field(None)
