...
class CfnCustomLineItemDefConfig(pydantic.BaseModel):
    ...
    LineItemFilterProperty: typing.Optional[list[CfnCustomLineItemDefLineitemfilterpropertyParams]] = pydantic.Field(None, description='')
...
class ModuleModel(pydantic.BaseModel):
    ...
    CfnCustomLineItem_LineItemFilterProperty: typing.Optional[dict[str, CfnCustomLineItem_LineItemFilterPropertyDef]] = pydantic.Field(None)
