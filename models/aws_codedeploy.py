...
class EcsDeploymentGroupDef(BaseConstruct):
    ...
    ignore_alarm_configuration: typing.Optional[bool] = pydantic.Field(None, description='Whether to skip the step of checking CloudWatch alarms during the deployment process. Default: - false\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['blue_green_deployment_config', 'service', 'alarms', 'application', 'auto_rollback', 'deployment_config', 'deployment_group_name', 'ignore_alarm_configuration', 'ignore_poll_alarms_failure', 'role']
...
class LambdaDeploymentGroupDef(BaseConstruct):
    ...
    role: typing.Optional[typing.Union[models.aws_iam.LazyRoleDef, models.aws_iam.RoleDef]] = pydantic.Field(None, description='The service Role of this Deployment Group. Default: - A new Role will be created.')
    _init_params: typing.ClassVar[list[str]] = ['alias', 'alarms', 'application', 'auto_rollback', 'deployment_config', 'deployment_group_name', 'ignore_alarm_configuration', 'ignore_poll_alarms_failure', 'post_hook', 'pre_hook', 'role']
...
class ServerDeploymentGroupDef(BaseConstruct):
    ...
    role: typing.Optional[typing.Union[models.aws_iam.LazyRoleDef, models.aws_iam.RoleDef]] = pydantic.Field(None, description='The service Role of this Deployment Group. Default: - A new Role will be created.\n')
    termination_hook: typing.Optional[bool] = pydantic.Field(None, description='Indicates whether the deployment group was configured to have CodeDeploy install a termination hook into an Auto Scaling group. Default: - false')
    _init_params: typing.ClassVar[list[str]] = ['alarms', 'application', 'auto_rollback', 'auto_scaling_groups', 'deployment_config', 'deployment_group_name', 'ec2_instance_tags', 'ignore_alarm_configuration', 'ignore_poll_alarms_failure', 'install_agent', 'load_balancer', 'load_balancers', 'on_premise_instance_tags', 'role', 'termination_hook']
...
#  autogenerated from aws_cdk.aws_codedeploy.CfnDeploymentConfig.MinimumHealthyHostsPerZoneProperty
class CfnDeploymentConfig_MinimumHealthyHostsPerZonePropertyDef(BaseStruct):
    type: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The ``type`` associated with the ``MinimumHealthyHostsPerZone`` option.\n')
    value: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The ``value`` associated with the ``MinimumHealthyHostsPerZone`` option.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-codedeploy-deploymentconfig-minimumhealthyhostsperzone.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_codedeploy as codedeploy\n\n    minimum_healthy_hosts_per_zone_property = codedeploy.CfnDeploymentConfig.MinimumHealthyHostsPerZoneProperty(\n        type="type",\n        value=123\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['type', 'value']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_codedeploy.CfnDeploymentConfig.MinimumHealthyHostsPerZoneProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
#  autogenerated from aws_cdk.aws_codedeploy.CfnDeploymentConfig.ZonalConfigProperty
class CfnDeploymentConfig_ZonalConfigPropertyDef(BaseStruct):
...
class CfnDeploymentConfigDef(BaseCfnResource):
    ...
    zonal_config: typing.Union[models.UnsupportedResource, models.aws_codedeploy.CfnDeploymentConfig_ZonalConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Configure the ``ZonalConfig`` object if you want AWS CodeDeploy to deploy your application to one `Availability Zone <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-regions-availability-zones.html#concepts-availability-zones>`_ at a time, within an AWS Region. For more information about the zonal configuration feature, see `zonal configuration <https://docs.aws.amazon.com/codedeploy/latest/userguide/deployment-configurations-create.html#zonal-config>`_ in the *CodeDeploy User Guide* .')
    _init_params: typing.ClassVar[list[str]] = ['compute_platform', 'deployment_config_name', 'minimum_healthy_hosts', 'traffic_routing_config', 'zonal_config']
    _method_names: typing.ClassVar[list[str]] = ['MinimumHealthyHostsPerZoneProperty', 'MinimumHealthyHostsProperty', 'TimeBasedCanaryProperty', 'TimeBasedLinearProperty', 'TrafficRoutingConfigProperty', 'ZonalConfigProperty', 'add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnDeploymentConfigDefConfig(pydantic.BaseModel):
    MinimumHealthyHostsPerZoneProperty: typing.Optional[list[models.aws_codedeploy.CfnDeploymentConfigDefMinimumhealthyhostsperzonepropertyParams]] = pydantic.Field(None, description='')
    ...
    ZonalConfigProperty: typing.Optional[list[models.aws_codedeploy.CfnDeploymentConfigDefZonalconfigpropertyParams]] = pydantic.Field(None, description='')
...
class CfnDeploymentConfigDefMinimumhealthyhostsperzonepropertyParams(pydantic.BaseModel):
...
class CfnDeploymentConfigDefZonalconfigpropertyParams(pydantic.BaseModel):
    first_zone_monitor_duration_in_seconds: typing.Union[int, float, None] = pydantic.Field(None, description='')
    minimum_healthy_hosts_per_zone: typing.Union[models.UnsupportedResource, models.aws_codedeploy.CfnDeploymentConfig_MinimumHealthyHostsPerZonePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    monitor_duration_in_seconds: typing.Union[int, float, None] = pydantic.Field(None, description='')
    ...
...
class ModuleModel(pydantic.BaseModel):
    ...
    CfnDeploymentConfig_MinimumHealthyHostsPerZoneProperty: typing.Optional[dict[str, models.aws_codedeploy.CfnDeploymentConfig_MinimumHealthyHostsPerZonePropertyDef]] = pydantic.Field(None)
    ...
    CfnDeploymentConfig_ZonalConfigProperty: typing.Optional[dict[str, models.aws_codedeploy.CfnDeploymentConfig_ZonalConfigPropertyDef]] = pydantic.Field(None)
