...
class BaseScalableAttributeDef(BaseClass):
    dimension: str = pydantic.Field(..., description='Scalable dimension of the attribute.\n')
    resource_id: str = pydantic.Field(..., description='Resource ID of the attribute.\n')
    role: typing.Union[models.aws_iam.LazyRoleDef, models.aws_iam.RoleDef] = pydantic.Field(..., description='Role to use for scaling.\n')
    service_namespace: aws_cdk.aws_applicationautoscaling.ServiceNamespace = pydantic.Field(..., description='Service namespace of the scalable attribute.\n')
...
class ScheduleDefConfig(pydantic.BaseModel):
    at: typing.Optional[list[ScheduleDefAtParams]] = pydantic.Field(None, description='Construct a Schedule from a moment in time.')
...
class ScalableTargetDef(BaseConstruct):
    max_capacity: typing.Union[int, float] = pydantic.Field(..., description='The maximum value that Application Auto Scaling can use to scale a target during a scaling activity.\n')
    min_capacity: typing.Union[int, float] = pydantic.Field(..., description='The minimum value that Application Auto Scaling can use to scale a target during a scaling activity.\n')
    resource_id: str = pydantic.Field(..., description='The resource identifier to associate with this scalable target. This string consists of the resource type and unique identifier. Example value: ``service/ecsStack-MyECSCluster-AB12CDE3F4GH/ecsStack-MyECSService-AB12CDE3F4GH``\n')
    scalable_dimension: str = pydantic.Field(..., description="The scalable dimension that's associated with the scalable target. Specify the service namespace, resource type, and scaling property. Example value: ``ecs:service:DesiredCount``\n")
    service_namespace: aws_cdk.aws_applicationautoscaling.ServiceNamespace = pydantic.Field(..., description='The namespace of the AWS service that provides the resource or custom-resource for a resource provided by your own application or service. For valid AWS service namespace values, see the RegisterScalableTarget action in the Application Auto Scaling API Reference.\n')
    ...
    from_scalable_target_id: typing.Optional[ScalableTargetDefFromScalableTargetIdParams] = pydantic.Field(None, description='')
    resource_config: typing.Optional[ScalableTargetDefConfig] = pydantic.Field(None)


class ScalableTargetDefConfig(pydantic.BaseModel):
    add_to_role_policy: typing.Optional[list[ScalableTargetDefAddToRolePolicyParams]] = pydantic.Field(None, description="Add a policy statement to the role's policy.")
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    scale_on_metric: typing.Optional[list[ScalableTargetDefScaleOnMetricParams]] = pydantic.Field(None, description='Scale out or in, in response to a metric.')
    scale_on_schedule: typing.Optional[list[ScalableTargetDefScaleOnScheduleParams]] = pydantic.Field(None, description='Scale out or in based on time.')
    scale_to_track_metric: typing.Optional[list[ScalableTargetDefScaleToTrackMetricParams]] = pydantic.Field(None, description='Scale out or in in order to keep a metric around a target value.')
...
class ScalableTargetDefScaleOnMetricParams(pydantic.BaseModel):
    ...
    scaling_steps: typing.Sequence[typing.Union[models.aws_applicationautoscaling.ScalingIntervalDef, dict[str, typing.Any]]] = pydantic.Field(..., description='The intervals for scaling. Maps a range of metric values to a particular scaling behavior.\n')
...
class StepScalingActionDef(BaseConstruct):
    scaling_target: typing.Union[models.aws_applicationautoscaling.ScalableTargetDef] = pydantic.Field(..., description='The scalable target.\n')
...
class StepScalingPolicyDef(BaseConstruct):
    scaling_target: typing.Union[models.aws_applicationautoscaling.ScalableTargetDef] = pydantic.Field(..., description='The scaling target.\n')
    metric: typing.Union[models.aws_cloudwatch.MathExpressionDef, models.aws_cloudwatch.MetricDef] = pydantic.Field(..., description='Metric to scale on.\n')
    scaling_steps: typing.Sequence[typing.Union[models.aws_applicationautoscaling.ScalingIntervalDef, dict[str, typing.Any]]] = pydantic.Field(..., description='The intervals for scaling. Maps a range of metric values to a particular scaling behavior.\n')
    adjustment_type: typing.Optional[aws_cdk.aws_applicationautoscaling.AdjustmentType] = pydantic.Field(None, description="How the adjustment numbers inside 'intervals' are interpreted. Default: ChangeInCapacity\n")
    cooldown: typing.Optional[models.DurationDef] = pydantic.Field(None, description='Grace period after scaling activity. Subsequent scale outs during the cooldown period are squashed so that only the biggest scale out happens. Subsequent scale ins during the cooldown period are ignored. Default: No cooldown period\n')
...
class TargetTrackingScalingPolicyDef(BaseConstruct):
    scaling_target: typing.Union[models.aws_applicationautoscaling.ScalableTargetDef] = pydantic.Field(..., description='')
    target_value: typing.Union[int, float] = pydantic.Field(..., description='The target value for the metric.\n')
    custom_metric: typing.Optional[typing.Union[models.aws_cloudwatch.MathExpressionDef, models.aws_cloudwatch.MetricDef]] = pydantic.Field(None, description='A custom metric for application autoscaling. The metric must track utilization. Scaling out will happen if the metric is higher than the target value, scaling in will happen in the metric is lower than the target value. Exactly one of customMetric or predefinedMetric must be specified. Default: - No custom metric.\n')
    predefined_metric: typing.Optional[aws_cdk.aws_applicationautoscaling.PredefinedMetric] = pydantic.Field(None, description='A predefined metric for application autoscaling. The metric must track utilization. Scaling out will happen if the metric is higher than the target value, scaling in will happen in the metric is lower than the target value. Exactly one of customMetric or predefinedMetric must be specified. Default: - No predefined metrics.\n')
    resource_label: typing.Optional[str] = pydantic.Field(None, description='Identify the resource associated with the metric type. Only used for predefined metric ALBRequestCountPerTarget. Example value: ``app/<load-balancer-name>/<load-balancer-id>/targetgroup/<target-group-name>/<target-group-id>`` Default: - No resource label.\n')
...
class BaseScalableAttributePropsDef(BaseStruct):
    ...
    resource_config: typing.Optional[BaseScalableAttributePropsDefConfig] = pydantic.Field(None)
...
class CfnScalableTarget_ScheduledActionPropertyDef(BaseStruct):
    schedule: str = pydantic.Field(..., description='The schedule for this action. The following formats are supported:. - At expressions - " ``at( *yyyy* - *mm* - *dd* T *hh* : *mm* : *ss* )`` " - Rate expressions - " ``rate( *value* *unit* )`` " - Cron expressions - " ``cron( *fields* )`` " At expressions are useful for one-time schedules. Cron expressions are useful for scheduled actions that run periodically at a specified date and time, and rate expressions are useful for scheduled actions that run at a regular interval. At and cron expressions use Universal Coordinated Time (UTC) by default. The cron format consists of six fields separated by white spaces: [Minutes] [Hours] [Day_of_Month] [Month] [Day_of_Week] [Year]. For rate expressions, *value* is a positive integer and *unit* is ``minute`` | ``minutes`` | ``hour`` | ``hours`` | ``day`` | ``days`` .\n')
    scheduled_action_name: str = pydantic.Field(..., description='The name of the scheduled action. This name must be unique among all other scheduled actions on the specified scalable target.\n')
    end_time: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], datetime.datetime, None] = pydantic.Field(None, description='The date and time that the action is scheduled to end, in UTC.\n')
    scalable_target_action: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_applicationautoscaling.CfnScalableTarget_ScalableTargetActionPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The new minimum and maximum capacity. You can set both values or just one. At the scheduled time, if the current capacity is below the minimum capacity, Application Auto Scaling scales out to the minimum capacity. If the current capacity is above the maximum capacity, Application Auto Scaling scales in to the maximum capacity.\n')
...
class CfnScalableTarget_SuspendedStatePropertyDef(BaseStruct):
    dynamic_scaling_in_suspended: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description="Whether scale in by a target tracking scaling policy or a step scaling policy is suspended. Set the value to ``true`` if you don't want Application Auto Scaling to remove capacity when a scaling policy is triggered. The default is ``false`` .\n")
    dynamic_scaling_out_suspended: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description="Whether scale out by a target tracking scaling policy or a step scaling policy is suspended. Set the value to ``true`` if you don't want Application Auto Scaling to add capacity when a scaling policy is triggered. The default is ``false`` .\n")
    scheduled_scaling_suspended: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description="Whether scheduled scaling is suspended. Set the value to ``true`` if you don't want Application Auto Scaling to add or remove capacity by initiating scheduled actions. The default is ``false`` .\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-applicationautoscaling-scalabletarget-suspendedstate.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_applicationautoscaling as appscaling\n\n    suspended_state_property = appscaling.CfnScalableTarget.SuspendedStateProperty(\n        dynamic_scaling_in_suspended=False,\n        dynamic_scaling_out_suspended=False,\n        scheduled_scaling_suspended=False\n    )\n")
...
class CfnScalingPolicy_PredefinedMetricSpecificationPropertyDef(BaseStruct):
    predefined_metric_type: str = pydantic.Field(..., description='The metric type. The ``ALBRequestCountPerTarget`` metric type applies only to Spot fleet requests and ECS services.\n')
...
class CfnScalingPolicy_StepAdjustmentPropertyDef(BaseStruct):
    scaling_adjustment: typing.Union[int, float] = pydantic.Field(..., description='The amount by which to scale. The adjustment is based on the value that you specified in the ``AdjustmentType`` property (either an absolute number or a percentage). A positive value adds to the current capacity and a negative number subtracts from the current capacity.\n')
...
class CfnScalingPolicy_TargetTrackingScalingPolicyConfigurationPropertyDef(BaseStruct):
    target_value: typing.Union[int, float] = pydantic.Field(..., description="The target value for the metric. Although this property accepts numbers of type Double, it won't accept values that are either too small or too large. Values must be in the range of -2^360 to 2^360. The value must be a valid number based on the choice of metric. For example, if the metric is CPU utilization, then the target value is a percent value that represents how much of the CPU can be used before scaling out.\n")
...
class CfnScalableTargetDef(BaseCfnResource):
    ...
    _init_params: typing.ClassVar[list[str]] = ['max_capacity', 'min_capacity', 'resource_id', 'role_arn', 'scalable_dimension', 'service_namespace', 'scheduled_actions', 'suspended_state']
    ...
    resource_config: typing.Optional[CfnScalableTargetDefConfig] = pydantic.Field(None)


class CfnScalableTargetDefConfig(pydantic.BaseModel):
    ScalableTargetActionProperty: typing.Optional[list[CfnScalableTargetDefScalabletargetactionpropertyParams]] = pydantic.Field(None, description='')
    ScheduledActionProperty: typing.Optional[list[CfnScalableTargetDefScheduledactionpropertyParams]] = pydantic.Field(None, description='')
    SuspendedStateProperty: typing.Optional[list[CfnScalableTargetDefSuspendedstatepropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[CfnScalableTargetDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[CfnScalableTargetDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[CfnScalableTargetDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[CfnScalableTargetDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[CfnScalableTargetDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[CfnScalableTargetDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[CfnScalableTargetDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[CfnScalableTargetDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[CfnScalableTargetDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[CfnScalableTargetDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[CfnScalableTargetDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[CfnScalableTargetDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[CfnScalableTargetDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
class CfnScalingPolicyDef(BaseCfnResource):
    policy_name: str = pydantic.Field(..., description="The name of the scaling policy. Updates to the name of a target tracking scaling policy are not supported, unless you also update the metric used for scaling. To change only a target tracking scaling policy's name, first delete the policy by removing the existing ``AWS::ApplicationAutoScaling::ScalingPolicy`` resource from the template and updating the stack. Then, recreate the resource with the same settings and a different name.\n")
    policy_type: str = pydantic.Field(..., description='The scaling policy type. The following policy types are supported: ``TargetTrackingScaling`` —Not supported for Amazon EMR ``StepScaling`` —Not supported for DynamoDB, Amazon Comprehend, Lambda, Amazon Keyspaces, Amazon MSK, Amazon ElastiCache, or Neptune.\n')
    ...
    step_scaling_policy_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_applicationautoscaling.CfnScalingPolicy_StepScalingPolicyConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A step scaling policy.\n')
    target_tracking_scaling_policy_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_applicationautoscaling.CfnScalingPolicy_TargetTrackingScalingPolicyConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A target tracking scaling policy.')
...
class CfnScalingPolicyDefConfig(pydantic.BaseModel):
    ...
    StepScalingPolicyConfigurationProperty: typing.Optional[list[CfnScalingPolicyDefStepscalingpolicyconfigurationpropertyParams]] = pydantic.Field(None, description='')
    TargetTrackingScalingPolicyConfigurationProperty: typing.Optional[list[CfnScalingPolicyDefTargettrackingscalingpolicyconfigurationpropertyParams]] = pydantic.Field(None, description='')
...
class CfnScalingPolicyDefCustomizedmetricspecificationpropertyParams(pydantic.BaseModel):
    ...
    dimensions: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_applicationautoscaling.CfnScalingPolicy_MetricDimensionPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
...
class CfnScalingPolicyDefStepscalingpolicyconfigurationpropertyParams(pydantic.BaseModel):
    ...
    step_adjustments: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_applicationautoscaling.CfnScalingPolicy_StepAdjustmentPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    ...
...
class CfnScalingPolicyDefTargettrackingscalingpolicyconfigurationpropertyParams(pydantic.BaseModel):
    ...
    customized_metric_specification: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_applicationautoscaling.CfnScalingPolicy_CustomizedMetricSpecificationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    disable_scale_in: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description='')
    predefined_metric_specification: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_applicationautoscaling.CfnScalingPolicy_PredefinedMetricSpecificationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
...
class ModuleModel(pydantic.BaseModel):
    BaseScalableAttribute: typing.Optional[dict[str, BaseScalableAttributeDef]] = pydantic.Field(None)
    Schedule: typing.Optional[dict[str, ScheduleDef]] = pydantic.Field(None)
    ScalableTarget: typing.Optional[dict[str, ScalableTargetDef]] = pydantic.Field(None)
    ...
    BaseScalableAttributeProps: typing.Optional[dict[str, BaseScalableAttributePropsDef]] = pydantic.Field(None)
    ...
    CfnScalableTarget_ScalableTargetActionProperty: typing.Optional[dict[str, CfnScalableTarget_ScalableTargetActionPropertyDef]] = pydantic.Field(None)
    CfnScalableTarget_ScheduledActionProperty: typing.Optional[dict[str, CfnScalableTarget_ScheduledActionPropertyDef]] = pydantic.Field(None)
    CfnScalableTarget_SuspendedStateProperty: typing.Optional[dict[str, CfnScalableTarget_SuspendedStatePropertyDef]] = pydantic.Field(None)
    ...
    CfnScalingPolicy_StepScalingPolicyConfigurationProperty: typing.Optional[dict[str, CfnScalingPolicy_StepScalingPolicyConfigurationPropertyDef]] = pydantic.Field(None)
    CfnScalingPolicy_TargetTrackingScalingPolicyConfigurationProperty: typing.Optional[dict[str, CfnScalingPolicy_TargetTrackingScalingPolicyConfigurationPropertyDef]] = pydantic.Field(None)
    ...
    ScalableTargetProps: typing.Optional[dict[str, ScalableTargetPropsDef]] = pydantic.Field(None)
    ScalingInterval: typing.Optional[dict[str, ScalingIntervalDef]] = pydantic.Field(None)
    ScalingSchedule: typing.Optional[dict[str, ScalingScheduleDef]] = pydantic.Field(None)
    ...
    CfnScalableTarget: typing.Optional[dict[str, CfnScalableTargetDef]] = pydantic.Field(None)
    CfnScalingPolicy: typing.Optional[dict[str, CfnScalingPolicyDef]] = pydantic.Field(None)
    CfnScalableTargetProps: typing.Optional[dict[str, CfnScalableTargetPropsDef]] = pydantic.Field(None)
