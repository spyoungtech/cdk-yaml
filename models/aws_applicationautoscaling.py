...
class CfnScalingPolicy_CustomizedMetricSpecificationPropertyDef(BaseStruct):
    ...
    metrics: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_applicationautoscaling.CfnScalingPolicy_TargetTrackingMetricDataQueryPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The metrics to include in the target tracking scaling policy, as a metric data query. This can include both raw metric and metric math expressions.\n')
...
#  autogenerated from aws_cdk.aws_applicationautoscaling.CfnScalingPolicy.TargetTrackingMetricDataQueryProperty
class CfnScalingPolicy_TargetTrackingMetricDataQueryPropertyDef(BaseStruct):
    ...
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_applicationautoscaling.CfnScalingPolicy.TargetTrackingMetricDataQueryProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
#  autogenerated from aws_cdk.aws_applicationautoscaling.CfnScalingPolicy.TargetTrackingMetricDimensionProperty
class CfnScalingPolicy_TargetTrackingMetricDimensionPropertyDef(BaseStruct):
    name: typing.Optional[str] = pydantic.Field(None, description='The name of the dimension.\n')
    value: typing.Optional[str] = pydantic.Field(None, description='The value of the dimension.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-applicationautoscaling-scalingpolicy-targettrackingmetricdimension.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_applicationautoscaling as appscaling\n\n    target_tracking_metric_dimension_property = appscaling.CfnScalingPolicy.TargetTrackingMetricDimensionProperty(\n        name="name",\n        value="value"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['name', 'value']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_applicationautoscaling.CfnScalingPolicy.TargetTrackingMetricDimensionProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
#  autogenerated from aws_cdk.aws_applicationautoscaling.CfnScalingPolicy.TargetTrackingMetricStatProperty
class CfnScalingPolicy_TargetTrackingMetricStatPropertyDef(BaseStruct):
    metric: typing.Union[models.UnsupportedResource, models.aws_applicationautoscaling.CfnScalingPolicy_TargetTrackingMetricPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The CloudWatch metric to return, including the metric name, namespace, and dimensions. To get the exact metric name, namespace, and dimensions, inspect the `Metric <https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_Metric.html>`_ object that is returned by a call to `ListMetrics <https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_ListMetrics.html>`_ .\n')
    stat: typing.Optional[str] = pydantic.Field(None, description='The statistic to return. It can include any CloudWatch statistic or extended statistic. For a list of valid values, see the table in `Statistics <https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/cloudwatch_concepts.html#Statistic>`_ in the *Amazon CloudWatch User Guide* . The most commonly used metric for scaling is ``Average`` .\n')
    ...
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_applicationautoscaling.CfnScalingPolicy.TargetTrackingMetricStatProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class ScalingScheduleDef(BaseStruct):
    ...
    start_time: typing.Optional[datetime.datetime] = pydantic.Field(None, description='When this scheduled action becomes active. Default: The rule is activate immediately\n')
    time_zone: typing.Optional[models.TimeZoneDef] = pydantic.Field(None, description='The time zone used when referring to the date and time of a scheduled action, when the scheduled action uses an at or cron expression. Default: - UTC\n\n:exampleMetadata: infused\n\nExample::\n\n    # cluster: ecs.Cluster\n\n    load_balanced_fargate_service = ecs_patterns.ApplicationLoadBalancedFargateService(self, "Service",\n        cluster=cluster,\n        memory_limit_mi_b=1024,\n        desired_count=1,\n        cpu=512,\n        task_image_options=ecsPatterns.ApplicationLoadBalancedTaskImageOptions(\n            image=ecs.ContainerImage.from_registry("amazon/amazon-ecs-sample")\n        )\n    )\n\n    scalable_target = load_balanced_fargate_service.service.auto_scale_task_count(\n        min_capacity=5,\n        max_capacity=20\n    )\n\n    scalable_target.scale_on_schedule("DaytimeScaleDown",\n        schedule=appscaling.Schedule.cron(hour="8", minute="0"),\n        min_capacity=1\n    )\n\n    scalable_target.scale_on_schedule("EveningRushScaleUp",\n        schedule=appscaling.Schedule.cron(hour="20", minute="0"),\n        min_capacity=10\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['schedule', 'end_time', 'max_capacity', 'min_capacity', 'start_time', 'time_zone']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnScalingPolicyDef(BaseCfnResource):
    ...
    resource_id: typing.Optional[str] = pydantic.Field(None, description='The identifier of the resource associated with the scaling policy. This string consists of the resource type and unique identifier. - ECS service - The resource type is ``service`` and the unique identifier is the cluster name and service name. Example: ``service/my-cluster/my-service`` . - Spot Fleet - The resource type is ``spot-fleet-request`` and the unique identifier is the Spot Fleet request ID. Example: ``spot-fleet-request/sfr-73fbd2ce-aa30-494c-8788-1cee4EXAMPLE`` . - EMR cluster - The resource type is ``instancegroup`` and the unique identifier is the cluster ID and instance group ID. Example: ``instancegroup/j-2EEZNYKUA1NTV/ig-1791Y4E1L8YI0`` . - AppStream 2.0 fleet - The resource type is ``fleet`` and the unique identifier is the fleet name. Example: ``fleet/sample-fleet`` . - DynamoDB table - The resource type is ``table`` and the unique identifier is the table name. Example: ``table/my-table`` . - DynamoDB global secondary index - The resource type is ``index`` and the unique identifier is the index name. Example: ``table/my-table/index/my-table-index`` . - Aurora DB cluster - The resource type is ``cluster`` and the unique identifier is the cluster name. Example: ``cluster:my-db-cluster`` . - SageMaker endpoint variant - The resource type is ``variant`` and the unique identifier is the resource ID. Example: ``endpoint/my-end-point/variant/KMeansClustering`` . - Custom resources are not supported with a resource type. This parameter must specify the ``OutputValue`` from the CloudFormation template stack used to access the resources. The unique identifier is defined by the service provider. More information is available in our `GitHub repository <https://docs.aws.amazon.com/https://github.com/aws/aws-auto-scaling-custom-resource>`_ . - Amazon Comprehend document classification endpoint - The resource type and unique identifier are specified using the endpoint ARN. Example: ``arn:aws:comprehend:us-west-2:123456789012:document-classifier-endpoint/EXAMPLE`` . - Amazon Comprehend entity recognizer endpoint - The resource type and unique identifier are specified using the endpoint ARN. Example: ``arn:aws:comprehend:us-west-2:123456789012:entity-recognizer-endpoint/EXAMPLE`` . - Lambda provisioned concurrency - The resource type is ``function`` and the unique identifier is the function name with a function version or alias name suffix that is not ``$LATEST`` . Example: ``function:my-function:prod`` or ``function:my-function:1`` . - Amazon Keyspaces table - The resource type is ``table`` and the unique identifier is the table name. Example: ``keyspace/mykeyspace/table/mytable`` . - Amazon MSK cluster - The resource type and unique identifier are specified using the cluster ARN. Example: ``arn:aws:kafka:us-east-1:123456789012:cluster/demo-cluster-1/6357e0b2-0e6a-4b86-a0b4-70df934c2e31-5`` . - Amazon ElastiCache replication group - The resource type is ``replication-group`` and the unique identifier is the replication group name. Example: ``replication-group/mycluster`` . - Neptune cluster - The resource type is ``cluster`` and the unique identifier is the cluster name. Example: ``cluster:mycluster`` . - SageMaker serverless endpoint - The resource type is ``variant`` and the unique identifier is the resource ID. Example: ``endpoint/my-end-point/variant/KMeansClustering`` . - SageMaker inference component - The resource type is ``inference-component`` and the unique identifier is the resource ID. Example: ``inference-component/my-inference-component`` .\n')
    ...
    _method_names: typing.ClassVar[list[str]] = ['CustomizedMetricSpecificationProperty', 'MetricDimensionProperty', 'PredefinedMetricSpecificationProperty', 'StepAdjustmentProperty', 'StepScalingPolicyConfigurationProperty', 'TargetTrackingMetricDataQueryProperty', 'TargetTrackingMetricDimensionProperty', 'TargetTrackingMetricProperty', 'TargetTrackingMetricStatProperty', 'TargetTrackingScalingPolicyConfigurationProperty', 'add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnScalingPolicyDefConfig(pydantic.BaseModel):
    ...
    TargetTrackingMetricDataQueryProperty: typing.Optional[list[models.aws_applicationautoscaling.CfnScalingPolicyDefTargettrackingmetricdataquerypropertyParams]] = pydantic.Field(None, description='')
    TargetTrackingMetricDimensionProperty: typing.Optional[list[models.aws_applicationautoscaling.CfnScalingPolicyDefTargettrackingmetricdimensionpropertyParams]] = pydantic.Field(None, description='')
    TargetTrackingMetricProperty: typing.Optional[list[models.aws_applicationautoscaling.CfnScalingPolicyDefTargettrackingmetricpropertyParams]] = pydantic.Field(None, description='')
    TargetTrackingMetricStatProperty: typing.Optional[list[models.aws_applicationautoscaling.CfnScalingPolicyDefTargettrackingmetricstatpropertyParams]] = pydantic.Field(None, description='')
...
class CfnScalingPolicyDefCustomizedmetricspecificationpropertyParams(pydantic.BaseModel):
    ...
    metrics: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_applicationautoscaling.CfnScalingPolicy_TargetTrackingMetricDataQueryPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
...
class CfnScalingPolicyDefTargettrackingmetricdataquerypropertyParams(pydantic.BaseModel):
    ...
    metric_stat: typing.Union[models.UnsupportedResource, models.aws_applicationautoscaling.CfnScalingPolicy_TargetTrackingMetricStatPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    return_data: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
    ...

class CfnScalingPolicyDefTargettrackingmetricdimensionpropertyParams(pydantic.BaseModel):
    name: typing.Optional[str] = pydantic.Field(None, description='')
    value: typing.Optional[str] = pydantic.Field(None, description='')
    ...

class CfnScalingPolicyDefTargettrackingmetricpropertyParams(pydantic.BaseModel):
    dimensions: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_applicationautoscaling.CfnScalingPolicy_TargetTrackingMetricDimensionPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    metric_name: typing.Optional[str] = pydantic.Field(None, description='')
    namespace: typing.Optional[str] = pydantic.Field(None, description='')
    ...

class CfnScalingPolicyDefTargettrackingmetricstatpropertyParams(pydantic.BaseModel):
    metric: typing.Union[models.UnsupportedResource, models.aws_applicationautoscaling.CfnScalingPolicy_TargetTrackingMetricPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
...
class ModuleModel(pydantic.BaseModel):
    ...
    CfnScalingPolicy_TargetTrackingMetricDataQueryProperty: typing.Optional[dict[str, models.aws_applicationautoscaling.CfnScalingPolicy_TargetTrackingMetricDataQueryPropertyDef]] = pydantic.Field(None)
    CfnScalingPolicy_TargetTrackingMetricDimensionProperty: typing.Optional[dict[str, models.aws_applicationautoscaling.CfnScalingPolicy_TargetTrackingMetricDimensionPropertyDef]] = pydantic.Field(None)
    CfnScalingPolicy_TargetTrackingMetricProperty: typing.Optional[dict[str, models.aws_applicationautoscaling.CfnScalingPolicy_TargetTrackingMetricPropertyDef]] = pydantic.Field(None)
    CfnScalingPolicy_TargetTrackingMetricStatProperty: typing.Optional[dict[str, models.aws_applicationautoscaling.CfnScalingPolicy_TargetTrackingMetricStatPropertyDef]] = pydantic.Field(None)
