...
class CfnCluster_JobFlowInstancesConfigPropertyDef(BaseStruct):
    ...
    keep_job_flow_alive_when_no_steps: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='Specifies whether the cluster should remain available after completing all steps. Defaults to ``false`` . For more information about configuring cluster termination, see `Control Cluster Termination <https://docs.aws.amazon.com/emr/latest/ManagementGuide/emr-plan-termination.html>`_ in the *EMR Management Guide* .\n')
...
#  autogenerated from aws_cdk.aws_emr.CfnCluster.PlacementGroupConfigProperty
class CfnCluster_PlacementGroupConfigPropertyDef(BaseStruct):
    instance_role: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Role of the instance in the cluster. Starting with Amazon EMR release 5.23.0, the only supported instance role is ``MASTER`` .\n')
    placement_strategy: typing.Optional[str] = pydantic.Field(None, description='Amazon EC2 Placement Group strategy associated with instance role. Starting with Amazon EMR release 5.23.0, the only supported placement strategy is ``SPREAD`` for the ``MASTER`` instance role.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-emr-cluster-placementgroupconfig.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_emr as emr\n\n    placement_group_config_property = emr.CfnCluster.PlacementGroupConfigProperty(\n        instance_role="instanceRole",\n\n        # the properties below are optional\n        placement_strategy="placementStrategy"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['instance_role', 'placement_strategy']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_emr.CfnCluster.PlacementGroupConfigProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class CfnClusterDef(BaseCfnResource):
    ...
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description="The name of the cluster. This parameter can't contain the characters <, >, $, |, or ` (backtick).\n")
    ...
    ebs_root_volume_iops: typing.Union[int, float, None] = pydantic.Field(None, description='The IOPS, of the Amazon EBS root device volume of the Linux AMI that is used for each Amazon EC2 instance. Available in Amazon EMR releases 6.15.0 and later.\n')
    ...
    ebs_root_volume_throughput: typing.Union[int, float, None] = pydantic.Field(None, description='The throughput, in MiB/s, of the Amazon EBS root device volume of the Linux AMI that is used for each Amazon EC2 instance. Available in Amazon EMR releases 6.15.0 and later.\n')
    ...
    placement_group_configs: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_emr.CfnCluster_PlacementGroupConfigPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
...
class CfnClusterDefConfig(pydantic.BaseModel):
    ...
    PlacementGroupConfigProperty: typing.Optional[list[models.aws_emr.CfnClusterDefPlacementgroupconfigpropertyParams]] = pydantic.Field(None, description='')
...
class CfnClusterDefJobflowinstancesconfigpropertyParams(pydantic.BaseModel):
    ...
    unhealthy_node_replacement: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
    ...
...
class CfnClusterDefPlacementgroupconfigpropertyParams(pydantic.BaseModel):
    instance_role: str = pydantic.Field(..., description='')
    placement_strategy: typing.Optional[str] = pydantic.Field(None, description='')
    ...
...
class CfnStudioDef(BaseCfnResource):
    ...
    encryption_key_arn: typing.Optional[str] = pydantic.Field(None, description='The AWS KMS key identifier (ARN) used to encrypt Amazon EMR Studio workspace and notebook files when backed up to Amazon S3.\n')
    idc_instance_arn: typing.Optional[str] = pydantic.Field(None, description='The ARN of the IAM Identity Center instance the Studio application belongs to.\n')
    idc_user_assignment: typing.Optional[str] = pydantic.Field(None, description='Indicates whether the Studio has ``REQUIRED`` or ``OPTIONAL`` IAM Identity Center user assignment. If the value is set to ``REQUIRED`` , users must be explicitly assigned to the Studio application to access the Studio.\n')
    ...
    trusted_identity_propagation_enabled: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='Indicates whether the Studio has Trusted identity propagation enabled. The default value is ``false`` .\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['auth_mode', 'default_s3_location', 'engine_security_group_id', 'name', 'service_role', 'subnet_ids', 'vpc_id', 'workspace_security_group_id', 'description', 'encryption_key_arn', 'idc_instance_arn', 'idc_user_assignment', 'idp_auth_url', 'idp_relay_state_parameter_name', 'tags', 'trusted_identity_propagation_enabled', 'user_role']
    _method_names: typing.ClassVar[list[str]] = ['add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class ModuleModel(pydantic.BaseModel):
    ...
    CfnCluster_PlacementGroupConfigProperty: typing.Optional[dict[str, models.aws_emr.CfnCluster_PlacementGroupConfigPropertyDef]] = pydantic.Field(None)
