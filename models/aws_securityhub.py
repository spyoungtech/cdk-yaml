...
class CfnAutomationRuleDef(BaseCfnResource):
    ...
    resource_config: typing.Optional[CfnAutomationRuleDefConfig] = pydantic.Field(None)


class CfnAutomationRuleDefConfig(pydantic.BaseModel):
    AutomationRulesActionProperty: typing.Optional[list[CfnAutomationRuleDefAutomationrulesactionpropertyParams]] = pydantic.Field(None, description='')
    AutomationRulesFindingFieldsUpdateProperty: typing.Optional[list[CfnAutomationRuleDefAutomationrulesfindingfieldsupdatepropertyParams]] = pydantic.Field(None, description='')
    AutomationRulesFindingFiltersProperty: typing.Optional[list[CfnAutomationRuleDefAutomationrulesfindingfilterspropertyParams]] = pydantic.Field(None, description='')
    DateFilterProperty: typing.Optional[list[CfnAutomationRuleDefDatefilterpropertyParams]] = pydantic.Field(None, description='')
    DateRangeProperty: typing.Optional[list[CfnAutomationRuleDefDaterangepropertyParams]] = pydantic.Field(None, description='')
    MapFilterProperty: typing.Optional[list[CfnAutomationRuleDefMapfilterpropertyParams]] = pydantic.Field(None, description='')
    NoteUpdateProperty: typing.Optional[list[CfnAutomationRuleDefNoteupdatepropertyParams]] = pydantic.Field(None, description='')
    NumberFilterProperty: typing.Optional[list[CfnAutomationRuleDefNumberfilterpropertyParams]] = pydantic.Field(None, description='')
    RelatedFindingProperty: typing.Optional[list[CfnAutomationRuleDefRelatedfindingpropertyParams]] = pydantic.Field(None, description='')
    SeverityUpdateProperty: typing.Optional[list[CfnAutomationRuleDefSeverityupdatepropertyParams]] = pydantic.Field(None, description='')
    StringFilterProperty: typing.Optional[list[CfnAutomationRuleDefStringfilterpropertyParams]] = pydantic.Field(None, description='')
    WorkflowUpdateProperty: typing.Optional[list[CfnAutomationRuleDefWorkflowupdatepropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[CfnAutomationRuleDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[CfnAutomationRuleDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[CfnAutomationRuleDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[CfnAutomationRuleDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[CfnAutomationRuleDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[CfnAutomationRuleDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[CfnAutomationRuleDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[CfnAutomationRuleDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[CfnAutomationRuleDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[CfnAutomationRuleDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[CfnAutomationRuleDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[CfnAutomationRuleDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[CfnAutomationRuleDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
class CfnStandardDef(BaseCfnResource):
    ...
    resource_config: typing.Optional[CfnStandardDefConfig] = pydantic.Field(None)


class CfnStandardDefConfig(pydantic.BaseModel):
    StandardsControlProperty: typing.Optional[list[CfnStandardDefStandardscontrolpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[CfnStandardDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[CfnStandardDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[CfnStandardDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[CfnStandardDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[CfnStandardDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[CfnStandardDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[CfnStandardDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[CfnStandardDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[CfnStandardDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[CfnStandardDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[CfnStandardDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[CfnStandardDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[CfnStandardDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
class ModuleModel(pydantic.BaseModel):
    CfnAutomationRule_AutomationRulesActionProperty: typing.Optional[dict[str, CfnAutomationRule_AutomationRulesActionPropertyDef]] = pydantic.Field(None)
    CfnAutomationRule_AutomationRulesFindingFieldsUpdateProperty: typing.Optional[dict[str, CfnAutomationRule_AutomationRulesFindingFieldsUpdatePropertyDef]] = pydantic.Field(None)
    CfnAutomationRule_AutomationRulesFindingFiltersProperty: typing.Optional[dict[str, CfnAutomationRule_AutomationRulesFindingFiltersPropertyDef]] = pydantic.Field(None)
    CfnAutomationRule_DateFilterProperty: typing.Optional[dict[str, CfnAutomationRule_DateFilterPropertyDef]] = pydantic.Field(None)
    CfnAutomationRule_DateRangeProperty: typing.Optional[dict[str, CfnAutomationRule_DateRangePropertyDef]] = pydantic.Field(None)
    CfnAutomationRule_MapFilterProperty: typing.Optional[dict[str, CfnAutomationRule_MapFilterPropertyDef]] = pydantic.Field(None)
    CfnAutomationRule_NoteUpdateProperty: typing.Optional[dict[str, CfnAutomationRule_NoteUpdatePropertyDef]] = pydantic.Field(None)
    CfnAutomationRule_NumberFilterProperty: typing.Optional[dict[str, CfnAutomationRule_NumberFilterPropertyDef]] = pydantic.Field(None)
    CfnAutomationRule_RelatedFindingProperty: typing.Optional[dict[str, CfnAutomationRule_RelatedFindingPropertyDef]] = pydantic.Field(None)
    CfnAutomationRule_SeverityUpdateProperty: typing.Optional[dict[str, CfnAutomationRule_SeverityUpdatePropertyDef]] = pydantic.Field(None)
    CfnAutomationRule_StringFilterProperty: typing.Optional[dict[str, CfnAutomationRule_StringFilterPropertyDef]] = pydantic.Field(None)
    CfnAutomationRule_WorkflowUpdateProperty: typing.Optional[dict[str, CfnAutomationRule_WorkflowUpdatePropertyDef]] = pydantic.Field(None)
    CfnStandard_StandardsControlProperty: typing.Optional[dict[str, CfnStandard_StandardsControlPropertyDef]] = pydantic.Field(None)
    CfnAutomationRule: typing.Optional[dict[str, CfnAutomationRuleDef]] = pydantic.Field(None)
    CfnHub: typing.Optional[dict[str, CfnHubDef]] = pydantic.Field(None)
    CfnStandard: typing.Optional[dict[str, CfnStandardDef]] = pydantic.Field(None)
    CfnAutomationRuleProps: typing.Optional[dict[str, CfnAutomationRulePropsDef]] = pydantic.Field(None)
    CfnHubProps: typing.Optional[dict[str, CfnHubPropsDef]] = pydantic.Field(None)
    CfnStandardProps: typing.Optional[dict[str, CfnStandardPropsDef]] = pydantic.Field(None)
    ...
