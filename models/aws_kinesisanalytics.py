...
class CfnApplicationV2_ApplicationConfigurationPropertyDef(BaseStruct):
    ...
    application_system_rollback_configuration: typing.Union[models.UnsupportedResource, aws_cdk.aws_kinesisanalytics.CfnApplicationV2.ApplicationSystemRollbackConfigurationProperty, dict[str, typing.Any], None] = pydantic.Field(None, description='Describes whether system initiated rollbacks are enabled for a Flink-based Kinesis Data Analytics application.\n')
    ...
    sql_application_configuration: typing.Union[models.UnsupportedResource, models.aws_kinesisanalytics.CfnApplicationV2_SqlApplicationConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The creation and update parameters for a SQL-based Kinesis Data Analytics application.\n')
...
class CfnApplicationOutputV2Def(BaseCfnResource):
    application_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the application.\n')
    output: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_kinesisanalytics.CfnApplicationOutputV2_OutputPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description="Describes a SQL-based Kinesis Data Analytics application's output configuration, in which you identify an in-application stream and a destination where you want the in-application stream data to be written. The destination can be a Kinesis data stream or a Kinesis Data Firehose delivery stream.")
    _init_params: typing.ClassVar[list[str]] = ['application_name', 'output']
    _method_names: typing.ClassVar[list[str]] = ['DestinationSchemaProperty', 'KinesisFirehoseOutputProperty', 'KinesisStreamsOutputProperty', 'LambdaOutputProperty', 'OutputProperty', 'add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnApplicationV2DefConfig(pydantic.BaseModel):
    ...
    ApplicationSystemRollbackConfigurationProperty: typing.Optional[list[models.aws_kinesisanalytics.CfnApplicationV2DefApplicationsystemrollbackconfigurationpropertyParams]] = pydantic.Field(None, description='')
...
class CfnApplicationV2DefApplicationconfigurationpropertyParams(pydantic.BaseModel):
    ...
    application_system_rollback_configuration: typing.Union[models.UnsupportedResource, aws_cdk.aws_kinesisanalytics.CfnApplicationV2.ApplicationSystemRollbackConfigurationProperty, dict[str, typing.Any], None] = pydantic.Field(None, description='')
...
class CfnApplicationV2DefApplicationsystemrollbackconfigurationpropertyParams(pydantic.BaseModel):
