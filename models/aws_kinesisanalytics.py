...
class CfnApplication_InputPropertyDef(BaseStruct):
    ...
    name_prefix: str = pydantic.Field(..., description='Name prefix to use when creating an in-application stream. Suppose that you specify a prefix "MyInApplicationStream." Amazon Kinesis Analytics then creates one or more (as per the ``InputParallelism`` count you specified) in-application streams with names "MyInApplicationStream_001," "MyInApplicationStream_002," and so on.\n')
...
class CfnApplication_KinesisFirehoseInputPropertyDef(BaseStruct):
    resource_arn: str = pydantic.Field(..., description='ARN of the input delivery stream.\n')
    role_arn: str = pydantic.Field(..., description='ARN of the IAM role that Amazon Kinesis Analytics can assume to access the stream on your behalf. You need to make sure that the role has the necessary permissions to access the stream.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kinesisanalytics-application-kinesisfirehoseinput.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_kinesisanalytics as kinesisanalytics\n\n    kinesis_firehose_input_property = kinesisanalytics.CfnApplication.KinesisFirehoseInputProperty(\n        resource_arn="resourceArn",\n        role_arn="roleArn"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['resource_arn', 'role_arn']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnApplication_KinesisStreamsInputPropertyDef(BaseStruct):
    resource_arn: str = pydantic.Field(..., description='ARN of the input Amazon Kinesis stream to read.\n')
    role_arn: str = pydantic.Field(..., description='ARN of the IAM role that Amazon Kinesis Analytics can assume to access the stream on your behalf. You need to grant the necessary permissions to this role.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kinesisanalytics-application-kinesisstreamsinput.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_kinesisanalytics as kinesisanalytics\n\n    kinesis_streams_input_property = kinesisanalytics.CfnApplication.KinesisStreamsInputProperty(\n        resource_arn="resourceArn",\n        role_arn="roleArn"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['resource_arn', 'role_arn']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnApplication_RecordColumnPropertyDef(BaseStruct):
    name: str = pydantic.Field(..., description='Name of the column created in the in-application input stream or reference table.\n')
    sql_type: str = pydantic.Field(..., description='Type of column created in the in-application input stream or reference table.\n')
...
class CfnApplicationOutput_KinesisFirehoseOutputPropertyDef(BaseStruct):
    resource_arn: str = pydantic.Field(..., description='ARN of the destination Amazon Kinesis Firehose delivery stream to write to.\n')
    role_arn: str = pydantic.Field(..., description='ARN of the IAM role that Amazon Kinesis Analytics can assume to write to the destination stream on your behalf. You need to grant the necessary permissions to this role.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kinesisanalytics-applicationoutput-kinesisfirehoseoutput.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_kinesisanalytics as kinesisanalytics\n\n    kinesis_firehose_output_property = kinesisanalytics.CfnApplicationOutput.KinesisFirehoseOutputProperty(\n        resource_arn="resourceArn",\n        role_arn="roleArn"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['resource_arn', 'role_arn']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnApplicationOutput_KinesisStreamsOutputPropertyDef(BaseStruct):
    resource_arn: str = pydantic.Field(..., description='ARN of the destination Amazon Kinesis stream to write to.\n')
...
class CfnApplicationOutput_LambdaOutputPropertyDef(BaseStruct):
    resource_arn: str = pydantic.Field(..., description='Amazon Resource Name (ARN) of the destination Lambda function to write to. .. epigraph:: To specify an earlier version of the Lambda function than the latest, include the Lambda function version in the Lambda function ARN. For more information about Lambda ARNs, see `Example ARNs: AWS Lambda <https://docs.aws.amazon.com//general/latest/gr/aws-arns-and-namespaces.html#arn-syntax-lambda>`_\n')
    role_arn: str = pydantic.Field(..., description='ARN of the IAM role that Amazon Kinesis Analytics can assume to write to the destination function on your behalf. You need to grant the necessary permissions to this role.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kinesisanalytics-applicationoutput-lambdaoutput.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_kinesisanalytics as kinesisanalytics\n\n    lambda_output_property = kinesisanalytics.CfnApplicationOutput.LambdaOutputProperty(\n        resource_arn="resourceArn",\n        role_arn="roleArn"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['resource_arn', 'role_arn']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnApplicationOutput_OutputPropertyDef(BaseStruct):
    destination_schema: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationOutput_DestinationSchemaPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='Describes the data format when records are written to the destination. For more information, see `Configuring Application Output <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/how-it-works-output.html>`_ .\n')
    kinesis_firehose_output: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationOutput_KinesisFirehoseOutputPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Identifies an Amazon Kinesis Firehose delivery stream as the destination.\n')
    kinesis_streams_output: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationOutput_KinesisStreamsOutputPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Identifies an Amazon Kinesis stream as the destination.\n')
    lambda_output: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationOutput_LambdaOutputPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Identifies an AWS Lambda function as the destination.\n')
...
class CfnApplicationOutputV2_OutputPropertyDef(BaseStruct):
    destination_schema: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationOutputV2_DestinationSchemaPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='Describes the data format when records are written to the destination.\n')
    kinesis_firehose_output: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationOutputV2_KinesisFirehoseOutputPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Identifies a Kinesis Data Firehose delivery stream as the destination.\n')
    kinesis_streams_output: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationOutputV2_KinesisStreamsOutputPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Identifies a Kinesis data stream as the destination.\n')
    lambda_output: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationOutputV2_LambdaOutputPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Identifies an Amazon Lambda function as the destination.\n')
...
class CfnApplicationReferenceDataSource_ReferenceSchemaPropertyDef(BaseStruct):
    record_columns: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationReferenceDataSource_RecordColumnPropertyDef, dict[str, typing.Any]]]] = pydantic.Field(..., description='A list of RecordColumn objects.\n')
    record_format: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationReferenceDataSource_RecordFormatPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='Specifies the format of the records on the reference source.\n')
...
class CfnApplicationReferenceDataSource_S3ReferenceDataSourcePropertyDef(BaseStruct):
    bucket_arn: str = pydantic.Field(..., description='Amazon Resource Name (ARN) of the S3 bucket.\n')
    file_key: str = pydantic.Field(..., description='Object key name containing reference data.\n')
    reference_role_arn: str = pydantic.Field(..., description='ARN of the IAM role that the service can assume to read data on your behalf. This role must have permission for the ``s3:GetObject`` action on the object and trust policy that allows Amazon Kinesis Analytics service principal to assume this role.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kinesisanalytics-applicationreferencedatasource-s3referencedatasource.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_kinesisanalytics as kinesisanalytics\n\n    s3_reference_data_source_property = kinesisanalytics.CfnApplicationReferenceDataSource.S3ReferenceDataSourceProperty(\n        bucket_arn="bucketArn",\n        file_key="fileKey",\n        reference_role_arn="referenceRoleArn"\n    )\n')
...
class CfnApplicationReferenceDataSourceV2_ReferenceDataSourcePropertyDef(BaseStruct):
    reference_schema: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationReferenceDataSourceV2_ReferenceSchemaPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='Describes the format of the data in the streaming source, and how each data element maps to corresponding columns created in the in-application stream.\n')
...
class CfnApplicationReferenceDataSourceV2_ReferenceSchemaPropertyDef(BaseStruct):
    ...
    record_format: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationReferenceDataSourceV2_RecordFormatPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='Specifies the format of the records on the streaming source.\n')
...
class CfnApplicationV2_ApplicationCodeConfigurationPropertyDef(BaseStruct):
    code_content: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_CodeContentPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='The location and type of the application code.\n')
...
class CfnApplicationV2_ApplicationConfigurationPropertyDef(BaseStruct):
    ...
    environment_properties: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_EnvironmentPropertiesPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Describes execution properties for a Flink-based Kinesis Data Analytics application.\n')
    flink_application_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_FlinkApplicationConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The creation and update parameters for a Flink-based Kinesis Data Analytics application.\n')
    sql_application_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_SqlApplicationConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The creation and update parameters for a SQL-based Kinesis Data Analytics application.\n')
...
class CfnApplicationV2_CodeContentPropertyDef(BaseStruct):
    s3_content_location: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_S3ContentLocationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Information about the Amazon S3 bucket that contains the application code.\n')
...
class CfnApplicationV2_DeployAsApplicationConfigurationPropertyDef(BaseStruct):
    s3_content_location: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_S3ContentBaseLocationPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='The description of an Amazon S3 object that contains the Amazon Data Analytics application, including the Amazon Resource Name (ARN) of the S3 bucket, the name of the Amazon S3 object that contains the data, and the version number of the Amazon S3 object that contains the data.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kinesisanalyticsv2-application-deployasapplicationconfiguration.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_kinesisanalytics as kinesisanalytics\n\n    deploy_as_application_configuration_property = kinesisanalytics.CfnApplicationV2.DeployAsApplicationConfigurationProperty(\n        s3_content_location=kinesisanalytics.CfnApplicationV2.S3ContentBaseLocationProperty(\n            bucket_arn="bucketArn",\n\n            # the properties below are optional\n            base_path="basePath"\n        )\n    )\n')
...
class CfnApplicationV2_InputPropertyDef(BaseStruct):
    ...
    input_parallelism: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_InputParallelismPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Describes the number of in-application streams to create.\n')
...
class CfnApplicationV2_InputSchemaPropertyDef(BaseStruct):
    record_columns: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_RecordColumnPropertyDef, dict[str, typing.Any]]]] = pydantic.Field(..., description='A list of ``RecordColumn`` objects.\n')
    record_format: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_RecordFormatPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='Specifies the format of the records on the streaming source.\n')
...
class CfnApplicationV2_MappingParametersPropertyDef(BaseStruct):
    csv_mapping_parameters: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_CSVMappingParametersPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Provides additional mapping information when the record format uses delimiters (for example, CSV).\n')
    json_mapping_parameters: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_JSONMappingParametersPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Provides additional mapping information when JSON is the record format on the streaming source.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kinesisanalyticsv2-application-mappingparameters.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_kinesisanalytics as kinesisanalytics\n\n    mapping_parameters_property = kinesisanalytics.CfnApplicationV2.MappingParametersProperty(\n        csv_mapping_parameters=kinesisanalytics.CfnApplicationV2.CSVMappingParametersProperty(\n            record_column_delimiter="recordColumnDelimiter",\n            record_row_delimiter="recordRowDelimiter"\n        ),\n        json_mapping_parameters=kinesisanalytics.CfnApplicationV2.JSONMappingParametersProperty(\n            record_row_path="recordRowPath"\n        )\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['csv_mapping_parameters', 'json_mapping_parameters']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnApplicationV2_ZeppelinApplicationConfigurationPropertyDef(BaseStruct):
    catalog_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_CatalogConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The Amazon Glue Data Catalog that you use in queries in a Kinesis Data Analytics Studio notebook.\n')
...
class CfnApplicationDefInputprocessingconfigurationpropertyParams(pydantic.BaseModel):
    input_lambda_processor: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplication_InputLambdaProcessorPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnApplicationDefInputpropertyParams(pydantic.BaseModel):
    ...
    input_parallelism: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplication_InputParallelismPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    input_processing_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplication_InputProcessingConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    kinesis_firehose_input: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplication_KinesisFirehoseInputPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    kinesis_streams_input: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplication_KinesisStreamsInputPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...

class CfnApplicationDefInputschemapropertyParams(pydantic.BaseModel):
    record_columns: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplication_RecordColumnPropertyDef, dict[str, typing.Any]]]] = pydantic.Field(..., description='')
    record_format: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplication_RecordFormatPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
...
class CfnApplicationDefMappingparameterspropertyParams(pydantic.BaseModel):
    csv_mapping_parameters: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplication_CSVMappingParametersPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
...
class CfnApplicationCloudWatchLoggingOptionV2Def(BaseCfnResource):
    ...
    cloud_watch_logging_option: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationCloudWatchLoggingOptionV2_CloudWatchLoggingOptionPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='Provides a description of Amazon CloudWatch logging options, including the log stream Amazon Resource Name (ARN).')
    ...
    resource_config: typing.Optional[CfnApplicationCloudWatchLoggingOptionV2DefConfig] = pydantic.Field(None)


class CfnApplicationCloudWatchLoggingOptionV2DefConfig(pydantic.BaseModel):
    CloudWatchLoggingOptionProperty: typing.Optional[list[CfnApplicationCloudWatchLoggingOptionV2DefCloudwatchloggingoptionpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[CfnApplicationCloudWatchLoggingOptionV2DefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[CfnApplicationCloudWatchLoggingOptionV2DefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[CfnApplicationCloudWatchLoggingOptionV2DefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[CfnApplicationCloudWatchLoggingOptionV2DefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[CfnApplicationCloudWatchLoggingOptionV2DefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[CfnApplicationCloudWatchLoggingOptionV2DefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[CfnApplicationCloudWatchLoggingOptionV2DefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[CfnApplicationCloudWatchLoggingOptionV2DefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[CfnApplicationCloudWatchLoggingOptionV2DefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[CfnApplicationCloudWatchLoggingOptionV2DefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[CfnApplicationCloudWatchLoggingOptionV2DefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[CfnApplicationCloudWatchLoggingOptionV2DefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[CfnApplicationCloudWatchLoggingOptionV2DefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
class CfnApplicationOutputDef(BaseCfnResource):
    application_name: str = pydantic.Field(..., description='Name of the application to which you want to add the output configuration.\n')
    output: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationOutput_OutputPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='An array of objects, each describing one output configuration. In the output configuration, you specify the name of an in-application stream, a destination (that is, an Amazon Kinesis stream, an Amazon Kinesis Firehose delivery stream, or an AWS Lambda function), and record the formation to use when writing to the destination.')
...
class CfnApplicationOutputDefOutputpropertyParams(pydantic.BaseModel):
    destination_schema: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationOutput_DestinationSchemaPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    kinesis_firehose_output: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationOutput_KinesisFirehoseOutputPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    kinesis_streams_output: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationOutput_KinesisStreamsOutputPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    lambda_output: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationOutput_LambdaOutputPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
...
class CfnApplicationOutputV2Def(BaseCfnResource):
    application_name: str = pydantic.Field(..., description='The name of the application.\n')
    output: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationOutputV2_OutputPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description="Describes a SQL-based Kinesis Data Analytics application's output configuration, in which you identify an in-application stream and a destination where you want the in-application stream data to be written. The destination can be a Kinesis data stream or a Kinesis Data Firehose delivery stream.")
    _init_params: typing.ClassVar[list[str]] = ['application_name', 'output']
    _method_names: typing.ClassVar[list[str]] = ['DestinationSchemaProperty', 'KinesisFirehoseOutputProperty', 'KinesisStreamsOutputProperty', 'LambdaOutputProperty', 'OutputProperty', 'add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
    ...
    resource_config: typing.Optional[CfnApplicationOutputV2DefConfig] = pydantic.Field(None)


class CfnApplicationOutputV2DefConfig(pydantic.BaseModel):
    DestinationSchemaProperty: typing.Optional[list[CfnApplicationOutputV2DefDestinationschemapropertyParams]] = pydantic.Field(None, description='')
    KinesisFirehoseOutputProperty: typing.Optional[list[CfnApplicationOutputV2DefKinesisfirehoseoutputpropertyParams]] = pydantic.Field(None, description='')
    KinesisStreamsOutputProperty: typing.Optional[list[CfnApplicationOutputV2DefKinesisstreamsoutputpropertyParams]] = pydantic.Field(None, description='')
    LambdaOutputProperty: typing.Optional[list[CfnApplicationOutputV2DefLambdaoutputpropertyParams]] = pydantic.Field(None, description='')
    OutputProperty: typing.Optional[list[CfnApplicationOutputV2DefOutputpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[CfnApplicationOutputV2DefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[CfnApplicationOutputV2DefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[CfnApplicationOutputV2DefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[CfnApplicationOutputV2DefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[CfnApplicationOutputV2DefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[CfnApplicationOutputV2DefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[CfnApplicationOutputV2DefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[CfnApplicationOutputV2DefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[CfnApplicationOutputV2DefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[CfnApplicationOutputV2DefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[CfnApplicationOutputV2DefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[CfnApplicationOutputV2DefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[CfnApplicationOutputV2DefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
class CfnApplicationOutputV2DefOutputpropertyParams(pydantic.BaseModel):
    destination_schema: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationOutputV2_DestinationSchemaPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    kinesis_firehose_output: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationOutputV2_KinesisFirehoseOutputPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    kinesis_streams_output: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationOutputV2_KinesisStreamsOutputPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    lambda_output: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationOutputV2_LambdaOutputPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    name: typing.Optional[str] = pydantic.Field(None, description='')
    ...
...
class CfnApplicationReferenceDataSourceDef(BaseCfnResource):
    application_name: str = pydantic.Field(..., description='Name of an existing application.\n')
    reference_data_source: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationReferenceDataSource_ReferenceDataSourcePropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='The reference data source can be an object in your Amazon S3 bucket. Amazon Kinesis Analytics reads the object and copies the data into the in-application table that is created. You provide an S3 bucket, object key name, and the resulting in-application table that is created. You must also provide an IAM role with the necessary permissions that Amazon Kinesis Analytics can assume to read the object from your S3 bucket on your behalf.')
...
class CfnApplicationReferenceDataSourceDefMappingparameterspropertyParams(pydantic.BaseModel):
    csv_mapping_parameters: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationReferenceDataSource_CSVMappingParametersPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    json_mapping_parameters: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationReferenceDataSource_JSONMappingParametersPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnApplicationReferenceDataSourceDefReferencedatasourcepropertyParams(pydantic.BaseModel):
    reference_schema: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationReferenceDataSource_ReferenceSchemaPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    s3_reference_data_source: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationReferenceDataSource_S3ReferenceDataSourcePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
...
class CfnApplicationReferenceDataSourceDefReferenceschemapropertyParams(pydantic.BaseModel):
    record_columns: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationReferenceDataSource_RecordColumnPropertyDef, dict[str, typing.Any]]]] = pydantic.Field(..., description='')
    record_format: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationReferenceDataSource_RecordFormatPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    record_encoding: typing.Optional[str] = pydantic.Field(None, description='')
    ...
...
class CfnApplicationReferenceDataSourceV2Def(BaseCfnResource):
    ...
    resource_config: typing.Optional[CfnApplicationReferenceDataSourceV2DefConfig] = pydantic.Field(None)


class CfnApplicationReferenceDataSourceV2DefConfig(pydantic.BaseModel):
    CSVMappingParametersProperty: typing.Optional[list[CfnApplicationReferenceDataSourceV2DefCsvmappingparameterspropertyParams]] = pydantic.Field(None, description='')
    JSONMappingParametersProperty: typing.Optional[list[CfnApplicationReferenceDataSourceV2DefJsonmappingparameterspropertyParams]] = pydantic.Field(None, description='')
    MappingParametersProperty: typing.Optional[list[CfnApplicationReferenceDataSourceV2DefMappingparameterspropertyParams]] = pydantic.Field(None, description='')
    RecordColumnProperty: typing.Optional[list[CfnApplicationReferenceDataSourceV2DefRecordcolumnpropertyParams]] = pydantic.Field(None, description='')
    RecordFormatProperty: typing.Optional[list[CfnApplicationReferenceDataSourceV2DefRecordformatpropertyParams]] = pydantic.Field(None, description='')
    ReferenceDataSourceProperty: typing.Optional[list[CfnApplicationReferenceDataSourceV2DefReferencedatasourcepropertyParams]] = pydantic.Field(None, description='')
    ReferenceSchemaProperty: typing.Optional[list[CfnApplicationReferenceDataSourceV2DefReferenceschemapropertyParams]] = pydantic.Field(None, description='')
    S3ReferenceDataSourceProperty: typing.Optional[list[CfnApplicationReferenceDataSourceV2DefS3ReferencedatasourcepropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[CfnApplicationReferenceDataSourceV2DefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[CfnApplicationReferenceDataSourceV2DefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[CfnApplicationReferenceDataSourceV2DefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[CfnApplicationReferenceDataSourceV2DefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[CfnApplicationReferenceDataSourceV2DefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[CfnApplicationReferenceDataSourceV2DefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[CfnApplicationReferenceDataSourceV2DefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[CfnApplicationReferenceDataSourceV2DefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[CfnApplicationReferenceDataSourceV2DefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[CfnApplicationReferenceDataSourceV2DefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[CfnApplicationReferenceDataSourceV2DefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[CfnApplicationReferenceDataSourceV2DefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[CfnApplicationReferenceDataSourceV2DefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
class CfnApplicationReferenceDataSourceV2DefMappingparameterspropertyParams(pydantic.BaseModel):
    csv_mapping_parameters: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationReferenceDataSourceV2_CSVMappingParametersPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    json_mapping_parameters: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationReferenceDataSourceV2_JSONMappingParametersPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnApplicationReferenceDataSourceV2DefRecordformatpropertyParams(pydantic.BaseModel):
    record_format_type: str = pydantic.Field(..., description='')
    mapping_parameters: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationReferenceDataSourceV2_MappingParametersPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...

class CfnApplicationReferenceDataSourceV2DefReferencedatasourcepropertyParams(pydantic.BaseModel):
    reference_schema: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationReferenceDataSourceV2_ReferenceSchemaPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    s3_reference_data_source: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationReferenceDataSourceV2_S3ReferenceDataSourcePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    table_name: typing.Optional[str] = pydantic.Field(None, description='')
    ...
...
class CfnApplicationV2Def(BaseCfnResource):
    ...
    application_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_ApplicationConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Use this parameter to configure the application.\n')
    application_description: typing.Optional[str] = pydantic.Field(None, description='The description of the application.\n')
    application_maintenance_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_ApplicationMaintenanceConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='``AWS::KinesisAnalyticsV2::Application.ApplicationMaintenanceConfiguration``.\n')
    ...
    resource_config: typing.Optional[CfnApplicationV2DefConfig] = pydantic.Field(None)


class CfnApplicationV2DefConfig(pydantic.BaseModel):
    ApplicationCodeConfigurationProperty: typing.Optional[list[CfnApplicationV2DefApplicationcodeconfigurationpropertyParams]] = pydantic.Field(None, description='')
    ApplicationConfigurationProperty: typing.Optional[list[CfnApplicationV2DefApplicationconfigurationpropertyParams]] = pydantic.Field(None, description='')
    ApplicationMaintenanceConfigurationProperty: typing.Optional[list[CfnApplicationV2DefApplicationmaintenanceconfigurationpropertyParams]] = pydantic.Field(None, description='')
    ApplicationRestoreConfigurationProperty: typing.Optional[list[CfnApplicationV2DefApplicationrestoreconfigurationpropertyParams]] = pydantic.Field(None, description='')
    ApplicationSnapshotConfigurationProperty: typing.Optional[list[CfnApplicationV2DefApplicationsnapshotconfigurationpropertyParams]] = pydantic.Field(None, description='')
    CSVMappingParametersProperty: typing.Optional[list[CfnApplicationV2DefCsvmappingparameterspropertyParams]] = pydantic.Field(None, description='')
    CatalogConfigurationProperty: typing.Optional[list[CfnApplicationV2DefCatalogconfigurationpropertyParams]] = pydantic.Field(None, description='')
    CheckpointConfigurationProperty: typing.Optional[list[CfnApplicationV2DefCheckpointconfigurationpropertyParams]] = pydantic.Field(None, description='')
    CodeContentProperty: typing.Optional[list[CfnApplicationV2DefCodecontentpropertyParams]] = pydantic.Field(None, description='')
    CustomArtifactConfigurationProperty: typing.Optional[list[CfnApplicationV2DefCustomartifactconfigurationpropertyParams]] = pydantic.Field(None, description='')
    DeployAsApplicationConfigurationProperty: typing.Optional[list[CfnApplicationV2DefDeployasapplicationconfigurationpropertyParams]] = pydantic.Field(None, description='')
    EnvironmentPropertiesProperty: typing.Optional[list[CfnApplicationV2DefEnvironmentpropertiespropertyParams]] = pydantic.Field(None, description='')
    FlinkApplicationConfigurationProperty: typing.Optional[list[CfnApplicationV2DefFlinkapplicationconfigurationpropertyParams]] = pydantic.Field(None, description='')
    FlinkRunConfigurationProperty: typing.Optional[list[CfnApplicationV2DefFlinkrunconfigurationpropertyParams]] = pydantic.Field(None, description='')
    GlueDataCatalogConfigurationProperty: typing.Optional[list[CfnApplicationV2DefGluedatacatalogconfigurationpropertyParams]] = pydantic.Field(None, description='')
    InputLambdaProcessorProperty: typing.Optional[list[CfnApplicationV2DefInputlambdaprocessorpropertyParams]] = pydantic.Field(None, description='')
    InputParallelismProperty: typing.Optional[list[CfnApplicationV2DefInputparallelismpropertyParams]] = pydantic.Field(None, description='')
    InputProcessingConfigurationProperty: typing.Optional[list[CfnApplicationV2DefInputprocessingconfigurationpropertyParams]] = pydantic.Field(None, description='')
    InputProperty: typing.Optional[list[CfnApplicationV2DefInputpropertyParams]] = pydantic.Field(None, description='')
    InputSchemaProperty: typing.Optional[list[CfnApplicationV2DefInputschemapropertyParams]] = pydantic.Field(None, description='')
    JSONMappingParametersProperty: typing.Optional[list[CfnApplicationV2DefJsonmappingparameterspropertyParams]] = pydantic.Field(None, description='')
    KinesisFirehoseInputProperty: typing.Optional[list[CfnApplicationV2DefKinesisfirehoseinputpropertyParams]] = pydantic.Field(None, description='')
    KinesisStreamsInputProperty: typing.Optional[list[CfnApplicationV2DefKinesisstreamsinputpropertyParams]] = pydantic.Field(None, description='')
    MappingParametersProperty: typing.Optional[list[CfnApplicationV2DefMappingparameterspropertyParams]] = pydantic.Field(None, description='')
    MavenReferenceProperty: typing.Optional[list[CfnApplicationV2DefMavenreferencepropertyParams]] = pydantic.Field(None, description='')
    MonitoringConfigurationProperty: typing.Optional[list[CfnApplicationV2DefMonitoringconfigurationpropertyParams]] = pydantic.Field(None, description='')
    ParallelismConfigurationProperty: typing.Optional[list[CfnApplicationV2DefParallelismconfigurationpropertyParams]] = pydantic.Field(None, description='')
    PropertyGroupProperty: typing.Optional[list[CfnApplicationV2DefPropertygrouppropertyParams]] = pydantic.Field(None, description='')
    RecordColumnProperty: typing.Optional[list[CfnApplicationV2DefRecordcolumnpropertyParams]] = pydantic.Field(None, description='')
    RecordFormatProperty: typing.Optional[list[CfnApplicationV2DefRecordformatpropertyParams]] = pydantic.Field(None, description='')
    RunConfigurationProperty: typing.Optional[list[CfnApplicationV2DefRunconfigurationpropertyParams]] = pydantic.Field(None, description='')
    S3ContentBaseLocationProperty: typing.Optional[list[CfnApplicationV2DefS3ContentbaselocationpropertyParams]] = pydantic.Field(None, description='')
    S3ContentLocationProperty: typing.Optional[list[CfnApplicationV2DefS3ContentlocationpropertyParams]] = pydantic.Field(None, description='')
    SqlApplicationConfigurationProperty: typing.Optional[list[CfnApplicationV2DefSqlapplicationconfigurationpropertyParams]] = pydantic.Field(None, description='')
    VpcConfigurationProperty: typing.Optional[list[CfnApplicationV2DefVpcconfigurationpropertyParams]] = pydantic.Field(None, description='')
    ZeppelinApplicationConfigurationProperty: typing.Optional[list[CfnApplicationV2DefZeppelinapplicationconfigurationpropertyParams]] = pydantic.Field(None, description='')
    ZeppelinMonitoringConfigurationProperty: typing.Optional[list[CfnApplicationV2DefZeppelinmonitoringconfigurationpropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[CfnApplicationV2DefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[CfnApplicationV2DefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[CfnApplicationV2DefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[CfnApplicationV2DefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[CfnApplicationV2DefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[CfnApplicationV2DefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[CfnApplicationV2DefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[CfnApplicationV2DefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[CfnApplicationV2DefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[CfnApplicationV2DefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[CfnApplicationV2DefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[CfnApplicationV2DefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[CfnApplicationV2DefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')
...
class CfnApplicationV2DefApplicationconfigurationpropertyParams(pydantic.BaseModel):
    application_code_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_ApplicationCodeConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    application_snapshot_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_ApplicationSnapshotConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    environment_properties: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_EnvironmentPropertiesPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    flink_application_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_FlinkApplicationConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    sql_application_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_SqlApplicationConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    vpc_configurations: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_VpcConfigurationPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    zeppelin_application_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_ZeppelinApplicationConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnApplicationV2DefCodecontentpropertyParams(pydantic.BaseModel):
    s3_content_location: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_S3ContentLocationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
...
class CfnApplicationV2DefDeployasapplicationconfigurationpropertyParams(pydantic.BaseModel):
    s3_content_location: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_S3ContentBaseLocationPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    ...

class CfnApplicationV2DefEnvironmentpropertiespropertyParams(pydantic.BaseModel):
    property_groups: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_PropertyGroupPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    ...

class CfnApplicationV2DefFlinkapplicationconfigurationpropertyParams(pydantic.BaseModel):
    checkpoint_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_CheckpointConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    monitoring_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_MonitoringConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    parallelism_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_ParallelismConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnApplicationV2DefInputprocessingconfigurationpropertyParams(pydantic.BaseModel):
    input_lambda_processor: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_InputLambdaProcessorPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...

class CfnApplicationV2DefInputpropertyParams(pydantic.BaseModel):
    input_schema: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_InputSchemaPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    name_prefix: str = pydantic.Field(..., description='')
    input_parallelism: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_InputParallelismPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    input_processing_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_InputProcessingConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    kinesis_firehose_input: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_KinesisFirehoseInputPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    kinesis_streams_input: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_KinesisStreamsInputPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnApplicationV2DefInputschemapropertyParams(pydantic.BaseModel):
    record_columns: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_RecordColumnPropertyDef, dict[str, typing.Any]]]] = pydantic.Field(..., description='')
    record_format: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_RecordFormatPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    record_encoding: typing.Optional[str] = pydantic.Field(None, description='')
    ...
...
class CfnApplicationV2DefRecordformatpropertyParams(pydantic.BaseModel):
    record_format_type: str = pydantic.Field(..., description='')
    mapping_parameters: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_MappingParametersPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnApplicationV2DefZeppelinapplicationconfigurationpropertyParams(pydantic.BaseModel):
    catalog_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_CatalogConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    custom_artifacts_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_CustomArtifactConfigurationPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    deploy_as_application_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_DeployAsApplicationConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    monitoring_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_kinesisanalytics.CfnApplicationV2_ZeppelinMonitoringConfigurationPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class ModuleModel(pydantic.BaseModel):
    ...
    CfnApplicationCloudWatchLoggingOptionV2_CloudWatchLoggingOptionProperty: typing.Optional[dict[str, CfnApplicationCloudWatchLoggingOptionV2_CloudWatchLoggingOptionPropertyDef]] = pydantic.Field(None)
    ...
    CfnApplicationOutputV2_DestinationSchemaProperty: typing.Optional[dict[str, CfnApplicationOutputV2_DestinationSchemaPropertyDef]] = pydantic.Field(None)
    CfnApplicationOutputV2_KinesisFirehoseOutputProperty: typing.Optional[dict[str, CfnApplicationOutputV2_KinesisFirehoseOutputPropertyDef]] = pydantic.Field(None)
    CfnApplicationOutputV2_KinesisStreamsOutputProperty: typing.Optional[dict[str, CfnApplicationOutputV2_KinesisStreamsOutputPropertyDef]] = pydantic.Field(None)
    CfnApplicationOutputV2_LambdaOutputProperty: typing.Optional[dict[str, CfnApplicationOutputV2_LambdaOutputPropertyDef]] = pydantic.Field(None)
    CfnApplicationOutputV2_OutputProperty: typing.Optional[dict[str, CfnApplicationOutputV2_OutputPropertyDef]] = pydantic.Field(None)
    ...
    CfnApplicationReferenceDataSourceV2_CSVMappingParametersProperty: typing.Optional[dict[str, CfnApplicationReferenceDataSourceV2_CSVMappingParametersPropertyDef]] = pydantic.Field(None)
    CfnApplicationReferenceDataSourceV2_JSONMappingParametersProperty: typing.Optional[dict[str, CfnApplicationReferenceDataSourceV2_JSONMappingParametersPropertyDef]] = pydantic.Field(None)
    CfnApplicationReferenceDataSourceV2_MappingParametersProperty: typing.Optional[dict[str, CfnApplicationReferenceDataSourceV2_MappingParametersPropertyDef]] = pydantic.Field(None)
    CfnApplicationReferenceDataSourceV2_RecordColumnProperty: typing.Optional[dict[str, CfnApplicationReferenceDataSourceV2_RecordColumnPropertyDef]] = pydantic.Field(None)
    CfnApplicationReferenceDataSourceV2_RecordFormatProperty: typing.Optional[dict[str, CfnApplicationReferenceDataSourceV2_RecordFormatPropertyDef]] = pydantic.Field(None)
    CfnApplicationReferenceDataSourceV2_ReferenceDataSourceProperty: typing.Optional[dict[str, CfnApplicationReferenceDataSourceV2_ReferenceDataSourcePropertyDef]] = pydantic.Field(None)
    CfnApplicationReferenceDataSourceV2_ReferenceSchemaProperty: typing.Optional[dict[str, CfnApplicationReferenceDataSourceV2_ReferenceSchemaPropertyDef]] = pydantic.Field(None)
    CfnApplicationReferenceDataSourceV2_S3ReferenceDataSourceProperty: typing.Optional[dict[str, CfnApplicationReferenceDataSourceV2_S3ReferenceDataSourcePropertyDef]] = pydantic.Field(None)
    CfnApplicationV2_ApplicationCodeConfigurationProperty: typing.Optional[dict[str, CfnApplicationV2_ApplicationCodeConfigurationPropertyDef]] = pydantic.Field(None)
    CfnApplicationV2_ApplicationConfigurationProperty: typing.Optional[dict[str, CfnApplicationV2_ApplicationConfigurationPropertyDef]] = pydantic.Field(None)
    CfnApplicationV2_ApplicationMaintenanceConfigurationProperty: typing.Optional[dict[str, CfnApplicationV2_ApplicationMaintenanceConfigurationPropertyDef]] = pydantic.Field(None)
    CfnApplicationV2_ApplicationRestoreConfigurationProperty: typing.Optional[dict[str, CfnApplicationV2_ApplicationRestoreConfigurationPropertyDef]] = pydantic.Field(None)
    CfnApplicationV2_ApplicationSnapshotConfigurationProperty: typing.Optional[dict[str, CfnApplicationV2_ApplicationSnapshotConfigurationPropertyDef]] = pydantic.Field(None)
    CfnApplicationV2_CatalogConfigurationProperty: typing.Optional[dict[str, CfnApplicationV2_CatalogConfigurationPropertyDef]] = pydantic.Field(None)
    CfnApplicationV2_CheckpointConfigurationProperty: typing.Optional[dict[str, CfnApplicationV2_CheckpointConfigurationPropertyDef]] = pydantic.Field(None)
    CfnApplicationV2_CodeContentProperty: typing.Optional[dict[str, CfnApplicationV2_CodeContentPropertyDef]] = pydantic.Field(None)
    CfnApplicationV2_CSVMappingParametersProperty: typing.Optional[dict[str, CfnApplicationV2_CSVMappingParametersPropertyDef]] = pydantic.Field(None)
    CfnApplicationV2_CustomArtifactConfigurationProperty: typing.Optional[dict[str, CfnApplicationV2_CustomArtifactConfigurationPropertyDef]] = pydantic.Field(None)
    CfnApplicationV2_DeployAsApplicationConfigurationProperty: typing.Optional[dict[str, CfnApplicationV2_DeployAsApplicationConfigurationPropertyDef]] = pydantic.Field(None)
    CfnApplicationV2_EnvironmentPropertiesProperty: typing.Optional[dict[str, CfnApplicationV2_EnvironmentPropertiesPropertyDef]] = pydantic.Field(None)
    CfnApplicationV2_FlinkApplicationConfigurationProperty: typing.Optional[dict[str, CfnApplicationV2_FlinkApplicationConfigurationPropertyDef]] = pydantic.Field(None)
    CfnApplicationV2_FlinkRunConfigurationProperty: typing.Optional[dict[str, CfnApplicationV2_FlinkRunConfigurationPropertyDef]] = pydantic.Field(None)
    CfnApplicationV2_GlueDataCatalogConfigurationProperty: typing.Optional[dict[str, CfnApplicationV2_GlueDataCatalogConfigurationPropertyDef]] = pydantic.Field(None)
    CfnApplicationV2_InputLambdaProcessorProperty: typing.Optional[dict[str, CfnApplicationV2_InputLambdaProcessorPropertyDef]] = pydantic.Field(None)
    CfnApplicationV2_InputParallelismProperty: typing.Optional[dict[str, CfnApplicationV2_InputParallelismPropertyDef]] = pydantic.Field(None)
    CfnApplicationV2_InputProcessingConfigurationProperty: typing.Optional[dict[str, CfnApplicationV2_InputProcessingConfigurationPropertyDef]] = pydantic.Field(None)
    CfnApplicationV2_InputProperty: typing.Optional[dict[str, CfnApplicationV2_InputPropertyDef]] = pydantic.Field(None)
    CfnApplicationV2_InputSchemaProperty: typing.Optional[dict[str, CfnApplicationV2_InputSchemaPropertyDef]] = pydantic.Field(None)
    CfnApplicationV2_JSONMappingParametersProperty: typing.Optional[dict[str, CfnApplicationV2_JSONMappingParametersPropertyDef]] = pydantic.Field(None)
    CfnApplicationV2_KinesisFirehoseInputProperty: typing.Optional[dict[str, CfnApplicationV2_KinesisFirehoseInputPropertyDef]] = pydantic.Field(None)
    CfnApplicationV2_KinesisStreamsInputProperty: typing.Optional[dict[str, CfnApplicationV2_KinesisStreamsInputPropertyDef]] = pydantic.Field(None)
    CfnApplicationV2_MappingParametersProperty: typing.Optional[dict[str, CfnApplicationV2_MappingParametersPropertyDef]] = pydantic.Field(None)
    CfnApplicationV2_MavenReferenceProperty: typing.Optional[dict[str, CfnApplicationV2_MavenReferencePropertyDef]] = pydantic.Field(None)
    CfnApplicationV2_MonitoringConfigurationProperty: typing.Optional[dict[str, CfnApplicationV2_MonitoringConfigurationPropertyDef]] = pydantic.Field(None)
    CfnApplicationV2_ParallelismConfigurationProperty: typing.Optional[dict[str, CfnApplicationV2_ParallelismConfigurationPropertyDef]] = pydantic.Field(None)
    CfnApplicationV2_PropertyGroupProperty: typing.Optional[dict[str, CfnApplicationV2_PropertyGroupPropertyDef]] = pydantic.Field(None)
    CfnApplicationV2_RecordColumnProperty: typing.Optional[dict[str, CfnApplicationV2_RecordColumnPropertyDef]] = pydantic.Field(None)
    CfnApplicationV2_RecordFormatProperty: typing.Optional[dict[str, CfnApplicationV2_RecordFormatPropertyDef]] = pydantic.Field(None)
    CfnApplicationV2_RunConfigurationProperty: typing.Optional[dict[str, CfnApplicationV2_RunConfigurationPropertyDef]] = pydantic.Field(None)
    CfnApplicationV2_S3ContentBaseLocationProperty: typing.Optional[dict[str, CfnApplicationV2_S3ContentBaseLocationPropertyDef]] = pydantic.Field(None)
    CfnApplicationV2_S3ContentLocationProperty: typing.Optional[dict[str, CfnApplicationV2_S3ContentLocationPropertyDef]] = pydantic.Field(None)
    CfnApplicationV2_SqlApplicationConfigurationProperty: typing.Optional[dict[str, CfnApplicationV2_SqlApplicationConfigurationPropertyDef]] = pydantic.Field(None)
    CfnApplicationV2_VpcConfigurationProperty: typing.Optional[dict[str, CfnApplicationV2_VpcConfigurationPropertyDef]] = pydantic.Field(None)
    CfnApplicationV2_ZeppelinApplicationConfigurationProperty: typing.Optional[dict[str, CfnApplicationV2_ZeppelinApplicationConfigurationPropertyDef]] = pydantic.Field(None)
    CfnApplicationV2_ZeppelinMonitoringConfigurationProperty: typing.Optional[dict[str, CfnApplicationV2_ZeppelinMonitoringConfigurationPropertyDef]] = pydantic.Field(None)
    CfnApplication: typing.Optional[dict[str, CfnApplicationDef]] = pydantic.Field(None)
    CfnApplicationCloudWatchLoggingOptionV2: typing.Optional[dict[str, CfnApplicationCloudWatchLoggingOptionV2Def]] = pydantic.Field(None)
    CfnApplicationOutput: typing.Optional[dict[str, CfnApplicationOutputDef]] = pydantic.Field(None)
    CfnApplicationOutputV2: typing.Optional[dict[str, CfnApplicationOutputV2Def]] = pydantic.Field(None)
    CfnApplicationReferenceDataSource: typing.Optional[dict[str, CfnApplicationReferenceDataSourceDef]] = pydantic.Field(None)
    CfnApplicationReferenceDataSourceV2: typing.Optional[dict[str, CfnApplicationReferenceDataSourceV2Def]] = pydantic.Field(None)
    CfnApplicationV2: typing.Optional[dict[str, CfnApplicationV2Def]] = pydantic.Field(None)
    CfnApplicationCloudWatchLoggingOptionV2Props: typing.Optional[dict[str, CfnApplicationCloudWatchLoggingOptionV2PropsDef]] = pydantic.Field(None)
    CfnApplicationOutputProps: typing.Optional[dict[str, CfnApplicationOutputPropsDef]] = pydantic.Field(None)
    CfnApplicationOutputV2Props: typing.Optional[dict[str, CfnApplicationOutputV2PropsDef]] = pydantic.Field(None)
    ...
    CfnApplicationReferenceDataSourceV2Props: typing.Optional[dict[str, CfnApplicationReferenceDataSourceV2PropsDef]] = pydantic.Field(None)
    CfnApplicationV2Props: typing.Optional[dict[str, CfnApplicationV2PropsDef]] = pydantic.Field(None)
    ...
