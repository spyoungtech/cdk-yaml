...
class OriginGroupDef(BaseClass):
    fallback_origin: typing.Union[models.aws_cloudfront.OriginBaseDef, models.aws_cloudfront_origins.HttpOriginDef, models.aws_cloudfront_origins.LoadBalancerV2OriginDef, models.aws_cloudfront_origins.OriginGroupDef, models.aws_cloudfront_origins.RestApiOriginDef, models.aws_cloudfront_origins.S3OriginDef] = pydantic.Field(..., description='The fallback origin that should serve requests when the primary fails.')
    primary_origin: typing.Union[models.aws_cloudfront.OriginBaseDef, models.aws_cloudfront_origins.HttpOriginDef, models.aws_cloudfront_origins.LoadBalancerV2OriginDef, models.aws_cloudfront_origins.OriginGroupDef, models.aws_cloudfront_origins.RestApiOriginDef, models.aws_cloudfront_origins.S3OriginDef] = pydantic.Field(..., description='The primary origin that should serve requests for this group.\n')
