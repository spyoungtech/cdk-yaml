...
class ContainerImageAssetMetadataEntryDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['packaging', 'path', 'source_hash', 'build_args', 'build_secrets', 'build_ssh', 'cache_from', 'cache_to', 'file', 'image_tag', 'network_mode', 'outputs', 'platform', 'repository_name', 'target']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class DockerImageSourceDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['cache_from', 'cache_to', 'directory', 'docker_build_args', 'docker_build_secrets', 'docker_build_ssh', 'docker_build_target', 'docker_file', 'docker_outputs', 'executable', 'network_mode', 'platform']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
