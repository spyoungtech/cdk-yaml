...
class ManifestDef(BaseClass):
    ...
    load_assembly_manifest: typing.Optional[ManifestDefLoadAssemblyManifestParams] = pydantic.Field(None, description='Load and validates the cloud assembly manifest from file.')
    load_asset_manifest: typing.Optional[ManifestDefLoadAssetManifestParams] = pydantic.Field(None, description='Load and validates the asset manifest from file.')
    load_integ_manifest: typing.Optional[ManifestDefLoadIntegManifestParams] = pydantic.Field(None, description='Load and validates the integ manifest from file.')
    resource_config: typing.Optional[ManifestDefConfig] = pydantic.Field(None)


class ManifestDefConfig(pydantic.BaseModel):
    save_assembly_manifest: typing.Optional[list[ManifestDefSaveAssemblyManifestParams]] = pydantic.Field(None, description='Validates and saves the cloud assembly manifest to file.')
    save_asset_manifest: typing.Optional[list[ManifestDefSaveAssetManifestParams]] = pydantic.Field(None, description='Validates and saves the asset manifest to file.')
    save_integ_manifest: typing.Optional[list[ManifestDefSaveIntegManifestParams]] = pydantic.Field(None, description='Validates and saves the integ manifest to file.')
...
class AmiContextQueryDef(BaseStruct):
    account: str = pydantic.Field(..., description='Account to query.\n')
    filters: typing.Mapping[str, typing.Sequence[str]] = pydantic.Field(..., description='Filters to DescribeImages call.\n')
    region: str = pydantic.Field(..., description='Region to query.\n')
...
class AssemblyManifestDef(BaseStruct):
    version: str = pydantic.Field(..., description='Protocol version.\n')
...
class AssetManifestDef(BaseStruct):
    version: str = pydantic.Field(..., description='Version of the manifest.\n')
...
class AvailabilityZonesContextQueryDef(BaseStruct):
    account: str = pydantic.Field(..., description='Query account.\n')
    region: str = pydantic.Field(..., description='Query region.\n')
...
class BootstrapRoleDef(BaseStruct):
    arn: str = pydantic.Field(..., description='The ARN of the IAM role created as part of bootrapping e.g. lookupRoleArn.\n')
...
class ContainerImageAssetMetadataEntryDef(BaseStruct):
    packaging: str = pydantic.Field(..., description='Type of asset.\n')
    path: str = pydantic.Field(..., description='Path on disk to the asset.\n')
    source_hash: str = pydantic.Field(..., description='The hash of the asset source.\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['packaging', 'path', 'source_hash', 'build_args', 'build_secrets', 'cache_from', 'cache_to', 'file', 'image_tag', 'network_mode', 'outputs', 'platform', 'repository_name', 'target']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class DockerImageAssetDef(BaseStruct):
    destinations: typing.Mapping[str, typing.Union[models.cloud_assembly_schema.DockerImageDestinationDef, dict[str, typing.Any]]] = pydantic.Field(..., description='Destinations for this file asset.\n')
    source: typing.Union[models.cloud_assembly_schema.DockerImageSourceDef, dict[str, typing.Any]] = pydantic.Field(..., description='Source description for file assets.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import cloud_assembly_schema\n\n    docker_image_asset = cloud_assembly_schema.DockerImageAsset(\n        destinations={\n            "destinations_key": cloud_assembly_schema.DockerImageDestination(\n                image_tag="imageTag",\n                repository_name="repositoryName",\n\n                # the properties below are optional\n                assume_role_arn="assumeRoleArn",\n                assume_role_external_id="assumeRoleExternalId",\n                region="region"\n            )\n        },\n        source=cloud_assembly_schema.DockerImageSource(\n            cache_from=[cloud_assembly_schema.DockerCacheOption(\n                type="type",\n\n                # the properties below are optional\n                params={\n                    "params_key": "params"\n                }\n            )],\n            cache_to=cloud_assembly_schema.DockerCacheOption(\n                type="type",\n\n                # the properties below are optional\n                params={\n                    "params_key": "params"\n                }\n            ),\n            directory="directory",\n            docker_build_args={\n                "docker_build_args_key": "dockerBuildArgs"\n            },\n            docker_build_secrets={\n                "docker_build_secrets_key": "dockerBuildSecrets"\n            },\n            docker_build_target="dockerBuildTarget",\n            docker_file="dockerFile",\n            docker_outputs=["dockerOutputs"],\n            executable=["executable"],\n            network_mode="networkMode",\n            platform="platform"\n        )\n    )\n')
...
class DockerImageSourceDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['cache_from', 'cache_to', 'directory', 'docker_build_args', 'docker_build_secrets', 'docker_build_target', 'docker_file', 'docker_outputs', 'executable', 'network_mode', 'platform']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class EndpointServiceAvailabilityZonesContextQueryDef(BaseStruct):
    account: str = pydantic.Field(..., description='Query account.\n')
    region: str = pydantic.Field(..., description='Query region.\n')
    service_name: str = pydantic.Field(..., description='Query service name.\n')
...
class FileAssetDef(BaseStruct):
    destinations: typing.Mapping[str, typing.Union[models.cloud_assembly_schema.FileDestinationDef, dict[str, typing.Any]]] = pydantic.Field(..., description='Destinations for this file asset.\n')
    source: typing.Union[models.cloud_assembly_schema.FileSourceDef, dict[str, typing.Any]] = pydantic.Field(..., description='Source description for file assets.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import cloud_assembly_schema\n\n    file_asset = cloud_assembly_schema.FileAsset(\n        destinations={\n            "destinations_key": cloud_assembly_schema.FileDestination(\n                bucket_name="bucketName",\n                object_key="objectKey",\n\n                # the properties below are optional\n                assume_role_arn="assumeRoleArn",\n                assume_role_external_id="assumeRoleExternalId",\n                region="region"\n            )\n        },\n        source=cloud_assembly_schema.FileSource(\n            executable=["executable"],\n            packaging=cloud_assembly_schema.FileAssetPackaging.FILE,\n            path="path"\n        )\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['destinations', 'source']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class FileAssetMetadataEntryDef(BaseStruct):
    artifact_hash_parameter: str = pydantic.Field(..., description='The name of the parameter where the hash of the bundled asset should be passed in.\n')
    packaging: str = pydantic.Field(..., description='Requested packaging style.\n')
    path: str = pydantic.Field(..., description='Path on disk to the asset.\n')
    s3_bucket_parameter: str = pydantic.Field(..., description='Name of parameter where S3 bucket should be passed in.\n')
    s3_key_parameter: str = pydantic.Field(..., description='Name of parameter where S3 key should be passed in.\n')
...
class HostedZoneContextQueryDef(BaseStruct):
    account: str = pydantic.Field(..., description='Query account.\n')
    domain_name: str = pydantic.Field(..., description='The domain name e.g. example.com to lookup.\n')
    region: str = pydantic.Field(..., description='Query region.\n')
    lookup_role_arn: typing.Optional[str] = pydantic.Field(None, description='The ARN of the role that should be used to look up the missing values. Default: - None\n')
...
class IntegManifestDef(BaseStruct):
    test_cases: typing.Mapping[str, typing.Union[models.cloud_assembly_schema.TestCaseDef, dict[str, typing.Any]]] = pydantic.Field(..., description='test cases.\n')
    version: str = pydantic.Field(..., description='Version of the manifest.\n')
...
class KeyContextQueryDef(BaseStruct):
    account: str = pydantic.Field(..., description='Query account.\n')
    alias_name: str = pydantic.Field(..., description='Alias name used to search the Key.\n')
    region: str = pydantic.Field(..., description='Query region.\n')
...
class LoadBalancerContextQueryDef(BaseStruct):
    load_balancer_type: aws_cdk.cloud_assembly_schema.LoadBalancerType = pydantic.Field(..., description='Filter load balancers by their type.\n')
...
class NestedCloudAssemblyPropertiesDef(BaseStruct):
    directory_name: str = pydantic.Field(..., description='Relative path to the nested cloud assembly.\n')
...
class PluginContextQueryDef(BaseStruct):
    plugin_name: str = pydantic.Field(..., description='The name of the plugin.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import cloud_assembly_schema\n\n    plugin_context_query = cloud_assembly_schema.PluginContextQuery(\n        plugin_name="pluginName"\n    )\n')
...
class RuntimeInfoDef(BaseStruct):
    libraries: typing.Mapping[str, str] = pydantic.Field(..., description='The list of libraries loaded in the application, associated with their versions.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import cloud_assembly_schema\n\n    runtime_info = cloud_assembly_schema.RuntimeInfo(\n        libraries={\n            "libraries_key": "libraries"\n        }\n    )\n')
...
class SSMParameterContextQueryDef(BaseStruct):
    account: str = pydantic.Field(..., description='Query account.\n')
    parameter_name: str = pydantic.Field(..., description='Parameter name to query.\n')
    region: str = pydantic.Field(..., description='Query region.\n')
...
class TagDef(BaseStruct):
    key: str = pydantic.Field(..., description='Tag key. (In the actual file on disk this will be cased as "Key", and the structure is patched to match this structure upon loading: https://github.com/aws/aws-cdk/blob/4aadaa779b48f35838cccd4e25107b2338f05547/packages/%40aws-cdk/cloud-assembly-schema/lib/manifest.ts#L137)\n')
    value: str = pydantic.Field(..., description='Tag value. (In the actual file on disk this will be cased as "Value", and the structure is patched to match this structure upon loading: https://github.com/aws/aws-cdk/blob/4aadaa779b48f35838cccd4e25107b2338f05547/packages/%40aws-cdk/cloud-assembly-schema/lib/manifest.ts#L137)\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import cloud_assembly_schema\n\n    tag = cloud_assembly_schema.Tag(\n        key="key",\n        value="value"\n    )\n')
...
class TestCaseDef(BaseStruct):
    ...
    stacks: typing.Sequence[str] = pydantic.Field(..., description='Stacks that should be tested as part of this test case The stackNames will be passed as args to the cdk commands so dependent stacks will be automatically deployed unless ``exclusively`` is passed.\n')
...
class VpcContextQueryDef(BaseStruct):
    account: str = pydantic.Field(..., description='Query account.\n')
    filter: typing.Mapping[str, str] = pydantic.Field(..., description='Filters to apply to the VPC. Filter parameters are the same as passed to DescribeVpcs.\n')
    region: str = pydantic.Field(..., description='Query region.\n')
    lookup_role_arn: typing.Optional[str] = pydantic.Field(None, description='The ARN of the role that should be used to look up the missing values. Default: - None\n')
...
class ModuleModel(pydantic.BaseModel):
    Manifest: typing.Optional[dict[str, ManifestDef]] = pydantic.Field(None)
    AmiContextQuery: typing.Optional[dict[str, AmiContextQueryDef]] = pydantic.Field(None)
    ArtifactManifest: typing.Optional[dict[str, ArtifactManifestDef]] = pydantic.Field(None)
    AssemblyManifest: typing.Optional[dict[str, AssemblyManifestDef]] = pydantic.Field(None)
    AssetManifest: typing.Optional[dict[str, AssetManifestDef]] = pydantic.Field(None)
    AssetManifestOptions: typing.Optional[dict[str, AssetManifestOptionsDef]] = pydantic.Field(None)
    AssetManifestProperties: typing.Optional[dict[str, AssetManifestPropertiesDef]] = pydantic.Field(None)
    AvailabilityZonesContextQuery: typing.Optional[dict[str, AvailabilityZonesContextQueryDef]] = pydantic.Field(None)
    AwsCloudFormationStackProperties: typing.Optional[dict[str, AwsCloudFormationStackPropertiesDef]] = pydantic.Field(None)
    AwsDestination: typing.Optional[dict[str, AwsDestinationDef]] = pydantic.Field(None)
    BootstrapRole: typing.Optional[dict[str, BootstrapRoleDef]] = pydantic.Field(None)
    CdkCommand: typing.Optional[dict[str, CdkCommandDef]] = pydantic.Field(None)
    CdkCommands: typing.Optional[dict[str, CdkCommandsDef]] = pydantic.Field(None)
    ContainerImageAssetCacheOption: typing.Optional[dict[str, ContainerImageAssetCacheOptionDef]] = pydantic.Field(None)
    ContainerImageAssetMetadataEntry: typing.Optional[dict[str, ContainerImageAssetMetadataEntryDef]] = pydantic.Field(None)
    DefaultCdkOptions: typing.Optional[dict[str, DefaultCdkOptionsDef]] = pydantic.Field(None)
    DeployCommand: typing.Optional[dict[str, DeployCommandDef]] = pydantic.Field(None)
    DeployOptions: typing.Optional[dict[str, DeployOptionsDef]] = pydantic.Field(None)
    DestroyCommand: typing.Optional[dict[str, DestroyCommandDef]] = pydantic.Field(None)
    DestroyOptions: typing.Optional[dict[str, DestroyOptionsDef]] = pydantic.Field(None)
    ...
    DockerImageDestination: typing.Optional[dict[str, DockerImageDestinationDef]] = pydantic.Field(None)
    DockerImageSource: typing.Optional[dict[str, DockerImageSourceDef]] = pydantic.Field(None)
    ...
    FileAsset: typing.Optional[dict[str, FileAssetDef]] = pydantic.Field(None)
    FileAssetMetadataEntry: typing.Optional[dict[str, FileAssetMetadataEntryDef]] = pydantic.Field(None)
    FileDestination: typing.Optional[dict[str, FileDestinationDef]] = pydantic.Field(None)
    FileSource: typing.Optional[dict[str, FileSourceDef]] = pydantic.Field(None)
    Hooks: typing.Optional[dict[str, HooksDef]] = pydantic.Field(None)
    HostedZoneContextQuery: typing.Optional[dict[str, HostedZoneContextQueryDef]] = pydantic.Field(None)
    IntegManifest: typing.Optional[dict[str, IntegManifestDef]] = pydantic.Field(None)
    KeyContextQuery: typing.Optional[dict[str, KeyContextQueryDef]] = pydantic.Field(None)
    LoadBalancerContextQuery: typing.Optional[dict[str, LoadBalancerContextQueryDef]] = pydantic.Field(None)
    LoadBalancerFilter: typing.Optional[dict[str, LoadBalancerFilterDef]] = pydantic.Field(None)
    LoadBalancerListenerContextQuery: typing.Optional[dict[str, LoadBalancerListenerContextQueryDef]] = pydantic.Field(None)
    LoadManifestOptions: typing.Optional[dict[str, LoadManifestOptionsDef]] = pydantic.Field(None)
    MetadataEntry: typing.Optional[dict[str, MetadataEntryDef]] = pydantic.Field(None)
    MissingContext: typing.Optional[dict[str, MissingContextDef]] = pydantic.Field(None)
    NestedCloudAssemblyProperties: typing.Optional[dict[str, NestedCloudAssemblyPropertiesDef]] = pydantic.Field(None)
    PluginContextQuery: typing.Optional[dict[str, PluginContextQueryDef]] = pydantic.Field(None)
    RuntimeInfo: typing.Optional[dict[str, RuntimeInfoDef]] = pydantic.Field(None)
    SecurityGroupContextQuery: typing.Optional[dict[str, SecurityGroupContextQueryDef]] = pydantic.Field(None)
    SSMParameterContextQuery: typing.Optional[dict[str, SSMParameterContextQueryDef]] = pydantic.Field(None)
    Tag: typing.Optional[dict[str, TagDef]] = pydantic.Field(None)
    TestCase: typing.Optional[dict[str, TestCaseDef]] = pydantic.Field(None)
    TestOptions: typing.Optional[dict[str, TestOptionsDef]] = pydantic.Field(None)
    TreeArtifactProperties: typing.Optional[dict[str, TreeArtifactPropertiesDef]] = pydantic.Field(None)
    VpcContextQuery: typing.Optional[dict[str, VpcContextQueryDef]] = pydantic.Field(None)
    ...
