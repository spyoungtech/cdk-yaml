...
class StringListParameterDefConfig(pydantic.BaseModel):
    ...
    grant_read: typing.Optional[list[models.aws_ssm.StringListParameterDefGrantReadParams]] = pydantic.Field(None, description='Grants read (DescribeParameter, GetParameters, GetParameter, GetParameterHistory) permissions on the SSM Parameter.')
...
class StringParameterDefConfig(pydantic.BaseModel):
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    grant_read: typing.Optional[list[models.aws_ssm.StringParameterDefGrantReadParams]] = pydantic.Field(None, description='Grants read (DescribeParameter, GetParameters, GetParameter, GetParameterHistory) permissions on the SSM Parameter.')
...
class CfnPatchBaseline_PatchSourcePropertyDef(BaseStruct):
    ...
    products: typing.Optional[typing.Sequence[str]] = pydantic.Field(None, description='The specific operating system versions a patch repository applies to, such as "Ubuntu16.04", "RedhatEnterpriseLinux7.2" or "Suse12.7". For lists of supported product values, see `PatchFilter <https://docs.aws.amazon.com/systems-manager/latest/APIReference/API_PatchFilter.html>`_ in the *AWS Systems Manager API Reference* .\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ssm-patchbaseline-patchsource.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_ssm as ssm\n\n    patch_source_property = ssm.CfnPatchBaseline.PatchSourceProperty(\n        configuration="configuration",\n        name="name",\n        products=["products"]\n    )\n')
...
class CfnPatchBaseline_RulePropertyDef(BaseStruct):
    ...
    enable_non_security: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='For managed nodes identified by the approval rule filters, enables a patch baseline to apply non-security updates available in the specified repository. The default value is ``false`` . Applies to Linux managed nodes only. Default: - false\n')
...
class CfnDocumentDef(BaseCfnResource):
    ...
    name: typing.Optional[str] = pydantic.Field(None, description="A name for the SSM document. .. epigraph:: You can't use the following strings as document name prefixes. These are reserved by AWS for use as document name prefixes: - ``aws`` - ``amazon`` - ``amzn`` - ``AWSEC2`` - ``AWSConfigRemediation`` - ``AWSSupport``\n")
...
class CfnPatchBaselineDef(BaseCfnResource):
    ...
    approved_patches_compliance_level: typing.Optional[str] = pydantic.Field(None, description='Defines the compliance level for approved patches. When an approved patch is reported as missing, this value describes the severity of the compliance violation. The default value is ``UNSPECIFIED`` . Default: - "UNSPECIFIED"\n')
    approved_patches_enable_non_security: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='Indicates whether the list of approved patches includes non-security updates that should be applied to the managed nodes. The default value is ``false`` . Applies to Linux managed nodes only. Default: - false\n')
    default_baseline: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='Set the baseline as default baseline. Only registering to default patch baseline is allowed. Default: - false\n')
    ...
    operating_system: typing.Optional[str] = pydantic.Field(None, description='Defines the operating system the patch baseline applies to. The default value is ``WINDOWS`` . Default: - "WINDOWS"\n')
    ...
    _init_params: typing.ClassVar[list[str]] = ['name', 'approval_rules', 'approved_patches', 'approved_patches_compliance_level', 'approved_patches_enable_non_security', 'default_baseline', 'description', 'global_filters', 'operating_system', 'patch_groups', 'rejected_patches', 'rejected_patches_action', 'sources', 'tags']
...
class CfnResourceDataSyncDef(BaseCfnResource):
    sync_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A name for the resource data sync.\n')
    ...
    kms_key_arn: typing.Optional[str] = pydantic.Field(None, description='The Amazon Resource Name (ARN) of an encryption key for a destination in Amazon S3 . You can use a KMS key to encrypt inventory data in Amazon S3 . You must specify a key that exist in the same AWS Region as the destination Amazon S3 bucket.\n')
...
class CfnResourcePolicyDef(BaseCfnResource):
    ...
    resource_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Amazon Resource Name (ARN) of the resource to which you want to attach a policy.')
