...
class CfnDetector_CFNFeatureConfigurationPropertyDef(BaseStruct):
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Name of the feature.\n')
...
class CfnFilter_FindingCriteriaPropertyDef(BaseStruct):
    ...
    item_type: typing.Union[models.UnsupportedResource, models.aws_guardduty.CfnFilter_ConditionPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Specifies the condition to be applied to a single field when filtering through findings.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-guardduty-filter-findingcriteria.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_guardduty as guardduty\n\n    # criterion: Any\n\n    finding_criteria_property = guardduty.CfnFilter.FindingCriteriaProperty(\n        criterion=criterion,\n        item_type=guardduty.CfnFilter.ConditionProperty(\n            eq=["eq"],\n            equal_to=["equalTo"],\n            greater_than=123,\n            greater_than_or_equal=123,\n            gt=123,\n            gte=123,\n            less_than=123,\n            less_than_or_equal=123,\n            lt=123,\n            lte=123,\n            neq=["neq"],\n            not_equals=["notEquals"]\n        )\n    )\n')
...
class CfnDetectorDefConfig(pydantic.BaseModel):
    ...
    CFNFeatureAdditionalConfigurationProperty: typing.Optional[list[CfnDetectorDefCfnfeatureadditionalconfigurationpropertyParams]] = pydantic.Field(None, description='')
    CFNFeatureConfigurationProperty: typing.Optional[list[CfnDetectorDefCfnfeatureconfigurationpropertyParams]] = pydantic.Field(None, description='')
    ...
    TagItemProperty: typing.Optional[list[CfnDetectorDefTagitempropertyParams]] = pydantic.Field(None, description='')
...
class CfnFilterDef(BaseCfnResource):
    action: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Specifies the action that is to be applied to the findings that match the filter.\n')
    description: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The description of the filter. Valid characters include alphanumeric characters, and special characters such as hyphen, period, colon, underscore, parentheses ( ``{ }`` , ``[ ]`` , and ``( )`` ), forward slash, horizontal tab, vertical tab, newline, form feed, return, and whitespace.\n')
...
class CfnIPSetDef(BaseCfnResource):
    activate: typing.Union[_REQUIRED_INIT_PARAM, bool, models.UnsupportedResource] = pydantic.Field(REQUIRED_INIT_PARAM, description='Indicates whether or not GuardDuty uses the ``IPSet`` .\n')
    detector_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The unique ID of the detector of the GuardDuty account that you want to create an IPSet for.\n')
...
class CfnMasterDef(BaseCfnResource):
    ...
    master_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='')
...
class CfnMemberDef(BaseCfnResource):
    detector_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The ID of the detector associated with the GuardDuty service to add the member to.\n')
    ...
    member_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='')
...
class CfnThreatIntelSetDef(BaseCfnResource):
    activate: typing.Union[_REQUIRED_INIT_PARAM, bool, models.UnsupportedResource] = pydantic.Field(REQUIRED_INIT_PARAM, description='A Boolean value that indicates whether GuardDuty is to start using the uploaded ThreatIntelSet.\n')
    detector_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The unique ID of the detector of the GuardDuty account that you want to create a threatIntelSet for.\n')
...
class ModuleModel(pydantic.BaseModel):
    ...
    CfnDetector_CFNFeatureAdditionalConfigurationProperty: typing.Optional[dict[str, CfnDetector_CFNFeatureAdditionalConfigurationPropertyDef]] = pydantic.Field(None)
    CfnDetector_CFNFeatureConfigurationProperty: typing.Optional[dict[str, CfnDetector_CFNFeatureConfigurationPropertyDef]] = pydantic.Field(None)
    ...
    CfnDetector_TagItemProperty: typing.Optional[dict[str, CfnDetector_TagItemPropertyDef]] = pydantic.Field(None)
