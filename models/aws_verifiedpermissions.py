...
class CfnIdentitySource_IdentitySourceConfigurationPropertyDef(BaseStruct):
    cognito_user_pool_configuration: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_verifiedpermissions.CfnIdentitySource_CognitoUserPoolConfigurationPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='A structure that contains configuration information used when creating or updating an identity source that represents a connection to an Amazon Cognito user pool used as an identity provider for Verified Permissions .\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-verifiedpermissions-identitysource-identitysourceconfiguration.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_verifiedpermissions as verifiedpermissions\n\n    identity_source_configuration_property = verifiedpermissions.CfnIdentitySource.IdentitySourceConfigurationProperty(\n        cognito_user_pool_configuration=verifiedpermissions.CfnIdentitySource.CognitoUserPoolConfigurationProperty(\n            user_pool_arn="userPoolArn",\n\n            # the properties below are optional\n            client_ids=["clientIds"]\n        )\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['cognito_user_pool_configuration']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnIdentitySource_IdentitySourceDetailsPropertyDef(BaseStruct):
    client_ids: typing.Optional[typing.Sequence[str]] = pydantic.Field(None, description='The application client IDs associated with the specified Amazon Cognito user pool that are enabled for this identity source.\n')
    discovery_url: typing.Optional[str] = pydantic.Field(None, description="The well-known URL that points to this user pool's OIDC discovery endpoint. This is a URL string in the following format. This URL replaces the placeholders for both the AWS Region and the user pool identifier with those appropriate for this user pool. ``https://cognito-idp. *<region>* .amazonaws.com/ *<user-pool-id>* /.well-known/openid-configuration``\n")
    open_id_issuer: typing.Optional[str] = pydantic.Field(None, description='A string that identifies the type of OIDC service represented by this . At this time, the only valid value is ``cognito`` .\n')
    user_pool_arn: typing.Optional[str] = pydantic.Field(None, description='The `Amazon Resource Name (ARN) <https://docs.aws.amazon.com//general/latest/gr/aws-arns-and-namespaces.html>`_ of the Amazon Cognito user pool whose identities are accessible to this Verified Permissions policy store.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-verifiedpermissions-identitysource-identitysourcedetails.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_verifiedpermissions as verifiedpermissions\n\n    identity_source_details_property = verifiedpermissions.CfnIdentitySource.IdentitySourceDetailsProperty(\n        client_ids=["clientIds"],\n        discovery_url="discoveryUrl",\n        open_id_issuer="openIdIssuer",\n        user_pool_arn="userPoolArn"\n    )\n')
...
class CfnIdentitySourceDef(BaseCfnResource):
    configuration: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_verifiedpermissions.CfnIdentitySource_IdentitySourceConfigurationPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='Contains configuration information used when creating a new . .. epigraph:: At this time, the only valid member of this structure is a user pool configuration. You must specify a ``userPoolArn`` , and optionally, a ``ClientId`` . This data type is used as a request parameter for the `CreateIdentitySource <https://docs.aws.amazon.com/API_CreateIdentitySource.html>`_ operation.\n')
    policy_store_id: typing.Optional[str] = pydantic.Field(None, description='Specifies the ID of the in which you want to store this . Only policies and requests made using this can reference identities from the identity provider configured in the new .\n')
    principal_entity_type: typing.Optional[str] = pydantic.Field(None, description='Specifies the namespace and data type of the principals generated for identities authenticated by the new .')
    _init_params: typing.ClassVar[list[str]] = ['configuration', 'policy_store_id', 'principal_entity_type']
    _method_names: typing.ClassVar[list[str]] = ['CognitoUserPoolConfigurationProperty', 'IdentitySourceConfigurationProperty', 'IdentitySourceDetailsProperty', 'add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnIdentitySourceDefIdentitysourceconfigurationpropertyParams(pydantic.BaseModel):
    cognito_user_pool_configuration: typing.Union[models.UnsupportedResource, models.aws_verifiedpermissions.CfnIdentitySource_CognitoUserPoolConfigurationPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    ...
...
class CfnPolicyDef(BaseCfnResource):
    ...
    policy_store_id: typing.Optional[str] = pydantic.Field(None, description='Specifies the ``PolicyStoreId`` of the you want to store the policy in.')
...
class CfnPolicyStoreDef(BaseCfnResource):
    ...
    _init_params: typing.ClassVar[list[str]] = ['validation_settings', 'schema']
...
class CfnPolicyTemplateDef(BaseCfnResource):
    statement: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Specifies the content that you want to use for the new , written in the policy language.\n')
    ...
    policy_store_id: typing.Optional[str] = pydantic.Field(None, description='The unique identifier of the policy store that contains the template.')
    _init_params: typing.ClassVar[list[str]] = ['statement', 'description', 'policy_store_id']
