...
class AnnotationsDef(BaseClass):
    ...
    _method_names: typing.ClassVar[list[str]] = ['add_deprecation', 'add_error', 'add_info', 'add_warning']
...
class AnnotationsDefConfig(pydantic.BaseModel):
    ...
    add_warning: typing.Optional[list[AnnotationsDefAddWarningParams]] = pydantic.Field(None, description='Adds a warning metadata entry to this construct.\nThe CLI will display the warning when an app is synthesized, or fail if run\nin --strict mode.')
...
class CfnDynamicReferenceDef(BaseClass):
    service: aws_cdk.CfnDynamicReferenceService = pydantic.Field(..., description='-')
...
class CfnWaitConditionHandleDef(BaseClass):
    _init_params: typing.ClassVar[list[str]] = []
...
class DockerIgnoreStrategyDef(BaseClass):
    absolute_root_path: str = pydantic.Field(..., description='-')
...
class DockerImageDef(BaseClass):
    image: str = pydantic.Field(..., description='The Docker image.')
...
class NestedStackSynthesizerDef(BaseClass):
    parent_deployment: typing.Union[models.BootstraplessSynthesizerDef, models.CliCredentialsStackSynthesizerDef, models.DefaultStackSynthesizerDef, models.LegacyStackSynthesizerDef, models.NestedStackSynthesizerDef, models.StackSynthesizerDef] = pydantic.Field(..., description='-')
...
class ReferenceDef(BaseClass):
    value: typing.Any = pydantic.Field(..., description='-')
    target: models.AnyResource = pydantic.Field(..., description='-\n')
...
class RemoveTagDef(BaseClass):
    key: str = pydantic.Field(..., description='The string key for the tag.')
...
class SecretValueDef(BaseClass):
    protected_value: typing.Any = pydantic.Field(..., description='-\n')
    stack_trace: typing.Optional[bool] = pydantic.Field(None, description='Capture the stack trace of where this token is created. Default: true\n')
    type_hint: typing.Optional[aws_cdk.ResolutionTypeHint] = pydantic.Field(None, description='Type that this token is expected to evaluate to. Default: ResolutionTypeHint.STRING')
...
class TagManagerDef(BaseClass):
    tag_type: aws_cdk.TagType = pydantic.Field(..., description='-')
    resource_type_name: str = pydantic.Field(..., description='-\n')
...
class AssetStagingDef(BaseConstruct):
    source_path: str = pydantic.Field(..., description='The source file or directory to copy from.\n')
    extra_hash: typing.Optional[str] = pydantic.Field(None, description='Extra information to encode into the fingerprint (e.g. build instructions and other inputs). Default: - hash is only based on source content\n')
...
class CustomResourceProviderDef(BaseConstruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['code_directory', 'runtime', 'description', 'environment', 'memory_size', 'policy_statements', 'timeout']
...
class StackDef(BaseConstruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['analytics_reporting', 'cross_region_references', 'description', 'env', 'permissions_boundary', 'stack_name', 'synthesizer', 'tags', 'termination_protection']
...
class BundlingOptionsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['image', 'bundling_file_access', 'command', 'entrypoint', 'environment', 'local', 'network', 'output_type', 'security_opt', 'user', 'volumes', 'volumes_from', 'working_directory']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class DockerBuildOptionsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['build_args', 'file', 'platform', 'target_stage']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class DockerCacheOptionDef(BaseStruct):
    type: str = pydantic.Field(..., description='The type of cache to use. Refer to https://docs.docker.com/build/cache/backends/ for full list of backends. Default: - unspecified\n')
...
class DockerImageAssetLocationDef(BaseStruct):
    image_uri: str = pydantic.Field(..., description='The URI of the image in Amazon ECR (including a tag).\n')
    repository_name: str = pydantic.Field(..., description='The name of the ECR repository.\n')
...
class DockerImageAssetSourceDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['source_hash', 'asset_name', 'directory_name', 'docker_build_args', 'docker_build_secrets', 'docker_build_target', 'docker_cache_from', 'docker_cache_to', 'docker_file', 'docker_outputs', 'executable', 'network_mode', 'platform']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class DockerRunOptionsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['command', 'entrypoint', 'environment', 'network', 'security_opt', 'user', 'volumes', 'volumes_from', 'working_directory']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class DockerVolumeDef(BaseStruct):
    container_path: str = pydantic.Field(..., description='The path where the file or directory is mounted in the container.\n')
    host_path: str = pydantic.Field(..., description='The path to the file or directory on the host machine.\n')
...
class FileAssetLocationDef(BaseStruct):
    bucket_name: str = pydantic.Field(..., description='The name of the Amazon S3 bucket.\n')
    http_url: str = pydantic.Field(..., description='The HTTP URL of this asset on Amazon S3. This value suitable for inclusion in a CloudFormation template, and may be an encoded token. Example value: ``https://s3-us-east-1.amazonaws.com/mybucket/myobject``\n')
    object_key: str = pydantic.Field(..., description='The Amazon S3 object key.\n')
    s3_object_url: str = pydantic.Field(..., description='The S3 URL of this asset on Amazon S3. This value suitable for inclusion in a CloudFormation template, and may be an encoded token. Example value: ``s3://mybucket/myobject``\n')
...
class GetContextKeyResultDef(BaseStruct):
    key: str = pydantic.Field(..., description='')
    props: typing.Mapping[str, typing.Any] = pydantic.Field(..., description='')
...
class PolicyValidationPluginReportBeta1Def(BaseStruct):
    success: bool = pydantic.Field(..., description='Whether or not the report was successful.\n')
    violations: typing.Sequence[typing.Union[models.PolicyViolationBeta1Def, dict[str, typing.Any]]] = pydantic.Field(..., description='List of violations in the report.\n')
...
class PolicyViolatingResourceBeta1Def(BaseStruct):
    locations: typing.Sequence[str] = pydantic.Field(..., description='The locations in the CloudFormation template that pose the violations.\n')
    resource_logical_id: str = pydantic.Field(..., description='The logical ID of the resource in the CloudFormation template.\n')
    template_path: str = pydantic.Field(..., description='The path to the CloudFormation template that contains this resource.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    import aws_cdk as cdk\n\n    policy_violating_resource_beta1 = cdk.PolicyViolatingResourceBeta1(\n        locations=["locations"],\n        resource_logical_id="resourceLogicalId",\n        template_path="templatePath"\n    )\n')
...
class PolicyViolationBeta1Def(BaseStruct):
    description: str = pydantic.Field(..., description='The description of the violation.\n')
    rule_name: str = pydantic.Field(..., description='The name of the rule.\n')
    violating_resources: typing.Sequence[typing.Union[models.PolicyViolatingResourceBeta1Def, dict[str, typing.Any]]] = pydantic.Field(..., description='The resources violating this rule.\n')
...
class ResourceEnvironmentDef(BaseStruct):
    account: str = pydantic.Field(..., description="The AWS account ID that this resource belongs to. Since this can be a Token (for example, when the account is CloudFormation's AWS::AccountId intrinsic), make sure to use Token.compareStrings() instead of just comparing the values for equality.\n")
    region: str = pydantic.Field(..., description='The AWS region that this resource belongs to. Since this can be a Token (for example, when the region is CloudFormation\'s AWS::Region intrinsic), make sure to use Token.compareStrings() instead of just comparing the values for equality.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    import aws_cdk as cdk\n\n    resource_environment = cdk.ResourceEnvironment(\n        account="account",\n        region="region"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['account', 'region']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class RoleOptionsDef(BaseStruct):
    assume_role_arn: str = pydantic.Field(..., description='ARN of the role to assume.\n')
...
class CfnCodeDeployBlueGreenHookDef(BaseCfnResource):
    applications: typing.Sequence[typing.Union[models.CfnCodeDeployBlueGreenApplicationDef, dict[str, typing.Any]]] = pydantic.Field(..., description='Properties of the Amazon ECS applications being deployed.\n')
    service_role: str = pydantic.Field(..., description='The IAM Role for CloudFormation to use to perform blue-green deployments.\n')
...
class CfnCustomResourceDef(BaseCfnResource):
    service_token: str = pydantic.Field(..., description=".. epigraph:: Only one property is defined by AWS for a custom resource: ``ServiceToken`` . All other properties are defined by the service provider. The service token that was given to the template developer by the service provider to access the service, such as an Amazon SNS topic ARN or Lambda function ARN. The service token must be from the same Region in which you are creating the stack. Updates aren't supported.")
...
class CfnHookDef(BaseCfnResource):
    type: str = pydantic.Field(..., description='The type of the hook (for example, "AWS::CodeDeploy::BlueGreen").\n')
...
class CfnHookTypeConfigDef(BaseCfnResource):
    configuration: str = pydantic.Field(..., description='Specifies the activated hook type configuration, in this AWS account and AWS Region . You must specify either ``TypeName`` and ``Configuration`` or ``TypeARN`` and ``Configuration`` .\n')
    configuration_alias: typing.Optional[str] = pydantic.Field(None, description='Specifies the activated hook type configuration, in this AWS account and AWS Region . Defaults to ``default`` alias. Hook types currently support default configuration alias.\n')
...
class CfnHookVersionDef(BaseCfnResource):
    ...
    logging_config: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.CfnHookVersion_LoggingConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Contains logging configuration information for an extension.')
...
class CfnJsonDef(BaseCfnResource):
    value: typing.Any = pydantic.Field(..., description='The value to resolve. Can be any JavaScript object, including tokens and references in keys or values.')
    _init_params: typing.ClassVar[list[str]] = ['value']
    _method_names: typing.ClassVar[list[str]] = ['resolve']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnMacroDef(BaseCfnResource):
    function_name: str = pydantic.Field(..., description='The Amazon Resource Name (ARN) of the underlying AWS Lambda function that you want AWS CloudFormation to invoke when the macro is run.\n')
    name: str = pydantic.Field(..., description='The name of the macro. The name of the macro must be unique across all macros in the account.\n')
...
class CfnModuleVersionDef(BaseCfnResource):
    module_name: str = pydantic.Field(..., description='The name of the module being registered.\n')
    module_package: str = pydantic.Field(..., description="A URL to the S3 bucket containing the package that contains the template fragment and schema files for the module version to register. .. epigraph:: The user registering the module version must be able to access the module package in the S3 bucket. That's, the user needs to have `GetObject <https://docs.aws.amazon.com/AmazonS3/latest/API/API_GetObject.html>`_ permissions for the package. For more information, see `Actions, Resources, and Condition Keys for Amazon S3 <https://docs.aws.amazon.com/IAM/latest/UserGuide/list_amazons3.html>`_ in the *AWS Identity and Access Management User Guide* .")
...
class CfnOutputDef(BaseCfnResource):
    value: str = pydantic.Field(..., description='The value of the property returned by the aws cloudformation describe-stacks command. The value of an output can include literals, parameter references, pseudo-parameters, a mapping value, or intrinsic functions.\n')
...
class CfnPublisherDef(BaseCfnResource):
    accept_terms_and_conditions: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef]] = pydantic.Field(..., description='Whether you accept the `Terms and Conditions <https://docs.aws.amazon.com/https://cloudformation-registry-documents.s3.amazonaws.com/Terms_and_Conditions_for_AWS_CloudFormation_Registry_Publishers.pdf>`_ for publishing extensions in the CloudFormation registry. You must accept the terms and conditions in order to register to publish public extensions to the CloudFormation registry. The default is ``false`` .\n')
...
class CfnResourceDef(BaseCfnResource):
    type: str = pydantic.Field(..., description='CloudFormation resource type (e.g. ``AWS::S3::Bucket``).\n')
...
class CfnResourceVersionDef(BaseCfnResource):
    schema_handler_package: str = pydantic.Field(..., description='A URL to the S3 bucket containing the resource project package that contains the necessary files for the resource you want to register. For information on generating a schema handler package for the resource you want to register, see `submit <https://docs.aws.amazon.com/cloudformation-cli/latest/userguide/resource-type-cli-submit.html>`_ in the *CloudFormation CLI User Guide* . .. epigraph:: The user registering the resource must be able to access the package in the S3 bucket. That is, the user needs to have `GetObject <https://docs.aws.amazon.com/AmazonS3/latest/API/API_GetObject.html>`_ permissions for the schema handler package. For more information, see `Actions, Resources, and Condition Keys for Amazon S3 <https://docs.aws.amazon.com/IAM/latest/UserGuide/list_amazons3.html>`_ in the *AWS Identity and Access Management User Guide* .\n')
    type_name: str = pydantic.Field(..., description="The name of the resource being registered. We recommend that resource names adhere to the following pattern: *company_or_organization* :: *service* :: *type* . .. epigraph:: The following organization namespaces are reserved and can't be used in your resource names: - ``Alexa`` - ``AMZN`` - ``Amazon`` - ``AWS`` - ``Custom`` - ``Dev``\n")
    ...
    logging_config: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.CfnResourceVersion_LoggingConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Logging configuration information for a resource.')
    _init_params: typing.ClassVar[list[str]] = ['schema_handler_package', 'type_name', 'execution_role_arn', 'logging_config']
    _method_names: typing.ClassVar[list[str]] = ['LoggingConfigProperty', 'add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnStackSetDef(BaseCfnResource):
    ...
    auto_deployment: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.CfnStackSet_AutoDeploymentPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='[ ``Service-managed`` permissions] Describes whether StackSets automatically deploys to AWS Organizations accounts that are added to a target organization or organizational unit (OU).\n')
    ...
    operation_preferences: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.CfnStackSet_OperationPreferencesPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The user-specified preferences for how AWS CloudFormation performs a stack set operation.\n')
    parameters: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.CfnStackSet_ParameterPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The input parameters for the stack set template.\n')
    stack_instances_group: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.CfnStackSet_StackInstancesPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='A group of stack instances with parameters in some specific accounts and Regions.\n')
    ...
    template_url: typing.Optional[str] = pydantic.Field(None, description="Location of file containing the template body. The URL must point to a template (max size: 460,800 bytes) that's located in an Amazon S3 bucket. You must include either ``TemplateURL`` or ``TemplateBody`` in a StackSet, but you can't use both. *Minimum* : ``1`` *Maximum* : ``1024``")
...
class CfnStackSetDefStackinstancespropertyParams(pydantic.BaseModel):
    deployment_targets: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.CfnStackSet_DeploymentTargetsPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    regions: typing.Sequence[str] = pydantic.Field(..., description='')
    parameter_overrides: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.CfnStackSet_ParameterPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    ...
...
class CfnTypeActivationDef(BaseCfnResource):
    auto_update: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description='Whether to automatically update the extension in this account and Region when a new *minor* version is published by the extension publisher. Major versions released by the publisher must be manually updated. The default is ``true`` .\n')
    ...
    logging_config: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.CfnTypeActivation_LoggingConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Specifies logging configuration information for an extension.\n')
...
class CfnCodeDeployBlueGreenApplicationDef(BaseCfnProperty):
    ecs_attributes: typing.Union[models.CfnCodeDeployBlueGreenEcsAttributesDef, dict[str, typing.Any]] = pydantic.Field(..., description='The detailed attributes of the deployed target.\n')
    target: typing.Union[models.CfnCodeDeployBlueGreenApplicationTargetDef, dict[str, typing.Any]] = pydantic.Field(..., description='The target that is being deployed.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    import aws_cdk as cdk\n\n    cfn_code_deploy_blue_green_application = cdk.CfnCodeDeployBlueGreenApplication(\n        ecs_attributes=cdk.CfnCodeDeployBlueGreenEcsAttributes(\n            task_definitions=["taskDefinitions"],\n            task_sets=["taskSets"],\n            traffic_routing=cdk.CfnTrafficRouting(\n                prod_traffic_route=cdk.CfnTrafficRoute(\n                    logical_id="logicalId",\n                    type="type"\n                ),\n                target_groups=["targetGroups"],\n                test_traffic_route=cdk.CfnTrafficRoute(\n                    logical_id="logicalId",\n                    type="type"\n                )\n            )\n        ),\n        target=cdk.CfnCodeDeployBlueGreenApplicationTarget(\n            logical_id="logicalId",\n            type="type"\n        )\n    )\n')
...
class CfnCodeDeployBlueGreenApplicationTargetDef(BaseCfnProperty):
    logical_id: str = pydantic.Field(..., description='The logical id of the target resource.\n')
    type: str = pydantic.Field(..., description='The resource type of the target being deployed. Right now, the only allowed value is \'AWS::ECS::Service\'.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    import aws_cdk as cdk\n\n    cfn_code_deploy_blue_green_application_target = cdk.CfnCodeDeployBlueGreenApplicationTarget(\n        logical_id="logicalId",\n        type="type"\n    )\n')
...
class CfnCodeDeployBlueGreenEcsAttributesDef(BaseCfnProperty):
    task_definitions: typing.Sequence[str] = pydantic.Field(..., description='The logical IDs of the blue and green, respectively, AWS::ECS::TaskDefinition task definitions.\n')
    task_sets: typing.Sequence[str] = pydantic.Field(..., description='The logical IDs of the blue and green, respectively, AWS::ECS::TaskSet task sets.\n')
    traffic_routing: typing.Union[models.CfnTrafficRoutingDef, dict[str, typing.Any]] = pydantic.Field(..., description='The traffic routing configuration.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    import aws_cdk as cdk\n\n    cfn_code_deploy_blue_green_ecs_attributes = cdk.CfnCodeDeployBlueGreenEcsAttributes(\n        task_definitions=["taskDefinitions"],\n        task_sets=["taskSets"],\n        traffic_routing=cdk.CfnTrafficRouting(\n            prod_traffic_route=cdk.CfnTrafficRoute(\n                logical_id="logicalId",\n                type="type"\n            ),\n            target_groups=["targetGroups"],\n            test_traffic_route=cdk.CfnTrafficRoute(\n                logical_id="logicalId",\n                type="type"\n            )\n        )\n    )\n')
...
class CfnCodeDeployLambdaAliasUpdateDef(BaseCfnProperty):
    application_name: str = pydantic.Field(..., description='The name of the AWS CodeDeploy application.\n')
    deployment_group_name: str = pydantic.Field(..., description='The name of the AWS CodeDeploy deployment group. This is where the traffic-shifting policy is set.\n')
...
class CfnDynamicReferencePropsDef(BaseCfnProperty):
    reference_key: str = pydantic.Field(..., description='The reference key of the dynamic reference.\n')
    service: aws_cdk.CfnDynamicReferenceService = pydantic.Field(..., description='The service to retrieve the dynamic reference from.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    import aws_cdk as cdk\n\n    cfn_dynamic_reference_props = cdk.CfnDynamicReferenceProps(\n        reference_key="referenceKey",\n        service=cdk.CfnDynamicReferenceService.SSM\n    )\n')
...
class CfnRuleAssertionDef(BaseCfnProperty):
    assert_: typing.Union[models.CfnConditionDef] = pydantic.Field(..., description='The assertion.\n')
    assert_description: str = pydantic.Field(..., description='The assertion description.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    import aws_cdk as cdk\n\n    # cfn_condition_expression: cdk.ICfnConditionExpression\n\n    cfn_rule_assertion = cdk.CfnRuleAssertion(\n        assert=cfn_condition_expression,\n        assert_description="assertDescription"\n    )\n')
...
class CfnStackSet_AutoDeploymentPropertyDef(BaseCfnProperty):
    enabled: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description='If set to ``true`` , StackSets automatically deploys additional stack instances to AWS Organizations accounts that are added to a target organization or organizational unit (OU) in the specified Regions. If an account is removed from a target organization or OU, StackSets deletes stack instances from the account in the specified Regions.\n')
    retain_stacks_on_account_removal: typing.Union[bool, typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], None] = pydantic.Field(None, description='If set to ``true`` , stack resources are retained when an account is removed from a target organization or OU. If set to ``false`` , stack resources are deleted. Specify only if ``Enabled`` is set to ``True`` .\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudformation-stackset-autodeployment.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    import aws_cdk as cdk\n\n    auto_deployment_property = cdk.CfnStackSet.AutoDeploymentProperty(\n        enabled=False,\n        retain_stacks_on_account_removal=False\n    )\n')
...
class CfnStackSet_DeploymentTargetsPropertyDef(BaseCfnProperty):
    ...
    _init_params: typing.ClassVar[list[str]] = ['account_filter_type', 'accounts', 'organizational_unit_ids']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnStackSet_ParameterPropertyDef(BaseCfnProperty):
    parameter_key: str = pydantic.Field(..., description="The key associated with the parameter. If you don't specify a key and value for a particular parameter, AWS CloudFormation uses the default value that's specified in your template.\n")
    parameter_value: str = pydantic.Field(..., description='The input value associated with the parameter.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudformation-stackset-parameter.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    import aws_cdk as cdk\n\n    parameter_property = cdk.CfnStackSet.ParameterProperty(\n        parameter_key="parameterKey",\n        parameter_value="parameterValue"\n    )\n')
...
class CfnStackSet_StackInstancesPropertyDef(BaseCfnProperty):
    deployment_targets: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.CfnStackSet_DeploymentTargetsPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='The AWS ``OrganizationalUnitIds`` or ``Accounts`` for which to create stack instances in the specified Regions.\n')
    regions: typing.Sequence[str] = pydantic.Field(..., description='The names of one or more Regions where you want to create stack instances using the specified AWS accounts .\n')
    parameter_overrides: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.CfnStackSet_ParameterPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='A list of stack set parameters whose values you want to override in the selected stack instances.\n\n:link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudformation-stackset-stackinstances.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    import aws_cdk as cdk\n\n    stack_instances_property = cdk.CfnStackSet.StackInstancesProperty(\n        deployment_targets=cdk.CfnStackSet.DeploymentTargetsProperty(\n            account_filter_type="accountFilterType",\n            accounts=["accounts"],\n            organizational_unit_ids=["organizationalUnitIds"]\n        ),\n        regions=["regions"],\n\n        # the properties below are optional\n        parameter_overrides=[cdk.CfnStackSet.ParameterProperty(\n            parameter_key="parameterKey",\n            parameter_value="parameterValue"\n        )]\n    )\n')
...
class CfnTrafficRouteDef(BaseCfnProperty):
    logical_id: str = pydantic.Field(..., description='The logical id of the target resource.\n')
    type: str = pydantic.Field(..., description='The resource type of the route. Today, the only allowed value is \'AWS::ElasticLoadBalancingV2::Listener\'.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    import aws_cdk as cdk\n\n    cfn_traffic_route = cdk.CfnTrafficRoute(\n        logical_id="logicalId",\n        type="type"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['logical_id', 'type']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnTrafficRoutingDef(BaseCfnProperty):
    prod_traffic_route: typing.Union[models.CfnTrafficRouteDef, dict[str, typing.Any]] = pydantic.Field(..., description='The listener to be used by your load balancer to direct traffic to your target groups.\n')
    target_groups: typing.Sequence[str] = pydantic.Field(..., description='The logical IDs of the blue and green, respectively, AWS::ElasticLoadBalancingV2::TargetGroup target groups.\n')
    test_traffic_route: typing.Union[models.CfnTrafficRouteDef, dict[str, typing.Any]] = pydantic.Field(..., description='The listener to be used by your load balancer to direct traffic to your target groups.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    import aws_cdk as cdk\n\n    cfn_traffic_routing = cdk.CfnTrafficRouting(\n        prod_traffic_route=cdk.CfnTrafficRoute(\n            logical_id="logicalId",\n            type="type"\n        ),\n        target_groups=["targetGroups"],\n        test_traffic_route=cdk.CfnTrafficRoute(\n            logical_id="logicalId",\n            type="type"\n        )\n    )\n')
...
class CfnTrafficRoutingConfigDef(BaseCfnProperty):
    type: aws_cdk.CfnTrafficRoutingType = pydantic.Field(..., description='The type of traffic shifting used by the blue-green deployment configuration.\n')
