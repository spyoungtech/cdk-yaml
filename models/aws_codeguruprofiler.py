...
class CfnProfilingGroup_AgentPermissionsPropertyDef(BaseStruct):
    principals: typing.Sequence[str] = pydantic.Field(..., description='``CfnProfilingGroup.AgentPermissionsProperty.Principals``.')
...
class CfnProfilingGroup_ChannelPropertyDef(BaseStruct):
    channel_uri: str = pydantic.Field(..., description='The channel URI.\n')
...
class CfnProfilingGroupDef(BaseCfnResource):
    profiling_group_name: str = pydantic.Field(..., description='The name of the profiling group.\n')
    ...
    anomaly_detection_notification_configuration: typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], typing.Sequence[typing.Union[typing.Union[models.CfnDynamicReferenceDef, models.IntrinsicDef, models.JsonNullDef, models.ReferenceDef, models.SecretValueDef, models.CfnConditionDef, models.CfnJsonDef, models.aws_events.EventFieldDef, models.aws_events.MatchDef, models.aws_iam.PolicyDocumentDef, models.custom_resources.PhysicalResourceIdReferenceDef], models.aws_codeguruprofiler.CfnProfilingGroup_ChannelPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='Adds anomaly notifications for a profiling group.\n')
