...
class CfnKeyspaceDefConfig(pydantic.BaseModel):
    ReplicationSpecificationProperty: typing.Optional[list[CfnKeyspaceDefReplicationspecificationpropertyParams]] = pydantic.Field(None, description='')
...
class ModuleModel(pydantic.BaseModel):
    CfnKeyspace_ReplicationSpecificationProperty: typing.Optional[dict[str, CfnKeyspace_ReplicationSpecificationPropertyDef]] = pydantic.Field(None)
