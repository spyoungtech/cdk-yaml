...
class MatchResultDef(BaseClass):
    target: typing.Union[typing.Any, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='-')
...
#  autogenerated from aws_cdk.assertions.Tags
class TagsDef(BaseClass):
    _init_params: typing.ClassVar[list[str]] = []
    _method_names: typing.ClassVar[list[str]] = ['all', 'has_none', 'has_values']
    _classmethod_names: typing.ClassVar[list[str]] = ['from_stack']
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.assertions.Tags'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = ['from_stack']
    ...


    from_stack: typing.Optional[models.assertions.TagsDefFromStackParams] = pydantic.Field(None, description='Find tags associated with a synthesized CDK ``Stack``.')
    resource_config: typing.Optional[models.assertions.TagsDefConfig] = pydantic.Field(None)


class TagsDefConfig(pydantic.BaseModel):
    all: typing.Optional[bool] = pydantic.Field(None, description="Get the tags associated with the manifest.\nThis will be an empty object if\nno tags were supplied.\n\n:return: The tags associated with the stack's synthesized manifest.")
    has_none: typing.Optional[bool] = pydantic.Field(None, description="Assert that the there are no tags associated with the synthesized CDK Stack's manifest.\nThis is a convenience method over ``hasValues(Match.exact({}))``, and is\npresent because the more obvious method of detecting no tags\n(``Match.absent()``) will not work. Manifests default the tag set to an empty\nobject.")
    has_values: typing.Optional[list[models.assertions.TagsDefHasValuesParams]] = pydantic.Field(None, description="Assert that the given Matcher or object matches the tags associated with the synthesized CDK Stack's manifest.")

class TagsDefFromStackParams(pydantic.BaseModel):
    stack: models.StackDef = pydantic.Field(..., description='the CDK Stack to find tags on.')
    ...

class TagsDefHasValuesParams(pydantic.BaseModel):
    tags: typing.Any = pydantic.Field(..., description='the expected set of tags. This should be a string or Matcher object.')
    ...
...
class MatchCaptureDef(BaseStruct):
    capture: typing.Union[models.assertions.CaptureDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The instance of Capture class to which this capture is associated with.\n')
    value: typing.Union[typing.Any, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The value that was captured.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import assertions\n\n    # capture: assertions.Capture\n    # value: Any\n\n    match_capture = assertions.MatchCapture(\n        capture=capture,\n        value=value\n    )\n')
...
class MatchFailureDef(BaseStruct):
    matcher: typing.Union[models.assertions.MatcherDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The matcher that had the failure.\n')
    message: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Failure message.\n')
    path: typing.Union[typing.Sequence[str], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description="The relative path in the target where the failure occurred. If the failure occurred at root of the match tree, set the path to an empty list. If it occurs in the 5th index of an array nested within the 'foo' key of an object, set the path as ``['/foo', '[5]']``.\n")
...
class ModuleModel(pydantic.BaseModel):
    ...
    Tags: typing.Optional[dict[str, models.assertions.TagsDef]] = pydantic.Field(None)
