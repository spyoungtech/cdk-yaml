...
#  autogenerated from aws_cdk.aws_cloudfront.AssetImportSource
class AssetImportSourceDef(BaseClass):
    path: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='the path to the local file.')
    ...
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_cloudfront.AssetImportSource'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = ['from_asset', 'from_bucket', 'from_inline']
    ...


    from_asset: typing.Optional[models.aws_cloudfront.AssetImportSourceDefFromAssetParams] = pydantic.Field(None, description='An import source that exists as a local file.')
    from_bucket: typing.Optional[models.aws_cloudfront.AssetImportSourceDefFromBucketParams] = pydantic.Field(None, description='An import source that exists as an object in an S3 bucket.')
    from_inline: typing.Optional[models.aws_cloudfront.AssetImportSourceDefFromInlineParams] = pydantic.Field(None, description='An import source that uses an inline string.')

class AssetImportSourceDefFromAssetParams(pydantic.BaseModel):
    path: str = pydantic.Field(..., description='the path to the local file.\n')
    deploy_time: typing.Optional[bool] = pydantic.Field(None, description='Whether or not the asset needs to exist beyond deployment time; i.e. are copied over to a different location and not needed afterwards. Setting this property to true has an impact on the lifecycle of the asset, because we will assume that it is safe to delete after the CloudFormation deployment succeeds. For example, Lambda Function assets are copied over to Lambda during deployment. Therefore, it is not necessary to store the asset in S3, so we consider those deployTime assets. Default: false\n')
    readers: typing.Optional[typing.Sequence[models.AnyResource]] = pydantic.Field(None, description='A list of principals that should be able to read this asset from S3. You can use ``asset.grantRead(principal)`` to grant read permissions later. Default: - No principals that can read file asset.\n')
    asset_hash: typing.Optional[str] = pydantic.Field(None, description='Specify a custom hash for this asset. If ``assetHashType`` is set it must be set to ``AssetHashType.CUSTOM``. For consistency, this custom hash will be SHA256 hashed and encoded as hex. The resulting hash will be the asset hash. NOTE: the hash is used in order to identify a specific revision of the asset, and used for optimizing and caching deployment activities related to this asset such as packaging, uploading to Amazon S3, etc. If you chose to customize the hash, you will need to make sure it is updated every time the asset changes, or otherwise it is possible that some deployments will not be invalidated. Default: - based on ``assetHashType``\n')
    asset_hash_type: typing.Optional[aws_cdk.AssetHashType] = pydantic.Field(None, description='Specifies the type of hash to calculate for this asset. If ``assetHash`` is configured, this option must be ``undefined`` or ``AssetHashType.CUSTOM``. Default: - the default is ``AssetHashType.SOURCE``, but if ``assetHash`` is explicitly specified this value defaults to ``AssetHashType.CUSTOM``.\n')
...
class AssetImportSourceDefFromBucketParams(pydantic.BaseModel):
    bucket: typing.Union[models.aws_s3.BucketBaseDef, models.aws_s3.BucketDef] = pydantic.Field(..., description='the S3 bucket that contains the data.\n')
    key: str = pydantic.Field(..., description='the key within the S3 bucket that contains the data.')
    ...

class AssetImportSourceDefFromInlineParams(pydantic.BaseModel):
    data: str = pydantic.Field(..., description='the contents of the KeyValueStore.')
    ...
...
#  autogenerated from aws_cdk.aws_cloudfront.Endpoint
class EndpointDef(BaseClass):
    _init_params: typing.ClassVar[list[str]] = []
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = ['from_kinesis_stream']
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_cloudfront.Endpoint'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = ['from_kinesis_stream']
    ...
...
#  autogenerated from aws_cdk.aws_cloudfront.FunctionRuntime
class FunctionRuntimeDef(BaseClass):
    _init_params: typing.ClassVar[list[str]] = []
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = ['custom']
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_cloudfront.FunctionRuntime'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...


    resource_config: typing.Optional[models.aws_cloudfront.FunctionRuntimeDefConfig] = pydantic.Field(None)


class FunctionRuntimeDefConfig(pydantic.BaseModel):
    custom: typing.Optional[list[models.aws_cloudfront.FunctionRuntimeDefCustomParams]] = pydantic.Field(None, description='A custom runtime string.\nGives full control over the runtime string fragment.')

class FunctionRuntimeDefCustomParams(pydantic.BaseModel):
    runtime_string: str = pydantic.Field(..., description='-')
    return_config: typing.Optional[list[models.aws_cloudfront.FunctionRuntimeDefConfig]] = pydantic.Field(None)
    ...
...
#  autogenerated from aws_cdk.aws_cloudfront.ImportSource
class ImportSourceDef(BaseClass):
    _init_params: typing.ClassVar[list[str]] = []
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = ['from_asset', 'from_bucket', 'from_inline']
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_cloudfront.ImportSource'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = ['from_asset', 'from_bucket', 'from_inline']
    ...


    from_asset: typing.Optional[models.aws_cloudfront.ImportSourceDefFromAssetParams] = pydantic.Field(None, description='An import source that exists as a local file.')
    from_bucket: typing.Optional[models.aws_cloudfront.ImportSourceDefFromBucketParams] = pydantic.Field(None, description='An import source that exists as an object in an S3 bucket.')
    from_inline: typing.Optional[models.aws_cloudfront.ImportSourceDefFromInlineParams] = pydantic.Field(None, description='An import source that uses an inline string.')

class ImportSourceDefFromAssetParams(pydantic.BaseModel):
    path: str = pydantic.Field(..., description='the path to the local file.\n')
    deploy_time: typing.Optional[bool] = pydantic.Field(None, description='Whether or not the asset needs to exist beyond deployment time; i.e. are copied over to a different location and not needed afterwards. Setting this property to true has an impact on the lifecycle of the asset, because we will assume that it is safe to delete after the CloudFormation deployment succeeds. For example, Lambda Function assets are copied over to Lambda during deployment. Therefore, it is not necessary to store the asset in S3, so we consider those deployTime assets. Default: false\n')
    readers: typing.Optional[typing.Sequence[models.AnyResource]] = pydantic.Field(None, description='A list of principals that should be able to read this asset from S3. You can use ``asset.grantRead(principal)`` to grant read permissions later. Default: - No principals that can read file asset.\n')
    asset_hash: typing.Optional[str] = pydantic.Field(None, description='Specify a custom hash for this asset. If ``assetHashType`` is set it must be set to ``AssetHashType.CUSTOM``. For consistency, this custom hash will be SHA256 hashed and encoded as hex. The resulting hash will be the asset hash. NOTE: the hash is used in order to identify a specific revision of the asset, and used for optimizing and caching deployment activities related to this asset such as packaging, uploading to Amazon S3, etc. If you chose to customize the hash, you will need to make sure it is updated every time the asset changes, or otherwise it is possible that some deployments will not be invalidated. Default: - based on ``assetHashType``\n')
...
class ImportSourceDefFromBucketParams(pydantic.BaseModel):
    bucket: typing.Union[models.aws_s3.BucketBaseDef, models.aws_s3.BucketDef] = pydantic.Field(..., description='the S3 bucket that contains the data.\n')
    key: str = pydantic.Field(..., description='the key within the S3 bucket that contains the data.')
    ...

class ImportSourceDefFromInlineParams(pydantic.BaseModel):
    data: str = pydantic.Field(..., description='the contents of the KeyValueStore.')
    ...


#  autogenerated from aws_cdk.aws_cloudfront.InlineImportSource
class InlineImportSourceDef(BaseClass):
    data: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='the contents of the KeyValueStore.')
    _init_params: typing.ClassVar[list[str]] = ['data']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = ['from_asset', 'from_bucket', 'from_inline']
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_cloudfront.InlineImportSource'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = ['from_asset', 'from_bucket', 'from_inline']
    ...


    from_asset: typing.Optional[models.aws_cloudfront.InlineImportSourceDefFromAssetParams] = pydantic.Field(None, description='An import source that exists as a local file.')
    from_bucket: typing.Optional[models.aws_cloudfront.InlineImportSourceDefFromBucketParams] = pydantic.Field(None, description='An import source that exists as an object in an S3 bucket.')
    from_inline: typing.Optional[models.aws_cloudfront.InlineImportSourceDefFromInlineParams] = pydantic.Field(None, description='An import source that uses an inline string.')

class InlineImportSourceDefFromAssetParams(pydantic.BaseModel):
    path: str = pydantic.Field(..., description='the path to the local file.\n')
    deploy_time: typing.Optional[bool] = pydantic.Field(None, description='Whether or not the asset needs to exist beyond deployment time; i.e. are copied over to a different location and not needed afterwards. Setting this property to true has an impact on the lifecycle of the asset, because we will assume that it is safe to delete after the CloudFormation deployment succeeds. For example, Lambda Function assets are copied over to Lambda during deployment. Therefore, it is not necessary to store the asset in S3, so we consider those deployTime assets. Default: false\n')
    readers: typing.Optional[typing.Sequence[models.AnyResource]] = pydantic.Field(None, description='A list of principals that should be able to read this asset from S3. You can use ``asset.grantRead(principal)`` to grant read permissions later. Default: - No principals that can read file asset.\n')
    asset_hash: typing.Optional[str] = pydantic.Field(None, description='Specify a custom hash for this asset. If ``assetHashType`` is set it must be set to ``AssetHashType.CUSTOM``. For consistency, this custom hash will be SHA256 hashed and encoded as hex. The resulting hash will be the asset hash. NOTE: the hash is used in order to identify a specific revision of the asset, and used for optimizing and caching deployment activities related to this asset such as packaging, uploading to Amazon S3, etc. If you chose to customize the hash, you will need to make sure it is updated every time the asset changes, or otherwise it is possible that some deployments will not be invalidated. Default: - based on ``assetHashType``\n')
...
class InlineImportSourceDefFromBucketParams(pydantic.BaseModel):
    bucket: typing.Union[models.aws_s3.BucketBaseDef, models.aws_s3.BucketDef] = pydantic.Field(..., description='the S3 bucket that contains the data.\n')
    key: str = pydantic.Field(..., description='the key within the S3 bucket that contains the data.')
    ...

class InlineImportSourceDefFromInlineParams(pydantic.BaseModel):
    data: str = pydantic.Field(..., description='the contents of the KeyValueStore.')
    ...
...
class OriginRequestCookieBehaviorDefDenyListParams(pydantic.BaseModel):
    cookies: list[str] = pydantic.Field(...)
    return_config: typing.Optional[list[models.aws_cloudfront.OriginRequestCookieBehaviorDefConfig]] = pydantic.Field(None)
    ...
...
class OriginRequestHeaderBehaviorDefDenyListParams(pydantic.BaseModel):
    headers: list[str] = pydantic.Field(...)
    return_config: typing.Optional[list[models.aws_cloudfront.OriginRequestHeaderBehaviorDefConfig]] = pydantic.Field(None)
    ...
...
class OriginRequestQueryStringBehaviorDefDenyListParams(pydantic.BaseModel):
    query_strings: list[str] = pydantic.Field(...)
    return_config: typing.Optional[list[models.aws_cloudfront.OriginRequestQueryStringBehaviorDefConfig]] = pydantic.Field(None)
    ...
...
#  autogenerated from aws_cdk.aws_cloudfront.S3ImportSource
class S3ImportSourceDef(BaseClass):
    bucket: typing.Union[_REQUIRED_INIT_PARAM, models.aws_s3.BucketBaseDef, models.aws_s3.BucketDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='the S3 bucket that contains the data.')
    key: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='the key within the S3 bucket that contains the data.')
    _init_params: typing.ClassVar[list[str]] = ['bucket', 'key']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = ['from_asset', 'from_bucket', 'from_inline']
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_cloudfront.S3ImportSource'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = ['from_asset', 'from_bucket', 'from_inline']
    ...


    from_asset: typing.Optional[models.aws_cloudfront.S3ImportSourceDefFromAssetParams] = pydantic.Field(None, description='An import source that exists as a local file.')
    from_bucket: typing.Optional[models.aws_cloudfront.S3ImportSourceDefFromBucketParams] = pydantic.Field(None, description='An import source that exists as an object in an S3 bucket.')
    from_inline: typing.Optional[models.aws_cloudfront.S3ImportSourceDefFromInlineParams] = pydantic.Field(None, description='An import source that uses an inline string.')
    resource_config: typing.Optional[models.aws_cloudfront.S3ImportSourceDefConfig] = pydantic.Field(None)


class S3ImportSourceDefConfig(pydantic.BaseModel):
    bucket_config: typing.Optional[models._interface_methods.AwsS3IBucketDefConfig] = pydantic.Field(None)

class S3ImportSourceDefFromAssetParams(pydantic.BaseModel):
    path: str = pydantic.Field(..., description='the path to the local file.\n')
    deploy_time: typing.Optional[bool] = pydantic.Field(None, description='Whether or not the asset needs to exist beyond deployment time; i.e. are copied over to a different location and not needed afterwards. Setting this property to true has an impact on the lifecycle of the asset, because we will assume that it is safe to delete after the CloudFormation deployment succeeds. For example, Lambda Function assets are copied over to Lambda during deployment. Therefore, it is not necessary to store the asset in S3, so we consider those deployTime assets. Default: false\n')
    readers: typing.Optional[typing.Sequence[models.AnyResource]] = pydantic.Field(None, description='A list of principals that should be able to read this asset from S3. You can use ``asset.grantRead(principal)`` to grant read permissions later. Default: - No principals that can read file asset.\n')
    asset_hash: typing.Optional[str] = pydantic.Field(None, description='Specify a custom hash for this asset. If ``assetHashType`` is set it must be set to ``AssetHashType.CUSTOM``. For consistency, this custom hash will be SHA256 hashed and encoded as hex. The resulting hash will be the asset hash. NOTE: the hash is used in order to identify a specific revision of the asset, and used for optimizing and caching deployment activities related to this asset such as packaging, uploading to Amazon S3, etc. If you chose to customize the hash, you will need to make sure it is updated every time the asset changes, or otherwise it is possible that some deployments will not be invalidated. Default: - based on ``assetHashType``\n')
...
class S3ImportSourceDefFromBucketParams(pydantic.BaseModel):
    bucket: typing.Union[models.aws_s3.BucketBaseDef, models.aws_s3.BucketDef] = pydantic.Field(..., description='the S3 bucket that contains the data.\n')
    key: str = pydantic.Field(..., description='the key within the S3 bucket that contains the data.')
    ...

class S3ImportSourceDefFromInlineParams(pydantic.BaseModel):
    data: str = pydantic.Field(..., description='the contents of the KeyValueStore.')
    ...
...
class CloudFrontWebDistributionDef(BaseConstruct):
    origin_configs: typing.Union[typing.Sequence[typing.Union[models.aws_cloudfront.SourceConfigurationDef, dict[str, typing.Any]]], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The origin configurations for this distribution. Behaviors are a part of the origin.\n')
...
class DistributionDef(BaseConstruct):
    default_behavior: typing.Union[_REQUIRED_INIT_PARAM, models.aws_cloudfront.BehaviorOptionsDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The default behavior for the distribution.\n')
    ...
    publish_additional_metrics: typing.Optional[bool] = pydantic.Field(None, description='Whether to enable additional CloudWatch metrics. Default: false\n')
    ...
    web_acl_id: typing.Optional[str] = pydantic.Field(None, description='Unique identifier that specifies the AWS WAF web ACL to associate with this CloudFront distribution. To specify a web ACL created using the latest version of AWS WAF, use the ACL ARN, for example ``arn:aws:wafv2:us-east-1:123456789012:global/webacl/ExampleWebACL/473e64fd-f30b-4765-81a0-62ad96dd167a``. To specify a web ACL created using AWS WAF Classic, use the ACL ID, for example ``473e64fd-f30b-4765-81a0-62ad96dd167a``. Default: - No AWS Web Application Firewall web access control list (web ACL).')
    _init_params: typing.ClassVar[list[str]] = ['default_behavior', 'additional_behaviors', 'certificate', 'comment', 'default_root_object', 'domain_names', 'enabled', 'enable_ipv6', 'enable_logging', 'error_responses', 'geo_restriction', 'http_version', 'log_bucket', 'log_file_prefix', 'log_includes_cookies', 'minimum_protocol_version', 'price_class', 'publish_additional_metrics', 'ssl_support_method', 'web_acl_id']
    _method_names: typing.ClassVar[list[str]] = ['add_behavior', 'apply_removal_policy', 'grant', 'grant_create_invalidation', 'metric', 'metric401_error_rate', 'metric403_error_rate', 'metric404_error_rate', 'metric4xx_error_rate', 'metric502_error_rate', 'metric503_error_rate', 'metric504_error_rate', 'metric5xx_error_rate', 'metric_bytes_downloaded', 'metric_bytes_uploaded', 'metric_cache_hit_rate', 'metric_origin_latency', 'metric_requests', 'metric_total_error_rate']
    _classmethod_names: typing.ClassVar[list[str]] = ['from_distribution_attributes']
...
class DistributionDefConfig(pydantic.BaseModel):
    ...
    metric: typing.Optional[list[models.aws_cloudfront.DistributionDefMetricParams]] = pydantic.Field(None, description='Return the given named metric for this Distribution.')
    metric401_error_rate: typing.Optional[list[models.aws_cloudfront.DistributionDefMetric401ErrorRateParams]] = pydantic.Field(None, description="Metric for the percentage of all viewer requests for which the response's HTTP status code is 401.\nTo obtain this metric, you need to set ``publishAdditionalMetrics`` to ``true``.")
    metric403_error_rate: typing.Optional[list[models.aws_cloudfront.DistributionDefMetric403ErrorRateParams]] = pydantic.Field(None, description="Metric for the percentage of all viewer requests for which the response's HTTP status code is 403.\nTo obtain this metric, you need to set ``publishAdditionalMetrics`` to ``true``.")
    metric404_error_rate: typing.Optional[list[models.aws_cloudfront.DistributionDefMetric404ErrorRateParams]] = pydantic.Field(None, description="Metric for the percentage of all viewer requests for which the response's HTTP status code is 404.\nTo obtain this metric, you need to set ``publishAdditionalMetrics`` to ``true``.")
    metric4xx_error_rate: typing.Optional[list[models.aws_cloudfront.DistributionDefMetric4XxErrorRateParams]] = pydantic.Field(None, description="Metric for the percentage of all viewer requests for which the response's HTTP status code is 4xx.")
    metric502_error_rate: typing.Optional[list[models.aws_cloudfront.DistributionDefMetric502ErrorRateParams]] = pydantic.Field(None, description="Metric for the percentage of all viewer requests for which the response's HTTP status code is 502.\nTo obtain this metric, you need to set ``publishAdditionalMetrics`` to ``true``.")
    metric503_error_rate: typing.Optional[list[models.aws_cloudfront.DistributionDefMetric503ErrorRateParams]] = pydantic.Field(None, description="Metric for the percentage of all viewer requests for which the response's HTTP status code is 503.\nTo obtain this metric, you need to set ``publishAdditionalMetrics`` to ``true``.")
    metric504_error_rate: typing.Optional[list[models.aws_cloudfront.DistributionDefMetric504ErrorRateParams]] = pydantic.Field(None, description="Metric for the percentage of all viewer requests for which the response's HTTP status code is 504.\nTo obtain this metric, you need to set ``publishAdditionalMetrics`` to ``true``.")
    metric5xx_error_rate: typing.Optional[list[models.aws_cloudfront.DistributionDefMetric5XxErrorRateParams]] = pydantic.Field(None, description="Metric for the percentage of all viewer requests for which the response's HTTP status code is 5xx.")
    metric_bytes_downloaded: typing.Optional[list[models.aws_cloudfront.DistributionDefMetricBytesDownloadedParams]] = pydantic.Field(None, description='Metric for the total number of bytes downloaded by viewers for GET, HEAD, and OPTIONS requests.')
    metric_bytes_uploaded: typing.Optional[list[models.aws_cloudfront.DistributionDefMetricBytesUploadedParams]] = pydantic.Field(None, description='Metric for the total number of bytes that viewers uploaded to your origin with CloudFront, using POST and PUT requests.')
    metric_cache_hit_rate: typing.Optional[list[models.aws_cloudfront.DistributionDefMetricCacheHitRateParams]] = pydantic.Field(None, description='Metric for the percentage of all cacheable requests for which CloudFront served the content from its cache.\nHTTP POST and PUT requests, and errors, are not considered cacheable requests.\n\nTo obtain this metric, you need to set ``publishAdditionalMetrics`` to ``true``.')
    metric_origin_latency: typing.Optional[list[models.aws_cloudfront.DistributionDefMetricOriginLatencyParams]] = pydantic.Field(None, description='Metric for the total time spent from when CloudFront receives a request to when it starts providing a response to the network (not the viewer), for requests that are served from the origin, not the CloudFront cache.\nThis is also known as first byte latency, or time-to-first-byte.\n\nTo obtain this metric, you need to set ``publishAdditionalMetrics`` to ``true``.')
    metric_requests: typing.Optional[list[models.aws_cloudfront.DistributionDefMetricRequestsParams]] = pydantic.Field(None, description='Metric for the total number of viewer requests received by CloudFront, for all HTTP methods and for both HTTP and HTTPS requests.')
    metric_total_error_rate: typing.Optional[list[models.aws_cloudfront.DistributionDefMetricTotalErrorRateParams]] = pydantic.Field(None, description="Metric for the percentage of all viewer requests for which the response's HTTP status code is 4xx or 5xx.")
...
class DistributionDefAddBehaviorParams(pydantic.BaseModel):
    ...
    realtime_log_config: typing.Optional[typing.Union[models.aws_cloudfront.RealtimeLogConfigDef]] = pydantic.Field(None, description='The real-time log configuration to be attached to this cache behavior. Default: - none\n')
...
class DistributionDefMetricParams(pydantic.BaseModel):
...
class DistributionDefMetric401ErrorRateParams(pydantic.BaseModel):
    account: typing.Optional[str] = pydantic.Field(None, description='Account which this metric comes from. Default: - Deployment account.\n')
    color: typing.Optional[str] = pydantic.Field(None, description="The hex color code, prefixed with '#' (e.g. '#00ff00'), to use when this metric is rendered on a graph. The ``Color`` class has a set of standard colors that can be used here. Default: - Automatic color\n")
    dimensions_map: typing.Optional[typing.Mapping[str, str]] = pydantic.Field(None, description='Dimensions of the metric. Default: - No dimensions.\n')
    label: typing.Optional[str] = pydantic.Field(None, description="Label for this metric when added to a Graph in a Dashboard. You can use `dynamic labels <https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/graph-dynamic-labels.html>`_ to show summary information about the entire displayed time series in the legend. For example, if you use:: [max: ${MAX}] MyMetric As the metric label, the maximum value in the visible range will be shown next to the time series name in the graph's legend. Default: - No label\n")
...
class DistributionDefMetric403ErrorRateParams(pydantic.BaseModel):
    account: typing.Optional[str] = pydantic.Field(None, description='Account which this metric comes from. Default: - Deployment account.\n')
    color: typing.Optional[str] = pydantic.Field(None, description="The hex color code, prefixed with '#' (e.g. '#00ff00'), to use when this metric is rendered on a graph. The ``Color`` class has a set of standard colors that can be used here. Default: - Automatic color\n")
    dimensions_map: typing.Optional[typing.Mapping[str, str]] = pydantic.Field(None, description='Dimensions of the metric. Default: - No dimensions.\n')
    label: typing.Optional[str] = pydantic.Field(None, description="Label for this metric when added to a Graph in a Dashboard. You can use `dynamic labels <https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/graph-dynamic-labels.html>`_ to show summary information about the entire displayed time series in the legend. For example, if you use:: [max: ${MAX}] MyMetric As the metric label, the maximum value in the visible range will be shown next to the time series name in the graph's legend. Default: - No label\n")
...
class DistributionDefMetric404ErrorRateParams(pydantic.BaseModel):
    account: typing.Optional[str] = pydantic.Field(None, description='Account which this metric comes from. Default: - Deployment account.\n')
    color: typing.Optional[str] = pydantic.Field(None, description="The hex color code, prefixed with '#' (e.g. '#00ff00'), to use when this metric is rendered on a graph. The ``Color`` class has a set of standard colors that can be used here. Default: - Automatic color\n")
    dimensions_map: typing.Optional[typing.Mapping[str, str]] = pydantic.Field(None, description='Dimensions of the metric. Default: - No dimensions.\n')
    label: typing.Optional[str] = pydantic.Field(None, description="Label for this metric when added to a Graph in a Dashboard. You can use `dynamic labels <https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/graph-dynamic-labels.html>`_ to show summary information about the entire displayed time series in the legend. For example, if you use:: [max: ${MAX}] MyMetric As the metric label, the maximum value in the visible range will be shown next to the time series name in the graph's legend. Default: - No label\n")
...
class DistributionDefMetric4XxErrorRateParams(pydantic.BaseModel):
    account: typing.Optional[str] = pydantic.Field(None, description='Account which this metric comes from. Default: - Deployment account.\n')
    color: typing.Optional[str] = pydantic.Field(None, description="The hex color code, prefixed with '#' (e.g. '#00ff00'), to use when this metric is rendered on a graph. The ``Color`` class has a set of standard colors that can be used here. Default: - Automatic color\n")
    dimensions_map: typing.Optional[typing.Mapping[str, str]] = pydantic.Field(None, description='Dimensions of the metric. Default: - No dimensions.\n')
    label: typing.Optional[str] = pydantic.Field(None, description="Label for this metric when added to a Graph in a Dashboard. You can use `dynamic labels <https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/graph-dynamic-labels.html>`_ to show summary information about the entire displayed time series in the legend. For example, if you use:: [max: ${MAX}] MyMetric As the metric label, the maximum value in the visible range will be shown next to the time series name in the graph's legend. Default: - No label\n")
...
class DistributionDefMetric502ErrorRateParams(pydantic.BaseModel):
    account: typing.Optional[str] = pydantic.Field(None, description='Account which this metric comes from. Default: - Deployment account.\n')
    color: typing.Optional[str] = pydantic.Field(None, description="The hex color code, prefixed with '#' (e.g. '#00ff00'), to use when this metric is rendered on a graph. The ``Color`` class has a set of standard colors that can be used here. Default: - Automatic color\n")
    dimensions_map: typing.Optional[typing.Mapping[str, str]] = pydantic.Field(None, description='Dimensions of the metric. Default: - No dimensions.\n')
    label: typing.Optional[str] = pydantic.Field(None, description="Label for this metric when added to a Graph in a Dashboard. You can use `dynamic labels <https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/graph-dynamic-labels.html>`_ to show summary information about the entire displayed time series in the legend. For example, if you use:: [max: ${MAX}] MyMetric As the metric label, the maximum value in the visible range will be shown next to the time series name in the graph's legend. Default: - No label\n")
...
class DistributionDefMetric503ErrorRateParams(pydantic.BaseModel):
    account: typing.Optional[str] = pydantic.Field(None, description='Account which this metric comes from. Default: - Deployment account.\n')
    color: typing.Optional[str] = pydantic.Field(None, description="The hex color code, prefixed with '#' (e.g. '#00ff00'), to use when this metric is rendered on a graph. The ``Color`` class has a set of standard colors that can be used here. Default: - Automatic color\n")
    dimensions_map: typing.Optional[typing.Mapping[str, str]] = pydantic.Field(None, description='Dimensions of the metric. Default: - No dimensions.\n')
    label: typing.Optional[str] = pydantic.Field(None, description="Label for this metric when added to a Graph in a Dashboard. You can use `dynamic labels <https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/graph-dynamic-labels.html>`_ to show summary information about the entire displayed time series in the legend. For example, if you use:: [max: ${MAX}] MyMetric As the metric label, the maximum value in the visible range will be shown next to the time series name in the graph's legend. Default: - No label\n")
...
class DistributionDefMetric504ErrorRateParams(pydantic.BaseModel):
    account: typing.Optional[str] = pydantic.Field(None, description='Account which this metric comes from. Default: - Deployment account.\n')
    color: typing.Optional[str] = pydantic.Field(None, description="The hex color code, prefixed with '#' (e.g. '#00ff00'), to use when this metric is rendered on a graph. The ``Color`` class has a set of standard colors that can be used here. Default: - Automatic color\n")
    dimensions_map: typing.Optional[typing.Mapping[str, str]] = pydantic.Field(None, description='Dimensions of the metric. Default: - No dimensions.\n')
    label: typing.Optional[str] = pydantic.Field(None, description="Label for this metric when added to a Graph in a Dashboard. You can use `dynamic labels <https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/graph-dynamic-labels.html>`_ to show summary information about the entire displayed time series in the legend. For example, if you use:: [max: ${MAX}] MyMetric As the metric label, the maximum value in the visible range will be shown next to the time series name in the graph's legend. Default: - No label\n")
...
class DistributionDefMetric5XxErrorRateParams(pydantic.BaseModel):
    account: typing.Optional[str] = pydantic.Field(None, description='Account which this metric comes from. Default: - Deployment account.\n')
    color: typing.Optional[str] = pydantic.Field(None, description="The hex color code, prefixed with '#' (e.g. '#00ff00'), to use when this metric is rendered on a graph. The ``Color`` class has a set of standard colors that can be used here. Default: - Automatic color\n")
    dimensions_map: typing.Optional[typing.Mapping[str, str]] = pydantic.Field(None, description='Dimensions of the metric. Default: - No dimensions.\n')
    label: typing.Optional[str] = pydantic.Field(None, description="Label for this metric when added to a Graph in a Dashboard. You can use `dynamic labels <https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/graph-dynamic-labels.html>`_ to show summary information about the entire displayed time series in the legend. For example, if you use:: [max: ${MAX}] MyMetric As the metric label, the maximum value in the visible range will be shown next to the time series name in the graph's legend. Default: - No label\n")
...
class DistributionDefMetricBytesDownloadedParams(pydantic.BaseModel):
    account: typing.Optional[str] = pydantic.Field(None, description='Account which this metric comes from. Default: - Deployment account.\n')
    color: typing.Optional[str] = pydantic.Field(None, description="The hex color code, prefixed with '#' (e.g. '#00ff00'), to use when this metric is rendered on a graph. The ``Color`` class has a set of standard colors that can be used here. Default: - Automatic color\n")
    dimensions_map: typing.Optional[typing.Mapping[str, str]] = pydantic.Field(None, description='Dimensions of the metric. Default: - No dimensions.\n')
    label: typing.Optional[str] = pydantic.Field(None, description="Label for this metric when added to a Graph in a Dashboard. You can use `dynamic labels <https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/graph-dynamic-labels.html>`_ to show summary information about the entire displayed time series in the legend. For example, if you use:: [max: ${MAX}] MyMetric As the metric label, the maximum value in the visible range will be shown next to the time series name in the graph's legend. Default: - No label\n")
...
class DistributionDefMetricBytesUploadedParams(pydantic.BaseModel):
    account: typing.Optional[str] = pydantic.Field(None, description='Account which this metric comes from. Default: - Deployment account.\n')
    color: typing.Optional[str] = pydantic.Field(None, description="The hex color code, prefixed with '#' (e.g. '#00ff00'), to use when this metric is rendered on a graph. The ``Color`` class has a set of standard colors that can be used here. Default: - Automatic color\n")
    dimensions_map: typing.Optional[typing.Mapping[str, str]] = pydantic.Field(None, description='Dimensions of the metric. Default: - No dimensions.\n')
    label: typing.Optional[str] = pydantic.Field(None, description="Label for this metric when added to a Graph in a Dashboard. You can use `dynamic labels <https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/graph-dynamic-labels.html>`_ to show summary information about the entire displayed time series in the legend. For example, if you use:: [max: ${MAX}] MyMetric As the metric label, the maximum value in the visible range will be shown next to the time series name in the graph's legend. Default: - No label\n")
...
class DistributionDefMetricCacheHitRateParams(pydantic.BaseModel):
    account: typing.Optional[str] = pydantic.Field(None, description='Account which this metric comes from. Default: - Deployment account.\n')
    color: typing.Optional[str] = pydantic.Field(None, description="The hex color code, prefixed with '#' (e.g. '#00ff00'), to use when this metric is rendered on a graph. The ``Color`` class has a set of standard colors that can be used here. Default: - Automatic color\n")
    dimensions_map: typing.Optional[typing.Mapping[str, str]] = pydantic.Field(None, description='Dimensions of the metric. Default: - No dimensions.\n')
    label: typing.Optional[str] = pydantic.Field(None, description="Label for this metric when added to a Graph in a Dashboard. You can use `dynamic labels <https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/graph-dynamic-labels.html>`_ to show summary information about the entire displayed time series in the legend. For example, if you use:: [max: ${MAX}] MyMetric As the metric label, the maximum value in the visible range will be shown next to the time series name in the graph's legend. Default: - No label\n")
...
class DistributionDefMetricOriginLatencyParams(pydantic.BaseModel):
    account: typing.Optional[str] = pydantic.Field(None, description='Account which this metric comes from. Default: - Deployment account.\n')
    color: typing.Optional[str] = pydantic.Field(None, description="The hex color code, prefixed with '#' (e.g. '#00ff00'), to use when this metric is rendered on a graph. The ``Color`` class has a set of standard colors that can be used here. Default: - Automatic color\n")
    dimensions_map: typing.Optional[typing.Mapping[str, str]] = pydantic.Field(None, description='Dimensions of the metric. Default: - No dimensions.\n')
    label: typing.Optional[str] = pydantic.Field(None, description="Label for this metric when added to a Graph in a Dashboard. You can use `dynamic labels <https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/graph-dynamic-labels.html>`_ to show summary information about the entire displayed time series in the legend. For example, if you use:: [max: ${MAX}] MyMetric As the metric label, the maximum value in the visible range will be shown next to the time series name in the graph's legend. Default: - No label\n")
...
class DistributionDefMetricRequestsParams(pydantic.BaseModel):
    account: typing.Optional[str] = pydantic.Field(None, description='Account which this metric comes from. Default: - Deployment account.\n')
    color: typing.Optional[str] = pydantic.Field(None, description="The hex color code, prefixed with '#' (e.g. '#00ff00'), to use when this metric is rendered on a graph. The ``Color`` class has a set of standard colors that can be used here. Default: - Automatic color\n")
    dimensions_map: typing.Optional[typing.Mapping[str, str]] = pydantic.Field(None, description='Dimensions of the metric. Default: - No dimensions.\n')
    label: typing.Optional[str] = pydantic.Field(None, description="Label for this metric when added to a Graph in a Dashboard. You can use `dynamic labels <https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/graph-dynamic-labels.html>`_ to show summary information about the entire displayed time series in the legend. For example, if you use:: [max: ${MAX}] MyMetric As the metric label, the maximum value in the visible range will be shown next to the time series name in the graph's legend. Default: - No label\n")
...
class DistributionDefMetricTotalErrorRateParams(pydantic.BaseModel):
    account: typing.Optional[str] = pydantic.Field(None, description='Account which this metric comes from. Default: - Deployment account.\n')
    color: typing.Optional[str] = pydantic.Field(None, description="The hex color code, prefixed with '#' (e.g. '#00ff00'), to use when this metric is rendered on a graph. The ``Color`` class has a set of standard colors that can be used here. Default: - Automatic color\n")
    dimensions_map: typing.Optional[typing.Mapping[str, str]] = pydantic.Field(None, description='Dimensions of the metric. Default: - No dimensions.\n')
    label: typing.Optional[str] = pydantic.Field(None, description="Label for this metric when added to a Graph in a Dashboard. You can use `dynamic labels <https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/graph-dynamic-labels.html>`_ to show summary information about the entire displayed time series in the legend. For example, if you use:: [max: ${MAX}] MyMetric As the metric label, the maximum value in the visible range will be shown next to the time series name in the graph's legend. Default: - No label\n")
...
class FunctionDef(BaseConstruct):
    code: typing.Union[models.aws_cloudfront.FunctionCodeDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The source code of the function.\n')
    auto_publish: typing.Optional[bool] = pydantic.Field(None, description='A flag that determines whether to automatically publish the function to the LIVE stage when it’s created. Default: - true\n')
    ...
    key_value_store: typing.Optional[typing.Union[models.aws_cloudfront.KeyValueStoreDef]] = pydantic.Field(None, description='The Key Value Store to associate with this function. In order to associate a Key Value Store, the ``runtime`` must be ``cloudfront-js-2.0`` or newer. Default: - no key value store is associated\n')
    runtime: typing.Optional[models.aws_cloudfront.FunctionRuntimeDef] = pydantic.Field(None, description='The runtime environment for the function. Default: FunctionRuntime.JS_1_0 (unless ``keyValueStore`` is specified, then ``FunctionRuntime.JS_2_0``)')
    _init_params: typing.ClassVar[list[str]] = ['code', 'auto_publish', 'comment', 'function_name', 'key_value_store', 'runtime']
    _method_names: typing.ClassVar[list[str]] = ['apply_removal_policy']
...
class FunctionDefFromFunctionAttributesParams(pydantic.BaseModel):
    ...
    function_runtime: typing.Optional[str] = pydantic.Field(None, description='The Runtime of the function. Default: FunctionRuntime.JS_1_0')
    ...


#  autogenerated from aws_cdk.aws_cloudfront.KeyGroup
class KeyGroupDef(BaseConstruct):
    items: typing.Union[typing.Sequence[typing.Union[models.aws_cloudfront.PublicKeyDef]], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A list of public keys to add to the key group.\n')
...
#  autogenerated from aws_cdk.aws_cloudfront.KeyValueStore
class KeyValueStoreDef(BaseConstruct):
    comment: typing.Optional[str] = pydantic.Field(None, description='A comment for the Key Value Store. Default: No comment will be specified\n')
    key_value_store_name: typing.Optional[str] = pydantic.Field(None, description='The unique name of the Key Value Store. Default: A generated name\n')
    source: typing.Optional[models.aws_cloudfront.ImportSourceDef] = pydantic.Field(None, description='The import source for the Key Value Store. This will populate the initial items in the Key Value Store. The source data must be in a valid JSON format. Default: No data will be imported to the store')
    _init_params: typing.ClassVar[list[str]] = ['comment', 'key_value_store_name', 'source']
    _method_names: typing.ClassVar[list[str]] = ['apply_removal_policy']
    _classmethod_names: typing.ClassVar[list[str]] = ['from_key_value_store_arn']
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_cloudfront.KeyValueStore'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = ['from_key_value_store_arn']
    ...


    from_key_value_store_arn: typing.Optional[models.aws_cloudfront.KeyValueStoreDefFromKeyValueStoreArnParams] = pydantic.Field(None, description='Import a Key Value Store using its ARN.')
    resource_config: typing.Optional[models.aws_cloudfront.KeyValueStoreDefConfig] = pydantic.Field(None)


class KeyValueStoreDefConfig(pydantic.BaseModel):
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)

class KeyValueStoreDefApplyRemovalPolicyParams(pydantic.BaseModel):
    policy: aws_cdk.RemovalPolicy = pydantic.Field(..., description='-')
    ...

class KeyValueStoreDefFromKeyValueStoreArnParams(pydantic.BaseModel):
    scope: models.constructs.ConstructDef = pydantic.Field(..., description='-\n')
    id: str = pydantic.Field(..., description='-\n')
    key_value_store_arn: str = pydantic.Field(..., description='-')
    ...
...
class PublicKeyDef(BaseConstruct):
    encoded_key: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The public key that you can use with signed URLs and signed cookies, or with field-level encryption. The ``encodedKey`` parameter must include ``-----BEGIN PUBLIC KEY-----`` and ``-----END PUBLIC KEY-----`` lines.\n')
...
#  autogenerated from aws_cdk.aws_cloudfront.RealtimeLogConfig
class RealtimeLogConfigDef(BaseConstruct):
    end_points: typing.Union[typing.Sequence[models.aws_cloudfront.EndpointDef], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Contains information about the Amazon Kinesis data stream where you are sending real-time log data for this real-time log configuration.\n')
    fields: typing.Union[typing.Sequence[str], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A list of fields that are included in each real-time log record.\n')
    sampling_rate: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The sampling rate for this real-time log configuration.\n')
    realtime_log_config_name: typing.Optional[str] = pydantic.Field(None, description='The unique name of this real-time log configuration. Default: - the unique construct ID')
    _init_params: typing.ClassVar[list[str]] = ['end_points', 'fields', 'sampling_rate', 'realtime_log_config_name']
    _method_names: typing.ClassVar[list[str]] = ['apply_removal_policy']
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_cloudfront.RealtimeLogConfig'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class RealtimeLogConfigDefApplyRemovalPolicyParams(pydantic.BaseModel):
    policy: aws_cdk.RemovalPolicy = pydantic.Field(..., description='-')
    ...
...
class AddBehaviorOptionsDef(BaseStruct):
    ...
    _init_params: typing.ClassVar[list[str]] = ['allowed_methods', 'cached_methods', 'cache_policy', 'compress', 'edge_lambdas', 'function_associations', 'origin_request_policy', 'realtime_log_config', 'response_headers_policy', 'smooth_streaming', 'trusted_key_groups', 'viewer_protocol_policy']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class BehaviorOptionsDef(BaseStruct):
    ...
    trusted_key_groups: typing.Optional[typing.Sequence[typing.Union[models.aws_cloudfront.KeyGroupDef]]] = pydantic.Field(None, description='A list of Key Groups that CloudFront can use to validate signed URLs or signed cookies. Default: - no KeyGroups are associated with cache behavior\n')
    viewer_protocol_policy: typing.Optional[aws_cdk.aws_cloudfront.ViewerProtocolPolicy] = pydantic.Field(None, description='The protocol that viewers can use to access the files controlled by this behavior. Default: ViewerProtocolPolicy.ALLOW_ALL\n')
    origin: typing.Union[_REQUIRED_INIT_PARAM, models.aws_cloudfront.OriginBaseDef, models.aws_cloudfront_origins.FunctionUrlOriginDef, models.aws_cloudfront_origins.HttpOriginDef, models.aws_cloudfront_origins.LoadBalancerV2OriginDef, models.aws_cloudfront_origins.OriginGroupDef, models.aws_cloudfront_origins.RestApiOriginDef, models.aws_cloudfront_origins.S3OriginDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The origin that you want CloudFront to route requests to when they match this behavior.\n\n:exampleMetadata: infused\n\nExample::\n\n    # Adding an existing Lambda@Edge function created in a different stack\n    # to a CloudFront distribution.\n    # s3_bucket: s3.Bucket\n\n    function_version = lambda_.Version.from_version_arn(self, "Version", "arn:aws:lambda:us-east-1:123456789012:function:functionName:1")\n\n    cloudfront.Distribution(self, "distro",\n        default_behavior=cloudfront.BehaviorOptions(\n            origin=origins.S3Origin(s3_bucket),\n            edge_lambdas=[cloudfront.EdgeLambda(\n                function_version=function_version,\n                event_type=cloudfront.LambdaEdgeEventType.VIEWER_REQUEST\n            )\n            ]\n        )\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['allowed_methods', 'cached_methods', 'cache_policy', 'compress', 'edge_lambdas', 'function_associations', 'origin_request_policy', 'realtime_log_config', 'response_headers_policy', 'smooth_streaming', 'trusted_key_groups', 'viewer_protocol_policy', 'origin']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnCachePolicy_HeadersConfigPropertyDef(BaseStruct):
    header_behavior: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Determines whether any HTTP headers are included in the cache key and in requests that CloudFront sends to the origin. Valid values are: - ``none`` – No HTTP headers are included in the cache key or in requests that CloudFront sends to the origin. Even when this field is set to ``none`` , any headers that are listed in an ``OriginRequestPolicy`` *are* included in origin requests. - ``whitelist`` – Only the HTTP headers that are listed in the ``Headers`` type are included in the cache key and in requests that CloudFront sends to the origin.\n')
...
class CfnContinuousDeploymentPolicy_ContinuousDeploymentPolicyConfigPropertyDef(BaseStruct):
    enabled: typing.Union[_REQUIRED_INIT_PARAM, bool, models.UnsupportedResource] = pydantic.Field(REQUIRED_INIT_PARAM, description='A Boolean that indicates whether this continuous deployment policy is enabled (in effect). When this value is ``true`` , this policy is enabled and in effect. When this value is ``false`` , this policy is not enabled and has no effect.\n')
    staging_distribution_dns_names: typing.Union[typing.Sequence[str], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The CloudFront domain name of the staging distribution. For example: ``d111111abcdef8.cloudfront.net`` .\n')
    single_header_policy_config: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnContinuousDeploymentPolicy_SingleHeaderPolicyConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='This configuration determines which HTTP requests are sent to the staging distribution. If the HTTP request contains a header and value that matches what you specify here, the request is sent to the staging distribution. Otherwise the request is sent to the primary distribution.\n')
    single_weight_policy_config: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnContinuousDeploymentPolicy_SingleWeightPolicyConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='This configuration determines the percentage of HTTP requests that are sent to the staging distribution.\n')
    traffic_config: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnContinuousDeploymentPolicy_TrafficConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Contains the parameters for routing production traffic from your primary to staging distributions.\n')
    type: typing.Optional[str] = pydantic.Field(None, description='The type of traffic configuration.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-continuousdeploymentpolicy-continuousdeploymentpolicyconfig.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_cloudfront as cloudfront\n\n    continuous_deployment_policy_config_property = cloudfront.CfnContinuousDeploymentPolicy.ContinuousDeploymentPolicyConfigProperty(\n        enabled=False,\n        staging_distribution_dns_names=["stagingDistributionDnsNames"],\n\n        # the properties below are optional\n        single_header_policy_config=cloudfront.CfnContinuousDeploymentPolicy.SingleHeaderPolicyConfigProperty(\n            header="header",\n            value="value"\n        ),\n        single_weight_policy_config=cloudfront.CfnContinuousDeploymentPolicy.SingleWeightPolicyConfigProperty(\n            weight=123,\n\n            # the properties below are optional\n            session_stickiness_config=cloudfront.CfnContinuousDeploymentPolicy.SessionStickinessConfigProperty(\n                idle_ttl=123,\n                maximum_ttl=123\n            )\n        ),\n        traffic_config=cloudfront.CfnContinuousDeploymentPolicy.TrafficConfigProperty(\n            type="type",\n\n            # the properties below are optional\n            single_header_config=cloudfront.CfnContinuousDeploymentPolicy.SingleHeaderConfigProperty(\n                header="header",\n                value="value"\n            ),\n            single_weight_config=cloudfront.CfnContinuousDeploymentPolicy.SingleWeightConfigProperty(\n                weight=123,\n\n                # the properties below are optional\n                session_stickiness_config=cloudfront.CfnContinuousDeploymentPolicy.SessionStickinessConfigProperty(\n                    idle_ttl=123,\n                    maximum_ttl=123\n                )\n            )\n        ),\n        type="type"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['enabled', 'staging_distribution_dns_names', 'single_header_policy_config', 'single_weight_policy_config', 'traffic_config', 'type']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnContinuousDeploymentPolicy_SessionStickinessConfigPropertyDef(BaseStruct):
    idle_ttl: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The amount of time after which you want sessions to cease if no requests are received. Allowed values are 300–3600 seconds (5–60 minutes).\n')
    maximum_ttl: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The maximum amount of time to consider requests from the viewer as being part of the same session. Allowed values are 300–3600 seconds (5–60 minutes).\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-continuousdeploymentpolicy-sessionstickinessconfig.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_cloudfront as cloudfront\n\n    session_stickiness_config_property = cloudfront.CfnContinuousDeploymentPolicy.SessionStickinessConfigProperty(\n        idle_ttl=123,\n        maximum_ttl=123\n    )\n')
...
class CfnContinuousDeploymentPolicy_SingleHeaderConfigPropertyDef(BaseStruct):
    header: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The request header name that you want CloudFront to send to your staging distribution. The header must contain the prefix ``aws-cf-cd-`` .\n')
    value: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The request header value.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-continuousdeploymentpolicy-singleheaderconfig.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_cloudfront as cloudfront\n\n    single_header_config_property = cloudfront.CfnContinuousDeploymentPolicy.SingleHeaderConfigProperty(\n        header="header",\n        value="value"\n    )\n')
...
#  autogenerated from aws_cdk.aws_cloudfront.CfnContinuousDeploymentPolicy.SingleHeaderPolicyConfigProperty
class CfnContinuousDeploymentPolicy_SingleHeaderPolicyConfigPropertyDef(BaseStruct):
    header: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='')
    value: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='')
    _init_params: typing.ClassVar[list[str]] = ['header', 'value']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_cloudfront.CfnContinuousDeploymentPolicy.SingleHeaderPolicyConfigProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class CfnContinuousDeploymentPolicy_SingleWeightConfigPropertyDef(BaseStruct):
    weight: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The percentage of traffic to send to a staging distribution, expressed as a decimal number between 0 and 0.15. For example, a value of 0.10 means 10% of traffic is sent to the staging distribution.\n')
...
#  autogenerated from aws_cdk.aws_cloudfront.CfnContinuousDeploymentPolicy.SingleWeightPolicyConfigProperty
class CfnContinuousDeploymentPolicy_SingleWeightPolicyConfigPropertyDef(BaseStruct):
    weight: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='')
    session_stickiness_config: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnContinuousDeploymentPolicy_SessionStickinessConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    _init_params: typing.ClassVar[list[str]] = ['weight', 'session_stickiness_config']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_cloudfront.CfnContinuousDeploymentPolicy.SingleWeightPolicyConfigProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class CfnContinuousDeploymentPolicy_TrafficConfigPropertyDef(BaseStruct):
    type: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The type of traffic configuration.\n')
    single_header_config: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnContinuousDeploymentPolicy_SingleHeaderConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Determines which HTTP requests are sent to the staging distribution.\n')
    single_weight_config: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnContinuousDeploymentPolicy_SingleWeightConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Contains the percentage of traffic to send to the staging distribution.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-continuousdeploymentpolicy-trafficconfig.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_cloudfront as cloudfront\n\n    traffic_config_property = cloudfront.CfnContinuousDeploymentPolicy.TrafficConfigProperty(\n        type="type",\n\n        # the properties below are optional\n        single_header_config=cloudfront.CfnContinuousDeploymentPolicy.SingleHeaderConfigProperty(\n            header="header",\n            value="value"\n        ),\n        single_weight_config=cloudfront.CfnContinuousDeploymentPolicy.SingleWeightConfigProperty(\n            weight=123,\n\n            # the properties below are optional\n            session_stickiness_config=cloudfront.CfnContinuousDeploymentPolicy.SessionStickinessConfigProperty(\n                idle_ttl=123,\n                maximum_ttl=123\n            )\n        )\n    )\n')
...
class CfnDistribution_CacheBehaviorPropertyDef(BaseStruct):
    ...
    field_level_encryption_id: typing.Optional[str] = pydantic.Field(None, description='The value of ``ID`` for the field-level encryption configuration that you want CloudFront to use for encrypting specific fields of data for this cache behavior. Default: - ""\n')
...
class CfnDistribution_CustomErrorResponsePropertyDef(BaseStruct):
    error_code: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The HTTP status code for which you want to specify a custom error page and/or a caching duration.\n')
...
class CfnDistribution_CustomOriginConfigPropertyDef(BaseStruct):
    origin_protocol_policy: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Specifies the protocol (HTTP or HTTPS) that CloudFront uses to connect to the origin. Valid values are:. - ``http-only`` – CloudFront always uses HTTP to connect to the origin. - ``match-viewer`` – CloudFront connects to the origin using the same protocol that the viewer used to connect to CloudFront. - ``https-only`` – CloudFront always uses HTTPS to connect to the origin.\n')
    http_port: typing.Union[int, float, None] = pydantic.Field(None, description='The HTTP port that CloudFront uses to connect to the origin. Specify the HTTP port that the origin listens on. Default: - 80\n')
    https_port: typing.Union[int, float, None] = pydantic.Field(None, description='The HTTPS port that CloudFront uses to connect to the origin. Specify the HTTPS port that the origin listens on. Default: - 443\n')
...
class CfnDistribution_DefaultCacheBehaviorPropertyDef(BaseStruct):
    target_origin_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The value of ``ID`` for the origin that you want CloudFront to route requests to when they use the default cache behavior.\n')
    viewer_protocol_policy: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description="The protocol that viewers can use to access the files in the origin specified by ``TargetOriginId`` when a request matches the path pattern in ``PathPattern`` . You can specify the following options: - ``allow-all`` : Viewers can use HTTP or HTTPS. - ``redirect-to-https`` : If a viewer submits an HTTP request, CloudFront returns an HTTP status code of 301 (Moved Permanently) to the viewer along with the HTTPS URL. The viewer then resubmits the request using the new URL. - ``https-only`` : If a viewer sends an HTTP request, CloudFront returns an HTTP status code of 403 (Forbidden). For more information about requiring the HTTPS protocol, see `Requiring HTTPS Between Viewers and CloudFront <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/using-https-viewers-to-cloudfront.html>`_ in the *Amazon CloudFront Developer Guide* . .. epigraph:: The only way to guarantee that viewers retrieve an object that was fetched from the origin using HTTPS is never to use any other protocol to fetch the object. If you have recently changed from HTTP to HTTPS, we recommend that you clear your objects' cache because cached objects are protocol agnostic. That means that an edge location will return an object from the cache regardless of whether the current request protocol matches the protocol used previously. For more information, see `Managing Cache Expiration <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/Expiration.html>`_ in the *Amazon CloudFront Developer Guide* .\n")
    allowed_methods: typing.Optional[typing.Sequence[str]] = pydantic.Field(None, description="A complex type that controls which HTTP methods CloudFront processes and forwards to your Amazon S3 bucket or your custom origin. There are three choices: - CloudFront forwards only ``GET`` and ``HEAD`` requests. - CloudFront forwards only ``GET`` , ``HEAD`` , and ``OPTIONS`` requests. - CloudFront forwards ``GET, HEAD, OPTIONS, PUT, PATCH, POST`` , and ``DELETE`` requests. If you pick the third choice, you may need to restrict access to your Amazon S3 bucket or to your custom origin so users can't perform operations that you don't want them to. For example, you might not want users to have permissions to delete objects from your origin.\n")
    cached_methods: typing.Optional[typing.Sequence[str]] = pydantic.Field(None, description='A complex type that controls whether CloudFront caches the response to requests using the specified HTTP methods. There are two choices: - CloudFront caches responses to ``GET`` and ``HEAD`` requests. - CloudFront caches responses to ``GET`` , ``HEAD`` , and ``OPTIONS`` requests. If you pick the second choice for your Amazon S3 Origin, you may need to forward Access-Control-Request-Method, Access-Control-Request-Headers, and Origin headers for the responses to be cached correctly.\n')
    ...
    compress: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='Whether you want CloudFront to automatically compress certain files for this cache behavior. If so, specify ``true`` ; if not, specify ``false`` . For more information, see `Serving Compressed Files <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/ServingCompressedFiles.html>`_ in the *Amazon CloudFront Developer Guide* . Default: - false\n')
    default_ttl: typing.Union[int, float, None] = pydantic.Field(None, description='This field is deprecated. We recommend that you use the ``DefaultTTL`` field in a cache policy instead of this field. For more information, see `Creating cache policies <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/controlling-the-cache-key.html#cache-key-create-cache-policy>`_ or `Using the managed cache policies <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/using-managed-cache-policies.html>`_ in the *Amazon CloudFront Developer Guide* . The default amount of time that you want objects to stay in CloudFront caches before CloudFront forwards another request to your origin to determine whether the object has been updated. The value that you specify applies only when your origin does not add HTTP headers such as ``Cache-Control max-age`` , ``Cache-Control s-maxage`` , and ``Expires`` to objects. For more information, see `Managing How Long Content Stays in an Edge Cache (Expiration) <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/Expiration.html>`_ in the *Amazon CloudFront Developer Guide* . Default: - 86400\n')
    field_level_encryption_id: typing.Optional[str] = pydantic.Field(None, description='The value of ``ID`` for the field-level encryption configuration that you want CloudFront to use for encrypting specific fields of data for the default cache behavior. Default: - ""\n')
    ...
    function_associations: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnDistribution_FunctionAssociationPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='A list of CloudFront functions that are associated with this cache behavior. Your functions must be published to the ``LIVE`` stage to associate them with a cache behavior.\n')
    lambda_function_associations: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnDistribution_LambdaFunctionAssociationPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='A complex type that contains zero or more Lambda@Edge function associations for a cache behavior.\n')
    max_ttl: typing.Union[int, float, None] = pydantic.Field(None, description='This field is deprecated. We recommend that you use the ``MaxTTL`` field in a cache policy instead of this field. For more information, see `Creating cache policies <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/controlling-the-cache-key.html#cache-key-create-cache-policy>`_ or `Using the managed cache policies <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/using-managed-cache-policies.html>`_ in the *Amazon CloudFront Developer Guide* . The maximum amount of time that you want objects to stay in CloudFront caches before CloudFront forwards another request to your origin to determine whether the object has been updated. The value that you specify applies only when your origin adds HTTP headers such as ``Cache-Control max-age`` , ``Cache-Control s-maxage`` , and ``Expires`` to objects. For more information, see `Managing How Long Content Stays in an Edge Cache (Expiration) <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/Expiration.html>`_ in the *Amazon CloudFront Developer Guide* . Default: - 31536000\n')
    min_ttl: typing.Union[int, float, None] = pydantic.Field(None, description='This field is deprecated. We recommend that you use the ``MinTTL`` field in a cache policy instead of this field. For more information, see `Creating cache policies <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/controlling-the-cache-key.html#cache-key-create-cache-policy>`_ or `Using the managed cache policies <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/using-managed-cache-policies.html>`_ in the *Amazon CloudFront Developer Guide* . The minimum amount of time that you want objects to stay in CloudFront caches before CloudFront forwards another request to your origin to determine whether the object has been updated. For more information, see `Managing How Long Content Stays in an Edge Cache (Expiration) <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/Expiration.html>`_ in the *Amazon CloudFront Developer Guide* . You must specify ``0`` for ``MinTTL`` if you configure CloudFront to forward all headers to your origin (under ``Headers`` , if you specify ``1`` for ``Quantity`` and ``*`` for ``Name`` ). Default: - 0\n')
    ...
    response_headers_policy_id: typing.Optional[str] = pydantic.Field(None, description='The identifier for a response headers policy. Default: - ""\n')
    smooth_streaming: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='Indicates whether you want to distribute media files in the Microsoft Smooth Streaming format using the origin that is associated with this cache behavior. If so, specify ``true`` ; if not, specify ``false`` . If you specify ``true`` for ``SmoothStreaming`` , you can still distribute other content using this cache behavior if the content matches the value of ``PathPattern`` . Default: - false\n')
    trusted_key_groups: typing.Optional[typing.Sequence[str]] = pydantic.Field(None, description='A list of key groups that CloudFront can use to validate signed URLs or signed cookies. When a cache behavior contains trusted key groups, CloudFront requires signed URLs or signed cookies for all requests that match the cache behavior. The URLs or cookies must be signed with a private key whose corresponding public key is in the key group. The signed URL or cookie contains information about which public key CloudFront should use to verify the signature. For more information, see `Serving private content <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/PrivateContent.html>`_ in the *Amazon CloudFront Developer Guide* .\n')
...
class CfnDistribution_DistributionConfigPropertyDef(BaseStruct):
    default_cache_behavior: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_cloudfront.CfnDistribution_DefaultCacheBehaviorPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description="A complex type that describes the default cache behavior if you don't specify a ``CacheBehavior`` element or if files don't match any of the values of ``PathPattern`` in ``CacheBehavior`` elements. You must create exactly one default cache behavior.\n")
    enabled: typing.Union[_REQUIRED_INIT_PARAM, bool, models.UnsupportedResource] = pydantic.Field(REQUIRED_INIT_PARAM, description='From this field, you can enable or disable the selected distribution.\n')
    ...
    cache_behaviors: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnDistribution_CacheBehaviorPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='A complex type that contains zero or more ``CacheBehavior`` elements.\n')
    cnam_es: typing.Optional[typing.Sequence[str]] = pydantic.Field(None, description='')
    comment: typing.Optional[str] = pydantic.Field(None, description='A comment to describe the distribution. The comment cannot be longer than 128 characters. Default: - ""\n')
    ...
    custom_origin: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnDistribution_LegacyCustomOriginPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
    origin_groups: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnDistribution_OriginGroupsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A complex type that contains information about origin groups for this distribution. Specify a value for either the ``Origins`` or ``OriginGroups`` property.\n')
    origins: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnDistribution_OriginPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='A complex type that contains information about origins for this distribution. Specify a value for either the ``Origins`` or ``OriginGroups`` property.\n')
    ...
    restrictions: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnDistribution_RestrictionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A complex type that identifies ways in which you want to restrict distribution of your content.\n')
    s3_origin: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnDistribution_LegacyS3OriginPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    staging: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='A Boolean that indicates whether this is a staging distribution. When this value is ``true`` , this is a staging distribution. When this value is ``false`` , this is not a staging distribution.\n')
    viewer_certificate: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnDistribution_ViewerCertificatePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description="A complex type that determines the distribution's SSL/TLS configuration for communicating with viewers.\n")
...
class CfnDistribution_GeoRestrictionPropertyDef(BaseStruct):
    restriction_type: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description="The method that you want to use to restrict distribution of your content by country:. - ``none`` : No geo restriction is enabled, meaning access to content is not restricted by client geo location. - ``blacklist`` : The ``Location`` elements specify the countries in which you don't want CloudFront to distribute your content. - ``whitelist`` : The ``Location`` elements specify the countries in which you want CloudFront to distribute your content.\n")
...
class CfnDistribution_LambdaFunctionAssociationPropertyDef(BaseStruct):
    ...
    include_body: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='A flag that allows a Lambda@Edge function to have read access to the body content. For more information, see `Accessing the Request Body by Choosing the Include Body Option <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/lambda-include-body-access.html>`_ in the Amazon CloudFront Developer Guide.\n')
...
class CfnDistribution_LegacyCustomOriginPropertyDef(BaseStruct):
    dns_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='')
    origin_protocol_policy: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='')
    origin_ssl_protocols: typing.Union[typing.Sequence[str], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='')
    http_port: typing.Union[int, float, None] = pydantic.Field(None, description='Default: - 80\n')
    https_port: typing.Union[int, float, None] = pydantic.Field(None, description='Default: - 443\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-distribution-legacycustomorigin.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_cloudfront as cloudfront\n\n    legacy_custom_origin_property = cloudfront.CfnDistribution.LegacyCustomOriginProperty(\n        dns_name="dnsName",\n        origin_protocol_policy="originProtocolPolicy",\n        origin_ssl_protocols=["originSslProtocols"],\n\n        # the properties below are optional\n        http_port=123,\n        https_port=123\n    )\n')
...
class CfnDistribution_LoggingPropertyDef(BaseStruct):
    bucket: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Amazon S3 bucket to store the access logs in, for example, ``myawslogbucket.s3.amazonaws.com`` .\n')
    include_cookies: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description="Specifies whether you want CloudFront to include cookies in access logs, specify ``true`` for ``IncludeCookies`` . If you choose to include cookies in logs, CloudFront logs all cookies regardless of how you configure the cache behaviors for this distribution. If you don't want to include cookies when you create a distribution or if you want to disable include cookies for an existing distribution, specify ``false`` for ``IncludeCookies`` . Default: - false\n")
...
class CfnDistribution_OriginCustomHeaderPropertyDef(BaseStruct):
    header_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of a header that you want CloudFront to send to your origin. For more information, see `Adding Custom Headers to Origin Requests <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/forward-custom-headers.html>`_ in the *Amazon CloudFront Developer Guide* .\n')
    header_value: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The value for the header that you specified in the ``HeaderName`` field.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-distribution-origincustomheader.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_cloudfront as cloudfront\n\n    origin_custom_header_property = cloudfront.CfnDistribution.OriginCustomHeaderProperty(\n        header_name="headerName",\n        header_value="headerValue"\n    )\n')
...
class CfnDistribution_OriginGroupMembersPropertyDef(BaseStruct):
    items: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnDistribution_OriginGroupMemberPropertyDef, dict[str, typing.Any]]]] = pydantic.Field(REQUIRED_INIT_PARAM, description='Items (origins) in an origin group.\n')
    quantity: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The number of origins in an origin group.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-distribution-origingroupmembers.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_cloudfront as cloudfront\n\n    origin_group_members_property = cloudfront.CfnDistribution.OriginGroupMembersProperty(\n        items=[cloudfront.CfnDistribution.OriginGroupMemberProperty(\n            origin_id="originId"\n        )],\n        quantity=123\n    )\n')
...
class CfnDistribution_OriginGroupPropertyDef(BaseStruct):
    failover_criteria: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_cloudfront.CfnDistribution_OriginGroupFailoverCriteriaPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='A complex type that contains information about the failover criteria for an origin group.\n')
    members: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_cloudfront.CfnDistribution_OriginGroupMembersPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='A complex type that contains information about the origins in an origin group.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-distribution-origingroup.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_cloudfront as cloudfront\n\n    origin_group_property = cloudfront.CfnDistribution.OriginGroupProperty(\n        failover_criteria=cloudfront.CfnDistribution.OriginGroupFailoverCriteriaProperty(\n            status_codes=cloudfront.CfnDistribution.StatusCodesProperty(\n                items=[123],\n                quantity=123\n            )\n        ),\n        id="id",\n        members=cloudfront.CfnDistribution.OriginGroupMembersProperty(\n            items=[cloudfront.CfnDistribution.OriginGroupMemberProperty(\n                origin_id="originId"\n            )],\n            quantity=123\n        )\n    )\n')
...
class CfnDistribution_OriginGroupsPropertyDef(BaseStruct):
    quantity: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The number of origin groups.\n')
    items: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnDistribution_OriginGroupPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The items (origin groups) in a distribution.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-distribution-origingroups.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_cloudfront as cloudfront\n\n    origin_groups_property = cloudfront.CfnDistribution.OriginGroupsProperty(\n        quantity=123,\n\n        # the properties below are optional\n        items=[cloudfront.CfnDistribution.OriginGroupProperty(\n            failover_criteria=cloudfront.CfnDistribution.OriginGroupFailoverCriteriaProperty(\n                status_codes=cloudfront.CfnDistribution.StatusCodesProperty(\n                    items=[123],\n                    quantity=123\n                )\n            ),\n            id="id",\n            members=cloudfront.CfnDistribution.OriginGroupMembersProperty(\n                items=[cloudfront.CfnDistribution.OriginGroupMemberProperty(\n                    origin_id="originId"\n                )],\n                quantity=123\n            )\n        )]\n    )\n')
...
class CfnDistribution_OriginPropertyDef(BaseStruct):
    domain_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The domain name for the origin. For more information, see `Origin Domain Name <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/distribution-web-values-specify.html#DownloadDistValuesDomainName>`_ in the *Amazon CloudFront Developer Guide* .\n')
...
class CfnDistribution_OriginShieldPropertyDef(BaseStruct):
    enabled: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description="A flag that specifies whether Origin Shield is enabled. When it's enabled, CloudFront routes all requests through Origin Shield, which can help protect your origin. When it's disabled, CloudFront might send requests directly to your origin from multiple edge locations or regional edge caches.\n")
...
class CfnDistribution_StatusCodesPropertyDef(BaseStruct):
    items: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, typing.Sequence[typing.Union[int, float]]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The items (status codes) for an origin group.\n')
    quantity: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The number of status codes.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-distribution-statuscodes.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_cloudfront as cloudfront\n\n    status_codes_property = cloudfront.CfnDistribution.StatusCodesProperty(\n        items=[123],\n        quantity=123\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['items', 'quantity']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnDistribution_ViewerCertificatePropertyDef(BaseStruct):
    ...
    cloud_front_default_certificate: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='If the distribution uses the CloudFront domain name such as ``d111111abcdef8.cloudfront.net`` , set this field to ``true`` . If the distribution uses ``Aliases`` (alternate domain names or CNAMEs), omit this field and specify values for the following fields: - ``AcmCertificateArn`` or ``IamCertificateId`` (specify a value for one, not both) - ``MinimumProtocolVersion`` - ``SslSupportMethod``\n')
...
class CfnFunction_FunctionConfigPropertyDef(BaseStruct):
    comment: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A comment to describe the function.\n')
    runtime: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description="The function's runtime environment version.\n")
    key_value_store_associations: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnFunction_KeyValueStoreAssociationPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='The configuration for the key value store associations.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-function-functionconfig.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_cloudfront as cloudfront\n\n    function_config_property = cloudfront.CfnFunction.FunctionConfigProperty(\n        comment="comment",\n        runtime="runtime",\n\n        # the properties below are optional\n        key_value_store_associations=[cloudfront.CfnFunction.KeyValueStoreAssociationProperty(\n            key_value_store_arn="keyValueStoreArn"\n        )]\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['comment', 'runtime', 'key_value_store_associations']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
#  autogenerated from aws_cdk.aws_cloudfront.CfnFunction.KeyValueStoreAssociationProperty
class CfnFunction_KeyValueStoreAssociationPropertyDef(BaseStruct):
    key_value_store_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Amazon Resource Name (ARN) of the key value store association.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-function-keyvaluestoreassociation.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_cloudfront as cloudfront\n\n    key_value_store_association_property = cloudfront.CfnFunction.KeyValueStoreAssociationProperty(\n        key_value_store_arn="keyValueStoreArn"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['key_value_store_arn']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_cloudfront.CfnFunction.KeyValueStoreAssociationProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class CfnKeyGroup_KeyGroupConfigPropertyDef(BaseStruct):
    items: typing.Union[typing.Sequence[str], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A list of the identifiers of the public keys in the key group.\n')
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A name to identify the key group.\n')
...
#  autogenerated from aws_cdk.aws_cloudfront.CfnKeyValueStore.ImportSourceProperty
class CfnKeyValueStore_ImportSourcePropertyDef(BaseStruct):
    source_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Amazon Resource Name (ARN) of the import source for the key value store.\n')
    source_type: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The source type of the import source for the key value store.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-keyvaluestore-importsource.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_cloudfront as cloudfront\n\n    import_source_property = cloudfront.CfnKeyValueStore.ImportSourceProperty(\n        source_arn="sourceArn",\n        source_type="sourceType"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['source_arn', 'source_type']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_cloudfront.CfnKeyValueStore.ImportSourceProperty'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class CfnOriginRequestPolicy_OriginRequestPolicyConfigPropertyDef(BaseStruct):
    cookies_config: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_cloudfront.CfnOriginRequestPolicy_CookiesConfigPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The cookies from viewer requests to include in origin requests.\n')
    headers_config: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_cloudfront.CfnOriginRequestPolicy_HeadersConfigPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The HTTP headers to include in origin requests. These can include headers from viewer requests and additional headers added by CloudFront.\n')
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A unique name to identify the origin request policy.\n')
    query_strings_config: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_cloudfront.CfnOriginRequestPolicy_QueryStringsConfigPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The URL query strings from viewer requests to include in origin requests.\n')
...
class CfnPublicKey_PublicKeyConfigPropertyDef(BaseStruct):
    caller_reference: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description="A string included in the request to help make sure that the request can't be replayed.\n")
    encoded_key: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The public key that you can use with `signed URLs and signed cookies <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/PrivateContent.html>`_ , or with `field-level encryption <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/field-level-encryption.html>`_ .\n')
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A name to help identify the public key.\n')
...
class CfnResponseHeadersPolicy_AccessControlAllowMethodsPropertyDef(BaseStruct):
    items: typing.Union[typing.Sequence[str], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The list of HTTP methods. Valid values are:. - ``GET`` - ``DELETE`` - ``HEAD`` - ``OPTIONS`` - ``PATCH`` - ``POST`` - ``PUT`` - ``ALL`` ``ALL`` is a special value that includes all of the listed HTTP methods.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-responseheaderspolicy-accesscontrolallowmethods.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_cloudfront as cloudfront\n\n    access_control_allow_methods_property = cloudfront.CfnResponseHeadersPolicy.AccessControlAllowMethodsProperty(\n        items=["items"]\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['items']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnResponseHeadersPolicy_ContentSecurityPolicyPropertyDef(BaseStruct):
    content_security_policy: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The policy directives and their values that CloudFront includes as values for the ``Content-Security-Policy`` HTTP response header.\n')
    override: typing.Union[_REQUIRED_INIT_PARAM, bool, models.UnsupportedResource] = pydantic.Field(REQUIRED_INIT_PARAM, description='A Boolean that determines whether CloudFront overrides the ``Content-Security-Policy`` HTTP response header received from the origin with the one specified in this response headers policy.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-responseheaderspolicy-contentsecuritypolicy.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_cloudfront as cloudfront\n\n    content_security_policy_property = cloudfront.CfnResponseHeadersPolicy.ContentSecurityPolicyProperty(\n        content_security_policy="contentSecurityPolicy",\n        override=False\n    )\n')
...
class CfnResponseHeadersPolicy_CustomHeaderPropertyDef(BaseStruct):
    header: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The HTTP response header name.\n')
    override: typing.Union[_REQUIRED_INIT_PARAM, bool, models.UnsupportedResource] = pydantic.Field(REQUIRED_INIT_PARAM, description='A Boolean that determines whether CloudFront overrides a response header with the same name received from the origin with the header specified here.\n')
    value: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The value for the HTTP response header.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-responseheaderspolicy-customheader.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_cloudfront as cloudfront\n\n    custom_header_property = cloudfront.CfnResponseHeadersPolicy.CustomHeaderProperty(\n        header="header",\n        override=False,\n        value="value"\n    )\n')
...
class CfnResponseHeadersPolicy_FrameOptionsPropertyDef(BaseStruct):
    frame_option: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The value of the ``X-Frame-Options`` HTTP response header. Valid values are ``DENY`` and ``SAMEORIGIN`` . For more information about these values, see `X-Frame-Options <https://docs.aws.amazon.com/https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/X-Frame-Options>`_ in the MDN Web Docs.\n')
    override: typing.Union[_REQUIRED_INIT_PARAM, bool, models.UnsupportedResource] = pydantic.Field(REQUIRED_INIT_PARAM, description='A Boolean that determines whether CloudFront overrides the ``X-Frame-Options`` HTTP response header received from the origin with the one specified in this response headers policy.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-responseheaderspolicy-frameoptions.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_cloudfront as cloudfront\n\n    frame_options_property = cloudfront.CfnResponseHeadersPolicy.FrameOptionsProperty(\n        frame_option="frameOption",\n        override=False\n    )\n')
...
class CfnResponseHeadersPolicy_ReferrerPolicyPropertyDef(BaseStruct):
    override: typing.Union[_REQUIRED_INIT_PARAM, bool, models.UnsupportedResource] = pydantic.Field(REQUIRED_INIT_PARAM, description='A Boolean that determines whether CloudFront overrides the ``Referrer-Policy`` HTTP response header received from the origin with the one specified in this response headers policy.\n')
    referrer_policy: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The value of the ``Referrer-Policy`` HTTP response header. Valid values are:. - ``no-referrer`` - ``no-referrer-when-downgrade`` - ``origin`` - ``origin-when-cross-origin`` - ``same-origin`` - ``strict-origin`` - ``strict-origin-when-cross-origin`` - ``unsafe-url`` For more information about these values, see `Referrer-Policy <https://docs.aws.amazon.com/https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Referrer-Policy>`_ in the MDN Web Docs.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-responseheaderspolicy-referrerpolicy.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_cloudfront as cloudfront\n\n    referrer_policy_property = cloudfront.CfnResponseHeadersPolicy.ReferrerPolicyProperty(\n        override=False,\n        referrer_policy="referrerPolicy"\n    )\n')
...
class CfnResponseHeadersPolicy_ResponseHeadersPolicyConfigPropertyDef(BaseStruct):
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A name to identify the response headers policy. The name must be unique for response headers policies in this AWS account .\n')
    ...
    cors_config: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnResponseHeadersPolicy_CorsConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A configuration for a set of HTTP response headers that are used for cross-origin resource sharing (CORS).\n')
    custom_headers_config: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnResponseHeadersPolicy_CustomHeadersConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A configuration for a set of custom HTTP response headers.\n')
    remove_headers_config: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnResponseHeadersPolicy_RemoveHeadersConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A configuration for a set of HTTP headers to remove from the HTTP response.\n')
    security_headers_config: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnResponseHeadersPolicy_SecurityHeadersConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A configuration for a set of security-related HTTP response headers.\n')
...
class CfnResponseHeadersPolicy_ServerTimingHeadersConfigPropertyDef(BaseStruct):
    enabled: typing.Union[_REQUIRED_INIT_PARAM, bool, models.UnsupportedResource] = pydantic.Field(REQUIRED_INIT_PARAM, description="A Boolean that determines whether CloudFront adds the ``Server-Timing`` header to HTTP responses that it sends in response to requests that match a cache behavior that's associated with this response headers policy.\n")
...
class CfnResponseHeadersPolicy_StrictTransportSecurityPropertyDef(BaseStruct):
    access_control_max_age_sec: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='A number that CloudFront uses as the value for the ``max-age`` directive in the ``Strict-Transport-Security`` HTTP response header.\n')
    override: typing.Union[_REQUIRED_INIT_PARAM, bool, models.UnsupportedResource] = pydantic.Field(REQUIRED_INIT_PARAM, description='A Boolean that determines whether CloudFront overrides the ``Strict-Transport-Security`` HTTP response header received from the origin with the one specified in this response headers policy.\n')
    include_subdomains: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='A Boolean that determines whether CloudFront includes the ``includeSubDomains`` directive in the ``Strict-Transport-Security`` HTTP response header.\n')
    preload: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='A Boolean that determines whether CloudFront includes the ``preload`` directive in the ``Strict-Transport-Security`` HTTP response header.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-responseheaderspolicy-stricttransportsecurity.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_cloudfront as cloudfront\n\n    strict_transport_security_property = cloudfront.CfnResponseHeadersPolicy.StrictTransportSecurityProperty(\n        access_control_max_age_sec=123,\n        override=False,\n\n        # the properties below are optional\n        include_subdomains=False,\n        preload=False\n    )\n')
...
class CfnResponseHeadersPolicy_XSSProtectionPropertyDef(BaseStruct):
    override: typing.Union[_REQUIRED_INIT_PARAM, bool, models.UnsupportedResource] = pydantic.Field(REQUIRED_INIT_PARAM, description='A Boolean that determines whether CloudFront overrides the ``X-XSS-Protection`` HTTP response header received from the origin with the one specified in this response headers policy.\n')
    protection: typing.Union[_REQUIRED_INIT_PARAM, bool, models.UnsupportedResource] = pydantic.Field(REQUIRED_INIT_PARAM, description='A Boolean that determines the value of the ``X-XSS-Protection`` HTTP response header. When this setting is ``true`` , the value of the ``X-XSS-Protection`` header is ``1`` . When this setting is ``false`` , the value of the ``X-XSS-Protection`` header is ``0`` . For more information about these settings, see `X-XSS-Protection <https://docs.aws.amazon.com/https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/X-XSS-Protection>`_ in the MDN Web Docs.\n')
    mode_block: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='A Boolean that determines whether CloudFront includes the ``mode=block`` directive in the ``X-XSS-Protection`` header. For more information about this directive, see `X-XSS-Protection <https://docs.aws.amazon.com/https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/X-XSS-Protection>`_ in the MDN Web Docs.\n')
...
class CfnStreamingDistribution_LoggingPropertyDef(BaseStruct):
    bucket: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The Amazon S3 bucket to store the access logs in, for example, ``myawslogbucket.s3.amazonaws.com`` .\n')
    enabled: typing.Union[_REQUIRED_INIT_PARAM, bool, models.UnsupportedResource] = pydantic.Field(REQUIRED_INIT_PARAM, description="Specifies whether you want CloudFront to save access logs to an Amazon S3 bucket. If you don't want to enable logging when you create a streaming distribution or if you want to disable logging for an existing streaming distribution, specify ``false`` for ``Enabled`` , and specify ``empty Bucket`` and ``Prefix`` elements. If you specify ``false`` for ``Enabled`` but you specify values for ``Bucket`` and ``Prefix`` , the values are automatically deleted.\n")
    prefix: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='An optional string that you want CloudFront to prefix to the access log filenames for this streaming distribution, for example, ``myprefix/`` . If you want to enable logging, but you don\'t want to specify a prefix, you still must include an empty ``Prefix`` element in the ``Logging`` element.\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-streamingdistribution-logging.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_cloudfront as cloudfront\n\n    logging_property = cloudfront.CfnStreamingDistribution.LoggingProperty(\n        bucket="bucket",\n        enabled=False,\n        prefix="prefix"\n    )\n')
...
class CfnStreamingDistribution_S3OriginPropertyDef(BaseStruct):
    domain_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The DNS name of the Amazon S3 origin.\n')
    origin_access_identity: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The CloudFront origin access identity to associate with the distribution. Use an origin access identity to configure the distribution so that end users can only access objects in an Amazon S3 bucket through CloudFront. If you want end users to be able to access objects using either the CloudFront URL or the Amazon S3 URL, specify an empty ``OriginAccessIdentity`` element. To delete the origin access identity from an existing distribution, update the distribution configuration and include an empty ``OriginAccessIdentity`` element. To replace the origin access identity, update the distribution configuration and specify the new origin access identity. For more information, see `Using an Origin Access Identity to Restrict Access to Your Amazon S3 Content <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/private-content-restricting-access-to-s3.html>`_ in the *Amazon CloudFront Developer Guide* .\n\n:see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-streamingdistribution-s3origin.html\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_cloudfront as cloudfront\n\n    s3_origin_property = cloudfront.CfnStreamingDistribution.S3OriginProperty(\n        domain_name="domainName",\n        origin_access_identity="originAccessIdentity"\n    )\n')
...
class CfnStreamingDistribution_StreamingDistributionConfigPropertyDef(BaseStruct):
    comment: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Any comments you want to include about the streaming distribution.\n')
    enabled: typing.Union[_REQUIRED_INIT_PARAM, bool, models.UnsupportedResource] = pydantic.Field(REQUIRED_INIT_PARAM, description='Whether the streaming distribution is enabled to accept user requests for content.\n')
    s3_origin: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_cloudfront.CfnStreamingDistribution_S3OriginPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='A complex type that contains information about the Amazon S3 bucket from which you want CloudFront to get your media files for distribution.\n')
    trusted_signers: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_cloudfront.CfnStreamingDistribution_TrustedSignersPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='A complex type that specifies any AWS accounts that you want to permit to create signed URLs for private content. If you want the distribution to use signed URLs, include this element; if you want the distribution to use public URLs, remove this element. For more information, see `Serving Private Content through CloudFront <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/PrivateContent.html>`_ in the *Amazon CloudFront Developer Guide* .\n')
    ...
    logging: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnStreamingDistribution_LoggingPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='A complex type that controls whether access logs are written for the streaming distribution.\n')
...
class CfnStreamingDistribution_TrustedSignersPropertyDef(BaseStruct):
    enabled: typing.Union[_REQUIRED_INIT_PARAM, bool, models.UnsupportedResource] = pydantic.Field(REQUIRED_INIT_PARAM, description='This field is ``true`` if any of the AWS accounts in the list are configured as trusted signers. If not, this field is ``false`` .\n')
...
class CloudFrontWebDistributionAttributesDef(BaseStruct):
    distribution_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The distribution ID for this distribution.\n')
    domain_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The generated domain name of the Distribution, such as d111111abcdef8.cloudfront.net.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_cloudfront as cloudfront\n\n    cloud_front_web_distribution_attributes = cloudfront.CloudFrontWebDistributionAttributes(\n        distribution_id="distributionId",\n        domain_name="domainName"\n    )\n')
...
class CustomOriginConfigDef(BaseStruct):
    domain_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The domain name of the custom origin. Should not include the path - that should be in the parent SourceConfiguration\n')
...
class EdgeLambdaDef(BaseStruct):
    event_type: typing.Union[aws_cdk.aws_cloudfront.LambdaEdgeEventType, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The type of event in response to which should the function be invoked.\n')
    function_version: typing.Union[_REQUIRED_INIT_PARAM, models.aws_lambda.VersionDef] = pydantic.Field(REQUIRED_INIT_PARAM, description="The version of the Lambda function that will be invoked. **Note**: it's not possible to use the '$LATEST' function version for Lambda@Edge!\n")
...
class ErrorResponseDef(BaseStruct):
    http_status: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The HTTP status code for which you want to specify a custom error page and/or a caching duration.\n')
...
class FileCodeOptionsDef(BaseStruct):
    file_path: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The path of the file to read the code from.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_cloudfront as cloudfront\n\n    file_code_options = cloudfront.FileCodeOptions(\n        file_path="filePath"\n    )\n')
...
class FunctionAssociationDef(BaseStruct):
    event_type: typing.Union[aws_cdk.aws_cloudfront.FunctionEventType, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The type of event which should invoke the function.\n')
    function: typing.Union[_REQUIRED_INIT_PARAM, models.aws_cloudfront.FunctionDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The CloudFront function that will be invoked.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_cloudfront as cloudfront\n\n    # function_: cloudfront.Function\n\n    function_association = cloudfront.FunctionAssociation(\n        event_type=cloudfront.FunctionEventType.VIEWER_REQUEST,\n        function=function_\n    )\n')
...
class FunctionAttributesDef(BaseStruct):
    function_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The ARN of the function.\n')
    function_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the function.\n')
    function_runtime: typing.Optional[str] = pydantic.Field(None, description='The Runtime of the function. Default: FunctionRuntime.JS_1_0\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_cloudfront as cloudfront\n\n    function_attributes = cloudfront.FunctionAttributes(\n        function_arn="functionArn",\n        function_name="functionName",\n\n        # the properties below are optional\n        function_runtime="functionRuntime"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['function_arn', 'function_name', 'function_runtime']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
#  autogenerated from aws_cdk.aws_cloudfront.KeyValueStoreProps
class KeyValueStorePropsDef(BaseStruct):
    comment: typing.Optional[str] = pydantic.Field(None, description='A comment for the Key Value Store. Default: No comment will be specified\n')
    key_value_store_name: typing.Optional[str] = pydantic.Field(None, description='The unique name of the Key Value Store. Default: A generated name\n')
    ...
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_cloudfront.KeyValueStoreProps'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class LambdaFunctionAssociationDef(BaseStruct):
    event_type: typing.Union[aws_cdk.aws_cloudfront.LambdaEdgeEventType, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The lambda event type defines at which event the lambda is called during the request lifecycle.')
    lambda_function: typing.Union[_REQUIRED_INIT_PARAM, models.aws_lambda.VersionDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='A version of the lambda to associate.\n')
...
class OriginBindOptionsDef(BaseStruct):
    origin_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The identifier of this Origin, as assigned by the Distribution this Origin has been used added to.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import aws_cloudfront as cloudfront\n\n    origin_bind_options = cloudfront.OriginBindOptions(\n        origin_id="originId"\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['origin_id']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class OriginFailoverConfigDef(BaseStruct):
    failover_origin: typing.Union[_REQUIRED_INIT_PARAM, models.aws_cloudfront.OriginBaseDef, models.aws_cloudfront_origins.FunctionUrlOriginDef, models.aws_cloudfront_origins.HttpOriginDef, models.aws_cloudfront_origins.LoadBalancerV2OriginDef, models.aws_cloudfront_origins.OriginGroupDef, models.aws_cloudfront_origins.RestApiOriginDef, models.aws_cloudfront_origins.S3OriginDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The origin to use as the fallback origin.\n')
...
#  autogenerated from aws_cdk.aws_cloudfront.RealtimeLogConfigProps
class RealtimeLogConfigPropsDef(BaseStruct):
    end_points: typing.Union[typing.Sequence[models.aws_cloudfront.EndpointDef], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Contains information about the Amazon Kinesis data stream where you are sending real-time log data for this real-time log configuration.\n')
    fields: typing.Union[typing.Sequence[str], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A list of fields that are included in each real-time log record.\n')
    sampling_rate: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The sampling rate for this real-time log configuration.\n')
    ...
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_cloudfront.RealtimeLogConfigProps'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class ResponseCustomHeaderDef(BaseStruct):
    header: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The HTTP response header name.\n')
    override: typing.Union[bool, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A Boolean that determines whether CloudFront overrides a response header with the same name received from the origin with the header specified here.\n')
...
class ResponseHeadersContentSecurityPolicyDef(BaseStruct):
    content_security_policy: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The policy directives and their values that CloudFront includes as values for the Content-Security-Policy HTTP response header.\n')
    override: typing.Union[bool, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A Boolean that determines whether CloudFront overrides the Content-Security-Policy HTTP response header received from the origin with the one specified in this response headers policy.\n\n:exampleMetadata: infused\n\nExample::\n\n    # Using an existing managed response headers policy\n    # bucket_origin: origins.S3Origin\n\n    cloudfront.Distribution(self, "myDistManagedPolicy",\n        default_behavior=cloudfront.BehaviorOptions(\n            origin=bucket_origin,\n            response_headers_policy=cloudfront.ResponseHeadersPolicy.CORS_ALLOW_ALL_ORIGINS\n        )\n    )\n\n    # Creating a custom response headers policy -- all parameters optional\n    my_response_headers_policy = cloudfront.ResponseHeadersPolicy(self, "ResponseHeadersPolicy",\n        response_headers_policy_name="MyPolicy",\n        comment="A default policy",\n        cors_behavior=cloudfront.ResponseHeadersCorsBehavior(\n            access_control_allow_credentials=False,\n            access_control_allow_headers=["X-Custom-Header-1", "X-Custom-Header-2"],\n            access_control_allow_methods=["GET", "POST"],\n            access_control_allow_origins=["*"],\n            access_control_expose_headers=["X-Custom-Header-1", "X-Custom-Header-2"],\n            access_control_max_age=Duration.seconds(600),\n            origin_override=True\n        ),\n        custom_headers_behavior=cloudfront.ResponseCustomHeadersBehavior(\n            custom_headers=[cloudfront.ResponseCustomHeader(header="X-Amz-Date", value="some-value", override=True), cloudfront.ResponseCustomHeader(header="X-Amz-Security-Token", value="some-value", override=False)\n            ]\n        ),\n        security_headers_behavior=cloudfront.ResponseSecurityHeadersBehavior(\n            content_security_policy=cloudfront.ResponseHeadersContentSecurityPolicy(content_security_policy="default-src https:;", override=True),\n            content_type_options=cloudfront.ResponseHeadersContentTypeOptions(override=True),\n            frame_options=cloudfront.ResponseHeadersFrameOptions(frame_option=cloudfront.HeadersFrameOption.DENY, override=True),\n            referrer_policy=cloudfront.ResponseHeadersReferrerPolicy(referrer_policy=cloudfront.HeadersReferrerPolicy.NO_REFERRER, override=True),\n            strict_transport_security=cloudfront.ResponseHeadersStrictTransportSecurity(access_control_max_age=Duration.seconds(600), include_subdomains=True, override=True),\n            xss_protection=cloudfront.ResponseHeadersXSSProtection(protection=True, mode_block=True, report_uri="https://example.com/csp-report", override=True)\n        ),\n        remove_headers=["Server"],\n        server_timing_sampling_rate=50\n    )\n    cloudfront.Distribution(self, "myDistCustomPolicy",\n        default_behavior=cloudfront.BehaviorOptions(\n            origin=bucket_origin,\n            response_headers_policy=my_response_headers_policy\n        )\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['content_security_policy', 'override']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class ResponseHeadersContentTypeOptionsDef(BaseStruct):
    override: typing.Union[bool, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A Boolean that determines whether CloudFront overrides the X-Content-Type-Options HTTP response header received from the origin with the one specified in this response headers policy.\n\n:exampleMetadata: infused\n\nExample::\n\n    # Using an existing managed response headers policy\n    # bucket_origin: origins.S3Origin\n\n    cloudfront.Distribution(self, "myDistManagedPolicy",\n        default_behavior=cloudfront.BehaviorOptions(\n            origin=bucket_origin,\n            response_headers_policy=cloudfront.ResponseHeadersPolicy.CORS_ALLOW_ALL_ORIGINS\n        )\n    )\n\n    # Creating a custom response headers policy -- all parameters optional\n    my_response_headers_policy = cloudfront.ResponseHeadersPolicy(self, "ResponseHeadersPolicy",\n        response_headers_policy_name="MyPolicy",\n        comment="A default policy",\n        cors_behavior=cloudfront.ResponseHeadersCorsBehavior(\n            access_control_allow_credentials=False,\n            access_control_allow_headers=["X-Custom-Header-1", "X-Custom-Header-2"],\n            access_control_allow_methods=["GET", "POST"],\n            access_control_allow_origins=["*"],\n            access_control_expose_headers=["X-Custom-Header-1", "X-Custom-Header-2"],\n            access_control_max_age=Duration.seconds(600),\n            origin_override=True\n        ),\n        custom_headers_behavior=cloudfront.ResponseCustomHeadersBehavior(\n            custom_headers=[cloudfront.ResponseCustomHeader(header="X-Amz-Date", value="some-value", override=True), cloudfront.ResponseCustomHeader(header="X-Amz-Security-Token", value="some-value", override=False)\n            ]\n        ),\n        security_headers_behavior=cloudfront.ResponseSecurityHeadersBehavior(\n            content_security_policy=cloudfront.ResponseHeadersContentSecurityPolicy(content_security_policy="default-src https:;", override=True),\n            content_type_options=cloudfront.ResponseHeadersContentTypeOptions(override=True),\n            frame_options=cloudfront.ResponseHeadersFrameOptions(frame_option=cloudfront.HeadersFrameOption.DENY, override=True),\n            referrer_policy=cloudfront.ResponseHeadersReferrerPolicy(referrer_policy=cloudfront.HeadersReferrerPolicy.NO_REFERRER, override=True),\n            strict_transport_security=cloudfront.ResponseHeadersStrictTransportSecurity(access_control_max_age=Duration.seconds(600), include_subdomains=True, override=True),\n            xss_protection=cloudfront.ResponseHeadersXSSProtection(protection=True, mode_block=True, report_uri="https://example.com/csp-report", override=True)\n        ),\n        remove_headers=["Server"],\n        server_timing_sampling_rate=50\n    )\n    cloudfront.Distribution(self, "myDistCustomPolicy",\n        default_behavior=cloudfront.BehaviorOptions(\n            origin=bucket_origin,\n            response_headers_policy=my_response_headers_policy\n        )\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['override']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class ResponseHeadersCorsBehaviorDef(BaseStruct):
    access_control_allow_credentials: typing.Union[bool, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A Boolean that CloudFront uses as the value for the Access-Control-Allow-Credentials HTTP response header.\n')
    access_control_allow_headers: typing.Union[typing.Sequence[str], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description="A list of HTTP header names that CloudFront includes as values for the Access-Control-Allow-Headers HTTP response header. You can specify ``['*']`` to allow all headers.\n")
    access_control_allow_methods: typing.Union[typing.Sequence[str], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A list of HTTP methods that CloudFront includes as values for the Access-Control-Allow-Methods HTTP response header.\n')
    access_control_allow_origins: typing.Union[typing.Sequence[str], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description="A list of origins (domain names) that CloudFront can use as the value for the Access-Control-Allow-Origin HTTP response header. You can specify ``['*']`` to allow all origins.\n")
    origin_override: typing.Union[bool, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A Boolean that determines whether CloudFront overrides HTTP response headers received from the origin with the ones specified in this response headers policy.\n')
...
class ResponseHeadersFrameOptionsDef(BaseStruct):
    frame_option: typing.Union[aws_cdk.aws_cloudfront.HeadersFrameOption, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The value of the X-Frame-Options HTTP response header.\n')
    override: typing.Union[bool, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A Boolean that determines whether CloudFront overrides the X-Frame-Options HTTP response header received from the origin with the one specified in this response headers policy.\n\n:exampleMetadata: infused\n\nExample::\n\n    # Using an existing managed response headers policy\n    # bucket_origin: origins.S3Origin\n\n    cloudfront.Distribution(self, "myDistManagedPolicy",\n        default_behavior=cloudfront.BehaviorOptions(\n            origin=bucket_origin,\n            response_headers_policy=cloudfront.ResponseHeadersPolicy.CORS_ALLOW_ALL_ORIGINS\n        )\n    )\n\n    # Creating a custom response headers policy -- all parameters optional\n    my_response_headers_policy = cloudfront.ResponseHeadersPolicy(self, "ResponseHeadersPolicy",\n        response_headers_policy_name="MyPolicy",\n        comment="A default policy",\n        cors_behavior=cloudfront.ResponseHeadersCorsBehavior(\n            access_control_allow_credentials=False,\n            access_control_allow_headers=["X-Custom-Header-1", "X-Custom-Header-2"],\n            access_control_allow_methods=["GET", "POST"],\n            access_control_allow_origins=["*"],\n            access_control_expose_headers=["X-Custom-Header-1", "X-Custom-Header-2"],\n            access_control_max_age=Duration.seconds(600),\n            origin_override=True\n        ),\n        custom_headers_behavior=cloudfront.ResponseCustomHeadersBehavior(\n            custom_headers=[cloudfront.ResponseCustomHeader(header="X-Amz-Date", value="some-value", override=True), cloudfront.ResponseCustomHeader(header="X-Amz-Security-Token", value="some-value", override=False)\n            ]\n        ),\n        security_headers_behavior=cloudfront.ResponseSecurityHeadersBehavior(\n            content_security_policy=cloudfront.ResponseHeadersContentSecurityPolicy(content_security_policy="default-src https:;", override=True),\n            content_type_options=cloudfront.ResponseHeadersContentTypeOptions(override=True),\n            frame_options=cloudfront.ResponseHeadersFrameOptions(frame_option=cloudfront.HeadersFrameOption.DENY, override=True),\n            referrer_policy=cloudfront.ResponseHeadersReferrerPolicy(referrer_policy=cloudfront.HeadersReferrerPolicy.NO_REFERRER, override=True),\n            strict_transport_security=cloudfront.ResponseHeadersStrictTransportSecurity(access_control_max_age=Duration.seconds(600), include_subdomains=True, override=True),\n            xss_protection=cloudfront.ResponseHeadersXSSProtection(protection=True, mode_block=True, report_uri="https://example.com/csp-report", override=True)\n        ),\n        remove_headers=["Server"],\n        server_timing_sampling_rate=50\n    )\n    cloudfront.Distribution(self, "myDistCustomPolicy",\n        default_behavior=cloudfront.BehaviorOptions(\n            origin=bucket_origin,\n            response_headers_policy=my_response_headers_policy\n        )\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['frame_option', 'override']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class ResponseHeadersReferrerPolicyDef(BaseStruct):
    override: typing.Union[bool, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A Boolean that determines whether CloudFront overrides the Referrer-Policy HTTP response header received from the origin with the one specified in this response headers policy.\n')
    referrer_policy: typing.Union[aws_cdk.aws_cloudfront.HeadersReferrerPolicy, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The value of the Referrer-Policy HTTP response header.\n\n:exampleMetadata: infused\n\nExample::\n\n    # Using an existing managed response headers policy\n    # bucket_origin: origins.S3Origin\n\n    cloudfront.Distribution(self, "myDistManagedPolicy",\n        default_behavior=cloudfront.BehaviorOptions(\n            origin=bucket_origin,\n            response_headers_policy=cloudfront.ResponseHeadersPolicy.CORS_ALLOW_ALL_ORIGINS\n        )\n    )\n\n    # Creating a custom response headers policy -- all parameters optional\n    my_response_headers_policy = cloudfront.ResponseHeadersPolicy(self, "ResponseHeadersPolicy",\n        response_headers_policy_name="MyPolicy",\n        comment="A default policy",\n        cors_behavior=cloudfront.ResponseHeadersCorsBehavior(\n            access_control_allow_credentials=False,\n            access_control_allow_headers=["X-Custom-Header-1", "X-Custom-Header-2"],\n            access_control_allow_methods=["GET", "POST"],\n            access_control_allow_origins=["*"],\n            access_control_expose_headers=["X-Custom-Header-1", "X-Custom-Header-2"],\n            access_control_max_age=Duration.seconds(600),\n            origin_override=True\n        ),\n        custom_headers_behavior=cloudfront.ResponseCustomHeadersBehavior(\n            custom_headers=[cloudfront.ResponseCustomHeader(header="X-Amz-Date", value="some-value", override=True), cloudfront.ResponseCustomHeader(header="X-Amz-Security-Token", value="some-value", override=False)\n            ]\n        ),\n        security_headers_behavior=cloudfront.ResponseSecurityHeadersBehavior(\n            content_security_policy=cloudfront.ResponseHeadersContentSecurityPolicy(content_security_policy="default-src https:;", override=True),\n            content_type_options=cloudfront.ResponseHeadersContentTypeOptions(override=True),\n            frame_options=cloudfront.ResponseHeadersFrameOptions(frame_option=cloudfront.HeadersFrameOption.DENY, override=True),\n            referrer_policy=cloudfront.ResponseHeadersReferrerPolicy(referrer_policy=cloudfront.HeadersReferrerPolicy.NO_REFERRER, override=True),\n            strict_transport_security=cloudfront.ResponseHeadersStrictTransportSecurity(access_control_max_age=Duration.seconds(600), include_subdomains=True, override=True),\n            xss_protection=cloudfront.ResponseHeadersXSSProtection(protection=True, mode_block=True, report_uri="https://example.com/csp-report", override=True)\n        ),\n        remove_headers=["Server"],\n        server_timing_sampling_rate=50\n    )\n    cloudfront.Distribution(self, "myDistCustomPolicy",\n        default_behavior=cloudfront.BehaviorOptions(\n            origin=bucket_origin,\n            response_headers_policy=my_response_headers_policy\n        )\n    )\n')
    _init_params: typing.ClassVar[list[str]] = ['override', 'referrer_policy']
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class ResponseHeadersStrictTransportSecurityDef(BaseStruct):
    access_control_max_age: typing.Union[models.DurationDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A number that CloudFront uses as the value for the max-age directive in the Strict-Transport-Security HTTP response header.\n')
    override: typing.Union[bool, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A Boolean that determines whether CloudFront overrides the Strict-Transport-Security HTTP response header received from the origin with the one specified in this response headers policy.\n')
...
class ResponseHeadersXSSProtectionDef(BaseStruct):
    override: typing.Union[bool, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A Boolean that determines whether CloudFront overrides the X-XSS-Protection HTTP response header received from the origin with the one specified in this response headers policy.\n')
    protection: typing.Union[bool, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A Boolean that determines the value of the X-XSS-Protection HTTP response header. When this setting is true, the value of the X-XSS-Protection header is 1. When this setting is false, the value of the X-XSS-Protection header is 0.\n')
...
class S3OriginConfigDef(BaseStruct):
    s3_bucket_source: typing.Union[_REQUIRED_INIT_PARAM, models.aws_s3.BucketBaseDef, models.aws_s3.BucketDef] = pydantic.Field(REQUIRED_INIT_PARAM, description='The source bucket to serve content from.\n')
...
class SourceConfigurationDef(BaseStruct):
    behaviors: typing.Union[typing.Sequence[typing.Union[models.aws_cloudfront.BehaviorDef, dict[str, typing.Any]]], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The behaviors associated with this source. At least one (default) behavior must be included.\n')
...
#  autogenerated from aws_cdk.aws_cloudfront.IKeyValueStore
#  skipping Interface
...
#  autogenerated from aws_cdk.aws_cloudfront.IRealtimeLogConfig
#  skipping Interface
...
class CfnCachePolicyDef(BaseCfnResource):
    cache_policy_config: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_cloudfront.CfnCachePolicy_CachePolicyConfigPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The cache policy configuration.')
...
class CfnCachePolicyDefCachepolicyconfigpropertyParams(pydantic.BaseModel):
    ...
    parameters_in_cache_key_and_forwarded_to_origin: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnCachePolicy_ParametersInCacheKeyAndForwardedToOriginPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
...
class CfnCachePolicyDefParametersincachekeyandforwardedtooriginpropertyParams(pydantic.BaseModel):
    cookies_config: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnCachePolicy_CookiesConfigPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    enable_accept_encoding_gzip: typing.Union[bool, models.UnsupportedResource] = pydantic.Field(..., description='')
    headers_config: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnCachePolicy_HeadersConfigPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    query_strings_config: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnCachePolicy_QueryStringsConfigPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    enable_accept_encoding_brotli: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
    ...
...
class CfnContinuousDeploymentPolicyDefContinuousdeploymentpolicyconfigpropertyParams(pydantic.BaseModel):
    ...
    single_header_policy_config: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnContinuousDeploymentPolicy_SingleHeaderPolicyConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    single_weight_policy_config: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnContinuousDeploymentPolicy_SingleWeightPolicyConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    traffic_config: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnContinuousDeploymentPolicy_TrafficConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
...
class CfnContinuousDeploymentPolicyDefSingleheaderpolicyconfigpropertyParams(pydantic.BaseModel):
    header: str = pydantic.Field(..., description='')
    value: str = pydantic.Field(..., description='')
    ...
...
class CfnContinuousDeploymentPolicyDefSingleweightpolicyconfigpropertyParams(pydantic.BaseModel):
    weight: typing.Union[int, float] = pydantic.Field(..., description='')
    session_stickiness_config: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnContinuousDeploymentPolicy_SessionStickinessConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnContinuousDeploymentPolicyDefTrafficconfigpropertyParams(pydantic.BaseModel):
    ...
    single_header_config: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnContinuousDeploymentPolicy_SingleHeaderConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    single_weight_config: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnContinuousDeploymentPolicy_SingleWeightConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnDistributionDef(BaseCfnResource):
    distribution_config: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_cloudfront.CfnDistribution_DistributionConfigPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description="The distribution's configuration.\n")
...
class CfnDistributionDefCachebehaviorpropertyParams(pydantic.BaseModel):
    ...
    compress: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
    ...
    forwarded_values: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnDistribution_ForwardedValuesPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    function_associations: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnDistribution_FunctionAssociationPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    lambda_function_associations: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnDistribution_LambdaFunctionAssociationPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    ...
    smooth_streaming: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
...
class CfnDistributionDefDistributionconfigpropertyParams(pydantic.BaseModel):
    default_cache_behavior: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnDistribution_DefaultCacheBehaviorPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    enabled: typing.Union[bool, models.UnsupportedResource] = pydantic.Field(..., description='')
    aliases: typing.Optional[typing.Sequence[str]] = pydantic.Field(None, description='')
    cache_behaviors: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnDistribution_CacheBehaviorPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    cnam_es: typing.Optional[typing.Sequence[str]] = pydantic.Field(None, description='')
    comment: typing.Optional[str] = pydantic.Field(None, description='')
    continuous_deployment_policy_id: typing.Optional[str] = pydantic.Field(None, description='')
    custom_error_responses: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnDistribution_CustomErrorResponsePropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    custom_origin: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnDistribution_LegacyCustomOriginPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
    ipv6_enabled: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
    logging: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnDistribution_LoggingPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    origin_groups: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnDistribution_OriginGroupsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    origins: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnDistribution_OriginPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    price_class: typing.Optional[str] = pydantic.Field(None, description='')
    restrictions: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnDistribution_RestrictionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    s3_origin: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnDistribution_LegacyS3OriginPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    staging: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
    viewer_certificate: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnDistribution_ViewerCertificatePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
...
class CfnDistributionDefForwardedvaluespropertyParams(pydantic.BaseModel):
    query_string: typing.Union[bool, models.UnsupportedResource] = pydantic.Field(..., description='')
    cookies: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnDistribution_CookiesPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    headers: typing.Optional[typing.Sequence[str]] = pydantic.Field(None, description='')
...
class CfnDistributionDefLambdafunctionassociationpropertyParams(pydantic.BaseModel):
    event_type: typing.Optional[str] = pydantic.Field(None, description='')
    include_body: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
...
class CfnDistributionDefLoggingpropertyParams(pydantic.BaseModel):
    ...
    include_cookies: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
...
class CfnDistributionDefOrigingroupfailovercriteriapropertyParams(pydantic.BaseModel):
    status_codes: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnDistribution_StatusCodesPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    ...
...
class CfnDistributionDefOrigingroupmemberspropertyParams(pydantic.BaseModel):
    items: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnDistribution_OriginGroupMemberPropertyDef, dict[str, typing.Any]]]] = pydantic.Field(..., description='')
...
class CfnDistributionDefOrigingrouppropertyParams(pydantic.BaseModel):
    failover_criteria: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnDistribution_OriginGroupFailoverCriteriaPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    id: str = pydantic.Field(..., description='')
    members: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnDistribution_OriginGroupMembersPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    ...

class CfnDistributionDefOrigingroupspropertyParams(pydantic.BaseModel):
    quantity: typing.Union[int, float] = pydantic.Field(..., description='')
    items: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnDistribution_OriginGroupPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    ...
...
class CfnDistributionDefOriginpropertyParams(pydantic.BaseModel):
    ...
    custom_origin_config: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnDistribution_CustomOriginConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    origin_access_control_id: typing.Optional[str] = pydantic.Field(None, description='')
    origin_custom_headers: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnDistribution_OriginCustomHeaderPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    origin_path: typing.Optional[str] = pydantic.Field(None, description='')
    origin_shield: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnDistribution_OriginShieldPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    s3_origin_config: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnDistribution_S3OriginConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnDistributionDefRestrictionspropertyParams(pydantic.BaseModel):
    geo_restriction: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnDistribution_GeoRestrictionPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    ...
...
class CfnDistributionDefStatuscodespropertyParams(pydantic.BaseModel):
    items: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[int, float]]] = pydantic.Field(..., description='')
    quantity: typing.Union[int, float] = pydantic.Field(..., description='')
    ...
...
class CfnDistributionDefViewercertificatepropertyParams(pydantic.BaseModel):
    ...
    cloud_front_default_certificate: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
...
class CfnFunctionDef(BaseCfnResource):
    function_code: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The function code. For more information about writing a CloudFront function, see `Writing function code for CloudFront Functions <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/writing-function-code.html>`_ in the *Amazon CloudFront Developer Guide* .\n')
    function_config: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_cloudfront.CfnFunction_FunctionConfigPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='Contains configuration information about a CloudFront function.\n')
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A name to identify the function.\n')
    auto_publish: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='A flag that determines whether to automatically publish the function to the ``LIVE`` stage when it’s created. To automatically publish to the ``LIVE`` stage, set this property to ``true`` .\n')
    function_metadata: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnFunction_FunctionMetadataPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='Contains metadata about a CloudFront function.')
    _init_params: typing.ClassVar[list[str]] = ['function_code', 'function_config', 'name', 'auto_publish', 'function_metadata']
    _method_names: typing.ClassVar[list[str]] = ['FunctionConfigProperty', 'FunctionMetadataProperty', 'KeyValueStoreAssociationProperty', 'add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
...
class CfnFunctionDefConfig(pydantic.BaseModel):
    ...
    KeyValueStoreAssociationProperty: typing.Optional[list[models.aws_cloudfront.CfnFunctionDefKeyvaluestoreassociationpropertyParams]] = pydantic.Field(None, description='')
...
class CfnFunctionDefFunctionconfigpropertyParams(pydantic.BaseModel):
    ...
    key_value_store_associations: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnFunction_KeyValueStoreAssociationPropertyDef, dict[str, typing.Any]]], None] = pydantic.Field(None, description='')
    ...
...
class CfnFunctionDefKeyvaluestoreassociationpropertyParams(pydantic.BaseModel):
    key_value_store_arn: str = pydantic.Field(..., description='')
    ...
...
class CfnKeyGroupDef(BaseCfnResource):
    key_group_config: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_cloudfront.CfnKeyGroup_KeyGroupConfigPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The key group configuration.')
...
#  autogenerated from aws_cdk.aws_cloudfront.CfnKeyValueStore
class CfnKeyValueStoreDef(BaseCfnResource):
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the key value store.\n')
    comment: typing.Optional[str] = pydantic.Field(None, description='A comment for the key value store.\n')
    import_source: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnKeyValueStore_ImportSourcePropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='The import source for the key value store.')
    _init_params: typing.ClassVar[list[str]] = ['name', 'comment', 'import_source']
    _method_names: typing.ClassVar[list[str]] = ['ImportSourceProperty', 'add_deletion_override', 'add_dependency', 'add_depends_on', 'add_metadata', 'add_override', 'add_property_deletion_override', 'add_property_override', 'apply_removal_policy', 'get_att', 'get_metadata', 'inspect', 'obtain_dependencies', 'obtain_resource_dependencies', 'override_logical_id', 'remove_dependency', 'replace_dependency']
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_cloudfront.CfnKeyValueStore'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...


    resource_config: typing.Optional[models.aws_cloudfront.CfnKeyValueStoreDefConfig] = pydantic.Field(None)


class CfnKeyValueStoreDefConfig(pydantic.BaseModel):
    ImportSourceProperty: typing.Optional[list[models.aws_cloudfront.CfnKeyValueStoreDefImportsourcepropertyParams]] = pydantic.Field(None, description='')
    add_deletion_override: typing.Optional[list[models.aws_cloudfront.CfnKeyValueStoreDefAddDeletionOverrideParams]] = pydantic.Field(None, description='Syntactic sugar for ``addOverride(path, undefined)``.')
    add_dependency: typing.Optional[list[models.aws_cloudfront.CfnKeyValueStoreDefAddDependencyParams]] = pydantic.Field(None, description='Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.\nThis can be used for resources across stacks (or nested stack) boundaries\nand the dependency will automatically be transferred to the relevant scope.')
    add_depends_on: typing.Optional[list[models.aws_cloudfront.CfnKeyValueStoreDefAddDependsOnParams]] = pydantic.Field(None, description='(deprecated) Indicates that this resource depends on another resource and cannot be provisioned unless the other resource has been successfully provisioned.')
    add_metadata: typing.Optional[list[models.aws_cloudfront.CfnKeyValueStoreDefAddMetadataParams]] = pydantic.Field(None, description='Add a value to the CloudFormation Resource Metadata.')
    add_override: typing.Optional[list[models.aws_cloudfront.CfnKeyValueStoreDefAddOverrideParams]] = pydantic.Field(None, description='Adds an override to the synthesized CloudFormation resource.\nTo add a\nproperty override, either use ``addPropertyOverride`` or prefix ``path`` with\n"Properties." (i.e. ``Properties.TopicName``).\n\nIf the override is nested, separate each nested level using a dot (.) in the path parameter.\nIf there is an array as part of the nesting, specify the index in the path.\n\nTo include a literal ``.`` in the property name, prefix with a ``\\``. In most\nprogramming languages you will need to write this as ``"\\\\."`` because the\n``\\`` itself will need to be escaped.\n\nFor example::\n\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.0.Projection.NonKeyAttributes", ["myattribute"])\n   cfn_resource.add_override("Properties.GlobalSecondaryIndexes.1.ProjectionType", "INCLUDE")\n\nwould add the overrides Example::\n\n   "Properties": {\n     "GlobalSecondaryIndexes": [\n       {\n         "Projection": {\n           "NonKeyAttributes": [ "myattribute" ]\n           ...\n         }\n         ...\n       },\n       {\n         "ProjectionType": "INCLUDE"\n         ...\n       },\n     ]\n     ...\n   }\n\nThe ``value`` argument to ``addOverride`` will not be processed or translated\nin any way. Pass raw JSON values in here with the correct capitalization\nfor CloudFormation. If you pass CDK classes or structs, they will be\nrendered with lowercased key names, and CloudFormation will reject the\ntemplate.')
    add_property_deletion_override: typing.Optional[list[models.aws_cloudfront.CfnKeyValueStoreDefAddPropertyDeletionOverrideParams]] = pydantic.Field(None, description='Adds an override that deletes the value of a property from the resource definition.')
    add_property_override: typing.Optional[list[models.aws_cloudfront.CfnKeyValueStoreDefAddPropertyOverrideParams]] = pydantic.Field(None, description='Adds an override to a resource property.\nSyntactic sugar for ``addOverride("Properties.<...>", value)``.')
    apply_removal_policy: typing.Optional[list[models.GenericApplyRemovalPolicyParams]] = pydantic.Field(None)
    get_att: typing.Optional[list[models.aws_cloudfront.CfnKeyValueStoreDefGetAttParams]] = pydantic.Field(None, description='Returns a token for an runtime attribute of this resource.\nIdeally, use generated attribute accessors (e.g. ``resource.arn``), but this can be used for future compatibility\nin case there is no generated attribute.')
    get_metadata: typing.Optional[list[models.aws_cloudfront.CfnKeyValueStoreDefGetMetadataParams]] = pydantic.Field(None, description='Retrieve a value value from the CloudFormation Resource Metadata.')
    inspect: typing.Optional[list[models.aws_cloudfront.CfnKeyValueStoreDefInspectParams]] = pydantic.Field(None, description='Examines the CloudFormation resource and discloses attributes.')
    obtain_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Retrieves an array of resources this resource depends on.\nThis assembles dependencies on resources across stacks (including nested stacks)\nautomatically.')
    obtain_resource_dependencies: typing.Optional[bool] = pydantic.Field(None, description='Get a shallow copy of dependencies between this resource and other resources in the same stack.')
    override_logical_id: typing.Optional[list[models.aws_cloudfront.CfnKeyValueStoreDefOverrideLogicalIdParams]] = pydantic.Field(None, description='Overrides the auto-generated logical ID with a specific ID.')
    remove_dependency: typing.Optional[list[models.aws_cloudfront.CfnKeyValueStoreDefRemoveDependencyParams]] = pydantic.Field(None, description='Indicates that this resource no longer depends on another resource.\nThis can be used for resources across stacks (including nested stacks)\nand the dependency will automatically be removed from the relevant scope.')
    replace_dependency: typing.Optional[list[models.aws_cloudfront.CfnKeyValueStoreDefReplaceDependencyParams]] = pydantic.Field(None, description='Replaces one dependency with another.')

class CfnKeyValueStoreDefImportsourcepropertyParams(pydantic.BaseModel):
    source_arn: str = pydantic.Field(..., description='')
    source_type: str = pydantic.Field(..., description='')
    ...

class CfnKeyValueStoreDefAddDeletionOverrideParams(pydantic.BaseModel):
    path: str = pydantic.Field(..., description='The path of the value to delete.')
    ...

class CfnKeyValueStoreDefAddDependencyParams(pydantic.BaseModel):
    target: models.CfnResourceDef = pydantic.Field(..., description='-')
    ...

class CfnKeyValueStoreDefAddDependsOnParams(pydantic.BaseModel):
    target: models.CfnResourceDef = pydantic.Field(..., description='-\n\n:deprecated: use addDependency\n\n:stability: deprecated\n')
    ...

class CfnKeyValueStoreDefAddMetadataParams(pydantic.BaseModel):
    key: str = pydantic.Field(..., description='-\n')
    value: typing.Any = pydantic.Field(..., description='-\n\n:see:\n\nhttps://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/metadata-section-structure.html\n\nNote that this is a different set of metadata from CDK node metadata; this\nmetadata ends up in the stack template under the resource, whereas CDK\nnode metadata ends up in the Cloud Assembly.\n')
    ...

class CfnKeyValueStoreDefAddOverrideParams(pydantic.BaseModel):
    path: str = pydantic.Field(..., description='- The path of the property, you can use dot notation to override values in complex types. Any intermediate keys will be created as needed.\n')
    value: typing.Any = pydantic.Field(..., description='- The value. Could be primitive or complex.')
    ...

class CfnKeyValueStoreDefAddPropertyDeletionOverrideParams(pydantic.BaseModel):
    property_path: str = pydantic.Field(..., description='The path to the property.')
    ...

class CfnKeyValueStoreDefAddPropertyOverrideParams(pydantic.BaseModel):
    property_path: str = pydantic.Field(..., description='The path of the property.\n')
    value: typing.Any = pydantic.Field(..., description='The value.')
    ...

class CfnKeyValueStoreDefApplyRemovalPolicyParams(pydantic.BaseModel):
    policy: typing.Optional[aws_cdk.RemovalPolicy] = pydantic.Field(None, description='-\n')
    apply_to_update_replace_policy: typing.Optional[bool] = pydantic.Field(None, description='Apply the same deletion policy to the resource\'s "UpdateReplacePolicy". Default: true\n')
    default: typing.Optional[aws_cdk.RemovalPolicy] = pydantic.Field(None, description="The default policy to apply in case the removal policy is not defined. Default: - Default value is resource specific. To determine the default value for a resource, please consult that specific resource's documentation.\n\n:see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-deletionpolicy.html#aws-attribute-deletionpolicy-options\n")
    ...

class CfnKeyValueStoreDefGetAttParams(pydantic.BaseModel):
    attribute_name: str = pydantic.Field(..., description='The name of the attribute.\n')
    type_hint: typing.Optional[aws_cdk.ResolutionTypeHint] = pydantic.Field(None, description='-')
    return_config: typing.Optional[list[models.core.ReferenceDefConfig]] = pydantic.Field(None)
    ...

class CfnKeyValueStoreDefGetMetadataParams(pydantic.BaseModel):
    key: str = pydantic.Field(..., description='-\n\n:see:\n\nhttps://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/metadata-section-structure.html\n\nNote that this is a different set of metadata from CDK node metadata; this\nmetadata ends up in the stack template under the resource, whereas CDK\nnode metadata ends up in the Cloud Assembly.\n')
    ...

class CfnKeyValueStoreDefInspectParams(pydantic.BaseModel):
    inspector: models.TreeInspectorDef = pydantic.Field(..., description='tree inspector to collect and process attributes.')
    ...

class CfnKeyValueStoreDefOverrideLogicalIdParams(pydantic.BaseModel):
    new_logical_id: str = pydantic.Field(..., description='The new logical ID to use for this stack element.')
    ...

class CfnKeyValueStoreDefRemoveDependencyParams(pydantic.BaseModel):
    target: models.CfnResourceDef = pydantic.Field(..., description='-')
    ...

class CfnKeyValueStoreDefReplaceDependencyParams(pydantic.BaseModel):
    target: models.CfnResourceDef = pydantic.Field(..., description='The dependency to replace.\n')
    new_target: models.CfnResourceDef = pydantic.Field(..., description='The new dependency to add.')
    ...
...
class CfnMonitoringSubscriptionDef(BaseCfnResource):
    distribution_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The ID of the distribution that you are enabling metrics for.\n')
    monitoring_subscription: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_cloudfront.CfnMonitoringSubscription_MonitoringSubscriptionPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='A subscription configuration for additional CloudWatch metrics.')
...
class CfnOriginAccessControlDef(BaseCfnResource):
    origin_access_control_config: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_cloudfront.CfnOriginAccessControl_OriginAccessControlConfigPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The origin access control.')
...
class CfnOriginRequestPolicyDef(BaseCfnResource):
    origin_request_policy_config: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_cloudfront.CfnOriginRequestPolicy_OriginRequestPolicyConfigPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The origin request policy configuration.')
...
class CfnOriginRequestPolicyDefOriginrequestpolicyconfigpropertyParams(pydantic.BaseModel):
    cookies_config: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnOriginRequestPolicy_CookiesConfigPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    headers_config: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnOriginRequestPolicy_HeadersConfigPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    name: str = pydantic.Field(..., description='')
    query_strings_config: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnOriginRequestPolicy_QueryStringsConfigPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    comment: typing.Optional[str] = pydantic.Field(None, description='')
    ...
...
class CfnRealtimeLogConfigDef(BaseCfnResource):
    end_points: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnRealtimeLogConfig_EndPointPropertyDef, dict[str, typing.Any]]]] = pydantic.Field(REQUIRED_INIT_PARAM, description='Contains information about the Amazon Kinesis data stream where you are sending real-time log data for this real-time log configuration.\n')
    fields: typing.Union[typing.Sequence[str], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='A list of fields that are included in each real-time log record. In an API response, the fields are provided in the same order in which they are sent to the Amazon Kinesis data stream. For more information about fields, see `Real-time log configuration fields <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/real-time-logs.html#understand-real-time-log-config-fields>`_ in the *Amazon CloudFront Developer Guide* .\n')
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The unique name of this real-time log configuration.\n')
    sampling_rate: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The sampling rate for this real-time log configuration. The sampling rate determines the percentage of viewer requests that are represented in the real-time log data. The sampling rate is an integer between 1 and 100, inclusive.')
...
class CfnResponseHeadersPolicyDef(BaseCfnResource):
    response_headers_policy_config: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_cloudfront.CfnResponseHeadersPolicy_ResponseHeadersPolicyConfigPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='A response headers policy configuration.')
...
class CfnResponseHeadersPolicyDefContentsecuritypolicypropertyParams(pydantic.BaseModel):
    ...
    override: typing.Union[bool, models.UnsupportedResource] = pydantic.Field(..., description='')
    ...
...
class CfnResponseHeadersPolicyDefCorsconfigpropertyParams(pydantic.BaseModel):
    access_control_allow_credentials: typing.Union[bool, models.UnsupportedResource] = pydantic.Field(..., description='')
    access_control_allow_headers: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnResponseHeadersPolicy_AccessControlAllowHeadersPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    access_control_allow_methods: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnResponseHeadersPolicy_AccessControlAllowMethodsPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    access_control_allow_origins: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnResponseHeadersPolicy_AccessControlAllowOriginsPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    origin_override: typing.Union[bool, models.UnsupportedResource] = pydantic.Field(..., description='')
    access_control_expose_headers: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnResponseHeadersPolicy_AccessControlExposeHeadersPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
...
class CfnResponseHeadersPolicyDefCustomheadersconfigpropertyParams(pydantic.BaseModel):
    items: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnResponseHeadersPolicy_CustomHeaderPropertyDef, dict[str, typing.Any]]]] = pydantic.Field(..., description='')
    ...
...
class CfnResponseHeadersPolicyDefRemoveheadersconfigpropertyParams(pydantic.BaseModel):
    items: typing.Union[models.UnsupportedResource, typing.Sequence[typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnResponseHeadersPolicy_RemoveHeaderPropertyDef, dict[str, typing.Any]]]] = pydantic.Field(..., description='')
    ...

class CfnResponseHeadersPolicyDefResponseheaderspolicyconfigpropertyParams(pydantic.BaseModel):
    name: str = pydantic.Field(..., description='')
    comment: typing.Optional[str] = pydantic.Field(None, description='')
    cors_config: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnResponseHeadersPolicy_CorsConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    custom_headers_config: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnResponseHeadersPolicy_CustomHeadersConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    remove_headers_config: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnResponseHeadersPolicy_RemoveHeadersConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    security_headers_config: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnResponseHeadersPolicy_SecurityHeadersConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    server_timing_headers_config: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnResponseHeadersPolicy_ServerTimingHeadersConfigPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...

class CfnResponseHeadersPolicyDefSecurityheadersconfigpropertyParams(pydantic.BaseModel):
    content_security_policy: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnResponseHeadersPolicy_ContentSecurityPolicyPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    content_type_options: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnResponseHeadersPolicy_ContentTypeOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    frame_options: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnResponseHeadersPolicy_FrameOptionsPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    referrer_policy: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnResponseHeadersPolicy_ReferrerPolicyPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    strict_transport_security: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnResponseHeadersPolicy_StrictTransportSecurityPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    xss_protection: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnResponseHeadersPolicy_XSSProtectionPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    ...
...
class CfnResponseHeadersPolicyDefStricttransportsecuritypropertyParams(pydantic.BaseModel):
    ...
    override: typing.Union[bool, models.UnsupportedResource] = pydantic.Field(..., description='')
    include_subdomains: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
    preload: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
    ...

class CfnResponseHeadersPolicyDefXssprotectionpropertyParams(pydantic.BaseModel):
    override: typing.Union[bool, models.UnsupportedResource] = pydantic.Field(..., description='')
    protection: typing.Union[bool, models.UnsupportedResource] = pydantic.Field(..., description='')
    mode_block: typing.Union[bool, models.UnsupportedResource, None] = pydantic.Field(None, description='')
...
class CfnStreamingDistributionDef(BaseCfnResource):
    streaming_distribution_config: typing.Union[_REQUIRED_INIT_PARAM, models.UnsupportedResource, models.aws_cloudfront.CfnStreamingDistribution_StreamingDistributionConfigPropertyDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='The current configuration information for the RTMP distribution.\n')
    tags: typing.Optional[typing.Sequence[typing.Union[models.CfnTagDef, dict[str, typing.Any]]]] = pydantic.Field(None, description='A complex type that contains zero or more ``Tag`` elements.')
...
class CfnStreamingDistributionDefStreamingdistributionconfigpropertyParams(pydantic.BaseModel):
    comment: str = pydantic.Field(..., description='')
    enabled: typing.Union[bool, models.UnsupportedResource] = pydantic.Field(..., description='')
    s3_origin: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnStreamingDistribution_S3OriginPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    trusted_signers: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnStreamingDistribution_TrustedSignersPropertyDef, dict[str, typing.Any]] = pydantic.Field(..., description='')
    aliases: typing.Optional[typing.Sequence[str]] = pydantic.Field(None, description='')
    logging: typing.Union[models.UnsupportedResource, models.aws_cloudfront.CfnStreamingDistribution_LoggingPropertyDef, dict[str, typing.Any], None] = pydantic.Field(None, description='')
    price_class: typing.Optional[str] = pydantic.Field(None, description='')
    ...
...
#  autogenerated from aws_cdk.aws_cloudfront.CfnKeyValueStoreProps
class CfnKeyValueStorePropsDef(BaseCfnProperty):
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the key value store.\n')
    comment: typing.Optional[str] = pydantic.Field(None, description='A comment for the key value store.\n')
    ...
    _method_names: typing.ClassVar[list[str]] = []
    _classmethod_names: typing.ClassVar[list[str]] = []
    _cdk_class_fqn: typing.ClassVar[str] = 'aws_cdk.aws_cloudfront.CfnKeyValueStoreProps'
    _alternate_constructor_method_names: typing.ClassVar[list[str]] = []
    ...
...
class ModuleModel(pydantic.BaseModel):
    ...
    AssetImportSource: typing.Optional[dict[str, models.aws_cloudfront.AssetImportSourceDef]] = pydantic.Field(None)
    ...
    FunctionRuntime: typing.Optional[dict[str, models.aws_cloudfront.FunctionRuntimeDef]] = pydantic.Field(None)
    GeoRestriction: typing.Optional[dict[str, models.aws_cloudfront.GeoRestrictionDef]] = pydantic.Field(None)
    ImportSource: typing.Optional[dict[str, models.aws_cloudfront.ImportSourceDef]] = pydantic.Field(None)
    InlineImportSource: typing.Optional[dict[str, models.aws_cloudfront.InlineImportSourceDef]] = pydantic.Field(None)
    ...
    S3ImportSource: typing.Optional[dict[str, models.aws_cloudfront.S3ImportSourceDef]] = pydantic.Field(None)
    ...
    KeyValueStore: typing.Optional[dict[str, models.aws_cloudfront.KeyValueStoreDef]] = pydantic.Field(None)
    ...
    CfnFunction_KeyValueStoreAssociationProperty: typing.Optional[dict[str, models.aws_cloudfront.CfnFunction_KeyValueStoreAssociationPropertyDef]] = pydantic.Field(None)
    ...
    CfnKeyValueStore_ImportSourceProperty: typing.Optional[dict[str, models.aws_cloudfront.CfnKeyValueStore_ImportSourcePropertyDef]] = pydantic.Field(None)
    ...
    KeyValueStoreProps: typing.Optional[dict[str, models.aws_cloudfront.KeyValueStorePropsDef]] = pydantic.Field(None)
    ...
    CfnKeyValueStore: typing.Optional[dict[str, models.aws_cloudfront.CfnKeyValueStoreDef]] = pydantic.Field(None)
    ...
    CfnKeyValueStoreProps: typing.Optional[dict[str, models.aws_cloudfront.CfnKeyValueStorePropsDef]] = pydantic.Field(None)
