...
class AssetManifestArtifactDef(BaseClass):
    assembly: typing.Union[models.cx_api.CloudAssemblyDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='-')
...
class CloudAssemblyDef(BaseClass):
    directory: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The root directory of the assembly.\n')
...
class CloudFormationStackArtifactDef(BaseClass):
    assembly: typing.Union[models.cx_api.CloudAssemblyDef, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='-')
    artifact_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='-\n')
    type: typing.Union[aws_cdk.cloud_assembly_schema.ArtifactType, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The type of artifact.\n')
    dependencies: typing.Optional[typing.Sequence[str]] = pydantic.Field(None, description='IDs of artifacts that must be deployed before this artifact. Default: - no dependencies.\n')
    display_name: typing.Optional[str] = pydantic.Field(None, description='A string that represents this artifact. Should only be used in user interfaces. Default: - no display name\n')
    environment: typing.Optional[str] = pydantic.Field(None, description='The environment into which this artifact is deployed. Default: - no envrionment.\n')
...
class EnvironmentDef(BaseStruct):
    account: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The AWS account this environment deploys into.\n')
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The arbitrary name of this environment (user-set, or at least user-meaningful).\n')
    region: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The AWS region name where this environment deploys into.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import cx_api\n\n    environment = cx_api.Environment(\n        account="account",\n        name="name",\n        region="region"\n    )\n')
...
class EnvironmentPlaceholderValuesDef(BaseStruct):
    account_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Return the account.\n')
    partition: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Return the partition.\n')
    region: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Return the region.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import cx_api\n\n    environment_placeholder_values = cx_api.EnvironmentPlaceholderValues(\n        account_id="accountId",\n        partition="partition",\n        region="region"\n    )\n')
...
class KeyContextResponseDef(BaseStruct):
    key_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Id of the key.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import cx_api\n\n    key_context_response = cx_api.KeyContextResponse(\n        key_id="keyId"\n    )\n')
...
class LoadBalancerContextResponseDef(BaseStruct):
    ip_address_type: typing.Union[aws_cdk.cx_api.LoadBalancerIpAddressType, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Type of IP address.\n')
    load_balancer_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The ARN of the load balancer.\n')
    load_balancer_canonical_hosted_zone_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description="The hosted zone ID of the load balancer's name.\n")
    load_balancer_dns_name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description="Load balancer's DNS name.\n")
    security_group_ids: typing.Union[typing.Sequence[str], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description="Load balancer's security groups.\n")
    vpc_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Load balancer\'s VPC.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import cx_api\n\n    load_balancer_context_response = cx_api.LoadBalancerContextResponse(\n        ip_address_type=cx_api.LoadBalancerIpAddressType.IPV4,\n        load_balancer_arn="loadBalancerArn",\n        load_balancer_canonical_hosted_zone_id="loadBalancerCanonicalHostedZoneId",\n        load_balancer_dns_name="loadBalancerDnsName",\n        security_group_ids=["securityGroupIds"],\n        vpc_id="vpcId"\n    )\n')
...
class LoadBalancerListenerContextResponseDef(BaseStruct):
    listener_arn: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The ARN of the listener.\n')
    listener_port: typing.Union[_REQUIRED_INIT_PARAM, int, float] = pydantic.Field(REQUIRED_INIT_PARAM, description='The port the listener is listening on.\n')
    security_group_ids: typing.Union[typing.Sequence[str], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The security groups of the load balancer.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import cx_api\n\n    load_balancer_listener_context_response = cx_api.LoadBalancerListenerContextResponse(\n        listener_arn="listenerArn",\n        listener_port=123,\n        security_group_ids=["securityGroupIds"]\n    )\n')
...
class MetadataEntryResultDef(BaseStruct):
    ...
    path: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The path in which this entry was defined.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import cx_api\n\n    metadata_entry_result = cx_api.MetadataEntryResult(\n        path="path",\n        type="type",\n\n        # the properties below are optional\n        data="data",\n        trace=["trace"]\n    )\n')
...
class SecurityGroupContextResponseDef(BaseStruct):
    allow_all_outbound: typing.Union[bool, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='Whether the security group allows all outbound traffic. This will be true when the security group has all-protocol egress permissions to access both ``0.0.0.0/0`` and ``::/0``.\n')
    security_group_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The security group\'s id.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import cx_api\n\n    security_group_context_response = cx_api.SecurityGroupContextResponse(\n        allow_all_outbound=False,\n        security_group_id="securityGroupId"\n    )\n')
...
class SynthesisMessageDef(BaseStruct):
    entry: typing.Union[_REQUIRED_INIT_PARAM, models.cloud_assembly_schema.MetadataEntryDef, dict[str, typing.Any]] = pydantic.Field(REQUIRED_INIT_PARAM, description='')
    level: typing.Union[aws_cdk.cx_api.SynthesisMessageLevel, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='')
...
class VpcContextResponseDef(BaseStruct):
    availability_zones: typing.Union[typing.Sequence[str], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='AZs.\n')
    vpc_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='VPC id.\n')
...
class VpcSubnetDef(BaseStruct):
    availability_zone: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description="The code of the availability zone this subnet is in (for example, 'us-west-2a').\n")
    route_table_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The identifier of the route table for this subnet.\n')
    subnet_id: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The identifier of the subnet.\n')
...
class VpcSubnetGroupDef(BaseStruct):
    name: typing.Union[str, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The name of the subnet group, determined by looking at the tags of of the subnets that belong to it.\n')
    subnets: typing.Union[typing.Sequence[typing.Union[models.cx_api.VpcSubnetDef, dict[str, typing.Any]]], _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The subnets that are part of this group. There is no condition that the subnets have to be symmetric in the group.\n')
    type: typing.Union[aws_cdk.cx_api.VpcSubnetGroupType, _REQUIRED_INIT_PARAM] = pydantic.Field(REQUIRED_INIT_PARAM, description='The type of the subnet group.\n\n:exampleMetadata: fixture=_generated\n\nExample::\n\n    # The code below shows an example of how to instantiate this type.\n    # The values are placeholders you should change.\n    from aws_cdk import cx_api\n\n    vpc_subnet_group = cx_api.VpcSubnetGroup(\n        name="name",\n        subnets=[cx_api.VpcSubnet(\n            availability_zone="availabilityZone",\n            route_table_id="routeTableId",\n            subnet_id="subnetId",\n\n            # the properties below are optional\n            cidr="cidr"\n        )],\n        type=cx_api.VpcSubnetGroupType.PUBLIC\n    )\n')
