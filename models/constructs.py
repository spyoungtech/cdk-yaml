...
class DependableDefGetParams(pydantic.BaseModel):
    instance: typing.Union[models.aws_iam.CompositeDependableDef, models.aws_iam.GrantDef, models.constructs.DependencyGroupDef] = pydantic.Field(..., description='-\n\n:deprecated: use ``of``\n\n:stability: deprecated\n')
...
class DependencyGroupDef(BaseClass):
    deps: list[typing.Union[models.aws_iam.CompositeDependableDef, models.aws_iam.GrantDef, models.constructs.DependencyGroupDef]] = pydantic.Field(...)
...
class DependencyGroupDefAddParams(pydantic.BaseModel):
    scopes: list[typing.Union[models.aws_iam.CompositeDependableDef, models.aws_iam.GrantDef, models.constructs.DependencyGroupDef]] = pydantic.Field(...)
    ...


#  autogenerated from constructs.Node
class NodeDef(BaseClass):
    host: models.constructs.ConstructDef = pydantic.Field(..., description='-')
...
class MetadataEntryDef(BaseStruct):
    data: typing.Any = pydantic.Field(..., description='The data.\n')
    type: str = pydantic.Field(..., description='The metadata entry type.\n')
